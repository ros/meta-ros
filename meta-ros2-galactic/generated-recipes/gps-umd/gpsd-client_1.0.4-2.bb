...
# matches with: https://github.com/ros2-gbp/gps_umd-release/archive/release/galactic/gpsd_client/1.0.4-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/gpsd_client"
SRC_URI = "git://github.com/ros2-gbp/gps_umd-release;${ROS_BRANCH};protocol=https"
SRCREV = "8d13229bdc59bbb9791e0798ce76c6737d6d34a2"
S = "${WORKDIR}/git"
