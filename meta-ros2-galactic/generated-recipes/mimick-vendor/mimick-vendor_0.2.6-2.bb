...
# matches with: https://github.com/ros2-gbp/mimick_vendor-release/archive/release/galactic/mimick_vendor/0.2.6-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/mimick_vendor"
SRC_URI = "git://github.com/ros2-gbp/mimick_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "ef45aa3e5f534905d853707ef8bec22fdabcaeef"
S = "${WORKDIR}/git"
