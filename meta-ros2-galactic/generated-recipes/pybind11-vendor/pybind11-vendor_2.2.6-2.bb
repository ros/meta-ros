...
# matches with: https://github.com/ros2-gbp/pybind11_vendor-release/archive/release/galactic/pybind11_vendor/2.2.6-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/pybind11_vendor"
SRC_URI = "git://github.com/ros2-gbp/pybind11_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "da362372ce1077a610c332fa225abb318eb190fe"
S = "${WORKDIR}/git"
