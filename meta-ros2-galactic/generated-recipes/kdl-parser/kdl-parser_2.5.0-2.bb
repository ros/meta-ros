...
# matches with: https://github.com/ros2-gbp/kdl_parser-release/archive/release/galactic/kdl_parser/2.5.0-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/kdl_parser"
SRC_URI = "git://github.com/ros2-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "a2774d72beba3da6ed243e6eabb5bc638dd600f4"
S = "${WORKDIR}/git"
