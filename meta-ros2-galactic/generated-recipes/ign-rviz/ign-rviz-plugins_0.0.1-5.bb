...
# matches with: https://github.com/ros2-gbp/ign_rviz-release/archive/release/galactic/ign_rviz_plugins/0.0.1-5.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ign_rviz_plugins"
SRC_URI = "git://github.com/ros2-gbp/ign_rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "02c0e530a5ac2c4ea11f3fec0f3bdec1cd77091b"
S = "${WORKDIR}/git"
