...
# matches with: https://github.com/ros2-gbp/control_box_rst-release/archive/release/galactic/control_box_rst/0.0.7-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/control_box_rst"
SRC_URI = "git://github.com/ros2-gbp/control_box_rst-release;${ROS_BRANCH};protocol=https"
SRCREV = "815d23ba24354fd43e5ff87b7f4162f75500733b"
S = "${WORKDIR}/git"
