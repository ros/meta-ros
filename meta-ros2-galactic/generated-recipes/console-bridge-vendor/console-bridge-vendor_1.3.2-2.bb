...
# matches with: https://github.com/ros2-gbp/console_bridge_vendor-release/archive/release/galactic/console_bridge_vendor/1.3.2-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/console_bridge_vendor"
SRC_URI = "git://github.com/ros2-gbp/console_bridge_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "8b59ed95cb18a9dd67a08bfb22aee3d88c65fa3c"
S = "${WORKDIR}/git"
