...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/galactic/qt_gui_py_common/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/qt_gui_py_common"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "0a065003ca8d961e374ef4698e9db180b3a36bb6"
S = "${WORKDIR}/git"
