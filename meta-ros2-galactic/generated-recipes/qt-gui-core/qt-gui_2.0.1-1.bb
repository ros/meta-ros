...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/galactic/qt_gui/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "95390316f75de32b305c37d62a752556739af249"
S = "${WORKDIR}/git"
