...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/galactic/qt_gui_cpp/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/qt_gui_cpp"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "21040c4c22b22250465c490953c0175fa6a49685"
S = "${WORKDIR}/git"
