...
# matches with: https://github.com/ros2-gbp/robot_state_publisher-release/archive/release/galactic/robot_state_publisher/2.5.1-1.tar.gz
...
SRCREV = "bd29ca80e2e1def3a9e931412395a165d7013d6e"
S = "${WORKDIR}/git"
