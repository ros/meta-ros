...
# matches with: https://github.com/ros2-gbp/resource_retriever-release/archive/release/galactic/resource_retriever/2.5.0-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/resource_retriever"
SRC_URI = "git://github.com/ros2-gbp/resource_retriever-release;${ROS_BRANCH};protocol=https"
SRCREV = "09a2b1597523d267b5e27f3985c9b746fa0842fd"
S = "${WORKDIR}/git"
