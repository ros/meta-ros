...
# matches with: https://github.com/ros2-gbp/ros2_ouster_drivers-release/archive/release/galactic/ouster_msgs/0.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ouster_msgs"
SRC_URI = "git://github.com/ros2-gbp/ros2_ouster_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "046cd959abffd0024e45cd8825036f4a70183821"
S = "${WORKDIR}/git"
