...
# matches with: https://github.com/ros2-gbp/cartographer_ros-release/archive/release/galactic/cartographer_ros_msgs/1.0.9003-4.tar.gz
ROS_BRANCH ?= "branch=release/galactic/cartographer_ros_msgs"
SRC_URI = "git://github.com/ros2-gbp/cartographer_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "795f1a275e96f4e848effc3cbd8b85633286efc2"
S = "${WORKDIR}/git"
