...
# matches with: https://github.com/ros2-gbp/cartographer_ros-release/archive/release/galactic/cartographer_ros/1.0.9003-4.tar.gz
ROS_BRANCH ?= "branch=release/galactic/cartographer_ros"
SRC_URI = "git://github.com/ros2-gbp/cartographer_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "07bb6a6fa729e519d84dcdcb7e7187c0704bbdd6"
S = "${WORKDIR}/git"
