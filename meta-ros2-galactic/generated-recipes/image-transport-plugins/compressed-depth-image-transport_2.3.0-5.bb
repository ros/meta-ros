...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/galactic/compressed_depth_image_transport/2.3.0-5.tar.gz
...
SRCREV = "1770686f64d327bddbfc2d8be07b0cab53d758a8"
S = "${WORKDIR}/git"
