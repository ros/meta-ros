...
# matches with: https://github.com/pal-gbp/backward_ros-release/archive/release/galactic/backward_ros/1.0.1-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/backward_ros"
SRC_URI = "git://github.com/pal-gbp/backward_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "0fd12e7f11ca11803fd5f0b2a6da0e39315171fe"
S = "${WORKDIR}/git"
