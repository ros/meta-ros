...
# matches with: https://github.com/SBG-Systems/sbg_ros2-release/archive/release/galactic/sbg_driver/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/sbg_driver"
SRC_URI = "git://github.com/SBG-Systems/sbg_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "64a49b7eede4dc85818fd74d6dde976d84121b59"
S = "${WORKDIR}/git"
