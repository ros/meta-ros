...
# matches with: https://github.com/ros2-gbp/micro_ros_msgs-release/archive/release/galactic/micro_ros_msgs/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/micro_ros_msgs"
SRC_URI = "git://github.com/ros2-gbp/micro_ros_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "f02433eba29d5c484f48f8d2bfe119c50e1a2df8"
S = "${WORKDIR}/git"
