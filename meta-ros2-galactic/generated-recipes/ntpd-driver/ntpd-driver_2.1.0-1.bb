...
# matches with: https://github.com/vooon/ntpd_driver-release/archive/release/galactic/ntpd_driver/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ntpd_driver"
SRC_URI = "git://github.com/vooon/ntpd_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "dff755d9e13b678b05c6cad8aaa2f3304c1a45b7"
S = "${WORKDIR}/git"
