...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/galactic/examples_rclpy_minimal_action_client/0.11.2-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/examples_rclpy_minimal_action_client"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "6e2c08c238f675bfa9841f6243a4aeca3412b1a9"
S = "${WORKDIR}/git"
