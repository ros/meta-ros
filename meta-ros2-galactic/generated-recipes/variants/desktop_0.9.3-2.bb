...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/galactic/desktop/0.9.3-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/desktop"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "61b46551988823b4d7d436107b3c98032fe6ea44"
S = "${WORKDIR}/git"
