...
# matches with: https://github.com/ros2-gbp/cartographer-release/archive/release/galactic/cartographer/1.0.9001-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/cartographer"
SRC_URI = "git://github.com/ros2-gbp/cartographer-release;${ROS_BRANCH};protocol=https"
SRCREV = "8c52023a2be52dc519245d335ea3023c44aa7af0"
S = "${WORKDIR}/git"
