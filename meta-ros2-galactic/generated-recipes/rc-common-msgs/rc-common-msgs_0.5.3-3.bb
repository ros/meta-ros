...
# matches with: https://github.com/ros2-gbp/rc_common_msgs_ros2-release/archive/release/galactic/rc_common_msgs/0.5.3-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rc_common_msgs"
SRC_URI = "git://github.com/ros2-gbp/rc_common_msgs_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8cc5885e15539290c45e6e91a1336f2f8b7f7755"
S = "${WORKDIR}/git"
