...
# matches with: https://github.com/ros2-gbp/ros_testing-release/archive/release/galactic/ros_testing/0.3.0-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ros_testing"
SRC_URI = "git://github.com/ros2-gbp/ros_testing-release;${ROS_BRANCH};protocol=https"
SRCREV = "e83a470c30ad33c19b4bddeed869bb85ccdce6e8"
S = "${WORKDIR}/git"
