...
# matches with: https://github.com/ros2-gbp/python_cmake_module-release/archive/release/galactic/python_cmake_module/0.8.1-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/python_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/python_cmake_module-release;${ROS_BRANCH};protocol=https"
SRCREV = "4c51d2a0206e7908c6573c04afa5e442ee44cd20"
S = "${WORKDIR}/git"
