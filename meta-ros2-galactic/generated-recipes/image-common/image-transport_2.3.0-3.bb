...
# matches with: https://github.com/ros2-gbp/image_common-release/archive/release/galactic/image_transport/2.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/image_transport"
SRC_URI = "git://github.com/ros2-gbp/image_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "5c543d1fbaa799ccab2c1d7b0aad3d0c613afc9b"
S = "${WORKDIR}/git"
