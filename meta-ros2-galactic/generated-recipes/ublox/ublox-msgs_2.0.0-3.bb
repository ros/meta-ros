...
# matches with: https://github.com/ros2-gbp/ublox-release/archive/release/galactic/ublox_msgs/2.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ublox_msgs"
SRC_URI = "git://github.com/ros2-gbp/ublox-release;${ROS_BRANCH};protocol=https"
SRCREV = "42b6b7efbd3202fffb304ec2947a32e63b48f554"
S = "${WORKDIR}/git"
