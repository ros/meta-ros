...
# matches with: https://github.com/ros2-gbp/vision_opencv-release/archive/release/galactic/image_geometry/2.2.1-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/image_geometry"
SRC_URI = "git://github.com/ros2-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "49cafe5d5ddc85f470420a4102006c273b1c91f4"
S = "${WORKDIR}/git"
