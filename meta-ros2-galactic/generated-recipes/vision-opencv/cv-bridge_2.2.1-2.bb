...
# matches with: https://github.com/ros2-gbp/vision_opencv-release/archive/release/galactic/cv_bridge/2.2.1-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/cv_bridge"
SRC_URI = "git://github.com/ros2-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "73d009a52c631d1cb6d39faca1cabacb4132701d"
S = "${WORKDIR}/git"
