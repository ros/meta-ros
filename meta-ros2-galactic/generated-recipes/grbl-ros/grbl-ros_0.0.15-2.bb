...
# matches with: https://github.com/ros2-gbp/grbl_ros-release/archive/release/galactic/grbl_ros/0.0.15-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/grbl_ros"
SRC_URI = "git://github.com/ros2-gbp/grbl_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "6fe01bfa9e3feaae8acf4f7ccd47b4693d7e6d4b"
S = "${WORKDIR}/git"
