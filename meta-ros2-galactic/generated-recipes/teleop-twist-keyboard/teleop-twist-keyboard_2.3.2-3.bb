...
# matches with: https://github.com/ros2-gbp/teleop_twist_keyboard-release/archive/release/galactic/teleop_twist_keyboard/2.3.2-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/teleop_twist_keyboard"
SRC_URI = "git://github.com/ros2-gbp/teleop_twist_keyboard-release;${ROS_BRANCH};protocol=https"
SRCREV = "07b976f58ca0bf351026e5a6afbb0e699563e535"
S = "${WORKDIR}/git"
