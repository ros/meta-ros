...
# matches with: https://github.com/ros2-gbp/rcl_logging-release/archive/release/galactic/rcl_logging_log4cxx/2.1.2-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rcl_logging_log4cxx"
SRC_URI = "git://github.com/ros2-gbp/rcl_logging-release;${ROS_BRANCH};protocol=https"
SRCREV = "3d4655538e5d663a69db1e73f94ecd4ad0eeec4b"
S = "${WORKDIR}/git"
