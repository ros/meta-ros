...
# matches with: https://github.com/robotis-ros2-release/hls_lfcd_lds_driver-release/archive/release/galactic/hls_lfcd_lds_driver/2.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/hls_lfcd_lds_driver"
SRC_URI = "git://github.com/robotis-ros2-release/hls_lfcd_lds_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "b34826fc6cd0ab3e8923dfe4e579324c457ee0ee"
S = "${WORKDIR}/git"
