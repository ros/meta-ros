...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/galactic/bond/3.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/galactic/bond"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "d91760995a212adb731081ade1cad2c2019a1360"
S = "${WORKDIR}/git"
