...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/galactic/test_bond/3.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/galactic/test_bond"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "997cdbfa3a66a7cec253c6e1e9e7bedc165c5266"
S = "${WORKDIR}/git"
