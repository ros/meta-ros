...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/galactic/bond_core/3.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/galactic/bond_core"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "4ad6ae87cf7dea6571f40c23a85975d7d6135d8d"
S = "${WORKDIR}/git"
