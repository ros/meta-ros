...
# matches with: https://github.com/astuff/automotive_autonomy_msgs-release/archive/release/galactic/automotive_navigation_msgs/3.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/automotive_navigation_msgs"
SRC_URI = "git://github.com/astuff/automotive_autonomy_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "857f2bfbe4739d0be18d2af04c84274308bcc677"
S = "${WORKDIR}/git"
