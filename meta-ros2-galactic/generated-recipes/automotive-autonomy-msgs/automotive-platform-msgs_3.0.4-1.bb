...
# matches with: https://github.com/astuff/automotive_autonomy_msgs-release/archive/release/galactic/automotive_platform_msgs/3.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/automotive_platform_msgs"
SRC_URI = "git://github.com/astuff/automotive_autonomy_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "0cf00b89e76713b65a19bab91df33ead41376144"
S = "${WORKDIR}/git"
