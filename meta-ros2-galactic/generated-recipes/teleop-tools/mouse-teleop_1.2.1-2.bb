...
# matches with: https://github.com/ros2-gbp/teleop_tools-release/archive/release/galactic/mouse_teleop/1.2.1-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/mouse_teleop"
SRC_URI = "git://github.com/ros2-gbp/teleop_tools-release;${ROS_BRANCH};protocol=https"
SRCREV = "be8e74d228bf1fe9e1672835dc1abfbdcfaebf36"
S = "${WORKDIR}/git"
