...
# matches with: https://github.com/ros2-gbp/joint_state_publisher-release/archive/release/galactic/joint_state_publisher_gui/2.2.0-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/joint_state_publisher_gui"
SRC_URI = "git://github.com/ros2-gbp/joint_state_publisher-release;${ROS_BRANCH};protocol=https"
SRCREV = "2116eb9e3674b4c71878ffb743bc7115c258859b"
S = "${WORKDIR}/git"
