...
# matches with: https://github.com/ros2-gbp/joint_state_publisher-release/archive/release/galactic/joint_state_publisher/2.2.0-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/joint_state_publisher"
SRC_URI = "git://github.com/ros2-gbp/joint_state_publisher-release;${ROS_BRANCH};protocol=https"
SRCREV = "564ef77742afbea647cc85bf4bdd69ee1ea7284c"
S = "${WORKDIR}/git"
