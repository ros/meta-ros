...
# matches with: https://github.com/ros2-gbp/rosidl_python-release/archive/release/galactic/rosidl_generator_py/0.11.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rosidl_generator_py"
SRC_URI = "git://github.com/ros2-gbp/rosidl_python-release;${ROS_BRANCH};protocol=https"
SRCREV = "b69d9cd6e9cfa7de82ff040cc6b757df32e6d0fc"
S = "${WORKDIR}/git"
