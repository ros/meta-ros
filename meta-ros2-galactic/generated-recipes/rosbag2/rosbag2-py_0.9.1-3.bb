...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/galactic/rosbag2_py/0.9.1-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rosbag2_py"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "4889ac5e40c5142368b2757f1d1939b317282d27"
S = "${WORKDIR}/git"
