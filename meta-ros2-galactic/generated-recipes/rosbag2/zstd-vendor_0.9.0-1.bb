...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/galactic/zstd_vendor/0.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/zstd_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "08f993b392682fcc64c8203ef65cc8460c9dd91c"
S = "${WORKDIR}/git"
