...
# matches with: https://github.com/DLu/tf_transformations_release/archive/release/galactic/tf_transformations/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/tf_transformations"
SRC_URI = "git://github.com/DLu/tf_transformations_release;${ROS_BRANCH};protocol=https"
SRCREV = "ffabf29191320df6b21fbde24877e49cb406acf5"
S = "${WORKDIR}/git"
