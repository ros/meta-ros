...
# matches with: https://github.com/ros2-gbp/example_interfaces-release/archive/release/galactic/example_interfaces/0.9.2-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/example_interfaces"
SRC_URI = "git://github.com/ros2-gbp/example_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "b2cb2fd441b0b2fe8e9c6640004302a2c784f35a"
S = "${WORKDIR}/git"
