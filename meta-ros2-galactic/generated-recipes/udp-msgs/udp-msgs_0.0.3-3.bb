...
# matches with: https://github.com/ros2-gbp/udp_msgs-release/archive/release/galactic/udp_msgs/0.0.3-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/udp_msgs"
SRC_URI = "git://github.com/ros2-gbp/udp_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "5d5fd3e4f62d428cc67a0b0c00201525bf931e60"
S = "${WORKDIR}/git"
