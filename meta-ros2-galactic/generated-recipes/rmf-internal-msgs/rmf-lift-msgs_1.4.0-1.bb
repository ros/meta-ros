...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/galactic/rmf_lift_msgs/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rmf_lift_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "4096a0d1ced937478b5c33b78c74c104f4e86a5d"
S = "${WORKDIR}/git"
