...
# matches with: https://github.com/ros2-gbp/ifm3d-release/archive/release/galactic/ifm3d_core/0.18.0-6.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ifm3d_core"
SRC_URI = "git://github.com/ros2-gbp/ifm3d-release;${ROS_BRANCH};protocol=https"
SRCREV = "ce62465681258d97b34d0c114c45e8d022e5cf2f"
S = "${WORKDIR}/git"
