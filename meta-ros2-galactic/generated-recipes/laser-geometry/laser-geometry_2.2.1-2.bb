...
# matches with: https://github.com/ros2-gbp/laser_geometry-release/archive/release/galactic/laser_geometry/2.2.1-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/laser_geometry"
SRC_URI = "git://github.com/ros2-gbp/laser_geometry-release;${ROS_BRANCH};protocol=https"
SRCREV = "4bc51213f820492ab47bd9c750b9d91b12efae01"
S = "${WORKDIR}/git"
