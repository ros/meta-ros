...
# matches with: https://github.com/ros2-gbp/ros_workspace-release/archive/release/galactic/ros_workspace/1.0.2-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ros_workspace"
SRC_URI = "git://github.com/ros2-gbp/ros_workspace-release;${ROS_BRANCH};protocol=https"
SRCREV = "a9fc13ea3577c20a68f1c83b9c5181f9347b909f"
S = "${WORKDIR}/git"
