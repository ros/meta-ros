...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/galactic/rviz_ogre_vendor/8.5.0-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "95429f3b04df736f252355e0be095a596d58f013"
S = "${WORKDIR}/git"
