...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/galactic/rviz_assimp_vendor/8.5.0-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rviz_assimp_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "7c27c653011185a98b4984493145026330764cfb"
S = "${WORKDIR}/git"
