...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/galactic/ros_ign/0.233.2-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ros_ign"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "d921721c0b90383544df30d1c11d5b162546acdd"
S = "${WORKDIR}/git"
