...
# matches with: https://github.com/moveit/warehouse_ros_mongo-release/archive/release/galactic/warehouse_ros_mongo/2.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/warehouse_ros_mongo"
SRC_URI = "git://github.com/moveit/warehouse_ros_mongo-release;${ROS_BRANCH};protocol=https"
SRCREV = "d3ceba81e770784f88ac6e80d781ba7fdbacb43c"
S = "${WORKDIR}/git"
