...
# matches with: https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/galactic/rmw_fastrtps_dynamic_cpp/5.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rmw_fastrtps_dynamic_cpp"
SRC_URI = "git://github.com/ros2-gbp/rmw_fastrtps-release;${ROS_BRANCH};protocol=https"
SRCREV = "de61d6bfe75c06f555b177d1f62cb097735dbf82"
S = "${WORKDIR}/git"
