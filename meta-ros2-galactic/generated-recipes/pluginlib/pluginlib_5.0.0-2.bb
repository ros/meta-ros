...
# matches with: https://github.com/ros2-gbp/pluginlib-release/archive/release/galactic/pluginlib/5.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/pluginlib"
SRC_URI = "git://github.com/ros2-gbp/pluginlib-release;${ROS_BRANCH};protocol=https"
SRCREV = "4ee712c6deecceb898e6ceb892c96cb59d4ade4d"
S = "${WORKDIR}/git"
