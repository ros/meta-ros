...
# matches with: https://github.com/ros2-gbp/ament_cmake_catch2-release/archive/release/galactic/ament_cmake_catch2/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ament_cmake_catch2"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake_catch2-release;${ROS_BRANCH};protocol=https"
SRCREV = "de193d2e744817e6744f41d174a76eb519f2fb7d"
S = "${WORKDIR}/git"
