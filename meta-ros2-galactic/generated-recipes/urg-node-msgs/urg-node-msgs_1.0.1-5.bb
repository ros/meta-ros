...
# matches with: https://github.com/ros2-gbp/urg_node_msgs-release/archive/release/galactic/urg_node_msgs/1.0.1-5.tar.gz
ROS_BRANCH ?= "branch=release/galactic/urg_node_msgs"
SRC_URI = "git://github.com/ros2-gbp/urg_node_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "2db5cd7f7734bb75a5ce5c6a2e4481290b02bc56"
S = "${WORKDIR}/git"
