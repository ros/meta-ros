...
# matches with: https://github.com/ros2-gbp/grbl_msgs-release/archive/release/galactic/grbl_msgs/0.0.2-5.tar.gz
ROS_BRANCH ?= "branch=release/galactic/grbl_msgs"
SRC_URI = "git://github.com/ros2-gbp/grbl_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "1a53ac4f537a29255ff249769a2dcfefb47432be"
S = "${WORKDIR}/git"
