...
# matches with: https://github.com/ros2-gbp/pointcloud_to_laserscan-release/archive/release/galactic/pointcloud_to_laserscan/2.0.1-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/pointcloud_to_laserscan"
SRC_URI = "git://github.com/ros2-gbp/pointcloud_to_laserscan-release;${ROS_BRANCH};protocol=https"
SRCREV = "a10d7e2c93303314457d94ab57b102192173fe08"
S = "${WORKDIR}/git"
