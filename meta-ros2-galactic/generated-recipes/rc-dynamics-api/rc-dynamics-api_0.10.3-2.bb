...
# matches with: https://github.com/ros2-gbp/rc_dynamics_api-release/archive/release/galactic/rc_dynamics_api/0.10.3-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rc_dynamics_api"
SRC_URI = "git://github.com/ros2-gbp/rc_dynamics_api-release;${ROS_BRANCH};protocol=https"
SRCREV = "3cd9863a126446aa5f9a5b1c7762775ae6e1e0fe"
S = "${WORKDIR}/git"
