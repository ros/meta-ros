...
# matches with: https://github.com/moveit/moveit_resources-release/archive/release/galactic/moveit_resources_fanuc_moveit_config/2.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/moveit_resources_fanuc_moveit_config"
SRC_URI = "git://github.com/moveit/moveit_resources-release;${ROS_BRANCH};protocol=https"
SRCREV = "7a4071246a617a376cba38639eeb10bdcc54a10b"
S = "${WORKDIR}/git"
