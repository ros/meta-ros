...
# matches with: https://github.com/ros2-gbp/ros_canopen-release/archive/release/galactic/can_msgs/2.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/can_msgs"
SRC_URI = "git://github.com/ros2-gbp/ros_canopen-release;${ROS_BRANCH};protocol=https"
SRCREV = "50f0ded5a61a0b3db2f6ead7325100a7f16f4f8b"
S = "${WORKDIR}/git"
