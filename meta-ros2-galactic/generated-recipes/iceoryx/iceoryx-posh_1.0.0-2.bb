...
# matches with: https://github.com/ros2-gbp/iceoryx-release/archive/release/galactic/iceoryx_posh/1.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/iceoryx_posh"
SRC_URI = "git://github.com/ros2-gbp/iceoryx-release;${ROS_BRANCH};protocol=https"
SRCREV = "d17617220ea6cc0df6a4f9360fe6deb844a4ba31"
S = "${WORKDIR}/git"
