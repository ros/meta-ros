...
# matches with: https://github.com/ros2-gbp/rqt_image_view-release/archive/release/galactic/rqt_image_view/1.1.1-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rqt_image_view"
SRC_URI = "git://github.com/ros2-gbp/rqt_image_view-release;${ROS_BRANCH};protocol=https"
SRCREV = "fae4cc145de30ff2fceee84d6d6e5cedb8c3eba9"
S = "${WORKDIR}/git"
