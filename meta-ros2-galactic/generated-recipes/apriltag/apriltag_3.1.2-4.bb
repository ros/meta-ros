...
# matches with: https://github.com/ros2-gbp/apriltag-release/archive/release/galactic/apriltag/3.1.2-4.tar.gz
ROS_BRANCH ?= "branch=release/galactic/apriltag"
SRC_URI = "git://github.com/ros2-gbp/apriltag-release;${ROS_BRANCH};protocol=https"
SRCREV = "181fe5b201a46721505221c75bcceba844147eaf"
S = "${WORKDIR}/git"
