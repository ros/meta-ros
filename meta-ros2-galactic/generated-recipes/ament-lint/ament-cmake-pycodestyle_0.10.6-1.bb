...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/galactic/ament_cmake_pycodestyle/0.10.6-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ament_cmake_pycodestyle"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "0fe2978ea6ab1ac8dbc268a0effc56a102016cdc"
S = "${WORKDIR}/git"
