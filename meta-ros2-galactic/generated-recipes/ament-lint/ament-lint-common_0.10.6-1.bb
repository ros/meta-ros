...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/galactic/ament_lint_common/0.10.6-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ament_lint_common"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "cf79d73e6acf1e65ef8bb0e94857b0038aca93a8"
S = "${WORKDIR}/git"
