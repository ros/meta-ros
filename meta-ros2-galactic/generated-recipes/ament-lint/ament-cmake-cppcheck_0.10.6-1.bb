...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/galactic/ament_cmake_cppcheck/0.10.6-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ament_cmake_cppcheck"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "f125cc76640f0818a50082c4a6e232d3f267796a"
S = "${WORKDIR}/git"
