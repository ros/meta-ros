...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/galactic/ament_clang_tidy/0.10.6-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ament_clang_tidy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "359753030d88c783dd714fe0f56c5a605d0fccb5"
S = "${WORKDIR}/git"
