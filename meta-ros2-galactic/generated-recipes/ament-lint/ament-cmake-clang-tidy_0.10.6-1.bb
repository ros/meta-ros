...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/galactic/ament_cmake_clang_tidy/0.10.6-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ament_cmake_clang_tidy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "9a56852c8eb6e6385d5f6d68fdb84eaa880e56df"
S = "${WORKDIR}/git"
