...
# matches with: https://github.com/mavlink/mavros-release/archive/release/galactic/libmavconn/2.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/libmavconn"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "82d8a9b0ee38dd267fa92de6160a2d52fbc541c4"
S = "${WORKDIR}/git"
