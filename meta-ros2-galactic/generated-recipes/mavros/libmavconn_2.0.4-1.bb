...
# matches with: https://github.com/mavlink/mavros-release/archive/release/galactic/libmavconn/2.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/libmavconn"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "d74074c9e0f23be72e14b9f29dff0e0e80b854ea"
S = "${WORKDIR}/git"
