...
# matches with: https://github.com/moveit/moveit2-release/archive/release/galactic/run_move_group/2.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/run_move_group"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "92853dd132a532ca3bb589102b5554878689df53"
S = "${WORKDIR}/git"
