...
# matches with: https://github.com/moveit/moveit2-release/archive/release/galactic/moveit_ros/2.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/moveit_ros"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "ccf73da5ef776456190cafbc89bd4ccbb47dc37c"
S = "${WORKDIR}/git"
