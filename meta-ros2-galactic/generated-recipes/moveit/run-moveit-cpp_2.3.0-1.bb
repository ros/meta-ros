...
# matches with: https://github.com/moveit/moveit2-release/archive/release/galactic/run_moveit_cpp/2.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/run_moveit_cpp"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e877826b5a1c7b4c8691aec00128466b1ffbc4a3"
S = "${WORKDIR}/git"
