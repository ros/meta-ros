...
# matches with: https://github.com/moveit/moveit2-release/archive/release/galactic/moveit_core/2.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/moveit_core"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "26b62cc922e653718017e3180a47f42819e42850"
S = "${WORKDIR}/git"
