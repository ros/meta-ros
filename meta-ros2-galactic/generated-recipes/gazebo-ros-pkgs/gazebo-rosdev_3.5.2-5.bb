...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/galactic/gazebo_dev/3.5.2-5.tar.gz
ROS_BRANCH ?= "branch=release/galactic/gazebo_dev"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "79736944bbfdc9f5c649d651c6e469d3c08526b4"
S = "${WORKDIR}/git"
