...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/galactic/gazebo_plugins/3.5.2-5.tar.gz
ROS_BRANCH ?= "branch=release/galactic/gazebo_plugins"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "ae6eb8edd98e86849200d2924dc938c7b27f3bad"
S = "${WORKDIR}/git"
