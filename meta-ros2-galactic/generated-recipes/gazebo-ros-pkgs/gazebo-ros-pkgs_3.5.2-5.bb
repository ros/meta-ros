...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/galactic/gazebo_ros_pkgs/3.5.2-5.tar.gz
ROS_BRANCH ?= "branch=release/galactic/gazebo_ros_pkgs"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "1c3781080247f7302e932d755096eb4a6ed142ff"
S = "${WORKDIR}/git"
