...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/galactic/gazebo_ros/3.5.2-5.tar.gz
ROS_BRANCH ?= "branch=release/galactic/gazebo_ros"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "3eba359c4a0f6eb21ce9127020595a50dbb7a567"
S = "${WORKDIR}/git"
