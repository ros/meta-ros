...
# matches with: https://github.com/ros2-gbp/image_pipeline-release/archive/release/galactic/image_view/2.2.1-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/image_view"
SRC_URI = "git://github.com/ros2-gbp/image_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "d714b652f837058ab3b2228a79fc71196fe8d9bd"
S = "${WORKDIR}/git"
