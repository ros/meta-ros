...
# matches with: https://github.com/ros2-gbp/rmf_cmake_uncrustify-release/archive/release/galactic/rmf_cmake_uncrustify/1.2.0-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rmf_cmake_uncrustify"
SRC_URI = "git://github.com/ros2-gbp/rmf_cmake_uncrustify-release;${ROS_BRANCH};protocol=https"
SRCREV = "2dbc38b416eddb9422b1060dbd6c39cc5c3efa32"
S = "${WORKDIR}/git"
