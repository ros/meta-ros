...
# matches with: https://github.com/ros2-gbp/geographic_info-release/archive/release/galactic/geographic_info/1.0.4-5.tar.gz
ROS_BRANCH ?= "branch=release/galactic/geographic_info"
SRC_URI = "git://github.com/ros2-gbp/geographic_info-release;${ROS_BRANCH};protocol=https"
SRCREV = "4929e80828ca5d48e4fe7d22c0b8bc368cbb18ae"
S = "${WORKDIR}/git"
