...
# matches with: https://github.com/ros2-gbp/rqt-release/archive/release/galactic/rqt_py_common/1.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rqt_py_common"
SRC_URI = "git://github.com/ros2-gbp/rqt-release;${ROS_BRANCH};protocol=https"
SRCREV = "2eae5e03a824dae5bfe6948292590f0d3139288d"
S = "${WORKDIR}/git"
