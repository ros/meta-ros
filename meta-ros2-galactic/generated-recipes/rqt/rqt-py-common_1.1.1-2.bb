...
# matches with: https://github.com/ros2-gbp/rqt-release/archive/release/galactic/rqt_py_common/1.1.1-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rqt_py_common"
SRC_URI = "git://github.com/ros2-gbp/rqt-release;${ROS_BRANCH};protocol=https"
SRCREV = "b73734b259c3161be2d9ccc70ef8c47633caafdf"
S = "${WORKDIR}/git"
