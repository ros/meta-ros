...
# matches with: https://github.com/ros2-gbp/eigen3_cmake_module-release/archive/release/galactic/eigen3_cmake_module/0.1.1-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/eigen3_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/eigen3_cmake_module-release;${ROS_BRANCH};protocol=https"
SRCREV = "453b06b1f46bca67b88508360f202d144ed941b4"
S = "${WORKDIR}/git"
