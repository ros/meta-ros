...
# matches with: https://github.com/ros-gbp/octomap-release/archive/release/galactic/dynamic_edt_3d/1.9.7-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/dynamic_edt_3d"
SRC_URI = "git://github.com/ros-gbp/octomap-release;${ROS_BRANCH};protocol=https"
SRCREV = "14636ea5efc393d95eddb557c327d7b16ddf713c"
S = "${WORKDIR}/git"
