...
# matches with: https://github.com/ros2-gbp/eigen_stl_containers-release/archive/release/galactic/eigen_stl_containers/1.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/galactic/eigen_stl_containers"
SRC_URI = "git://github.com/ros2-gbp/eigen_stl_containers-release;${ROS_BRANCH};protocol=https"
SRCREV = "1d3fb85eacd488c4bb9a3c188328a2131961162c"
S = "${WORKDIR}/git"
