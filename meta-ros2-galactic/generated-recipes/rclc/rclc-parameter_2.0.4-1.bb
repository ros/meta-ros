...
# matches with: https://github.com/ros2-gbp/rclc-release/archive/release/galactic/rclc_parameter/2.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rclc_parameter"
SRC_URI = "git://github.com/ros2-gbp/rclc-release;${ROS_BRANCH};protocol=https"
SRCREV = "0f52b4d65cbcb9bd29876ddbde48104e2abb259b"
S = "${WORKDIR}/git"
