...
# matches with: https://github.com/ros2-gbp/async_web_server_cpp-release/archive/release/galactic/async_web_server_cpp/2.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/galactic/async_web_server_cpp"
SRC_URI = "git://github.com/ros2-gbp/async_web_server_cpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "b1741f4116aa206fc5273beb5b601af1321380e1"
S = "${WORKDIR}/git"
