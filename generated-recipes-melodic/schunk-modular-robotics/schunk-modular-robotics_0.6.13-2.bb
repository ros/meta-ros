...
SRC_URI = "https://github.com/ipa320/schunk_modular_robotics-release/archive/release/melodic/schunk_modular_robotics/0.6.13-2.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
