...
SRC_URI = "https://github.com/ipa320/cob_perception_common-release/archive/release/melodic/cob_perception_msgs/0.6.14-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
