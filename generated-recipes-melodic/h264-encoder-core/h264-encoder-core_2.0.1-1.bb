...
SRC_URI = "https://github.com/aws-gbp/h264_encoder_core-release/archive/release/melodic/h264_encoder_core/2.0.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "3fd9248f758713236d980934c7387c55"
SRC_URI[sha256sum] = "dbc4f911dc13d008b82e2ecc282975e2579061533d77738d5611e8abff285319"
S = "${WORKDIR}/h264_encoder_core-release-release-melodic-h264_encoder_core-2.0.1-1"
