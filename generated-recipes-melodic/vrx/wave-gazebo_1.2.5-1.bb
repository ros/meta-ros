...
SRC_URI = "https://github.com/ros-gbp/vrx-release/archive/release/melodic/wave_gazebo/1.2.5-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "94d3c3d6207ffcda45aa04aca3ba2d44"
SRC_URI[sha256sum] = "3cbf2802ad349908a6ececec9fb767fe57115d496069b0a4c3305fb341c0380f"
S = "${WORKDIR}/vrx-release-release-melodic-wave_gazebo-1.2.5-1"
