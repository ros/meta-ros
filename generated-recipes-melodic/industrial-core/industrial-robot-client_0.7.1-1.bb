...
SRC_URI = "https://github.com/ros-industrial-release/industrial_core-release/archive/release/melodic/industrial_robot_client/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
