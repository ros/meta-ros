...
SRC_URI = "https://github.com/roboception-gbp/rc_dynamics_api-release/archive/release/melodic/rc_dynamics_api/0.10.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
