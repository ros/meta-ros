...
SRC_URI = "https://github.com/rst-tu-dortmund/teb_local_planner-release/archive/release/melodic/teb_local_planner/0.8.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
