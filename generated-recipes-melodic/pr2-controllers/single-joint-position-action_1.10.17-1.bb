...
SRC_URI = "https://github.com/pr2-gbp/pr2_controllers-release/archive/release/melodic/single_joint_position_action/1.10.17-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
