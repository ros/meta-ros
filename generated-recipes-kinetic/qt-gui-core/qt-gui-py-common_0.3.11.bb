...
SRC_URI = "https://github.com/ros-gbp/qt_gui_core-release/archive/release/kinetic/qt_gui_py_common/0.3.11-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "eff75d3656bf3ee41998df3edf74591d"
SRC_URI[sha256sum] = "c227fd0e113edc63bc1e82b609e8ece3828111856fda0837236548746bdf78b4"
S = "${WORKDIR}/qt_gui_core-release-release-kinetic-qt_gui_py_common-0.3.11-0"
