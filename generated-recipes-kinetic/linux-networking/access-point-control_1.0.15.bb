...
SRC_URI = "https://github.com/pr2-gbp/linux_networking-release/archive/release/kinetic/access_point_control/1.0.15-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d721d8b49f142c2a331ab1e7965d1a80"
SRC_URI[sha256sum] = "8373f805c0200dcd6b516082f486463211cafe0494573e578fe6c4c03121849e"
S = "${WORKDIR}/linux_networking-release-release-kinetic-access_point_control-1.0.15-0"
