...
SRC_URI = "https://github.com/pr2-gbp/linux_networking-release/archive/release/kinetic/network_traffic_control/1.0.15-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "47887182dbb277597b311e20fd96c574"
SRC_URI[sha256sum] = "ad9a62ac1231a0bdacd6112805d018ce5d3d654682918794704d70b4ea619b2f"
S = "${WORKDIR}/linux_networking-release-release-kinetic-network_traffic_control-1.0.15-0"
