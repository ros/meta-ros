...
SRC_URI = "https://github.com/pr2-gbp/linux_networking-release/archive/release/kinetic/network_control_tests/1.0.15-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "fdfd08358be913cab7365ce7c3dde15a"
SRC_URI[sha256sum] = "d88b347e5713476cbc43f1c5935d2749107992c9acaa159ae9a8bb46f9df1dac"
S = "${WORKDIR}/linux_networking-release-release-kinetic-network_control_tests-1.0.15-0"
