...
SRC_URI = "https://github.com/ros-industrial-release/universal_robot-release/archive/release/kinetic/ur3_e_moveit_config/1.2.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a5e601d7ed00de4301cb2a18603df8e4"
SRC_URI[sha256sum] = "bc05a74ccb49fa20a4c42d8c9c58656db54e33a06fe40e125a4e7496125f41f0"
S = "${WORKDIR}/universal_robot-release-release-kinetic-ur3_e_moveit_config-1.2.6-1"
