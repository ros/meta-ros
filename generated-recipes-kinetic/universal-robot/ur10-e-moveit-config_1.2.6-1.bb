...
SRC_URI = "https://github.com/ros-industrial-release/universal_robot-release/archive/release/kinetic/ur10_e_moveit_config/1.2.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "faa428bac8ce06846f534c3e7a169eaa"
SRC_URI[sha256sum] = "0907c383969439c2bf9727fac54b50a65d645b9bd8ce215c8cbc991197277241"
S = "${WORKDIR}/universal_robot-release-release-kinetic-ur10_e_moveit_config-1.2.6-1"
