...
SRC_URI = "https://github.com/DataspeedInc-release/dbw_fca_ros-release/archive/release/kinetic/dbw_fca_description/1.0.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "dd2b790ad7254af8af87d7aed5e92b57"
SRC_URI[sha256sum] = "b14ced68b05aaca8520ed8ffc546e23725e677d21e661ba5ab842e92f49370ca"
S = "${WORKDIR}/dbw_fca_ros-release-release-kinetic-dbw_fca_description-1.0.6-1"
