...
SRC_URI = "https://github.com/DataspeedInc-release/dbw_fca_ros-release/archive/release/kinetic/dbw_fca_can/1.0.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "17f6dc01f84dd6203ca549b9a441e927"
SRC_URI[sha256sum] = "53bd2a513e1af517bf5c2226484896c1717304cd27d0b1e1ee031e1b3ed72eb0"
S = "${WORKDIR}/dbw_fca_ros-release-release-kinetic-dbw_fca_can-1.0.6-1"
