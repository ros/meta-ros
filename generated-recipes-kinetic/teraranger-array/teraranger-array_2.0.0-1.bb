...
SRC_URI = "https://github.com/Terabee/teraranger_array-release/archive/release/kinetic/teraranger_array/2.0.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "e1ced78778af3c0b5c76e6417d6923d1"
SRC_URI[sha256sum] = "67cef9d3e64f2d16a34522cd17429e9829e5342d6f043fcbf2d4126e15326ebf"
S = "${WORKDIR}/teraranger_array-release-release-kinetic-teraranger_array-2.0.0-1"
