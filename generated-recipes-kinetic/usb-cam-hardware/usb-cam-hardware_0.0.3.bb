...
SRC_URI = "https://github.com/yoshito-n-students/usb_cam_hardware-release/archive/release/kinetic/usb_cam_hardware/0.0.3-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "18961d4f10757b7e638e37e9ecc09d87"
SRC_URI[sha256sum] = "e7cdc34a962eb471e116d8cda31ab920b9422588d0b5b971090c3003a1cef35f"
S = "${WORKDIR}/usb_cam_hardware-release-release-kinetic-usb_cam_hardware-0.0.3-0"
