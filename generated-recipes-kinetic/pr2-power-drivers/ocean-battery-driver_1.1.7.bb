...
SRC_URI = "https://github.com/pr2-gbp/pr2_power_drivers-release/archive/release/kinetic/ocean_battery_driver/1.1.7-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a844ca38d7f58c19d70ee4e7e338042d"
SRC_URI[sha256sum] = "a222dcefa000b5a33659131ff0657d0704becddd37ad8e7382b69bd7b0e6edb0"
S = "${WORKDIR}/pr2_power_drivers-release-release-kinetic-ocean_battery_driver-1.1.7-0"
