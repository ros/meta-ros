...
SRC_URI = "https://github.com/ros-gbp/navigation_experimental-release/archive/release/kinetic/navigation_experimental/0.2.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "02b4d65576daaa32848e1580d86b24cd"
SRC_URI[sha256sum] = "f832c073d3bcc6a0dae7b1d748bbf52ec6a0842eef1aa82be2c8a9f63c690fe3"
S = "${WORKDIR}/navigation_experimental-release-release-kinetic-navigation_experimental-0.2.2-1"
