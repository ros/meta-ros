...
SRC_URI = "https://github.com/clearpath-gbp/cpr_multimaster_tools-release/archive/release/kinetic/clock_relay/0.0.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "91658aa466c85728cc715cac9dbf89da"
SRC_URI[sha256sum] = "49a8500cdb62580a97141f79c267c0f7e58a847cee017f62e4a706ffed8eb5b3"
S = "${WORKDIR}/cpr_multimaster_tools-release-release-kinetic-clock_relay-0.0.2-1"
