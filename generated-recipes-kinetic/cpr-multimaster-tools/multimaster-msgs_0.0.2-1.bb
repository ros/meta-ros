...
SRC_URI = "https://github.com/clearpath-gbp/cpr_multimaster_tools-release/archive/release/kinetic/multimaster_msgs/0.0.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "39f7db7ef980d3d75b0ad14a769b04f1"
SRC_URI[sha256sum] = "9a0983bf01a81bd3132acae94ccd7b70f8ddfc6381950302d24c5cb098d6e703"
S = "${WORKDIR}/cpr_multimaster_tools-release-release-kinetic-multimaster_msgs-0.0.2-1"
