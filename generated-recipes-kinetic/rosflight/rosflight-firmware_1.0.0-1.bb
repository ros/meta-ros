...
SRC_URI = "https://github.com/rosflight/rosflight-release/archive/release/kinetic/rosflight_firmware/1.0.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "cd1a3db103c495080074f5a9d6a60406"
SRC_URI[sha256sum] = "f67261299a26a7c6a6b69c245e555ddc8efd3621d422e2f7f23fd29ddee21f54"
S = "${WORKDIR}/rosflight-release-release-kinetic-rosflight_firmware-1.0.0-1"
