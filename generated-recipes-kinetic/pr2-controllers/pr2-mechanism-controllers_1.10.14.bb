...
SRC_URI = "https://github.com/pr2-gbp/pr2_controllers-release/archive/release/kinetic/pr2_mechanism_controllers/1.10.14-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "ea8eb750eecd5160d7e3ccc6a0efc47e"
SRC_URI[sha256sum] = "9d2484a38c6db5057f097dec74cbd66a8d8ba01b1c7050f82f16f56f2d77be94"
S = "${WORKDIR}/pr2_controllers-release-release-kinetic-pr2_mechanism_controllers-1.10.14-0"
