...
SRC_URI = "https://github.com/ros-gbp/robot_state_publisher-release/archive/release/kinetic/robot_state_publisher/1.13.7-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "529d4bf835cec04359287393d5b221c8"
SRC_URI[sha256sum] = "23ee023d8854b508f0cd7f1ccceac40a5b68d5f4c7bf898db4db065ac6351e57"
S = "${WORKDIR}/robot_state_publisher-release-release-kinetic-robot_state_publisher-1.13.7-1"
