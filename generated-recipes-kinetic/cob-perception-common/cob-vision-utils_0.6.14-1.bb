...
SRC_URI = "https://github.com/ipa320/cob_perception_common-release/archive/release/kinetic/cob_vision_utils/0.6.14-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "355beb82398a9ac5738aebb0e7eed0b8"
SRC_URI[sha256sum] = "34dc18f3163f53d698ffda477d6cd3e4967ac86346fe5d3081e51df7b8b87874"
S = "${WORKDIR}/cob_perception_common-release-release-kinetic-cob_vision_utils-0.6.14-1"
