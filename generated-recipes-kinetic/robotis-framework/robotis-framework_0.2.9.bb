...
SRC_URI = "https://github.com/ROBOTIS-GIT-release/ROBOTIS-Framework-release/archive/release/kinetic/robotis_framework/0.2.9-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "8b4a5e16696a3acef0279d962000ce67"
SRC_URI[sha256sum] = "06f2dedcbb952add7d87a29faa3eaaf8a13f33a383eb41082d370bc3542a417f"
S = "${WORKDIR}/ROBOTIS-Framework-release-release-kinetic-robotis_framework-0.2.9-0"
