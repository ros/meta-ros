...
SRC_URI = "https://github.com/fetchrobotics-gbp/fetch_gazebo-release/archive/release/kinetic/fetch_gazebo_demo/0.8.2-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2f752d19dba9dce69ce9d21391acd42a"
SRC_URI[sha256sum] = "aef49f304da2d0b29eeb5815a06c2c1132601b3f154f2d78a5d96b00c42e8276"
S = "${WORKDIR}/fetch_gazebo-release-release-kinetic-fetch_gazebo_demo-0.8.2-0"
