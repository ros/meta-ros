...
SRC_URI = "https://github.com/ros-gbp/robot_calibration-release/archive/release/kinetic/robot_calibration_msgs/0.6.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d704729decc9426f34a8975adc033575"
SRC_URI[sha256sum] = "80d6f8cd645f0be2c22fb50486018451453c634f6f149abea05aa1364bd9d10f"
S = "${WORKDIR}/robot_calibration-release-release-kinetic-robot_calibration_msgs-0.6.1-1"
