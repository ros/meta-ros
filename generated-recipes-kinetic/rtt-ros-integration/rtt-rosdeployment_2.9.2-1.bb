...
ROS_AUTHOR = "Jonthan Bohren <jbo@jhu.edu>"
...
SRC_URI = "https://github.com/orocos-gbp/rtt_ros_integration-release/archive/release/kinetic/rtt_rosdeployment/2.9.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "1ad7479a31636f47edb0d7149f5ca48f"
SRC_URI[sha256sum] = "dca3166a5ba8b4b4963643a6b317b3e4c0bf1cd6afd4d94f5376939a72dc7936"
S = "${WORKDIR}/rtt_ros_integration-release-release-kinetic-rtt_rosdeployment-2.9.2-1"
