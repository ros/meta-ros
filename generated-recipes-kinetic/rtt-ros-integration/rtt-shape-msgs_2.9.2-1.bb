...
SRC_URI = "https://github.com/orocos-gbp/rtt_ros_integration-release/archive/release/kinetic/rtt_shape_msgs/2.9.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "60f3a36f10d8551583f089bdcd734a29"
SRC_URI[sha256sum] = "3ffd4307395eb79c62071c191c2473d19162ac6dd1e7be0874013f2d3fc7497f"
S = "${WORKDIR}/rtt_ros_integration-release-release-kinetic-rtt_shape_msgs-2.9.2-1"
