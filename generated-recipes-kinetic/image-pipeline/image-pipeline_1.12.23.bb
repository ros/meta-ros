...
SRC_URI = "https://github.com/ros-gbp/image_pipeline-release/archive/release/kinetic/image_pipeline/1.12.23-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "88c8bd87d85290f03abcf0a0fc7685ea"
SRC_URI[sha256sum] = "9deccdc236c0245bf2422db738fc0a8603f51054df87f4c3c2a030a178945a75"
S = "${WORKDIR}/image_pipeline-release-release-kinetic-image_pipeline-1.12.23-0"
