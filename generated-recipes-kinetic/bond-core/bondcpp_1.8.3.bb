...
SRC_URI = "https://github.com/ros-gbp/bond_core-release/archive/release/kinetic/bondcpp/1.8.3-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "5e040c995141a20a08c9bae44d6e7c25"
SRC_URI[sha256sum] = "169af3f64acf62ecf5dfbfe9e3d26bdf8f5ad36e921ff5a3821c0bb8bd848a9a"
S = "${WORKDIR}/bond_core-release-release-kinetic-bondcpp-1.8.3-0"
