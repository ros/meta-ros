...
SRC_URI = "https://github.com/DataspeedInc-release/dataspeed_pds-release/archive/release/kinetic/dataspeed_pds_scripts/1.0.2-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "93ed7aed792f9976910e1790298f88f8"
SRC_URI[sha256sum] = "aa9fb29eebfa3a402011be03bd2c68d40e57c5574aa5abd02524208170ad7dab"
S = "${WORKDIR}/dataspeed_pds-release-release-kinetic-dataspeed_pds_scripts-1.0.2-0"
