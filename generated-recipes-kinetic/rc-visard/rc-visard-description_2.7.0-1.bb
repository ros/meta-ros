...
SRC_URI = "https://github.com/roboception-gbp/rc_visard-release/archive/release/kinetic/rc_visard_description/2.7.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "01f6483c3d72a54a26d05f49e6ebae55"
SRC_URI[sha256sum] = "a1812fff44cb5f08941e3997fe62f04e1b02015406f481dbd8ca8ff5ec2f1da5"
S = "${WORKDIR}/rc_visard-release-release-kinetic-rc_visard_description-2.7.0-1"
