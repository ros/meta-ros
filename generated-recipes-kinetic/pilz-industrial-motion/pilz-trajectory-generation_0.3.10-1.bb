...
SRC_URI = "https://github.com/PilzDE/pilz_industrial_motion-release/archive/release/kinetic/pilz_trajectory_generation/0.3.10-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "35cea551d9f35f79f3814229824904fe"
SRC_URI[sha256sum] = "bc5f747041bf0602a84bd776966ad11a8d50aee7181be48bff2c762fe8219def"
S = "${WORKDIR}/pilz_industrial_motion-release-release-kinetic-pilz_trajectory_generation-0.3.10-1"
