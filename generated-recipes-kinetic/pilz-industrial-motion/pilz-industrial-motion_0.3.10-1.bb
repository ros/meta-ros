...
SRC_URI = "https://github.com/PilzDE/pilz_industrial_motion-release/archive/release/kinetic/pilz_industrial_motion/0.3.10-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "907cc83b980e1e9a177b6f84caa8fbcc"
SRC_URI[sha256sum] = "f6521ad3538c01a6a671fcb86c4db0a04f3febadfab405518109b8ff186740d3"
S = "${WORKDIR}/pilz_industrial_motion-release-release-kinetic-pilz_industrial_motion-0.3.10-1"
