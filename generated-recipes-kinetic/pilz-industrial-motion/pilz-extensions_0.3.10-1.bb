...
SRC_URI = "https://github.com/PilzDE/pilz_industrial_motion-release/archive/release/kinetic/pilz_extensions/0.3.10-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "bd53a2a1215ea55e8aee15470421b6fe"
SRC_URI[sha256sum] = "b15345cbf6fcc4698bb483c730fc73d63014857f1978d771422ab273662072db"
S = "${WORKDIR}/pilz_industrial_motion-release-release-kinetic-pilz_extensions-0.3.10-1"
