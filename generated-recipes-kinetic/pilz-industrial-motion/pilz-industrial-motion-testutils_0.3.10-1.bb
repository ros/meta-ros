...
SRC_URI = "https://github.com/PilzDE/pilz_industrial_motion-release/archive/release/kinetic/pilz_industrial_motion_testutils/0.3.10-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9df1ae552a9dcae40a916bb8e7bafd35"
SRC_URI[sha256sum] = "50907af1ea26773568a750578dfd816052d2f6d995d0199445b40fd703cfbefe"
S = "${WORKDIR}/pilz_industrial_motion-release-release-kinetic-pilz_industrial_motion_testutils-0.3.10-1"
