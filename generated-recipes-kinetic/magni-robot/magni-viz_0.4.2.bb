...
SRC_URI = "https://github.com/UbiquityRobotics-release/magni_robot-release/archive/release/kinetic/magni_viz/0.4.2-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2377fa14ec32c75baf1b3d6ac4b6071d"
SRC_URI[sha256sum] = "2caa633fa92905b7a96ef14a80be6e46a9035b2437a8ecac57157e2523d63a17"
S = "${WORKDIR}/magni_robot-release-release-kinetic-magni_viz-0.4.2-0"
