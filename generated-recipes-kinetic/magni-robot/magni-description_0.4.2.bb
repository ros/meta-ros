...
SRC_URI = "https://github.com/UbiquityRobotics-release/magni_robot-release/archive/release/kinetic/magni_description/0.4.2-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "5776d3b6b5b4d5be6fa6544d9c786eae"
SRC_URI[sha256sum] = "5ca95ee9329dbbbd67984cc3cc55aa0a2e53e8dee0b675984ffa6ad6916dfdd2"
S = "${WORKDIR}/magni_robot-release-release-kinetic-magni_description-0.4.2-0"
