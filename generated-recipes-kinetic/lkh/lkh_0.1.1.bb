...
SRC_URI = "https://github.com/crigroup/lkh-release/archive/release/kinetic/lkh/0.1.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/lkh-release-release-kinetic-lkh-0.1.1-0"
