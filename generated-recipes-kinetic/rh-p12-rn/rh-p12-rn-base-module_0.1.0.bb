...
SRC_URI = "https://github.com/ROBOTIS-GIT-release/RH-P12-RN-release/archive/release/kinetic/rh_p12_rn_base_module/0.1.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d30de39833e5630890be0a19b9ab5da7"
SRC_URI[sha256sum] = "cdfe53d432c37dc07800ecb0f0cbd3255b01055aec76fa9f90d6c37eea4c7f3e"
S = "${WORKDIR}/RH-P12-RN-release-release-kinetic-rh_p12_rn_base_module-0.1.0-0"
