...
SRC_URI = "https://github.com/swri-robotics-gbp/imagezero_transport-release/archive/release/kinetic/imagezero/0.2.4-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/imagezero_transport-release-release-kinetic-imagezero-0.2.4-0"
