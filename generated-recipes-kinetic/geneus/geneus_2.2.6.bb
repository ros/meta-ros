...
SRC_URI = "https://github.com/tork-a/geneus-release/archive/release/kinetic/geneus/2.2.6-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/geneus-release-release-kinetic-geneus-2.2.6-0"
