...
SRC_URI = "https://github.com/ipa-led/leuze_ros_drivers-release/archive/release/kinetic/leuze_bringup/1.0.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "328e1cb072384230c36c1b8674875d0a"
SRC_URI[sha256sum] = "c009b3fe85c2743cc6e5558f22c4a5c5dd5fb1aeb1d2b2b43364ebf76b586a31"
S = "${WORKDIR}/leuze_ros_drivers-release-release-kinetic-leuze_bringup-1.0.1-1"
