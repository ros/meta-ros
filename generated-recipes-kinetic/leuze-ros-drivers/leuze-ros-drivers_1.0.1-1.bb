...
SRC_URI = "https://github.com/ipa-led/leuze_ros_drivers-release/archive/release/kinetic/leuze_ros_drivers/1.0.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "6c50828b7bf41cfb2730d135c2427d2a"
SRC_URI[sha256sum] = "f330d8c27bb85d3ff89e133c03db4b984b29cca21482e9db3a0d0bff0bceb8da"
S = "${WORKDIR}/leuze_ros_drivers-release-release-kinetic-leuze_ros_drivers-1.0.1-1"
