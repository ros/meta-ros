...
SRC_URI = "https://github.com/anybotics/grid_map-release/archive/release/kinetic/grid_map_sdf/1.6.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "57be9805f6012420f559bebc53484bdc"
SRC_URI[sha256sum] = "5b7ba54ef786b5fa0743939fdc14fabd87137e829cd0ba14d5df8ae0e1d42b77"
S = "${WORKDIR}/grid_map-release-release-kinetic-grid_map_sdf-1.6.2-1"
