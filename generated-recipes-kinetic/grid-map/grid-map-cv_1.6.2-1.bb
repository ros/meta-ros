...
SRC_URI = "https://github.com/anybotics/grid_map-release/archive/release/kinetic/grid_map_cv/1.6.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "ea25f5bc9cb53e37b2eb4abd3feee842"
SRC_URI[sha256sum] = "eb4a6a602d19f4268d1450edc8d2306b23e2456b60e9d3df1f2f12c1bd0a95fc"
S = "${WORKDIR}/grid_map-release-release-kinetic-grid_map_cv-1.6.2-1"
