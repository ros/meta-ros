...
SRC_URI = "https://github.com/anybotics/grid_map-release/archive/release/kinetic/grid_map_demos/1.6.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "1f96f517adb0d3a7b0cb24d6a5e79d85"
SRC_URI[sha256sum] = "01cbf50c1f042af1e1a17550b5e26d1321e100a94c94ea98098cfb01492a67fb"
S = "${WORKDIR}/grid_map-release-release-kinetic-grid_map_demos-1.6.2-1"
