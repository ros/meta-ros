...
SRC_URI = "https://github.com/ipa320/cob_substitute-release/archive/release/kinetic/cob_docker_control/0.6.8-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "c685d3abe96347686c5f1af0894c3462"
SRC_URI[sha256sum] = "ed3b9976ae565dbe95fa90f03c3aa875ae7f6ce8755f38c89a02a03af2947967"
S = "${WORKDIR}/cob_substitute-release-release-kinetic-cob_docker_control-0.6.8-1"
