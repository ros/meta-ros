...
SRC_URI = "https://github.com/ros-gbp/uav_testing-release/archive/release/kinetic/ksql_airport/0.0.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "284080f879e70fdeab2af6ef0b50da84"
SRC_URI[sha256sum] = "a2f16a1a50e86346428455dabeae82e5a37d0e66f44440e13d2b21d23da8573c"
S = "${WORKDIR}/uav_testing-release-release-kinetic-ksql_airport-0.0.1-1"
