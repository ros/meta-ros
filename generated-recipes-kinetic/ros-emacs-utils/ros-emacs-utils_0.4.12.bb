...
SRC_URI = "https://github.com/code-iai-release/ros_emacs_utils-release/archive/release/kinetic/ros_emacs_utils/0.4.12-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "5003820f2a8c45ec02663d0ac9b7bb45"
SRC_URI[sha256sum] = "438bd67e27a9e36f686c6b07f2a3253bae1143aefc4a2301d49c504db6b14df9"
S = "${WORKDIR}/ros_emacs_utils-release-release-kinetic-ros_emacs_utils-0.4.12-0"
