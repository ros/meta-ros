...
SRC_URI = "https://github.com/astuff/astuff_sensor_msgs-release/archive/release/kinetic/radar_msgs/2.3.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d2fa0c0ae5952ef5efb496da121896b5"
SRC_URI[sha256sum] = "d97de686cb11d08039a4037888ba86301c60580fa4004e8d9864bd1856a20eb0"
S = "${WORKDIR}/astuff_sensor_msgs-release-release-kinetic-radar_msgs-2.3.1-0"
