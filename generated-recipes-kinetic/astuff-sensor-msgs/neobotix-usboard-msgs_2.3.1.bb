...
SRC_URI = "https://github.com/astuff/astuff_sensor_msgs-release/archive/release/kinetic/neobotix_usboard_msgs/2.3.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f907335e2835dcdcb64c0e1057ebb82b"
SRC_URI[sha256sum] = "ee1798c33b1876a8d936e8aead4a4960adffac76955c53bfda44647ad969116f"
S = "${WORKDIR}/astuff_sensor_msgs-release-release-kinetic-neobotix_usboard_msgs-2.3.1-0"
