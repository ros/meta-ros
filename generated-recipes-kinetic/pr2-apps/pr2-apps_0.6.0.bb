...
SRC_URI = "https://github.com/pr2-gbp/pr2_apps-release/archive/release/kinetic/pr2_apps/0.6.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "726f95e193db3cd199ff008a94df01c7"
SRC_URI[sha256sum] = "d6233efd2dcb06410236f776ba3efbeb215c9db43a9155c452479e6152533be5"
S = "${WORKDIR}/pr2_apps-release-release-kinetic-pr2_apps-0.6.0-0"
