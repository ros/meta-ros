...
SRC_URI = "https://github.com/mrpt-ros-pkg-release/mrpt_navigation-release/archive/release/kinetic/mrpt_local_obstacles/0.1.26-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "7cc4e2e633d838f332c3d6a6fc66ef0a"
SRC_URI[sha256sum] = "e1e6fcb4cfede77795b36755670e4c1601c96fa8ab377e0332652ba2b36c434d"
S = "${WORKDIR}/mrpt_navigation-release-release-kinetic-mrpt_local_obstacles-0.1.26-1"
