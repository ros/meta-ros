...
SRC_URI = "https://github.com/roboception-gbp/rc_genicam_api-release/archive/release/kinetic/rc_genicam_api/2.2.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "eeee51af1d41bc5e5a989537dec276db"
SRC_URI[sha256sum] = "f5711d2a2637481dd12524c5c65c9703a3a5dfba7c582e375e9fce68f243defc"
S = "${WORKDIR}/rc_genicam_api-release-release-kinetic-rc_genicam_api-2.2.2-1"
