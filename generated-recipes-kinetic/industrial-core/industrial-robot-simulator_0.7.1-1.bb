...
SRC_URI = "https://github.com/ros-industrial-release/industrial_core-release/archive/release/kinetic/industrial_robot_simulator/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "e9e000bd19ff284d2d73562eb35da6cb"
SRC_URI[sha256sum] = "5c1d841b215ba686da49baec26471d893ec94ee8bab1bfa5316ed4410c74a360"
S = "${WORKDIR}/industrial_core-release-release-kinetic-industrial_robot_simulator-0.7.1-1"
