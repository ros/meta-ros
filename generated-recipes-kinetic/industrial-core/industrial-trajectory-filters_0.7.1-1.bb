...
SRC_URI = "https://github.com/ros-industrial-release/industrial_core-release/archive/release/kinetic/industrial_trajectory_filters/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9c2f8e54a5159f8a498ac4c1dc32b125"
SRC_URI[sha256sum] = "88abedfb278699d5b20ad2fcfdaa2dcfde2a89fc5ce65d6e14d82292dd7dc318"
S = "${WORKDIR}/industrial_core-release-release-kinetic-industrial_trajectory_filters-0.7.1-1"
