...
SRC_URI = "https://github.com/ros-industrial-release/industrial_core-release/archive/release/kinetic/simple_message/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "b9d43dcf2b5a35cea60e0f923c2c64ea"
SRC_URI[sha256sum] = "03b10af29cb7c1632ad8fa20490c3244b97db32ad48196a33984110aa0ace63d"
S = "${WORKDIR}/industrial_core-release-release-kinetic-simple_message-0.7.1-1"
