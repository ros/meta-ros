...
SRC_URI = "https://github.com/tork-a/jsk_visualization-release/archive/release/kinetic/jsk_interactive/2.1.5-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "eac16fd5336e9dbdc678d3f8706cea4b"
SRC_URI[sha256sum] = "b002c8e6ee0921a4a57d6bef4a2baaf488d4116e2fbf3945380c416190db2768"
S = "${WORKDIR}/jsk_visualization-release-release-kinetic-jsk_interactive-2.1.5-0"
