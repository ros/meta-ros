...
DESCRIPTION = "This package is for generating footsteps of ROBOTIS-OP3.     It has several config files and launch files in order to use footstep planner package."
...
SRC_URI = "https://github.com/ROBOTIS-GIT-release/robotis_op3_tools-release/archive/release/kinetic/op3_navigation/0.2.2-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "64d34b1b258265b72d4e6717bf15c1a8"
SRC_URI[sha256sum] = "94f01f62264441cffe4778a5ac591593ad9aa24774b79e4180941381100f101b"
S = "${WORKDIR}/robotis_op3_tools-release-release-kinetic-op3_navigation-0.2.2-0"
