...
SRC_URI = "https://github.com/cpswarm/swarm_functions-release/archive/release/kinetic/kinematics_exchanger/1.1.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "e73809028b8ffae42d9beef7dda5012f"
SRC_URI[sha256sum] = "3eee44d062a9f3d98ac8b203cbf7d9d1ab115621fe991160cf79d49289853f2b"
S = "${WORKDIR}/swarm_functions-release-release-kinetic-kinematics_exchanger-1.1.0-1"
