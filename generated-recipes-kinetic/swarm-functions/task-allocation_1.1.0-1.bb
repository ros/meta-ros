...
SRC_URI = "https://github.com/cpswarm/swarm_functions-release/archive/release/kinetic/task_allocation/1.1.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "b33d0b5ac1734dca6acbbe1396632e22"
SRC_URI[sha256sum] = "cc059f8347be9d0f24d6135dcd1e763e44fea2e63a82c9d3b9d9a4f61dd854ff"
S = "${WORKDIR}/swarm_functions-release-release-kinetic-task_allocation-1.1.0-1"
