...
SRC_URI = "https://github.com/pr2-gbp/pr2_common-release/archive/release/kinetic/pr2_common/1.12.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "77584468a8502135a1f4cc42cb63e7b3"
SRC_URI[sha256sum] = "9225508e8db9e13f977eddd37b41fc776408298b5c04c18037a8621f55efa50a"
S = "${WORKDIR}/pr2_common-release-release-kinetic-pr2_common-1.12.4-1"
