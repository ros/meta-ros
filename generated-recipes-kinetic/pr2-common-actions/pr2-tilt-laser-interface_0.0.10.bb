...
SRC_URI = "https://github.com/pr2-gbp/pr2_common_actions-release/archive/release/kinetic/pr2_tilt_laser_interface/0.0.10-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "43a734b81fa484c1bd5e0993dcff6cd0"
SRC_URI[sha256sum] = "3839089ef7938bdb42f51eb747f19310ee1be8dc72a14c2a52d6eb646aed43aa"
S = "${WORKDIR}/pr2_common_actions-release-release-kinetic-pr2_tilt_laser_interface-0.0.10-0"
