...
SRC_URI = "https://github.com/SteveMacenski/spatio_temporal_voxel_layer-release/archive/release/kinetic/spatio_temporal_voxel_layer/1.2.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a85a829a67d4bf264db468f3545a1d66"
SRC_URI[sha256sum] = "01447433873335a28db5ee7146abec292d04aaa42d4bfe6a174a254e8ae48b18"
S = "${WORKDIR}/spatio_temporal_voxel_layer-release-release-kinetic-spatio_temporal_voxel_layer-1.2.1-0"
