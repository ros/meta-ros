...
SRC_URI = "https://github.com/peci1/tf_remapper_cpp-release/archive/release/kinetic/tf_remapper_cpp/1.1.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "84662cd5c11bb24a9f4adb85fd0fbc0e"
SRC_URI[sha256sum] = "da882c8a6467c9123bd974dcaf94a6c0bd621ec87218a360af7587fbac411be5"
S = "${WORKDIR}/tf_remapper_cpp-release-release-kinetic-tf_remapper_cpp-1.1.1-0"
