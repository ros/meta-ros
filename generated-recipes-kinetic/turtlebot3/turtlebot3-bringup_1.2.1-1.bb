...
SRC_URI = "https://github.com/ROBOTIS-GIT-release/turtlebot3-release/archive/release/kinetic/turtlebot3_bringup/1.2.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "eb2a24d2bac4ed24717e2ad4bc6a9a2a"
SRC_URI[sha256sum] = "1e6254b12d861b5e5231ae8449e19ba72c3f4476cfccef437b6f20317699cd46"
S = "${WORKDIR}/turtlebot3-release-release-kinetic-turtlebot3_bringup-1.2.1-1"
