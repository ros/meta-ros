...
SRC_URI = "https://github.com/ipa320/cob_command_tools-release/archive/release/kinetic/cob_interactive_teleop/0.6.15-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2c6cd61a1016ea85b7c54c8acb7df3a1"
SRC_URI[sha256sum] = "783651e0fb9f29a3e11e599d5391db4b7086d95d9a7f15d9a2709d4583d781dd"
S = "${WORKDIR}/cob_command_tools-release-release-kinetic-cob_interactive_teleop-0.6.15-1"
