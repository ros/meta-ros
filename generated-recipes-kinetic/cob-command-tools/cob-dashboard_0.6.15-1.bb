...
SRC_URI = "https://github.com/ipa320/cob_command_tools-release/archive/release/kinetic/cob_dashboard/0.6.15-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9399cf19f67ac23f20902cdcc0a8656a"
SRC_URI[sha256sum] = "57002c95f78f2b42769390ba2a2042909ae9349c8d68e0b33d7e086d76a4bd03"
S = "${WORKDIR}/cob_command_tools-release-release-kinetic-cob_dashboard-0.6.15-1"
