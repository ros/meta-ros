...
SRC_URI = "https://github.com/ipa320/cob_command_tools-release/archive/release/kinetic/cob_monitoring/0.6.15-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9d6191371c7480ceaf121ce98cd51539"
SRC_URI[sha256sum] = "acc6a86099511fb8b2a7a1e83238843b9743fd1330858c8c40f78b3d314cff39"
S = "${WORKDIR}/cob_command_tools-release-release-kinetic-cob_monitoring-0.6.15-1"
