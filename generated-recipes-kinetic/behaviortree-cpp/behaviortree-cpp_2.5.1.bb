...
SRC_URI = "https://github.com/BehaviorTree/behaviortree_cpp-release/archive/release/kinetic/behaviortree_cpp/2.5.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "3a7a699d4d67176f03eb4ca79a559366"
SRC_URI[sha256sum] = "e8732929b0566874fe3b9584fcf40df76c10ec686fcd9fd9affba6e90a8e4e86"
S = "${WORKDIR}/behaviortree_cpp-release-release-kinetic-behaviortree_cpp-2.5.1-0"
