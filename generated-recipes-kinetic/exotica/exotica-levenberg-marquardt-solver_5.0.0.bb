...
SRC_URI = "https://github.com/ipab-slmc/exotica-release/archive/release/kinetic/exotica_levenberg_marquardt_solver/5.0.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "7ef7599f28424eedd912661250e2160c"
SRC_URI[sha256sum] = "49f2a5535759894ad4b2a8a8d3442cd8aa7f90b914bc8f867cda0fd2d962d4a7"
S = "${WORKDIR}/exotica-release-release-kinetic-exotica_levenberg_marquardt_solver-5.0.0-0"
