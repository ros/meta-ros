...
SRC_URI = "https://github.com/ipab-slmc/exotica-release/archive/release/kinetic/exotica_core/5.0.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "e34decab25190b36293e80c76ab5bd75"
SRC_URI[sha256sum] = "15d7411d8b64ca107e002fd726ac71522f2e1e8efb3e01e22d828998180317bc"
S = "${WORKDIR}/exotica-release-release-kinetic-exotica_core-5.0.0-0"
