...
SRC_URI = "https://github.com/ipab-slmc/exotica-release/archive/release/kinetic/exotica_collision_scene_fcl_latest/5.0.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "5fb367431d503f4730a292ad6ebc6faf"
SRC_URI[sha256sum] = "00c141c2716d048f8ecefaa8e85c5157c708050db7164de8deb697a62b04c216"
S = "${WORKDIR}/exotica-release-release-kinetic-exotica_collision_scene_fcl_latest-5.0.0-0"
