...
SRC_URI = "https://github.com/ipab-slmc/exotica-release/archive/release/kinetic/exotica_aico_solver/5.0.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "e2c2ec1e38edfff8344e18c22f7e4b3d"
SRC_URI[sha256sum] = "045c7102c2b9756890ea7def52b0072ec44f1432850ef02f05ada35d2e855e20"
S = "${WORKDIR}/exotica-release-release-kinetic-exotica_aico_solver-5.0.0-0"
