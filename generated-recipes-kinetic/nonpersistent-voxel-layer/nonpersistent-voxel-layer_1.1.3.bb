...
SRC_URI = "https://github.com/SteveMacenski/nonpersistent_voxel_layer-release/archive/release/kinetic/nonpersistent_voxel_layer/1.1.3-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "c52a392001bd3f3cbff9ffddf9438e4b"
SRC_URI[sha256sum] = "8d8ded6c9745f78888e621e74090f34bd6f919d7d209a441c4fc170ccf2d2d0c"
S = "${WORKDIR}/nonpersistent_voxel_layer-release-release-kinetic-nonpersistent_voxel_layer-1.1.3-0"
