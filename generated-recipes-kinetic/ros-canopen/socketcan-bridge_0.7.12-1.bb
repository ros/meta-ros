...
SRC_URI = "https://github.com/ros-industrial-release/ros_canopen-release/archive/release/kinetic/socketcan_bridge/0.7.12-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4ad0ed65f5c105e4929d7f10f27eb412"
SRC_URI[sha256sum] = "3683788cc6df58a0042ebbbd58fa0fbdc46d9cdd71b03351be01682f11d6b60a"
S = "${WORKDIR}/ros_canopen-release-release-kinetic-socketcan_bridge-0.7.12-1"
