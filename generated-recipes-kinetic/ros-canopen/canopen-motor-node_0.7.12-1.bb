...
SRC_URI = "https://github.com/ros-industrial-release/ros_canopen-release/archive/release/kinetic/canopen_motor_node/0.7.12-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "1c821db8794e7a77b0bde07f3a9d6aab"
SRC_URI[sha256sum] = "9a6e14e74c9063a4bba8c8257e6045f0f55a68d2964cc677338dec5c68cbf283"
S = "${WORKDIR}/ros_canopen-release-release-kinetic-canopen_motor_node-0.7.12-1"
