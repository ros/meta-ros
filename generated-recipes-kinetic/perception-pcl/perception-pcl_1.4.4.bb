...
SRC_URI = "https://github.com/ros-gbp/perception_pcl-release/archive/release/kinetic/perception_pcl/1.4.4-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "5920d6a17b94dfad4e6e49a19b24e5bc"
SRC_URI[sha256sum] = "dac70ef69f32a1bc70475ce8a2e2f312558d3369ec6687812d661ba83d23fb07"
S = "${WORKDIR}/perception_pcl-release-release-kinetic-perception_pcl-1.4.4-0"
