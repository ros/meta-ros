...
SRC_URI = "https://github.com/ros-gbp/python_qt_binding-release/archive/release/kinetic/python_qt_binding/0.3.4-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4f001f607c2be9423a69655fe0274672"
SRC_URI[sha256sum] = "ea6943351d48918e37d30db52637c7063caef9a9a9e72cd128fa6f3b84ab35cb"
S = "${WORKDIR}/python_qt_binding-release-release-kinetic-python_qt_binding-0.3.4-0"
