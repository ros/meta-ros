...
SRC_URI = "https://github.com/PilzDE/pilz_robots-release/archive/release/kinetic/pilz_control/0.4.11-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "6a9138c6db9cf33c50047950f495db87"
SRC_URI[sha256sum] = "87476526bca7357a5b2984e70ca33e12106520f736329c348def4d3e54f47f52"
S = "${WORKDIR}/pilz_robots-release-release-kinetic-pilz_control-0.4.11-1"
