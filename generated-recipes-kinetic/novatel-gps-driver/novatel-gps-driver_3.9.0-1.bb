...
SRC_URI = "https://github.com/swri-robotics-gbp/novatel_gps_driver-release/archive/release/kinetic/novatel_gps_driver/3.9.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9e39944003b76c5bbdc5ba1a601b9468"
SRC_URI[sha256sum] = "964d5169141a20a251cd6a5f68a314d9aec02ef97d0ba4369ece3ec1bc71969f"
S = "${WORKDIR}/novatel_gps_driver-release-release-kinetic-novatel_gps_driver-3.9.0-1"
