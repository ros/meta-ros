...
SRC_URI = "https://github.com/swri-robotics-gbp/marti_common-release/archive/release/kinetic/swri_math_util/2.11.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4b75d959a02b6b6ee56e58d444ba05f3"
SRC_URI[sha256sum] = "dd011d342331641cb4c26e1bdfddc2fe9dddc4821292a9e4bbcdabe13ea6b16a"
S = "${WORKDIR}/marti_common-release-release-kinetic-swri_math_util-2.11.0-1"
