...
SRC_URI = "https://github.com/swri-robotics-gbp/marti_common-release/archive/release/kinetic/marti_data_structures/2.11.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "af17884a8af74a5fefac18813d861054"
SRC_URI[sha256sum] = "f068376c3859d5d0816b310a090552633594593103026a4c2f02d83c0a97dd59"
S = "${WORKDIR}/marti_common-release-release-kinetic-marti_data_structures-2.11.0-1"
