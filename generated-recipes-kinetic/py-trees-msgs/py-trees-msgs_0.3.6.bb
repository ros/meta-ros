...
SRC_URI = "https://github.com/stonier/py_trees_msgs-release/archive/release/kinetic/py_trees_msgs/0.3.6-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "656f78077a7a1e7b5f7b910ec814c286"
SRC_URI[sha256sum] = "98321ee885da8d5be668962f5d3205adde0d61f4daf749db394412b42cd51945"
S = "${WORKDIR}/py_trees_msgs-release-release-kinetic-py_trees_msgs-0.3.6-0"
