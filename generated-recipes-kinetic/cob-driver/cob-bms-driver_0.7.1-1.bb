...
SRC_URI = "https://github.com/ipa320/cob_driver-release/archive/release/kinetic/cob_bms_driver/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "e6507ccda7e895090090f40362d07332"
SRC_URI[sha256sum] = "59a0996db74f8e2ac37b2d3d6de75591d8dfd72d8e9c38a565ac6adb089323f0"
S = "${WORKDIR}/cob_driver-release-release-kinetic-cob_bms_driver-0.7.1-1"
