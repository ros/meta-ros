...
SRC_URI = "https://github.com/ipa320/cob_driver-release/archive/release/kinetic/cob_sick_lms1xx/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4a28d79f85ec3abaca10f72a849409de"
SRC_URI[sha256sum] = "0c2054e38db44f7a88ce386dbbf6c54344213061edef7c08eb56f8538edd168c"
S = "${WORKDIR}/cob_driver-release-release-kinetic-cob_sick_lms1xx-0.7.1-1"
