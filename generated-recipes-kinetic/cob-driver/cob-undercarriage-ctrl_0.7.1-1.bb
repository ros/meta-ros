...
SRC_URI = "https://github.com/ipa320/cob_driver-release/archive/release/kinetic/cob_undercarriage_ctrl/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a52fe55a212cc74973e598aa2931abce"
SRC_URI[sha256sum] = "b4417c4c32af77b23c354e5ca649e8df5293b6bea76ef8933875fef31be185cf"
S = "${WORKDIR}/cob_driver-release-release-kinetic-cob_undercarriage_ctrl-0.7.1-1"
