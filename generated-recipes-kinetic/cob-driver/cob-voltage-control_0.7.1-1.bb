...
SRC_URI = "https://github.com/ipa320/cob_driver-release/archive/release/kinetic/cob_voltage_control/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "84b87744739e87891850aca99428bb2e"
SRC_URI[sha256sum] = "4639e392b3217eb3bf1f40954e28be2e077d3a0488ffdfcfb2d7f694caa8bd94"
S = "${WORKDIR}/cob_driver-release-release-kinetic-cob_voltage_control-0.7.1-1"
