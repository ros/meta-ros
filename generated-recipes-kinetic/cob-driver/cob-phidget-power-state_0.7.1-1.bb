...
SRC_URI = "https://github.com/ipa320/cob_driver-release/archive/release/kinetic/cob_phidget_power_state/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "51958dd86cccecad69d623e5e1ea6e7e"
SRC_URI[sha256sum] = "c561c20d14f1228e4f026e1b03a959c05b9223ea88ea553a5accc443f5cfd954"
S = "${WORKDIR}/cob_driver-release-release-kinetic-cob_phidget_power_state-0.7.1-1"
