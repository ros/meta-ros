...
SRC_URI = "https://github.com/ipa320/cob_driver-release/archive/release/kinetic/cob_scan_unifier/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "fd875c93b1b18511287341e6caebc970"
SRC_URI[sha256sum] = "70f6c34499e39b9eb0fc2e8904bdd0cc69f7d13e20c59d93a6f41e8f97e1bbe0"
S = "${WORKDIR}/cob_driver-release-release-kinetic-cob_scan_unifier-0.7.1-1"
