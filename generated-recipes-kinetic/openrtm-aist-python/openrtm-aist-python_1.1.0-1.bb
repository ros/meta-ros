...
SRC_URI = "https://github.com/tork-a/openrtm_aist_python-release/archive/release/kinetic/openrtm_aist_python/1.1.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "155a6bdd3fe9d5e835b749ae123d8942"
SRC_URI[sha256sum] = "f4607a16d5c2aeabf8be67c124d19526e0adde500005f383d751beb3d8e4c04e"
S = "${WORKDIR}/openrtm_aist_python-release-release-kinetic-openrtm_aist_python-1.1.0-1"
