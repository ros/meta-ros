...
SRC_URI = "https://github.com/ethz-adrl/ifopt-release/archive/release/kinetic/ifopt/2.0.7-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "1431dcfd7d32e5a1317f2f0d8199d7ce"
SRC_URI[sha256sum] = "71ad56c5d61fe81afe24e63f22a094911f58f22fce1b0b4611423a324f210336"
S = "${WORKDIR}/ifopt-release-release-kinetic-ifopt-2.0.7-1"
