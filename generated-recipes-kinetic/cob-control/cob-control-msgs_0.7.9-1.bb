...
SRC_URI = "https://github.com/ipa320/cob_control-release/archive/release/kinetic/cob_control_msgs/0.7.9-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "ee737f6bb5d679c09b6e101ed329b093"
SRC_URI[sha256sum] = "110349807b99c8fb88f9eb05a583a7ecba916d348daeaec9db70f84ec2a49c74"
S = "${WORKDIR}/cob_control-release-release-kinetic-cob_control_msgs-0.7.9-1"
