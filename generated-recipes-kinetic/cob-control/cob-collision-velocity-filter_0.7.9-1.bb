...
SRC_URI = "https://github.com/ipa320/cob_control-release/archive/release/kinetic/cob_collision_velocity_filter/0.7.9-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "3460c88c643cf8a9b4dba1d574e9c3dc"
SRC_URI[sha256sum] = "2f04a5669c78fc934f60d2bad95ee719a86591eb18d63deb63ceac518a12bec6"
S = "${WORKDIR}/cob_control-release-release-kinetic-cob_collision_velocity_filter-0.7.9-1"
