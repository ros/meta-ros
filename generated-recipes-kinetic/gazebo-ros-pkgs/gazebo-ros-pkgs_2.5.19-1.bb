...
SRC_URI = "https://github.com/ros-gbp/gazebo_ros_pkgs-release/archive/release/kinetic/gazebo_ros_pkgs/2.5.19-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "dfc9abc3d9166d96b90e5155b982cacb"
SRC_URI[sha256sum] = "f58f378fc8c5792eb42e4a348252276e0a39fd84521a97118ce2bb4766f68062"
S = "${WORKDIR}/gazebo_ros_pkgs-release-release-kinetic-gazebo_ros_pkgs-2.5.19-1"
