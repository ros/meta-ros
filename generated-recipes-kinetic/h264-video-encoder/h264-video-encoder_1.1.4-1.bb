...
SRC_URI = "https://github.com/aws-gbp/h264_video_encoder-release/archive/release/kinetic/h264_video_encoder/1.1.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "96e26eb2f9ba2389bd82c97e674a084d"
SRC_URI[sha256sum] = "bd56f199e14fe267f5eb9ddfbc7738c7e245a2b4236a2a6a3c287e5ebcdb63fd"
S = "${WORKDIR}/h264_video_encoder-release-release-kinetic-h264_video_encoder-1.1.4-1"
