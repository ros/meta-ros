...
SRC_URI = "https://github.com/uos-gbp/move_base_flex-release/archive/release/kinetic/mbf_costmap_core/0.2.5-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "fa865a8d5b6a5bd02ca258bb60fbba39"
SRC_URI[sha256sum] = "868c2f13857df6fae747b29108f7103e8da308a084ffa70bef4fc2aff1feda64"
S = "${WORKDIR}/move_base_flex-release-release-kinetic-mbf_costmap_core-0.2.5-1"
