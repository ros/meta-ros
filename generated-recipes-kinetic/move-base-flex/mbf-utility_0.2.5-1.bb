...
SRC_URI = "https://github.com/uos-gbp/move_base_flex-release/archive/release/kinetic/mbf_utility/0.2.5-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "277b97eb2bd55a6114d225539008e87c"
SRC_URI[sha256sum] = "959d2bdcfd96d1bef6d6a2e4df17ad48f22df57ee2400949c7c867900f8175d6"
S = "${WORKDIR}/move_base_flex-release-release-kinetic-mbf_utility-0.2.5-1"
