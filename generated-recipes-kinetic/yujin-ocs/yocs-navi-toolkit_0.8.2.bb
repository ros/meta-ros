...
SRC_URI = "https://github.com/yujinrobot-release/yujin_ocs-release/archive/release/kinetic/yocs_navi_toolkit/0.8.2-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "74ed2972331b1e60be73f4a50eba40e4"
SRC_URI[sha256sum] = "70d8ffe9e7e466a9b0929b3fbba8182560078459f079d539702cdab9b9dcffbc"
S = "${WORKDIR}/yujin_ocs-release-release-kinetic-yocs_navi_toolkit-0.8.2-0"
