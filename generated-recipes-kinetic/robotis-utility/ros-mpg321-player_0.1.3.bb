...
DESCRIPTION = "This package is a node that can playing mp3 file.     This package is using mpg321 which is command-line mp3 player."
...
SRC_URI = "https://github.com/ROBOTIS-GIT-release/ROBOTIS-Utility-release/archive/release/kinetic/ros_mpg321_player/0.1.3-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "3fb4f20f36d7eb5e87cec091cff0d74a"
SRC_URI[sha256sum] = "8d6783a5578afb7f436d8139c5b72bf8190882905738b9eaf055bc22ca91349a"
S = "${WORKDIR}/ROBOTIS-Utility-release-release-kinetic-ros_mpg321_player-0.1.3-0"
