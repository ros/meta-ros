...
SRC_URI = "https://github.com/yujinrobot-release/ecl_manipulation-release/archive/release/kinetic/ecl/0.60.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/ecl_manipulation-release-release-kinetic-ecl-0.60.1-1"
