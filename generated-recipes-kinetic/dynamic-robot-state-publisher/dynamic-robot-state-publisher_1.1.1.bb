...
SRC_URI = "https://github.com/peci1/dynamic_robot_state_publisher-release/archive/release/kinetic/dynamic_robot_state_publisher/1.1.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9ff748204e0a9502a67c04f103d2e225"
SRC_URI[sha256sum] = "bc5ce88af6cd8d9fff8b2012e6d309b085deb0d80557148e41dae6b9245b0b62"
S = "${WORKDIR}/dynamic_robot_state_publisher-release-release-kinetic-dynamic_robot_state_publisher-1.1.1-0"
