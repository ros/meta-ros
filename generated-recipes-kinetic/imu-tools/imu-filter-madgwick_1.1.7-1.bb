...
SRC_URI = "https://github.com/uos-gbp/imu_tools-release/archive/release/kinetic/imu_filter_madgwick/1.1.7-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "710bb713672a9a2783caea5a87447a0d"
SRC_URI[sha256sum] = "9443da92f35b02f2ad69fefc9907f9aa6558a4364afbf03318b7234b2e6e84f4"
S = "${WORKDIR}/imu_tools-release-release-kinetic-imu_filter_madgwick-1.1.7-1"
