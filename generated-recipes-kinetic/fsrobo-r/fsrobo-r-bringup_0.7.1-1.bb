...
SRC_URI = "https://github.com/FUJISOFT-Robotics/fsrobo_r-release/archive/release/kinetic/fsrobo_r_bringup/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "72c9a96b27e9bbc5e188b430416e14a1"
SRC_URI[sha256sum] = "d996724fc8a51fb5fd07fe53ddc2c138cd5d3f98d2347ca10f45b562d1014da6"
S = "${WORKDIR}/fsrobo_r-release-release-kinetic-fsrobo_r_bringup-0.7.1-1"
