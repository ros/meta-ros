...
SRC_URI = "https://github.com/ros-gbp/ros_controllers-release/archive/release/kinetic/force_torque_sensor_controller/0.13.5-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "58ccafd544a1aeb91229e60d515569f5"
SRC_URI[sha256sum] = "8777d68ce69e252a16588b0b4b89418c25ed94ff674fd93f260ba56f596a939c"
S = "${WORKDIR}/ros_controllers-release-release-kinetic-force_torque_sensor_controller-0.13.5-0"
