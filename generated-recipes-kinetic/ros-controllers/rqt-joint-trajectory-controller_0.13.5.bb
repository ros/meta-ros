...
SRC_URI = "https://github.com/ros-gbp/ros_controllers-release/archive/release/kinetic/rqt_joint_trajectory_controller/0.13.5-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2aff05b8ddff25e42b57443248ea9072"
SRC_URI[sha256sum] = "6870251fde88d2b747a3aa2fd4d0fbf84d69e65cf40bb11fd05e4cc505dee53f"
S = "${WORKDIR}/ros_controllers-release-release-kinetic-rqt_joint_trajectory_controller-0.13.5-0"
