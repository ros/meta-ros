...
SRC_URI = "https://github.com/uuvsimulator/uuv_simulator-release/archive/release/kinetic/uuv_auv_control_allocator/0.6.13-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d05c0ddee2b71ff5f5a32fc5360197ac"
SRC_URI[sha256sum] = "afc80cd2db6bd5d78c81673d6b75cc77ba2ab589638f111963ea6cb7e28ffb3d"
S = "${WORKDIR}/uuv_simulator-release-release-kinetic-uuv_auv_control_allocator-0.6.13-0"
