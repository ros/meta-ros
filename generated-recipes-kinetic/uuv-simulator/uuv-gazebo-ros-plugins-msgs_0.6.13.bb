...
SRC_URI = "https://github.com/uuvsimulator/uuv_simulator-release/archive/release/kinetic/uuv_gazebo_ros_plugins_msgs/0.6.13-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d9197766f3c64dba20d81b7b5d4cd6f3"
SRC_URI[sha256sum] = "e536acbb0defed2cd275d0d803138ce628063cd92dd4450bb0ba651d03e4977f"
S = "${WORKDIR}/uuv_simulator-release-release-kinetic-uuv_gazebo_ros_plugins_msgs-0.6.13-0"
