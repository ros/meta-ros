...
SRC_URI = "https://github.com/ros-gbp/diagnostics-release/archive/release/kinetic/diagnostic_common_diagnostics/1.9.3-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d20b716241d058da8192659d8e3d86a1"
SRC_URI[sha256sum] = "db632abf2e50a94225e7aec7de6585a92ba2494c4cb5e0459752a581e66e948b"
S = "${WORKDIR}/diagnostics-release-release-kinetic-diagnostic_common_diagnostics-1.9.3-0"
