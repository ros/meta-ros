...
SRC_URI = "https://github.com/robustify/igvc_self_drive_sim-release/archive/release/kinetic/igvc_self_drive_description/0.1.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4e44db8a720182339ca4da5beb5dbe27"
SRC_URI[sha256sum] = "19f24c726d4b6bf51f5d6a050ead118c4a87bb4e65e46b62482f8b90aab9041e"
S = "${WORKDIR}/igvc_self_drive_sim-release-release-kinetic-igvc_self_drive_description-0.1.4-1"
