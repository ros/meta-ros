...
SRC_URI = "https://github.com/robustify/igvc_self_drive_sim-release/archive/release/kinetic/igvc_self_drive_gazebo/0.1.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2230c18c16030cfa3e73d9968e43e7b2"
SRC_URI[sha256sum] = "d0282af6c542c255da6411c3c874f37e810ef0febeb8cce759adba28b49c3061"
S = "${WORKDIR}/igvc_self_drive_sim-release-release-kinetic-igvc_self_drive_gazebo-0.1.4-1"
