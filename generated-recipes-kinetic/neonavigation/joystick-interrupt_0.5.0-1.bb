...
SRC_URI = "https://github.com/at-wat/neonavigation-release/archive/release/kinetic/joystick_interrupt/0.5.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "1ee44296bb00a11d25e9ca352c067aaa"
SRC_URI[sha256sum] = "684bf1d56a69668ad3f60be796d16d0859b569c4bf7fa60084fcad89cd3db8f8"
S = "${WORKDIR}/neonavigation-release-release-kinetic-joystick_interrupt-0.5.0-1"
