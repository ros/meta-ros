...
SRC_URI = "https://github.com/DataspeedInc-release/velodyne_simulator-release/archive/release/kinetic/velodyne_gazebo_plugins/1.0.9-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f89b26d32c2219ef194f150448ae9dd0"
SRC_URI[sha256sum] = "9366456f31e82a1abd305fb89722153c3ae43fe52a486e5de4a64b8c9f82273c"
S = "${WORKDIR}/velodyne_simulator-release-release-kinetic-velodyne_gazebo_plugins-1.0.9-0"
