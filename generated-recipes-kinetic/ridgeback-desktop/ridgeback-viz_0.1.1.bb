...
SRC_URI = "https://github.com/clearpath-gbp/ridgeback_desktop-release/archive/release/kinetic/ridgeback_viz/0.1.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "40f80ecfb918597df769a694217c3112"
SRC_URI[sha256sum] = "81a15a6be2a99b7a78e1e12bed9355c512a2d5e0ee3076c637598796561c4e04"
S = "${WORKDIR}/ridgeback_desktop-release-release-kinetic-ridgeback_viz-0.1.1-0"
