...
SRC_URI = "https://github.com/artivis/distance_map-release/archive/release/kinetic/distance_map_msgs/0.1.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "eef44f369f3fec813243e0c9db1f6c90"
SRC_URI[sha256sum] = "864098f2693e220b4004f4840e77f3e9d81a92acc2461f86d50eb89f1199a1b1"
S = "${WORKDIR}/distance_map-release-release-kinetic-distance_map_msgs-0.1.0-1"
