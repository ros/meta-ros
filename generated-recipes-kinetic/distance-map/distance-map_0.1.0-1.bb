...
SRC_URI = "https://github.com/artivis/distance_map-release/archive/release/kinetic/distance_map/0.1.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "27ea3f3c4183cb1f923cd005dd413a09"
SRC_URI[sha256sum] = "5242728136342733c11c092be44fc922bcfa654cc18f1b975957677330474b2c"
S = "${WORKDIR}/distance_map-release-release-kinetic-distance_map-0.1.0-1"
