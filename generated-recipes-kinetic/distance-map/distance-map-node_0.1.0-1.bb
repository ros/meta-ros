...
SRC_URI = "https://github.com/artivis/distance_map-release/archive/release/kinetic/distance_map_node/0.1.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "0ded98200aa49b4e2ca82aaaf0e594af"
SRC_URI[sha256sum] = "bfa2b0ecd145b590187a5cbb94adc0408ca0113b138dbb9ed52faec89829d36e"
S = "${WORKDIR}/distance_map-release-release-kinetic-distance_map_node-0.1.0-1"
