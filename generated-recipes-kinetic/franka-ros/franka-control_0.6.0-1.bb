...
SRC_URI = "https://github.com/frankaemika/franka_ros-release/archive/release/kinetic/franka_control/0.6.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "11a409028ebb5e88bfc7bef134ef6c2d"
SRC_URI[sha256sum] = "1eb6aa78aff3ad5c5f617462d21be812931fe5d2bfecc774d8dc0550596d7b8e"
S = "${WORKDIR}/franka_ros-release-release-kinetic-franka_control-0.6.0-1"
