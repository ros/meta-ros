...
SRC_URI = "https://github.com/frankaemika/franka_ros-release/archive/release/kinetic/franka_gripper/0.6.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2830d3fc2ba98de85af276dd2e806ffb"
SRC_URI[sha256sum] = "5a59e493975969f8c78eee2d6458c613bf3bec4006edf8b1cd1c3262df992610"
S = "${WORKDIR}/franka_ros-release-release-kinetic-franka_gripper-0.6.0-1"
