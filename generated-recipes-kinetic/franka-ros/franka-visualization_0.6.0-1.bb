...
SRC_URI = "https://github.com/frankaemika/franka_ros-release/archive/release/kinetic/franka_visualization/0.6.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "11fda3f955dbaa03a43c3e99bafc651d"
SRC_URI[sha256sum] = "0dd98f3753c5847a39afabb933e6f5df266719349db7a1cdf67b364d464dc1e2"
S = "${WORKDIR}/franka_ros-release-release-kinetic-franka_visualization-0.6.0-1"
