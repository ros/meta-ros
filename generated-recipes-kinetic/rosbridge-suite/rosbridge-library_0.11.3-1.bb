...
SRC_URI = "https://github.com/RobotWebTools-release/rosbridge_suite-release/archive/release/kinetic/rosbridge_library/0.11.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a2bac6be4e7db3c6a05e01b53053cace"
SRC_URI[sha256sum] = "030180bdc8c10d653d2cd087d48dcfa33cfccc9dfce4ae028033c4fa666daa50"
S = "${WORKDIR}/rosbridge_suite-release-release-kinetic-rosbridge_library-0.11.3-1"
