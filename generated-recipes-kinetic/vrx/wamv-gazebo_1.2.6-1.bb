...
SRC_URI = "https://github.com/ros-gbp/vrx-release/archive/release/kinetic/wamv_gazebo/1.2.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "c9e2f7908b08c8620481a6910f24aeeb"
SRC_URI[sha256sum] = "c41fc7222e3fedc5f56f82c8b952962c1fc8a7eb6653445b620577a6169e8f44"
S = "${WORKDIR}/vrx-release-release-kinetic-wamv_gazebo-1.2.6-1"
