...
SRC_URI = "https://github.com/Kawasaki-Robotics/khi_robot-release/archive/release/kinetic/khi_robot_bringup/1.1.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a2fe2ff8d9d6bf49e5b7220401961943"
SRC_URI[sha256sum] = "be1db76ee75dd250d42a6db1aa2dec4513ecdab9e23ea5c9e0c27bfcee963177"
S = "${WORKDIR}/khi_robot-release-release-kinetic-khi_robot_bringup-1.1.2-1"
