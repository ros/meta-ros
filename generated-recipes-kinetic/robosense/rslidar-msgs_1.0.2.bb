...
SRC_URI = "https://github.com/CPFL/robosense-release/archive/release/kinetic/rslidar_msgs/1.0.2-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f1555cd062dc0f1fc69d736ba4974ee1"
SRC_URI[sha256sum] = "5d281f05f339daa847be5a486a68aa98cf4be9b49a12d1807101cb14cc45be1e"
S = "${WORKDIR}/robosense-release-release-kinetic-rslidar_msgs-1.0.2-0"
