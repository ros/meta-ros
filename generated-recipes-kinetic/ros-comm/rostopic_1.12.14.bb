...
SRC_URI = "https://github.com/ros-gbp/ros_comm-release/archive/release/kinetic/rostopic/1.12.14-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "625966ef841950f476448c166bee8d73"
SRC_URI[sha256sum] = "8642914defe3b2a987aa069cd25d683d02d1ae98fa1cc10da66faeca8852f57c"
S = "${WORKDIR}/ros_comm-release-release-kinetic-rostopic-1.12.14-0"
