...
SRC_URI = "https://github.com/at-wat/neonavigation_msgs-release/archive/release/kinetic/costmap_cspace_msgs/0.5.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "947841b6ed26c345cc6ed9292ddc2091"
SRC_URI[sha256sum] = "edcc47e537c5002239d74c64eefb9af640e45aa189997fd64ca1dd534b9ff8ee"
S = "${WORKDIR}/neonavigation_msgs-release-release-kinetic-costmap_cspace_msgs-0.5.0-1"
