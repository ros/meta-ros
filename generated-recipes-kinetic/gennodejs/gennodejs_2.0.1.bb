...
SRC_URI = "https://github.com/RethinkRobotics-release/gennodejs-release/archive/release/kinetic/gennodejs/2.0.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/gennodejs-release-release-kinetic-gennodejs-2.0.1-0"
