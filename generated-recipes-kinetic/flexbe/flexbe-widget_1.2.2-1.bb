...
SRC_URI = "https://github.com/FlexBE/flexbe_behavior_engine-release/archive/release/kinetic/flexbe_widget/1.2.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "61f673b4876693aa49aca5c5a7d2d895"
SRC_URI[sha256sum] = "07478d66a83de47880cb6c1964047cd96d6a55f04b3d8521797dc096bcee57ea"
S = "${WORKDIR}/flexbe_behavior_engine-release-release-kinetic-flexbe_widget-1.2.2-1"
