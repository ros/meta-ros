...
SRC_URI = "https://github.com/lagadic/vision_visp-release/archive/release/kinetic/visp_auto_tracker/0.11.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9b1b583851b8ebd9fc563f75ba184d69"
SRC_URI[sha256sum] = "932449bfdec3f07765a70557d2c6262e1000dd4bd8e1d5766d31c9cffd8091e7"
S = "${WORKDIR}/vision_visp-release-release-kinetic-visp_auto_tracker-0.11.1-1"
