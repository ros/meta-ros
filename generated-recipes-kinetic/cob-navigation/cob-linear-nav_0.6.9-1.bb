...
SRC_URI = "https://github.com/ipa320/cob_navigation-release/archive/release/kinetic/cob_linear_nav/0.6.9-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "7138618dfbac4694ab107ccdfe0d7aae"
SRC_URI[sha256sum] = "95b9594300b38568e4e72acfe201847e29302a7698915b75d6a4504e7132d8bf"
S = "${WORKDIR}/cob_navigation-release-release-kinetic-cob_linear_nav-0.6.9-1"
