...
SRC_URI = "https://github.com/ipa320/cob_navigation-release/archive/release/kinetic/cob_navigation_config/0.6.9-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "253116208db3ff264e459676a99e4747"
SRC_URI[sha256sum] = "8048e88f0d6a387902cb776df55a9292adf715e2ba02749bf2f47f881734ac16"
S = "${WORKDIR}/cob_navigation-release-release-kinetic-cob_navigation_config-0.6.9-1"
