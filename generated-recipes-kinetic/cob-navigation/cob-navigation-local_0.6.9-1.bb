...
SRC_URI = "https://github.com/ipa320/cob_navigation-release/archive/release/kinetic/cob_navigation_local/0.6.9-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "30804b131495c2e6a8e433662dab2e82"
SRC_URI[sha256sum] = "40f88719fb1893cf57b15f809de3835908f02b41fe6aea6fa6db4ef26dfde37d"
S = "${WORKDIR}/cob_navigation-release-release-kinetic-cob_navigation_local-0.6.9-1"
