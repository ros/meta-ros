...
SRC_URI = "https://github.com/ROBOTIS-GIT-release/turtlebot3_applications-release/archive/release/kinetic/turtlebot3_follow_filter/1.1.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "04ea95a0e347beb5917d7e3310832b28"
SRC_URI[sha256sum] = "ce62eb812b2be6e80f1e9d6344fef016d5a5d8cc1a6536fe0640f58426b57420"
S = "${WORKDIR}/turtlebot3_applications-release-release-kinetic-turtlebot3_follow_filter-1.1.0-0"
