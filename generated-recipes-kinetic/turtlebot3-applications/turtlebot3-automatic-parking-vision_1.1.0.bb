...
SRC_URI = "https://github.com/ROBOTIS-GIT-release/turtlebot3_applications-release/archive/release/kinetic/turtlebot3_automatic_parking_vision/1.1.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "8a0215a7d6ffab0db8698fffe91ecb65"
SRC_URI[sha256sum] = "e83048ac1a2f6be0ca3abbaf2819e858b8b88ff4ae80d05def1c5746b215fa79"
S = "${WORKDIR}/turtlebot3_applications-release-release-kinetic-turtlebot3_automatic_parking_vision-1.1.0-0"
