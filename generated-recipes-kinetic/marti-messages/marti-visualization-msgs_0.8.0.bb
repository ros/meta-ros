...
SRC_URI = "https://github.com/swri-robotics-gbp/marti_messages-release/archive/release/kinetic/marti_visualization_msgs/0.8.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "09d9e240525b5b83bbe988d1f019cd39"
SRC_URI[sha256sum] = "9b9fd7ace91bd5be3eb238b6b6fe2a69af991b4c9b4e040127d77fa0153d077f"
S = "${WORKDIR}/marti_messages-release-release-kinetic-marti_visualization_msgs-0.8.0-0"
