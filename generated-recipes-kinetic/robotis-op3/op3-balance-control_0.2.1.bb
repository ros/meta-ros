...
SRC_URI = "https://github.com/ROBOTIS-GIT-release/ROBOTIS-OP3-release/archive/release/kinetic/op3_balance_control/0.2.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d9f7669489fd18000852d65a23d4495c"
SRC_URI[sha256sum] = "5acbf20e7b57df2ee6531c91867030170799964eb75e9eb4accfa68f74a2d9c2"
S = "${WORKDIR}/ROBOTIS-OP3-release-release-kinetic-op3_balance_control-0.2.1-0"
