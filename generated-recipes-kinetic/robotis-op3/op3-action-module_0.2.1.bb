...
SRC_URI = "https://github.com/ROBOTIS-GIT-release/ROBOTIS-OP3-release/archive/release/kinetic/op3_action_module/0.2.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9275aa4cdf5ab594c3ade51f7a162eaa"
SRC_URI[sha256sum] = "f19338516aa79cb1951aabc477ea97b73ec09cbea91d9d7a849751ccecbaca4f"
S = "${WORKDIR}/ROBOTIS-OP3-release-release-kinetic-op3_action_module-0.2.1-0"
