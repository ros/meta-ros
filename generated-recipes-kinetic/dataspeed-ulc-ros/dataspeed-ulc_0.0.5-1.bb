...
SRC_URI = "https://github.com/DataspeedInc-release/dataspeed_ulc_ros-release/archive/release/kinetic/dataspeed_ulc/0.0.5-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "422f2cd930ac04840ac635e4a0a6a5ce"
SRC_URI[sha256sum] = "1beafc16f183ca5277bca47d9fd028dc60cafe7a7a5eab38add3ef0b88301b9d"
S = "${WORKDIR}/dataspeed_ulc_ros-release-release-kinetic-dataspeed_ulc-0.0.5-1"
