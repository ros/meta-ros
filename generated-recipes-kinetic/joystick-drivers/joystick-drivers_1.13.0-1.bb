...
SRC_URI = "https://github.com/ros-gbp/joystick_drivers-release/archive/release/kinetic/joystick_drivers/1.13.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "bcfd67cffdfe64d4a6ef8ca3ee4eda44"
SRC_URI[sha256sum] = "09efaa5bcd65e0f08b9a37bcffa9b261b8b7bdb43c38501a1fbaea2b75bf7bd0"
S = "${WORKDIR}/joystick_drivers-release-release-kinetic-joystick_drivers-1.13.0-1"
