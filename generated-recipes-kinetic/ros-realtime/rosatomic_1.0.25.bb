...
SRC_URI = "https://github.com/ros-gbp/ros_realtime-release/archive/release/kinetic/rosatomic/1.0.25-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "3b54e959fe3045be355dbb489c435603"
SRC_URI[sha256sum] = "88d799652518201a36dcb10edd31c7b29bb684cd68face857348501f27cb9eb8"
S = "${WORKDIR}/ros_realtime-release-release-kinetic-rosatomic-1.0.25-0"
