...
SRC_URI = "https://github.com/ros-gbp/ros_control-release/archive/release/kinetic/transmission_interface/0.13.3-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "3d041ff07c265fef6a89734f314c1b3f"
SRC_URI[sha256sum] = "5ea69c02ba27cce7d5bb727821595ff1eacfeda4febdb5a56ed243d779dd825d"
S = "${WORKDIR}/ros_control-release-release-kinetic-transmission_interface-0.13.3-0"
