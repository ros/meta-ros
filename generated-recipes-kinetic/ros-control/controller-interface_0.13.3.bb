...
SRC_URI = "https://github.com/ros-gbp/ros_control-release/archive/release/kinetic/controller_interface/0.13.3-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a7d0d266c6e684e3564b30042ccdb570"
SRC_URI[sha256sum] = "5db8ab2db8d3bdfbaa79743ec62a1932d3763d016812652cc145b674cb58ea8c"
S = "${WORKDIR}/ros_control-release-release-kinetic-controller_interface-0.13.3-0"
