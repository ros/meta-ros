...
SRC_URI = "https://github.com/ros-gbp/ros_control-release/archive/release/kinetic/combined_robot_hw_tests/0.13.3-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9bfee4a9d969938a1a9a631907d2aaf4"
SRC_URI[sha256sum] = "e32b1cb024910e272987686faa470d1bdf98860227eb0a2e368415ca3ac9102f"
S = "${WORKDIR}/ros_control-release-release-kinetic-combined_robot_hw_tests-0.13.3-0"
