...
SRC_URI = "https://github.com/ROBOTIS-GIT-release/ROBOTIS-OP3-msgs-release/archive/release/kinetic/op3_offset_tuner_msgs/0.1.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "8ed32b215d14baf7de547d8838d4ce7b"
SRC_URI[sha256sum] = "bb1ae01bab217767063e9efc419103fa3245355a8d3215b9d7734e646366fe87"
S = "${WORKDIR}/ROBOTIS-OP3-msgs-release-release-kinetic-op3_offset_tuner_msgs-0.1.1-0"
