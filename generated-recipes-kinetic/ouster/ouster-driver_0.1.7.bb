...
SRC_URI = "https://github.com/CPFL/ouster-release/archive/release/kinetic/ouster_driver/0.1.7-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "fbff2037078b52568f858db675a5cc59"
SRC_URI[sha256sum] = "6696f1152949ac3729d2b7be7b3f03f835d783cb3866c0664d4d5770a19ea1c1"
S = "${WORKDIR}/ouster-release-release-kinetic-ouster_driver-0.1.7-0"
