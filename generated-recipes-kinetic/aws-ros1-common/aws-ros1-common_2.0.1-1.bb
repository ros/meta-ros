...
SRC_URI = "https://github.com/aws-gbp/aws_ros1_common-release/archive/release/kinetic/aws_ros1_common/2.0.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "898e86cf87a836465552081441adab58"
SRC_URI[sha256sum] = "a6809dc8925f253335963fe069c7043ecc8d4143f21fc60aca776655afb2f132"
S = "${WORKDIR}/aws_ros1_common-release-release-kinetic-aws_ros1_common-2.0.1-1"
