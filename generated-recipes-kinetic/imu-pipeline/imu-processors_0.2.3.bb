...
SRC_URI = "https://github.com/ros-gbp/imu_pipeline-release/archive/release/kinetic/imu_processors/0.2.3-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2c140ea1c25dc2e496fc237c29cca635"
SRC_URI[sha256sum] = "f42b36cc5c874042cf826732d1f68361621bf020b4080686882cdc4e791c8264"
S = "${WORKDIR}/imu_pipeline-release-release-kinetic-imu_processors-0.2.3-0"
