...
SRC_URI = "https://github.com/ros-perception/opencv_apps-release/archive/release/kinetic/opencv_apps/2.0.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "1be0e6937b13561aeb85f960319984b3"
SRC_URI[sha256sum] = "e1009a12d6fda59502ad6336ab20cef4fe785066348088630ba57e384ce2ae1e"
S = "${WORKDIR}/opencv_apps-release-release-kinetic-opencv_apps-2.0.1-1"
