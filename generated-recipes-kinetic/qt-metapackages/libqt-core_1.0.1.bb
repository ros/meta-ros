...
SRC_URI = "https://github.com/swri-robotics-gbp/qt_metapackages-release/archive/release/kinetic/libqt_core/1.0.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "6213e6a29a5f1d601320bc7ae14c2784"
SRC_URI[sha256sum] = "3fdd66ad982042a75f64fc13f7d7ead47fd05a5ee97142c7775af0f5e18ebd07"
S = "${WORKDIR}/qt_metapackages-release-release-kinetic-libqt_core-1.0.1-0"
