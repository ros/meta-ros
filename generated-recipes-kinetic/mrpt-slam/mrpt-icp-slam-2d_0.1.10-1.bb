...
SRC_URI = "https://github.com/mrpt-ros-pkg-release/mrpt_slam-release/archive/release/kinetic/mrpt_icp_slam_2d/0.1.10-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "de9fa28c471b30ab521dff30e81bebb9"
SRC_URI[sha256sum] = "42fee3a8312a91dd20d6b6eb0a42e3fd7d30f7619ffafd42305df715ed5a5a25"
S = "${WORKDIR}/mrpt_slam-release-release-kinetic-mrpt_icp_slam_2d-0.1.10-1"
