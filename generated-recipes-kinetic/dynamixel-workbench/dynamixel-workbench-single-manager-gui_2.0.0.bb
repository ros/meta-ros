...
SRC_URI = "https://github.com/ROBOTIS-GIT-release/dynamixel-workbench-release/archive/release/kinetic/dynamixel_workbench_single_manager_gui/2.0.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "e2208ff106e7fb25317ba84df306d819"
SRC_URI[sha256sum] = "8727794a14e886ddd94be2361f752b26a348d9ffe3895b967ec99dc351a41c55"
S = "${WORKDIR}/dynamixel-workbench-release-release-kinetic-dynamixel_workbench_single_manager_gui-2.0.0-0"
