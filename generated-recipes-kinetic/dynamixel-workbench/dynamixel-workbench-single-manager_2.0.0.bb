...
SRC_URI = "https://github.com/ROBOTIS-GIT-release/dynamixel-workbench-release/archive/release/kinetic/dynamixel_workbench_single_manager/2.0.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a82e4e0a496cdf08eef572d8ea4110a6"
SRC_URI[sha256sum] = "7ade6200b559099cd96e36dfac6316ee70fb50d21d592406fc7fec37e0f7b2ac"
S = "${WORKDIR}/dynamixel-workbench-release-release-kinetic-dynamixel_workbench_single_manager-2.0.0-0"
