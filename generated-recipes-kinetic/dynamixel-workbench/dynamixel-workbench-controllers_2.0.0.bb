...
SRC_URI = "https://github.com/ROBOTIS-GIT-release/dynamixel-workbench-release/archive/release/kinetic/dynamixel_workbench_controllers/2.0.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "cce27b6771b6b1f42cd26c2146b5cd03"
SRC_URI[sha256sum] = "ef893c3483c8ca773e64a6e83b27b670a5adbe0d1f27a61d295b328202ce2807"
S = "${WORKDIR}/dynamixel-workbench-release-release-kinetic-dynamixel_workbench_controllers-2.0.0-0"
