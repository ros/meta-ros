# Branch `[hardknott]` (UNSUPPORTED)

The **hardknott** OpenEmbedded release series has reached its EOL (see
...
have not been added to this branch, and building with **hardknott** is no
longer supported.
