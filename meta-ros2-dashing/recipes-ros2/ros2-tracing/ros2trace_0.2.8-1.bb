...
# matches with: https://gitlab.com/ros_tracing/ros2_tracing-release/archive/release/dashing/ros2trace/0.2.8-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/ros2trace"
SRC_URI = "git://gitlab.com/ros_tracing/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "8e7120cb9c74a4adda263de0314ee15031585f5d"
S = "${WORKDIR}/git"
