...
# matches with: https://gitlab.com/ros_tracing/ros2_tracing-release/archive/release/dashing/tracetools_read/0.2.8-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/tracetools_read"
SRC_URI = "git://gitlab.com/ros_tracing/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "d81abfa6555104b59c04426866316bca39b91e70"
S = "${WORKDIR}/git"
