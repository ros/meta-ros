...
# matches with: https://gitlab.com/ros_tracing/ros2_tracing-release/archive/release/dashing/tracetools_launch/0.2.8-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/tracetools_launch"
SRC_URI = "git://gitlab.com/ros_tracing/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "9b16c3c53afbdb45b84909f00d9a559d667c8b46"
S = "${WORKDIR}/git"
