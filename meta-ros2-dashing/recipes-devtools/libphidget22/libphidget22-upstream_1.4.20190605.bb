...
SRC_URI = "https://www.phidgets.com/downloads/phidget22/libraries/linux/${SRCNAME}/${SRCNAME}-${PV}.tar.gz \
    https://raw.githubusercontent.com/ros2-gbp/phidgets_drivers-release/release/dashing/${SRCNAME}/2.0.1-1/patch/libphidgets22-fix-uninitialized-memory-access.patch;name=patch \
"
