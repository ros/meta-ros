...
do_install_append() {
    # ERROR: libphidget22-2.0.1-1-r0 do_populate_sysroot: QA Issue: libphidget22.pc failed sanity test (tmpdir) in path /jenkins/mjansa/build-ros/ros2-dashing-thud/tmp-glibc/work/i586-oe-linux/libphidget22/2.0.1-1-r0/sysroot-destdir/usr/lib/pkgconfig [pkgconfig]
    # head -n 1 /jenkins/mjansa/build-ros/ros2-dashing-thud/tmp-glibc/work/i586-oe-linux/libphidget22/2.0.1-1-r0/sysroot-destdir/usr/lib/pkgconfig/libphidget22.pc
    # prefix=/jenkins/mjansa/build-ros/ros2-dashing-thud/tmp-glibc/work/i586-oe-linux/libphidget22/2.0.1-1-r0/build/libphidget22_install
