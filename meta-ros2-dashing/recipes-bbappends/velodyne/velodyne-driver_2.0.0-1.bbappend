...
# ERROR: velodyne-driver-2.0.0-1-r0 do_package_qa: QA Issue: /usr/lib/velodyne_driver/vdump contained in package velodyne-driver requires /bin/bash, but no providers found in RDEPENDS_velodyne-driver? [file-rdeps]
RDEPENDS_${PN} += "bash"
