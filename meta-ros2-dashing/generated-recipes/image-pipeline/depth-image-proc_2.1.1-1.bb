...
# matches with: https://github.com/ros2-gbp/image_pipeline-release/archive/release/dashing/depth_image_proc/2.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/depth_image_proc"
SRC_URI = "git://github.com/ros2-gbp/image_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "cdd377a0d5959e2bad8d350b86b934f921029503"
S = "${WORKDIR}/git"
