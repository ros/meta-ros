...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/dashing/launch_testing/0.8.3-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/launch_testing"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "4a278049949148d48735fea2df856873b458d430"
S = "${WORKDIR}/git"
