...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/dashing/rviz_rendering/6.1.7-2.tar.gz
ROS_BRANCH ?= "branch=release/dashing/rviz_rendering"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "eed2f20f2165f2516270b6b89e10ec6cc488b847"
S = "${WORKDIR}/git"
