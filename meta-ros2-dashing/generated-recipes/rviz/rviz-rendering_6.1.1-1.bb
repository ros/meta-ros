...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/dashing/rviz_rendering/6.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/rviz_rendering"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "a28b5da959f4696537a21b7fcfbedcfcaf5136a2"
S = "${WORKDIR}/git"
