...
# matches with: https://github.com/ros2-gbp/rclc-release/archive/release/dashing/rclc_examples/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/rclc_examples"
SRC_URI = "git://github.com/ros2-gbp/rclc-release;${ROS_BRANCH};protocol=https"
SRCREV = "ebbbd97b5fabbbbbb09798f98b75639eb4052e18"
S = "${WORKDIR}/git"
