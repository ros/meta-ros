...
# matches with: https://github.com/ros2-gbp/rclc-release/archive/release/dashing/rclc_lifecycle/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/rclc_lifecycle"
SRC_URI = "git://github.com/ros2-gbp/rclc-release;${ROS_BRANCH};protocol=https"
SRCREV = "648810720337b6f4533a32bbef4c9e5fb0bf2685"
S = "${WORKDIR}/git"
