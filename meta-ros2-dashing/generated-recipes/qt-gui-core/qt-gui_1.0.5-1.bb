...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/dashing/qt_gui/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "a20d625b85e80a2723c65d67236a56357b6523ef"
S = "${WORKDIR}/git"
