...
# matches with: https://github.com/ros2-gbp/rqt-release/archive/release/dashing/rqt_py_common/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/rqt_py_common"
SRC_URI = "git://github.com/ros2-gbp/rqt-release;${ROS_BRANCH};protocol=https"
SRCREV = "e10c0f1196be330aecfc195e445c51b2f14113e2"
S = "${WORKDIR}/git"
