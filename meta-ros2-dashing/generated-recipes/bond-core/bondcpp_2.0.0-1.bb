...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/dashing/bondcpp/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/bondcpp"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "af57cd0723ff12d9586746b8471c8385225cb1bb"
S = "${WORKDIR}/git"
