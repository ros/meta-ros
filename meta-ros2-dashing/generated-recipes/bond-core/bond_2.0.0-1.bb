...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/dashing/bond/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/bond"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "87bd61cc3a55e1fd941825abcefab5ff52781ffe"
S = "${WORKDIR}/git"
