...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/dashing/test_bond/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/test_bond"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "e7904e950224d5dcc90231d36a34af2758f7caa0"
S = "${WORKDIR}/git"
