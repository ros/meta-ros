...
# matches with: https://github.com/roboception-gbp/rc_genicam_api-release/archive/release/dashing/rc_genicam_api/2.3.5-1.tar.gz
...
SRCREV = "b36f03349712de70209fc19385240a48d7f9cf6e"
S = "${WORKDIR}/git"
