...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/dashing/ros_base/0.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/ros_base"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "98d3fc63aa303485bc1a54485551a54f8fae72fd"
S = "${WORKDIR}/git"
