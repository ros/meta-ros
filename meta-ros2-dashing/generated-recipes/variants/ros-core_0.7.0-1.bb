...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/dashing/ros_core/0.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/ros_core"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "e4ec51f1ea74a1175618d4e500e706ed63ab840b"
S = "${WORKDIR}/git"
