...
# matches with: https://github.com/ros2-gbp/googletest-release/archive/release/dashing/gtest_vendor/1.8.9000-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/gtest_vendor"
SRC_URI = "git://github.com/ros2-gbp/googletest-release;${ROS_BRANCH};protocol=https"
SRCREV = "2ce27dc279940871fbbac8b291d21477c2b5a042"
S = "${WORKDIR}/git"
