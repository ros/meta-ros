...
# matches with: https://github.com/ros2-gbp/grbl_msgs-release/archive/release/lyrical/grbl_msgs/0.0.2-10.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/grbl_msgs"
SRC_URI = "git://github.com/ros2-gbp/grbl_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "f0a6479d91effc1e0c99edde94c328fd2797c815"
S = "${WORKDIR}/git"
