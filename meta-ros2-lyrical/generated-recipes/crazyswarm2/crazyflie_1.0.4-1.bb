...
# matches with: https://github.com/ros2-gbp/crazyswarm2-release/archive/release/lyrical/crazyflie/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/crazyflie"
SRC_URI = "git://github.com/ros2-gbp/crazyswarm2-release;${ROS_BRANCH};protocol=https"
SRCREV = "6a8fc5ab79f16dab9b7247e272135bd4b453e42f"
S = "${WORKDIR}/git"
