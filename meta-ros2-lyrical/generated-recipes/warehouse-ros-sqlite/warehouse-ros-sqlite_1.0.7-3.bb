...
# matches with: https://github.com/ros2-gbp/warehouse_ros_sqlite-release/archive/release/lyrical/warehouse_ros_sqlite/1.0.7-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/warehouse_ros_sqlite"
SRC_URI = "git://github.com/ros2-gbp/warehouse_ros_sqlite-release;${ROS_BRANCH};protocol=https"
SRCREV = "cc5934a620a032b4cc19cea0384f609da9d28ed1"
S = "${WORKDIR}/git"
