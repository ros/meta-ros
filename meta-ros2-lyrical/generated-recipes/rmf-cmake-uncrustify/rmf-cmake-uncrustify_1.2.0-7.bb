...
# matches with: https://github.com/ros2-gbp/rmf_cmake_uncrustify-release/archive/release/lyrical/rmf_cmake_uncrustify/1.2.0-7.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rmf_cmake_uncrustify"
SRC_URI = "git://github.com/ros2-gbp/rmf_cmake_uncrustify-release;${ROS_BRANCH};protocol=https"
SRCREV = "8e11324b45cf862cfcae4eab8539261e6ff28d1e"
S = "${WORKDIR}/git"
