...
# matches with: https://github.com/ros2-gbp/nao_interfaces-release/archive/release/lyrical/nao_command_msgs/1.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/nao_command_msgs"
SRC_URI = "git://github.com/ros2-gbp/nao_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "f3e1b13bab53b918b526e31f5caec3ca2fa959b6"
S = "${WORKDIR}/git"
