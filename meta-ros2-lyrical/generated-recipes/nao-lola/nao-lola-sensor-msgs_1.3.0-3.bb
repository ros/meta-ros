...
# matches with: https://github.com/ros2-gbp/nao_lola-release/archive/release/lyrical/nao_lola_sensor_msgs/1.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/nao_lola_sensor_msgs"
SRC_URI = "git://github.com/ros2-gbp/nao_lola-release;${ROS_BRANCH};protocol=https"
SRCREV = "f6bb6e9f2b8c9eb123b5a1cf250a551df499e655"
S = "${WORKDIR}/git"
