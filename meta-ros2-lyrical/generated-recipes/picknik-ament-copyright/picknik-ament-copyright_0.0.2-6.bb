...
# matches with: https://github.com/ros2-gbp/picknik_ament_copyright-release/archive/release/lyrical/picknik_ament_copyright/0.0.2-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/picknik_ament_copyright"
SRC_URI = "git://github.com/ros2-gbp/picknik_ament_copyright-release;${ROS_BRANCH};protocol=https"
SRCREV = "cd46569cdd3c86ba38f7c310c0cac91a40b4d264"
S = "${WORKDIR}/git"
