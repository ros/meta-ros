...
# matches with: https://github.com/ros2-gbp/ntrip_client-release/archive/release/lyrical/ntrip_client/1.4.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ntrip_client"
SRC_URI = "git://github.com/ros2-gbp/ntrip_client-release;${ROS_BRANCH};protocol=https"
SRCREV = "e89f585e6496100920fa00852133721e05b3eeff"
S = "${WORKDIR}/git"
