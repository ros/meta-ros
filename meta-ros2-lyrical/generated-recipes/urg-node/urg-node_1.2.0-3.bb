...
# matches with: https://github.com/ros2-gbp/urg_node-release/archive/release/lyrical/urg_node/1.2.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/urg_node"
SRC_URI = "git://github.com/ros2-gbp/urg_node-release;${ROS_BRANCH};protocol=https"
SRCREV = "cf211a7eeca4f9b7f4ca29d9fccf6da1a7c906fb"
S = "${WORKDIR}/git"
