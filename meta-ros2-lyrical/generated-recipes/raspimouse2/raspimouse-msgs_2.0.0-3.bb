...
# matches with: https://github.com/ros2-gbp/raspimouse2-release/archive/release/lyrical/raspimouse_msgs/2.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/raspimouse_msgs"
SRC_URI = "git://github.com/ros2-gbp/raspimouse2-release;${ROS_BRANCH};protocol=https"
SRCREV = "1db4788aaab052b3115ce8be152a020235723a7b"
S = "${WORKDIR}/git"
