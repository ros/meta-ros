...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/lyrical/shape_msgs/5.9.2-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/shape_msgs"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "f0d682d681e2e798505cf8627e6ea6d62b85c8e5"
S = "${WORKDIR}/git"
