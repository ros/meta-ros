...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/lyrical/rosidl_parser/5.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "f46cef86da94fd3950a8ea81502e73fb4223b9f8"
S = "${WORKDIR}/git"
