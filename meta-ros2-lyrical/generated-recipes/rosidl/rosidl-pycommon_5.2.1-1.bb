...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/lyrical/rosidl_pycommon/5.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rosidl_pycommon"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "bef5b0486e1e2e7d240efafb14e0a6254d5db921"
S = "${WORKDIR}/git"
