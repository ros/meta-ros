...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/lyrical/demo_nodes_cpp/0.37.8-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/demo_nodes_cpp"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "6e63431c6821b11988d4e2d65702322255ecb65f"
S = "${WORKDIR}/git"
