...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/lyrical/lifecycle/0.37.8-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/lifecycle"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "9ba0a66f82b4ab156fa128a2ca853e33b071bd49"
S = "${WORKDIR}/git"
