...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/lyrical/mola_input_rosbag2/2.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/mola_input_rosbag2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "4911977b6840cd20fca25235bf9bf14155b915c8"
S = "${WORKDIR}/git"
