...
# matches with: https://github.com/ros2-gbp/mqtt_client-release/archive/release/lyrical/mqtt_client_interfaces/2.4.1-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/mqtt_client_interfaces"
SRC_URI = "git://github.com/ros2-gbp/mqtt_client-release;${ROS_BRANCH};protocol=https"
SRCREV = "39c37f2e94fb7d33fd2839c4beda889c62e8089f"
S = "${WORKDIR}/git"
