...
# matches with: https://github.com/ros2-gbp/image_pipeline-release/archive/release/lyrical/image_publisher/7.1.6-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/image_publisher"
SRC_URI = "git://github.com/ros2-gbp/image_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "102180819ba7f129104d17529d7de2363cac35ba"
S = "${WORKDIR}/git"
