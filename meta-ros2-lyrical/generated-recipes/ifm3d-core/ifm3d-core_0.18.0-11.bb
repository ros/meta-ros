...
# matches with: https://github.com/ros2-gbp/ifm3d-release/archive/release/lyrical/ifm3d_core/0.18.0-11.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ifm3d_core"
SRC_URI = "git://github.com/ros2-gbp/ifm3d-release;${ROS_BRANCH};protocol=https"
SRCREV = "3629886e4f1ac8553f0e47084210052a5b4744a5"
S = "${WORKDIR}/git"
