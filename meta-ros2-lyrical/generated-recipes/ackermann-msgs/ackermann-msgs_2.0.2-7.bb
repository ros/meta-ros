...
# matches with: https://github.com/ros2-gbp/ackermann_msgs-release/archive/release/lyrical/ackermann_msgs/2.0.2-7.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ackermann_msgs"
SRC_URI = "git://github.com/ros2-gbp/ackermann_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "d20c760a0ed9394a65ff2daeb8f5be5823983eb7"
S = "${WORKDIR}/git"
