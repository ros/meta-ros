...
# matches with: https://github.com/ros2-gbp/ament_cmake-release/archive/release/lyrical/ament_cmake_core/2.8.7-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ament_cmake_core"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake-release;${ROS_BRANCH};protocol=https"
SRCREV = "3783a87bad407304edf79852b90cfac70bfdcc13"
S = "${WORKDIR}/git"
