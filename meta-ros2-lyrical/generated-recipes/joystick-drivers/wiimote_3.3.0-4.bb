...
# matches with: https://github.com/ros2-gbp/joystick_drivers-release/archive/release/lyrical/wiimote/3.3.0-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/wiimote"
SRC_URI = "git://github.com/ros2-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "3bf199c1e531b8e1eefcae1a1b6294777eb89f15"
S = "${WORKDIR}/git"
