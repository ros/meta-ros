...
# matches with: https://github.com/ros2-gbp/joystick_drivers-release/archive/release/lyrical/joy_linux/3.3.0-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/joy_linux"
SRC_URI = "git://github.com/ros2-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "78bad7e3c30d7876f790b31dcaa8b6a8fd192326"
S = "${WORKDIR}/git"
