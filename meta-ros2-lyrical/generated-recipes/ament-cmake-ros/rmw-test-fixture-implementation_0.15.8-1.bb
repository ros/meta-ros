...
# matches with: https://github.com/ros2-gbp/ament_cmake_ros-release/archive/release/lyrical/rmw_test_fixture_implementation/0.15.8-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rmw_test_fixture_implementation"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "940647e4e74f8be0aeab24a1587278edb9bd0e5d"
S = "${WORKDIR}/git"
