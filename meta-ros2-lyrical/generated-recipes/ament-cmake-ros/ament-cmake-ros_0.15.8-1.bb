...
# matches with: https://github.com/ros2-gbp/ament_cmake_ros-release/archive/release/lyrical/ament_cmake_ros/0.15.8-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ament_cmake_ros"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "bbb57b1d1d99c1bc52c6204b7e646289607152fb"
S = "${WORKDIR}/git"
