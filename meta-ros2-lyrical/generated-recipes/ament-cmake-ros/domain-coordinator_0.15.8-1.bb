...
# matches with: https://github.com/ros2-gbp/ament_cmake_ros-release/archive/release/lyrical/domain_coordinator/0.15.8-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/domain_coordinator"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "523e8d4b19cf3365cccf13bce80e264275a3a7ee"
S = "${WORKDIR}/git"
