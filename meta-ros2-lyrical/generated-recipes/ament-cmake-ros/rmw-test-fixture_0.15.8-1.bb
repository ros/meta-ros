...
# matches with: https://github.com/ros2-gbp/ament_cmake_ros-release/archive/release/lyrical/rmw_test_fixture/0.15.8-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rmw_test_fixture"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "aae47e9915738629da83188f84adce4269eccddb"
S = "${WORKDIR}/git"
