...
# matches with: https://github.com/ros2-gbp/ros_canopen-release/archive/release/lyrical/can_msgs/2.0.0-7.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/can_msgs"
SRC_URI = "git://github.com/ros2-gbp/ros_canopen-release;${ROS_BRANCH};protocol=https"
SRCREV = "b114477911a5a000739ad998152fce2bb43842a9"
S = "${WORKDIR}/git"
