...
# matches with: https://github.com/ros2-gbp/ros_battery_monitoring-release/archive/release/lyrical/battery_state_rviz_overlay/1.2.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/battery_state_rviz_overlay"
SRC_URI = "git://github.com/ros2-gbp/ros_battery_monitoring-release;${ROS_BRANCH};protocol=https"
SRCREV = "df2809afc1cbfd94810841dbcf3e54cc6457c3ad"
S = "${WORKDIR}/git"
