...
# matches with: https://github.com/ros2-gbp/cpp_polyfills-release/archive/release/lyrical/tcb_span/2.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/tcb_span"
SRC_URI = "git://github.com/ros2-gbp/cpp_polyfills-release;${ROS_BRANCH};protocol=https"
SRCREV = "8a3cd699ddca24767e0e1d343224277a10da83f9"
S = "${WORKDIR}/git"
