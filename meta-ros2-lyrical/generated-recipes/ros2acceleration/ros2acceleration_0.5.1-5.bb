...
# matches with: https://github.com/ros2-gbp/ros2acceleration-release/archive/release/lyrical/ros2acceleration/0.5.1-5.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ros2acceleration"
SRC_URI = "git://github.com/ros2-gbp/ros2acceleration-release;${ROS_BRANCH};protocol=https"
SRCREV = "f9277a9afd8a1d4fadd5d29eeb0111484bc379a8"
S = "${WORKDIR}/git"
