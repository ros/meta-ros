...
# matches with: https://github.com/ros2-gbp/rmf_visualization-release/archive/release/lyrical/rmf_visualization_rviz2_plugins/2.6.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rmf_visualization_rviz2_plugins"
SRC_URI = "git://github.com/ros2-gbp/rmf_visualization-release;${ROS_BRANCH};protocol=https"
SRCREV = "728da391d5cd4e2b407ccf225ddf8907802bebb5"
S = "${WORKDIR}/git"
