...
# matches with: https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/lyrical/mola_georeferencing/2.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/mola_georeferencing"
SRC_URI = "git://github.com/ros2-gbp/mola_state_estimation-release;${ROS_BRANCH};protocol=https"
SRCREV = "e9e7e96b6bc1f4b946204a514da215dfc72f90c2"
S = "${WORKDIR}/git"
