...
# matches with: https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/lyrical/mola_gtsam_factors/2.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/mola_gtsam_factors"
SRC_URI = "git://github.com/ros2-gbp/mola_state_estimation-release;${ROS_BRANCH};protocol=https"
SRCREV = "015c1ca61367e67da7f7d088846007e8a8db3c04"
S = "${WORKDIR}/git"
