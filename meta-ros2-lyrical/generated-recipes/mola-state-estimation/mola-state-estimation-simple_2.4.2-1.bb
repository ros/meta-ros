...
# matches with: https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/lyrical/mola_state_estimation_simple/2.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/mola_state_estimation_simple"
SRC_URI = "git://github.com/ros2-gbp/mola_state_estimation-release;${ROS_BRANCH};protocol=https"
SRCREV = "cf2e04fcb0660df01c5f7f767a3d0a7541361f86"
S = "${WORKDIR}/git"
