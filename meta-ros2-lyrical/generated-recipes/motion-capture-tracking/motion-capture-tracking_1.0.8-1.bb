...
# matches with: https://github.com/ros2-gbp/motion_capture_tracking-release/archive/release/lyrical/motion_capture_tracking/1.0.8-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/motion_capture_tracking"
SRC_URI = "git://github.com/ros2-gbp/motion_capture_tracking-release;${ROS_BRANCH};protocol=https"
SRCREV = "26ef95a2af5f0a8a76f79edc8fe689fb943def40"
S = "${WORKDIR}/git"
