...
ROS_CN = "roboplan"
ROS_BPN = "roboplan_examples"

ROS_BUILD_DEPENDS = "\
    roboplan \
    roboplan-cartesian-planning \
...
# matches with: https://github.com/ros2-gbp/roboplan-release/archive/release/lyrical/roboplan_examples/0.6.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/roboplan_examples"
SRC_URI = "git://github.com/ros2-gbp/roboplan-release;${ROS_BRANCH};protocol=https"
SRCREV = "2429347abe16f8dd74b718ca016e9ae8411203e1"
