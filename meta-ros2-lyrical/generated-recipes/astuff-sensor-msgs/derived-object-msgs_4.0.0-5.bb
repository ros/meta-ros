...
# matches with: https://github.com/ros2-gbp/astuff_sensor_msgs-release/archive/release/lyrical/derived_object_msgs/4.0.0-5.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/derived_object_msgs"
SRC_URI = "git://github.com/ros2-gbp/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "9c39c56e1fb908366d2b921dd533481af9d9bc98"
S = "${WORKDIR}/git"
