...
# matches with: https://github.com/ros2-gbp/astuff_sensor_msgs-release/archive/release/lyrical/neobotix_usboard_msgs/4.0.0-5.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/neobotix_usboard_msgs"
SRC_URI = "git://github.com/ros2-gbp/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "159da242baa34dbfd29eeda50404b3c7e0f28bd3"
S = "${WORKDIR}/git"
