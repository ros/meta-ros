...
# matches with: https://github.com/ros2-gbp/astuff_sensor_msgs-release/archive/release/lyrical/delphi_mrr_msgs/4.0.0-5.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/delphi_mrr_msgs"
SRC_URI = "git://github.com/ros2-gbp/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "89f9ae10ae75583357b200506cc576a57fea08b5"
S = "${WORKDIR}/git"
