...
# matches with: https://github.com/ros2-gbp/astuff_sensor_msgs-release/archive/release/lyrical/delphi_esr_msgs/4.0.0-5.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/delphi_esr_msgs"
SRC_URI = "git://github.com/ros2-gbp/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "40943a9fa02f60a082cce90f72c9d70fb378aa36"
S = "${WORKDIR}/git"
