...
# matches with: https://github.com/ros2-gbp/astuff_sensor_msgs-release/archive/release/lyrical/delphi_srr_msgs/4.0.0-5.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/delphi_srr_msgs"
SRC_URI = "git://github.com/ros2-gbp/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "4e150a984b836b70f1311dc59c6c8fffcb919fa0"
S = "${WORKDIR}/git"
