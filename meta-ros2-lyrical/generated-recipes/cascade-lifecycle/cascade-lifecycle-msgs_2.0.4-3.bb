...
# matches with: https://github.com/ros2-gbp/cascade_lifecycle-release/archive/release/lyrical/cascade_lifecycle_msgs/2.0.4-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/cascade_lifecycle_msgs"
SRC_URI = "git://github.com/ros2-gbp/cascade_lifecycle-release;${ROS_BRANCH};protocol=https"
SRCREV = "18280112cb874cd2121be7bd6cf928292db9f721"
S = "${WORKDIR}/git"
