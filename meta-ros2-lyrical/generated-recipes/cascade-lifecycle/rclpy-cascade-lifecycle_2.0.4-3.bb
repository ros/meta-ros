...
# matches with: https://github.com/ros2-gbp/cascade_lifecycle-release/archive/release/lyrical/rclpy_cascade_lifecycle/2.0.4-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rclpy_cascade_lifecycle"
SRC_URI = "git://github.com/ros2-gbp/cascade_lifecycle-release;${ROS_BRANCH};protocol=https"
SRCREV = "b9c119237b8601de3d3f136fb907abcc7b991fcf"
S = "${WORKDIR}/git"
