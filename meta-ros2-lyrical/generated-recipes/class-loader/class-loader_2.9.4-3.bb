...
# matches with: https://github.com/ros2-gbp/class_loader-release/archive/release/lyrical/class_loader/2.9.4-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/class_loader"
SRC_URI = "git://github.com/ros2-gbp/class_loader-release;${ROS_BRANCH};protocol=https"
SRCREV = "a61afc401132071ceaf06b085f521f1dc6a7fd70"
S = "${WORKDIR}/git"
