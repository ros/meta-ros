...
# matches with: https://github.com/ros2-gbp/rclc-release/archive/release/lyrical/rclc_lifecycle/6.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rclc_lifecycle"
SRC_URI = "git://github.com/ros2-gbp/rclc-release;${ROS_BRANCH};protocol=https"
SRCREV = "a6ae35f11bbba31700b90be63e8d6f9548f1c868"
S = "${WORKDIR}/git"
