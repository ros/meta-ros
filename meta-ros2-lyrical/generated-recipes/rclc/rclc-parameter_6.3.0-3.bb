...
# matches with: https://github.com/ros2-gbp/rclc-release/archive/release/lyrical/rclc_parameter/6.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rclc_parameter"
SRC_URI = "git://github.com/ros2-gbp/rclc-release;${ROS_BRANCH};protocol=https"
SRCREV = "0979bd578c3cff6cf8e9675f25b40f1cd92f2f3b"
S = "${WORKDIR}/git"
