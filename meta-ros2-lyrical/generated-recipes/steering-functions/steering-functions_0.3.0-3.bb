...
# matches with: https://github.com/ros2-gbp/steering_functions-release/archive/release/lyrical/steering_functions/0.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/steering_functions"
SRC_URI = "git://github.com/ros2-gbp/steering_functions-release;${ROS_BRANCH};protocol=https"
SRCREV = "dedb13dea7d825ec3a067127683a04943d11af1d"
S = "${WORKDIR}/git"
