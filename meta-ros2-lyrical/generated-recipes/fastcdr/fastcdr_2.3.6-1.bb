...
# matches with: https://github.com/ros2-gbp/fastcdr-release/archive/release/lyrical/fastcdr/2.3.6-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/fastcdr"
SRC_URI = "git://github.com/ros2-gbp/fastcdr-release;${ROS_BRANCH};protocol=https"
SRCREV = "b2a53668e849d08521a7c17cacd36c03498fda42"
S = "${WORKDIR}/git"
