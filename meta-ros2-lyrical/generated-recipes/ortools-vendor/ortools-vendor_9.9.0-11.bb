...
# matches with: https://github.com/ros2-gbp/ortools_vendor-release/archive/release/lyrical/ortools_vendor/9.9.0-11.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ortools_vendor"
SRC_URI = "git://github.com/ros2-gbp/ortools_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "1748f03d0e5e6b5a59e01d686330cf1c76ff810e"
S = "${WORKDIR}/git"
