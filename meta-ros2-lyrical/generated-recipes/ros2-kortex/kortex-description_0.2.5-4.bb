...
# matches with: https://github.com/ros2-gbp/ros2_kortex-release/archive/release/lyrical/kortex_description/0.2.5-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/kortex_description"
SRC_URI = "git://github.com/ros2-gbp/ros2_kortex-release;${ROS_BRANCH};protocol=https"
SRCREV = "eea678eac81db9267753ac10fafa95962715c829"
S = "${WORKDIR}/git"
