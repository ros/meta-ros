...
# matches with: https://github.com/ros2-gbp/automotive_autonomy_msgs-release/archive/release/lyrical/automotive_navigation_msgs/3.0.4-7.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/automotive_navigation_msgs"
SRC_URI = "git://github.com/ros2-gbp/automotive_autonomy_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "96f19f98fbcaf1ea320b0d3eb6d90fc31db4d03d"
S = "${WORKDIR}/git"
