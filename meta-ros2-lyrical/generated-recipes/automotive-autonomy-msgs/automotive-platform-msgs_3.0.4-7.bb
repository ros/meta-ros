...
# matches with: https://github.com/ros2-gbp/automotive_autonomy_msgs-release/archive/release/lyrical/automotive_platform_msgs/3.0.4-7.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/automotive_platform_msgs"
SRC_URI = "git://github.com/ros2-gbp/automotive_autonomy_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "e7861b28d7618f666ccbf3e31fc5fa3b00cf45f4"
S = "${WORKDIR}/git"
