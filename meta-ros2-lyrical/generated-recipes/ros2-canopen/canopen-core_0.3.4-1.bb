...
# matches with: https://github.com/ros2-gbp/ros2_canopen-release/archive/release/lyrical/canopen_core/0.3.4-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/canopen_core"
SRC_URI = "git://github.com/ros2-gbp/ros2_canopen-release;${ROS_BRANCH};protocol=https"
SRCREV = "a8e31b2c24f7d0ef054cd19bf277fa7717949054"
S = "${WORKDIR}/git"
