...
# matches with: https://github.com/ros2-gbp/apriltag_detector-release/archive/release/lyrical/apriltag_detector_mit/3.0.4-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/apriltag_detector_mit"
SRC_URI = "git://github.com/ros2-gbp/apriltag_detector-release;${ROS_BRANCH};protocol=https"
SRCREV = "aece4046cdc54f91c1d335279a5ab9251c3ff4de"
S = "${WORKDIR}/git"
