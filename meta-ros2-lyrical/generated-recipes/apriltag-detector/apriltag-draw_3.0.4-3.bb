...
# matches with: https://github.com/ros2-gbp/apriltag_detector-release/archive/release/lyrical/apriltag_draw/3.0.4-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/apriltag_draw"
SRC_URI = "git://github.com/ros2-gbp/apriltag_detector-release;${ROS_BRANCH};protocol=https"
SRCREV = "8b56a382619c1b08f67843344a6cf59bdf5976a4"
S = "${WORKDIR}/git"
