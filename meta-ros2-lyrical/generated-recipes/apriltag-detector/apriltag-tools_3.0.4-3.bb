...
# matches with: https://github.com/ros2-gbp/apriltag_detector-release/archive/release/lyrical/apriltag_tools/3.0.4-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/apriltag_tools"
SRC_URI = "git://github.com/ros2-gbp/apriltag_detector-release;${ROS_BRANCH};protocol=https"
SRCREV = "c1e670dc87db77ba8af05aff42d275e616e48fb1"
S = "${WORKDIR}/git"
