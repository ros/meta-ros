...
# matches with: https://github.com/ros2-gbp/nmea_navsat_driver-release/archive/release/lyrical/nmea_navsat_driver/2.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/nmea_navsat_driver"
SRC_URI = "git://github.com/ros2-gbp/nmea_navsat_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "edbb98d460781bb0d4dc56725f7f4163f6072dfb"
S = "${WORKDIR}/git"
