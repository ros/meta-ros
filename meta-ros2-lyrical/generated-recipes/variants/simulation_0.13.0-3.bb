...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/lyrical/simulation/0.13.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/simulation"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "8bcd1f0344f9d3e8dc50fab1016efafd6bb36827"
S = "${WORKDIR}/git"
