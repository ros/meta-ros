...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/lyrical/desktop/0.13.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/desktop"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "e7dc1d4bfb33a5d66dd4a7b3a7d2bdc40793110e"
S = "${WORKDIR}/git"
