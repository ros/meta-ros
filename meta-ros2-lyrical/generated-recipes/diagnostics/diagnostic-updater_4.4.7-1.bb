...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/lyrical/diagnostic_updater/4.4.7-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/diagnostic_updater"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "af790d9e1fecb566e541a4f4b650d16ce2bb91ae"
S = "${WORKDIR}/git"
