...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/lyrical/diagnostic_common_diagnostics/4.4.7-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/diagnostic_common_diagnostics"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "78df12bdc8c57db02b1882170ef62b330594fd1c"
S = "${WORKDIR}/git"
