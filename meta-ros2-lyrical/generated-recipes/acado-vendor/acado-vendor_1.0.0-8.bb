...
# matches with: https://github.com/ros2-gbp/acado_vendor-release/archive/release/lyrical/acado_vendor/1.0.0-8.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/acado_vendor"
SRC_URI = "git://github.com/ros2-gbp/acado_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "babd3cbcd6e5ca549c119096cafff51e99102d51"
S = "${WORKDIR}/git"
