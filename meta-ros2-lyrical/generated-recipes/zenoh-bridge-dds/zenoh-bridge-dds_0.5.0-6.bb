...
# matches with: https://github.com/ros2-gbp/zenoh_bridge_dds-release/archive/release/lyrical/zenoh_bridge_dds/0.5.0-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/zenoh_bridge_dds"
SRC_URI = "git://github.com/ros2-gbp/zenoh_bridge_dds-release;${ROS_BRANCH};protocol=https"
SRCREV = "89e85a5127f5d75d98a1c9ebbdfcdb973150bc5e"
S = "${WORKDIR}/git"
