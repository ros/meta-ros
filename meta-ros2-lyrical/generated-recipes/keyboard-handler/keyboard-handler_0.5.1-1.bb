...
# matches with: https://github.com/ros2-gbp/keyboard_handler-release/archive/release/lyrical/keyboard_handler/0.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/keyboard_handler"
SRC_URI = "git://github.com/ros2-gbp/keyboard_handler-release;${ROS_BRANCH};protocol=https"
SRCREV = "702c15a1ddceb17800de3379f69342b102f95a58"
S = "${WORKDIR}/git"
