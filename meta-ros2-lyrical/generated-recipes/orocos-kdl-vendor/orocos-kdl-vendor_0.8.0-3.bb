...
# matches with: https://github.com/ros2-gbp/orocos_kdl_vendor-release/archive/release/lyrical/orocos_kdl_vendor/0.8.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/orocos_kdl_vendor"
SRC_URI = "git://github.com/ros2-gbp/orocos_kdl_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "906fc298c4e64c4e4826e8cd4efd4b3e57ae2715"
S = "${WORKDIR}/git"
