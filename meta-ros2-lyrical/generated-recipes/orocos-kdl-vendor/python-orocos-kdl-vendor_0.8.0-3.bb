...
# matches with: https://github.com/ros2-gbp/orocos_kdl_vendor-release/archive/release/lyrical/python_orocos_kdl_vendor/0.8.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/python_orocos_kdl_vendor"
SRC_URI = "git://github.com/ros2-gbp/orocos_kdl_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "e2c47b5e624df9cd91e60bd6e0bec223f7529e37"
S = "${WORKDIR}/git"
