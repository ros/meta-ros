...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/lyrical/ament_cmake_clang_format/0.20.6-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ament_cmake_clang_format"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "c5f896709028267bd32b900e167382fa8cb80aab"
S = "${WORKDIR}/git"
