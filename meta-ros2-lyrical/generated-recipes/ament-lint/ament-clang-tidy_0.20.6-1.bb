...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/lyrical/ament_clang_tidy/0.20.6-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ament_clang_tidy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "28fe67db4ddb2acfea81d63b33641c873231da94"
S = "${WORKDIR}/git"
