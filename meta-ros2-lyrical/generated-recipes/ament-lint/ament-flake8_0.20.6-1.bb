...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/lyrical/ament_flake8/0.20.6-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ament_flake8"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "232908054d2cd99daf959786ef7ca7cbf120a262"
S = "${WORKDIR}/git"
