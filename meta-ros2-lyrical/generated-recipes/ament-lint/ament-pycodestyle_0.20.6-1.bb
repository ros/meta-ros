...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/lyrical/ament_pycodestyle/0.20.6-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ament_pycodestyle"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "8efce6c5e4cd3ba0f664855d783b8b5dbd695f05"
S = "${WORKDIR}/git"
