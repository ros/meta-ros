...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/lyrical/ament_cmake_pycodestyle/0.20.6-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ament_cmake_pycodestyle"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "9203986912a568fd701805c6b9ceed4e31f7026c"
S = "${WORKDIR}/git"
