...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/lyrical/ament_cmake_mypy/0.20.6-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ament_cmake_mypy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "343efde1148b40269e8cacfd2fcf8230b46c4da6"
S = "${WORKDIR}/git"
