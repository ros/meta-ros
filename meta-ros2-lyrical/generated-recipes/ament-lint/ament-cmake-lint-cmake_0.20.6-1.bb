...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/lyrical/ament_cmake_lint_cmake/0.20.6-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ament_cmake_lint_cmake"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "2421f38462af87757a0f1481767f3618b7d0e2c9"
S = "${WORKDIR}/git"
