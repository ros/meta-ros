...
# matches with: https://github.com/ros2-gbp/mrt_cmake_modules-release/archive/release/lyrical/mrt_cmake_modules/1.0.11-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/mrt_cmake_modules"
SRC_URI = "git://github.com/ros2-gbp/mrt_cmake_modules-release;${ROS_BRANCH};protocol=https"
SRCREV = "d6711160b47d081ae2651b62fa72b80bb7ecbb44"
S = "${WORKDIR}/git"
