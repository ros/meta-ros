...
# matches with: https://github.com/ros2-gbp/librealsense2-release/archive/release/lyrical/librealsense2/2.57.7-7.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/librealsense2"
SRC_URI = "git://github.com/ros2-gbp/librealsense2-release;${ROS_BRANCH};protocol=https"
SRCREV = "538bf715ad3d5555fe86875a0e6b8a551008cd34"
S = "${WORKDIR}/git"
