...
# matches with: https://github.com/ros2-gbp/googletest-release/archive/release/lyrical/gtest_vendor/1.16.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/gtest_vendor"
SRC_URI = "git://github.com/ros2-gbp/googletest-release;${ROS_BRANCH};protocol=https"
SRCREV = "81d0753db77ecf530bc4b3e2f57d11c0876bd401"
S = "${WORKDIR}/git"
