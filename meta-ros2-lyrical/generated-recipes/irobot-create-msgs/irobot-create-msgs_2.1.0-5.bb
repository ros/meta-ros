...
# matches with: https://github.com/ros2-gbp/irobot_create_msgs-release/archive/release/lyrical/irobot_create_msgs/2.1.0-5.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/irobot_create_msgs"
SRC_URI = "git://github.com/ros2-gbp/irobot_create_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "27c8d92ac8137fe11e947c570a31f1650eb89b06"
S = "${WORKDIR}/git"
