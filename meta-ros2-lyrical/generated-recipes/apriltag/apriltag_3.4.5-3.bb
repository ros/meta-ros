...
# matches with: https://github.com/ros2-gbp/apriltag-release/archive/release/lyrical/apriltag/3.4.5-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/apriltag"
SRC_URI = "git://github.com/ros2-gbp/apriltag-release;${ROS_BRANCH};protocol=https"
SRCREV = "c1eabcb4daebbe4b2a812f43345d40fc299df927"
S = "${WORKDIR}/git"
