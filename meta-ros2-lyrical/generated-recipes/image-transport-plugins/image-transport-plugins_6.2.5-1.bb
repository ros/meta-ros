...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/lyrical/image_transport_plugins/6.2.5-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/image_transport_plugins"
SRC_URI = "git://github.com/ros2-gbp/image_transport_plugins-release;${ROS_BRANCH};protocol=https"
SRCREV = "d335f3f6e034032143fe02bffb2aaf368d04fc8d"
S = "${WORKDIR}/git"
