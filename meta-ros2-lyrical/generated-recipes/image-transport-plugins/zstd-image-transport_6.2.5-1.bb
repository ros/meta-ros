...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/lyrical/zstd_image_transport/6.2.5-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/zstd_image_transport"
SRC_URI = "git://github.com/ros2-gbp/image_transport_plugins-release;${ROS_BRANCH};protocol=https"
SRCREV = "e26ca5cecf71f6e39dd0736c14db7da06d85c2b3"
S = "${WORKDIR}/git"
