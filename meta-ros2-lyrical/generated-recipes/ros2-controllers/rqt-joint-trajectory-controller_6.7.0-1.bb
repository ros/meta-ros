...
# matches with: https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/rqt_joint_trajectory_controller/6.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rqt_joint_trajectory_controller"
SRC_URI = "git://github.com/ros2-gbp/ros2_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "bd1eccd5204a150e57095b1b299b146e99cb4315"
S = "${WORKDIR}/git"
