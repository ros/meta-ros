...
# matches with: https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/bicycle_steering_controller/6.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/bicycle_steering_controller"
SRC_URI = "git://github.com/ros2-gbp/ros2_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "b0543f7fe0a52b8ddc400b437603e99e8282167c"
S = "${WORKDIR}/git"
