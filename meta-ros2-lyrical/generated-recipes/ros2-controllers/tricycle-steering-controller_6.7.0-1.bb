...
# matches with: https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/tricycle_steering_controller/6.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/tricycle_steering_controller"
SRC_URI = "git://github.com/ros2-gbp/ros2_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "fe86f5ad67a435222665a343d82f6d39a9e9b811"
S = "${WORKDIR}/git"
