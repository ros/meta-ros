...
# matches with: https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/parallel_gripper_controller/6.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/parallel_gripper_controller"
SRC_URI = "git://github.com/ros2-gbp/ros2_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "10485963dba55389195cc3a81fa47e3f24689a38"
S = "${WORKDIR}/git"
