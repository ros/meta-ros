...
# matches with: https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/chained_filter_controller/6.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/chained_filter_controller"
SRC_URI = "git://github.com/ros2-gbp/ros2_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "c0a4a43ffdfa623e48fff76eccd8374eaf4e484a"
S = "${WORKDIR}/git"
