...
# matches with: https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/ackermann_steering_controller/6.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ackermann_steering_controller"
SRC_URI = "git://github.com/ros2-gbp/ros2_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "e5e6a58627504b2a801d3c78a537c3120403c481"
S = "${WORKDIR}/git"
