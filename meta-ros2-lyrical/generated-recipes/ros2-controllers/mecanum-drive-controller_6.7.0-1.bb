...
# matches with: https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/mecanum_drive_controller/6.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/mecanum_drive_controller"
SRC_URI = "git://github.com/ros2-gbp/ros2_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "23175fe33836aa15c4ef92c314a1cf6e5d8f880d"
S = "${WORKDIR}/git"
