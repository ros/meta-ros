...
# matches with: https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/state_interfaces_broadcaster/6.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/state_interfaces_broadcaster"
SRC_URI = "git://github.com/ros2-gbp/ros2_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "d880d2a8368324a93326ca5768ca3078ef21d79a"
S = "${WORKDIR}/git"
