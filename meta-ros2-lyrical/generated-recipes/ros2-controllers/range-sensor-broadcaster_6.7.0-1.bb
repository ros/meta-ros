...
# matches with: https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/range_sensor_broadcaster/6.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/range_sensor_broadcaster"
SRC_URI = "git://github.com/ros2-gbp/ros2_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "7eca9c983854876c89f1ac83ea6fc22d5fe0da0c"
S = "${WORKDIR}/git"
