...
# matches with: https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/lyrical/microstrain_inertial_msgs/4.8.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/microstrain_inertial_msgs"
SRC_URI = "git://github.com/ros2-gbp/microstrain_inertial-release;${ROS_BRANCH};protocol=https"
SRCREV = "e1cd49270b140cebd5b5adde46fcb8071483f3e9"
S = "${WORKDIR}/git"
