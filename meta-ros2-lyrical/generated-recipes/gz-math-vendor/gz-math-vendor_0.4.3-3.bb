...
DESCRIPTION = "Vendor package for: gz-math 9.1.0      Gazebo Math : Math classes and functions for robot applications"
...
# matches with: https://github.com/ros2-gbp/gz_math_vendor-release/archive/release/lyrical/gz_math_vendor/0.4.3-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/gz_math_vendor"
SRC_URI = "git://github.com/ros2-gbp/gz_math_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "80a08a311dffcd1179cb75c07ba9494d58e5a0f1"
S = "${WORKDIR}/git"
