...
# matches with: https://github.com/ros2-gbp/sick_safevisionary_ros2-release/archive/release/lyrical/sick_safevisionary_driver/1.0.3-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/sick_safevisionary_driver"
SRC_URI = "git://github.com/ros2-gbp/sick_safevisionary_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d789cc47c749f0c865bfae135d6d90eeae064148"
S = "${WORKDIR}/git"
