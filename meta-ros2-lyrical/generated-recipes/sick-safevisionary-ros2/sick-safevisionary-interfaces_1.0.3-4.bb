...
# matches with: https://github.com/ros2-gbp/sick_safevisionary_ros2-release/archive/release/lyrical/sick_safevisionary_interfaces/1.0.3-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/sick_safevisionary_interfaces"
SRC_URI = "git://github.com/ros2-gbp/sick_safevisionary_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "0b923722b832bde04f37f492ce40903a6d44790e"
S = "${WORKDIR}/git"
