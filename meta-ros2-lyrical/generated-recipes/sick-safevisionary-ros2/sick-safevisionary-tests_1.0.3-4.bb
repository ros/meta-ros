...
# matches with: https://github.com/ros2-gbp/sick_safevisionary_ros2-release/archive/release/lyrical/sick_safevisionary_tests/1.0.3-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/sick_safevisionary_tests"
SRC_URI = "git://github.com/ros2-gbp/sick_safevisionary_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "45755f66d7bd137af690cb624dec4816d1219d0f"
S = "${WORKDIR}/git"
