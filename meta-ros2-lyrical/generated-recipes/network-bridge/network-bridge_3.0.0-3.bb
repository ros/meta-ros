...
# matches with: https://github.com/ros2-gbp/network_bridge-release/archive/release/lyrical/network_bridge/3.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/network_bridge"
SRC_URI = "git://github.com/ros2-gbp/network_bridge-release;${ROS_BRANCH};protocol=https"
SRCREV = "df8c01d3e9f990985ff4d61fc876f0f007fe1c73"
S = "${WORKDIR}/git"
