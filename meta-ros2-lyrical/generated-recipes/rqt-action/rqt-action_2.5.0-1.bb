...
# matches with: https://github.com/ros2-gbp/rqt_action-release/archive/release/lyrical/rqt_action/2.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rqt_action"
SRC_URI = "git://github.com/ros2-gbp/rqt_action-release;${ROS_BRANCH};protocol=https"
SRCREV = "a1bfeb58f2b817156843922f87d04b47520fc197"
S = "${WORKDIR}/git"
