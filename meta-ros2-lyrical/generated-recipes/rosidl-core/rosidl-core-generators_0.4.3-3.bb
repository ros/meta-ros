...
# matches with: https://github.com/ros2-gbp/rosidl_core-release/archive/release/lyrical/rosidl_core_generators/0.4.3-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rosidl_core_generators"
SRC_URI = "git://github.com/ros2-gbp/rosidl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "1a4aa4d60ee14f17cfc08dd6af9ec45b6ae5d960"
S = "${WORKDIR}/git"
