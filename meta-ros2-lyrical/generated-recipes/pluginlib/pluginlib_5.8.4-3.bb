...
# matches with: https://github.com/ros2-gbp/pluginlib-release/archive/release/lyrical/pluginlib/5.8.4-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/pluginlib"
SRC_URI = "git://github.com/ros2-gbp/pluginlib-release;${ROS_BRANCH};protocol=https"
SRCREV = "1762af75daeb81c5950efb2ac21f9f1750f4f2e9"
S = "${WORKDIR}/git"
