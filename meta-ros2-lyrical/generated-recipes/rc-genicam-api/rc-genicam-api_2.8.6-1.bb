...
# matches with: https://github.com/ros2-gbp/rc_genicam_api-release/archive/release/lyrical/rc_genicam_api/2.8.6-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rc_genicam_api"
SRC_URI = "git://github.com/ros2-gbp/rc_genicam_api-release;${ROS_BRANCH};protocol=https"
SRCREV = "df25048fe2edcd6ef8ca2c847295859712b92c76"
S = "${WORKDIR}/git"
