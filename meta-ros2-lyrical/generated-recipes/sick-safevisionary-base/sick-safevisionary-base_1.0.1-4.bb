...
# matches with: https://github.com/ros2-gbp/sick_safevisionary_base-release/archive/release/lyrical/sick_safevisionary_base/1.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/sick_safevisionary_base"
SRC_URI = "git://github.com/ros2-gbp/sick_safevisionary_base-release;${ROS_BRANCH};protocol=https"
SRCREV = "477ce5a5055c0f0dcc88c9a80d6abb521e6edb9a"
S = "${WORKDIR}/git"
