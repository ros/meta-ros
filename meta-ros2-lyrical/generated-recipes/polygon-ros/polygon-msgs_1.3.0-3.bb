...
# matches with: https://github.com/ros2-gbp/polygon_ros-release/archive/release/lyrical/polygon_msgs/1.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/polygon_msgs"
SRC_URI = "git://github.com/ros2-gbp/polygon_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "6a0785d9deb01a18ce7e652d9b89ae688c821f7f"
S = "${WORKDIR}/git"
