...
# matches with: https://github.com/ros2-gbp/micro_ros_msgs-release/archive/release/lyrical/micro_ros_msgs/1.0.0-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/micro_ros_msgs"
SRC_URI = "git://github.com/ros2-gbp/micro_ros_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "d88a7d1f4557c9feb7f1e3eca2b84db349673465"
S = "${WORKDIR}/git"
