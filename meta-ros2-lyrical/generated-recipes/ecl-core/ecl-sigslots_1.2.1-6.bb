...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_sigslots/1.2.1-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ecl_sigslots"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "cfbf2b307afa8467f00ec0f0f0550219c1bcb512"
S = "${WORKDIR}/git"
