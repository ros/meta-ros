...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_manipulators/1.2.1-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ecl_manipulators"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "e77ad7172299650a804023577a0246b2d869cd83"
S = "${WORKDIR}/git"
