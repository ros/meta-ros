...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_formatters/1.2.1-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ecl_formatters"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "07f612d68944208bba253bc6997cddca98ad7a17"
S = "${WORKDIR}/git"
