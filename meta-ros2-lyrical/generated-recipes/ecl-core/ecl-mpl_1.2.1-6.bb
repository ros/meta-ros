...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_mpl/1.2.1-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ecl_mpl"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "2bf45bbd99602b3ee1eedefb36840a2c3b6f40fe"
S = "${WORKDIR}/git"
