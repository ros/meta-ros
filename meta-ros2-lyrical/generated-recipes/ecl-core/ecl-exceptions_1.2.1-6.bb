...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_exceptions/1.2.1-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ecl_exceptions"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "df832727b7409a76cb062f0631dbed02f478f2eb"
S = "${WORKDIR}/git"
