...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_mobile_robot/1.2.1-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ecl_mobile_robot"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "ca5e9be1945d2e7cf7b580a1ac00ea1cbaa64ed0"
S = "${WORKDIR}/git"
