...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_geometry/1.2.1-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ecl_geometry"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "f8c37b851d4276cc4d6f34ca262c3164c82b0ebb"
S = "${WORKDIR}/git"
