...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_threads/1.2.1-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ecl_threads"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "26b96e5c75628a8f1a1493387089f6cdca8f2cc3"
S = "${WORKDIR}/git"
