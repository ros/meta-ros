...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_converters/1.2.1-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ecl_converters"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "200404f920c1288d0d9698cd7fadb1516086cd5d"
S = "${WORKDIR}/git"
