...
# matches with: https://github.com/ros2-gbp/aruco_opencv-release/archive/release/lyrical/aruco_opencv_msgs/6.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/aruco_opencv_msgs"
SRC_URI = "git://github.com/ros2-gbp/aruco_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "b5fba80939767e7a283d2cafc6be5380ea380ae9"
S = "${WORKDIR}/git"
