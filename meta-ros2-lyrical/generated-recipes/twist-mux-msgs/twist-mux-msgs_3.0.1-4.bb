...
# matches with: https://github.com/ros2-gbp/twist_mux_msgs-release/archive/release/lyrical/twist_mux_msgs/3.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/twist_mux_msgs"
SRC_URI = "git://github.com/ros2-gbp/twist_mux_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "be67cdeede068d367d5dc457acffcfcd568a7763"
S = "${WORKDIR}/git"
