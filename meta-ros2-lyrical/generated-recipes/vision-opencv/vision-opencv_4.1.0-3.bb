...
# matches with: https://github.com/ros2-gbp/vision_opencv-release/archive/release/lyrical/vision_opencv/4.1.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/vision_opencv"
SRC_URI = "git://github.com/ros2-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "5d775c08776170da4a0e6bdf4202cab63cc746dc"
S = "${WORKDIR}/git"
