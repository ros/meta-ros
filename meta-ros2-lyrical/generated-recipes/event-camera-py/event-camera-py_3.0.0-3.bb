...
# matches with: https://github.com/ros2-gbp/event_camera_py-release/archive/release/lyrical/event_camera_py/3.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/event_camera_py"
SRC_URI = "git://github.com/ros2-gbp/event_camera_py-release;${ROS_BRANCH};protocol=https"
SRCREV = "b7a98d11dbd8fa06531e1da5330ad6ad36fff447"
S = "${WORKDIR}/git"
