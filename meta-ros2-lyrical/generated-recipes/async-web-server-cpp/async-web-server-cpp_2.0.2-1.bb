...
# matches with: https://github.com/ros2-gbp/async_web_server_cpp-release/archive/release/lyrical/async_web_server_cpp/2.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/async_web_server_cpp"
SRC_URI = "git://github.com/ros2-gbp/async_web_server_cpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "976b862414999aa9b06490a57515a7019e6e15d0"
S = "${WORKDIR}/git"
