...
# matches with: https://github.com/ros2-gbp/rosbag2_to_video-release/archive/release/lyrical/rosbag2_to_video/1.0.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rosbag2_to_video"
SRC_URI = "git://github.com/ros2-gbp/rosbag2_to_video-release;${ROS_BRANCH};protocol=https"
SRCREV = "e32312557afd05039a8c9ad58071a58087aad9ca"
S = "${WORKDIR}/git"
