...
# matches with: https://github.com/ros2-gbp/eigen_stl_containers-release/archive/release/lyrical/eigen_stl_containers/1.1.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/eigen_stl_containers"
SRC_URI = "git://github.com/ros2-gbp/eigen_stl_containers-release;${ROS_BRANCH};protocol=https"
SRCREV = "b1dd5c10625804264d20378552e4a27d7756ee66"
S = "${WORKDIR}/git"
