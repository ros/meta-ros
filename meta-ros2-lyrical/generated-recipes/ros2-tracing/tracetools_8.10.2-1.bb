...
# matches with: https://github.com/ros2-gbp/ros2_tracing-release/archive/release/lyrical/tracetools/8.10.2-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/tracetools"
SRC_URI = "git://github.com/ros2-gbp/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "1e1b7f3097371326453d7542fd855c01117dda0a"
S = "${WORKDIR}/git"
