...
# matches with: https://github.com/ros2-gbp/ros2_tracing-release/archive/release/lyrical/tracetools_trace/8.10.2-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/tracetools_trace"
SRC_URI = "git://github.com/ros2-gbp/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "4aff273a37aa76d1cfd82f882d90a4ef10a4d240"
S = "${WORKDIR}/git"
