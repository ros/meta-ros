...
# matches with: https://github.com/ros2-gbp/ros2_tracing-release/archive/release/lyrical/tracetools_read/8.10.2-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/tracetools_read"
SRC_URI = "git://github.com/ros2-gbp/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "14a59501b2ccff08027a9d8e59d6153846330a2b"
S = "${WORKDIR}/git"
