...
# matches with: https://github.com/ros2-gbp/ros2_tracing-release/archive/release/lyrical/tracetools_test/8.10.2-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/tracetools_test"
SRC_URI = "git://github.com/ros2-gbp/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "081e13b46edfa403ebe7aec67b55f8b0f3fd9fd4"
S = "${WORKDIR}/git"
