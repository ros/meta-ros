...
# matches with: https://github.com/ros2-gbp/image_common-release/archive/release/lyrical/camera_info_manager_py/6.4.10-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/camera_info_manager_py"
SRC_URI = "git://github.com/ros2-gbp/image_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "bd0aab40b3dae2b710b2f485998e82a4cc1e8428"
S = "${WORKDIR}/git"
