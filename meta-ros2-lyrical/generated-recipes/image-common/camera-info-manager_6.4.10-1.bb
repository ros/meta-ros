...
# matches with: https://github.com/ros2-gbp/image_common-release/archive/release/lyrical/camera_info_manager/6.4.10-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/camera_info_manager"
SRC_URI = "git://github.com/ros2-gbp/image_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "d15f1e6425585b00c68be305ed2e9dd82fcb2356"
S = "${WORKDIR}/git"
