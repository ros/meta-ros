...
# matches with: https://github.com/ros2-gbp/image_common-release/archive/release/lyrical/camera_calibration_parsers/6.4.10-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/camera_calibration_parsers"
SRC_URI = "git://github.com/ros2-gbp/image_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "1031a00fb33d58c5f0dad394c1daf65892026cf7"
S = "${WORKDIR}/git"
