...
# matches with: https://github.com/ros2-gbp/image_common-release/archive/release/lyrical/image_common/6.4.10-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/image_common"
SRC_URI = "git://github.com/ros2-gbp/image_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "47d2e6f784a1ec44e9e80067981f205f7d49ecff"
S = "${WORKDIR}/git"
