...
# matches with: https://github.com/ros2-gbp/marti_messages-release/archive/release/lyrical/marti_dbw_msgs/1.6.1-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/marti_dbw_msgs"
SRC_URI = "git://github.com/ros2-gbp/marti_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "6b1469e5758689348ffddee4acde280ace8f39fd"
S = "${WORKDIR}/git"
