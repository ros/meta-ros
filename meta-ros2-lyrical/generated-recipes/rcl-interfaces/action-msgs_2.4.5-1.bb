...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/lyrical/action_msgs/2.4.5-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/action_msgs"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "f940c6381d7a57ead0e293d092880d0d34df5efd"
S = "${WORKDIR}/git"
