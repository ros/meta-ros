...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/lyrical/lifecycle_msgs/2.4.5-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/lifecycle_msgs"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "d8a314b81fe70589342a25a7039b591e9953cdfa"
S = "${WORKDIR}/git"
