...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/lyrical/statistics_msgs/2.4.5-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/statistics_msgs"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "0e8ef7791a0295225591ac6780e235a30266a078"
S = "${WORKDIR}/git"
