...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/lyrical/type_description_interfaces/2.4.5-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/type_description_interfaces"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "543961b4e884335e9bc20f349871a5d2aa835a1d"
S = "${WORKDIR}/git"
