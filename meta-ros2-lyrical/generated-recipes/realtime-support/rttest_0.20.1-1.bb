...
# matches with: https://github.com/ros2-gbp/realtime_support-release/archive/release/lyrical/rttest/0.20.1-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rttest"
SRC_URI = "git://github.com/ros2-gbp/realtime_support-release;${ROS_BRANCH};protocol=https"
SRCREV = "a2a3e68d6e403c0fbf28af4fb3daf6676a4987f6"
S = "${WORKDIR}/git"
