...
# matches with: https://github.com/ros2-gbp/eigen3_cmake_module-release/archive/release/lyrical/eigen3_cmake_module/0.5.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/eigen3_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/eigen3_cmake_module-release;${ROS_BRANCH};protocol=https"
SRCREV = "22a8f713bf498472ebe39aa9547dbb7c997a3cbd"
S = "${WORKDIR}/git"
