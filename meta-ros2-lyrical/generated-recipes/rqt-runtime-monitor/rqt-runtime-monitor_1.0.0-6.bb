...
# matches with: https://github.com/ros2-gbp/rqt_runtime_monitor-release/archive/release/lyrical/rqt_runtime_monitor/1.0.0-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rqt_runtime_monitor"
SRC_URI = "git://github.com/ros2-gbp/rqt_runtime_monitor-release;${ROS_BRANCH};protocol=https"
SRCREV = "54b5f3b771e72a588ec0eb1df59e12601c9cada7"
S = "${WORKDIR}/git"
