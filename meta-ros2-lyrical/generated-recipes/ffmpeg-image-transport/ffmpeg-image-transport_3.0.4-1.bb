...
# matches with: https://github.com/ros2-gbp/ffmpeg_image_transport-release/archive/release/lyrical/ffmpeg_image_transport/3.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ffmpeg_image_transport"
SRC_URI = "git://github.com/ros2-gbp/ffmpeg_image_transport-release;${ROS_BRANCH};protocol=https"
SRCREV = "4d5c7e1f2793c91215dcc07ddf9dd7df20103c1f"
S = "${WORKDIR}/git"
