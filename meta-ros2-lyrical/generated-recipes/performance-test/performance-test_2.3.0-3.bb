...
# matches with: https://github.com/ros2-gbp/performance_test-release/archive/release/lyrical/performance_test/2.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/performance_test"
SRC_URI = "git://github.com/ros2-gbp/performance_test-release;${ROS_BRANCH};protocol=https"
SRCREV = "b2bd0289f7ac35316e130fec7ae46722243589ac"
S = "${WORKDIR}/git"
