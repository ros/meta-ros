...
# matches with: https://github.com/ros2-gbp/ros_workspace-release/archive/release/lyrical/ros_workspace/1.0.3-9.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ros_workspace"
SRC_URI = "git://github.com/ros2-gbp/ros_workspace-release;${ROS_BRANCH};protocol=https"
SRCREV = "a36e9d5df77c331ab387345db8bd8aeafa54e48a"
S = "${WORKDIR}/git"
