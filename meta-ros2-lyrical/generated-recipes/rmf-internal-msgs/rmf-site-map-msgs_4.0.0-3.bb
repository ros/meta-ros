...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/lyrical/rmf_site_map_msgs/4.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rmf_site_map_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "bd55a9b547bf96a2180ed070ca9fe9706ca12985"
S = "${WORKDIR}/git"
