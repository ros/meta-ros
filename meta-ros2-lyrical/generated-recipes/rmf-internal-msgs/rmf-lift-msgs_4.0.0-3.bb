...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/lyrical/rmf_lift_msgs/4.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rmf_lift_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "ee8a9bf1a55ffeecb53dda0d10d3427aba529c7a"
S = "${WORKDIR}/git"
