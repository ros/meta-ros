...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/lyrical/rmf_scheduler_msgs/4.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rmf_scheduler_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "00c800ac1f0488cd9455b4de8444b34136a11cb6"
S = "${WORKDIR}/git"
