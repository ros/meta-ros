...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/lyrical/rmf_dispenser_msgs/4.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rmf_dispenser_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "a8dfee2a9280a92d135e647e4b230b29a5f943cf"
S = "${WORKDIR}/git"
