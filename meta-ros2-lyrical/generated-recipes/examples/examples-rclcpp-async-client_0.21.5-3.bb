...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/lyrical/examples_rclcpp_async_client/0.21.5-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/examples_rclcpp_async_client"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "73f15c48ee121f86381c5ffb9da1a036499ea39b"
S = "${WORKDIR}/git"
