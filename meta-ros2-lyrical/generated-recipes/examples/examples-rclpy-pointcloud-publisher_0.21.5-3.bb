...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/lyrical/examples_rclpy_pointcloud_publisher/0.21.5-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/examples_rclpy_pointcloud_publisher"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "12041244ebea05533de6bc3e4fb44a628d0c48b4"
S = "${WORKDIR}/git"
