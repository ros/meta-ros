...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/lyrical/examples_rclcpp_minimal_action_client/0.21.5-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/examples_rclcpp_minimal_action_client"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "f3633680a9bfcb16e9e2378ed206bd66c323d1d9"
S = "${WORKDIR}/git"
