...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/lyrical/examples_rclpy_minimal_service/0.21.5-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/examples_rclpy_minimal_service"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "e664b334fa3fca3ac4256ac11d3eb639cd804b29"
S = "${WORKDIR}/git"
