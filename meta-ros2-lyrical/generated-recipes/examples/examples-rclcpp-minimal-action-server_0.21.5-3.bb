...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/lyrical/examples_rclcpp_minimal_action_server/0.21.5-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/examples_rclcpp_minimal_action_server"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "5ebb245eb5720ba2178b607920a1bd9c7e86bbda"
S = "${WORKDIR}/git"
