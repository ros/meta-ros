...
# matches with: https://github.com/ros2-gbp/kobuki_ros_interfaces-release/archive/release/lyrical/kobuki_ros_interfaces/1.0.0-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/kobuki_ros_interfaces"
SRC_URI = "git://github.com/ros2-gbp/kobuki_ros_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "711ee0e84fdf8bdfa3f008d3ee68fb02077e5e4b"
S = "${WORKDIR}/git"
