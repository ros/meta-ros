...
# matches with: https://github.com/ros2-gbp/ouster-ros-release/archive/release/lyrical/ouster_ros/0.14.2-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ouster_ros"
SRC_URI = "git://github.com/ros2-gbp/ouster-ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "0f36375395eff4a60443a23f7c23f6a0e93e3d7e"
S = "${WORKDIR}/git"
