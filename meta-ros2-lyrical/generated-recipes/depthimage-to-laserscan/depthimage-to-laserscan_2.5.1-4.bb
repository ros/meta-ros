...
# matches with: https://github.com/ros2-gbp/depthimage_to_laserscan-release/archive/release/lyrical/depthimage_to_laserscan/2.5.1-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/depthimage_to_laserscan"
SRC_URI = "git://github.com/ros2-gbp/depthimage_to_laserscan-release;${ROS_BRANCH};protocol=https"
SRCREV = "257ffe17ad3c83156ac9ad91282e8d951dddf987"
S = "${WORKDIR}/git"
