...
# matches with: https://github.com/ros2-gbp/ublox-release/archive/release/lyrical/ublox_msgs/3.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ublox_msgs"
SRC_URI = "git://github.com/ros2-gbp/ublox-release;${ROS_BRANCH};protocol=https"
SRCREV = "d0f90aafa3eb499abed723a2d7a390b4417517b4"
S = "${WORKDIR}/git"
