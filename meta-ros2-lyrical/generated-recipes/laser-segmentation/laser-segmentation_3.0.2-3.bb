...
# matches with: https://github.com/ros2-gbp/laser_segmentation-release/archive/release/lyrical/laser_segmentation/3.0.2-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/laser_segmentation"
SRC_URI = "git://github.com/ros2-gbp/laser_segmentation-release;${ROS_BRANCH};protocol=https"
SRCREV = "4de7913ff9ae3e6f40fa0e558524324b96aae6ec"
S = "${WORKDIR}/git"
