...
# matches with: https://github.com/ros2-gbp/py_trees_ros_tutorials-release/archive/release/lyrical/py_trees_ros_tutorials/2.4.0-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/py_trees_ros_tutorials"
SRC_URI = "git://github.com/ros2-gbp/py_trees_ros_tutorials-release;${ROS_BRANCH};protocol=https"
SRCREV = "a87149c3fa03173a201d32b9756a8f1ff997c17d"
S = "${WORKDIR}/git"
