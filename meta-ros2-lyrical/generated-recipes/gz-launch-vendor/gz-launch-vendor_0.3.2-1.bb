...
DESCRIPTION = "Vendor package for: gz-launch 9.0.1      Gazebo Launch : Run and manage programs and plugins"
...
# matches with: https://github.com/ros2-gbp/gz_launch_vendor-release/archive/release/lyrical/gz_launch_vendor/0.3.2-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/gz_launch_vendor"
SRC_URI = "git://github.com/ros2-gbp/gz_launch_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "520cc661b920c184b326dc33d847e2547a4d7284"
S = "${WORKDIR}/git"
