...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/lyrical/bond/4.4.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/bond"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "ea560b7060f3d0e15c2ffbafb1eedaec562da751"
S = "${WORKDIR}/git"
