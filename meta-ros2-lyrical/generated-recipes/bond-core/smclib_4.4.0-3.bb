...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/lyrical/smclib/4.4.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/smclib"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "bc2db84527cf0ba67fb4f7960d8f03603e28cd85"
S = "${WORKDIR}/git"
