...
# matches with: https://github.com/ros2-gbp/google_benchmark_vendor-release/archive/release/lyrical/google_benchmark_vendor/0.7.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/google_benchmark_vendor"
SRC_URI = "git://github.com/ros2-gbp/google_benchmark_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "162d048238280f80e3bf627285bad21340dced19"
S = "${WORKDIR}/git"
