...
# matches with: https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/lyrical/phidgets_drivers/2.4.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/phidgets_drivers"
SRC_URI = "git://github.com/ros2-gbp/phidgets_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "b505422687383162a39ae8cca86fe35a1cdade3a"
S = "${WORKDIR}/git"
