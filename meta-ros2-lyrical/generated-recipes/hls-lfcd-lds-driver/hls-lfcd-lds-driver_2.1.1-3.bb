...
# matches with: https://github.com/ros2-gbp/hls_lfcd_lds_driver-release/archive/release/lyrical/hls_lfcd_lds_driver/2.1.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/hls_lfcd_lds_driver"
SRC_URI = "git://github.com/ros2-gbp/hls_lfcd_lds_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "7ed39b537ad995d6cd114185f6a2b6e131758abf"
S = "${WORKDIR}/git"
