...
# matches with: https://github.com/ros2-gbp/resource_retriever-release/archive/release/lyrical/resource_retriever/3.9.3-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/resource_retriever"
SRC_URI = "git://github.com/ros2-gbp/resource_retriever-release;${ROS_BRANCH};protocol=https"
SRCREV = "cfb5fdc2b2b5577e497806e823757b6def881e14"
S = "${WORKDIR}/git"
