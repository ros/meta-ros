...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_setup_core_plugins/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_setup_core_plugins"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "4d66fcc7727e05ae9e84d692fb6840ca819aaaaf"
S = "${WORKDIR}/git"
