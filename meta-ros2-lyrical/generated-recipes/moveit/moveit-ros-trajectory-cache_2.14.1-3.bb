...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_ros_trajectory_cache/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_ros_trajectory_cache"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "c4c4a148aea5e74f8ebfb57df5d7b172348098a4"
S = "${WORKDIR}/git"
