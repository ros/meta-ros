...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/pilz_industrial_motion_planner_testutils/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/pilz_industrial_motion_planner_testutils"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b8d082e9548a6e5a5a38a6039eb2f0034d3d400e"
S = "${WORKDIR}/git"
