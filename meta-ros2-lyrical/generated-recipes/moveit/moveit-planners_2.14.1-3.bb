...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_planners/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_planners"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "2ea66dfc2f189a05da2668485caa95eb63a8e8ea"
S = "${WORKDIR}/git"
