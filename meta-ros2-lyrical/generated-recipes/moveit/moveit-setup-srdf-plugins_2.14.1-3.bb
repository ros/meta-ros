...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_setup_srdf_plugins/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_setup_srdf_plugins"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b5a8df59d1c213ee2646ad1acde1a874a8d626e9"
S = "${WORKDIR}/git"
