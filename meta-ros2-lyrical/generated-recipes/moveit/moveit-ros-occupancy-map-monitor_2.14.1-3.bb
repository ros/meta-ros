...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_ros_occupancy_map_monitor/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_ros_occupancy_map_monitor"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a7a18dd200b8a7c285d085e6b2202925c4cac60b"
S = "${WORKDIR}/git"
