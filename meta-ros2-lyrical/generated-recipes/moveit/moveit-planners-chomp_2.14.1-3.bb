...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_planners_chomp/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_planners_chomp"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "05ef6e86199259f1b0bbf9cf60f6a1a507693462"
S = "${WORKDIR}/git"
