...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_planners_ompl/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_planners_ompl"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "4f6740433f30f164c1626d8b0ee6acd419ea3eca"
S = "${WORKDIR}/git"
