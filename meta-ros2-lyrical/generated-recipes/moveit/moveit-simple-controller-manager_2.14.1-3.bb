...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_simple_controller_manager/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_simple_controller_manager"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "f745491bc7eef42b289e185ac93ff19ebcc23c0e"
S = "${WORKDIR}/git"
