...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5e5e5c70daa3e1f1d583bd88f21d8ec01fc75b09"
S = "${WORKDIR}/git"
