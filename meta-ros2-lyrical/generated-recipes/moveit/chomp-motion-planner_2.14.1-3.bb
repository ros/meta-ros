...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/chomp_motion_planner/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/chomp_motion_planner"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "4280d5b587f170051e4e22f6f8df4ce63af4364a"
S = "${WORKDIR}/git"
