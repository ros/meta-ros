...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_ros_robot_interaction/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_ros_robot_interaction"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a96f7e7f5676f0eeed553aa8103399fa356ddea6"
S = "${WORKDIR}/git"
