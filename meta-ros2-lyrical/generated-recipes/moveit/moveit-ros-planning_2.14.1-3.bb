...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_ros_planning/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_ros_planning"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "333f6887420917035f02de0690595122936f90f5"
S = "${WORKDIR}/git"
