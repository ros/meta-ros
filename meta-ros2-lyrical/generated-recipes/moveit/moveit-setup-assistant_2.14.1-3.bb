...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_setup_assistant/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_setup_assistant"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a72fdeb33350b071ca27b87a3b65cae97f4d07cc"
S = "${WORKDIR}/git"
