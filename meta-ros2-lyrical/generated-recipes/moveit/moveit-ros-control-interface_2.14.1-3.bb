...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_ros_control_interface/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_ros_control_interface"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e9758865715d0c1af8a9aab2da5261655b3041cb"
S = "${WORKDIR}/git"
