...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_servo/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_servo"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "6ce5ab1ba0a12808f65006f9e8c390afbcbe019e"
S = "${WORKDIR}/git"
