...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_plugins/2.14.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_plugins"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "1259f78d34ae196354a0930d599793405ff0b020"
S = "${WORKDIR}/git"
