...
# matches with: https://github.com/ros2-gbp/at_sonde_ros_driver-release/archive/release/lyrical/at_sonde_ros_driver/1.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/at_sonde_ros_driver"
SRC_URI = "git://github.com/ros2-gbp/at_sonde_ros_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "3e1dfa86d7371599e1ed1b8d92e520c5875724f8"
S = "${WORKDIR}/git"
