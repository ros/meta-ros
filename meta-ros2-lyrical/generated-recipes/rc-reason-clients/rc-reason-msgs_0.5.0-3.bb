...
# matches with: https://github.com/ros2-gbp/rc_reason_clients-release/archive/release/lyrical/rc_reason_msgs/0.5.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rc_reason_msgs"
SRC_URI = "git://github.com/ros2-gbp/rc_reason_clients-release;${ROS_BRANCH};protocol=https"
SRCREV = "a99a47174991bd15c4a38daf3e8e4a37f747af3b"
S = "${WORKDIR}/git"
