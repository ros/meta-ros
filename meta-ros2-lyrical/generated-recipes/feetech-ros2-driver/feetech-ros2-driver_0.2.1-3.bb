...
# matches with: https://github.com/ros2-gbp/feetech_ros2_driver-release/archive/release/lyrical/feetech_ros2_driver/0.2.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/feetech_ros2_driver"
SRC_URI = "git://github.com/ros2-gbp/feetech_ros2_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "f962372d89869395dc163123064053969f64f4e2"
S = "${WORKDIR}/git"
