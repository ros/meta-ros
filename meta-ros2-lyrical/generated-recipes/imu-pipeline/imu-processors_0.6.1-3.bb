...
# matches with: https://github.com/ros2-gbp/imu_pipeline-release/archive/release/lyrical/imu_processors/0.6.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/imu_processors"
SRC_URI = "git://github.com/ros2-gbp/imu_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "0b753f41f9d38ba80a91a8c92a9cd140dd37be7b"
S = "${WORKDIR}/git"
