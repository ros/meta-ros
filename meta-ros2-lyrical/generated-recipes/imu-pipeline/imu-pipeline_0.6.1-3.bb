...
# matches with: https://github.com/ros2-gbp/imu_pipeline-release/archive/release/lyrical/imu_pipeline/0.6.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/imu_pipeline"
SRC_URI = "git://github.com/ros2-gbp/imu_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "29aa650ca785ee2424984546a3cd3a51d502b901"
S = "${WORKDIR}/git"
