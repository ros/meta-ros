...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/lyrical/lanelet2_projection/1.2.1-8.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/lanelet2_projection"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "14436d6a968533e73639969e8cd5159d5750ce2c"
S = "${WORKDIR}/git"
