...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/lyrical/lanelet2/1.2.1-8.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/lanelet2"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5061f213606de2ecc0e16495ca550a21203ceed8"
S = "${WORKDIR}/git"
