...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/lyrical/lanelet2_routing/1.2.1-8.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/lanelet2_routing"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "be7fb02008e135d138fc246b0cf7faccfa1e9e9a"
S = "${WORKDIR}/git"
