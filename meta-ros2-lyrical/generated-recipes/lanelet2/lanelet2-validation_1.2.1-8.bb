...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/lyrical/lanelet2_validation/1.2.1-8.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/lanelet2_validation"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a20b58c26da42c38d4eb46d4850bd769a15bd85f"
S = "${WORKDIR}/git"
