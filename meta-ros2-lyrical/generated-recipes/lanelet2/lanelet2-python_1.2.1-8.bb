...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/lyrical/lanelet2_python/1.2.1-8.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/lanelet2_python"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "749f0019f217a05a37377425336a22bc951ebdf9"
S = "${WORKDIR}/git"
