...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/lyrical/lanelet2_traffic_rules/1.2.1-8.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/lanelet2_traffic_rules"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "2d53088448ee0f2c6ccaac629d4d8b103ca1732e"
S = "${WORKDIR}/git"
