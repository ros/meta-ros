...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/lyrical/lanelet2_core/1.2.1-8.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/lanelet2_core"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "c757653d0db06d55af0276dacc57c5db8080c092"
S = "${WORKDIR}/git"
