...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/lyrical/lanelet2_maps/1.2.1-8.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/lanelet2_maps"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "049325c6271df275bd37704211d89f1a030ec62d"
S = "${WORKDIR}/git"
