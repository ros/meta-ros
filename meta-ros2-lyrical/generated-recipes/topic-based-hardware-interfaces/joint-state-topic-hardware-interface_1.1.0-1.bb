...
# matches with: https://github.com/ros2-gbp/topic_based_hardware-release/archive/release/lyrical/joint_state_topic_hardware_interface/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/joint_state_topic_hardware_interface"
SRC_URI = "git://github.com/ros2-gbp/topic_based_hardware-release;${ROS_BRANCH};protocol=https"
SRCREV = "bd3983d1a71c1a2a311f1b948b4a18e05b36bf72"
S = "${WORKDIR}/git"
