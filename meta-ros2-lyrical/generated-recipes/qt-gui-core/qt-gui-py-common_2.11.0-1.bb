...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/lyrical/qt_gui_py_common/2.11.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/qt_gui_py_common"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "387fa37b217d0197d89fb688468211f6acc880b8"
S = "${WORKDIR}/git"
