...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/lyrical/tf2_bullet/0.45.7-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/tf2_bullet"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b0aeb0516c5d6db3638f1caf3ec497a7c39cd584"
S = "${WORKDIR}/git"
