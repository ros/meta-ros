...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/lyrical/tf2_tools/0.45.7-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "ebc12755fe73d7282dfe7617afe3c22a9a50b604"
S = "${WORKDIR}/git"
