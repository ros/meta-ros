...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/lyrical/tf2_geometry_msgs/0.45.7-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/tf2_geometry_msgs"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8fda229b7c7cd1fce93bdb3b72df005ea5fc41ea"
S = "${WORKDIR}/git"
