...
# matches with: https://github.com/ros2-gbp/rmf_battery-release/archive/release/lyrical/rmf_battery/0.4.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rmf_battery"
SRC_URI = "git://github.com/ros2-gbp/rmf_battery-release;${ROS_BRANCH};protocol=https"
SRCREV = "6b76180660600f62a41939b13973e5f4a0472aee"
S = "${WORKDIR}/git"
