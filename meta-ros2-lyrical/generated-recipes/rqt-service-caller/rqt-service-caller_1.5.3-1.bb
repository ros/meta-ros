...
# matches with: https://github.com/ros2-gbp/rqt_service_caller-release/archive/release/lyrical/rqt_service_caller/1.5.3-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rqt_service_caller"
SRC_URI = "git://github.com/ros2-gbp/rqt_service_caller-release;${ROS_BRANCH};protocol=https"
SRCREV = "d345f051913068f5a3aee1069b056257147cfb8e"
S = "${WORKDIR}/git"
