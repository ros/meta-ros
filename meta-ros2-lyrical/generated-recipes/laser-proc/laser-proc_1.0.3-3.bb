...
# matches with: https://github.com/ros2-gbp/laser_proc-release/archive/release/lyrical/laser_proc/1.0.3-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/laser_proc"
SRC_URI = "git://github.com/ros2-gbp/laser_proc-release;${ROS_BRANCH};protocol=https"
SRCREV = "c126a550dec03cfaba72cea5f04db039655f9211"
S = "${WORKDIR}/git"
