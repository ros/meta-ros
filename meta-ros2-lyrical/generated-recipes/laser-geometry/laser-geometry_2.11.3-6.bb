...
# matches with: https://github.com/ros2-gbp/laser_geometry-release/archive/release/lyrical/laser_geometry/2.11.3-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/laser_geometry"
SRC_URI = "git://github.com/ros2-gbp/laser_geometry-release;${ROS_BRANCH};protocol=https"
SRCREV = "5f930e4ff7d093cdbd0a45d08172876d66ca133c"
S = "${WORKDIR}/git"
