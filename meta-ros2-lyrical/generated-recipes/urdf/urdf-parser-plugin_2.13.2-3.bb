...
# matches with: https://github.com/ros2-gbp/urdf-release/archive/release/lyrical/urdf_parser_plugin/2.13.2-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/urdf_parser_plugin"
SRC_URI = "git://github.com/ros2-gbp/urdf-release;${ROS_BRANCH};protocol=https"
SRCREV = "06f925cdc79ee005af6317f0b0998425d410ea06"
S = "${WORKDIR}/git"
