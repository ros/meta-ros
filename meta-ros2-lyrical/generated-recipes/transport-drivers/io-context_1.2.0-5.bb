...
# matches with: https://github.com/ros2-gbp/transport_drivers-release/archive/release/lyrical/io_context/1.2.0-5.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/io_context"
SRC_URI = "git://github.com/ros2-gbp/transport_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "9930d28d534edb7aa0f67ede2552644bf71853e1"
S = "${WORKDIR}/git"
