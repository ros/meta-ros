...
# matches with: https://github.com/ros2-gbp/urdfdom_headers-release/archive/release/lyrical/urdfdom_headers/3.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/urdfdom_headers"
SRC_URI = "git://github.com/ros2-gbp/urdfdom_headers-release;${ROS_BRANCH};protocol=https"
SRCREV = "39a1026200aa8d293b99b4acf666d6b689ea090d"
S = "${WORKDIR}/git"
