...
# matches with: https://github.com/ros2-gbp/velodyne-release/archive/release/lyrical/velodyne_driver/2.5.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/velodyne_driver"
SRC_URI = "git://github.com/ros2-gbp/velodyne-release;${ROS_BRANCH};protocol=https"
SRCREV = "19a2ab137272a6475b26f31b58a52901feb8965d"
S = "${WORKDIR}/git"
