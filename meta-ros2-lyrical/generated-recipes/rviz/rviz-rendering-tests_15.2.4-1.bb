...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/lyrical/rviz_rendering_tests/15.2.4-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rviz_rendering_tests"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "233f8773f4ca5e08124aefafbfc543dc06405586"
S = "${WORKDIR}/git"
