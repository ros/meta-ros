...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/lyrical/rviz_rendering/15.2.4-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rviz_rendering"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "cf65ae1b1ae2ef1c344d8fb39e2e4f8d689ed39b"
S = "${WORKDIR}/git"
