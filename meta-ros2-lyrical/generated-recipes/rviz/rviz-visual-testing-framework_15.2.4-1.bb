...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/lyrical/rviz_visual_testing_framework/15.2.4-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rviz_visual_testing_framework"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "9879eb2af7fd39fb25d55ed0beb6a3e76124b383"
S = "${WORKDIR}/git"
