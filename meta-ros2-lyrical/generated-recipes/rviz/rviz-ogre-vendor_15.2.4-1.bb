...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/lyrical/rviz_ogre_vendor/15.2.4-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "7193bf13fa8dcb3fa8b4a59a5952a8048b0d8ed2"
S = "${WORKDIR}/git"
