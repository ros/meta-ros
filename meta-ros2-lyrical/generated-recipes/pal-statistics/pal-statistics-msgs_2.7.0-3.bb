...
# matches with: https://github.com/ros2-gbp/pal_statistics-release/archive/release/lyrical/pal_statistics_msgs/2.7.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/pal_statistics_msgs"
SRC_URI = "git://github.com/ros2-gbp/pal_statistics-release;${ROS_BRANCH};protocol=https"
SRCREV = "65a2b3b5ce9be4956a6765fdbcf31138fc8ed24d"
S = "${WORKDIR}/git"
