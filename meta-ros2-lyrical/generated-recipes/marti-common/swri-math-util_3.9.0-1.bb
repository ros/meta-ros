...
# matches with: https://github.com/ros2-gbp/marti_common-release/archive/release/lyrical/swri_math_util/3.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/swri_math_util"
SRC_URI = "git://github.com/ros2-gbp/marti_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "1bc8a1775912fda902420699de0c2699ca309cf2"
S = "${WORKDIR}/git"
