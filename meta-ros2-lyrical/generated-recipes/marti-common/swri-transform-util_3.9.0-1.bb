...
# matches with: https://github.com/ros2-gbp/marti_common-release/archive/release/lyrical/swri_transform_util/3.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/swri_transform_util"
SRC_URI = "git://github.com/ros2-gbp/marti_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "94bf6eb394db2bab4725209b2cbaf9458b0270bc"
S = "${WORKDIR}/git"
