...
# matches with: https://github.com/ros2-gbp/marti_common-release/archive/release/lyrical/swri_dbw_interface/3.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/swri_dbw_interface"
SRC_URI = "git://github.com/ros2-gbp/marti_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "8b4a655135831a567471faf172781d0b9612aa6b"
S = "${WORKDIR}/git"
