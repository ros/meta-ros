...
# matches with: https://github.com/ros2-gbp/event_camera_msgs-release/archive/release/lyrical/event_camera_msgs/2.0.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/event_camera_msgs"
SRC_URI = "git://github.com/ros2-gbp/event_camera_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "a3a8a7b983f99d9fec1ded30294b34d277f475fe"
S = "${WORKDIR}/git"
