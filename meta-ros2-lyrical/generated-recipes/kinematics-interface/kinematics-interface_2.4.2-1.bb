...
# matches with: https://github.com/ros2-gbp/kinematics_interface-release/archive/release/lyrical/kinematics_interface/2.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/kinematics_interface"
SRC_URI = "git://github.com/ros2-gbp/kinematics_interface-release;${ROS_BRANCH};protocol=https"
SRCREV = "9de01450cca519d86f44cd2ea82a2613d4a460c8"
S = "${WORKDIR}/git"
