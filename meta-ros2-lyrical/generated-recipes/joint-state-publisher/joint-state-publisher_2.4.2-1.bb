...
# matches with: https://github.com/ros2-gbp/joint_state_publisher-release/archive/release/lyrical/joint_state_publisher/2.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/joint_state_publisher"
SRC_URI = "git://github.com/ros2-gbp/joint_state_publisher-release;${ROS_BRANCH};protocol=https"
SRCREV = "37d36c4f663ae047a123a1d4b3be7c14f98bbf2d"
S = "${WORKDIR}/git"
