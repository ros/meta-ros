...
# matches with: https://github.com/ros2-gbp/joint_state_publisher-release/archive/release/lyrical/joint_state_publisher_gui/2.4.2-1.tar.gz
...
SRCREV = "c54d777675796482f9f63fcfe57d4e9b2de1017a"
S = "${WORKDIR}/git"
