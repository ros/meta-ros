...
# matches with: https://github.com/ros2-gbp/boost_geometry_util-release/archive/release/lyrical/boost_geometry_util/0.0.1-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/boost_geometry_util"
SRC_URI = "git://github.com/ros2-gbp/boost_geometry_util-release;${ROS_BRANCH};protocol=https"
SRCREV = "e3018a5caa6717734ce3d1f1c9c2cf6b999993e9"
S = "${WORKDIR}/git"
