...
# matches with: https://github.com/ros2-gbp/rc_genicam_driver_ros2-release/archive/release/lyrical/rc_genicam_driver/0.4.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rc_genicam_driver"
SRC_URI = "git://github.com/ros2-gbp/rc_genicam_driver_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "db75556d27edf3377eaaa2db311600f2aa9d9fa8"
S = "${WORKDIR}/git"
