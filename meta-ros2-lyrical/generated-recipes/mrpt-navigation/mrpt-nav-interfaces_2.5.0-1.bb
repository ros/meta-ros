...
# matches with: https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/lyrical/mrpt_nav_interfaces/2.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/mrpt_nav_interfaces"
SRC_URI = "git://github.com/ros2-gbp/mrpt_navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "5222db27eb2c91379b8188e8a25502aa0250b150"
S = "${WORKDIR}/git"
