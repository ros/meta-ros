...
# matches with: https://github.com/ros2-gbp/gps_umd-release/archive/release/lyrical/gpsd_client/2.1.2-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/gpsd_client"
SRC_URI = "git://github.com/ros2-gbp/gps_umd-release;${ROS_BRANCH};protocol=https"
SRCREV = "a5f1bad15e4a2fa9b91206c7bd7f58708e80aeaf"
S = "${WORKDIR}/git"
