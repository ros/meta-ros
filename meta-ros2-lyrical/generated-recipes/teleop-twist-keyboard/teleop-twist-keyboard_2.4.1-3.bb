...
# matches with: https://github.com/ros2-gbp/teleop_twist_keyboard-release/archive/release/lyrical/teleop_twist_keyboard/2.4.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/teleop_twist_keyboard"
SRC_URI = "git://github.com/ros2-gbp/teleop_twist_keyboard-release;${ROS_BRANCH};protocol=https"
SRCREV = "701ff770882742d43f4a899f2d080587605aa7c1"
S = "${WORKDIR}/git"
