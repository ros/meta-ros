...
# matches with: https://github.com/ros2-gbp/ros_testing-release/archive/release/lyrical/ros2test/0.9.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ros2test"
SRC_URI = "git://github.com/ros2-gbp/ros_testing-release;${ROS_BRANCH};protocol=https"
SRCREV = "310854007542719b25b82374f4743c0e572c2b67"
S = "${WORKDIR}/git"
