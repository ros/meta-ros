...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/lyrical/fuse_variables/1.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/fuse_variables"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "aa6b011d81d86bd0aa286f90b0900ff8103b5d87"
S = "${WORKDIR}/git"
