...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/lyrical/fuse_optimizers/1.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/fuse_optimizers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "2bf676d8e961413a8dea6c67884bbd8747f6d149"
S = "${WORKDIR}/git"
