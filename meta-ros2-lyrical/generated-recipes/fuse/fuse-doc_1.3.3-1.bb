...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/lyrical/fuse_doc/1.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/fuse_doc"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "141726ca149809f595ef090bd75f9fbf37f47607"
S = "${WORKDIR}/git"
