...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/lyrical/fuse_constraints/1.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/fuse_constraints"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "6199eddcd46bb111c37ef67fb0844ee998ca2ac7"
S = "${WORKDIR}/git"
