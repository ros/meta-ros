...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/lyrical/fuse_msgs/1.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/fuse_msgs"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "1cfb28fca16ce37de6ddf6c71284f8da5af1e37b"
S = "${WORKDIR}/git"
