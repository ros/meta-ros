...
# matches with: https://github.com/ros2-gbp/rc_dynamics_api-release/archive/release/lyrical/rc_dynamics_api/0.10.5-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rc_dynamics_api"
SRC_URI = "git://github.com/ros2-gbp/rc_dynamics_api-release;${ROS_BRANCH};protocol=https"
SRCREV = "a705b77a7edce2cf7f81b8d32e0e29849407c1de"
S = "${WORKDIR}/git"
