...
# matches with: https://github.com/ros2-gbp/ament_cmake_catch2-release/archive/release/lyrical/ament_cmake_catch2/1.5.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ament_cmake_catch2"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake_catch2-release;${ROS_BRANCH};protocol=https"
SRCREV = "9571ea322597e81e31eb73ab2639f190b09eb6cd"
S = "${WORKDIR}/git"
