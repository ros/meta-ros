...
DESCRIPTION = "Vendor package for: gz-transport 15.0.2      Gazebo Transport: Provides fast and efficient asynchronous message passing, services, and data logging."
...
# matches with: https://github.com/ros2-gbp/gz_transport_vendor-release/archive/release/lyrical/gz_transport_vendor/0.3.4-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/gz_transport_vendor"
SRC_URI = "git://github.com/ros2-gbp/gz_transport_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "fe42181734199674a93fd274fe53809ea5871d00"
S = "${WORKDIR}/git"
