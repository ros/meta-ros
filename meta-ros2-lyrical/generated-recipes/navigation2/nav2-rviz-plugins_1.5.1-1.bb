...
ROS_EXEC_DEPENDS = "\
    ${ROS_UNRESOLVED_DEP-libqt6statemachine6} \
    backward-ros \
    geometry-msgs \
    nav-msgs \
    nav2-lifecycle-manager \
...
# matches with: https://github.com/ros2-gbp/navigation2-release/archive/release/lyrical/nav2_rviz_plugins/1.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/nav2_rviz_plugins"
SRC_URI = "git://github.com/ros2-gbp/navigation2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a45df0a2d2b75c43f0ca2b74eb19c58f8bbe1d2d"
