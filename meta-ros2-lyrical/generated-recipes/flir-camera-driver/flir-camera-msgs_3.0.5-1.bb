...
# matches with: https://github.com/ros2-gbp/flir_camera_driver-release/archive/release/lyrical/flir_camera_msgs/3.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/flir_camera_msgs"
SRC_URI = "git://github.com/ros2-gbp/flir_camera_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "53407ecd9be51dc783d32d1f9607d8551109df73"
S = "${WORKDIR}/git"
