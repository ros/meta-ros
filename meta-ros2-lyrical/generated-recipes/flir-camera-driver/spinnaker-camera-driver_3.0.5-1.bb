...
# matches with: https://github.com/ros2-gbp/flir_camera_driver-release/archive/release/lyrical/spinnaker_camera_driver/3.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/spinnaker_camera_driver"
SRC_URI = "git://github.com/ros2-gbp/flir_camera_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "90da992aed51467a7055153bf0a0eb489c19c9b5"
S = "${WORKDIR}/git"
