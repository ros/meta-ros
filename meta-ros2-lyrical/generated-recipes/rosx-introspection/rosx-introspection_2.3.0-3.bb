...
# matches with: https://github.com/ros2-gbp/rosx_introspection-release/archive/release/lyrical/rosx_introspection/2.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rosx_introspection"
SRC_URI = "git://github.com/ros2-gbp/rosx_introspection-release;${ROS_BRANCH};protocol=https"
SRCREV = "615864c4eb47b1c84740988313a51467e5b8a81e"
S = "${WORKDIR}/git"
