...
# matches with: https://github.com/ros2-gbp/ros2_control-release/archive/release/lyrical/controller_interface/6.7.1-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/controller_interface"
SRC_URI = "git://github.com/ros2-gbp/ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "a2ec6df9b0758083c736470a5437a964796145e3"
S = "${WORKDIR}/git"
