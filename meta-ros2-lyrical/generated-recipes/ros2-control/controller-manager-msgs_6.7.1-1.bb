...
# matches with: https://github.com/ros2-gbp/ros2_control-release/archive/release/lyrical/controller_manager_msgs/6.7.1-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/controller_manager_msgs"
SRC_URI = "git://github.com/ros2-gbp/ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "7bf29e4aa5ad64ca51496e28aba97d8095d2a2a1"
S = "${WORKDIR}/git"
