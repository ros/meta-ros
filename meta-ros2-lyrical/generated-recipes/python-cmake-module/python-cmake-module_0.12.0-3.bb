...
# matches with: https://github.com/ros2-gbp/python_cmake_module-release/archive/release/lyrical/python_cmake_module/0.12.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/python_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/python_cmake_module-release;${ROS_BRANCH};protocol=https"
SRCREV = "403c8b05aaf294b3a64b4b91746dcb44461d2adb"
S = "${WORKDIR}/git"
