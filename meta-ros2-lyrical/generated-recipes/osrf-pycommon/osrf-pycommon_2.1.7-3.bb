...
# matches with: https://github.com/ros2-gbp/osrf_pycommon-release/archive/release/lyrical/osrf_pycommon/2.1.7-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/osrf_pycommon"
SRC_URI = "git://github.com/ros2-gbp/osrf_pycommon-release;${ROS_BRANCH};protocol=https"
SRCREV = "a06776458a8599b6da83f423362bf33ed217599e"
S = "${WORKDIR}/git"
