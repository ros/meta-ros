...
# matches with: https://github.com/ros2-gbp/rclcpp-release/archive/release/lyrical/rclcpp_lifecycle/32.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rclcpp_lifecycle"
SRC_URI = "git://github.com/ros2-gbp/rclcpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "ef57f7eda6c5a188cce3daf32f1557e2b808a487"
S = "${WORKDIR}/git"
