...
# matches with: https://github.com/ros2-gbp/ld08_driver-release/archive/release/lyrical/ld08_driver/1.1.4-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ld08_driver"
SRC_URI = "git://github.com/ros2-gbp/ld08_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "72f57a6c94ee0357723e41fc9835739a991f1c0f"
S = "${WORKDIR}/git"
