...
# matches with: https://github.com/ros2-gbp/flexbe_behavior_engine-release/archive/release/lyrical/flexbe_states/4.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/flexbe_states"
SRC_URI = "git://github.com/ros2-gbp/flexbe_behavior_engine-release;${ROS_BRANCH};protocol=https"
SRCREV = "d513796126456881be94b610bbf67ac1d11e082b"
S = "${WORKDIR}/git"
