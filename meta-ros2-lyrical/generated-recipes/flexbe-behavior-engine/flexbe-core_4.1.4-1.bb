...
# matches with: https://github.com/ros2-gbp/flexbe_behavior_engine-release/archive/release/lyrical/flexbe_core/4.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/flexbe_core"
SRC_URI = "git://github.com/ros2-gbp/flexbe_behavior_engine-release;${ROS_BRANCH};protocol=https"
SRCREV = "21076c0234de4eb45528127aeee371769f0f1b17"
S = "${WORKDIR}/git"
