...
# matches with: https://github.com/ros2-gbp/flexbe_behavior_engine-release/archive/release/lyrical/flexbe_msgs/4.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/flexbe_msgs"
SRC_URI = "git://github.com/ros2-gbp/flexbe_behavior_engine-release;${ROS_BRANCH};protocol=https"
SRCREV = "964d4c128290b508c9e5fddec75152783ae8cc7b"
S = "${WORKDIR}/git"
