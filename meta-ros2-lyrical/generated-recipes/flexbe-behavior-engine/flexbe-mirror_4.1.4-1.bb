...
# matches with: https://github.com/ros2-gbp/flexbe_behavior_engine-release/archive/release/lyrical/flexbe_mirror/4.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/flexbe_mirror"
SRC_URI = "git://github.com/ros2-gbp/flexbe_behavior_engine-release;${ROS_BRANCH};protocol=https"
SRCREV = "2b7c04d5f7526a9ad5009a5a2f9896fa3c164df5"
S = "${WORKDIR}/git"
