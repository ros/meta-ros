...
# matches with: https://github.com/ros2-gbp/flexbe_behavior_engine-release/archive/release/lyrical/flexbe_testing/4.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/flexbe_testing"
SRC_URI = "git://github.com/ros2-gbp/flexbe_behavior_engine-release;${ROS_BRANCH};protocol=https"
SRCREV = "64d9b24b512a8cb63fea1fdc8a9436a2b370de50"
S = "${WORKDIR}/git"
