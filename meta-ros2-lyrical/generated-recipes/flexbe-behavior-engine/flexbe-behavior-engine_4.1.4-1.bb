...
# matches with: https://github.com/ros2-gbp/flexbe_behavior_engine-release/archive/release/lyrical/flexbe_behavior_engine/4.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/flexbe_behavior_engine"
SRC_URI = "git://github.com/ros2-gbp/flexbe_behavior_engine-release;${ROS_BRANCH};protocol=https"
SRCREV = "2fac4de1910bc27c004741fb5bbf26901023b588"
S = "${WORKDIR}/git"
