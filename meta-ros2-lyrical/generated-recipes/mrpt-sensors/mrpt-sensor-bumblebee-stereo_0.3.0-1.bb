...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/lyrical/mrpt_sensor_bumblebee_stereo/0.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/mrpt_sensor_bumblebee_stereo"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "00ad04fe3c6211efcd1e855cdac0a226299bd671"
S = "${WORKDIR}/git"
