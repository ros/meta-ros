...
# matches with: https://github.com/ros2-gbp/micro_ros_diagnostics-release/archive/release/lyrical/micro_ros_diagnostic_msgs/0.3.0-7.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/micro_ros_diagnostic_msgs"
SRC_URI = "git://github.com/ros2-gbp/micro_ros_diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "9f781ddeb1b5bea2a251df387b1f948313cefbfd"
S = "${WORKDIR}/git"
