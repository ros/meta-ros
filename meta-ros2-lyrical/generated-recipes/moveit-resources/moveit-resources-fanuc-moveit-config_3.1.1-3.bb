...
# matches with: https://github.com/ros2-gbp/moveit_resources-release/archive/release/lyrical/moveit_resources_fanuc_moveit_config/3.1.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_resources_fanuc_moveit_config"
SRC_URI = "git://github.com/ros2-gbp/moveit_resources-release;${ROS_BRANCH};protocol=https"
SRCREV = "fbcb1cded912982d684bf2fd71097287e66caffe"
S = "${WORKDIR}/git"
