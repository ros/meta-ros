...
# matches with: https://github.com/ros2-gbp/moveit_resources-release/archive/release/lyrical/moveit_resources_panda_description/3.1.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_resources_panda_description"
SRC_URI = "git://github.com/ros2-gbp/moveit_resources-release;${ROS_BRANCH};protocol=https"
SRCREV = "26737444ae66af8223bfd2a47b9c7953a480f95b"
S = "${WORKDIR}/git"
