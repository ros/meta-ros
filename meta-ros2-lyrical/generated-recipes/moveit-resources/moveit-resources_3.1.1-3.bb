...
# matches with: https://github.com/ros2-gbp/moveit_resources-release/archive/release/lyrical/moveit_resources/3.1.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_resources"
SRC_URI = "git://github.com/ros2-gbp/moveit_resources-release;${ROS_BRANCH};protocol=https"
SRCREV = "7d4ed2e82350e43e0eb85db504bb3379d5b92fc4"
S = "${WORKDIR}/git"
