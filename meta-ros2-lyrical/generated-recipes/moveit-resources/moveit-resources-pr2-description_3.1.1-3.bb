...
# matches with: https://github.com/ros2-gbp/moveit_resources-release/archive/release/lyrical/moveit_resources_pr2_description/3.1.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/moveit_resources_pr2_description"
SRC_URI = "git://github.com/ros2-gbp/moveit_resources-release;${ROS_BRANCH};protocol=https"
SRCREV = "bb228786d8db195b77f286dbe35a1ab83c0036b3"
S = "${WORKDIR}/git"
