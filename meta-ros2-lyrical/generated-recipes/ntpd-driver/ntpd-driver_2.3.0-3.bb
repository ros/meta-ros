...
# matches with: https://github.com/ros2-gbp/ntpd_driver-release/archive/release/lyrical/ntpd_driver/2.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ntpd_driver"
SRC_URI = "git://github.com/ros2-gbp/ntpd_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "9830b64a8d3abb54192d5fd4daed386b90dcf7fd"
S = "${WORKDIR}/git"
