...
# matches with: https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/lyrical/ublox_nav_sat_fix_hp_node/0.7.4-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ublox_nav_sat_fix_hp_node"
SRC_URI = "git://github.com/ros2-gbp/ublox_dgnss-release;${ROS_BRANCH};protocol=https"
SRCREV = "308594b7b39d8f770b25f44e3377d03486019f0e"
S = "${WORKDIR}/git"
