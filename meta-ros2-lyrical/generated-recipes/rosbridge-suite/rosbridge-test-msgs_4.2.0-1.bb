...
# matches with: https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/lyrical/rosbridge_test_msgs/4.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rosbridge_test_msgs"
SRC_URI = "git://github.com/ros2-gbp/rosbridge_suite-release;${ROS_BRANCH};protocol=https"
SRCREV = "21188cb9b84d015ae3a595037fd61b2cfbe1f496"
S = "${WORKDIR}/git"
