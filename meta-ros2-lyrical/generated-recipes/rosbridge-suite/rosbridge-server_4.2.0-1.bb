...
# matches with: https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/lyrical/rosbridge_server/4.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rosbridge_server"
SRC_URI = "git://github.com/ros2-gbp/rosbridge_suite-release;${ROS_BRANCH};protocol=https"
SRCREV = "7fcb62f7266f1b4e350114737fa3fabd0c64e9d9"
S = "${WORKDIR}/git"
