...
# matches with: https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/lyrical/rosapi_msgs/4.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rosapi_msgs"
SRC_URI = "git://github.com/ros2-gbp/rosbridge_suite-release;${ROS_BRANCH};protocol=https"
SRCREV = "8045ddad3a086ad3b97a4af3130880a826cfc585"
S = "${WORKDIR}/git"
