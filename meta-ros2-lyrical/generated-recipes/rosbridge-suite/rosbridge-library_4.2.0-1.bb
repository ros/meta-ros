...
# matches with: https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/lyrical/rosbridge_library/4.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rosbridge_library"
SRC_URI = "git://github.com/ros2-gbp/rosbridge_suite-release;${ROS_BRANCH};protocol=https"
SRCREV = "2c457789e411e64a91666cca7beef8dc773d9d54"
S = "${WORKDIR}/git"
