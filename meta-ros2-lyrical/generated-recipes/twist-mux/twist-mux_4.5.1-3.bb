...
# matches with: https://github.com/ros2-gbp/twist_mux-release/archive/release/lyrical/twist_mux/4.5.1-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/twist_mux"
SRC_URI = "git://github.com/ros2-gbp/twist_mux-release;${ROS_BRANCH};protocol=https"
SRCREV = "a219d72d9455ea88d7d14bf03746fd79c2a5e4a1"
S = "${WORKDIR}/git"
