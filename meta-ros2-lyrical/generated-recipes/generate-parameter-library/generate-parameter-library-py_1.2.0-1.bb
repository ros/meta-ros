...
# matches with: https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/lyrical/generate_parameter_library_py/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/generate_parameter_library_py"
SRC_URI = "git://github.com/ros2-gbp/generate_parameter_library-release;${ROS_BRANCH};protocol=https"
SRCREV = "433745c159a472e94db2d76ccdaf519ae0f09594"
S = "${WORKDIR}/git"
