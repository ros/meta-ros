...
# matches with: https://github.com/ros2-gbp/libstatistics_collector-release/archive/release/lyrical/libstatistics_collector/2.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/libstatistics_collector"
SRC_URI = "git://github.com/ros2-gbp/libstatistics_collector-release;${ROS_BRANCH};protocol=https"
SRCREV = "00f74e9c8cddc1fd9b42d7759d1c9318014ec3f8"
S = "${WORKDIR}/git"
