...
# matches with: https://github.com/ros2-gbp/rc_common_msgs_ros2-release/archive/release/lyrical/rc_common_msgs/0.5.3-7.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/rc_common_msgs"
SRC_URI = "git://github.com/ros2-gbp/rc_common_msgs_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "92b0855f7e0d0cf4d4559cdaf512be3ee56f6d97"
S = "${WORKDIR}/git"
