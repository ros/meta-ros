...
# matches with: https://github.com/ros2-gbp/odom_to_tf_ros2-release/archive/release/lyrical/odom_to_tf_ros2/1.0.8-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/odom_to_tf_ros2"
SRC_URI = "git://github.com/ros2-gbp/odom_to_tf_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "29083f618d400fe1eabcbf441f9364ad9e0f11f4"
S = "${WORKDIR}/git"
