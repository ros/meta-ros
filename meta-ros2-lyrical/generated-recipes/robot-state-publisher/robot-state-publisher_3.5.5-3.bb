...
# matches with: https://github.com/ros2-gbp/robot_state_publisher-release/archive/release/lyrical/robot_state_publisher/3.5.5-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/robot_state_publisher"
SRC_URI = "git://github.com/ros2-gbp/robot_state_publisher-release;${ROS_BRANCH};protocol=https"
SRCREV = "87c4d66f95b4f7d3c141ff9be345b0d24ff8bfc7"
S = "${WORKDIR}/git"
