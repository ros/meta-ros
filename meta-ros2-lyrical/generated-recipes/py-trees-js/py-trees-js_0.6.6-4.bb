...
# matches with: https://github.com/ros2-gbp/py_trees_js-release/archive/release/lyrical/py_trees_js/0.6.6-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/py_trees_js"
SRC_URI = "git://github.com/ros2-gbp/py_trees_js-release;${ROS_BRANCH};protocol=https"
SRCREV = "9dbac17f16c2a2e894feb218c03b72f87a9a26cd"
S = "${WORKDIR}/git"
