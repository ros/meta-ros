...
# matches with: https://github.com/ros2-gbp/ros2_message_filters-release/archive/release/lyrical/message_filters/7.4.1-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/message_filters"
SRC_URI = "git://github.com/ros2-gbp/ros2_message_filters-release;${ROS_BRANCH};protocol=https"
SRCREV = "659c2842be759a3edf13db6dbb4eb6cd9fd44afa"
S = "${WORKDIR}/git"
