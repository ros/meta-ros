...
# matches with: https://github.com/ros2-gbp/control_box_rst-release/archive/release/lyrical/control_box_rst/0.0.7-7.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/control_box_rst"
SRC_URI = "git://github.com/ros2-gbp/control_box_rst-release;${ROS_BRANCH};protocol=https"
SRCREV = "7647fe03e8bbf29ebc7acfebce0451bd8581271f"
S = "${WORKDIR}/git"
