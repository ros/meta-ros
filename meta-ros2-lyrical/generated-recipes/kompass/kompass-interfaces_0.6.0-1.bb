...
# matches with: https://github.com/ros2-gbp/kompass-release/archive/release/lyrical/kompass_interfaces/0.6.0-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/kompass_interfaces"
SRC_URI = "git://github.com/ros2-gbp/kompass-release;${ROS_BRANCH};protocol=https"
SRCREV = "df77cdce878dca9df3519c3e3c0fb1addc7cfcec"
S = "${WORKDIR}/git"
