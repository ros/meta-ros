...
# matches with: https://github.com/ros2-gbp/ros_environment-release/archive/release/lyrical/ros_environment/4.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ros_environment"
SRC_URI = "git://github.com/ros2-gbp/ros_environment-release;${ROS_BRANCH};protocol=https"
SRCREV = "3321bdfca0db9d87359063729bc065de17ad939b"
S = "${WORKDIR}/git"
