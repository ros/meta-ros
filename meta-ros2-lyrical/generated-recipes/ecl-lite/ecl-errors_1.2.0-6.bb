...
# matches with: https://github.com/ros2-gbp/ecl_lite-release/archive/release/lyrical/ecl_errors/1.2.0-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ecl_errors"
SRC_URI = "git://github.com/ros2-gbp/ecl_lite-release;${ROS_BRANCH};protocol=https"
SRCREV = "5fbb461a8e267aa76a3227f3a0a533fac958d7ca"
S = "${WORKDIR}/git"
