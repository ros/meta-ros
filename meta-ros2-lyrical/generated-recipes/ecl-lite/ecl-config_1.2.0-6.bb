...
# matches with: https://github.com/ros2-gbp/ecl_lite-release/archive/release/lyrical/ecl_config/1.2.0-6.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/ecl_config"
SRC_URI = "git://github.com/ros2-gbp/ecl_lite-release;${ROS_BRANCH};protocol=https"
SRCREV = "a51417e1e13014999e44ecdb480d77f14ffd62a6"
S = "${WORKDIR}/git"
