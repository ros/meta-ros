...
# matches with: https://github.com/ros2-gbp/nmea_msgs-release/archive/release/lyrical/nmea_msgs/2.1.0-4.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/nmea_msgs"
SRC_URI = "git://github.com/ros2-gbp/nmea_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "31b4cc2161f11aef5d2e907df05cf5eabd248dc4"
S = "${WORKDIR}/git"
