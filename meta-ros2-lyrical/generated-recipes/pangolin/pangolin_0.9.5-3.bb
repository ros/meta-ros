...
# matches with: https://github.com/ros2-gbp/Pangolin-release/archive/release/lyrical/pangolin/0.9.5-3.tar.gz
ROS_BRANCH ?= "branch=release/lyrical/pangolin"
SRC_URI = "git://github.com/ros2-gbp/Pangolin-release;${ROS_BRANCH};protocol=https"
SRCREV = "f806336122120c37673ee84ccdccc4bce7fbfb8b"
S = "${WORKDIR}/git"
