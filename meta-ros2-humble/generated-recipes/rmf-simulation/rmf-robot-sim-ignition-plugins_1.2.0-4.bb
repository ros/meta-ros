...
# matches with: https://github.com/ros2-gbp/rmf_simulation-release/archive/release/humble/rmf_robot_sim_ignition_plugins/1.2.0-4.tar.gz
ROS_BRANCH ?= "branch=release/humble/rmf_robot_sim_ignition_plugins"
SRC_URI = "git://github.com/ros2-gbp/rmf_simulation-release;${ROS_BRANCH};protocol=https"
SRCREV = "f13d3ce5afed0a6124199481a4746da0566a2ed1"
S = "${WORKDIR}/git"
