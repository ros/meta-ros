...
# matches with: https://github.com/ros2-gbp/rmf_simulation-release/archive/release/humble/rmf_robot_sim_gazebo_plugins/1.2.0-4.tar.gz
ROS_BRANCH ?= "branch=release/humble/rmf_robot_sim_gazebo_plugins"
SRC_URI = "git://github.com/ros2-gbp/rmf_simulation-release;${ROS_BRANCH};protocol=https"
SRCREV = "b0452888055c3985e06ee91b2444f6688ef42ddb"
S = "${WORKDIR}/git"
