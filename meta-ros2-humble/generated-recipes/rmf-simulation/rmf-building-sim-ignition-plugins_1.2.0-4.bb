...
# matches with: https://github.com/ros2-gbp/rmf_simulation-release/archive/release/humble/rmf_building_sim_ignition_plugins/1.2.0-4.tar.gz
ROS_BRANCH ?= "branch=release/humble/rmf_building_sim_ignition_plugins"
SRC_URI = "git://github.com/ros2-gbp/rmf_simulation-release;${ROS_BRANCH};protocol=https"
SRCREV = "b2040793d9a26db75156f3508d0edc6f22cf2258"
S = "${WORKDIR}/git"
