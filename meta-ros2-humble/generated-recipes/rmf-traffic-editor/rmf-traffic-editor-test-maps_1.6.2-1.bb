...
# matches with: https://github.com/ros2-gbp/rmf_traffic_editor-release/archive/release/humble/rmf_traffic_editor_test_maps/1.6.2-1.tar.gz
...
SRCREV = "e2422794d1ead515ee1db794624ff3e20bf34b13"
S = "${WORKDIR}/git"
