...
# matches with: https://github.com/ros2-gbp/autoware_internal_msgs-release/archive/release/humble/autoware_internal_perception_msgs/1.12.1-1.tar.gz
...
SRCREV = "16a727461ca2e7659000143148277a06f72053e5"
S = "${WORKDIR}/git"
