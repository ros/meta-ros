...
# matches with: https://github.com/ros2-gbp/imu_tools-release/archive/release/humble/imu_tools/2.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/imu_tools"
SRC_URI = "git://github.com/ros2-gbp/imu_tools-release;${ROS_BRANCH};protocol=https"
SRCREV = "a7cb16a2d05aa1bbe29e078e915dd288cc19db8a"
S = "${WORKDIR}/git"
