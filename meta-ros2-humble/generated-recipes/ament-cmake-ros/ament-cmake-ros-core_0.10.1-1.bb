...
# matches with: https://github.com/ros2-gbp/ament_cmake_ros-release/archive/release/humble/ament_cmake_ros_core/0.10.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ament_cmake_ros_core"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "16aac14d0d5e831c5aab38a5cd6783552786dd06"
S = "${WORKDIR}/git"
