...
# matches with: https://github.com/ros2-gbp/apriltag_detector-release/archive/release/humble/apriltag_detector_umich/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/apriltag_detector_umich"
SRC_URI = "git://github.com/ros2-gbp/apriltag_detector-release;${ROS_BRANCH};protocol=https"
SRCREV = "73beca1e0489c855c4a2025feb086bf84394067d"
S = "${WORKDIR}/git"
