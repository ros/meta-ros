...
# matches with: https://github.com/pal-gbp/aruco_ros-release/archive/release/humble/aruco_ros/5.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/aruco_ros"
SRC_URI = "git://github.com/pal-gbp/aruco_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "144b8e3493698eea429b109330787428832127d1"
S = "${WORKDIR}/git"
