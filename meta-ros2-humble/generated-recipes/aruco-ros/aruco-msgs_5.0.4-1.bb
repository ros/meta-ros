...
# matches with: https://github.com/pal-gbp/aruco_ros-release/archive/release/humble/aruco_msgs/5.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/aruco_msgs"
SRC_URI = "git://github.com/pal-gbp/aruco_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "623f24672968591a65b98a95685bc4e3633994c9"
S = "${WORKDIR}/git"
