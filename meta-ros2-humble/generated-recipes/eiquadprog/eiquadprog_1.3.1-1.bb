...
# matches with: https://github.com/ros2-gbp/eiquadprog-release/archive/release/humble/eiquadprog/1.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/eiquadprog"
SRC_URI = "git://github.com/ros2-gbp/eiquadprog-release;${ROS_BRANCH};protocol=https"
SRCREV = "749cb946672efc990a69f9289ff764c5be20d001"
S = "${WORKDIR}/git"
