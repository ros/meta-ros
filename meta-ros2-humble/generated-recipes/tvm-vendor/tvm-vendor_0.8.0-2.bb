...
# matches with: https://github.com/ros2-gbp/tvm_vendor-release/archive/release/humble/tvm_vendor/0.8.0-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/tvm_vendor"
SRC_URI = "git://github.com/ros2-gbp/tvm_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "5caf8b2111ef8e029d8856288c8a37aff20a00b0"
S = "${WORKDIR}/git"
