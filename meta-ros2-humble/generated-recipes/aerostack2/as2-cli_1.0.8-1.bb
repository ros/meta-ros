...
# matches with: https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/as2_cli/1.0.8-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/as2_cli"
SRC_URI = "git://github.com/ros2-gbp/aerostack2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8dbc9b78ebd2765b0fba18f1ee5b683ae82be1b7"
S = "${WORKDIR}/git"
