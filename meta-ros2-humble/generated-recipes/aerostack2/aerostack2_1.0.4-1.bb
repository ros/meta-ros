...
# matches with: https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/aerostack2/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/aerostack2"
SRC_URI = "git://github.com/ros2-gbp/aerostack2-release;${ROS_BRANCH};protocol=https"
SRCREV = "1fc449301d040ca8917a394b3fa444667c4ec21c"
S = "${WORKDIR}/git"
