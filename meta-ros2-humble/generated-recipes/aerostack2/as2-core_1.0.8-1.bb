...
# matches with: https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/as2_core/1.0.8-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/as2_core"
SRC_URI = "git://github.com/ros2-gbp/aerostack2-release;${ROS_BRANCH};protocol=https"
SRCREV = "38308ee6f93495ca01154a130674176cbee6e290"
S = "${WORKDIR}/git"
