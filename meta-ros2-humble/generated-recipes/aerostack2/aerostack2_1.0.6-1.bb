...
# matches with: https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/aerostack2/1.0.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/aerostack2"
SRC_URI = "git://github.com/ros2-gbp/aerostack2-release;${ROS_BRANCH};protocol=https"
SRCREV = "f4d4897ac41c850cccfc2ac2137ebfae62185f72"
S = "${WORKDIR}/git"
