...
# matches with: https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/as2_core/1.0.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/as2_core"
SRC_URI = "git://github.com/ros2-gbp/aerostack2-release;${ROS_BRANCH};protocol=https"
SRCREV = "f70a9a3f97e6e8d81d3c16bf3bfa0aafb373c4d3"
S = "${WORKDIR}/git"
