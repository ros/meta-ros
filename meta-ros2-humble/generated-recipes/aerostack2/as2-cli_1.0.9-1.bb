...
# matches with: https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/as2_cli/1.0.9-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/as2_cli"
SRC_URI = "git://github.com/ros2-gbp/aerostack2-release;${ROS_BRANCH};protocol=https"
SRCREV = "0bd7b1143dfda1a72f4461aed669304081bddcec"
S = "${WORKDIR}/git"
