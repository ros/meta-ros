...
# matches with: https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/as2_core/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/as2_core"
SRC_URI = "git://github.com/ros2-gbp/aerostack2-release;${ROS_BRANCH};protocol=https"
SRCREV = "4177b43ab9dc0fde8db73c7148f5539dcc0ee6d2"
S = "${WORKDIR}/git"
