...
# matches with: https://github.com/ros2-gbp/rqt_tf_tree-release/archive/release/humble/rqt_tf_tree/1.0.6-1.tar.gz
...
SRCREV = "867c6adb69b974c88d7d4b9a9bdb62d3e77f25ee"
S = "${WORKDIR}/git"
