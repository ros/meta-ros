...
# matches with: https://github.com/ros2-gbp/teleop_twist_joy-release/archive/release/humble/teleop_twist_joy/2.4.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/teleop_twist_joy"
SRC_URI = "git://github.com/ros2-gbp/teleop_twist_joy-release;${ROS_BRANCH};protocol=https"
SRCREV = "4fa7f22414950ddd64a9ea33b8801ef17ab59d02"
S = "${WORKDIR}/git"
