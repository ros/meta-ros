...
# matches with: https://github.com/ros2-gbp/ros2_control_cmake-release/archive/release/humble/ros2_control_cmake/0.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros2_control_cmake"
SRC_URI = "git://github.com/ros2-gbp/ros2_control_cmake-release;${ROS_BRANCH};protocol=https"
SRCREV = "173d5a9383030c47f20dc77587d70ee5e4b3462c"
S = "${WORKDIR}/git"
