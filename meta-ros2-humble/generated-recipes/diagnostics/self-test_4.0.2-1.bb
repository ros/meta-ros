...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/humble/self_test/4.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/self_test"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "aff2f72402e6267cc32bf1ae9a2eb312c0223516"
S = "${WORKDIR}/git"
