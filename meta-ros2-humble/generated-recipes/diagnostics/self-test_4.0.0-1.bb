...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/humble/self_test/4.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/self_test"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "dfeb1458012910ae94a99aa1dcbdd3f2e0033995"
S = "${WORKDIR}/git"
