...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/humble/self_test/3.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/self_test"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "3a5001087c7e14de9b84ddaf6f1344d772f6120f"
S = "${WORKDIR}/git"
