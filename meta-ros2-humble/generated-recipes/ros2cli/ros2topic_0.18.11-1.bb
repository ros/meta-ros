...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2topic/0.18.11-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros2topic"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "742815af218c0d39a95dae4d64974813e660c499"
S = "${WORKDIR}/git"
