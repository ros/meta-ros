...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2multicast/0.18.3-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros2multicast"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "e971aac16b3556a4c9ed5db2a2d5065a940d9fe7"
S = "${WORKDIR}/git"
