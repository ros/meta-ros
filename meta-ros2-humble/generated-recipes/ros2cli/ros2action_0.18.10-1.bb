...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2action/0.18.10-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros2action"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "21ee079cc832134f8b79f818083f6547ae78da74"
S = "${WORKDIR}/git"
