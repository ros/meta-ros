...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2multicast/0.18.7-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros2multicast"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "0d1f753389ca4ecf49320db2cd91c72ec482d7db"
S = "${WORKDIR}/git"
