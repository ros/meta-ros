...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2interface/0.18.9-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros2interface"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "b40ebb472cd81356fa96f29f813d5a510bad0d9c"
S = "${WORKDIR}/git"
