...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2lifecycle/0.18.11-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros2lifecycle"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "9db277f5be42df51947182429cd72a74861d9509"
S = "${WORKDIR}/git"
