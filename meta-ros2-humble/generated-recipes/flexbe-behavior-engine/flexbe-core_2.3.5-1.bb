...
# matches with: https://github.com/ros2-gbp/flexbe_behavior_engine-release/archive/release/humble/flexbe_core/2.3.5-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/flexbe_core"
SRC_URI = "git://github.com/ros2-gbp/flexbe_behavior_engine-release;${ROS_BRANCH};protocol=https"
SRCREV = "c48851e9148661b8345787a60d3943e9fe81ca05"
S = "${WORKDIR}/git"
