...
# matches with: https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/humble/rosapi/1.1.2-3.tar.gz
ROS_BRANCH ?= "branch=release/humble/rosapi"
SRC_URI = "git://github.com/ros2-gbp/rosbridge_suite-release;${ROS_BRANCH};protocol=https"
SRCREV = "0738813ac3a02844eee64994bd577af84936fd8f"
S = "${WORKDIR}/git"
