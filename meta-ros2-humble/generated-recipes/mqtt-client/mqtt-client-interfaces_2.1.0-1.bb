...
# matches with: https://github.com/ika-rwth-aachen/mqtt_client-release/archive/release/humble/mqtt_client_interfaces/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mqtt_client_interfaces"
SRC_URI = "git://github.com/ika-rwth-aachen/mqtt_client-release;${ROS_BRANCH};protocol=https"
SRCREV = "a69a77402d5dcc070b27657fbb5fec88b81ae828"
S = "${WORKDIR}/git"
