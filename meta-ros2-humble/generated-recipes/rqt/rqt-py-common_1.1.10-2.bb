...
# matches with: https://github.com/ros2-gbp/rqt-release/archive/release/humble/rqt_py_common/1.1.10-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/rqt_py_common"
SRC_URI = "git://github.com/ros2-gbp/rqt-release;${ROS_BRANCH};protocol=https"
SRCREV = "f0494dedbc389e4d973fc7cccedea038a28a1ea0"
S = "${WORKDIR}/git"
