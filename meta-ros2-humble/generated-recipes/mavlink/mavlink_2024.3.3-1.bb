...
# matches with: https://github.com/ros2-gbp/mavlink-gbp-release/archive/release/humble/mavlink/2024.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mavlink"
SRC_URI = "git://github.com/ros2-gbp/mavlink-gbp-release;${ROS_BRANCH};protocol=https"
SRCREV = "d6e402c8215a1ac90ae0299045608c7192360011"
S = "${WORKDIR}/git"
