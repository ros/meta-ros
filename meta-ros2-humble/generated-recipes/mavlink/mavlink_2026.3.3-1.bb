...
# matches with: https://github.com/ros2-gbp/mavlink-gbp-release/archive/release/humble/mavlink/2026.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mavlink"
SRC_URI = "git://github.com/ros2-gbp/mavlink-gbp-release;${ROS_BRANCH};protocol=https"
SRCREV = "12637e42bf26a2e3e8ca2c14beea18ad4389339e"
S = "${WORKDIR}/git"
