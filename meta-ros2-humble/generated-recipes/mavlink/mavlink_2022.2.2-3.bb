...
# matches with: https://github.com/ros2-gbp/mavlink-gbp-release/archive/release/humble/mavlink/2022.2.2-3.tar.gz
ROS_BRANCH ?= "branch=release/humble/mavlink"
SRC_URI = "git://github.com/ros2-gbp/mavlink-gbp-release;${ROS_BRANCH};protocol=https"
SRCREV = "39a46ff54b462e3f8a5bf3256469060b0e1b8c17"
S = "${WORKDIR}/git"
