...
# matches with: https://github.com/ros2-gbp/pluginlib-release/archive/release/humble/pluginlib/5.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/pluginlib"
SRC_URI = "git://github.com/ros2-gbp/pluginlib-release;${ROS_BRANCH};protocol=https"
SRCREV = "7458a3f05e5169654e1fd5d8734774c959a41eee"
S = "${WORKDIR}/git"
