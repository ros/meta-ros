...
# matches with: https://github.com/ros2-gbp/proxsuite-release/archive/release/humble/proxsuite/0.3.6-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/proxsuite"
SRC_URI = "git://github.com/ros2-gbp/proxsuite-release;${ROS_BRANCH};protocol=https"
SRCREV = "6f6f4667d6ee9e2bfeb8dc43ae73b7a359294eea"
S = "${WORKDIR}/git"
