...
# matches with: https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/humble/mola_state_estimation_smoother/1.11.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_state_estimation_smoother"
SRC_URI = "git://github.com/ros2-gbp/mola_state_estimation-release;${ROS_BRANCH};protocol=https"
SRCREV = "e3b154629cf487b66e1bb2a100fc561a8bbb588f"
S = "${WORKDIR}/git"
