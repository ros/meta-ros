...
# matches with: https://github.com/clearpath-gbp/clearpath_common-release/archive/release/humble/clearpath_manipulators/1.2.0-1.tar.gz
...
SRCREV = "e5b06145a6ef6a9fc95ccb69b4e79f4627fd3d7a"
S = "${WORKDIR}/git"
