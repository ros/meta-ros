...
# matches with: https://github.com/pal-gbp/pal_gazebo_plugins-release/archive/release/humble/pal_gazebo_plugins/4.0.4-1.tar.gz
...
SRCREV = "729d0b28032df32865f952abc8663b9b84990a6b"
S = "${WORKDIR}/git"
