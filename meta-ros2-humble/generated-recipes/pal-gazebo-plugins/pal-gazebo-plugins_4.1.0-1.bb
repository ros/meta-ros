...
# matches with: https://github.com/pal-gbp/pal_gazebo_plugins-release/archive/release/humble/pal_gazebo_plugins/4.1.0-1.tar.gz
...
SRCREV = "53d2bd3e7496a8b333c7da0e6c198ef66eac46ed"
S = "${WORKDIR}/git"
