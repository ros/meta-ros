...
# matches with: https://github.com/ros2-gbp/ros2_canopen-release/archive/release/humble/canopen/0.2.11-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/canopen"
SRC_URI = "git://github.com/ros2-gbp/ros2_canopen-release;${ROS_BRANCH};protocol=https"
SRCREV = "8cdfb48b9ecdddd383aa44f9cefe37fe01fc188b"
S = "${WORKDIR}/git"
