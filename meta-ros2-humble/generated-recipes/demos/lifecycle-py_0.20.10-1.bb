...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/humble/lifecycle_py/0.20.10-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/lifecycle_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "63ddbaf7d3f35892d75861be541193bcf2576a06"
S = "${WORKDIR}/git"
