...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/humble/lifecycle_py/0.20.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/lifecycle_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "54dd1a257a5846bc7adc4d9a8be0277b21f51ec0"
S = "${WORKDIR}/git"
