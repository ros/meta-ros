...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/humble/image_tools/0.20.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/image_tools"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "b680c3afbc34144ac62a4b09419655e1fab86b41"
S = "${WORKDIR}/git"
