...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/humble/demo_nodes_cpp/0.20.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/demo_nodes_cpp"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "c308c7061c57b400984922b2846c95f8d14d9b59"
S = "${WORKDIR}/git"
