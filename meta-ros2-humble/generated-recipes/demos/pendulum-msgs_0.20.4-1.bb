...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/humble/pendulum_msgs/0.20.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/pendulum_msgs"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "9d0bcdafdb8a3dcbeb6e7b45efc737cdd1bec64b"
S = "${WORKDIR}/git"
