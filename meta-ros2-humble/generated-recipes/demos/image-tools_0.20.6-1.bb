...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/humble/image_tools/0.20.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/image_tools"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "f837834c139bc60364efa07078540e0feb6a5d28"
S = "${WORKDIR}/git"
