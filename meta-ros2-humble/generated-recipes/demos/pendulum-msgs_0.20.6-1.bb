...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/humble/pendulum_msgs/0.20.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/pendulum_msgs"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "61a61fa74f51780a3e954c2d063c96c853551db7"
S = "${WORKDIR}/git"
