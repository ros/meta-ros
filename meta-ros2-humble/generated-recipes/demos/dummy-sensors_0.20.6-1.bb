...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/humble/dummy_sensors/0.20.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/dummy_sensors"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "162149a3e618e9110155b8f08b30246f9e2aa646"
S = "${WORKDIR}/git"
