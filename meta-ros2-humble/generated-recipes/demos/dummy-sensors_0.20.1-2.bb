...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/humble/dummy_sensors/0.20.1-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/dummy_sensors"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "29def78014c2f2bd796e651b66d8314a4eeffb8c"
S = "${WORKDIR}/git"
