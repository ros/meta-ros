...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/humble/dummy_sensors/0.20.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/dummy_sensors"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "9d1930910448ac560526d85969ec12b40c133e9b"
S = "${WORKDIR}/git"
