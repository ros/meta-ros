...
# matches with: https://github.com/luxonis/depthai-core-release/archive/release/humble/depthai/2.17.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/depthai"
SRC_URI = "git://github.com/luxonis/depthai-core-release;${ROS_BRANCH};protocol=https"
SRCREV = "9219fdcc78eb1e3350f03266820c621b74bf596e"
S = "${WORKDIR}/git"
