...
# matches with: https://github.com/luxonis/depthai-core-release/archive/release/humble/depthai/2.29.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/depthai"
SRC_URI = "git://github.com/luxonis/depthai-core-release;${ROS_BRANCH};protocol=https"
SRCREV = "b591e8dd2a282b1e6f8c9e7e8d4caacab8016532"
S = "${WORKDIR}/git"
