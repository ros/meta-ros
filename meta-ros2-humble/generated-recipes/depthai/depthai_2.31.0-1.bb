...
# matches with: https://github.com/luxonis/depthai-core-release/archive/release/humble/depthai/2.31.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/depthai"
SRC_URI = "git://github.com/luxonis/depthai-core-release;${ROS_BRANCH};protocol=https"
SRCREV = "7b43be76ad8fe719a172dcbdd2cf43ecc05b83ce"
S = "${WORKDIR}/git"
