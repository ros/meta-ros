...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/humble/mrpt_generic_sensor/0.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_generic_sensor"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "5f0e556a64285a1fa49bb86d99237fa916b0eb23"
S = "${WORKDIR}/git"
