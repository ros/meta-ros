...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/humble/mrpt_sensor_imu_taobotics/0.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_sensor_imu_taobotics"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "3de70ebde8bebb59c9f073ac66df364d0b138127"
S = "${WORKDIR}/git"
