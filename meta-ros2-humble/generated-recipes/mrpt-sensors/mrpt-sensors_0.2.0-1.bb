...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/humble/mrpt_sensors/0.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_sensors"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "b7e5b5e1a8efb050c0c0b2d830a4d7c33495dacd"
S = "${WORKDIR}/git"
