...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/humble/mrpt_sensor_gnns_nmea/0.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_sensor_gnns_nmea"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "690f37d363353442009db35b1b248bf01f272457"
S = "${WORKDIR}/git"
