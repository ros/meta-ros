...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_eigen/0.25.20-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/tf2_eigen"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "973a4a64756bf5e8e877b3295114c84b70f19b9f"
S = "${WORKDIR}/git"
