...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_py/0.25.13-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/tf2_py"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "42fe3ecc7ea93980a474c7f34ab109c8323ff5e4"
S = "${WORKDIR}/git"
