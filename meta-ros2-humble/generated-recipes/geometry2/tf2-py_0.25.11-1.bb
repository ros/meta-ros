...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_py/0.25.11-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/tf2_py"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "74edce5b755067a0b3ed5eb90eca16e041584f3e"
S = "${WORKDIR}/git"
