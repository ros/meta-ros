...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/humble/geometry2/0.25.7-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/geometry2"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "2de90d1ccacd8bd001c17a6c85a3fdc067ef734d"
S = "${WORKDIR}/git"
