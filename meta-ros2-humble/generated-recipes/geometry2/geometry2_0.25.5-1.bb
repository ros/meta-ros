...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/humble/geometry2/0.25.5-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/geometry2"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "c35a5fb54642627ee8e52f78c823ed3be9009549"
S = "${WORKDIR}/git"
