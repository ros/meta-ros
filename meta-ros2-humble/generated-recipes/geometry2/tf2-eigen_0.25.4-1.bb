...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_eigen/0.25.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/tf2_eigen"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a3695fc1bc7d5729bd3e33353e2e87b7dd3ccf7b"
S = "${WORKDIR}/git"
