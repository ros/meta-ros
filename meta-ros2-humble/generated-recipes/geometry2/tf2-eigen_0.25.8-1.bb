...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_eigen/0.25.8-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/tf2_eigen"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "0cb225bfe4dc13a5163571c3bf3722398db8528f"
S = "${WORKDIR}/git"
