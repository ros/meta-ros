...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/humble/geometry2/0.25.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/geometry2"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a07c3956ad5668aba5570baa356343db5e7ba8bb"
S = "${WORKDIR}/git"
