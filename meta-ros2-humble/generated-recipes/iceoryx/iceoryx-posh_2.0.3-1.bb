...
# matches with: https://github.com/ros2-gbp/iceoryx-release/archive/release/humble/iceoryx_posh/2.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/iceoryx_posh"
SRC_URI = "git://github.com/ros2-gbp/iceoryx-release;${ROS_BRANCH};protocol=https"
SRCREV = "1079f9e4c5dfd231deec2eb3953e4c0cc99fb591"
S = "${WORKDIR}/git"
