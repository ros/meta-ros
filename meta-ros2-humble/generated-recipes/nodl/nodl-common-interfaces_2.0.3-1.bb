...
# matches with: https://github.com/ros2-gbp/nodl-release/archive/release/humble/nodl_common_interfaces/2.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/nodl_common_interfaces"
SRC_URI = "git://github.com/ros2-gbp/nodl-release;${ROS_BRANCH};protocol=https"
SRCREV = "25aa0ac87de0b28a840c65c13d5b30bc80312da1"
S = "${WORKDIR}/git"
