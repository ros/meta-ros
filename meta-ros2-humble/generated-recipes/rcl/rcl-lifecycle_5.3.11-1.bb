...
# matches with: https://github.com/ros2-gbp/rcl-release/archive/release/humble/rcl_lifecycle/5.3.11-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/rcl_lifecycle"
SRC_URI = "git://github.com/ros2-gbp/rcl-release;${ROS_BRANCH};protocol=https"
SRCREV = "feeeebfb01b91fc4d2d591ae66829f60daacfba1"
S = "${WORKDIR}/git"
