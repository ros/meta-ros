...
# matches with: https://github.com/pal-gbp/pal_gripper-release/archive/release/humble/pal_gripper/3.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/pal_gripper"
SRC_URI = "git://github.com/pal-gbp/pal_gripper-release;${ROS_BRANCH};protocol=https"
SRCREV = "2b588ee49d73fc5a505be7fe191ee9f9cf28b1fc"
S = "${WORKDIR}/git"
