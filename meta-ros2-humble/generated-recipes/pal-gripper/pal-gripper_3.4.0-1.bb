...
# matches with: https://github.com/pal-gbp/pal_gripper-release/archive/release/humble/pal_gripper/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/pal_gripper"
SRC_URI = "git://github.com/pal-gbp/pal_gripper-release;${ROS_BRANCH};protocol=https"
SRCREV = "c35075ae23d24afa24bf233f48274488a2bcc770"
S = "${WORKDIR}/git"
