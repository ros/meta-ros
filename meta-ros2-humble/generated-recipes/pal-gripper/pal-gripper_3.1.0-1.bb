...
# matches with: https://github.com/pal-gbp/pal_gripper-release/archive/release/humble/pal_gripper/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/pal_gripper"
SRC_URI = "git://github.com/pal-gbp/pal_gripper-release;${ROS_BRANCH};protocol=https"
SRCREV = "a7c4246f4b777b177fed1aba59b5433b5299deb5"
S = "${WORKDIR}/git"
