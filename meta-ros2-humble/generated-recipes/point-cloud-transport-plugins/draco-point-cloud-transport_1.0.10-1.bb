...
# matches with: https://github.com/ros2-gbp/point_cloud_transport_plugins-release/archive/release/humble/draco_point_cloud_transport/1.0.10-1.tar.gz
...
SRCREV = "6fa64f68fd92d36c0218bd7ce9e7b4ac3cd02b67"
S = "${WORKDIR}/git"
