...
# matches with: https://github.com/ros2-gbp/point_cloud_transport_plugins-release/archive/release/humble/zlib_point_cloud_transport/1.0.9-1.tar.gz
...
SRCREV = "fb102582e8867145a264fb5a8a6d4d540aeb2f74"
S = "${WORKDIR}/git"
