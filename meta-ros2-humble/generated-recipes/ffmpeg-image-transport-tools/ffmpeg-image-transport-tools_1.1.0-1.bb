...
# matches with: https://github.com/ros2-gbp/ffmpeg_image_transport_tools-release/archive/release/humble/ffmpeg_image_transport_tools/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ffmpeg_image_transport_tools"
SRC_URI = "git://github.com/ros2-gbp/ffmpeg_image_transport_tools-release;${ROS_BRANCH};protocol=https"
SRCREV = "bd2f70432f1bfa8756492bfe099e6033dce6eb43"
S = "${WORKDIR}/git"
