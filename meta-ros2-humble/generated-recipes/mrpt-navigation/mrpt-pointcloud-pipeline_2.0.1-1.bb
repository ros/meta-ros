...
# matches with: https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/humble/mrpt_pointcloud_pipeline/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_pointcloud_pipeline"
SRC_URI = "git://github.com/ros2-gbp/mrpt_navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "dc168f6bb3a22dbd984f50817faf46f8f6b1a864"
S = "${WORKDIR}/git"
