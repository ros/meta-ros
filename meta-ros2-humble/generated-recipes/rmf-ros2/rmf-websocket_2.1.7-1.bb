...
# matches with: https://github.com/ros2-gbp/rmf_ros2-release/archive/release/humble/rmf_websocket/2.1.7-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/rmf_websocket"
SRC_URI = "git://github.com/ros2-gbp/rmf_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "86f934da6586ebdc1ed48c8b2dc3c86d1d2ccfaf"
S = "${WORKDIR}/git"
