...
# matches with: https://github.com/ros2-gbp/odom_to_tf_ros2-release/archive/release/humble/odom_to_tf_ros2/1.0.7-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/odom_to_tf_ros2"
SRC_URI = "git://github.com/ros2-gbp/odom_to_tf_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "13a19e2341255e7dd518ecee1e24cee29facdf46"
S = "${WORKDIR}/git"
