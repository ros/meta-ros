...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/humble/launch_pytest/1.0.11-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/launch_pytest"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "f6ee77e2ae710f7d0cadf84b1be64331d433b1eb"
S = "${WORKDIR}/git"
