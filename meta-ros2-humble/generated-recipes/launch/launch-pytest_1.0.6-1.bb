...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/humble/launch_pytest/1.0.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/launch_pytest"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "f94fae450dc678eafa55b077501afddfcc79c336"
S = "${WORKDIR}/git"
