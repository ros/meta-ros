...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/humble/launch_pytest/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/launch_pytest"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "2978fee9456b9b184145f6d5b7678819c4cfcede"
S = "${WORKDIR}/git"
