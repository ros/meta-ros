...
# matches with: https://github.com/ros2-gbp/camera_ros-release/archive/release/humble/camera_ros/0.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/camera_ros"
SRC_URI = "git://github.com/ros2-gbp/camera_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "6d2e584200bfb420d296666faec9a9fcb9bc519d"
S = "${WORKDIR}/git"
