...
# matches with: https://github.com/ros2-gbp/camera_ros-release/archive/release/humble/camera_ros/0.1.0-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/camera_ros"
SRC_URI = "git://github.com/ros2-gbp/camera_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "b3a09a18a346563487686a911fac8cbffce9998b"
S = "${WORKDIR}/git"
