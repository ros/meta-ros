...
# matches with: https://github.com/ros2-gbp/gps_umd-release/archive/release/humble/gpsd_client/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/gpsd_client"
SRC_URI = "git://github.com/ros2-gbp/gps_umd-release;${ROS_BRANCH};protocol=https"
SRCREV = "6cc2a6da5dba477b6d81ad34259b9e5274529b6f"
S = "${WORKDIR}/git"
