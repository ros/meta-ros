...
# matches with: https://github.com/ros2-gbp/gps_umd-release/archive/release/humble/gpsd_client/2.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/gpsd_client"
SRC_URI = "git://github.com/ros2-gbp/gps_umd-release;${ROS_BRANCH};protocol=https"
SRCREV = "fa9dbca4bba163e60206719804fe0ac0d72087f8"
S = "${WORKDIR}/git"
