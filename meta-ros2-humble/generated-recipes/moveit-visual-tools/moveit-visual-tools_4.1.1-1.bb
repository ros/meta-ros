...
# matches with: https://github.com/ros2-gbp/moveit_visual_tools-release/archive/release/humble/moveit_visual_tools/4.1.1-1.tar.gz
...
SRCREV = "aee01d131218e41aa2cda2517fa9bed78ef8766f"
S = "${WORKDIR}/git"
