...
# matches with: https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/humble/ur_dashboard_msgs/2.6.0-1.tar.gz
...
SRCREV = "cd222ac3a1cd5d87562a14d0ef7d952db8118f0e"
S = "${WORKDIR}/git"
