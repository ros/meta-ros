...
# matches with: https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/humble/ur_dashboard_msgs/2.8.1-1.tar.gz
...
SRCREV = "653978271be9df65714afe6a32760b6fe3a6cf78"
S = "${WORKDIR}/git"
