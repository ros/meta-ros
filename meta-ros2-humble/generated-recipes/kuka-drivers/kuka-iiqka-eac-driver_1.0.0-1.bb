...
# matches with: https://github.com/ros2-gbp/kuka_drivers-release/archive/release/humble/kuka_iiqka_eac_driver/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/kuka_iiqka_eac_driver"
SRC_URI = "git://github.com/ros2-gbp/kuka_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "8ee76a9ca4338b71371402010cf786321c7ce866"
S = "${WORKDIR}/git"
