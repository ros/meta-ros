...
# matches with: https://github.com/ros2-gbp/kuka_drivers-release/archive/release/humble/kuka_sunrise_fri_driver/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/kuka_sunrise_fri_driver"
SRC_URI = "git://github.com/ros2-gbp/kuka_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "216d31fc943b8cc02dd1f3dafcb6324b2a35483d"
S = "${WORKDIR}/git"
