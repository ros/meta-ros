...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_regulated_pure_pursuit_controller/1.1.12-1.tar.gz
...
SRCREV = "2703a1116909d82b3b5987873750a750e6f58f9a"
S = "${WORKDIR}/git"
