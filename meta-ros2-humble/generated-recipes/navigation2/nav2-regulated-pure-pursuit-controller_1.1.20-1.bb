...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_regulated_pure_pursuit_controller/1.1.20-1.tar.gz
...
SRCREV = "262050b1a71f2b6ea05038202aec2f55ac4ae054"
S = "${WORKDIR}/git"
