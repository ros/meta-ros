...
# matches with: https://github.com/pal-gbp/omni_base_simulation-release/archive/release/humble/omni_base_simulation/2.11.1-1.tar.gz
...
SRCREV = "b6a9869a3a025c9456e5ff838a13543392fb6d5f"
S = "${WORKDIR}/git"
