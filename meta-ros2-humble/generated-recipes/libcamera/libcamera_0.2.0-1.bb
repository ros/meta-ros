...
# matches with: https://github.com/ros2-gbp/libcamera-release/archive/release/humble/libcamera/0.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/libcamera"
SRC_URI = "git://github.com/ros2-gbp/libcamera-release;${ROS_BRANCH};protocol=https"
SRCREV = "d2d94f70c8c28e8cf6d1755d35885510c71195e3"
S = "${WORKDIR}/git"
