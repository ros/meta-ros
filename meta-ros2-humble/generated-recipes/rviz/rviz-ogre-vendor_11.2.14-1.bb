...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_ogre_vendor/11.2.14-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "38ac67acb941925f5008f42f43b3283ea84eb765"
S = "${WORKDIR}/git"
