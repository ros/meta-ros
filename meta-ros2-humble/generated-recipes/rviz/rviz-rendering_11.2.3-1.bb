...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_rendering/11.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/rviz_rendering"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "5d36a049f80efcc6ef349220cc088de5ffdb3bc7"
S = "${WORKDIR}/git"
