...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_ogre_vendor/11.2.25-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "382826a329c4cd41fbdccc217bdeee8e0af8d643"
S = "${WORKDIR}/git"
