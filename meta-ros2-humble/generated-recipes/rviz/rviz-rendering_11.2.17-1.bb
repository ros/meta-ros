...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_rendering/11.2.17-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/rviz_rendering"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "7bb6a55d1c8266f22e3d5e0cd9472a684891f3ad"
S = "${WORKDIR}/git"
