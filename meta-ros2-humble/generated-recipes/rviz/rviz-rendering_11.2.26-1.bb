...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_rendering/11.2.26-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/rviz_rendering"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "2fe09e1ed21ed27a126287a8fb755af0a1a44b37"
S = "${WORKDIR}/git"
