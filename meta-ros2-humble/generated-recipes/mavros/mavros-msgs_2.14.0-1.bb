...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/humble/mavros_msgs/2.14.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mavros_msgs"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "d65bc38417643728504ac417218d1bd666628357"
S = "${WORKDIR}/git"
