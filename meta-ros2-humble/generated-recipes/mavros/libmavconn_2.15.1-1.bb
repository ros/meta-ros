...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/humble/libmavconn/2.15.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/libmavconn"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "51ddef4e77b7961a52051e2cb79cb4bc19bce54c"
S = "${WORKDIR}/git"
