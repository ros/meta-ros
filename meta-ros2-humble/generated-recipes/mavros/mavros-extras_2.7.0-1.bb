...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/humble/mavros_extras/2.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mavros_extras"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "39639a4355d0fd93991046cdae4eeb8c125eb705"
S = "${WORKDIR}/git"
