...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/humble/mavros_msgs/2.12.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mavros_msgs"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "24ac4b52772f57cda41a38742d8172b58371f475"
S = "${WORKDIR}/git"
