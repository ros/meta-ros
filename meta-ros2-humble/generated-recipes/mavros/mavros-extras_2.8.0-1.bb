...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/humble/mavros_extras/2.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mavros_extras"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "fda1646416804cc8a6f6eecf392ff00b1e88a781"
S = "${WORKDIR}/git"
