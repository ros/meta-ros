...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/humble/mavros_msgs/2.6.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mavros_msgs"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "4d0f18a141c8b18bbdcd57f14df20f8f2b39ffbc"
S = "${WORKDIR}/git"
