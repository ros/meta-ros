...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/humble/mavros_msgs/2.1.0-3.tar.gz
ROS_BRANCH ?= "branch=release/humble/mavros_msgs"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "a63693fa170881d3e5c4b55931f1772d2375cdd9"
S = "${WORKDIR}/git"
