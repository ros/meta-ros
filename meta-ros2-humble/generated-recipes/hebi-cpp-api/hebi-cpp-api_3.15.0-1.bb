...
# matches with: https://github.com/ros2-gbp/hebi_cpp_api-release/archive/release/humble/hebi_cpp_api/3.15.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/hebi_cpp_api"
SRC_URI = "git://github.com/ros2-gbp/hebi_cpp_api-release;${ROS_BRANCH};protocol=https"
SRCREV = "cca0cb57d0d55199d81a45ad11685844f3ade67b"
S = "${WORKDIR}/git"
