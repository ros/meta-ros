...
# matches with: https://github.com/ros2-gbp/apriltag_mit-release/archive/release/humble/apriltag_mit/1.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/apriltag_mit"
SRC_URI = "git://github.com/ros2-gbp/apriltag_mit-release;${ROS_BRANCH};protocol=https"
SRCREV = "e4796cb46fbd7da0c5f9235eceefb026b883720e"
S = "${WORKDIR}/git"
