...
# matches with: https://github.com/ros2-gbp/leo_common-release/archive/release/humble/leo_teleop/1.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/leo_teleop"
SRC_URI = "git://github.com/ros2-gbp/leo_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "2bf3e7e6fca2c3c4b2dce5e2ef1728e68e3c874a"
S = "${WORKDIR}/git"
