...
# matches with: https://github.com/ros2-gbp/mp2p_icp-release/archive/release/humble/mp2p_icp/2.10.3-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mp2p_icp"
SRC_URI = "git://github.com/ros2-gbp/mp2p_icp-release;${ROS_BRANCH};protocol=https"
SRCREV = "e9781decf167c8faeef35540166fec7ef7435fd3"
S = "${WORKDIR}/git"
