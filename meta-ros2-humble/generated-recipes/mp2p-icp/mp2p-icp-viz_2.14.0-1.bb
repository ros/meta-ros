...
# matches with: https://github.com/ros2-gbp/mp2p_icp-release/archive/release/humble/mp2p_icp_viz/2.14.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mp2p_icp_viz"
SRC_URI = "git://github.com/ros2-gbp/mp2p_icp-release;${ROS_BRANCH};protocol=https"
SRCREV = "99bb6acb57c32b3d8efecd81d8f2f1da11ce3a1b"
S = "${WORKDIR}/git"
