...
# matches with: https://github.com/ros2-gbp/mp2p_icp-release/archive/release/humble/mp2p_icp_core/2.14.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mp2p_icp_core"
SRC_URI = "git://github.com/ros2-gbp/mp2p_icp-release;${ROS_BRANCH};protocol=https"
SRCREV = "debc0703fc624977dd92cc8207c433bb0d2b5882"
S = "${WORKDIR}/git"
