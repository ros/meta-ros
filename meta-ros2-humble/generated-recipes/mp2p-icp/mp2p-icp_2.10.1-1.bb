...
# matches with: https://github.com/ros2-gbp/mp2p_icp-release/archive/release/humble/mp2p_icp/2.10.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mp2p_icp"
SRC_URI = "git://github.com/ros2-gbp/mp2p_icp-release;${ROS_BRANCH};protocol=https"
SRCREV = "1d50d7763f661fbe9d7e3b792afc0bf9b05cce93"
S = "${WORKDIR}/git"
