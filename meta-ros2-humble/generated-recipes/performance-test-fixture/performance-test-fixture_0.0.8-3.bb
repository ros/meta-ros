...
# matches with: https://github.com/ros2-gbp/performance_test_fixture-release/archive/release/humble/performance_test_fixture/0.0.8-3.tar.gz
...
SRCREV = "b411012695969d7fb3699f0442ba6e95e1d3a520"
S = "${WORKDIR}/git"
