...
# matches with: https://github.com/ros2-gbp/move_base_flex-release/archive/release/humble/mbf_msgs/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mbf_msgs"
SRC_URI = "git://github.com/ros2-gbp/move_base_flex-release;${ROS_BRANCH};protocol=https"
SRCREV = "b447438227e5a95d10dbb3b91e27ee9fa8e37337"
S = "${WORKDIR}/git"
