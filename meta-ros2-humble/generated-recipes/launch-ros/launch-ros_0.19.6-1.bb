...
# matches with: https://github.com/ros2-gbp/launch_ros-release/archive/release/humble/launch_ros/0.19.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/launch_ros"
SRC_URI = "git://github.com/ros2-gbp/launch_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "b9ed28aca2fcb836dad7e006053096e1e077bfe9"
S = "${WORKDIR}/git"
