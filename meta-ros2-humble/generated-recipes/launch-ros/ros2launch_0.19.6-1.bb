...
# matches with: https://github.com/ros2-gbp/launch_ros-release/archive/release/humble/ros2launch/0.19.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros2launch"
SRC_URI = "git://github.com/ros2-gbp/launch_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "b0bbdaac702c47173570f8af982ed98cd95907a0"
S = "${WORKDIR}/git"
