...
# matches with: https://github.com/ros2-gbp/launch_ros-release/archive/release/humble/ros2launch/0.19.8-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros2launch"
SRC_URI = "git://github.com/ros2-gbp/launch_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "baacbcb10cdfd8a379a7b8ba1e7fe23ec03d094a"
S = "${WORKDIR}/git"
