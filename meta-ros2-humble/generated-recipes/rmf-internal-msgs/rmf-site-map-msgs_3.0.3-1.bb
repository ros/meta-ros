...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/humble/rmf_site_map_msgs/3.0.3-1.tar.gz
...
SRCREV = "db1af0e6a1ad10ca8db384c39b93a4f3ae70d665"
S = "${WORKDIR}/git"
