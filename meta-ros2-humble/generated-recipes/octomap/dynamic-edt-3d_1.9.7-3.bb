...
# matches with: https://github.com/ros2-gbp/octomap-release/archive/release/humble/dynamic_edt_3d/1.9.7-3.tar.gz
ROS_BRANCH ?= "branch=release/humble/dynamic_edt_3d"
SRC_URI = "git://github.com/ros2-gbp/octomap-release;${ROS_BRANCH};protocol=https"
SRCREV = "dfec1c14fd608d0d62aa62da72a0ccaf1febba0f"
S = "${WORKDIR}/git"
