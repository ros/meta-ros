...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_gz_image/0.244.15-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_gz_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "f629fdb1f713eba49388fa33eb0dc06fcbb16b1f"
S = "${WORKDIR}/git"
