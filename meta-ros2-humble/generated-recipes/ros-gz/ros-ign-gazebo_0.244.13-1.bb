...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign_gazebo/0.244.13-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_ign_gazebo"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "963de13dd087c449ef4b06e1374de958f57d1a84"
S = "${WORKDIR}/git"
