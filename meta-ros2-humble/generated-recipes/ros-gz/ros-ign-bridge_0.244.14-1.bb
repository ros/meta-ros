...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign_bridge/0.244.14-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_ign_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "4b8a3f64c47be226148a56fa3019681ddd917ae5"
S = "${WORKDIR}/git"
