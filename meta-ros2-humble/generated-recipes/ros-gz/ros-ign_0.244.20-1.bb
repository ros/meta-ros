...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign/0.244.20-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_ign"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "e99640eadbed9547bab110933a48f9e662b4860f"
S = "${WORKDIR}/git"
