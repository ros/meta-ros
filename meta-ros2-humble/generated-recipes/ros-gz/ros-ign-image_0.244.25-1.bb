...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign_image/0.244.25-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_ign_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "faa00656981cae561fc7f2eba106d8feacbb03bd"
S = "${WORKDIR}/git"
