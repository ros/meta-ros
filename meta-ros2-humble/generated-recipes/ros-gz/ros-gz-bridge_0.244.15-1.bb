...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_gz_bridge/0.244.15-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_gz_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "29612fb2dbe9c6a21fe1242a25c2eea9a976610a"
S = "${WORKDIR}/git"
