...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign_bridge/0.244.11-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_ign_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "717fb24d7e3dbbc0640053fdde9301643e0cadec"
S = "${WORKDIR}/git"
