...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_gz_bridge/0.244.20-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_gz_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "887376815d109bd723d9f5f4b43a6bd97c77bdcf"
S = "${WORKDIR}/git"
