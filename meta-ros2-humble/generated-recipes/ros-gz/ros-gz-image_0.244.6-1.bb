...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_gz_image/0.244.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_gz_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "d5670804529598befee4e7c614edad31f98d6143"
S = "${WORKDIR}/git"
