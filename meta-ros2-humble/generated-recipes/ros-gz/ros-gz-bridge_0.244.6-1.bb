...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_gz_bridge/0.244.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_gz_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "0a4fbb42209fb1f39c0184713d88840f81be6333"
S = "${WORKDIR}/git"
