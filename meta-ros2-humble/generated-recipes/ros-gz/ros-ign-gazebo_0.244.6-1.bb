...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign_gazebo/0.244.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_ign_gazebo"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "931cde9369c8918af9c630eca46b517c678666e5"
S = "${WORKDIR}/git"
