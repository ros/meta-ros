...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign_image/0.244.14-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_ign_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "31472cef021911d5d3f4efa938cd048c3edb638d"
S = "${WORKDIR}/git"
