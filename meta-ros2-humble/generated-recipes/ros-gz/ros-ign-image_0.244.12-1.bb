...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign_image/0.244.12-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_ign_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "8588febe395f95c4a3cc9b06eefe3796942eac07"
S = "${WORKDIR}/git"
