...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_gz_image/0.244.11-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_gz_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "a028cc608226220637e5e7b1e7e13484cf7b7d33"
S = "${WORKDIR}/git"
