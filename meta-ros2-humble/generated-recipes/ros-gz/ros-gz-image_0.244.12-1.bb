...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_gz_image/0.244.12-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_gz_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "10e42d2e2ea726fccc229774b1e2b813099eef44"
S = "${WORKDIR}/git"
