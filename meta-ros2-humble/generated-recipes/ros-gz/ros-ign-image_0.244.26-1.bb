...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign_image/0.244.26-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_ign_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "dfc948546e8f34a91b43fd54f2d3e65562d9528e"
S = "${WORKDIR}/git"
