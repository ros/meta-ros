...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign/0.244.23-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_ign"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "eb66b5b31a401ac2cdaaee487043639d41d1bc82"
S = "${WORKDIR}/git"
