...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign_bridge/0.244.20-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_ign_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "4d188fa46ea596f77be4aa6e3fe177287153e12b"
S = "${WORKDIR}/git"
