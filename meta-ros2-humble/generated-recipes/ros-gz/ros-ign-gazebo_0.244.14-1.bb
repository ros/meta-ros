...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign_gazebo/0.244.14-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_ign_gazebo"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "8f25a40baa04feb3069abc2a433124c50e1bf841"
S = "${WORKDIR}/git"
