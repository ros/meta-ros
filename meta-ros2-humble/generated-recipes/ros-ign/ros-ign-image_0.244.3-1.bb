...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign_image/0.244.3-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ros_ign_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "b30d2c1fd0174f60574226edc5a479ec7e8bb505"
S = "${WORKDIR}/git"
