...
# matches with: https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/humble/generate_parameter_library_py/0.5.0-1.tar.gz
...
SRCREV = "b1a9dedbd0294cc5b3aca7a8d27752eb62edad6e"
S = "${WORKDIR}/git"
