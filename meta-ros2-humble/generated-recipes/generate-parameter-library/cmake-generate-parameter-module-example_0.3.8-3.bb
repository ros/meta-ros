...
# matches with: https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/humble/cmake_generate_parameter_module_example/0.3.8-3.tar.gz
ROS_BRANCH ?= "branch=release/humble/cmake_generate_parameter_module_example"
SRC_URI = "git://github.com/ros2-gbp/generate_parameter_library-release;${ROS_BRANCH};protocol=https"
SRCREV = "d6ca9bf14b807600f4329e8cc4fc4d273e22b536"
S = "${WORKDIR}/git"
