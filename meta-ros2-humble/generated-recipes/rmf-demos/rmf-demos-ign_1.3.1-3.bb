...
# matches with: https://github.com/ros2-gbp/rmf_demos-release/archive/release/humble/rmf_demos_ign/1.3.1-3.tar.gz
ROS_BRANCH ?= "branch=release/humble/rmf_demos_ign"
SRC_URI = "git://github.com/ros2-gbp/rmf_demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "ecc6ce742bd3316a1544393037aedf73a6e1997e"
S = "${WORKDIR}/git"
