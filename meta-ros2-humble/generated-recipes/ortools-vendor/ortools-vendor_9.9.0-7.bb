...
# matches with: https://github.com/ros2-gbp/ortools_vendor-release/archive/release/humble/ortools_vendor/9.9.0-7.tar.gz
ROS_BRANCH ?= "branch=release/humble/ortools_vendor"
SRC_URI = "git://github.com/ros2-gbp/ortools_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "1470a7ff301e50d287e148af4edc4959c010b4a4"
S = "${WORKDIR}/git"
