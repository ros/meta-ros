...
# matches with: https://github.com/ros2-gbp/velodyne-release/archive/release/humble/velodyne_msgs/2.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/velodyne_msgs"
SRC_URI = "git://github.com/ros2-gbp/velodyne-release;${ROS_BRANCH};protocol=https"
SRCREV = "e9849c9be82195b8d27bbe5f6ea81b24cd6aa3fd"
S = "${WORKDIR}/git"
