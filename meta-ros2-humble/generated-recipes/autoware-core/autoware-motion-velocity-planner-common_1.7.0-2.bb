...
# matches with: https://github.com/ros2-gbp/autoware_core-release/archive/release/humble/autoware_motion_velocity_planner_common/1.7.0-2.tar.gz
...
SRCREV = "94874939e77ac8fe70bfd814ae38dfc88c4ecdf3"
S = "${WORKDIR}/git"
