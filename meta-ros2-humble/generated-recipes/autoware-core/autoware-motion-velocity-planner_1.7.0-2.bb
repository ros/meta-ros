...
# matches with: https://github.com/ros2-gbp/autoware_core-release/archive/release/humble/autoware_motion_velocity_planner/1.7.0-2.tar.gz
...
SRCREV = "89a65012a1396675866d7e39a31831f54661fd53"
S = "${WORKDIR}/git"
