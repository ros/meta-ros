...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/humble/test_bond/3.0.2-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/test_bond"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "3a2071192369ca9f2edd288d2c3d0f2af6e3b808"
S = "${WORKDIR}/git"
