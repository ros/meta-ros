...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/humble/bond_core/4.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/bond_core"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "3d518641a3bd1ffa7ca4f7d5b18fc6ae813f06c2"
S = "${WORKDIR}/git"
