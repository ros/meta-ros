...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/humble/bond_core/3.0.2-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/bond_core"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "e5449cac803c73e2c5a08f05b681b9f3bb874b3e"
S = "${WORKDIR}/git"
