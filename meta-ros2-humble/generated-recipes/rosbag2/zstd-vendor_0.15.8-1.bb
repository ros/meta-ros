...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/zstd_vendor/0.15.8-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/zstd_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "91b621be8b048dd56be7a3ca69a70952cc649db3"
S = "${WORKDIR}/git"
