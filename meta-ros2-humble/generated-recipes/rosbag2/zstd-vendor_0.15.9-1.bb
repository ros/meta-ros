...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/zstd_vendor/0.15.9-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/zstd_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "0506de7348504daef8a5b97e52d6cf8b79f0b0b8"
S = "${WORKDIR}/git"
