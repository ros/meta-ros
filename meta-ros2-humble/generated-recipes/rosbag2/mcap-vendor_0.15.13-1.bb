...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/mcap_vendor/0.15.13-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mcap_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "2a1213404dc70064c558e4e3db31d77961fc20a8"
S = "${WORKDIR}/git"
