...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/zstd_vendor/0.15.7-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/zstd_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "0e8ad7b2dd82b8e2a6c123d05f30d6090cc07a90"
S = "${WORKDIR}/git"
