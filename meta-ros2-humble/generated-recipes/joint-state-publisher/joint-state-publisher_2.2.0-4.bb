...
# matches with: https://github.com/ros2-gbp/joint_state_publisher-release/archive/release/humble/joint_state_publisher/2.2.0-4.tar.gz
...
SRCREV = "d83a42f6db70cc374b797502403b32105fa8215e"
S = "${WORKDIR}/git"
