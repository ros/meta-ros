...
# matches with: https://github.com/ros2-gbp/ffmpeg_image_transport-release/archive/release/humble/ffmpeg_image_transport/1.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ffmpeg_image_transport"
SRC_URI = "git://github.com/ros2-gbp/ffmpeg_image_transport-release;${ROS_BRANCH};protocol=https"
SRCREV = "08ae151a323ba8d5542043d039926826d0a78ddf"
S = "${WORKDIR}/git"
