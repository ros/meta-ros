...
# matches with: https://github.com/ros2-gbp/vrpn_mocap-release/archive/release/humble/vrpn_mocap/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/vrpn_mocap"
SRC_URI = "git://github.com/ros2-gbp/vrpn_mocap-release;${ROS_BRANCH};protocol=https"
SRCREV = "4d4e25880d69d90c2ec7a3285030dabcaf447d3b"
S = "${WORKDIR}/git"
