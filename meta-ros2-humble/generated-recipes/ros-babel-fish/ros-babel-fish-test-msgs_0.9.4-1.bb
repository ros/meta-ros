...
# matches with: https://github.com/ros2-gbp/ros_babel_fish-release/archive/release/humble/ros_babel_fish_test_msgs/0.9.4-1.tar.gz
...
SRCREV = "0d3247b2d6fe4cecfe1a5ebab5c50603213cb1da"
S = "${WORKDIR}/git"
