...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/humble/lanelet2_core/1.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/lanelet2_core"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "abe8919d8125b7c75649ea2eb282dc6a7155bae2"
S = "${WORKDIR}/git"
