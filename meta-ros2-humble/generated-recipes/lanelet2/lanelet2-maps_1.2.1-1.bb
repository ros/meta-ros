...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/humble/lanelet2_maps/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/lanelet2_maps"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a8e21efb90eccba170052cce25f4d1eb2533e8fb"
S = "${WORKDIR}/git"
