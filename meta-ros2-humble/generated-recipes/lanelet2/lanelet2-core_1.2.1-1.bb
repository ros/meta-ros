...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/humble/lanelet2_core/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/lanelet2_core"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "fa0a71cd74e5c6effcbe85435d5ba7a1d4d30f62"
S = "${WORKDIR}/git"
