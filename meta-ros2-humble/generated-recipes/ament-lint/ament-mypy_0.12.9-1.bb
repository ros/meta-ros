...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_mypy/0.12.9-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ament_mypy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "b4c95c201ccc52bcf8d2017fecc86215310f62c9"
S = "${WORKDIR}/git"
