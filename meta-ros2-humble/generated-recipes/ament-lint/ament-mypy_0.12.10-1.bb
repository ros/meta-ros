...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_mypy/0.12.10-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ament_mypy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "3265ec3414db735c41cad713567eed1f8dad40cd"
S = "${WORKDIR}/git"
