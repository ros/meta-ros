...
# matches with: https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/mecanum_drive_controller/2.50.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mecanum_drive_controller"
SRC_URI = "git://github.com/ros2-gbp/ros2_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "9378bc1d3649a0912f5069b2b8f671b6ac3f20f8"
S = "${WORKDIR}/git"
