...
# matches with: https://github.com/ros2-gbp/twist_mux-release/archive/release/humble/twist_mux/4.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/twist_mux"
SRC_URI = "git://github.com/ros2-gbp/twist_mux-release;${ROS_BRANCH};protocol=https"
SRCREV = "aa6f2e0bdc52f30ccf7f23194060c061734e9d77"
S = "${WORKDIR}/git"
