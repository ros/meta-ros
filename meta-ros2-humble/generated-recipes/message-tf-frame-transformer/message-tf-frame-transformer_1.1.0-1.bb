...
# matches with: https://github.com/ika-rwth-aachen/message_tf_frame_transformer-release/archive/release/humble/message_tf_frame_transformer/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/message_tf_frame_transformer"
SRC_URI = "git://github.com/ika-rwth-aachen/message_tf_frame_transformer-release;${ROS_BRANCH};protocol=https"
SRCREV = "9e9a3385ad14f435f78bf5fb9acf8de8686b5d8a"
S = "${WORKDIR}/git"
