...
# matches with: https://github.com/ros2-gbp/psdk_ros2-release/archive/release/humble/psdk_wrapper/1.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/psdk_wrapper"
SRC_URI = "git://github.com/ros2-gbp/psdk_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "3b98f3316d8bedafbbf50b838d0db42ebb000f1b"
S = "${WORKDIR}/git"
