...
# matches with: https://github.com/ros2-gbp/psdk_ros2-release/archive/release/humble/psdk_wrapper/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/psdk_wrapper"
SRC_URI = "git://github.com/ros2-gbp/psdk_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "2f5d74a481333db4e31c6ecdaaf93a71c53f8c1d"
S = "${WORKDIR}/git"
