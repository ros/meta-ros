...
# matches with: https://github.com/ros2-gbp/astuff_sensor_msgs-release/archive/release/humble/neobotix_usboard_msgs/4.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/neobotix_usboard_msgs"
SRC_URI = "git://github.com/ros2-gbp/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "55dcf1a27f53170939a97d03ae97fb41c9c0290c"
S = "${WORKDIR}/git"
