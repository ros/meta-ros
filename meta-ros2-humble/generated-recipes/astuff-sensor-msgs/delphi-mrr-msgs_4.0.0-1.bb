...
# matches with: https://github.com/ros2-gbp/astuff_sensor_msgs-release/archive/release/humble/delphi_mrr_msgs/4.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/delphi_mrr_msgs"
SRC_URI = "git://github.com/ros2-gbp/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "71318823e5f054908d65eaced64dbfe52da1fc51"
S = "${WORKDIR}/git"
