...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/humble/rosidl_parser/3.1.5-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "1053e51a06309d2bed8245ad84f1f32fd5e0111b"
S = "${WORKDIR}/git"
