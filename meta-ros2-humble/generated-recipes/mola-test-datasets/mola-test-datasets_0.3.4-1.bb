...
# matches with: https://github.com/ros2-gbp/mola_test_datasets-release/archive/release/humble/mola_test_datasets/0.3.4-1.tar.gz
...
SRCREV = "eb19f15779abcbfb2e766718b7a07505bf57554e"
S = "${WORKDIR}/git"
