...
# matches with: https://github.com/SBG-Systems/sbg_ros2-release/archive/release/humble/sbg_driver/3.3.2-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/sbg_driver"
SRC_URI = "git://github.com/SBG-Systems/sbg_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "7af132cc2e37936f110e1eb2c2430fb6c98c8aa0"
S = "${WORKDIR}/git"
