...
# matches with: https://github.com/ros2-gbp/perception_pcl-release/archive/release/humble/pcl_ros/2.4.0-6.tar.gz
ROS_BRANCH ?= "branch=release/humble/pcl_ros"
SRC_URI = "git://github.com/ros2-gbp/perception_pcl-release;${ROS_BRANCH};protocol=https"
SRCREV = "3522a4423dd789c8e8697a46f2b59c56079e4acc"
S = "${WORKDIR}/git"
