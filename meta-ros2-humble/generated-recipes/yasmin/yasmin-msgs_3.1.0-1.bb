...
# matches with: https://github.com/ros2-gbp/yasmin-release/archive/release/humble/yasmin_msgs/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/yasmin_msgs"
SRC_URI = "git://github.com/ros2-gbp/yasmin-release;${ROS_BRANCH};protocol=https"
SRCREV = "51a3961a7cc1d85903be93f3b22bbe9a894c2fbb"
S = "${WORKDIR}/git"
