...
# matches with: https://github.com/ros2-gbp/yasmin-release/archive/release/humble/yasmin_editor/5.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/yasmin_editor"
SRC_URI = "git://github.com/ros2-gbp/yasmin-release;${ROS_BRANCH};protocol=https"
SRCREV = "a7e4e96a5394a6b5839821a32c3283cb25bad259"
S = "${WORKDIR}/git"
