...
# matches with: https://github.com/ros2-gbp/yasmin-release/archive/release/humble/yasmin_demos/4.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/yasmin_demos"
SRC_URI = "git://github.com/ros2-gbp/yasmin-release;${ROS_BRANCH};protocol=https"
SRCREV = "ef5a542adde3d8e28b26a93cef0e6d77b055afa2"
S = "${WORKDIR}/git"
