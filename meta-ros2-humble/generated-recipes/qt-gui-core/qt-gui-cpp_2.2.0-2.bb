...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/humble/qt_gui_cpp/2.2.0-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/qt_gui_cpp"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "9569b1c3ce0858a76b89af349ddc90b4bc649c26"
S = "${WORKDIR}/git"
