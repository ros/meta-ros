...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/humble/qt_gui_cpp/2.2.3-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/qt_gui_cpp"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "e59f89fc5fc8fe80378847975b3aa5985aa6e197"
S = "${WORKDIR}/git"
