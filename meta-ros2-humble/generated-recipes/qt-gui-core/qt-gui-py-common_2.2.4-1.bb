...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/humble/qt_gui_py_common/2.2.4-1.tar.gz
...
SRCREV = "fb244778d2e8b4dfeda4ce284dd159d8e33985cf"
S = "${WORKDIR}/git"
