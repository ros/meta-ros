...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/humble/qt_gui/2.2.5-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "7d2b704bd3c32d8ba79cc27e9729dc3fa2f23b11"
S = "${WORKDIR}/git"
