...
# matches with: https://github.com/ros2-gbp/rclc-release/archive/release/humble/rclc_examples/3.0.8-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/rclc_examples"
SRC_URI = "git://github.com/ros2-gbp/rclc-release;${ROS_BRANCH};protocol=https"
SRCREV = "d7df2bd7527a7133cf46246c2e577b1253a2edea"
S = "${WORKDIR}/git"
