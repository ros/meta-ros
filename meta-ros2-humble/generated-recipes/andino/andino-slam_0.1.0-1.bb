...
# matches with: https://github.com/ros2-gbp/andino-release/archive/release/humble/andino_slam/0.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/andino_slam"
SRC_URI = "git://github.com/ros2-gbp/andino-release;${ROS_BRANCH};protocol=https"
SRCREV = "8d9d38bdc061b52dec34f852bdec68a0e633e5b9"
S = "${WORKDIR}/git"
