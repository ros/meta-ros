...
# matches with: https://github.com/ros2-gbp/andino-release/archive/release/humble/andino_bringup/0.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/andino_bringup"
SRC_URI = "git://github.com/ros2-gbp/andino-release;${ROS_BRANCH};protocol=https"
SRCREV = "c756f847fb5cfc2bd4e4d1fef205369d689af7bf"
S = "${WORKDIR}/git"
