...
# matches with: https://github.com/ros2-gbp/andino-release/archive/release/humble/andino_description/0.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/andino_description"
SRC_URI = "git://github.com/ros2-gbp/andino-release;${ROS_BRANCH};protocol=https"
SRCREV = "fc0d2c229d08bd1b3d5bcf51f533e5465711bc6c"
S = "${WORKDIR}/git"
