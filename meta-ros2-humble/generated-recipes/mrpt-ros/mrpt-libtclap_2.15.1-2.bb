...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libtclap/2.15.1-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libtclap"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "dabcf05d0c71a67f56f37f82df6fe48a683780b8"
S = "${WORKDIR}/git"
