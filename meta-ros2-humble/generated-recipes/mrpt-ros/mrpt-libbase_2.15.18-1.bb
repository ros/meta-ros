...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libbase/2.15.18-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libbase"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "6006d4ce4edc21823c1932e808cee341ed4fd0db"
S = "${WORKDIR}/git"
