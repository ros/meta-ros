...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libnav/2.14.16-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libnav"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "c46026653b4a1dca4edcecdfd70de3509aa6e726"
S = "${WORKDIR}/git"
