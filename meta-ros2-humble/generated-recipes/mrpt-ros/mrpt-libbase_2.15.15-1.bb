...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libbase/2.15.15-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libbase"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "91b71c72b2e8764a9335410e10995dff44adc8b6"
S = "${WORKDIR}/git"
