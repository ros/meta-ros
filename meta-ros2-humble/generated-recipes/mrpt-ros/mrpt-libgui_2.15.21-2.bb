...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libgui/2.15.21-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libgui"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "24f23de84490e6a8280bc07d129536448f8e3901"
S = "${WORKDIR}/git"
