...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libmaps/2.15.18-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libmaps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "9b5cbc17b1c20e1ea09061803837e65a1a294a8a"
S = "${WORKDIR}/git"
