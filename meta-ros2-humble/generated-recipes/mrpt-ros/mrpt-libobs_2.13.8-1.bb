...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libobs/2.13.8-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libobs"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "bbe4596467bf662adce19d79b6ad4856a281dd64"
S = "${WORKDIR}/git"
