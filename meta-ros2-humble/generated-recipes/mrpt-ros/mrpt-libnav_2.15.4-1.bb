...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libnav/2.15.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libnav"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "872e74294ec79ba9eb1c4fe75ed3defdc409cc68"
S = "${WORKDIR}/git"
