...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libobs/2.15.1-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libobs"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "ae5ea784b9d8e94f44586baf42150fadc4fafb86"
S = "${WORKDIR}/git"
