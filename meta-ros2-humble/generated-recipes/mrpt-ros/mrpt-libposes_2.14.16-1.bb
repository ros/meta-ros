...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libposes/2.14.16-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libposes"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "bf44be8b71bb2a00d01c96a63bea02da3bc0be97"
S = "${WORKDIR}/git"
