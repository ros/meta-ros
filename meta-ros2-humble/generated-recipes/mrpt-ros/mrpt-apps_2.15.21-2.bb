...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_apps/2.15.21-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_apps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "bc197bb0e2d45313544a74db7ad75ca10a7ffd2a"
S = "${WORKDIR}/git"
