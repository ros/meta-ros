...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libtclap/2.14.12-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libtclap"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "642f8fc087bba9a033d6fd0603a5d810c366fa92"
S = "${WORKDIR}/git"
