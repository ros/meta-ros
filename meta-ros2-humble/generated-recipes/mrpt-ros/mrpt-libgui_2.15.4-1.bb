...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libgui/2.15.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libgui"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "3a72be003af12b0c567797db806e681551c3621b"
S = "${WORKDIR}/git"
