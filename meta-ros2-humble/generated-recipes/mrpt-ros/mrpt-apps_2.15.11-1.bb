...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_apps/2.15.11-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_apps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "5a5b8c629a37906276f97d616f15aa0b8db41f70"
S = "${WORKDIR}/git"
