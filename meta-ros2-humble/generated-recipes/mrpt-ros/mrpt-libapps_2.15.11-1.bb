...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libapps/2.15.11-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libapps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "c3870db47fbe0a9fa19bf68b72a8c9ecf814a633"
S = "${WORKDIR}/git"
