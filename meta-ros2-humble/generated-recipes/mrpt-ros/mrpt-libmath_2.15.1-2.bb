...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libmath/2.15.1-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libmath"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "4040381745de17d3d55c4670eb7e2f1cfb4bd29e"
S = "${WORKDIR}/git"
