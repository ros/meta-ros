...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libnav/2.15.21-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libnav"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "356284eabc722be6bb233ae2d8b189a12ac47f72"
S = "${WORKDIR}/git"
