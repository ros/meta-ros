...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libtclap/2.15.15-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libtclap"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "e7a31a54f451e2137d2aa6e995217be5b59ef731"
S = "${WORKDIR}/git"
