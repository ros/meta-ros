...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libslam/2.13.8-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libslam"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "63b1faa8429b1e6167732957aebe2fedd6d85cf5"
S = "${WORKDIR}/git"
