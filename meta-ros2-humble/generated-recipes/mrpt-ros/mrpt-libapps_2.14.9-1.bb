...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libapps/2.14.9-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libapps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "5a545c53712c6a3eb601296be0a4aa90647eb1af"
S = "${WORKDIR}/git"
