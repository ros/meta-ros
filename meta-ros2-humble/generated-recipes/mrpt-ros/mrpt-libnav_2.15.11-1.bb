...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libnav/2.15.11-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libnav"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "0d52faeaca8135ea6dcadd817cde276a589d30a7"
S = "${WORKDIR}/git"
