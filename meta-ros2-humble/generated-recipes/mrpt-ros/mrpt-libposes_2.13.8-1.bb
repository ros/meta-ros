...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libposes/2.13.8-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libposes"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "e3df2783fbf2199316e00133b11ea7284b2cd84c"
S = "${WORKDIR}/git"
