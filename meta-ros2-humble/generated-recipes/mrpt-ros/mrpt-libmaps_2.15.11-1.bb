...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libmaps/2.15.11-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libmaps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "783835958f1427b72cada68f6efc7d130e7a6cae"
S = "${WORKDIR}/git"
