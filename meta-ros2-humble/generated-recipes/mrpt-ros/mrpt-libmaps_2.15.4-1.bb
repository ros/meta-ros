...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libmaps/2.15.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mrpt_libmaps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "8c7cada30f097bf8b7250019dc65670caa0902b8"
S = "${WORKDIR}/git"
