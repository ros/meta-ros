...
# matches with: https://github.com/ros2-gbp/rqt_graph-release/archive/release/humble/rqt_graph/1.2.1-3.tar.gz
ROS_BRANCH ?= "branch=release/humble/rqt_graph"
SRC_URI = "git://github.com/ros2-gbp/rqt_graph-release;${ROS_BRANCH};protocol=https"
SRCREV = "bd647d8af6a219968189c0f484c6dd8ada4d99da"
S = "${WORKDIR}/git"
