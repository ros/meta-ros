...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_traj_tools/1.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "090029a2617c95be0ce81cbea49afee04ed4fe0e"
S = "${WORKDIR}/git"
