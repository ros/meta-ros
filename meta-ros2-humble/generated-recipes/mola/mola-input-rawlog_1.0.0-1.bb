...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_input_rawlog/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_input_rawlog"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "93a2013589e1be7272223bc39c5909193d747a5d"
S = "${WORKDIR}/git"
