...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_traj_tools/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "5dd5e4a01c5af5b9871dbb9c88760be146809fe4"
S = "${WORKDIR}/git"
