...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_traj_tools/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "927d97b8be8a272b39347a7b6f4f07a3315f815a"
S = "${WORKDIR}/git"
