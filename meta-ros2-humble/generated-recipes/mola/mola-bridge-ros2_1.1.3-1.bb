...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_bridge_ros2/1.1.3-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_bridge_ros2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "38b9dde9b08b42f11d28679ffdd7dd37f63c4c89"
S = "${WORKDIR}/git"
