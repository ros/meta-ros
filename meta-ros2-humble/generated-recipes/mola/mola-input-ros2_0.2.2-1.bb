...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_input_ros2/0.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_input_ros2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "8354871a9a1e338dee1e03490c13919b6a7102fe"
S = "${WORKDIR}/git"
