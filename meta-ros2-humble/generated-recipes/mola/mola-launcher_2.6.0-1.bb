...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_launcher/2.6.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_launcher"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "d179cd9ea5d25ba16b5079e8d60058eda7b12c1f"
S = "${WORKDIR}/git"
