...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_bridge_ros2/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_bridge_ros2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "cb7cfcf3c3eb10f5477e6cebcd8ba7dbf681a962"
S = "${WORKDIR}/git"
