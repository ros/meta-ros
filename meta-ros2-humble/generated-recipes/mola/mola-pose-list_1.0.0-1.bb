...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_pose_list/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_pose_list"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "adfc15df2b5a7f224b05a521937eb66a0bcdcf33"
S = "${WORKDIR}/git"
