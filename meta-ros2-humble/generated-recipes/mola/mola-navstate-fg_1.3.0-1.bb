...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_navstate_fg/1.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_navstate_fg"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "0d2901587f4c082defc8f193e654ac90a4a6e7da"
S = "${WORKDIR}/git"
