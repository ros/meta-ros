...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_launcher/1.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_launcher"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "b31fe24afb19f51c08b49b0b0a51eff0836fa5ff"
S = "${WORKDIR}/git"
