...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_bridge_ros2/1.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_bridge_ros2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "41af74c03530384b901db8e5027bf7ef48be1e4b"
S = "${WORKDIR}/git"
