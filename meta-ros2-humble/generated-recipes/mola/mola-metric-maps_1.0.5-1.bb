...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_metric_maps/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_metric_maps"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "dfe379bb98261cd3ef0e86187ab235a6373a3d0f"
S = "${WORKDIR}/git"
