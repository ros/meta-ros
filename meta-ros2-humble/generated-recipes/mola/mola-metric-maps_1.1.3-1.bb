...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_metric_maps/1.1.3-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_metric_maps"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "24e8bf3e8e6dfeaf494218956381d8c9d4c4d1b6"
S = "${WORKDIR}/git"
