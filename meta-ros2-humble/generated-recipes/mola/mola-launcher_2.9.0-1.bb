...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_launcher/2.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_launcher"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "583960c074dbd202239518f88559b95c0e1054ec"
S = "${WORKDIR}/git"
