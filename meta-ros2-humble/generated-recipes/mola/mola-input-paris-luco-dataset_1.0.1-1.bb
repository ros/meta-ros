...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_input_paris_luco_dataset/1.0.1-1.tar.gz
...
SRCREV = "be004964e395193fa88d6274ce13530f7972065f"
S = "${WORKDIR}/git"
