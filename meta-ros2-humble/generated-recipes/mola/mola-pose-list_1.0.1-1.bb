...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_pose_list/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_pose_list"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "0acb1bef3183dea79ecb898ee41a8425ffbeace3"
S = "${WORKDIR}/git"
