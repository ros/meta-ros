...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_metric_maps/2.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_metric_maps"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "58dec3d5c57a8ad54e7f0efe9dcff05612366db1"
S = "${WORKDIR}/git"
