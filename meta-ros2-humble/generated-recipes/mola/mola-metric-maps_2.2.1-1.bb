...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_metric_maps/2.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_metric_maps"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "379711c9fd98baeead4114a51ff4b633e613ead1"
S = "${WORKDIR}/git"
