...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_launcher/1.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_launcher"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "d6703fc875d6abbcd3405261c6c9fa5a5db888c3"
S = "${WORKDIR}/git"
