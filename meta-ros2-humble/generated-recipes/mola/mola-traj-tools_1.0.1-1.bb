...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_traj_tools/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "3871de9ee03021059c846edb20c2973082905d42"
S = "${WORKDIR}/git"
