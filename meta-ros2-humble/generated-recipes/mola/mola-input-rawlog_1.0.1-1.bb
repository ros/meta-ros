...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_input_rawlog/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/mola_input_rawlog"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "85332c6b447d28a9a53d1fa5e3edbefbfaaca9d3"
S = "${WORKDIR}/git"
