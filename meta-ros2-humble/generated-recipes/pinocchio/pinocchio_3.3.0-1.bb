...
# matches with: https://github.com/ros2-gbp/pinocchio-release/archive/release/humble/pinocchio/3.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/pinocchio"
SRC_URI = "git://github.com/ros2-gbp/pinocchio-release;${ROS_BRANCH};protocol=https"
SRCREV = "67a706d3a7149992ed45c73a7d52d03feda2db3b"
S = "${WORKDIR}/git"
