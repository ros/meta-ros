...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_servo/2.5.8-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/moveit_servo"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "585df932aa0a337b05fb8a96515da1de6fc2688e"
S = "${WORKDIR}/git"
