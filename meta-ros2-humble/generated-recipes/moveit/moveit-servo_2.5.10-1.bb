...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_servo/2.5.10-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/moveit_servo"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8669acc5d97d2b6dcb50cf3552ed4cd51db35e04"
S = "${WORKDIR}/git"
