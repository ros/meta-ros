...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_ros/2.5.7-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/moveit_ros"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "f65741ea61bffe80c91828e3b1eb59b278430df6"
S = "${WORKDIR}/git"
