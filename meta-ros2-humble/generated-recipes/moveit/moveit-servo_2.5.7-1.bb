...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_servo/2.5.7-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/moveit_servo"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "18869715dae328032e960c2201c757db2ee1f278"
S = "${WORKDIR}/git"
