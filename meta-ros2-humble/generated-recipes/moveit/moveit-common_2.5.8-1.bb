...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_common/2.5.8-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e9a27a9becc8757e9e565d57b39e89130e388eaa"
S = "${WORKDIR}/git"
