...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_ros/2.5.5-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/moveit_ros"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "7cc6ae3d5a140f180fa434e0f10d47f0d91c17d0"
S = "${WORKDIR}/git"
