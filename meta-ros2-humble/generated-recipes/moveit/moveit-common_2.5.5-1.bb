...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_common/2.5.5-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "275d2376bb4449b908587033ee872c21826d9efd"
S = "${WORKDIR}/git"
