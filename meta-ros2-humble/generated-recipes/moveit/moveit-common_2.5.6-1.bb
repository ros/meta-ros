...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_common/2.5.6-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "1cd514aeafc050bd1cfe3e93cdc7bf762d1e468b"
S = "${WORKDIR}/git"
