...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_cpm_ts_coding/2.2.0-1.tar.gz
...
SRCREV = "8698db167e2b85454d1b5943f7417608300b4eb3"
S = "${WORKDIR}/git"
