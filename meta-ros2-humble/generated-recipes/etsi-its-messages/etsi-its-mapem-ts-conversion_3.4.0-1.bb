...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_mapem_ts_conversion/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/etsi_its_mapem_ts_conversion"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "d13ba545359f6c2458d35c8def1bc836ff5e8e52"
S = "${WORKDIR}/git"
