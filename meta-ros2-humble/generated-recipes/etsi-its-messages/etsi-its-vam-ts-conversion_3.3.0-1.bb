...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_vam_ts_conversion/3.3.0-1.tar.gz
...
SRCREV = "a4e81b008784a332c1948b3f0a0d1de4092fa2cc"
S = "${WORKDIR}/git"
