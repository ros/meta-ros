...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_mapem_ts_msgs/3.0.0-1.tar.gz
...
SRCREV = "830296f243be8e54041ffd422595160f45787e9f"
S = "${WORKDIR}/git"
