...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_mapem_ts_msgs/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/etsi_its_mapem_ts_msgs"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "5007bdb4715901ec040ab598d0dc4bb81e2b57e3"
S = "${WORKDIR}/git"
