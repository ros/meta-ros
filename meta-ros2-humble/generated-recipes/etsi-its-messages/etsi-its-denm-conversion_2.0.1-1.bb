...
# matches with: https://github.com/ika-rwth-aachen/etsi_its_messages-release/archive/release/humble/etsi_its_denm_conversion/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/etsi_its_denm_conversion"
SRC_URI = "git://github.com/ika-rwth-aachen/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "47a52ef8d9f34689f607943be9f0b1add4002c2a"
S = "${WORKDIR}/git"
