...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_denm_ts_msgs/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/etsi_its_denm_ts_msgs"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "f2d951ad7eb4ca1c3dbc0dbb76da83bb4e0f8ea1"
S = "${WORKDIR}/git"
