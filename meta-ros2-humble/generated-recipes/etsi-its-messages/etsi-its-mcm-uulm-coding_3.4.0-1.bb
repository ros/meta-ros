...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_mcm_uulm_coding/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/etsi_its_mcm_uulm_coding"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "5f3cfb200f882bc7bd36339d4869e24149ae2e44"
S = "${WORKDIR}/git"
