...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_denm_conversion/3.2.1-1.tar.gz
...
SRCREV = "325151237728caa4e5be27c2b5f57f4c2879fc2a"
S = "${WORKDIR}/git"
