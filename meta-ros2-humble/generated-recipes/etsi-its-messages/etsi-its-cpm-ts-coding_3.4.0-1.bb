...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_cpm_ts_coding/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/etsi_its_cpm_ts_coding"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "880832c3770570918ae17aa07c367a9b02a14098"
S = "${WORKDIR}/git"
