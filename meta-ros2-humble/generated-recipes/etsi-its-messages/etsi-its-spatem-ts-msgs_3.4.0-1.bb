...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_spatem_ts_msgs/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/etsi_its_spatem_ts_msgs"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "60998e04187d6701815edb455902886c1b9d3430"
S = "${WORKDIR}/git"
