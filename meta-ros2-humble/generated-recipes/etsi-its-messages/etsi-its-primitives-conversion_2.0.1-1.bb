...
# matches with: https://github.com/ika-rwth-aachen/etsi_its_messages-release/archive/release/humble/etsi_its_primitives_conversion/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/etsi_its_primitives_conversion"
SRC_URI = "git://github.com/ika-rwth-aachen/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "715fb8d6c463cc88d9a50c2c1b11a3e1d2dc50c2"
S = "${WORKDIR}/git"
