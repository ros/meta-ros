...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_mcm_uulm_msgs/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/etsi_its_mcm_uulm_msgs"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "2214fd87d2597eab7a0e09b460d5ad551574859f"
S = "${WORKDIR}/git"
