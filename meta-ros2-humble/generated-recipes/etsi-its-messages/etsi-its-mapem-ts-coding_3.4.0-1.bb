...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_mapem_ts_coding/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/etsi_its_mapem_ts_coding"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "b3026ded3bcdbd83d40215e9ea8320c6e5d227dc"
S = "${WORKDIR}/git"
