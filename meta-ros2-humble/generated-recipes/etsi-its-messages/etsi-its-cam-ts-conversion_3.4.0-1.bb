...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_cam_ts_conversion/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/etsi_its_cam_ts_conversion"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "efe4b17437aece50ba5b413dc60fe704ee180971"
S = "${WORKDIR}/git"
