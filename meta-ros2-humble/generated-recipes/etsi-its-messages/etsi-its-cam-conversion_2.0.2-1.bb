...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_cam_conversion/2.0.2-1.tar.gz
...
SRCREV = "b973505d3988617cdc8b39f7d4fe256dba9dfb0f"
S = "${WORKDIR}/git"
