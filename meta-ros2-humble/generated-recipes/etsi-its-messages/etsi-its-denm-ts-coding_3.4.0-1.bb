...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_denm_ts_coding/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/etsi_its_denm_ts_coding"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "341af80342ed578e4dec561b9afb1d69b30ae8be"
S = "${WORKDIR}/git"
