...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/humble/ecl_mobile_robot/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ecl_mobile_robot"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "4c1768ae0bace52f474e88d6ee0d0cd4b5aae973"
S = "${WORKDIR}/git"
