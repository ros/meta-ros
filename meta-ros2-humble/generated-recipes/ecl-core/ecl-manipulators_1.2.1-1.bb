...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/humble/ecl_manipulators/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ecl_manipulators"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "4f8f5665058a5abfacdc1a0f33e73cd0afb67621"
S = "${WORKDIR}/git"
