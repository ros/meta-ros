...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/humble/ecl_math/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ecl_math"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "d060b5c99fd52ffd9bc54f7b1d9b7286799ca1ca"
S = "${WORKDIR}/git"
