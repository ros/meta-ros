...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/humble/ecl_containers/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ecl_containers"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "4432e5f58cc42623cb1afaeecdba4447acd71a2a"
S = "${WORKDIR}/git"
