...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/humble/ecl_formatters/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ecl_formatters"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "72c0315b06e1d7ac44f953715b178feb3036c9b7"
S = "${WORKDIR}/git"
