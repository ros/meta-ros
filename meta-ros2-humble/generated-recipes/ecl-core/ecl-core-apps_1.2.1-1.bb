...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/humble/ecl_core_apps/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ecl_core_apps"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "c651a635ac18e2cf94f9cd4b9d382155ec61aea4"
S = "${WORKDIR}/git"
