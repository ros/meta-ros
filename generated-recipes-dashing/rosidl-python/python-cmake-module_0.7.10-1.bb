...
SRC_URI = "https://github.com/ros2-gbp/rosidl_python-release/archive/release/dashing/python_cmake_module/0.7.10-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "49fd16a3dde7bc32fe5831d12798a369"
SRC_URI[sha256sum] = "1ea605fb2a6decdf9c5c0dc0d52521db386fdcd9c0143f8da4893b8923d65487"
S = "${WORKDIR}/rosidl_python-release-release-dashing-python_cmake_module-0.7.10-1"
