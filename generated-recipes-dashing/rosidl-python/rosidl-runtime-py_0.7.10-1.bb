...
SRC_URI = "https://github.com/ros2-gbp/rosidl_python-release/archive/release/dashing/rosidl_runtime_py/0.7.10-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "6143338081dd7b1d2cac5f77f86037e1"
SRC_URI[sha256sum] = "6684a827307046043fa61a0807c8b57dc0e52c6fc9a45ab877ce92f92b701dff"
S = "${WORKDIR}/rosidl_python-release-release-dashing-rosidl_runtime_py-0.7.10-1"
