...
SRC_URI = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/dashing/qt_gui_cpp/1.0.5-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "047e60bf87bdc75e711fd62f4e56e6db"
SRC_URI[sha256sum] = "2710e10537eba3e6e26640cbcb7f536ac5ee6cdc5af2ee4a284e2bddd33ff249"
S = "${WORKDIR}/qt_gui_core-release-release-dashing-qt_gui_cpp-1.0.5-1"
