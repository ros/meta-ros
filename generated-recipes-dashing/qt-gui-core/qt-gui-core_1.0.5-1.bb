...
SRC_URI = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/dashing/qt_gui_core/1.0.5-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "64943e839d42c5603b2d0c271d52d15f"
SRC_URI[sha256sum] = "be9ffb20110afee67965f20bfab282f5ee7a77fafac1e2a87cff0b72f9ddd6fa"
S = "${WORKDIR}/qt_gui_core-release-release-dashing-qt_gui_core-1.0.5-1"
