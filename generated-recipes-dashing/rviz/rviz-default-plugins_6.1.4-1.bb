...
SRC_URI = "https://github.com/ros2-gbp/rviz-release/archive/release/dashing/rviz_default_plugins/6.1.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "96c0527d6fb655a3a0cc061b3f21908f"
SRC_URI[sha256sum] = "e00f52eb0ba6e7b0755b9228490dd982eb1306222ddac9b47eb0a8fd0bf8c33b"
S = "${WORKDIR}/rviz-release-release-dashing-rviz_default_plugins-6.1.4-1"
