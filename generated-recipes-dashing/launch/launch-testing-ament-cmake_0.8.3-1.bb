...
SRC_URI = "https://github.com/ros2-gbp/launch-release/archive/release/dashing/launch_testing_ament_cmake/0.8.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "11048cabb77757bd14be5496d8caec66"
SRC_URI[sha256sum] = "dffda1a80be92d39ec9833d23fe99a88a76e28e7bac592c9d4eff7cbe5129650"
S = "${WORKDIR}/launch-release-release-dashing-launch_testing_ament_cmake-0.8.3-1"
