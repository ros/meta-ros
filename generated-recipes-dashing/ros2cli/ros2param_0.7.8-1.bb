...
SRC_URI = "https://github.com/ros2-gbp/ros2cli-release/archive/release/dashing/ros2param/0.7.8-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "7d621d66a71c8e41d65bda50d0e69e2b"
SRC_URI[sha256sum] = "7899c1ccb0a4803dcef8bfc386a6b2d522501bba3345a6a584ff061452d2afee"
S = "${WORKDIR}/ros2cli-release-release-dashing-ros2param-0.7.8-1"
