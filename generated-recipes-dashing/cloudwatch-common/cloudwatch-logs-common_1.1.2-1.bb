...
SRC_URI = "https://github.com/aws-gbp/cloudwatch_common-release/archive/release/dashing/cloudwatch_logs_common/1.1.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "c33209ef988e43a44cdd4a29760ffb8a"
SRC_URI[sha256sum] = "02a0f0b6fa4f57da332b379dbb2b5d12a1dae647be942232c6078430f38c1ee7"
S = "${WORKDIR}/cloudwatch_common-release-release-dashing-cloudwatch_logs_common-1.1.2-1"
