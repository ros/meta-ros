...
SRC_URI = "https://github.com/aws-gbp/cloudwatch_common-release/archive/release/dashing/dataflow_lite/1.1.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "42267e29acd694e2a7544661693c0ebb"
SRC_URI[sha256sum] = "3b8be01f3b1b075c22c70ab6de3fbfc0ae8aa776c286eda4f426b94cad0f95a2"
S = "${WORKDIR}/cloudwatch_common-release-release-dashing-dataflow_lite-1.1.2-1"
