...
SRC_URI = "https://github.com/aws-gbp/cloudwatch_common-release/archive/release/dashing/cloudwatch_metrics_common/1.1.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a3023d61aabcda6645f71fce70092523"
SRC_URI[sha256sum] = "aa6226c67e5609a4c0266f64492155d352b404564ee9839f8aaa3277bd68432e"
S = "${WORKDIR}/cloudwatch_common-release-release-dashing-cloudwatch_metrics_common-1.1.2-1"
