...
SRC_URI = "https://github.com/ros2-gbp/demos-release/archive/release/dashing/logging_demo/0.7.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "032773eb4f0acfed602dc74be7fe7f8b"
SRC_URI[sha256sum] = "b4ddc521477aaa29d4a4a4d54c69032f3dc0effec78c9ce3437da643db235cfc"
S = "${WORKDIR}/demos-release-release-dashing-logging_demo-0.7.6-1"
