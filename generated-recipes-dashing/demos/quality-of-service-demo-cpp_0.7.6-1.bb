...
SRC_URI = "https://github.com/ros2-gbp/demos-release/archive/release/dashing/quality_of_service_demo_cpp/0.7.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9b6579e1c45ccc28e8dafdffe26a2959"
SRC_URI[sha256sum] = "f1b93dd7bebd9b9c7e7a817bde8245f077b59984962d5a9fa5c559e07ef9ee55"
S = "${WORKDIR}/demos-release-release-dashing-quality_of_service_demo_cpp-0.7.6-1"
