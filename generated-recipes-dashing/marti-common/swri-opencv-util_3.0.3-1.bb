...
SRC_URI = "https://github.com/swri-robotics-gbp/marti_common-release/archive/release/dashing/swri_opencv_util/3.0.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "ec9ca4ac52727a229706be5e7c1bd7dc"
SRC_URI[sha256sum] = "f894ccdb0c7829a4bb1c1d97bb2469a3d10d93a6154ccfe845ae5b3bd277e436"
S = "${WORKDIR}/marti_common-release-release-dashing-swri_opencv_util-3.0.3-1"
