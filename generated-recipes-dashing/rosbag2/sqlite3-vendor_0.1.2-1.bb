...
SRC_URI = "https://github.com/ros2-gbp/rosbag2-release/archive/release/dashing/sqlite3_vendor/0.1.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "7b602e894e3b6697e341cd85b9c80f9e"
SRC_URI[sha256sum] = "1310c55bd190c53853208b64e6e6d719cd68ca74b9c52492339346422469028f"
S = "${WORKDIR}/rosbag2-release-release-dashing-sqlite3_vendor-0.1.2-1"
