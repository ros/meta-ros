...
# matches with: https://github.com/ros2-gbp/irobot_create_msgs-release/archive/release/kilted/irobot_create_msgs/2.1.0-4.tar.gz
ROS_BRANCH ?= "branch=release/kilted/irobot_create_msgs"
SRC_URI = "git://github.com/ros2-gbp/irobot_create_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "3359af979f78de5d4e0885ca48a22c597d914c2a"
S = "${WORKDIR}/git"
