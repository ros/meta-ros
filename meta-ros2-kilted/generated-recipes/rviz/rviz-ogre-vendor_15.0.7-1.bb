...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_ogre_vendor/15.0.7-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "a308750644df5ce08dbb2799c4a6d135e0d2a6d8"
S = "${WORKDIR}/git"
