...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_ogre_vendor/15.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "15cb82f2954948a3868001e2ea3472029b813d94"
S = "${WORKDIR}/git"
