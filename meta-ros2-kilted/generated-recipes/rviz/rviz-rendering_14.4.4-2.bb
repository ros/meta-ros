...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_rendering/14.4.4-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rviz_rendering"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "da4b792d42a4ef8e4e259ae776dbf09e16bd6873"
S = "${WORKDIR}/git"
