...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_rendering/15.0.13-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rviz_rendering"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "42f2fc1aa4a98c9a1be9df557a21afe99375b3de"
S = "${WORKDIR}/git"
