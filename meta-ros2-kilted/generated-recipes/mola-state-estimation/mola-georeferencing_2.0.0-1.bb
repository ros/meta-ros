...
# matches with: https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/kilted/mola_georeferencing/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mola_georeferencing"
SRC_URI = "git://github.com/ros2-gbp/mola_state_estimation-release;${ROS_BRANCH};protocol=https"
SRCREV = "e935ff684c577c029481172ae6f99a0f6ea0db58"
S = "${WORKDIR}/git"
