...
# matches with: https://github.com/ros2-gbp/autoware_internal_msgs-release/archive/release/kilted/autoware_internal_msgs/1.8.1-3.tar.gz
ROS_BRANCH ?= "branch=release/kilted/autoware_internal_msgs"
SRC_URI = "git://github.com/ros2-gbp/autoware_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "8ff3a92b3d136dfbee14d75c9646c947cdcb1c96"
S = "${WORKDIR}/git"
