...
# matches with: https://github.com/ros2-gbp/launch_ros-release/archive/release/kilted/ros2launch/0.28.3-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/ros2launch"
SRC_URI = "git://github.com/ros2-gbp/launch_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "a77ddce552a1cea458be43d96de8bedc7adfd595"
S = "${WORKDIR}/git"
