...
# matches with: https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/chained_filter_controller/5.12.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/chained_filter_controller"
SRC_URI = "git://github.com/ros2-gbp/ros2_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "709c28fb0722d01106e27acbb25451642256bdcd"
S = "${WORKDIR}/git"
