...
# matches with: https://github.com/ros2-gbp/event_camera_py-release/archive/release/kilted/event_camera_py/3.0.0-1.tar.gz
...
SRCREV = "d32ac9d96cd8ecaeb9970160be7dd07f54d4a870"
S = "${WORKDIR}/git"
