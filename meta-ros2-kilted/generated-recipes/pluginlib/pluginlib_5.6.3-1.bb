...
# matches with: https://github.com/ros2-gbp/pluginlib-release/archive/release/kilted/pluginlib/5.6.3-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/pluginlib"
SRC_URI = "git://github.com/ros2-gbp/pluginlib-release;${ROS_BRANCH};protocol=https"
SRCREV = "f33f8aefc95ca660babafad3bfd5a45ba03501f2"
S = "${WORKDIR}/git"
