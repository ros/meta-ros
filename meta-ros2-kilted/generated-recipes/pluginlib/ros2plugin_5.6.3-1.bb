...
# matches with: https://github.com/ros2-gbp/pluginlib-release/archive/release/kilted/ros2plugin/5.6.3-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/ros2plugin"
SRC_URI = "git://github.com/ros2-gbp/pluginlib-release;${ROS_BRANCH};protocol=https"
SRCREV = "f2a75d1f2b1fed844dd35ccd0ea5f0ae2f2f1f10"
S = "${WORKDIR}/git"
