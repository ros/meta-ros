...
# matches with: https://github.com/ros2-gbp/ros_babel_fish-release/archive/release/kilted/ros_babel_fish_test_msgs/3.26.31-1.tar.gz
...
SRCREV = "82f6bbae0d1bf863869cdbbe89b25c674df77db6"
S = "${WORKDIR}/git"
