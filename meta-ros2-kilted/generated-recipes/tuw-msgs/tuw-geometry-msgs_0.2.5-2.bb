...
# matches with: https://github.com/ros2-gbp/tuw_msgs-release/archive/release/kilted/tuw_geometry_msgs/0.2.5-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/tuw_geometry_msgs"
SRC_URI = "git://github.com/ros2-gbp/tuw_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "818588ce8afd1cd13553a933d6e5c654923ea71f"
S = "${WORKDIR}/git"
