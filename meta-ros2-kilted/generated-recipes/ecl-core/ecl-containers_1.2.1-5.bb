...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/kilted/ecl_containers/1.2.1-5.tar.gz
ROS_BRANCH ?= "branch=release/kilted/ecl_containers"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "7de301241280927f513024928cc74ad9853f39ed"
S = "${WORKDIR}/git"
