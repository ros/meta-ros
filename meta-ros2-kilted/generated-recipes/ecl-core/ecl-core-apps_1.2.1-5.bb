...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/kilted/ecl_core_apps/1.2.1-5.tar.gz
ROS_BRANCH ?= "branch=release/kilted/ecl_core_apps"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "d3fd9765132c678d14169a0ec880d9224712a403"
S = "${WORKDIR}/git"
