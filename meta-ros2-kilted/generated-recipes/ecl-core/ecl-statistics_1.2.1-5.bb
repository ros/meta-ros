...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/kilted/ecl_statistics/1.2.1-5.tar.gz
ROS_BRANCH ?= "branch=release/kilted/ecl_statistics"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "70231be65a5a9757b58c3bde01817011a8c6b07f"
S = "${WORKDIR}/git"
