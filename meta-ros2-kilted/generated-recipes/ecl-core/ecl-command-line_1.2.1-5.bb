...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/kilted/ecl_command_line/1.2.1-5.tar.gz
ROS_BRANCH ?= "branch=release/kilted/ecl_command_line"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "fbe0dea1af9f3ae45919d76d5b32150fdf6e7621"
S = "${WORKDIR}/git"
