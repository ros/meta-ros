...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/kilted/ecl_formatters/1.2.1-5.tar.gz
ROS_BRANCH ?= "branch=release/kilted/ecl_formatters"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "386142e4255183dec2fa55aa22c7ce32beba6353"
S = "${WORKDIR}/git"
