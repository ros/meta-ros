...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/kilted/ecl_manipulators/1.2.1-5.tar.gz
ROS_BRANCH ?= "branch=release/kilted/ecl_manipulators"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "5e2ae6fdab9b3458105fe362f3604185516e5f52"
S = "${WORKDIR}/git"
