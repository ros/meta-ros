...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/kilted/ecl_converters/1.2.1-5.tar.gz
ROS_BRANCH ?= "branch=release/kilted/ecl_converters"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "83217ca890dfd7e51f324000ce8fd238e6fb3bad"
S = "${WORKDIR}/git"
