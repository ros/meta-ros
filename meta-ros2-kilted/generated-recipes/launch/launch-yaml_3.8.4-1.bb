...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/kilted/launch_yaml/3.8.4-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/launch_yaml"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "aeff5afa40b5c11ceb9b42a8e5a40fcceb978af7"
S = "${WORKDIR}/git"
