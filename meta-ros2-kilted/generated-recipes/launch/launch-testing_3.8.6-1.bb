...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/kilted/launch_testing/3.8.6-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/launch_testing"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "5ed7784b32468878b5bdf81a5c0b6af438eea98a"
S = "${WORKDIR}/git"
