...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/kilted/launch_pytest/3.8.6-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/launch_pytest"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "8276b9509d2cdeeaf1b70300a2ce4c22dc8621ff"
S = "${WORKDIR}/git"
