...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/kilted/launch_pytest/3.8.4-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/launch_pytest"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "cfb2cd22dd2eceac4b9f71f988aabe9adbcb57a9"
S = "${WORKDIR}/git"
