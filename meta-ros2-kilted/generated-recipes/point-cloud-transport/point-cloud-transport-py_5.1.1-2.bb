...
# matches with: https://github.com/ros2-gbp/point_cloud_transport-release/archive/release/kilted/point_cloud_transport_py/5.1.1-2.tar.gz
...
SRCREV = "41f6ce1075fc6cf6f12436a8d0cddf9d8149342f"
S = "${WORKDIR}/git"
