...
# matches with: https://github.com/ros2-gbp/mavlink-gbp-release/archive/release/kilted/mavlink/2026.6.6-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mavlink"
SRC_URI = "git://github.com/ros2-gbp/mavlink-gbp-release;${ROS_BRANCH};protocol=https"
SRCREV = "5fc63f7e5a57e828da2dc93bccc9869fed9f0e2f"
S = "${WORKDIR}/git"
