...
# matches with: https://github.com/ros2-gbp/orocos_kdl_vendor-release/archive/release/kilted/python_orocos_kdl_vendor/0.7.0-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/python_orocos_kdl_vendor"
SRC_URI = "git://github.com/ros2-gbp/orocos_kdl_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "f0ae9fa0b54c3469b5cc9e8669a6fc2e28184d37"
S = "${WORKDIR}/git"
