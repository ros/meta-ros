...
# matches with: https://github.com/ros2-gbp/mapviz-release/archive/release/kilted/mapviz_plugins/2.6.5-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mapviz_plugins"
SRC_URI = "git://github.com/ros2-gbp/mapviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "96663ac071fcb94db54db479e44b8c5be9549f6c"
S = "${WORKDIR}/git"
