...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/kilted/bond_core/4.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/bond_core"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "20551377ab534a2a92800d92b9a3868bea6c1487"
S = "${WORKDIR}/git"
