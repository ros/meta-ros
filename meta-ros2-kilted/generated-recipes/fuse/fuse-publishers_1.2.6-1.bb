...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_publishers/1.2.6-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/fuse_publishers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "b9cf935f347a2a63698989059140479fe196f190"
S = "${WORKDIR}/git"
