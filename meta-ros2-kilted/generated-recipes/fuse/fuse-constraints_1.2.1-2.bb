...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_constraints/1.2.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/fuse_constraints"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "f4d03e4e9b8259fdab8b6c23714525e906646a93"
S = "${WORKDIR}/git"
