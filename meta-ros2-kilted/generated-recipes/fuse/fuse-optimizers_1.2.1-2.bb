...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_optimizers/1.2.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/fuse_optimizers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "4e461498d2c8e81153b747a9109376130af95b80"
S = "${WORKDIR}/git"
