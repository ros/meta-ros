...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_variables/1.2.6-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/fuse_variables"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "e495238fe9fd432ad4237fd24b099c4579c8903c"
S = "${WORKDIR}/git"
