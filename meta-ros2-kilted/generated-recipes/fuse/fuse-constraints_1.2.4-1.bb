...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_constraints/1.2.4-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/fuse_constraints"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "5827519f9e6933494113f916ffc77a981bfd8fb1"
S = "${WORKDIR}/git"
