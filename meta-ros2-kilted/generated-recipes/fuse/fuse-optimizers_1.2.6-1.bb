...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_optimizers/1.2.6-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/fuse_optimizers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "9cef79ee9c8bbaa5a29a268b92733cb14a0d1530"
S = "${WORKDIR}/git"
