...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_constraints/1.2.6-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/fuse_constraints"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "3bdd37e888ca87b01365039c7176a6f65b38d675"
S = "${WORKDIR}/git"
