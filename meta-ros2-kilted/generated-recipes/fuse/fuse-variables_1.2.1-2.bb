...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_variables/1.2.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/fuse_variables"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "c98597aa8feae40d975a88cba3836fd3bcfa682f"
S = "${WORKDIR}/git"
