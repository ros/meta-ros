...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_variables/1.2.4-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/fuse_variables"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "068388f34e0f17bbe1b1d60e3ff015393a189482"
S = "${WORKDIR}/git"
