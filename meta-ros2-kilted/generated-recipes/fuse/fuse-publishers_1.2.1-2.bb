...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_publishers/1.2.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/fuse_publishers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "93b95d4310309aded79fd6172a936e78b33e000b"
S = "${WORKDIR}/git"
