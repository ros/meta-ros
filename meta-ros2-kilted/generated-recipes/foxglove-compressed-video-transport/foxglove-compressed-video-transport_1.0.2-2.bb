...
# matches with: https://github.com/ros2-gbp/foxglove_compressed_video_transport-release/archive/release/kilted/foxglove_compressed_video_transport/1.0.2-2.tar.gz
...
SRCREV = "afbbf28528a76be0ecd68b7fc41abaaf4f3993c9"
S = "${WORKDIR}/git"
