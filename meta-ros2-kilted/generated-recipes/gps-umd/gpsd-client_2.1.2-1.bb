...
# matches with: https://github.com/ros2-gbp/gps_umd-release/archive/release/kilted/gpsd_client/2.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/gpsd_client"
SRC_URI = "git://github.com/ros2-gbp/gps_umd-release;${ROS_BRANCH};protocol=https"
SRCREV = "8403ffa69adc05f14f545efd49ae579e9724463f"
S = "${WORKDIR}/git"
