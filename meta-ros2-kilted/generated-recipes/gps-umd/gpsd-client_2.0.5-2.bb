...
# matches with: https://github.com/ros2-gbp/gps_umd-release/archive/release/kilted/gpsd_client/2.0.5-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/gpsd_client"
SRC_URI = "git://github.com/ros2-gbp/gps_umd-release;${ROS_BRANCH};protocol=https"
SRCREV = "87edf7f1c664455225c0f3d4445f03a3a89a9bd9"
S = "${WORKDIR}/git"
