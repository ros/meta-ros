...
# matches with: https://github.com/ros2-gbp/kobuki_velocity_smoother-release/archive/release/kilted/kobuki_velocity_smoother/0.15.1-1.tar.gz
...
SRCREV = "d4770243be3295da9a7e83656ed56a44bd651c9b"
S = "${WORKDIR}/git"
