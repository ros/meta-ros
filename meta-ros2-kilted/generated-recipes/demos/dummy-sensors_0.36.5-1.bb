...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/kilted/dummy_sensors/0.36.5-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/dummy_sensors"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "66662fc25ef960779a84912a9e043ab3124efbd1"
S = "${WORKDIR}/git"
