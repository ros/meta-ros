...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/kilted/dummy_map_server/0.36.5-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/dummy_map_server"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "1dcfc3ac808e72bbe64da1e48f7c64ffdb76c99b"
S = "${WORKDIR}/git"
