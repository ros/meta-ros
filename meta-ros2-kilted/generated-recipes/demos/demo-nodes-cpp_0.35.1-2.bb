...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/kilted/demo_nodes_cpp/0.35.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/demo_nodes_cpp"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "dde855543eeec3d6c770ee4a4c307f5ae6b8a4c7"
S = "${WORKDIR}/git"
