...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/kilted/dummy_map_server/0.35.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/dummy_map_server"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "d3ba4a4d46d2d1d3c506701411f5fdea284c5fcb"
S = "${WORKDIR}/git"
