...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/kilted/topic_monitor/0.36.2-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/topic_monitor"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "11d512656ef626bc3a4fc28aa884e5b847a53fd4"
S = "${WORKDIR}/git"
