...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/kilted/dummy_map_server/0.36.2-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/dummy_map_server"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "e5b0055a80cbd99fee1c025a6b5caba5f3b0cbe5"
S = "${WORKDIR}/git"
