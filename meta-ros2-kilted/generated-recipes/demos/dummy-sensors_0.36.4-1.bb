...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/kilted/dummy_sensors/0.36.4-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/dummy_sensors"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "1932f4585ac1fa0b2adfde63fe5ca263d6ea1044"
S = "${WORKDIR}/git"
