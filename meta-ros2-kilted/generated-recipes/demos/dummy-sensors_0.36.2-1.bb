...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/kilted/dummy_sensors/0.36.2-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/dummy_sensors"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "c8f9725aa249ffac6ab408eb5790305a675eefac"
S = "${WORKDIR}/git"
