...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/kilted/topic_monitor/0.35.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/topic_monitor"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "bf61f5080f0f11ab2ef0f4a91c1c274ed83ca7e3"
S = "${WORKDIR}/git"
