...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/kilted/dummy_sensors/0.35.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/dummy_sensors"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "6017bab063bc0c0dc99609336fbb7e67e827bd5f"
S = "${WORKDIR}/git"
