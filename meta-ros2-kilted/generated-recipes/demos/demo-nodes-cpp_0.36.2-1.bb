...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/kilted/demo_nodes_cpp/0.36.2-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/demo_nodes_cpp"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "f16a25fb60583b6480770a017977673e68e3e44c"
S = "${WORKDIR}/git"
