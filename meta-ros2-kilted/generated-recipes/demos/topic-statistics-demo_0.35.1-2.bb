...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/kilted/topic_statistics_demo/0.35.1-2.tar.gz
...
SRCREV = "62f0bde9e8b67859869737a53f061988be7d4bd4"
S = "${WORKDIR}/git"
