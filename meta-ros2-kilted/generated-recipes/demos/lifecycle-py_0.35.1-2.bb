...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/kilted/lifecycle_py/0.35.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/lifecycle_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "93932e7230ace1c9443335f12b9d44a1808dda21"
S = "${WORKDIR}/git"
