...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/kilted/self_test/4.4.3-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/self_test"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "55b8a76a0e234f8bb190176309ff1a418a94baee"
S = "${WORKDIR}/git"
