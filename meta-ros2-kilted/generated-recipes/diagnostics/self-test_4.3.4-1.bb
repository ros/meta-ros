...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/kilted/self_test/4.3.4-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/self_test"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "e98ee4aeb8797f4d940612f3dce3413956b0fb41"
S = "${WORKDIR}/git"
