...
# matches with: https://github.com/ros2-gbp/transport_drivers-release/archive/release/kilted/serial_driver/1.2.0-4.tar.gz
ROS_BRANCH ?= "branch=release/kilted/serial_driver"
SRC_URI = "git://github.com/ros2-gbp/transport_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "608424201a138d7dec68ea9631bb8c5e6d960fc9"
S = "${WORKDIR}/git"
