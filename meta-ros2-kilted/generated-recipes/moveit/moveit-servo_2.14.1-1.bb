...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/kilted/moveit_servo/2.14.1-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/moveit_servo"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "68cb88beba9a411f9a9ba16d4b6a374391937bdd"
S = "${WORKDIR}/git"
