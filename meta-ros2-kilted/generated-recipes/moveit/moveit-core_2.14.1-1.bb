...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/kilted/moveit_core/2.14.1-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/moveit_core"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "eb22b9e76415e40dc3cc5ac4392ed3a6846fe817"
S = "${WORKDIR}/git"
