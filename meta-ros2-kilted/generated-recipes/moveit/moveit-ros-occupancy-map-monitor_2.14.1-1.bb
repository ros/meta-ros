...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/kilted/moveit_ros_occupancy_map_monitor/2.14.1-1.tar.gz
...
SRCREV = "30503382970fa59e1cae53f5cd06ad3e5d3ad17f"
S = "${WORKDIR}/git"
