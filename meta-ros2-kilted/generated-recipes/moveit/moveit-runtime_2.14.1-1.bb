...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/kilted/moveit_runtime/2.14.1-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/moveit_runtime"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "969c1e593e7afbb86399a28bd36dd8f94693ed56"
S = "${WORKDIR}/git"
