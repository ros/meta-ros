...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/kilted/rmf_lift_msgs/3.4.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rmf_lift_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "e80bec455a2ad390b3c8c7fe86d16d45823eb876"
S = "${WORKDIR}/git"
