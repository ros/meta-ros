...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/kilted/rmf_obstacle_msgs/3.4.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rmf_obstacle_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "516235bb16d6da45d126e3bdd7a701bf7bad9abd"
S = "${WORKDIR}/git"
