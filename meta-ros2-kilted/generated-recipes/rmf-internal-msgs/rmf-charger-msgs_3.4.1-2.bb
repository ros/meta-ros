...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/kilted/rmf_charger_msgs/3.4.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rmf_charger_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "f57df9a8eaf520ec1af86e843d07a95b41c4f769"
S = "${WORKDIR}/git"
