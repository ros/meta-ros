...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/kilted/rmf_dispenser_msgs/3.4.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rmf_dispenser_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "81bac258641224972ab7ff831bd1ab085301bf71"
S = "${WORKDIR}/git"
