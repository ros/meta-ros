...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/kilted/mola_traj_tools/1.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "902832edc2fc845e20798acac1545206749e55aa"
S = "${WORKDIR}/git"
