...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/kilted/mola_launcher/2.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mola_launcher"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "1723021a4699cf5cca52db86e07245b21cefde37"
S = "${WORKDIR}/git"
