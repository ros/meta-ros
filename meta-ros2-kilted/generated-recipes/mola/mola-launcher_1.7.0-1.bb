...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/kilted/mola_launcher/1.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mola_launcher"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "f1db06234723426c4570681fa74ba68f0dbd1cda"
S = "${WORKDIR}/git"
