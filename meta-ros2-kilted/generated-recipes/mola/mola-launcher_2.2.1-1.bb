...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/kilted/mola_launcher/2.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mola_launcher"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "3eac0035fda10acc6ab85c50b302924966f33c40"
S = "${WORKDIR}/git"
