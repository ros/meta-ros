...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/kilted/mola_launcher/2.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mola_launcher"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "8a0c2f4407f0e3b7c9b2072186b442a4fcfbc43f"
S = "${WORKDIR}/git"
