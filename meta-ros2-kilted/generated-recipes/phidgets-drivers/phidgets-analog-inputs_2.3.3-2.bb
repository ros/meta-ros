...
# matches with: https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/kilted/phidgets_analog_inputs/2.3.3-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/phidgets_analog_inputs"
SRC_URI = "git://github.com/ros2-gbp/phidgets_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "c045e088f4aa6fafff050530410e1ac9ed6676b3"
S = "${WORKDIR}/git"
