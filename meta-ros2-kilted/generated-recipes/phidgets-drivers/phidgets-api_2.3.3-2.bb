...
# matches with: https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/kilted/phidgets_api/2.3.3-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/phidgets_api"
SRC_URI = "git://github.com/ros2-gbp/phidgets_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "16ff5e388c74d72129f09dcaac43348c7af1fd80"
S = "${WORKDIR}/git"
