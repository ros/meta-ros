...
# matches with: https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/kilted/phidgets_temperature/2.3.3-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/phidgets_temperature"
SRC_URI = "git://github.com/ros2-gbp/phidgets_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "32ea95c5d59c39a8e2aace7e50b82041bf79a3d0"
S = "${WORKDIR}/git"
