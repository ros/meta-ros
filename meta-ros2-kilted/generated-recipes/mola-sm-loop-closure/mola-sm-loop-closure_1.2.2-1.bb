...
# matches with: https://github.com/ros2-gbp/mola_sm_loop_closure-release/archive/release/kilted/mola_sm_loop_closure/1.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mola_sm_loop_closure"
SRC_URI = "git://github.com/ros2-gbp/mola_sm_loop_closure-release;${ROS_BRANCH};protocol=https"
SRCREV = "f5e9d94dc40eaab6fc0098904b312b131445c2b9"
S = "${WORKDIR}/git"
