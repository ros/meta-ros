...
# matches with: https://github.com/ros2-gbp/moveit_resources-release/archive/release/kilted/moveit_resources_fanuc_moveit_config/3.1.0-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/moveit_resources_fanuc_moveit_config"
SRC_URI = "git://github.com/ros2-gbp/moveit_resources-release;${ROS_BRANCH};protocol=https"
SRCREV = "756029c9f56c03919dc67a5ed5cba7491d081550"
S = "${WORKDIR}/git"
