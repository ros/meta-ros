...
# matches with: https://github.com/ros2-gbp/moveit_resources-release/archive/release/kilted/dual_arm_panda_moveit_config/3.1.0-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/dual_arm_panda_moveit_config"
SRC_URI = "git://github.com/ros2-gbp/moveit_resources-release;${ROS_BRANCH};protocol=https"
SRCREV = "0923f9da5305c106f3a3edd43e2b77564ca39977"
S = "${WORKDIR}/git"
