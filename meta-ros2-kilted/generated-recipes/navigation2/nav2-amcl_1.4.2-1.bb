...
# matches with: https://github.com/ros2-gbp/navigation2-release/archive/release/kilted/nav2_amcl/1.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/nav2_amcl"
SRC_URI = "git://github.com/ros2-gbp/navigation2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b3ef4259d3031003e8b48b58560875e6995c01f0"
S = "${WORKDIR}/git"
