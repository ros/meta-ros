...
# matches with: https://github.com/ros2-gbp/navigation2-release/archive/release/kilted/nav2_core/1.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/nav2_core"
SRC_URI = "git://github.com/ros2-gbp/navigation2-release;${ROS_BRANCH};protocol=https"
SRCREV = "334533cc50d6f34cee2475f2d1303e13ed26d8f1"
S = "${WORKDIR}/git"
