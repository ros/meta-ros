...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/kilted/qt_gui_core/2.9.3-1.tar.gz
...
SRCREV = "372699e2189eee01543b4a0e85ca2b8180d8d9e4"
S = "${WORKDIR}/git"
