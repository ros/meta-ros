...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/kilted/qt_gui/2.9.3-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "1d55007e2d806b75f948328445a421cbeb73a3cd"
S = "${WORKDIR}/git"
