...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/kilted/qt_gui/2.9.0-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "d634fbdb6a2b55759d4808dd0b6ae94a8782823f"
S = "${WORKDIR}/git"
