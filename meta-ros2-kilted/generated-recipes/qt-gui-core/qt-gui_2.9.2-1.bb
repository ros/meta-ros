...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/kilted/qt_gui/2.9.2-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "ca398dc69793eac89506242487eb1cbfe2ff1a2e"
S = "${WORKDIR}/git"
