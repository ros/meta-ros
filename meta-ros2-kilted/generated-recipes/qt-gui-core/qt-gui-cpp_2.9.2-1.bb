...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/kilted/qt_gui_cpp/2.9.2-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/qt_gui_cpp"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "4929b24ad8e48cd5223388156b4f076e8b29a612"
S = "${WORKDIR}/git"
