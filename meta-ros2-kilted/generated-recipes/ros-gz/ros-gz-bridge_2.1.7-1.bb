...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/kilted/ros_gz_bridge/2.1.7-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/ros_gz_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "025bc65486c7e38728887089308cc0b7fca324cf"
S = "${WORKDIR}/git"
