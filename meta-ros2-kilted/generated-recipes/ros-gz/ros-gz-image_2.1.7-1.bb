...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/kilted/ros_gz_image/2.1.7-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/ros_gz_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "77eca163dc34c29fa0ac34b0bf8808b7ae52d3a5"
S = "${WORKDIR}/git"
