...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/kilted/ros_gz_bridge/2.1.8-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/ros_gz_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "262625246f931759a25c07fdbb9e310c74c792c2"
S = "${WORKDIR}/git"
