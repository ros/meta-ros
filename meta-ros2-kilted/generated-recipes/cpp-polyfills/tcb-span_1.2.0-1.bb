...
# matches with: https://github.com/ros2-gbp/cpp_polyfills-release/archive/release/kilted/tcb_span/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/tcb_span"
SRC_URI = "git://github.com/ros2-gbp/cpp_polyfills-release;${ROS_BRANCH};protocol=https"
SRCREV = "bffd2a5ef8c79ead60876af5a18b5f149aa8c7b8"
S = "${WORKDIR}/git"
