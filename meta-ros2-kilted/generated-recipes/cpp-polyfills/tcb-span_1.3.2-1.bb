...
# matches with: https://github.com/ros2-gbp/cpp_polyfills-release/archive/release/kilted/tcb_span/1.3.2-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/tcb_span"
SRC_URI = "git://github.com/ros2-gbp/cpp_polyfills-release;${ROS_BRANCH};protocol=https"
SRCREV = "3b4f6c884b85afc07ff3f351cfa4dd48f095bd21"
S = "${WORKDIR}/git"
