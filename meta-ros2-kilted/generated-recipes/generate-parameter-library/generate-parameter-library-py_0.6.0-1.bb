...
# matches with: https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/kilted/generate_parameter_library_py/0.6.0-1.tar.gz
...
SRCREV = "f2f7a1a5c4881bb6db1fd36ad804f398590438f7"
S = "${WORKDIR}/git"
