...
# matches with: https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/kilted/generate_parameter_library_example/0.5.0-1.tar.gz
...
SRCREV = "8631f2ddb76ffbe6c8822be1308fb208971bd747"
S = "${WORKDIR}/git"
