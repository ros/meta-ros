...
# matches with: https://github.com/ros2-gbp/libcaer_vendor-release/archive/release/kilted/libcaer_vendor/1.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/libcaer_vendor"
SRC_URI = "git://github.com/ros2-gbp/libcaer_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "4392c839cdc2d6dd23feda8498d1d468ae920fb0"
S = "${WORKDIR}/git"
