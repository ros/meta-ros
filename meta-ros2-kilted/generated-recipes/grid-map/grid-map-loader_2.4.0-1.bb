...
# matches with: https://github.com/ros2-gbp/grid_map-release/archive/release/kilted/grid_map_loader/2.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/grid_map_loader"
SRC_URI = "git://github.com/ros2-gbp/grid_map-release;${ROS_BRANCH};protocol=https"
SRCREV = "715a491c446d16bcbdb4fc320086655809508f0b"
S = "${WORKDIR}/git"
