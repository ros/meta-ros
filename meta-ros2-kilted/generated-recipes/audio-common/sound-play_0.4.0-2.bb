...
# matches with: https://github.com/ros2-gbp/audio_common-release/archive/release/kilted/sound_play/0.4.0-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/sound_play"
SRC_URI = "git://github.com/ros2-gbp/audio_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "617134e6dbf11cca8cff9fe2690c1b8b25da7115"
S = "${WORKDIR}/git"
