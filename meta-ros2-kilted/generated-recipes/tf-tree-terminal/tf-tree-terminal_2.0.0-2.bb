...
# matches with: https://github.com/ros2-gbp/tf_tree_terminal-release/archive/release/kilted/tf_tree_terminal/2.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/tf_tree_terminal"
SRC_URI = "git://github.com/ros2-gbp/tf_tree_terminal-release;${ROS_BRANCH};protocol=https"
SRCREV = "2c1f15fd000f60b7ea13ab9f553f794d5d05a245"
S = "${WORKDIR}/git"
