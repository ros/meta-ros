...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/kilted/etsi_its_mapem_ts_msgs/3.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/etsi_its_mapem_ts_msgs"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "e4227efe8251fbdce7e38cde7543ad469d63df25"
S = "${WORKDIR}/git"
