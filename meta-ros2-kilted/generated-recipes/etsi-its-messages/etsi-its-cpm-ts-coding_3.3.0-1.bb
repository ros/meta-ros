...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/kilted/etsi_its_cpm_ts_coding/3.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/etsi_its_cpm_ts_coding"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "740abfa6562aba576e9b38fcf0ef203e399ac6e7"
S = "${WORKDIR}/git"
