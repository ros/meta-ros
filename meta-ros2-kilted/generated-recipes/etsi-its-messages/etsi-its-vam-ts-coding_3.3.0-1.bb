...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/kilted/etsi_its_vam_ts_coding/3.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/etsi_its_vam_ts_coding"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "29a5b410b7d517136b5a8ccf4e4e684722f7c6cf"
S = "${WORKDIR}/git"
