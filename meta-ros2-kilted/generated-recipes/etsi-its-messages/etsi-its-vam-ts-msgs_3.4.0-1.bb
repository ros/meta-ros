...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/kilted/etsi_its_vam_ts_msgs/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/etsi_its_vam_ts_msgs"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "c0f64a1fdb8bd0e53c52cab9487faf938fda3c24"
S = "${WORKDIR}/git"
