...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/kilted/etsi_its_vam_ts_conversion/3.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/etsi_its_vam_ts_conversion"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "684db3e9701f95a4f9ee96333c58caf0031cf20a"
S = "${WORKDIR}/git"
