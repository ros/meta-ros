...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/kilted/etsi_its_cam_msgs/3.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/etsi_its_cam_msgs"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "a2fd2796801edf4d022c19d6272a869bcec0c8ab"
S = "${WORKDIR}/git"
