...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/kilted/etsi_its_cam_ts_conversion/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/etsi_its_cam_ts_conversion"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "4db628a03266bd1bea0c247249a09cd0b3046108"
S = "${WORKDIR}/git"
