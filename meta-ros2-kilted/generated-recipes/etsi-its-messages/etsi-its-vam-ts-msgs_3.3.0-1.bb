...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/kilted/etsi_its_vam_ts_msgs/3.3.0-1.tar.gz
...
SRCREV = "8a09845dc8db18591e3d9ccc11b0e2a9dd0b800f"
S = "${WORKDIR}/git"
