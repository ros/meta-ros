...
# matches with: https://github.com/ros2-gbp/Universal_Robots_Client_Library-release/archive/release/kilted/ur_client_library/2.6.0-1.tar.gz
...
SRCREV = "ffddad04f5828302537b32a4db49323533eee8b8"
S = "${WORKDIR}/git"
