...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_apps/2.15.8-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_apps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "491c84e2a88ca1d0948a2d23b98b6075219fb283"
S = "${WORKDIR}/git"
