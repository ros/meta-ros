...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libmaps/2.14.15-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libmaps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "fc0eb26f9b14638a100e0a7360fc8ca9392c9a94"
S = "${WORKDIR}/git"
