...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libposes/2.14.9-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libposes"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "b1d2c0672baf1f17d6c3b8e217098d61d9cc1438"
S = "${WORKDIR}/git"
