...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libbase/2.14.7-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libbase"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "c077db2dcebcdf74364248a37f6ee64ea29124ee"
S = "${WORKDIR}/git"
