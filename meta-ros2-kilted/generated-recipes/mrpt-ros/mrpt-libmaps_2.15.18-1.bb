...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libmaps/2.15.18-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libmaps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "995c2d2b2d7e0f8a34acdb4b4278a4b1d587bbb6"
S = "${WORKDIR}/git"
