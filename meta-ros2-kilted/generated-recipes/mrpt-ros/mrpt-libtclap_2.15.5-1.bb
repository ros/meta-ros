...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libtclap/2.15.5-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libtclap"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "b2889cd44fb3a7f35e7d5c77838f04ae308dcec1"
S = "${WORKDIR}/git"
