...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libobs/2.14.15-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libobs"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "35ee419059a92210b8cf06ccc276da32d89a161c"
S = "${WORKDIR}/git"
