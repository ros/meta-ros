...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libobs/2.14.12-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libobs"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "ddae182b865577f52579cfdc4b28df55073bd2ec"
S = "${WORKDIR}/git"
