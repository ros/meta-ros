...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libposes/2.15.5-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libposes"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "a4e2fd40b5506fa96998cb329adcdbc832a14dcc"
S = "${WORKDIR}/git"
