...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libslam/2.14.9-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libslam"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "37c5220c3009fe8cb5982092a4dc17861d9c0980"
S = "${WORKDIR}/git"
