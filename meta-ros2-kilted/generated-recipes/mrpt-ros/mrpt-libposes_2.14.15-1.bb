...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libposes/2.14.15-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libposes"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "5d5697106f71c0549af1d36de9a155deddaeb8dc"
S = "${WORKDIR}/git"
