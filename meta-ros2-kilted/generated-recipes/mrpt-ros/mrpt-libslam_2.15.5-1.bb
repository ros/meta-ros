...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libslam/2.15.5-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libslam"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "e45c7a2785a8e0e443cec756e61f22cfb4ba2953"
S = "${WORKDIR}/git"
