...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libbase/2.14.15-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libbase"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "d6716b39bea4daf3ea3535aa6252bd067c665a17"
S = "${WORKDIR}/git"
