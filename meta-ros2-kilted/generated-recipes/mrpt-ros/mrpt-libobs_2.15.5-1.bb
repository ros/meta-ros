...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libobs/2.15.5-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libobs"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "113306fa722f0a2d6a8fac84efd30640279bdd68"
S = "${WORKDIR}/git"
