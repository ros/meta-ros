...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libposes/2.15.18-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libposes"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "18a8b6becb4dbadc15d858759a8640ffb7cfdf99"
S = "${WORKDIR}/git"
