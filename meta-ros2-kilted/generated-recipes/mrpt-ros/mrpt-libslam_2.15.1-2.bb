...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libslam/2.15.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mrpt_libslam"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "ff35c51aa162e05943deea8b59c7239f4e23f18f"
S = "${WORKDIR}/git"
