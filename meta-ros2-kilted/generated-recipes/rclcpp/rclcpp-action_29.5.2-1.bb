...
# matches with: https://github.com/ros2-gbp/rclcpp-release/archive/release/kilted/rclcpp_action/29.5.2-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rclcpp_action"
SRC_URI = "git://github.com/ros2-gbp/rclcpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "9f5ffe6a6e2b98f47e0306961b999192db20390f"
S = "${WORKDIR}/git"
