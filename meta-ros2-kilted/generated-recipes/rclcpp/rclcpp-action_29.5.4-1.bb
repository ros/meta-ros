...
# matches with: https://github.com/ros2-gbp/rclcpp-release/archive/release/kilted/rclcpp_action/29.5.4-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rclcpp_action"
SRC_URI = "git://github.com/ros2-gbp/rclcpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "0466825b8bbf74f46add672a61b93eac39ad61d4"
S = "${WORKDIR}/git"
