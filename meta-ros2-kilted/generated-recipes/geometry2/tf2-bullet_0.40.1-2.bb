...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/kilted/tf2_bullet/0.40.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/tf2_bullet"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "73a373c2fdab93635a7d18ca5c5e1d947f8cd539"
S = "${WORKDIR}/git"
