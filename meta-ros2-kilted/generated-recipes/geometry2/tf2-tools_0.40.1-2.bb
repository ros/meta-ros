...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/kilted/tf2_tools/0.40.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "87a9060a2cfcae67a212ffe24fe2e662ec2bf546"
S = "${WORKDIR}/git"
