...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/kilted/tf2_tools/0.41.6-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5a92fd91964bf3d2fdbb6b8b5f33b655414eec80"
S = "${WORKDIR}/git"
