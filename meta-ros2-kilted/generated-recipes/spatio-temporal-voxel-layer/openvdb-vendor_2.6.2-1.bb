...
# matches with: https://github.com/SteveMacenski/spatio_temporal_voxel_layer-release/archive/release/kilted/openvdb_vendor/2.6.2-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/openvdb_vendor"
SRC_URI = "git://github.com/SteveMacenski/spatio_temporal_voxel_layer-release;${ROS_BRANCH};protocol=https"
SRCREV = "282fdc816d913eed3b07b418d41a27693d481efe"
S = "${WORKDIR}/git"
