...
# matches with: https://github.com/ros2-gbp/mp2p_icp-release/archive/release/kilted/mp2p_icp/2.10.3-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mp2p_icp"
SRC_URI = "git://github.com/ros2-gbp/mp2p_icp-release;${ROS_BRANCH};protocol=https"
SRCREV = "171703737dceea7697640c54343686a4aa496767"
S = "${WORKDIR}/git"
