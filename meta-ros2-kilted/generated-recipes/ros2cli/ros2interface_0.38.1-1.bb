...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2interface/0.38.1-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/ros2interface"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "ba3d9b30b62722217d8878116ecc1ee6cf9332be"
S = "${WORKDIR}/git"
