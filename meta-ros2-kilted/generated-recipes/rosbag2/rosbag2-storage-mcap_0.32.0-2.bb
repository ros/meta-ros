...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/kilted/rosbag2_storage_mcap/0.32.0-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rosbag2_storage_mcap"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d8680678ef20723c75f8fdede597d505080936a1"
S = "${WORKDIR}/git"
