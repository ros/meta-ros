...
# matches with: https://github.com/ros2-gbp/astuff_sensor_msgs-release/archive/release/kilted/delphi_esr_msgs/4.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/kilted/delphi_esr_msgs"
SRC_URI = "git://github.com/ros2-gbp/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "f33f68b81f5ab022e3b8f5de11c019a9eb306029"
S = "${WORKDIR}/git"
