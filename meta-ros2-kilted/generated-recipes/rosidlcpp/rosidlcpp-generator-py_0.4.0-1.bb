...
# matches with: https://github.com/ros2-gbp/rosidlcpp-release/archive/release/kilted/rosidlcpp_generator_py/0.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rosidlcpp_generator_py"
SRC_URI = "git://github.com/ros2-gbp/rosidlcpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "b15f07b428b428cb0b8b43699250876efb09d083"
S = "${WORKDIR}/git"
