...
# matches with: https://github.com/ros2-gbp/rosidlcpp-release/archive/release/kilted/rosidlcpp_parser/0.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rosidlcpp_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidlcpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "8f0c20fdb20f030ad027affbbcabc48aa567cf76"
S = "${WORKDIR}/git"
