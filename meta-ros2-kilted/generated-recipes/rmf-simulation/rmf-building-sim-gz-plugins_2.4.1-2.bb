...
# matches with: https://github.com/ros2-gbp/rmf_simulation-release/archive/release/kilted/rmf_building_sim_gz_plugins/2.4.1-2.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rmf_building_sim_gz_plugins"
SRC_URI = "git://github.com/ros2-gbp/rmf_simulation-release;${ROS_BRANCH};protocol=https"
SRCREV = "441c76f0fd4d639456ab5850911277ae5cb60e94"
S = "${WORKDIR}/git"
