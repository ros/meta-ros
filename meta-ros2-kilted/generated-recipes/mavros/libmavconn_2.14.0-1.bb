...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/kilted/libmavconn/2.14.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/libmavconn"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "f314dee526d101f53d640565ebd3d583dd4a3fce"
S = "${WORKDIR}/git"
