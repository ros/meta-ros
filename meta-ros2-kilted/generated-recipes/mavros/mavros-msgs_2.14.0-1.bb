...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/kilted/mavros_msgs/2.14.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mavros_msgs"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "4c72e8fbbcb128421fd992c8885f436ca72ee8ca"
S = "${WORKDIR}/git"
