...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/kilted/mavros_msgs/2.10.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mavros_msgs"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "28dd0b6d5f5af2bfc1e6257c8c5ff1a948a2a68b"
S = "${WORKDIR}/git"
