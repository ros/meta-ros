...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/kilted/mavros_extras/2.10.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mavros_extras"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "4a7b77077bd211b7727f55f758269be2fc22cad2"
S = "${WORKDIR}/git"
