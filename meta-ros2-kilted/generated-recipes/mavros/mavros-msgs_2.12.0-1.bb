...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/kilted/mavros_msgs/2.12.0-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/mavros_msgs"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "decdfcacad611920f2f7185dbddf63c60b1a3c07"
S = "${WORKDIR}/git"
