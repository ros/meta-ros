...
# matches with: https://github.com/ros2-gbp/ros_battery_monitoring-release/archive/release/kilted/battery_state_rviz_overlay/1.0.1-2.tar.gz
...
SRCREV = "203a0ef00a2db6c27b3a94806979eaae34e7659f"
S = "${WORKDIR}/git"
