...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/kilted/rosidl_parser/4.9.5-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "60f1470b2d26b8158c22e5a849d0db125db41f46"
S = "${WORKDIR}/git"
