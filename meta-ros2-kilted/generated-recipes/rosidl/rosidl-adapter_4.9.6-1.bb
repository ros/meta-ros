...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/kilted/rosidl_adapter/4.9.6-1.tar.gz
ROS_BRANCH ?= "branch=release/kilted/rosidl_adapter"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "eb2db9b97c18dd50700b40b16be026937cffb136"
S = "${WORKDIR}/git"
