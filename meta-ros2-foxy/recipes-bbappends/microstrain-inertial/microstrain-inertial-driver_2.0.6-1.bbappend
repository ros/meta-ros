...
#   /usr/opt/ros/foxy/lib/libboost_timer.so.1.68.0
#   /usr/opt/ros/foxy/lib/libboost_chrono.so.1.68.0
#   /usr/opt/ros/foxy/lib/libboost_unit_test_framework.so.1.68.0
#   /usr/opt/ros/foxy/lib/libboost_system.so.1.68.0
#   /usr/opt/ros/foxy/lib/libboost_prg_exec_monitor.so.1.68.0
#   /usr/opt/ros/foxy/lib/libboost_filesystem.so.1.68.0
...
# non -dev/-dbg/nativesdk- package microstrain-inertial-driver contains symlink .so '/usr/opt/ros/foxy/lib/libboost_chrono.so'
# non -dev/-dbg/nativesdk- package microstrain-inertial-driver contains symlink .so '/usr/opt/ros/foxy/lib/libboost_timer.so'
# non -dev/-dbg/nativesdk- package microstrain-inertial-driver contains symlink .so '/usr/opt/ros/foxy/lib/libboost_filesystem.so'
# non -dev/-dbg/nativesdk- package microstrain-inertial-driver contains symlink .so '/usr/opt/ros/foxy/lib/libboost_prg_exec_monitor.so'
# non -dev/-dbg/nativesdk- package microstrain-inertial-driver contains symlink .so '/usr/opt/ros/foxy/lib/libboost_unit_test_framework.so'
# non -dev/-dbg/nativesdk- package microstrain-inertial-driver contains symlink .so '/usr/opt/ros/foxy/lib/libboost_system.so' [dev-so]
INSANE_SKIP:${PN} += "dev-so"

# ERROR: microstrain-inertial-driver-2.0.4-1-r0 do_package_qa: QA Issue:
# microstrain-inertial-driver-prebuilt-boost: found library in wrong location: /usr/opt/ros/foxy/lib/libboost_timer.so.1.68.0
# microstrain-inertial-driver-prebuilt-boost: found library in wrong location: /usr/opt/ros/foxy/lib/libboost_chrono.so.1.68.0
# microstrain-inertial-driver-prebuilt-boost: found library in wrong location: /usr/opt/ros/foxy/lib/libboost_unit_test_framework.so.1.68.0
# microstrain-inertial-driver-prebuilt-boost: found library in wrong location: /usr/opt/ros/foxy/lib/libboost_system.so.1.68.0
# microstrain-inertial-driver-prebuilt-boost: found library in wrong location: /usr/opt/ros/foxy/lib/libboost_prg_exec_monitor.so.1.68.0
# microstrain-inertial-driver-prebuilt-boost: found library in wrong location: /usr/opt/ros/foxy/lib/libboost_filesystem.so.1.68.0 [libdir]
