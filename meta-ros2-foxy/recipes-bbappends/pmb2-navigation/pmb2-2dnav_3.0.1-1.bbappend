...
# pmb2-2dnav-3.0.1-1-r0 do_package_qa: QA Issue: /usr/lib/pmb2_2dnav/record_rgbd.sh contained in package pmb2-2dnav requires /bin/bash, but no providers found in RDEPENDS_pmb2-2dnav? [file-rdeps]
RDEPENDS:${PN} += "bash"
