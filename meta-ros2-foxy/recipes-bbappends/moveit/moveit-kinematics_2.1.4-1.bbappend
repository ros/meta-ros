...
# ERROR: moveit-kinematics-2.1.0-1-r0 do_package_qa: QA Issue: /usr/lib/moveit_kinematics/auto_create_ikfast_moveit_plugin.sh contained in package moveit-kinematics requires /bin/bash, but no providers found in RDEPENDS_moveit-kinematics? [file-rdeps]
RDEPENDS_${PN} += "bash"
