...
# matches with: https://github.com/ros2-gbp/micro_ros_msgs-release/archive/release/foxy/micro_ros_msgs/1.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/micro_ros_msgs"
SRC_URI = "git://github.com/ros2-gbp/micro_ros_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "79e593815b432a3ecc898c607abf061a51d2b70e"
S = "${WORKDIR}/git"
