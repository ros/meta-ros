...
# matches with: https://github.com/cyberbotics/webots_ros2-release/archive/release/foxy/webots_ros2_core/1.0.0-1.tar.gz
...
SRCREV = "c2d53072426828400a272dc023978b62f4d0a1cb"
S = "${WORKDIR}/git"
