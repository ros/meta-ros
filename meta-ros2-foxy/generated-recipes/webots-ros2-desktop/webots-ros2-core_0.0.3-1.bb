...
ROS_EXEC_DEPENDS = " \
    ${ROS_UNRESOLVED_PLATFORM_PKG_python-transforms3d-pip} \
    builtin-interfaces \
    rclpy \
    std-msgs \
    webots-ros2-msgs \
...
# matches with: https://github.com/cyberbotics/webots_ros2-release/archive/release/foxy/webots_ros2_core/0.0.3-1.tar.gz
...
SRCREV = "4cef32947822073ec35f4eb080ebc41a5308fc05"
S = "${WORKDIR}/git"
