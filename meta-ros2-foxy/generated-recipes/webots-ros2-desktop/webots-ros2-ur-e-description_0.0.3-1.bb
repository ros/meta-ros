...
# matches with: https://github.com/cyberbotics/webots_ros2-release/archive/release/foxy/webots_ros2_ur_e_description/0.0.3-1.tar.gz
...
SRCREV = "f16526ebc4d8e4d69803a3540459b8d3d35e0b92"
S = "${WORKDIR}/git"
