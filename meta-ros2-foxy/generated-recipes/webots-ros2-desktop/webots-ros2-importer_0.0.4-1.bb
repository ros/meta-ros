...
# matches with: https://github.com/cyberbotics/webots_ros2-release/archive/release/foxy/webots_ros2_importer/0.0.4-1.tar.gz
...
SRCREV = "0181b7a25a89bd7a353e5a4830789b7edd732c73"
S = "${WORKDIR}/git"
