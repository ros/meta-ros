...
# matches with: https://github.com/ros2-gbp/perception_pcl-release/archive/release/foxy/pcl_ros/2.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/pcl_ros"
SRC_URI = "git://github.com/ros2-gbp/perception_pcl-release;${ROS_BRANCH};protocol=https"
SRCREV = "165b5a91f60790f0d422692c4f2150a6572f3f15"
S = "${WORKDIR}/git"
