...
# matches with: https://github.com/cyberbotics/webots_ros2-release/archive/release/foxy/webots_ros2_ur_e_description/1.0.1-1.tar.gz
...
SRCREV = "e33bd0a5f7336282b9bfbd9a26439641be0750e6"
S = "${WORKDIR}/git"
