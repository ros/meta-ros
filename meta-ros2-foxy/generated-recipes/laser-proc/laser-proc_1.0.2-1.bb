...
# matches with: https://github.com/ros2-gbp/laser_proc-release/archive/release/foxy/laser_proc/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/laser_proc"
SRC_URI = "git://github.com/ros2-gbp/laser_proc-release;${ROS_BRANCH};protocol=https"
SRCREV = "33058015c569a6e0d1b87b807099b2c6438fd915"
S = "${WORKDIR}/git"
