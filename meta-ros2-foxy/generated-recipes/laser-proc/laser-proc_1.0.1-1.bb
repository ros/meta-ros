...
# matches with: https://github.com/ros2-gbp/laser_proc-release/archive/release/foxy/laser_proc/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/laser_proc"
SRC_URI = "git://github.com/ros2-gbp/laser_proc-release;${ROS_BRANCH};protocol=https"
SRCREV = "cac4eedc602f8390f59ee26bf350523798a23208"
S = "${WORKDIR}/git"
