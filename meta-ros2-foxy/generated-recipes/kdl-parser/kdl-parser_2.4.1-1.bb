...
# matches with: https://github.com/ros2-gbp/kdl_parser-release/archive/release/foxy/kdl_parser/2.4.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/kdl_parser"
SRC_URI = "git://github.com/ros2-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "fb62ca24defe583e4b5e2ec62e11f1bd5febb3dd"
S = "${WORKDIR}/git"
