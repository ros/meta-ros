...
# matches with: https://github.com/ros2-gbp/kdl_parser-release/archive/release/foxy/kdl_parser/2.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/kdl_parser"
SRC_URI = "git://github.com/ros2-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "96a944436f168712941f8b9cc3481f646106ba19"
S = "${WORKDIR}/git"
