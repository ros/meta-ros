...
# matches with: https://github.com/ros2-gbp/kdl_parser-release/archive/release/foxy/kdl_parser/2.4.1-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/kdl_parser"
SRC_URI = "git://github.com/ros2-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "bf837542700bdacf9f98551705cbe84b990cffad"
S = "${WORKDIR}/git"
