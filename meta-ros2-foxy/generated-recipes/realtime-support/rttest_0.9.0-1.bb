...
# matches with: https://github.com/ros2-gbp/realtime_support-release/archive/release/foxy/rttest/0.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rttest"
SRC_URI = "git://github.com/ros2-gbp/realtime_support-release;${ROS_BRANCH};protocol=https"
SRCREV = "f1f58ba2cd26c538dc9f1111d61e5fd157c76deb"
S = "${WORKDIR}/git"
