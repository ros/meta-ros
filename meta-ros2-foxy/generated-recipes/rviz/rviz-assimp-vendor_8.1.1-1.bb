...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/foxy/rviz_assimp_vendor/8.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rviz_assimp_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "127b14f213d4519d62972a4c9827e14cf2ef0a13"
S = "${WORKDIR}/git"
