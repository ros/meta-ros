...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/foxy/rviz_ogre_vendor/8.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "217c0d806f4e5e106ee4567d0f5809306c5b6ef7"
S = "${WORKDIR}/git"
