...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/foxy/rviz_assimp_vendor/8.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rviz_assimp_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "b6cae3abbcc0c387a7c127514b5f23a98246cc60"
S = "${WORKDIR}/git"
