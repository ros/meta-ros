...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/foxy/rviz_assimp_vendor/8.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rviz_assimp_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "66caf003b0e8c5a3fa187d8733ed4a373a8ce735"
S = "${WORKDIR}/git"
