...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/foxy/rviz_ogre_vendor/8.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "edb5ddd9a7340abfc710f67f245db8baff8882bc"
S = "${WORKDIR}/git"
