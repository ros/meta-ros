...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/foxy/rviz_ogre_vendor/8.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "5ac4750b13bbca37a627c7e8d2c751a5d9c0229f"
S = "${WORKDIR}/git"
