...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/foxy/rviz_ogre_vendor/8.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "e607d56a90200945021f93f6b34501a115f0b942"
S = "${WORKDIR}/git"
