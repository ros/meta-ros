...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/foxy/ros_ign_image/0.221.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ros_ign_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "28608e0546f4369282b62bddb4ef6eb9129ac1db"
S = "${WORKDIR}/git"
