...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/foxy/ros_ign_interfaces/0.221.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ros_ign_interfaces"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "f4672614caafe6f998a98b0b4151a5228f2aaa82"
S = "${WORKDIR}/git"
