...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/foxy/ros_ign_bridge/0.221.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ros_ign_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "fa074613a1afbfff2bc4ede41cd3b055dc96245e"
S = "${WORKDIR}/git"
