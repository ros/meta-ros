...
# matches with: https://github.com/ros-drivers-gbp/transport_drivers-release/archive/release/foxy/io_context/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/io_context"
SRC_URI = "git://github.com/ros-drivers-gbp/transport_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "aee6d6aa65f973ab054a54b5efc6f0e41154e638"
S = "${WORKDIR}/git"
