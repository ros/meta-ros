...
# matches with: https://github.com/ros-drivers-gbp/transport_drivers-release/archive/release/foxy/asio_cmake_module/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/asio_cmake_module"
SRC_URI = "git://github.com/ros-drivers-gbp/transport_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "917b07d09b39cc802cbf697091a2e3a52d58c67b"
S = "${WORKDIR}/git"
