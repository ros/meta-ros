...
# matches with: https://github.com/stonier/py_trees_ros-release/archive/release/foxy/py_trees_ros/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/py_trees_ros"
SRC_URI = "git://github.com/stonier/py_trees_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "16d98a35b682725a4bd35a4249ef14b28e3466da"
S = "${WORKDIR}/git"
