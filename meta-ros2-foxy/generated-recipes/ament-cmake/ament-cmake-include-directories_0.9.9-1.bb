...
# matches with: https://github.com/ros2-gbp/ament_cmake-release/archive/release/foxy/ament_cmake_include_directories/0.9.9-1.tar.gz
...
SRCREV = "df6d2a6e5ed1e51364f6b13852f9d5ed435b11a0"
S = "${WORKDIR}/git"
