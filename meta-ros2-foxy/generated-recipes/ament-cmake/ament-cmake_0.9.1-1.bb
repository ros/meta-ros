...
# matches with: https://github.com/ros2-gbp/ament_cmake-release/archive/release/foxy/ament_cmake/0.9.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ament_cmake"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake-release;${ROS_BRANCH};protocol=https"
SRCREV = "079df6727881e31cbafe3d5c5ce9e6cbb62dde40"
S = "${WORKDIR}/git"
