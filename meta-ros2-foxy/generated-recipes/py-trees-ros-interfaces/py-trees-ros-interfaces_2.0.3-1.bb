...
# matches with: https://github.com/stonier/py_trees_ros_interfaces-release/archive/release/foxy/py_trees_ros_interfaces/2.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/py_trees_ros_interfaces"
SRC_URI = "git://github.com/stonier/py_trees_ros_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "8cd1f405761e82550780245411a5de6b927d51ba"
S = "${WORKDIR}/git"
