...
# matches with: https://github.com/ros2-gbp/teleop_twist_joy-release/archive/release/foxy/teleop_twist_joy/2.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/teleop_twist_joy"
SRC_URI = "git://github.com/ros2-gbp/teleop_twist_joy-release;${ROS_BRANCH};protocol=https"
SRCREV = "bc2c6156f0acd1492f6777b4471558d3effab91b"
S = "${WORKDIR}/git"
