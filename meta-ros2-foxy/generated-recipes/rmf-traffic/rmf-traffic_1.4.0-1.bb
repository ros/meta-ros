...
# matches with: https://github.com/ros2-gbp/rmf_traffic-release/archive/release/foxy/rmf_traffic/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rmf_traffic"
SRC_URI = "git://github.com/ros2-gbp/rmf_traffic-release;${ROS_BRANCH};protocol=https"
SRCREV = "74b59ff221ea97c7008844262eea1d1e9343d605"
S = "${WORKDIR}/git"
