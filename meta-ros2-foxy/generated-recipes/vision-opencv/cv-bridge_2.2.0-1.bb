...
# matches with: https://github.com/ros2-gbp/vision_opencv-release/archive/release/foxy/cv_bridge/2.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/cv_bridge"
SRC_URI = "git://github.com/ros2-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "25183b7af23c2699f8c41900f7640566e2cdc153"
S = "${WORKDIR}/git"
