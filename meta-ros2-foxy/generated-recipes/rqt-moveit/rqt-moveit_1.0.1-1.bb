...
# matches with: https://github.com/ros2-gbp/rqt_moveit-release/archive/release/foxy/rqt_moveit/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rqt_moveit"
SRC_URI = "git://github.com/ros2-gbp/rqt_moveit-release;${ROS_BRANCH};protocol=https"
SRCREV = "5629309ef5cf535ab7738bfea47d661284f20ee6"
S = "${WORKDIR}/git"
