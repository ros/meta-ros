...
# matches with: https://github.com/ros2-gbp/rclcpp-release/archive/release/foxy/rclcpp_lifecycle/2.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rclcpp_lifecycle"
SRC_URI = "git://github.com/ros2-gbp/rclcpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "1933e65ce81943fb7f5e46bfb4c9d5f0afb923e4"
S = "${WORKDIR}/git"
