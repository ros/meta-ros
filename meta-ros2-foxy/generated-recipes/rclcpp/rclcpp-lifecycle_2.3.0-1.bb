...
# matches with: https://github.com/ros2-gbp/rclcpp-release/archive/release/foxy/rclcpp_lifecycle/2.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rclcpp_lifecycle"
SRC_URI = "git://github.com/ros2-gbp/rclcpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "2aa394132809cdf7af100af00cd4aa0cfeff259e"
S = "${WORKDIR}/git"
