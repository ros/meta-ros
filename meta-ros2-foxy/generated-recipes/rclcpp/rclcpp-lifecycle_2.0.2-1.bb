...
# matches with: https://github.com/ros2-gbp/rclcpp-release/archive/release/foxy/rclcpp_lifecycle/2.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rclcpp_lifecycle"
SRC_URI = "git://github.com/ros2-gbp/rclcpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "96ced25300a39dea844806ba72e60b64e9acaaad"
S = "${WORKDIR}/git"
