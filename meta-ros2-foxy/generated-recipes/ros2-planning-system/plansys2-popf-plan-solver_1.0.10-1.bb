...
# matches with: https://github.com/IntelligentRoboticsLabs/ros2_planning_system-release/archive/release/foxy/plansys2_popf_plan_solver/1.0.10-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/plansys2_popf_plan_solver"
SRC_URI = "git://github.com/IntelligentRoboticsLabs/ros2_planning_system-release;${ROS_BRANCH};protocol=https"
SRCREV = "de5d359b4973644e11b4b262405e0b9ffad2cf12"
S = "${WORKDIR}/git"
