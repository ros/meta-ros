...
# matches with: https://github.com/IntelligentRoboticsLabs/ros2_planning_system-release/archive/release/foxy/plansys2_core/1.0.10-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/plansys2_core"
SRC_URI = "git://github.com/IntelligentRoboticsLabs/ros2_planning_system-release;${ROS_BRANCH};protocol=https"
SRCREV = "80bca1194af87b1a2bd76ddccfaa431d2a78223c"
S = "${WORKDIR}/git"
