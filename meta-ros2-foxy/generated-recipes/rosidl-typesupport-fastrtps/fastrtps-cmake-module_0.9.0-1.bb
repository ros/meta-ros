...
# matches with: https://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release/archive/release/foxy/fastrtps_cmake_module/0.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/fastrtps_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release;${ROS_BRANCH};protocol=https"
SRCREV = "4240d2886c24fbdb5b781b116674031eb2f9ccc3"
S = "${WORKDIR}/git"
