...
# matches with: https://github.com/yujinrobot-release/ecl_core-release/archive/release/foxy/ecl_time/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ecl_time"
SRC_URI = "git://github.com/yujinrobot-release/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "4aa492a1d0f725cb59a7f5ce70e450a62067cd51"
S = "${WORKDIR}/git"
