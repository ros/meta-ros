...
# matches with: https://github.com/yujinrobot-release/ecl_core-release/archive/release/foxy/ecl_mobile_robot/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ecl_mobile_robot"
SRC_URI = "git://github.com/yujinrobot-release/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "417581dadb06c64c80bdf53cf1d83254ab6dfe4d"
S = "${WORKDIR}/git"
