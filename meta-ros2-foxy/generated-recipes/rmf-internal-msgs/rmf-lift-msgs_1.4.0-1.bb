...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/foxy/rmf_lift_msgs/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rmf_lift_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "610ac1bcda7344cf2139b5445cd12ad766efc7bf"
S = "${WORKDIR}/git"
