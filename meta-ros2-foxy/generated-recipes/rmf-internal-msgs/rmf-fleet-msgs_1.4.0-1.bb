...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/foxy/rmf_fleet_msgs/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rmf_fleet_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "8c5cf9e40c42212705f9180923df683a4b5aa011"
S = "${WORKDIR}/git"
