...
# matches with: https://github.com/stonier/kobuki_core-release/archive/release/foxy/kobuki_core/1.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/kobuki_core"
SRC_URI = "git://github.com/stonier/kobuki_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "f397193e3663f777c8a1e717346124ef45b8a806"
S = "${WORKDIR}/git"
