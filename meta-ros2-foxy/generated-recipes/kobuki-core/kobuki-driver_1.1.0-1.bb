...
# matches with: https://github.com/stonier/kobuki_core-release/archive/release/foxy/kobuki_driver/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/kobuki_driver"
SRC_URI = "git://github.com/stonier/kobuki_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "35bd9670df4bc0e648b09dc6e09537f3b8b120aa"
S = "${WORKDIR}/git"
