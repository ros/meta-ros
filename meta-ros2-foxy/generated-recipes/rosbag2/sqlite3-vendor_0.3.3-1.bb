...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/foxy/sqlite3_vendor/0.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/sqlite3_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5535217d8d2752013beca6c7a34c2511221d2d2e"
S = "${WORKDIR}/git"
