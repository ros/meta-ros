...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/foxy/sqlite3_vendor/0.3.6-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/sqlite3_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "6be2e8a7302f7dd62a2282582519ef28a4b0a41c"
S = "${WORKDIR}/git"
