...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/foxy/rosbag2_tests/0.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rosbag2_tests"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e1a2ef99e912d4ff28e0efb7dd1e0dcd6a6a79ac"
S = "${WORKDIR}/git"
