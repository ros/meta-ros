...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/foxy/rosbag2_tests/0.2.7-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rosbag2_tests"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5eb3e50b55de5d4991fb1036da29f2ff90772b0f"
S = "${WORKDIR}/git"
