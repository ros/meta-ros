...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/foxy/rosbag2_tests/0.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rosbag2_tests"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8076b631e0e77e1cfe3ac27ae022284fa085c2e2"
S = "${WORKDIR}/git"
