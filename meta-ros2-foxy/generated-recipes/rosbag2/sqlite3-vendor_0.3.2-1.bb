...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/foxy/sqlite3_vendor/0.3.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/sqlite3_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b47f6fdafb60ad12f90ac5767f5ebab2b6d07b18"
S = "${WORKDIR}/git"
