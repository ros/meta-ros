...
# matches with: https://github.com/fkie-release/async_web_server_cpp-release/archive/release/foxy/async_web_server_cpp/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/async_web_server_cpp"
SRC_URI = "git://github.com/fkie-release/async_web_server_cpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "1956056017ba2a220947f2f065453728bf89d527"
S = "${WORKDIR}/git"
