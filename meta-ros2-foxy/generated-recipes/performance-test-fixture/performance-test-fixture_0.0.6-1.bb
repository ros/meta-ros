...
# matches with: https://github.com/ros2-gbp/performance_test_fixture-release/archive/release/foxy/performance_test_fixture/0.0.6-1.tar.gz
...
SRCREV = "af9e6e0f7bdbe8bb6cd2d02eef008a3cad6bfa13"
S = "${WORKDIR}/git"
