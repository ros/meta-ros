...
# matches with: https://github.com/yujinrobot-release/sophus-release/archive/release/foxy/sophus/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/sophus"
SRC_URI = "git://github.com/yujinrobot-release/sophus-release;${ROS_BRANCH};protocol=https"
SRCREV = "342fe57be38e297cb764f05329a240cb4ebf59da"
S = "${WORKDIR}/git"
