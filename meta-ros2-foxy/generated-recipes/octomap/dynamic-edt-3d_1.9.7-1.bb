...
# matches with: https://github.com/ros-gbp/octomap-release/archive/release/foxy/dynamic_edt_3d/1.9.7-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/dynamic_edt_3d"
SRC_URI = "git://github.com/ros-gbp/octomap-release;${ROS_BRANCH};protocol=https"
SRCREV = "207d1aca17ea6a0ec59790e516f3f3a3d8d4f68d"
S = "${WORKDIR}/git"
