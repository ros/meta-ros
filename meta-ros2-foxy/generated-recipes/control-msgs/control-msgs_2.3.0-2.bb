...
# matches with: https://github.com/ros-gbp/control_msgs-release/archive/release/foxy/control_msgs/2.3.0-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/control_msgs"
SRC_URI = "git://github.com/ros-gbp/control_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "a77a1b69ce2ec4ea671859e0efb9681d33d90a70"
S = "${WORKDIR}/git"
