...
# matches with: https://github.com/ros-gbp/control_msgs-release/archive/release/foxy/control_msgs/2.4.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/control_msgs"
SRC_URI = "git://github.com/ros-gbp/control_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "12547801cb8e0a975c8fa7a12a65cd514b6917a1"
S = "${WORKDIR}/git"
