...
# matches with: https://github.com/ros-gbp/control_msgs-release/archive/release/foxy/control_msgs/2.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/foxy/control_msgs"
SRC_URI = "git://github.com/ros-gbp/control_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "b427a8723146554aa2dfe3c8a994ca52bee708cd"
S = "${WORKDIR}/git"
