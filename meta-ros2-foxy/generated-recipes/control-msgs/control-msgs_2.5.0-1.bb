...
# matches with: https://github.com/ros-gbp/control_msgs-release/archive/release/foxy/control_msgs/2.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/control_msgs"
SRC_URI = "git://github.com/ros-gbp/control_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "7094f85ad8d4f1abc76c0a33a8413754bd6f3d7d"
S = "${WORKDIR}/git"
