...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/foxy/nav2_dwb_controller/0.4.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/nav2_dwb_controller"
SRC_URI = "git://github.com/SteveMacenski/navigation2-release;${ROS_BRANCH};protocol=https"
SRCREV = "12536515afb92bb550e97d06dbd18f8cb9b0a7b5"
S = "${WORKDIR}/git"
