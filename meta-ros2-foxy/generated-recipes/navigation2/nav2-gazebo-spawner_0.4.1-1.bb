...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/foxy/nav2_gazebo_spawner/0.4.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/nav2_gazebo_spawner"
SRC_URI = "git://github.com/SteveMacenski/navigation2-release;${ROS_BRANCH};protocol=https"
SRCREV = "97c69c0060ba8f23cb9f80d65e17ae97c4bc61b1"
S = "${WORKDIR}/git"
