...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/foxy/nav2_regulated_pure_pursuit_controller/0.4.7-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/nav2_regulated_pure_pursuit_controller"
SRC_URI = "git://github.com/SteveMacenski/navigation2-release;${ROS_BRANCH};protocol=https"
SRCREV = "0f1ba7c46d8015bf4fcd22b24bc0257b6eace184"
S = "${WORKDIR}/git"
