...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/foxy/nav2_core/0.4.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/nav2_core"
SRC_URI = "git://github.com/SteveMacenski/navigation2-release;${ROS_BRANCH};protocol=https"
SRCREV = "9e0fa85b79f78f2db44e637ae4c604c8aa129a1b"
S = "${WORKDIR}/git"
