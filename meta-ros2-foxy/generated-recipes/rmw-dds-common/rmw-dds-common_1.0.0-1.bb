...
# matches with: https://github.com/ros2-gbp/rmw_dds_common-release/archive/release/foxy/rmw_dds_common/1.0.0-1.tar.gz
...
SRCREV = "842599ea8405f85585afc729ca2a0d110127dda8"
S = "${WORKDIR}/git"
