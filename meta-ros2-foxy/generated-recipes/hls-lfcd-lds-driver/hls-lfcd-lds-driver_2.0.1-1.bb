...
# matches with: https://github.com/robotis-ros2-release/hls_lfcd_lds_driver-release/archive/release/foxy/hls_lfcd_lds_driver/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/hls_lfcd_lds_driver"
SRC_URI = "git://github.com/robotis-ros2-release/hls_lfcd_lds_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "b1f2db933c90ffe0ca7ec1249cd756378d53ea28"
S = "${WORKDIR}/git"
