...
# matches with: https://github.com/ros2-gbp/ament_cmake_catch2-release/archive/release/foxy/ament_cmake_catch2/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ament_cmake_catch2"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake_catch2-release;${ROS_BRANCH};protocol=https"
SRCREV = "84e0d8d7d410b466753da0d4e6b8e6ee055e2573"
S = "${WORKDIR}/git"
