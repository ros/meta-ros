...
# matches with: https://github.com/fetchrobotics-gbp/robot_controllers-ros2-release/archive/release/foxy/robot_controllers/0.8.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/robot_controllers"
SRC_URI = "git://github.com/fetchrobotics-gbp/robot_controllers-ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8304fc69bebd8bc94546044fdbc1f1e114c75f60"
S = "${WORKDIR}/git"
