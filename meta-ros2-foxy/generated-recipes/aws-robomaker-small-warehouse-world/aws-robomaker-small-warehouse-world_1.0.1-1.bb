...
# matches with: https://github.com/aws-gbp/aws_robomaker_small_warehouse_world-release/archive/release/foxy/aws_robomaker_small_warehouse_world/1.0.1-1.tar.gz
...
SRCREV = "98135caafd550961d6112a1fbe89a2aa4a0e9e7a"
S = "${WORKDIR}/git"
