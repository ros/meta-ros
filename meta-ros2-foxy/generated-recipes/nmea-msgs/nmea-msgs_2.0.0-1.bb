...
# matches with: https://github.com/ros2-gbp/nmea_msgs-release/archive/release/foxy/nmea_msgs/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/nmea_msgs"
SRC_URI = "git://github.com/ros2-gbp/nmea_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "814063d3122ff6442f9d9e48fef0d605d9a98366"
S = "${WORKDIR}/git"
