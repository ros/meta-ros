...
# matches with: https://github.com/ros2-gbp/rcl_logging-release/archive/release/foxy/rcl_logging_log4cxx/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rcl_logging_log4cxx"
SRC_URI = "git://github.com/ros2-gbp/rcl_logging-release;${ROS_BRANCH};protocol=https"
SRCREV = "0e3840580f1077b7e6557a2adbb76ef28eb10cf5"
S = "${WORKDIR}/git"
