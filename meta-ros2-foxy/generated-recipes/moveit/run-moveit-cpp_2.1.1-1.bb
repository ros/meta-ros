...
# matches with: https://github.com/moveit/moveit2-release/archive/release/foxy/run_moveit_cpp/2.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/run_moveit_cpp"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "16598350ddd08531f3bc24c8685e50defd64d857"
S = "${WORKDIR}/git"
