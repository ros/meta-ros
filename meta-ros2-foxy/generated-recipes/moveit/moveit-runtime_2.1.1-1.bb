...
# matches with: https://github.com/moveit/moveit2-release/archive/release/foxy/moveit_runtime/2.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/moveit_runtime"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "eb74761b28a7d2057ffe95a72a102d657a3b5e5f"
S = "${WORKDIR}/git"
