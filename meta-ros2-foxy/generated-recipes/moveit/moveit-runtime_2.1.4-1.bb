...
# matches with: https://github.com/moveit/moveit2-release/archive/release/foxy/moveit_runtime/2.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/moveit_runtime"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d4d3489b1b60a1bd9494a6940c162c5f6546aa5b"
S = "${WORKDIR}/git"
