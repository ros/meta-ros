...
# matches with: https://github.com/moveit/moveit2-release/archive/release/foxy/moveit_plugins/2.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/moveit_plugins"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "ee9feb82a6e9d31161ec0e7d3eba87eb9dc0aaee"
S = "${WORKDIR}/git"
