...
# matches with: https://github.com/NewEagleRaptor/raptor-dbw-ros2-release/archive/release/foxy/raptor_can_dbc_parser/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/raptor_can_dbc_parser"
SRC_URI = "git://github.com/NewEagleRaptor/raptor-dbw-ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "1944f4aec118a966e2308878db0fd5560cec51bf"
S = "${WORKDIR}/git"
