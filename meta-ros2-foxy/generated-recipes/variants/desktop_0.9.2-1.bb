...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/foxy/desktop/0.9.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/desktop"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "e88e661f0ff4393f57365228046a65d1cc6d7f99"
S = "${WORKDIR}/git"
