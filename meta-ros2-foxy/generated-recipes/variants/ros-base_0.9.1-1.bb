...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/foxy/ros_base/0.9.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ros_base"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "cc732ead20372bb5e32f2ac719973b23b435e48f"
S = "${WORKDIR}/git"
