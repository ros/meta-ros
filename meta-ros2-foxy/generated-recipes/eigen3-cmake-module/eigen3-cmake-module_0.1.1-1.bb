...
# matches with: https://github.com/ros2-gbp/eigen3_cmake_module-release/archive/release/foxy/eigen3_cmake_module/0.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/eigen3_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/eigen3_cmake_module-release;${ROS_BRANCH};protocol=https"
SRCREV = "54cd78f4a5be03be21ea89504bda54dde9db0f0b"
S = "${WORKDIR}/git"
