...
# matches with: https://github.com/astuff/astuff_sensor_msgs-release/archive/release/foxy/astuff_sensor_msgs/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/astuff_sensor_msgs"
SRC_URI = "git://github.com/astuff/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "5afc895cd7f30f56b312ec5f036a054f01cc074b"
S = "${WORKDIR}/git"
