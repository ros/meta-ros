...
# matches with: https://github.com/astuff/astuff_sensor_msgs-release/archive/release/foxy/delphi_esr_msgs/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/delphi_esr_msgs"
SRC_URI = "git://github.com/astuff/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "9155affd27c4f463729fce20416afc24db4c5aec"
S = "${WORKDIR}/git"
