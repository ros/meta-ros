...
# matches with: https://github.com/astuff/astuff_sensor_msgs-release/archive/release/foxy/kartech_linear_actuator_msgs/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/kartech_linear_actuator_msgs"
SRC_URI = "git://github.com/astuff/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "7bc8919564ddffd9163bdd297e845d53672311c2"
S = "${WORKDIR}/git"
