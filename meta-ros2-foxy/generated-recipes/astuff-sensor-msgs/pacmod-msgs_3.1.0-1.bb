...
# matches with: https://github.com/astuff/astuff_sensor_msgs-release/archive/release/foxy/pacmod_msgs/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/pacmod_msgs"
SRC_URI = "git://github.com/astuff/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "d5accb23ac8f49f35d838e85f6fd215389fccb09"
S = "${WORKDIR}/git"
