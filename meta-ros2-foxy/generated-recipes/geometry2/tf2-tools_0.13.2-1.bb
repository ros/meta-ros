...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/foxy/tf2_tools/0.13.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "7c666eb64249550824ba6e57aecb51fb2025f85e"
S = "${WORKDIR}/git"
