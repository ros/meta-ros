...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/foxy/tf2_eigen_kdl/0.13.9-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/tf2_eigen_kdl"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d27be01d4b3db9f01befcff66fb0240147b2feb0"
S = "${WORKDIR}/git"
