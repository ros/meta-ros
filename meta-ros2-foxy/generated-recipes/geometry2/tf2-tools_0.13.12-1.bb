...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/foxy/tf2_tools/0.13.12-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "6575028cb8a4ab31b6fa6a6adc390ea13911763f"
S = "${WORKDIR}/git"
