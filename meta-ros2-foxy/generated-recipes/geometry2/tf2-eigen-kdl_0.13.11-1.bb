...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/foxy/tf2_eigen_kdl/0.13.11-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/tf2_eigen_kdl"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "22367d619c0ff1b34abe3e9135a14acac053af29"
S = "${WORKDIR}/git"
