...
# matches with: https://github.com/ros2-gbp/python_cmake_module-release/archive/release/foxy/python_cmake_module/0.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/python_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/python_cmake_module-release;${ROS_BRANCH};protocol=https"
SRCREV = "7d7510abf837204f54765069e5fad17e2ff90f7f"
S = "${WORKDIR}/git"
