...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/foxy/rosidl_parser/0.9.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "f61f9dc57f623b7d263838d72ca4be0e3911019b"
S = "${WORKDIR}/git"
