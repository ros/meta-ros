...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/foxy/rosidl_parser/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "e746a5dff00d3401be8b9b9e3dc7455603596cc7"
S = "${WORKDIR}/git"
