...
# matches with: https://github.com/vooon/ntpd_driver-release/archive/release/foxy/ntpd_driver/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ntpd_driver"
SRC_URI = "git://github.com/vooon/ntpd_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "31996eeff699e3744cc127dcd18f0b2e292ca97a"
S = "${WORKDIR}/git"
