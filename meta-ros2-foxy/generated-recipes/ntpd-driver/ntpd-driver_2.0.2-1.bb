...
# matches with: https://github.com/vooon/ntpd_driver-release/archive/release/foxy/ntpd_driver/2.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ntpd_driver"
SRC_URI = "git://github.com/vooon/ntpd_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "d046866551dd462c7f71e3d8b3dd51a46d789c7b"
S = "${WORKDIR}/git"
