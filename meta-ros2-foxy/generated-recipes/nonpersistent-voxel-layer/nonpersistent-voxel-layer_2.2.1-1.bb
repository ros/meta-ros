...
# matches with: https://github.com/SteveMacenski/nonpersistent_voxel_layer-release/archive/release/foxy/nonpersistent_voxel_layer/2.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/nonpersistent_voxel_layer"
SRC_URI = "git://github.com/SteveMacenski/nonpersistent_voxel_layer-release;${ROS_BRANCH};protocol=https"
SRCREV = "8b2f1682f5426509d915ed9ea4ab6063cfd124e6"
S = "${WORKDIR}/git"
