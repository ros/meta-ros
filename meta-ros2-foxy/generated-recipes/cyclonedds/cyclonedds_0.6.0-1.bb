...
# matches with: https://github.com/ros2-gbp/cyclonedds-release/archive/release/foxy/cyclonedds/0.6.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/cyclonedds"
SRC_URI = "git://github.com/ros2-gbp/cyclonedds-release;${ROS_BRANCH};protocol=https"
SRCREV = "3c3fc40443062b61862330d9894e2b10467216e3"
S = "${WORKDIR}/git"
