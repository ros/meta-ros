...
# matches with: https://github.com/ros2-gbp/rmf_ros2-release/archive/release/foxy/rmf_task_ros2/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rmf_task_ros2"
SRC_URI = "git://github.com/ros2-gbp/rmf_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5af03c4e5c6b822bf96fbdcccdf729bbb23add2e"
S = "${WORKDIR}/git"
