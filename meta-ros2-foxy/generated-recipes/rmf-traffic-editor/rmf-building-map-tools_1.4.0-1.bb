...
# matches with: https://github.com/ros2-gbp/rmf_traffic_editor-release/archive/release/foxy/rmf_building_map_tools/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rmf_building_map_tools"
SRC_URI = "git://github.com/ros2-gbp/rmf_traffic_editor-release;${ROS_BRANCH};protocol=https"
SRCREV = "6569ff7b908e0591a9951a09b9054067181f74f7"
S = "${WORKDIR}/git"
