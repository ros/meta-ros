...
# matches with: https://github.com/ros2-gbp/rmf_traffic_editor-release/archive/release/foxy/rmf_traffic_editor_assets/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rmf_traffic_editor_assets"
SRC_URI = "git://github.com/ros2-gbp/rmf_traffic_editor-release;${ROS_BRANCH};protocol=https"
SRCREV = "518d194a77e1ef585dc7a54a424cfe54d413731e"
S = "${WORKDIR}/git"
