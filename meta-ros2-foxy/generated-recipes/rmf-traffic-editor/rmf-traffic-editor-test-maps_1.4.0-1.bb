...
# matches with: https://github.com/ros2-gbp/rmf_traffic_editor-release/archive/release/foxy/rmf_traffic_editor_test_maps/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rmf_traffic_editor_test_maps"
SRC_URI = "git://github.com/ros2-gbp/rmf_traffic_editor-release;${ROS_BRANCH};protocol=https"
SRCREV = "d78577c148f34140d57dcbaf9911a348d62d82f3"
S = "${WORKDIR}/git"
