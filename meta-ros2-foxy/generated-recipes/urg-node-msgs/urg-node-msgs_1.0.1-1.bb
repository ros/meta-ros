...
# matches with: https://github.com/ros2-gbp/urg_node_msgs-release/archive/release/foxy/urg_node_msgs/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/urg_node_msgs"
SRC_URI = "git://github.com/ros2-gbp/urg_node_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "aa7d1daf05d1528490fc559c1110dd2991aa8ef8"
S = "${WORKDIR}/git"
