...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/foxy/composition_interfaces/0.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/composition_interfaces"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "f12b5b1d88a18b8b49272df990dfec665be03d6c"
S = "${WORKDIR}/git"
