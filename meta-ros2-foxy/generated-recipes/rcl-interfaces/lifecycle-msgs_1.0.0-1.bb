...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/foxy/lifecycle_msgs/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/lifecycle_msgs"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "cfa384b27af5d3db3b31914b438bfb518d73e597"
S = "${WORKDIR}/git"
