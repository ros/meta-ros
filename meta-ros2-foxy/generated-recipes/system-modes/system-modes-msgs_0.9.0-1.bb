...
# matches with: https://github.com/microROS/system_modes-release/archive/release/foxy/system_modes_msgs/0.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/system_modes_msgs"
SRC_URI = "git://github.com/microROS/system_modes-release;${ROS_BRANCH};protocol=https"
SRCREV = "74a6da9a7990b4aad4a3398272331c54980663f7"
S = "${WORKDIR}/git"
