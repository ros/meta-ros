...
# matches with: https://github.com/SICKAG/sick_scan2-release/archive/release/foxy/sick_scan2/0.1.9-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/sick_scan2"
SRC_URI = "git://github.com/SICKAG/sick_scan2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e6d4ad6e5bf55454354dfe3b01dfd13af0e8e39f"
S = "${WORKDIR}/git"
