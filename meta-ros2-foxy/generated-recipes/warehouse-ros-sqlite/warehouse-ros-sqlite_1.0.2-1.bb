...
# matches with: https://github.com/moveit/warehouse_ros_sqlite-release/archive/release/foxy/warehouse_ros_sqlite/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/warehouse_ros_sqlite"
SRC_URI = "git://github.com/moveit/warehouse_ros_sqlite-release;${ROS_BRANCH};protocol=https"
SRCREV = "02d20a584604934a083172e95346443a460d14b0"
S = "${WORKDIR}/git"
