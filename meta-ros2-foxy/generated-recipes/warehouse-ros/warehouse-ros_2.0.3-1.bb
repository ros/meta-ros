...
# matches with: https://github.com/moveit/warehouse_ros-release/archive/release/foxy/warehouse_ros/2.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/warehouse_ros"
SRC_URI = "git://github.com/moveit/warehouse_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "65460443926274d07caaa872f2f1580bdfe722cf"
S = "${WORKDIR}/git"
