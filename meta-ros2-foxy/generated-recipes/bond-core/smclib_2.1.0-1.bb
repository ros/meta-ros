...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/foxy/smclib/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/smclib"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "c8b4be10b89a95f11ac8f3c482ac3690710891b5"
S = "${WORKDIR}/git"
