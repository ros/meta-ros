...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/foxy/test_bond/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/test_bond"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "7b060ec5dcebc92cdcd2cc00b537a8b19e02951e"
S = "${WORKDIR}/git"
