...
# matches with: https://github.com/roboception-gbp/rc_genicam_api-release/archive/release/foxy/rc_genicam_api/2.5.6-1.tar.gz
...
SRCREV = "f57b3ca0c4039c6280eba7512aa9b1e75cec6cae"
S = "${WORKDIR}/git"
