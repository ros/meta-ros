...
# matches with: https://github.com/ros2-gbp/rmf_building_map_msgs-release/archive/release/foxy/rmf_building_map_msgs/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rmf_building_map_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_building_map_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "f5727d220dd2e2439e2f2c2cebf6526b7bb2aeab"
S = "${WORKDIR}/git"
