...
# matches with: https://github.com/ros2-gbp/joystick_drivers-release/archive/release/foxy/joy/3.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/joy"
SRC_URI = "git://github.com/ros2-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "580823b967d9b0779a6c11709663154f016b0b5f"
S = "${WORKDIR}/git"
