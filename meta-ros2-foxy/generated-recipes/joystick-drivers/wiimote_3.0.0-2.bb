...
# matches with: https://github.com/ros2-gbp/joystick_drivers-release/archive/release/foxy/wiimote/3.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/wiimote"
SRC_URI = "git://github.com/ros2-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "b244691720be9097e7f6801ddea16c402e53497f"
S = "${WORKDIR}/git"
