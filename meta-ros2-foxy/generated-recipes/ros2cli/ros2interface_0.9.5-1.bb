...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/foxy/ros2interface/0.9.5-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ros2interface"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "2ebf1456efaf10e026dbddd06227681bf16d9e2a"
S = "${WORKDIR}/git"
