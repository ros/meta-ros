...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/foxy/ros2interface/0.9.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ros2interface"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "5d5e7f0423a1a3cbea7c310bf6ce69b8010247c5"
S = "${WORKDIR}/git"
