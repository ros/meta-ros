...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/foxy/ros2interface/0.9.8-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ros2interface"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "1073d2d754484d9b6a40db62f81ada59f1675723"
S = "${WORKDIR}/git"
