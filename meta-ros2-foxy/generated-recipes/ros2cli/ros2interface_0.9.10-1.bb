...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/foxy/ros2interface/0.9.10-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ros2interface"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "acb7936f2e159ce565d69233578a807137a0b68c"
S = "${WORKDIR}/git"
