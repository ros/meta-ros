...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/foxy/ros2interface/0.9.4-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ros2interface"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "d4b9a5d6977fbb998a40223f60d811cfe043c10b"
S = "${WORKDIR}/git"
