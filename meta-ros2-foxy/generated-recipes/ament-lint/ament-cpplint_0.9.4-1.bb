...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_cpplint/0.9.4-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ament_cpplint"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "9076b85273616997b8a1eb0b1828d5977f03fe62"
S = "${WORKDIR}/git"
