...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_pycodestyle/0.9.3-1.tar.gz
...
SRCREV = "d9df5a2e7a1a1da8e8558ed2586446ceccb4d5bd"
S = "${WORKDIR}/git"
