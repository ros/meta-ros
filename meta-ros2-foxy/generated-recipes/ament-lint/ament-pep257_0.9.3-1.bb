...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_pep257/0.9.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ament_pep257"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "0e2f82add75ad547822dd2f8eae1f0bed234a70f"
S = "${WORKDIR}/git"
