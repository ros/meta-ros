...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_mypy/0.9.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ament_mypy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "df932634a76cf7a71962591909056ca815e60bcc"
S = "${WORKDIR}/git"
