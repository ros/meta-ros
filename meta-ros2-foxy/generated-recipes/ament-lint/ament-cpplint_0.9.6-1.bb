...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_cpplint/0.9.6-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ament_cpplint"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "921c1d4a5e498337cf2ab3b7fb0fe344e3b2692d"
S = "${WORKDIR}/git"
