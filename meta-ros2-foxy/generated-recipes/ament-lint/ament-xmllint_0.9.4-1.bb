...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_xmllint/0.9.4-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ament_xmllint"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "8e1e3293da5ef7b4a2f6d47452a78eb353d06f0e"
S = "${WORKDIR}/git"
