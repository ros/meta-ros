...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_cpplint/0.9.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ament_cpplint"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "7b2c824d9b3ca4fcd7e67cc8b8ccdfaba518ca3c"
S = "${WORKDIR}/git"
