...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_mypy/0.9.4-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ament_mypy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "05ba5eb6b4abb29c72e705338395c0fa0816f4cd"
S = "${WORKDIR}/git"
