...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_pclint/0.9.6-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ament_pclint"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "38651df1e17aa72cf3c4056dcc8e3e7c57f30370"
S = "${WORKDIR}/git"
