...
# matches with: https://github.com/moveit/moveit_resources-release/archive/release/foxy/moveit_resources_fanuc_moveit_config/2.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/moveit_resources_fanuc_moveit_config"
SRC_URI = "git://github.com/moveit/moveit_resources-release;${ROS_BRANCH};protocol=https"
SRCREV = "a1879d9b8b1ac0447547a67d1d1940acb7a08f8d"
S = "${WORKDIR}/git"
