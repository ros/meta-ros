...
# matches with: https://github.com/moveit/moveit_resources-release/archive/release/foxy/moveit_resources_fanuc_moveit_config/2.0.1-1.tar.gz
...
SRCREV = "d5d8e07a4b7b1896335096034232653f95ed7700"
S = "${WORKDIR}/git"
