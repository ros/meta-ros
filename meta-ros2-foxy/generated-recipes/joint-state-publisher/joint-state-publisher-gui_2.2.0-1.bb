...
# matches with: https://github.com/ros2-gbp/joint_state_publisher-release/archive/release/foxy/joint_state_publisher_gui/2.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/joint_state_publisher_gui"
SRC_URI = "git://github.com/ros2-gbp/joint_state_publisher-release;${ROS_BRANCH};protocol=https"
SRCREV = "cfdaa83ed76856f5d498c2474e894c5f54ae2973"
S = "${WORKDIR}/git"
