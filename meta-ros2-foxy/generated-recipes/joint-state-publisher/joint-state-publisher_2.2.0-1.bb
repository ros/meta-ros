...
# matches with: https://github.com/ros2-gbp/joint_state_publisher-release/archive/release/foxy/joint_state_publisher/2.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/joint_state_publisher"
SRC_URI = "git://github.com/ros2-gbp/joint_state_publisher-release;${ROS_BRANCH};protocol=https"
SRCREV = "4dec51a8bd672b96f253d4c1820a706e96aa5554"
S = "${WORKDIR}/git"
