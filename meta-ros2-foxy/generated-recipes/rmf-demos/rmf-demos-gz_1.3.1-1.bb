...
# matches with: https://github.com/ros2-gbp/rmf_demos-release/archive/release/foxy/rmf_demos_gz/1.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rmf_demos_gz"
SRC_URI = "git://github.com/ros2-gbp/rmf_demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "adcbd3da0a1500eac0c2594f745d8c99d965913f"
S = "${WORKDIR}/git"
