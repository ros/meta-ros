...
# matches with: https://github.com/ros2-gbp/rqt_runtime_monitor-release/archive/release/foxy/rqt_runtime_monitor/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rqt_runtime_monitor"
SRC_URI = "git://github.com/ros2-gbp/rqt_runtime_monitor-release;${ROS_BRANCH};protocol=https"
SRCREV = "c2c95bcc2830559485275025d892fc25aa9cf783"
S = "${WORKDIR}/git"
