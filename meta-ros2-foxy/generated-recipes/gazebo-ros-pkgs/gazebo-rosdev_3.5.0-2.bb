...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/foxy/gazebo_dev/3.5.0-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/gazebo_dev"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "82d66ce128951fe4fd1e862f3d6e9c8287640dd7"
S = "${WORKDIR}/git"
