...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/foxy/gazebo_dev/3.5.3-1.tar.gz
...
SRCREV = "9578c4ae81cb60e12df1fa000627d2e0fe9ffd23"
S = "${WORKDIR}/git"
