...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/foxy/gazebo_ros_pkgs/3.5.0-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/gazebo_ros_pkgs"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "28ea1863dd03a326296f22805f871080128ca3f5"
S = "${WORKDIR}/git"
