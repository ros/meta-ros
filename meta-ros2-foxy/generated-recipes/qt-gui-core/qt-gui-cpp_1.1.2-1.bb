...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/foxy/qt_gui_cpp/1.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/qt_gui_cpp"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "08845c854f5042e5ca6d701255630332446e0765"
S = "${WORKDIR}/git"
