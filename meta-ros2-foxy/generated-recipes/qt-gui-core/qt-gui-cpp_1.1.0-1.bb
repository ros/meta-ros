...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/foxy/qt_gui_cpp/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/qt_gui_cpp"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "918c11971153280a5de6ad35ad0777c007f8e112"
S = "${WORKDIR}/git"
