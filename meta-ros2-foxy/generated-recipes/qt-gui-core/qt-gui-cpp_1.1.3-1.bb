...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/foxy/qt_gui_cpp/1.1.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/qt_gui_cpp"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "ec754df7bd0da318324ac03c32bef9ea47014693"
S = "${WORKDIR}/git"
