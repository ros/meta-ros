...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/foxy/qt_gui/1.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "525138a4d7ffd59efb59d9366327567310c9a692"
S = "${WORKDIR}/git"
