...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/foxy/qt_gui_cpp/1.1.2-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/qt_gui_cpp"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "d1fad862badaf8ee5ae6ab38bc2d6ddff5570cff"
S = "${WORKDIR}/git"
