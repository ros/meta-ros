...
# matches with: https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/foxy/rmw_fastrtps_dynamic_cpp/1.2.4-1.tar.gz
...
SRCREV = "7801e0944ced6b5d587596985fc7eb6e198fa1db"
S = "${WORKDIR}/git"
