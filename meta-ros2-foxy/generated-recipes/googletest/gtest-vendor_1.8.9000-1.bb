...
# matches with: https://github.com/ros2-gbp/googletest-release/archive/release/foxy/gtest_vendor/1.8.9000-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/gtest_vendor"
SRC_URI = "git://github.com/ros2-gbp/googletest-release;${ROS_BRANCH};protocol=https"
SRCREV = "82256fce1b9320ccf07d1ee28a6c69c8015f7ed5"
S = "${WORKDIR}/git"
