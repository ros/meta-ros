...
# matches with: https://gitlab.com/micro-ROS/ros_tracing/ros2_tracing-release/archive/release/foxy/tracetools_test/1.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/tracetools_test"
SRC_URI = "git://gitlab.com/micro-ROS/ros_tracing/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "a553388db91f38b7581228c3faed0962d09ebad2"
S = "${WORKDIR}/git"
