...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/eloquent/ros_core/0.8.5-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/ros_core"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "6bb92c1405be86e6974b8d7231fa6bb95a26f8a1"
S = "${WORKDIR}/git"
