...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/eloquent/ros_base/0.8.3-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/ros_base"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "505c676142dfe0c843db71badfa684e415de9fa7"
S = "${WORKDIR}/git"
