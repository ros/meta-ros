...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/eloquent/desktop/0.8.5-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/desktop"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "f05c224d67274cb4557627397a6856a1f9b8b15c"
S = "${WORKDIR}/git"
