...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/eloquent/ros_core/0.8.3-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/ros_core"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "d045aac02345230e3d659361b56904cbfde3c309"
S = "${WORKDIR}/git"
