...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/eloquent/ros_base/0.8.5-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/ros_base"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "bf41985849decb11071eb5225cd9bc4e7b3de97b"
S = "${WORKDIR}/git"
