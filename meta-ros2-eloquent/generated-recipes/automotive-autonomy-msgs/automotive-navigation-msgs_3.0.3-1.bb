...
# matches with: https://github.com/astuff/automotive_autonomy_msgs-release/archive/release/eloquent/automotive_navigation_msgs/3.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/automotive_navigation_msgs"
