...
# matches with: https://github.com/astuff/automotive_autonomy_msgs-release/archive/release/eloquent/automotive_platform_msgs/3.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/automotive_platform_msgs"
SRC_URI = "git://github.com/astuff/automotive_autonomy_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "4df620ba2b33f50d11066c593b3a51ef7f0aeded"
S = "${WORKDIR}/git"
