...
# matches with: https://github.com/astuff/astuff_sensor_msgs-release/archive/release/eloquent/derived_object_msgs/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/derived_object_msgs"
SRC_URI = "git://github.com/astuff/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "fcf43e9fe24283cc7fb0b929564f3d9253f7f2df"
S = "${WORKDIR}/git"
