...
# matches with: https://github.com/astuff/astuff_sensor_msgs-release/archive/release/eloquent/delphi_esr_msgs/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/delphi_esr_msgs"
SRC_URI = "git://github.com/astuff/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "b540b188e9477ee29acd77ce2d3c204b952c3a8d"
S = "${WORKDIR}/git"
