...
# matches with: https://github.com/astuff/astuff_sensor_msgs-release/archive/release/eloquent/delphi_mrr_msgs/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/delphi_mrr_msgs"
SRC_URI = "git://github.com/astuff/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "d949c6f283b7d90b4e0548b79f8526557d078a29"
S = "${WORKDIR}/git"
