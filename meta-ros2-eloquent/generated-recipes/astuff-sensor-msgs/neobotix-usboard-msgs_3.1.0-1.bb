...
# matches with: https://github.com/astuff/astuff_sensor_msgs-release/archive/release/eloquent/neobotix_usboard_msgs/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/neobotix_usboard_msgs"
SRC_URI = "git://github.com/astuff/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "594d9f912e49660451a26fa29a1839f690137769"
S = "${WORKDIR}/git"
