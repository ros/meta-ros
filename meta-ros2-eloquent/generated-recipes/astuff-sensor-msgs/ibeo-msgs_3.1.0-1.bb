...
# matches with: https://github.com/astuff/astuff_sensor_msgs-release/archive/release/eloquent/ibeo_msgs/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/ibeo_msgs"
SRC_URI = "git://github.com/astuff/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "9bd3312c09bf665ee70d4650cfb1f4753c529656"
S = "${WORKDIR}/git"
