...
# matches with: https://github.com/astuff/astuff_sensor_msgs-release/archive/release/eloquent/delphi_srr_msgs/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/delphi_srr_msgs"
SRC_URI = "git://github.com/astuff/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "38666e8cc3c31d0cc2ddcb33f0aa80799bc1f983"
S = "${WORKDIR}/git"
