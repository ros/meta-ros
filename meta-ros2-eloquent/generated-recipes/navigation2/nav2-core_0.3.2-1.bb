...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/eloquent/nav2_core/0.3.2-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/nav2_core"
SRC_URI = "git://github.com/SteveMacenski/navigation2-release;${ROS_BRANCH};protocol=https"
SRCREV = "350cab1d1749fc8d385ea7ab2739cdcdad49ddc2"
S = "${WORKDIR}/git"
