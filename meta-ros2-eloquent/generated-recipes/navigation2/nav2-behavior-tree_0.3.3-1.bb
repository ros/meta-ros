...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/eloquent/nav2_behavior_tree/0.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/nav2_behavior_tree"
SRC_URI = "git://github.com/SteveMacenski/navigation2-release;${ROS_BRANCH};protocol=https"
SRCREV = "6076cd8b710e4e6434e5accbb8bc12369cbbffe0"
S = "${WORKDIR}/git"
