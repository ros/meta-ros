...
# matches with: https://github.com/ros2-gbp/joint_state_publisher-release/archive/release/eloquent/joint_state_publisher/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/joint_state_publisher"
SRC_URI = "git://github.com/ros2-gbp/joint_state_publisher-release;${ROS_BRANCH};protocol=https"
SRCREV = "26bc08d2d54495bb1b4dc96b3feeb86e3ac1698a"
S = "${WORKDIR}/git"
