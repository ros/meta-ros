...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/eloquent/rosidl_parser/0.8.1-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "27d6e7ae1a2250838a829da783635ee05ad10fab"
S = "${WORKDIR}/git"
