...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/eloquent/dummy_sensors/0.8.4-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/dummy_sensors"
