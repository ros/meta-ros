...
# matches with: https://github.com/ros2-gbp/console_bridge_vendor-release/archive/release/eloquent/console_bridge_vendor/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/console_bridge_vendor"
