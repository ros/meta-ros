...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/eloquent/tf2_eigen/0.12.5-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/tf2_eigen"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "19c35b1f394422a9d3bceb7748eaff6f3c62a60f"
S = "${WORKDIR}/git"
