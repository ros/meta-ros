...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/eloquent/gazebo_ros_pkgs/3.4.4-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/gazebo_ros_pkgs"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "137b2914e36c489dc54134a0b63c879e4c1cc9f9"
S = "${WORKDIR}/git"
