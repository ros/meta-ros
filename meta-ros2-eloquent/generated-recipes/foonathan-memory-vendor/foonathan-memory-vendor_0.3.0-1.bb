...
# matches with: https://github.com/ros2-gbp/foonathan_memory_vendor-release/archive/release/eloquent/foonathan_memory_vendor/0.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/foonathan_memory_vendor"
