...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/eloquent/actionlib_msgs/0.8.1-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/actionlib_msgs"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "c4071db7c210a15aef2961f0566d9af877d3a0ef"
S = "${WORKDIR}/git"
