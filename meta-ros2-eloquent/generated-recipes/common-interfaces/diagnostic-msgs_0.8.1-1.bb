...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/eloquent/diagnostic_msgs/0.8.1-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/diagnostic_msgs"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "26b6a083b1863b6b91a72b4db81e6ec949672787"
S = "${WORKDIR}/git"
