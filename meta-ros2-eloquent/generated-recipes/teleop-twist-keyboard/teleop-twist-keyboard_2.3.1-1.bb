...
# matches with: https://github.com/ros2-gbp/teleop_twist_keyboard-release/archive/release/eloquent/teleop_twist_keyboard/2.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/teleop_twist_keyboard"
SRC_URI = "git://github.com/ros2-gbp/teleop_twist_keyboard-release;${ROS_BRANCH};protocol=https"
SRCREV = "0e4c1eac46953c3ad6631ce79f34d5e0362debae"
S = "${WORKDIR}/git"
