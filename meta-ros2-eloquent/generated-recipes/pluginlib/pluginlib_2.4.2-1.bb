...
# matches with: https://github.com/ros2-gbp/pluginlib-release/archive/release/eloquent/pluginlib/2.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/pluginlib"
SRC_URI = "git://github.com/ros2-gbp/pluginlib-release;${ROS_BRANCH};protocol=https"
SRCREV = "b4940120646b6e7001752e396945704684411346"
S = "${WORKDIR}/git"
