...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/eloquent/composition_interfaces/0.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/composition_interfaces"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "e0dc3ba89ed8f2340e434026259f2cceb3faf12c"
S = "${WORKDIR}/git"
