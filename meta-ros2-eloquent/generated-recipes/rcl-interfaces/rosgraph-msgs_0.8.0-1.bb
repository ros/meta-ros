...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/eloquent/rosgraph_msgs/0.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/rosgraph_msgs"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "cb33a098bd34be7441e0ccdca4833291a7ddcc80"
S = "${WORKDIR}/git"
