...
# matches with: https://github.com/ros2-gbp/eigen_stl_containers-release/archive/release/eloquent/eigen_stl_containers/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/eigen_stl_containers"
