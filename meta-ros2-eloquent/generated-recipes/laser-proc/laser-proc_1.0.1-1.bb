...
# matches with: https://github.com/ros2-gbp/laser_proc-release/archive/release/eloquent/laser_proc/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/laser_proc"
SRC_URI = "git://github.com/ros2-gbp/laser_proc-release;${ROS_BRANCH};protocol=https"
SRCREV = "3618cb858374696542effcd2c5636b027b83a13a"
S = "${WORKDIR}/git"
