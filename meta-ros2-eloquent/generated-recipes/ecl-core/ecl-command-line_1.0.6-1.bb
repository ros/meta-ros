...
# matches with: https://github.com/yujinrobot-release/ecl_core-release/archive/release/eloquent/ecl_command_line/1.0.6-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/ecl_command_line"
SRC_URI = "git://github.com/yujinrobot-release/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "fe33498946b94d0e606c59a02ede4ff614ab56d3"
S = "${WORKDIR}/git"
