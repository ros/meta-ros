...
# matches with: https://github.com/yujinrobot-release/ecl_core-release/archive/release/eloquent/ecl_geometry/1.0.7-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/ecl_geometry"
SRC_URI = "git://github.com/yujinrobot-release/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "7ecd488f45410bcd1c81f135777b28ec0fc0e4b4"
S = "${WORKDIR}/git"
