...
# matches with: https://github.com/swri-robotics-gbp/gps_umd-release/archive/release/eloquent/gpsd_client/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/gpsd_client"
SRC_URI = "git://github.com/swri-robotics-gbp/gps_umd-release;${ROS_BRANCH};protocol=https"
SRCREV = "2ab96e9e8ed118c02d555ee4f562251f798b5ade"
S = "${WORKDIR}/git"
