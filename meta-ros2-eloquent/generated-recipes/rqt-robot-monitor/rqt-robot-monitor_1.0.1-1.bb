...
# matches with: https://github.com/ros2-gbp/rqt_robot_monitor-release/archive/release/eloquent/rqt_robot_monitor/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/rqt_robot_monitor"
SRC_URI = "git://github.com/ros2-gbp/rqt_robot_monitor-release;${ROS_BRANCH};protocol=https"
SRCREV = "ac087af882b7db00f44e8eeb1c7ec6110818f781"
S = "${WORKDIR}/git"
