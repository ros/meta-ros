...
# matches with: https://github.com/ros2-gbp/python_qt_binding-release/archive/release/eloquent/python_qt_binding/1.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/python_qt_binding"
SRC_URI = "git://github.com/ros2-gbp/python_qt_binding-release;${ROS_BRANCH};protocol=https"
SRCREV = "46d6bdff9afc6b1918c538152ac3a396ea0f59db"
S = "${WORKDIR}/git"
