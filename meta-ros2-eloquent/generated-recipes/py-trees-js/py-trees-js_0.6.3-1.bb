...
# matches with: https://github.com/stonier/py_trees_js-release/archive/release/eloquent/py_trees_js/0.6.3-1.tar.gz
...
SRCREV = "2d4a37392ddcea3edaf04f818db8157f0e53b6b3"
S = "${WORKDIR}/git"
