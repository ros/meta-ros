...
# matches with: https://github.com/ros2-gbp/rosidl_runtime_py-release/archive/release/eloquent/rosidl_runtime_py/0.8.2-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/rosidl_runtime_py"
