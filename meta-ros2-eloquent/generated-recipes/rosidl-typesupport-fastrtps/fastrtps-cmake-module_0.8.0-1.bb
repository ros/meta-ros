...
# matches with: https://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release/archive/release/eloquent/fastrtps_cmake_module/0.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/fastrtps_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release;${ROS_BRANCH};protocol=https"
SRCREV = "8e0d559623400e5f208c6643b39ed5970de30d29"
S = "${WORKDIR}/git"
