...
# matches with: https://github.com/ros-industrial-release/ros_canopen-release/archive/release/eloquent/can_msgs/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/can_msgs"
SRC_URI = "git://github.com/ros-industrial-release/ros_canopen-release;${ROS_BRANCH};protocol=https"
SRCREV = "f2ff3b01a30f7df21cd1ff1f5b2cbe2f8cafe1b9"
S = "${WORKDIR}/git"
