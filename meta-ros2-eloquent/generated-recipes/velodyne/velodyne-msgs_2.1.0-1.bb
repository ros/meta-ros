...
# matches with: https://github.com/ros-drivers-gbp/velodyne-release/archive/release/eloquent/velodyne_msgs/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/velodyne_msgs"
SRC_URI = "git://github.com/ros-drivers-gbp/velodyne-release;${ROS_BRANCH};protocol=https"
SRCREV = "3081f68de5789c71f4cdc036ff7a5356c01946a5"
S = "${WORKDIR}/git"
