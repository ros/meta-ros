...
# matches with: https://github.com/stonier/py_trees-release/archive/release/eloquent/py_trees/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/py_trees"
SRC_URI = "git://github.com/stonier/py_trees-release;${ROS_BRANCH};protocol=https"
SRCREV = "4179f831d032acee89ea000ba763092924dcfe80"
S = "${WORKDIR}/git"
