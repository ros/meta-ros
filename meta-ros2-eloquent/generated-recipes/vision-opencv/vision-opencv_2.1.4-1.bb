...
# matches with: https://github.com/ros2-gbp/vision_opencv-release/archive/release/eloquent/vision_opencv/2.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/vision_opencv"
SRC_URI = "git://github.com/ros2-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "ce30971b996e18f3eb7b5f16f6ef5a949e3dbaa0"
S = "${WORKDIR}/git"
