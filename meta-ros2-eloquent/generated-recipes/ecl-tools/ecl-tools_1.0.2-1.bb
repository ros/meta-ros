...
# matches with: https://github.com/yujinrobot-release/ecl_tools-release/archive/release/eloquent/ecl_tools/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/ecl_tools"
