...
# matches with: https://github.com/yujinrobot-release/ecl_tools-release/archive/release/eloquent/ecl_license/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/ecl_license"
SRC_URI = "git://github.com/yujinrobot-release/ecl_tools-release;${ROS_BRANCH};protocol=https"
SRCREV = "691403085a6db21b2e627157161229697bb4f8e7"
S = "${WORKDIR}/git"
