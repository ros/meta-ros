...
# matches with: https://github.com/ros2-gbp/cartographer-release/archive/release/eloquent/cartographer/1.0.9001-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/cartographer"
SRC_URI = "git://github.com/ros2-gbp/cartographer-release;${ROS_BRANCH};protocol=https"
SRCREV = "cd9298a3be5e441d82e2ac90172df6079acb3f4f"
S = "${WORKDIR}/git"
