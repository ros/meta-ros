...
# matches with: https://github.com/ros2-gbp/image_common-release/archive/release/eloquent/image_transport/2.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/image_transport"
SRC_URI = "git://github.com/ros2-gbp/image_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "b2352f3ab5290c5e0e3d58dca90183a9f0d085de"
S = "${WORKDIR}/git"
