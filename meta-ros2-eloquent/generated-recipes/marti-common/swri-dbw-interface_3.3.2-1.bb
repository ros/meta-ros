...
# matches with: https://github.com/swri-robotics-gbp/marti_common-release/archive/release/eloquent/swri_dbw_interface/3.3.2-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/swri_dbw_interface"
SRC_URI = "git://github.com/swri-robotics-gbp/marti_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "13bcc75db09b6d34eefb1ad43730d16fb5f3db7b"
S = "${WORKDIR}/git"
