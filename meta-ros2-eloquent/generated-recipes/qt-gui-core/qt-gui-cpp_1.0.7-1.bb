...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/eloquent/qt_gui_cpp/1.0.7-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/qt_gui_cpp"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "6506af1242af6d23af3e42aacbe0f94be95151ac"
S = "${WORKDIR}/git"
