...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/eloquent/qt_gui/1.0.7-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "fc496c7e6b9b0e84f185db9d6ad162eec3f4d65f"
S = "${WORKDIR}/git"
