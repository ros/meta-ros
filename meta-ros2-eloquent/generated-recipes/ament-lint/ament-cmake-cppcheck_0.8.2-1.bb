...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/eloquent/ament_cmake_cppcheck/0.8.2-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/ament_cmake_cppcheck"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "6318cb59a55f09aa6d6ae7dc6acc38fbc5fd1474"
S = "${WORKDIR}/git"
