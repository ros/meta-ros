...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/eloquent/ament_cmake_flake8/0.8.1-1.tar.gz
ROS_BRANCH ?= "branch=release/eloquent/ament_cmake_flake8"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "48a59f626c6f14d01420d6d3b21bbb1a6d183cf6"
S = "${WORKDIR}/git"
