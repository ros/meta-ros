...
#!/bin/sh
export PYTHONPATH="${PYTHON_SITEPACKAGES_DIR}:$PYTHONPATH"
pytest --automake
EOF
...
RDEPENDS:${PN}-ptest:append = " ${ROS_TEST_DEPENDS}"

do_install_ptest:append() {
    # xmllint test needs the package.xml file
    install -d ${D}${PTEST_PATH}/${PTEST_PYTEST_DIR}
    install -m 0555 ${S}/package.xml ${D}${PTEST_PATH}/${PTEST_PYTEST_DIR} 
}
