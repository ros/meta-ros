...
# matches with: https://github.com/ros2-gbp/pybind11_vendor-release/archive/release/rolling/pybind11_vendor/3.1.1-2.tar.gz
...
SRCREV = "efd6def13be434c030f879ae7b5aae300bbed469"
S = "${WORKDIR}/git"
