...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_ign_image/0.233.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros_ign_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "fadb0a789e81e0fa79cb582faab6680528f0fbfd"
S = "${WORKDIR}/git"
