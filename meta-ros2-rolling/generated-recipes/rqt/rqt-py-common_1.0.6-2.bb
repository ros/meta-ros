...
# matches with: https://github.com/ros2-gbp/rqt-release/archive/release/rolling/rqt_py_common/1.0.6-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_py_common"
SRC_URI = "git://github.com/ros2-gbp/rqt-release;${ROS_BRANCH};protocol=https"
SRCREV = "5e9a0bc968fabc3fadd13bf922c53f16efdb476d"
S = "${WORKDIR}/git"
