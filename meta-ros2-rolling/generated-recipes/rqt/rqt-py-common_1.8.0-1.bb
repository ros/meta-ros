...
# matches with: https://github.com/ros2-gbp/rqt-release/archive/release/rolling/rqt_py_common/1.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_py_common"
SRC_URI = "git://github.com/ros2-gbp/rqt-release;${ROS_BRANCH};protocol=https"
SRCREV = "b7a39318b177c05201676800b41085d3d120a177"
S = "${WORKDIR}/git"
