...
# matches with: https://github.com/ros2-gbp/ros_battery_monitoring-release/archive/release/rolling/battery_state_broadcaster/1.0.0-1.tar.gz
...
SRCREV = "0d64cba7565af1681c145bd00be7bd87a8b4b744"
S = "${WORKDIR}/git"
