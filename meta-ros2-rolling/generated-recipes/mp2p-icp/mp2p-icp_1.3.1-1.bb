...
# matches with: https://github.com/ros2-gbp/mp2p_icp-release/archive/release/rolling/mp2p_icp/1.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mp2p_icp"
SRC_URI = "git://github.com/ros2-gbp/mp2p_icp-release;${ROS_BRANCH};protocol=https"
SRCREV = "1ff8e5d5f6afa852cdb4829a0be5e1f6b38001d9"
S = "${WORKDIR}/git"
