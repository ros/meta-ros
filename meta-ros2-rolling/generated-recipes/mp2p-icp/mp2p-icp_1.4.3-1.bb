...
# matches with: https://github.com/ros2-gbp/mp2p_icp-release/archive/release/rolling/mp2p_icp/1.4.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mp2p_icp"
SRC_URI = "git://github.com/ros2-gbp/mp2p_icp-release;${ROS_BRANCH};protocol=https"
SRCREV = "6e5afe6477500291f62261ee46df9727edb1fd20"
S = "${WORKDIR}/git"
