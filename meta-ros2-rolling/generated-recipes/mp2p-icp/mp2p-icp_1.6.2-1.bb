...
# matches with: https://github.com/ros2-gbp/mp2p_icp-release/archive/release/rolling/mp2p_icp/1.6.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mp2p_icp"
SRC_URI = "git://github.com/ros2-gbp/mp2p_icp-release;${ROS_BRANCH};protocol=https"
SRCREV = "81ab7380e7b6adc782b22cc63c012361e90da6f2"
S = "${WORKDIR}/git"
