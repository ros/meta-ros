...
# matches with: https://github.com/ros2-gbp/ros2_tracing-release/archive/release/rolling/lttngpy/8.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lttngpy"
SRC_URI = "git://github.com/ros2-gbp/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "af219fa30d6facd4be6bebcdf8c6973632e810da"
S = "${WORKDIR}/git"
