...
# matches with: https://github.com/ros2-gbp/ros2_tracing-release/archive/release/rolling/lttngpy/8.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lttngpy"
SRC_URI = "git://github.com/ros2-gbp/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "92895ed5615935e72ab0a09f673244459f54bd5f"
S = "${WORKDIR}/git"
