...
# matches with: https://github.com/ros2-gbp/vrpn_mocap-release/archive/release/rolling/vrpn_mocap/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/vrpn_mocap"
SRC_URI = "git://github.com/ros2-gbp/vrpn_mocap-release;${ROS_BRANCH};protocol=https"
SRCREV = "5026923188ea864b980de17f8ab550971fdd5753"
S = "${WORKDIR}/git"
