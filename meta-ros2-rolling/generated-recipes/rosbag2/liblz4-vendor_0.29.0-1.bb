...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/liblz4_vendor/0.29.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/liblz4_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "721c177ac9d2b244763802f973c8d86c16cbdfbf"
S = "${WORKDIR}/git"
