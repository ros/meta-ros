...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/zstd_vendor/0.10.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/zstd_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b8a01fe268d59435f17d3f667d9341d498446667"
S = "${WORKDIR}/git"
