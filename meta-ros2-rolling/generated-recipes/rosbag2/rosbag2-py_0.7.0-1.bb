...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_py/0.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosbag2_py"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "24a2033819274f9d653f9d557bf2871097a3eb5e"
S = "${WORKDIR}/git"
