...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_cpp/0.25.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosbag2_cpp"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a7727bfc47b9cd54da56414fb32332ee91216394"
S = "${WORKDIR}/git"
