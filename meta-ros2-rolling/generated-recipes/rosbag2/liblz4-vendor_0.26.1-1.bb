...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/liblz4_vendor/0.26.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/liblz4_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "0ddc34d323c718b6852d7f4361f713ce44d5a77f"
S = "${WORKDIR}/git"
