...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_py/0.6.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosbag2_py"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d93d03bc0e830bbcdf2334ecb6a94d910435aba7"
S = "${WORKDIR}/git"
