...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/liblz4_vendor/0.27.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/liblz4_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "504fe4056a4f705a15c8085bf4a61539e2d2d91e"
S = "${WORKDIR}/git"
