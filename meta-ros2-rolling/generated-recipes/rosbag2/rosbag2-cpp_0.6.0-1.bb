...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_cpp/0.6.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosbag2_cpp"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "ecb904dd7eb15bf215086bd2d23f7c0459340d1d"
S = "${WORKDIR}/git"
