...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/zstd_cmake_module/0.33.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/zstd_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "7b5184f2093b7313d4b377035910469a96ed829e"
S = "${WORKDIR}/git"
