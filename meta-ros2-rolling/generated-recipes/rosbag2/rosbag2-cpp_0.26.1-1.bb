...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_cpp/0.26.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosbag2_cpp"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "1a1a137a24938cc2f9d5903a8be8db3605f817bd"
S = "${WORKDIR}/git"
