...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/zstd_vendor/0.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/zstd_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d2ab822c545a4defbb859c653c491203195c414d"
S = "${WORKDIR}/git"
