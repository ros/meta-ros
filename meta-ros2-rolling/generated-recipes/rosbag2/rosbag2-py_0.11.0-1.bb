...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_py/0.11.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosbag2_py"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a7497a188c65162e64f22b9f522692ae0ae0e88b"
S = "${WORKDIR}/git"
