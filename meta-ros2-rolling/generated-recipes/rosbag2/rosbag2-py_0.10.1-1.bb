...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_py/0.10.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosbag2_py"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "864551ce4438cfb158470110ed2bba008e1dccb3"
S = "${WORKDIR}/git"
