...
# matches with: https://github.com/ros2-gbp/rmw_connext-release/archive/release/rolling/rmw_connext_shared_cpp/3.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rmw_connext_shared_cpp"
SRC_URI = "git://github.com/ros2-gbp/rmw_connext-release;${ROS_BRANCH};protocol=https"
SRCREV = "62b55f3269f77aeee4b9a55eed61b01ba4243fbe"
S = "${WORKDIR}/git"
