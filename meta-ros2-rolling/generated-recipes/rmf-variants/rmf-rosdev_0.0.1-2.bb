...
# matches with: https://github.com/ros2-gbp/rmf_variants-release/archive/release/rolling/rmf_dev/0.0.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rmf_dev"
SRC_URI = "git://github.com/ros2-gbp/rmf_variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "2ab4d65006b5c7f8817257c6e5bd659464a5ecb5"
S = "${WORKDIR}/git"
