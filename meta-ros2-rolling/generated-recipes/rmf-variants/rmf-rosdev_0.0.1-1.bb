...
# matches with: https://github.com/ros2-gbp/rmf_variants-release/archive/release/rolling/rmf_dev/0.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rmf_dev"
SRC_URI = "git://github.com/ros2-gbp/rmf_variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "1ec94cc8a3020c4c04144268da754985ce3319b4"
S = "${WORKDIR}/git"
