...
# matches with: https://github.com/ros2-gbp/imu_tools-release/archive/release/rolling/imu_filter_madgwick/2.1.3-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/imu_filter_madgwick"
SRC_URI = "git://github.com/ros2-gbp/imu_tools-release;${ROS_BRANCH};protocol=https"
SRCREV = "0732efcbbb8f41e80c48fdd17cb4491b53d5ef98"
S = "${WORKDIR}/git"
