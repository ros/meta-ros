...
# matches with: https://github.com/ros2-gbp/gz_launch_vendor-release/archive/release/rolling/gz_launch_vendor/0.1.1-1.tar.gz
...
SRCREV = "1d308be03d2a82a9b13d8a3fddab7e9a1227b191"
S = "${WORKDIR}/git"
