...
# matches with: https://github.com/ros2-gbp/gz_launch_vendor-release/archive/release/rolling/gz_launch_vendor/0.1.0-1.tar.gz
...
SRCREV = "7cfc7bd6fd31787d1ceabcf37b4db54061d0b43f"
S = "${WORKDIR}/git"
