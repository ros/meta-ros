...
DESCRIPTION = "Vendor package for: gz-launch 9.0.0      Gazebo Launch : Run and manage programs and plugins"
...
# matches with: https://github.com/ros2-gbp/gz_launch_vendor-release/archive/release/rolling/gz_launch_vendor/0.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/gz_launch_vendor"
SRC_URI = "git://github.com/ros2-gbp/gz_launch_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "e7b8f013f6a2faf826df2d47b5a10462a05d966b"
S = "${WORKDIR}/git"
