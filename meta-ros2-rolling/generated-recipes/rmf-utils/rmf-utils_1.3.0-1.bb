...
# matches with: https://github.com/ros2-gbp/rmf_utils-release/archive/release/rolling/rmf_utils/1.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rmf_utils"
SRC_URI = "git://github.com/ros2-gbp/rmf_utils-release;${ROS_BRANCH};protocol=https"
SRCREV = "42cca03f29f4cdbda86a05bc45d0c73416a0f4c2"
S = "${WORKDIR}/git"
