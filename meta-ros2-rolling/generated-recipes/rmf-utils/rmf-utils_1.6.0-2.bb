...
# matches with: https://github.com/ros2-gbp/rmf_utils-release/archive/release/rolling/rmf_utils/1.6.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rmf_utils"
SRC_URI = "git://github.com/ros2-gbp/rmf_utils-release;${ROS_BRANCH};protocol=https"
SRCREV = "88edee5a65bc70432455f36d0be3240d26e64fb7"
S = "${WORKDIR}/git"
