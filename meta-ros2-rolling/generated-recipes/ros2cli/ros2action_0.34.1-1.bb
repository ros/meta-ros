...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2action/0.34.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2action"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "9438bf45f3208dffee15a8c9bbe85bd9a868865e"
S = "${WORKDIR}/git"
