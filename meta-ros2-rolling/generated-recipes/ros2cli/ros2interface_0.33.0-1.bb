...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2interface/0.33.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2interface"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "b3e86a051fcf09bfa2b7d111da7a21098f0e5aa4"
S = "${WORKDIR}/git"
