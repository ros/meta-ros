...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2multicast/0.29.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2multicast"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "45fdede59ee15aba9ffade0f8c75ccc6ac3a86f6"
S = "${WORKDIR}/git"
