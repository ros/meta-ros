...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2topic/0.31.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2topic"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "de32d4afa8a7b65eec470288bfb64bf0bf79236e"
S = "${WORKDIR}/git"
