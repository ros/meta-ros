...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2interface/0.31.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2interface"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "bf0d042b28a2327b1138fdc940537e8a51a9295f"
S = "${WORKDIR}/git"
