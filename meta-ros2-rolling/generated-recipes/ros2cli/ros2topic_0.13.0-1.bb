...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2topic/0.13.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2topic"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "24512ad3efff46be2ff4094fc6fbded94520a1fb"
S = "${WORKDIR}/git"
