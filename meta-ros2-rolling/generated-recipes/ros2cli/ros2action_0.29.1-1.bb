...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2action/0.29.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2action"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "937e3d888f6461cfe92de2558ee1e4e575b94b47"
S = "${WORKDIR}/git"
