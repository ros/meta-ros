...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2interface/0.29.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2interface"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "cbfc85db4513dba1bcc050e94538a61771723dfa"
S = "${WORKDIR}/git"
