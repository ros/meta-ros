...
# matches with: https://github.com/ros2-gbp/boost_sml_vendor-release/archive/release/rolling/boost_sml_vendor/1.1.12-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/boost_sml_vendor"
SRC_URI = "git://github.com/ros2-gbp/boost_sml_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "e79943b754e988e2b7aa8fd2e078203b89302d48"
S = "${WORKDIR}/git"
