...
# matches with: https://github.com/ros2-gbp/heaphook-release/archive/release/rolling/heaphook/0.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/heaphook"
SRC_URI = "git://github.com/ros2-gbp/heaphook-release;${ROS_BRANCH};protocol=https"
SRCREV = "e7d080b75343bc15d3187ced28b793a0e9fa6ef2"
S = "${WORKDIR}/git"
