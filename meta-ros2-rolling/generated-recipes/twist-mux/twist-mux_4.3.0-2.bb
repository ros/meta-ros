...
# matches with: https://github.com/ros2-gbp/twist_mux-release/archive/release/rolling/twist_mux/4.3.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/twist_mux"
SRC_URI = "git://github.com/ros2-gbp/twist_mux-release;${ROS_BRANCH};protocol=https"
SRCREV = "87f98d24c9376887efec3fc2767e307804831d1e"
S = "${WORKDIR}/git"
