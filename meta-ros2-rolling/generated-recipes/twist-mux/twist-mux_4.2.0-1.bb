...
# matches with: https://github.com/ros2-gbp/twist_mux-release/archive/release/rolling/twist_mux/4.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/twist_mux"
SRC_URI = "git://github.com/ros2-gbp/twist_mux-release;${ROS_BRANCH};protocol=https"
SRCREV = "0867be34a8b3ad61ec7fa79f46046c75a93b4c61"
S = "${WORKDIR}/git"
