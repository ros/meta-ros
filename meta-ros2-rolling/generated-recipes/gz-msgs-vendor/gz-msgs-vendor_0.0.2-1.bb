...
DESCRIPTION = "Vendor package for: gz-msgs10 10.1.2      Gazebo Messages: Protobuf messages and functions for robot applications"
...
# matches with: https://github.com/ros2-gbp/gz_msgs_vendor-release/archive/release/rolling/gz_msgs_vendor/0.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/gz_msgs_vendor"
SRC_URI = "git://github.com/ros2-gbp/gz_msgs_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "2687702b61eaff44e74ba0cc561bda41670791cd"
S = "${WORKDIR}/git"
