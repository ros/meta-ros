...
# matches with: https://github.com/introlab/rtabmap_ros-release/archive/release/rolling/rtabmap_viz/0.22.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rtabmap_viz"
SRC_URI = "git://github.com/introlab/rtabmap_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "f2c6329e7e09ef2e1893958386f4a9bca885605b"
S = "${WORKDIR}/git"
