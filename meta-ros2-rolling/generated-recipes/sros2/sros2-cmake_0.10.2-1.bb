...
# matches with: https://github.com/ros2-gbp/sros2-release/archive/release/rolling/sros2_cmake/0.10.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/sros2_cmake"
SRC_URI = "git://github.com/ros2-gbp/sros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "f1a61eeac46b32493b82df16e1a0676569df2a92"
S = "${WORKDIR}/git"
