...
# matches with: https://github.com/robotis-ros2-release/hls_lfcd_lds_driver-release/archive/release/rolling/hls_lfcd_lds_driver/2.0.4-1.tar.gz
...
SRCREV = "03b8eacfa1f6a3088fbc5897145db727555b1ed9"
S = "${WORKDIR}/git"
