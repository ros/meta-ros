...
# matches with: https://github.com/ros2-gbp/rqt_image_view-release/archive/release/rolling/rqt_image_view/1.0.4-2.tar.gz
...
SRCREV = "fade0eb6145252ca9a8cd8376dfcad647141981a"
S = "${WORKDIR}/git"
