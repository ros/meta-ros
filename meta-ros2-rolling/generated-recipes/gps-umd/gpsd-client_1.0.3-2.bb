...
# matches with: https://github.com/ros2-gbp/gps_umd-release/archive/release/rolling/gpsd_client/1.0.3-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/gpsd_client"
SRC_URI = "git://github.com/ros2-gbp/gps_umd-release;${ROS_BRANCH};protocol=https"
SRCREV = "728173f142216a4d650c12af21763f4e41833cff"
S = "${WORKDIR}/git"
