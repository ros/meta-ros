...
# matches with: https://github.com/ros2-gbp/gps_umd-release/archive/release/rolling/gpsd_client/1.0.4-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/gpsd_client"
SRC_URI = "git://github.com/ros2-gbp/gps_umd-release;${ROS_BRANCH};protocol=https"
SRCREV = "88a72f95d12e1d932d5771171158b0de384de236"
S = "${WORKDIR}/git"
