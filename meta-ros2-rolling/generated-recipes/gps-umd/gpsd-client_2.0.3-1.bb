...
# matches with: https://github.com/ros2-gbp/gps_umd-release/archive/release/rolling/gpsd_client/2.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/gpsd_client"
SRC_URI = "git://github.com/ros2-gbp/gps_umd-release;${ROS_BRANCH};protocol=https"
SRCREV = "b9ca72b10ead41d02c837e5581d305133014b0bd"
S = "${WORKDIR}/git"
