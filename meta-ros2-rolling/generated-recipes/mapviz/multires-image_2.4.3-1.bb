...
# matches with: https://github.com/ros2-gbp/mapviz-release/archive/release/rolling/multires_image/2.4.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/multires_image"
SRC_URI = "git://github.com/ros2-gbp/mapviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "e0614f4cde3b32425acd04442cafd0cd09e13e14"
S = "${WORKDIR}/git"
