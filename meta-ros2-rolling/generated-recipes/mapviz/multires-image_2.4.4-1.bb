...
# matches with: https://github.com/ros2-gbp/mapviz-release/archive/release/rolling/multires_image/2.4.4-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/multires_image"
SRC_URI = "git://github.com/ros2-gbp/mapviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "2e95dc68b3c306af3e27bb9dc347e14fada02a4c"
S = "${WORKDIR}/git"
