...
# matches with: https://github.com/ros2-gbp/ros_testing-release/archive/release/rolling/ros2test/0.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2test"
SRC_URI = "git://github.com/ros2-gbp/ros_testing-release;${ROS_BRANCH};protocol=https"
SRCREV = "e64d728b7226755ac02f494aa7ad34156bd6a472"
S = "${WORKDIR}/git"
