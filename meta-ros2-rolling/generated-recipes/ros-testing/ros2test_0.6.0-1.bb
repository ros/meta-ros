...
# matches with: https://github.com/ros2-gbp/ros_testing-release/archive/release/rolling/ros2test/0.6.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2test"
SRC_URI = "git://github.com/ros2-gbp/ros_testing-release;${ROS_BRANCH};protocol=https"
SRCREV = "8af026ec9945c6e119892d7d5d69b302f7bbea4e"
S = "${WORKDIR}/git"
