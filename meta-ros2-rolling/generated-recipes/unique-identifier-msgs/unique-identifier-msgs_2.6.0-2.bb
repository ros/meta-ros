...
# matches with: https://github.com/ros2-gbp/unique_identifier_msgs-release/archive/release/rolling/unique_identifier_msgs/2.6.0-2.tar.gz
...
SRCREV = "bf5085570ca89cc8bef9dab0b62b4aa2e0e9206e"
S = "${WORKDIR}/git"
