...
# matches with: https://github.com/ros2-gbp/rmf_task-release/archive/release/rolling/rmf_task/0.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rmf_task"
SRC_URI = "git://github.com/ros2-gbp/rmf_task-release;${ROS_BRANCH};protocol=https"
SRCREV = "5135fa38488901cdc35f804c8af174d7e408a467"
S = "${WORKDIR}/git"
