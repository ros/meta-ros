...
# matches with: https://github.com/ros2-gbp/rmf_task-release/archive/release/rolling/rmf_task/2.3.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rmf_task"
SRC_URI = "git://github.com/ros2-gbp/rmf_task-release;${ROS_BRANCH};protocol=https"
SRCREV = "1d8817e1147c114d095586840ffa02036acc28df"
S = "${WORKDIR}/git"
