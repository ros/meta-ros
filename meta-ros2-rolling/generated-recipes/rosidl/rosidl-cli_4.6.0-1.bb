...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_cli/4.6.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosidl_cli"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "9e0bcdcf1701ae5f018b9a8c94e30f093fdfff0f"
S = "${WORKDIR}/git"
