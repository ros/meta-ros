...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_parser/4.6.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "e226bdfdc299ea36cd3fb5aa3610dac07e5fa378"
S = "${WORKDIR}/git"
