...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_adapter/2.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosidl_adapter"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "d3a68f034b3e387f138ceda35ae7d491d5f43df4"
S = "${WORKDIR}/git"
