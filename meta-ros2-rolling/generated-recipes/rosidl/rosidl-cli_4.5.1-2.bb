...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_cli/4.5.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosidl_cli"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "28a553026191f7b987872161666c3fd0379cb8a2"
S = "${WORKDIR}/git"
