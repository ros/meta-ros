...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_parser/2.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "69830912a1b0edd2db0b9c7cbf24200a2123799a"
S = "${WORKDIR}/git"
