...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_cli/4.8.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosidl_cli"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "53b8898b7e5cfc687fa82dfb2f0d3e89d39340da"
S = "${WORKDIR}/git"
