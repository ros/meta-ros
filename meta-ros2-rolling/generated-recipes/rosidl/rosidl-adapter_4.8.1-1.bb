...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_adapter/4.8.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosidl_adapter"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "af4b8d01d7b62ded8040ff8afae03002315bbb8d"
S = "${WORKDIR}/git"
