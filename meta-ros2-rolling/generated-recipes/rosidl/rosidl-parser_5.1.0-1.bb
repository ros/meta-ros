...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_parser/5.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "f3b6c3a09baa42feb55d93b603ba00652fac688c"
S = "${WORKDIR}/git"
