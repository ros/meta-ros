...
# matches with: https://github.com/ros2-gbp/ffmpeg_image_transport_tools-release/archive/release/rolling/ffmpeg_image_transport_tools/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ffmpeg_image_transport_tools"
SRC_URI = "git://github.com/ros2-gbp/ffmpeg_image_transport_tools-release;${ROS_BRANCH};protocol=https"
SRCREV = "0021750e933b8f85692fa45416cfc676eabd2ed5"
S = "${WORKDIR}/git"
