...
# matches with: https://github.com/ros2-gbp/astuff_sensor_msgs-release/archive/release/rolling/mobileye_560_660_msgs/4.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mobileye_560_660_msgs"
SRC_URI = "git://github.com/ros2-gbp/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "59798e15c2258f70dd4c21841b821673ad6a47b2"
S = "${WORKDIR}/git"
