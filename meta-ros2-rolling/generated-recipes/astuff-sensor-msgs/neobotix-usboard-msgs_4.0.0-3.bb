...
# matches with: https://github.com/ros2-gbp/astuff_sensor_msgs-release/archive/release/rolling/neobotix_usboard_msgs/4.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/neobotix_usboard_msgs"
SRC_URI = "git://github.com/ros2-gbp/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "39b4ec73f149d9254a982127089acfd10e742001"
S = "${WORKDIR}/git"
