...
# matches with: https://github.com/ros2-gbp/astuff_sensor_msgs-release/archive/release/rolling/ibeo_msgs/4.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ibeo_msgs"
SRC_URI = "git://github.com/ros2-gbp/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "7b2b41c497c5067996da1c998296fa859ebb05f2"
S = "${WORKDIR}/git"
