...
# matches with: https://github.com/vooon/ntpd_driver-release/archive/release/rolling/ntpd_driver/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ntpd_driver"
SRC_URI = "git://github.com/vooon/ntpd_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "7cfeb0f32e68ec453cd167a473225bf8bd785d11"
S = "${WORKDIR}/git"
