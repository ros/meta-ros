...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_bullet/0.36.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_bullet"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "87bbacf0ba074b03bdb231a35f9ff2d52143b24b"
S = "${WORKDIR}/git"
