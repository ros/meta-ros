...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/geometry2/0.37.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/geometry2"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "9135d7bd7ac7556951eb95a0427716639e648fb5"
S = "${WORKDIR}/git"
