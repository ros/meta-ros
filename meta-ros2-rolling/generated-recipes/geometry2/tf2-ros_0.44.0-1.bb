...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_ros/0.44.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_ros"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "be8ffb0a0102adbac3db3993701299a46fc58a83"
S = "${WORKDIR}/git"
