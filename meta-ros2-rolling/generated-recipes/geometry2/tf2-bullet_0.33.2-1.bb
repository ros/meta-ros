...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_bullet/0.33.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_bullet"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "1258ca890e5f6129080636ba3b942c7b13ab89ab"
S = "${WORKDIR}/git"
