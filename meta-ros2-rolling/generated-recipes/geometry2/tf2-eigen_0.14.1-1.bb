...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_eigen/0.14.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_eigen"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "695379b3e1f37170baf27caa8eea07fde93c210c"
S = "${WORKDIR}/git"
