...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_ros/0.33.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_ros"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "1eae637a3005f6429508393503c73902451b06f1"
S = "${WORKDIR}/git"
