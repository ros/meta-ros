...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_py/0.45.6-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_py"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "822dcb003b7488be24d4d257073d8bbae2cdfaf8"
S = "${WORKDIR}/git"
