...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_kdl/0.38.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_kdl"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8d26d45e4dc42bbd63f6131e87bf155be983bbf3"
S = "${WORKDIR}/git"
