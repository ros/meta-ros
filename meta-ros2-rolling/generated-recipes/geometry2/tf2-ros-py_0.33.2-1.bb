...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_ros_py/0.33.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_ros_py"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8efa0e0dd11dfaed221de87add7fd5fcc2e273c8"
S = "${WORKDIR}/git"
