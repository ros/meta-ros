...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_kdl/0.18.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_kdl"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "02a1857c4087636e1b0cf14baf789c6530890b97"
S = "${WORKDIR}/git"
