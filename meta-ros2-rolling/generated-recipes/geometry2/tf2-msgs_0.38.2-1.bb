...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_msgs/0.38.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_msgs"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "f0a62d46309e2f380187ede79465c5a3d1d641be"
S = "${WORKDIR}/git"
