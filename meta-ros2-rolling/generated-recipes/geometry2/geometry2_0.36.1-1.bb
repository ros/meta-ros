...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/geometry2/0.36.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/geometry2"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "7093bb00dd9e506a8eb8b000faf4ab748384b31f"
S = "${WORKDIR}/git"
