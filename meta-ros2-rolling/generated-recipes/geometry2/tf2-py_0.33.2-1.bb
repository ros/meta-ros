...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_py/0.33.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_py"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "ef6fea9fb1e089abc5c592a5a2382b688fa3fbda"
S = "${WORKDIR}/git"
