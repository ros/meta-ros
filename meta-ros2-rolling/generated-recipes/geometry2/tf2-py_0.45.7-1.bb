...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_py/0.45.7-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_py"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "fae13e352713ffd8800f077be273266382ee0632"
S = "${WORKDIR}/git"
