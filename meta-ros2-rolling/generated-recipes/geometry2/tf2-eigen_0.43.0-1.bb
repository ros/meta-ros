...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_eigen/0.43.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_eigen"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a9cf9827f21b7f204c88d5a9bcf104ac21b5ada2"
S = "${WORKDIR}/git"
