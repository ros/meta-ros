...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_msgs/0.18.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_msgs"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d5af516ed4a93efae6db0a798b2acee759f44fb0"
S = "${WORKDIR}/git"
