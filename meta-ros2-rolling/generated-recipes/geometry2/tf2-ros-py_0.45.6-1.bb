...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_ros_py/0.45.6-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_ros_py"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "679c59a506dd08cde28c3996367a2d80be281514"
S = "${WORKDIR}/git"
