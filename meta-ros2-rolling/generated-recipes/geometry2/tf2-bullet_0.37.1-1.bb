...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_bullet/0.37.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_bullet"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "37b2e2a7c539e1736642a71d312f695c837cc45f"
S = "${WORKDIR}/git"
