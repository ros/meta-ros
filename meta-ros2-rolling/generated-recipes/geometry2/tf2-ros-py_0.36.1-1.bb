...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_ros_py/0.36.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_ros_py"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5fb6606972690f3d8a8a97fa3b4bfb11a4703f35"
S = "${WORKDIR}/git"
