...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_ros/0.36.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_ros"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "4542f5b946509246de4db4bf4c5a05a41d34ba40"
S = "${WORKDIR}/git"
