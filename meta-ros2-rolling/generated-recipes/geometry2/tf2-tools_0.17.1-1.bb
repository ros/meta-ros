...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_tools/0.17.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "06bb1fd264bd64e8aef33d1ab32cdea65087c5bd"
S = "${WORKDIR}/git"
