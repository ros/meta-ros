...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_bullet/0.38.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_bullet"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "c6ddf880bff4f7ca9e8a9132fb0dd350f554202f"
S = "${WORKDIR}/git"
