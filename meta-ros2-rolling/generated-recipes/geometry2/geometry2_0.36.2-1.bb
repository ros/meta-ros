...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/geometry2/0.36.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/geometry2"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "57561ab02356519f8443cd12f7c0eb2b951358ba"
S = "${WORKDIR}/git"
