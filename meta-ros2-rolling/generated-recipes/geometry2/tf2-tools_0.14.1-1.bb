...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_tools/0.14.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "0c0b3e9da8850c101d57440e348fd1fa3defb562"
S = "${WORKDIR}/git"
