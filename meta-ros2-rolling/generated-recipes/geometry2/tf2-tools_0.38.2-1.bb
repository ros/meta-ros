...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_tools/0.38.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "aef821033946b1d2c3b0adda75b07e2a358a2909"
S = "${WORKDIR}/git"
