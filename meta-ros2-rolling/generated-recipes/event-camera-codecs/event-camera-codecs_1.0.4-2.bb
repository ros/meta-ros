...
# matches with: https://github.com/ros2-gbp/event_camera_codecs-release/archive/release/rolling/event_camera_codecs/1.0.4-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/event_camera_codecs"
SRC_URI = "git://github.com/ros2-gbp/event_camera_codecs-release;${ROS_BRANCH};protocol=https"
SRCREV = "ed0e5f6773c46bfd27681cd2ea0ee6005329edd7"
S = "${WORKDIR}/git"
