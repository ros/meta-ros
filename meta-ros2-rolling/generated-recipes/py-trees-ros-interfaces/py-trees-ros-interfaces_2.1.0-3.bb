...
# matches with: https://github.com/ros2-gbp/py_trees_ros_interfaces-release/archive/release/rolling/py_trees_ros_interfaces/2.1.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/py_trees_ros_interfaces"
SRC_URI = "git://github.com/ros2-gbp/py_trees_ros_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "6bd6a582945f5c8bbfe8e1a07ecee856a35d0835"
S = "${WORKDIR}/git"
