...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/rolling/examples_rclcpp_minimal_action_server/0.20.2-1.tar.gz
...
SRCREV = "652694d26f51cd4a01662f2a2110caf52a89c938"
S = "${WORKDIR}/git"
