...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/rolling/examples_rclpy_minimal_action_client/0.20.2-1.tar.gz
...
SRCREV = "b4d95326ec92b9e11dafb6109eabd60f6988a908"
S = "${WORKDIR}/git"
