...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/rolling/examples_rclpy_minimal_action_client/0.19.3-1.tar.gz
...
SRCREV = "554933215a8dec76f98e4d939d672d4a932ed870"
S = "${WORKDIR}/git"
