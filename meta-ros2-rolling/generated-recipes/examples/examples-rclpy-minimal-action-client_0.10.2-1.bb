...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/rolling/examples_rclpy_minimal_action_client/0.10.2-1.tar.gz
...
SRCREV = "ebeb590836fca1e1d5f87093cf10116213e90a22"
S = "${WORKDIR}/git"
