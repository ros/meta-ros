...
# matches with: https://github.com/ros2-gbp/zbar_ros-release/archive/release/rolling/zbar_ros/0.4.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/zbar_ros"
SRC_URI = "git://github.com/ros2-gbp/zbar_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "776eabd122317b6e24a59b0c9830119a44c4112f"
S = "${WORKDIR}/git"
