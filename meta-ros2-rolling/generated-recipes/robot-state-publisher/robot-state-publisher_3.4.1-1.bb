...
# matches with: https://github.com/ros2-gbp/robot_state_publisher-release/archive/release/rolling/robot_state_publisher/3.4.1-1.tar.gz
...
SRCREV = "ec77148a420bc7ebc6727077436a2feb6b7aadc0"
S = "${WORKDIR}/git"
