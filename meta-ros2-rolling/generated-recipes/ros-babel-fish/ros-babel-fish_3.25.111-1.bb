...
# matches with: https://github.com/ros2-gbp/ros_babel_fish-release/archive/release/rolling/ros_babel_fish/3.25.111-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros_babel_fish"
SRC_URI = "git://github.com/ros2-gbp/ros_babel_fish-release;${ROS_BRANCH};protocol=https"
SRCREV = "e347a4c17d761b4bbfa859bf207d3b042798ad5a"
S = "${WORKDIR}/git"
