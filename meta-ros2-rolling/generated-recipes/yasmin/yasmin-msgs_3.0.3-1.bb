...
# matches with: https://github.com/ros2-gbp/yasmin-release/archive/release/rolling/yasmin_msgs/3.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/yasmin_msgs"
SRC_URI = "git://github.com/ros2-gbp/yasmin-release;${ROS_BRANCH};protocol=https"
SRCREV = "e22b0d0d0c7efcca6ed35a16589dabc7375c4723"
S = "${WORKDIR}/git"
