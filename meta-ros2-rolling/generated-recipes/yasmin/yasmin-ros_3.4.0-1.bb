...
# matches with: https://github.com/ros2-gbp/yasmin-release/archive/release/rolling/yasmin_ros/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/yasmin_ros"
SRC_URI = "git://github.com/ros2-gbp/yasmin-release;${ROS_BRANCH};protocol=https"
SRCREV = "40ea07ef72889f9e8372f1e8e1a0ca73250734c5"
S = "${WORKDIR}/git"
