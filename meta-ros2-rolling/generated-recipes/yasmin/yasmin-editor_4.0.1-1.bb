...
# matches with: https://github.com/ros2-gbp/yasmin-release/archive/release/rolling/yasmin_editor/4.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/yasmin_editor"
SRC_URI = "git://github.com/ros2-gbp/yasmin-release;${ROS_BRANCH};protocol=https"
SRCREV = "abde8adfc319c4e0b6a610091ae0f2a29034f2fc"
S = "${WORKDIR}/git"
