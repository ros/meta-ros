...
# matches with: https://github.com/ros2-gbp/marti_common-release/archive/release/rolling/swri_cli_tools/3.6.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/swri_cli_tools"
SRC_URI = "git://github.com/ros2-gbp/marti_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "6e2440ffc1ed9e04928bd65a79ff68bb2e5df934"
S = "${WORKDIR}/git"
