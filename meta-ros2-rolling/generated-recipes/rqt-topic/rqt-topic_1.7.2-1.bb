...
# matches with: https://github.com/ros2-gbp/rqt_topic-release/archive/release/rolling/rqt_topic/1.7.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_topic"
SRC_URI = "git://github.com/ros2-gbp/rqt_topic-release;${ROS_BRANCH};protocol=https"
SRCREV = "2250b520e583c74492599ce0d20becfe17fe0c93"
S = "${WORKDIR}/git"
