...
# matches with: https://github.com/ros2-gbp/rqt_topic-release/archive/release/rolling/rqt_topic/1.7.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_topic"
SRC_URI = "git://github.com/ros2-gbp/rqt_topic-release;${ROS_BRANCH};protocol=https"
SRCREV = "f4dc23f380944dadff6acc849f8f5fff6ef1b0a8"
S = "${WORKDIR}/git"
