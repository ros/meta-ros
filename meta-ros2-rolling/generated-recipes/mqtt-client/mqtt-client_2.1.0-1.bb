...
# matches with: https://github.com/ika-rwth-aachen/mqtt_client-release/archive/release/rolling/mqtt_client/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mqtt_client"
SRC_URI = "git://github.com/ika-rwth-aachen/mqtt_client-release;${ROS_BRANCH};protocol=https"
SRCREV = "a4341e60c831fde8e2f721ce52dbf3a0a7703aa5"
S = "${WORKDIR}/git"
