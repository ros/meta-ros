...
# matches with: https://github.com/moveit/moveit2-release/archive/release/rolling/moveit_plugins/2.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_plugins"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "2a43eb3e2b6b429e24daf14b9edd59599186f9a9"
S = "${WORKDIR}/git"
