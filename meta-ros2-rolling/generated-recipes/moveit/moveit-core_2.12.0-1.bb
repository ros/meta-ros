...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_core/2.12.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_core"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "69330fc131cb6446f4da0999104c0f71f0e04c28"
S = "${WORKDIR}/git"
