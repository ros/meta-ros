...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_common/2.11.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b1ffb678975e6d1b97c6dea75f3cd26a26b1592e"
S = "${WORKDIR}/git"
