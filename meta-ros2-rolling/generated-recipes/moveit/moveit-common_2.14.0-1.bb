...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_common/2.14.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "f8a046d91112d04bd64f54c77c97e09ada95f57f"
S = "${WORKDIR}/git"
