...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_servo/2.8.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_servo"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5b5b5294c3ef2de297a889ec9d8411074c83a345"
S = "${WORKDIR}/git"
