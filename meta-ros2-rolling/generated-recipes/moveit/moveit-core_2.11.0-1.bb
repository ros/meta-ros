...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_core/2.11.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_core"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "f5a91d3f79fa363e7b041433e3e0fcb306a4c780"
S = "${WORKDIR}/git"
