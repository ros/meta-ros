...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros/2.8.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_ros"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "05c4a472f08486e6ed97a5e84f080f30a852d5a9"
S = "${WORKDIR}/git"
