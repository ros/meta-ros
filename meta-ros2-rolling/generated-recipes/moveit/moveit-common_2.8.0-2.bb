...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_common/2.8.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "34ecc3d2408eeeb15fd26bc114521e3bcbbb8cf9"
S = "${WORKDIR}/git"
