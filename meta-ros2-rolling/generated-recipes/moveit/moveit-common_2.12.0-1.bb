...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_common/2.12.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "29ac43a17b02062e0984820acfbd3bdc0f6c8025"
S = "${WORKDIR}/git"
