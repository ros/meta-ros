...
# matches with: https://github.com/moveit/moveit2-release/archive/release/rolling/run_moveit_cpp/2.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/run_moveit_cpp"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "76e53f093a4d0370d8b4a4ee4c2eb23161bcf835"
S = "${WORKDIR}/git"
