...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_servo/2.12.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_servo"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "cb5d78bead22cf1179f4a023a93a2ac1b6961e28"
S = "${WORKDIR}/git"
