...
# matches with: https://github.com/moveit/moveit2-release/archive/release/rolling/moveit_servo/2.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_servo"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5e79d28bd3515c53f1730342162058624845435c"
S = "${WORKDIR}/git"
