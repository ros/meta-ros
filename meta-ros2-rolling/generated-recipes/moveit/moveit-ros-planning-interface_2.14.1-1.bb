...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros_planning_interface/2.14.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_ros_planning_interface"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "fac6cca6524f81a5071aada8ece98fb8a13498ef"
S = "${WORKDIR}/git"
