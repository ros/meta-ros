...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros_warehouse/2.13.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_ros_warehouse"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b731ecdc36fbe8bacd35ac78061c0d6b448dcaea"
S = "${WORKDIR}/git"
