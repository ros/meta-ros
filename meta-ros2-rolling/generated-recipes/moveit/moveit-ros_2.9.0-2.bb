...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros/2.9.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_ros"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "38774242a58cbe4b61b5b219153f6fe44cd1f58f"
S = "${WORKDIR}/git"
