...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros_tests/2.14.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_ros_tests"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "477a8c71b37038d31de38137b5fca083f30ff2da"
S = "${WORKDIR}/git"
