...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros/2.11.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_ros"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d8dec5fc61afd7dae561b5faf139ecb9441b5e1d"
S = "${WORKDIR}/git"
