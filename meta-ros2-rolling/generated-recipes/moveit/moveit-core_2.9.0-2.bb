...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_core/2.9.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_core"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "87683edfb9145f7de96548991802f8c6ce0fe771"
S = "${WORKDIR}/git"
