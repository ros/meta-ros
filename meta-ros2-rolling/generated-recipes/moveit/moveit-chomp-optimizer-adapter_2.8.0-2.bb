...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_chomp_optimizer_adapter/2.8.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_chomp_optimizer_adapter"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "85538684989143bcc424a2eb82eec3231122ce75"
S = "${WORKDIR}/git"
