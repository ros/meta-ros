...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros/2.14.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_ros"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "7614e546bb6acc57db51df5876868b6c88478aeb"
S = "${WORKDIR}/git"
