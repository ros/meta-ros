...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_servo/2.11.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_servo"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "ab458985e678dec1fbef2287ce0411613c6e35a6"
S = "${WORKDIR}/git"
