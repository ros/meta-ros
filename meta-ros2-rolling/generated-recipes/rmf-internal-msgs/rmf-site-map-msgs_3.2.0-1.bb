...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/rolling/rmf_site_map_msgs/3.2.0-1.tar.gz
...
SRCREV = "9091a3f53f55e90b8fab8a5b54429376bbc52f24"
S = "${WORKDIR}/git"
