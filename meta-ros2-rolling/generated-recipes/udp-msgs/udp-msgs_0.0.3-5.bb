...
# matches with: https://github.com/ros2-gbp/udp_msgs-release/archive/release/rolling/udp_msgs/0.0.3-5.tar.gz
ROS_BRANCH ?= "branch=release/rolling/udp_msgs"
SRC_URI = "git://github.com/ros2-gbp/udp_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "7c7e404bfda0eab01ac061df09cc4753cc09fbe1"
S = "${WORKDIR}/git"
