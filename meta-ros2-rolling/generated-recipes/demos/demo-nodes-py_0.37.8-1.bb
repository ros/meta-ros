...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/demo_nodes_py/0.37.8-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/demo_nodes_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "a0bdcdc872eea554c49cf6c4074d63164c617d9a"
S = "${WORKDIR}/git"
