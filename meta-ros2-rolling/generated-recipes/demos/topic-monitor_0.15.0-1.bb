...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/topic_monitor/0.15.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/topic_monitor"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "64191d8d5f05cdb95bf49cb555d3d532c385b355"
S = "${WORKDIR}/git"
