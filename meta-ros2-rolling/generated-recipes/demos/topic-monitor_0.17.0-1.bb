...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/topic_monitor/0.17.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/topic_monitor"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "1f7edbd1005a2ae72323667003140359f955d076"
S = "${WORKDIR}/git"
