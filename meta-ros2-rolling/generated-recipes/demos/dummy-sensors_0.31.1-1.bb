...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/dummy_sensors/0.31.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/dummy_sensors"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "a6b92b624cb611123d8772b3b8dbbfb7bd46b52d"
S = "${WORKDIR}/git"
