...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/lifecycle_py/0.33.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lifecycle_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "eb94ebb48d1196bc8a655f064802d1f657961e6a"
S = "${WORKDIR}/git"
