...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/demo_nodes_cpp/0.33.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/demo_nodes_cpp"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "820b3b5c46d4a542963183d1bd3f7aa83e91ff48"
S = "${WORKDIR}/git"
