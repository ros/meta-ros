...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/composition/0.33.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/composition"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "c27409e1fffa4ab2f5efcdccc2a603e5970c1de2"
S = "${WORKDIR}/git"
