...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/lifecycle_py/0.31.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lifecycle_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "a120c8227f42d2500f4f9c2f0e893f92db290bbb"
S = "${WORKDIR}/git"
