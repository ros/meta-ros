...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/topic_monitor/0.10.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/topic_monitor"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "b97815e2413a3656ea0adf29b42da50e73568e7e"
S = "${WORKDIR}/git"
