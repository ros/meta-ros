...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/demo_nodes_py/0.37.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/demo_nodes_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "354dbde3032ac5a539034a1bfcb6fb254bc15c6e"
S = "${WORKDIR}/git"
