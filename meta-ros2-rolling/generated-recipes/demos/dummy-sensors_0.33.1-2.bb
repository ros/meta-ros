...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/dummy_sensors/0.33.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/dummy_sensors"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "f47e18330d0f9265b569f7d8d93107f3891fb552"
S = "${WORKDIR}/git"
