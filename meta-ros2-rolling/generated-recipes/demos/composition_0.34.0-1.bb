...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/composition/0.34.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/composition"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "fd521a1d6faae58312832924061a5a76983adf6d"
S = "${WORKDIR}/git"
