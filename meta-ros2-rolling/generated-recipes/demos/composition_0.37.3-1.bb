...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/composition/0.37.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/composition"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "61d8dbf047797471523df5753d6e28d8432229f4"
S = "${WORKDIR}/git"
