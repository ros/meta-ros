...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/rolling/gazebo_ros_pkgs/3.5.2-3.tar.gz
...
SRCREV = "e2e0d5435b77182160f89655fb1769f367751ed5"
S = "${WORKDIR}/git"
