...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/rolling/gazebo_dev/3.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/gazebo_dev"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "44cca9e4a02c0c2bb969598d3631f9d46cb4a96a"
S = "${WORKDIR}/git"
