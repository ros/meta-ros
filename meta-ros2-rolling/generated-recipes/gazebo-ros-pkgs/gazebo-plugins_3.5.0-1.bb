...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/rolling/gazebo_plugins/3.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/gazebo_plugins"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "d46be4b28dedfec6ef0bd15e7bd167efec239a63"
S = "${WORKDIR}/git"
