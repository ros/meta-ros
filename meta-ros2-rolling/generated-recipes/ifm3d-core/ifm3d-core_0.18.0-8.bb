...
# matches with: https://github.com/ros2-gbp/ifm3d-release/archive/release/rolling/ifm3d_core/0.18.0-8.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ifm3d_core"
SRC_URI = "git://github.com/ros2-gbp/ifm3d-release;${ROS_BRANCH};protocol=https"
SRCREV = "f8d518fe37f4de14aa50d95f2961c05d7b87af92"
S = "${WORKDIR}/git"
