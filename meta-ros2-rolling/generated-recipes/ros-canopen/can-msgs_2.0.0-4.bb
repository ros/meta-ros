...
# matches with: https://github.com/ros2-gbp/ros_canopen-release/archive/release/rolling/can_msgs/2.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/can_msgs"
SRC_URI = "git://github.com/ros2-gbp/ros_canopen-release;${ROS_BRANCH};protocol=https"
SRCREV = "f83ea3e78c7c39f6674656565e02e1d1228e400c"
S = "${WORKDIR}/git"
