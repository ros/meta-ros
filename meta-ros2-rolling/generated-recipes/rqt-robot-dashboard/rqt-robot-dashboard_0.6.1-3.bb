...
# matches with: https://github.com/ros2-gbp/rqt_robot_dashboard-release/archive/release/rolling/rqt_robot_dashboard/0.6.1-3.tar.gz
...
SRCREV = "f63de1ae2cb1e087db2e0376e1ea24aac8f5609e"
S = "${WORKDIR}/git"
