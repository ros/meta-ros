...
# matches with: https://github.com/ros2-gbp/locator_ros_bridge-release/archive/release/rolling/bosch_locator_bridge/2.1.1-1.tar.gz
...
SRCREV = "0be50f64994b66ea32e6689f7193b9afa13be7d7"
S = "${WORKDIR}/git"
