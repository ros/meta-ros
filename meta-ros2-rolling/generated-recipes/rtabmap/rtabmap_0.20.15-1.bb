...
# matches with: https://github.com/introlab/rtabmap-release/archive/release/rolling/rtabmap/0.20.15-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rtabmap"
SRC_URI = "git://github.com/introlab/rtabmap-release;${ROS_BRANCH};protocol=https"
SRCREV = "b2dbd9c2629212bd920e6db2ee9ff5cf576609bf"
S = "${WORKDIR}/git"
