...
# matches with: https://github.com/ros2-gbp/performance_test_fixture-release/archive/release/rolling/performance_test_fixture/0.0.7-1.tar.gz
...
SRCREV = "676e9b14df1d5ab7d0d93be515540bca7a58be60"
S = "${WORKDIR}/git"
