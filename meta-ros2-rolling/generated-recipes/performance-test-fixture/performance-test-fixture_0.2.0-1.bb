...
# matches with: https://github.com/ros2-gbp/performance_test_fixture-release/archive/release/rolling/performance_test_fixture/0.2.0-1.tar.gz
...
SRCREV = "79dfe702acae22a3a7ae343b70facf4a79a8e1dc"
S = "${WORKDIR}/git"
