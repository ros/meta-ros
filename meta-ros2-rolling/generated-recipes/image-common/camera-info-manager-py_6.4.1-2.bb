...
# matches with: https://github.com/ros2-gbp/image_common-release/archive/release/rolling/camera_info_manager_py/6.4.1-2.tar.gz
...
SRCREV = "b7d4d7dd4c6411dbcf36739a84b5e08a6667cee0"
S = "${WORKDIR}/git"
