...
# matches with: https://github.com/ros2-gbp/apriltag_ros-release/archive/release/rolling/apriltag_ros/3.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/apriltag_ros"
SRC_URI = "git://github.com/ros2-gbp/apriltag_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "de4b420c4311d350268c7e03a850accf7e164218"
S = "${WORKDIR}/git"
