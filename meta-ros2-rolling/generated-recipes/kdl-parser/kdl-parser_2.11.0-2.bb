...
# matches with: https://github.com/ros2-gbp/kdl_parser-release/archive/release/rolling/kdl_parser/2.11.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/kdl_parser"
SRC_URI = "git://github.com/ros2-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "99afafc7d74ce4ac5c59a1792984b1efe078c892"
S = "${WORKDIR}/git"
