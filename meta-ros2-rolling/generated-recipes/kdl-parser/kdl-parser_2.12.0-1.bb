...
# matches with: https://github.com/ros2-gbp/kdl_parser-release/archive/release/rolling/kdl_parser/2.12.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/kdl_parser"
SRC_URI = "git://github.com/ros2-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "597777768cc8df0a0d9366eb01b21ddecff2d043"
S = "${WORKDIR}/git"
