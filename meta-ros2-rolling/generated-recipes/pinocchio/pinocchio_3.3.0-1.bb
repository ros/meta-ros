...
# matches with: https://github.com/ros2-gbp/pinocchio-release/archive/release/rolling/pinocchio/3.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/pinocchio"
SRC_URI = "git://github.com/ros2-gbp/pinocchio-release;${ROS_BRANCH};protocol=https"
SRCREV = "e1c27ef6091aaf52da0a7688443448ac221dfe1a"
S = "${WORKDIR}/git"
