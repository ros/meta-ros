...
# matches with: https://github.com/ros2-gbp/pinocchio-release/archive/release/rolling/pinocchio/2.6.17-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/pinocchio"
SRC_URI = "git://github.com/ros2-gbp/pinocchio-release;${ROS_BRANCH};protocol=https"
SRCREV = "ae82b8e3cfb79e302532d100ac14adfdc55a51e6"
S = "${WORKDIR}/git"
