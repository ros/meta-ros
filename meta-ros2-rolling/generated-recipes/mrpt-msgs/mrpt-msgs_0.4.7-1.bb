...
# matches with: https://github.com/ros2-gbp/mrpt_msgs-release/archive/release/rolling/mrpt_msgs/0.4.7-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_msgs"
SRC_URI = "git://github.com/ros2-gbp/mrpt_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "86f51d51985be651bd226bce79df902bbf12df4d"
S = "${WORKDIR}/git"
