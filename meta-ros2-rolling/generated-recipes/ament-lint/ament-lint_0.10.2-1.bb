...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_lint/0.10.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ament_lint"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "b5a7cc4de076d22472dec7c419e73d5f44ef79b6"
S = "${WORKDIR}/git"
