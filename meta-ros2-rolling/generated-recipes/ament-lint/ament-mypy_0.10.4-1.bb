...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_mypy/0.10.4-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ament_mypy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "f7b23b96df69d28a8db847f758a54538f84085f6"
S = "${WORKDIR}/git"
