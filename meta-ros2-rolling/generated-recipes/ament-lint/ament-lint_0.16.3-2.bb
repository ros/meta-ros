...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_lint/0.16.3-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ament_lint"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "593547bec15d61dbbc63563e5fcf6e5481044068"
S = "${WORKDIR}/git"
