...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_mypy/0.16.4-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ament_mypy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "4f94152a5200bd1bc5751a036c7a15d6e731bac6"
S = "${WORKDIR}/git"
