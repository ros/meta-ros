...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_mypy/0.17.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ament_mypy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "58e7f004f014787ef2a43de64bff76d0e8ef82e6"
S = "${WORKDIR}/git"
