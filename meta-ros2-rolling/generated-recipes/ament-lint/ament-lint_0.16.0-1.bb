...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_lint/0.16.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ament_lint"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "35756345a20325628ebcf78929e9e5f5df9da1b9"
S = "${WORKDIR}/git"
