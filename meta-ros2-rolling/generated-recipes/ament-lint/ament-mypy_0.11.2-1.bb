...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_mypy/0.11.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ament_mypy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "acd064a3f75eaa9e2d3e1771693ab76e9ef7fce2"
S = "${WORKDIR}/git"
