...
# matches with: https://github.com/ros-gbp/py_binding_tools-release/archive/release/rolling/py_binding_tools/2.0.0-1.tar.gz
...
SRCREV = "f39e90f0ce1edc7a2562c7082f9ae53480de10d7"
S = "${WORKDIR}/git"
