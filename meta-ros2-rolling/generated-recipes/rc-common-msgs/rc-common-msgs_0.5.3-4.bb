...
# matches with: https://github.com/ros2-gbp/rc_common_msgs_ros2-release/archive/release/rolling/rc_common_msgs/0.5.3-4.tar.gz
...
SRCREV = "4792a70da59864a418067bd7428b3b2b0b3dcb22"
S = "${WORKDIR}/git"
