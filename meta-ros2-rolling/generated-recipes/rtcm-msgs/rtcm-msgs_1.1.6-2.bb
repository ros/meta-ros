...
# matches with: https://github.com/ros2-gbp/rtcm_msgs-release/archive/release/rolling/rtcm_msgs/1.1.6-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rtcm_msgs"
SRC_URI = "git://github.com/ros2-gbp/rtcm_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "6254dceb089463497807bd24f81b6659f2846454"
S = "${WORKDIR}/git"
