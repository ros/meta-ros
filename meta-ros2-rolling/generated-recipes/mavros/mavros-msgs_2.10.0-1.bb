...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/rolling/mavros_msgs/2.10.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mavros_msgs"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "eb464504c3385aa58a540377d864b6d97160ece3"
S = "${WORKDIR}/git"
