...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/rolling/libmavconn/2.6.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/libmavconn"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "9e31dd6878ae54ac16cd59e40b79489ec4ebf256"
S = "${WORKDIR}/git"
