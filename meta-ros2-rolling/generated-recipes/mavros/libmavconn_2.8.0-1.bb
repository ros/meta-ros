...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/rolling/libmavconn/2.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/libmavconn"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "b6360985c2e0b1561ea57a3feef7248b04a9d187"
S = "${WORKDIR}/git"
