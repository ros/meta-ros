...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/rolling/libmavconn/2.6.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/libmavconn"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "8ab0bd75920f45addf064abbf431b38eba37625a"
S = "${WORKDIR}/git"
