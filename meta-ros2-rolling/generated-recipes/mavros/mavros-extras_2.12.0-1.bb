...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/rolling/mavros_extras/2.12.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mavros_extras"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "a7d3c26a2acf55b26add11b2d1a3b01dd19531bb"
S = "${WORKDIR}/git"
