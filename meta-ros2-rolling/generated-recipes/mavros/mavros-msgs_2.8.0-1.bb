...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/rolling/mavros_msgs/2.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mavros_msgs"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "98c65be6302c0ca9ffa9d627c43f1a8747119386"
S = "${WORKDIR}/git"
