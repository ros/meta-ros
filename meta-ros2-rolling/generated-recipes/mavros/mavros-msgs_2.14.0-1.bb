...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/rolling/mavros_msgs/2.14.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mavros_msgs"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "5ebdd9ffabaaa64a0050efbeb10d9a919082e6f1"
S = "${WORKDIR}/git"
