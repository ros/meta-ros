...
# matches with: https://github.com/ros2-gbp/rqt_shell-release/archive/release/rolling/rqt_shell/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_shell"
SRC_URI = "git://github.com/ros2-gbp/rqt_shell-release;${ROS_BRANCH};protocol=https"
SRCREV = "b78f190b73a5e2aa250f40df6b2eb9353c671ca6"
S = "${WORKDIR}/git"
