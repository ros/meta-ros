...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_navstate_fuse/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_navstate_fuse"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "10ba5b49afe9da48d79ed8b0e6cf0420a8f0ff27"
S = "${WORKDIR}/git"
