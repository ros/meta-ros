...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_traj_tools/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "b8e538ccaae958d5e1193843ee76f8469cd447d5"
S = "${WORKDIR}/git"
