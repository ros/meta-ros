...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_launcher/2.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_launcher"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "43742e98f2be4b4516793b3518f2f52815c1cc48"
S = "${WORKDIR}/git"
