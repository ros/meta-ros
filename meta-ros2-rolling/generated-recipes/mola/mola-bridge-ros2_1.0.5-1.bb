...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_bridge_ros2/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_bridge_ros2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "0717efe78da7167d81f2073899a9cb4a5142f825"
S = "${WORKDIR}/git"
