...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_traj_tools/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "e4c71d1d39e0b23e41b5a258d4cd1c289972bd3d"
S = "${WORKDIR}/git"
