...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_launcher/0.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_launcher"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "ee1d6435b3a49c8a08bc932539a0cd1e6107ccf0"
S = "${WORKDIR}/git"
