...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_launcher/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_launcher"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "ce3a767b50e2a141cbbdd53f04f49cdde2a443b9"
S = "${WORKDIR}/git"
