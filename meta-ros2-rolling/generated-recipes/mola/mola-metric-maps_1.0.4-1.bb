...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_metric_maps/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_metric_maps"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "69e5b40a0b73d41fba65a41a2b51af476bd04287"
S = "${WORKDIR}/git"
