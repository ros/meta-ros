...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_bridge_ros2/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_bridge_ros2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "bfdd50f4dd8cc260550ea3b60522fe5468e608e2"
S = "${WORKDIR}/git"
