...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_metric_maps/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_metric_maps"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "f1a3d2da35acdee3700c15b471a8a1f9bdc65c9b"
S = "${WORKDIR}/git"
