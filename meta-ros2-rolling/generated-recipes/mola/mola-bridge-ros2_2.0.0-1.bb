...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_bridge_ros2/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_bridge_ros2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "ecff1c3ff17f3d2672a87f0312e075ee873e9d98"
S = "${WORKDIR}/git"
