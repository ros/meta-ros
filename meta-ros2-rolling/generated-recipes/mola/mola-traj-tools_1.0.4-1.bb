...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_traj_tools/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "cab3bbd384e8b36bd0cd0ecc2ebe389048e178ac"
S = "${WORKDIR}/git"
