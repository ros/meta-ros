...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_traj_tools/1.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "885f91ea4603cf2dcff164835afb12f50d726445"
S = "${WORKDIR}/git"
