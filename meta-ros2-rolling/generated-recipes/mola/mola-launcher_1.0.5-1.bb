...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_launcher/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_launcher"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "db13a9fe254d312e16ec8594d2764b0ffdafb16a"
S = "${WORKDIR}/git"
