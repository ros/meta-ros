...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_metric_maps/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_metric_maps"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "ca5615dad7f39b3fad8b7f99e5c326aa89ddeb8e"
S = "${WORKDIR}/git"
