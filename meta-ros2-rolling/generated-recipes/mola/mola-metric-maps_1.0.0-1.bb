...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_metric_maps/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_metric_maps"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "f2fa94fa40f5803954744b28e48a24c116477dbe"
S = "${WORKDIR}/git"
