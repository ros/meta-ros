...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_navstate_fg/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_navstate_fg"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "addc801e768129f69d842ee63fd7fe8a64b17067"
S = "${WORKDIR}/git"
