...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_metric_maps/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mola_metric_maps"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "fa1f723373199b548ff31c2786fc320248479107"
S = "${WORKDIR}/git"
