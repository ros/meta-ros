...
# matches with: https://github.com/ros2-gbp/ros2_canopen-release/archive/release/rolling/canopen/0.2.7-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/canopen"
SRC_URI = "git://github.com/ros2-gbp/ros2_canopen-release;${ROS_BRANCH};protocol=https"
SRCREV = "843750c215eb517aa3ed2be8fdbac15f3c8113e5"
S = "${WORKDIR}/git"
