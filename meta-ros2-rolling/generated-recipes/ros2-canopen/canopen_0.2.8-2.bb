...
# matches with: https://github.com/ros2-gbp/ros2_canopen-release/archive/release/rolling/canopen/0.2.8-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/canopen"
SRC_URI = "git://github.com/ros2-gbp/ros2_canopen-release;${ROS_BRANCH};protocol=https"
SRCREV = "6de700c9eae1f72f15f790cd4b7318e900827e64"
S = "${WORKDIR}/git"
