...
# matches with: https://github.com/ros2-gbp/cyclonedds-release/archive/release/rolling/cyclonedds/0.10.4-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/cyclonedds"
SRC_URI = "git://github.com/ros2-gbp/cyclonedds-release;${ROS_BRANCH};protocol=https"
SRCREV = "3329ed66fe4ab4738735400230d31da9ab92c995"
S = "${WORKDIR}/git"
