...
# matches with: https://github.com/ros2-gbp/cyclonedds-release/archive/release/rolling/cyclonedds/0.8.0-5.tar.gz
ROS_BRANCH ?= "branch=release/rolling/cyclonedds"
SRC_URI = "git://github.com/ros2-gbp/cyclonedds-release;${ROS_BRANCH};protocol=https"
SRCREV = "b6ee83a1ed1359d38ba85dbb17d8d7eb261d0a7a"
S = "${WORKDIR}/git"
