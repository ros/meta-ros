...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch_testing/3.9.5-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/launch_testing"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "dbcbd16718d5db8877907f26c6c6e018e3744c03"
S = "${WORKDIR}/git"
