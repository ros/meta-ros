...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch_testing/3.7.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/launch_testing"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "16737a34170f3d07f81a31c3c692ff9db9799c13"
S = "${WORKDIR}/git"
