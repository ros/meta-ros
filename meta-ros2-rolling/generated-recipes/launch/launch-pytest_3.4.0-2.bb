...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch_pytest/3.4.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/launch_pytest"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "269fa370c33667fb63a90954a41c44019da5c3db"
S = "${WORKDIR}/git"
