...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch_pytest/3.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/launch_pytest"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "2d56adc33599ae5cfaad4ff84c1b63ea2351b743"
S = "${WORKDIR}/git"
