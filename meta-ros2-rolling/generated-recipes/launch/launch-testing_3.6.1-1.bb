...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch_testing/3.6.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/launch_testing"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "4fb8b8b075cfde8ceeefe6d3b9824c958a008a5d"
S = "${WORKDIR}/git"
