...
# matches with: https://github.com/ros2-gbp/laser_proc-release/archive/release/rolling/laser_proc/1.0.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/laser_proc"
SRC_URI = "git://github.com/ros2-gbp/laser_proc-release;${ROS_BRANCH};protocol=https"
SRCREV = "4beb8155953050bbaa69f88a29bf4d5498e139cd"
S = "${WORKDIR}/git"
