...
# matches with: https://github.com/ros2-gbp/laser_proc-release/archive/release/rolling/laser_proc/1.0.2-5.tar.gz
ROS_BRANCH ?= "branch=release/rolling/laser_proc"
SRC_URI = "git://github.com/ros2-gbp/laser_proc-release;${ROS_BRANCH};protocol=https"
SRCREV = "eed949d18fcd9e01d21745a8ca1f34de85753046"
S = "${WORKDIR}/git"
