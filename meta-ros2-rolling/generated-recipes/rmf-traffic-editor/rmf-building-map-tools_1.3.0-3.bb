...
# matches with: https://github.com/ros2-gbp/rmf_traffic_editor-release/archive/release/rolling/rmf_building_map_tools/1.3.0-3.tar.gz
...
SRCREV = "9f38d2be9b77e4e08cd0510e761318fd6a3be6ff"
S = "${WORKDIR}/git"
