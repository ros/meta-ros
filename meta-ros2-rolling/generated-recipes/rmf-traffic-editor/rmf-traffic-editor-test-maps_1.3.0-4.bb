...
# matches with: https://github.com/ros2-gbp/rmf_traffic_editor-release/archive/release/rolling/rmf_traffic_editor_test_maps/1.3.0-4.tar.gz
...
SRCREV = "9700954a5568635008a3362e5530b326ed361fd1"
S = "${WORKDIR}/git"
