...
# matches with: https://github.com/ros2-gbp/ecl_lite-release/archive/release/rolling/ecl_errors/1.2.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_errors"
SRC_URI = "git://github.com/ros2-gbp/ecl_lite-release;${ROS_BRANCH};protocol=https"
SRCREV = "629b40fe614538554d4dd9820d39feaa7dd053fa"
S = "${WORKDIR}/git"
