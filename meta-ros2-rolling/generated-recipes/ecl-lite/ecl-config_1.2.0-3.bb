...
# matches with: https://github.com/ros2-gbp/ecl_lite-release/archive/release/rolling/ecl_config/1.2.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_config"
SRC_URI = "git://github.com/ros2-gbp/ecl_lite-release;${ROS_BRANCH};protocol=https"
SRCREV = "57cf2a9299a658df265bb56ecf9a96f670045b18"
S = "${WORKDIR}/git"
