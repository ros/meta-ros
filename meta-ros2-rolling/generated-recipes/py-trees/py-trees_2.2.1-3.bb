...
# matches with: https://github.com/ros2-gbp/py_trees-release/archive/release/rolling/py_trees/2.2.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/py_trees"
SRC_URI = "git://github.com/ros2-gbp/py_trees-release;${ROS_BRANCH};protocol=https"
SRCREV = "e91ad9333492fd16fef08eab669c7af78a641b0b"
S = "${WORKDIR}/git"
