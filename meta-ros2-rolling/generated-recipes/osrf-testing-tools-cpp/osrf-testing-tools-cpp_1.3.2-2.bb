...
# matches with: https://github.com/ros2-gbp/osrf_testings_tools_cpp-release/archive/release/rolling/osrf_testing_tools_cpp/1.3.2-2.tar.gz
...
SRCREV = "11ea3d2847088130e0ad27d4fe3be9681e0e0b0d"
S = "${WORKDIR}/git"
