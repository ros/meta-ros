...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/rolling/self_test/3.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/self_test"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "4ae58efbc7f7d8bd46e9c712c8ccd53496b9c83f"
S = "${WORKDIR}/git"
