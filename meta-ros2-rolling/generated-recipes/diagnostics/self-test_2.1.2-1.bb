...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/rolling/self_test/2.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/self_test"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "fd843593b80635e9f8f5361badcb891a714c9d0e"
S = "${WORKDIR}/git"
