...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/rolling/diagnostics/3.1.2-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/diagnostics"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "2bf49fdc69434a3efbb180fd032724f9bd08d623"
S = "${WORKDIR}/git"
