...
DESCRIPTION = "Vendor package for: gz-common5 5.5.1      Gazebo Common : AV, Graphics, Events, and much more."
...
# matches with: https://github.com/ros2-gbp/gz_common_vendor-release/archive/release/rolling/gz_common_vendor/0.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/gz_common_vendor"
SRC_URI = "git://github.com/ros2-gbp/gz_common_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "fca67cf3801753f48dbe82d4350034cbd4c96ee6"
S = "${WORKDIR}/git"
