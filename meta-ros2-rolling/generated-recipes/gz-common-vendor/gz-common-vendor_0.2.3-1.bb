...
# matches with: https://github.com/ros2-gbp/gz_common_vendor-release/archive/release/rolling/gz_common_vendor/0.2.3-1.tar.gz
...
SRCREV = "6bf183be64781d8a186be3e4a43e7c6b6a34129e"
S = "${WORKDIR}/git"
