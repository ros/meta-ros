...
# matches with: https://github.com/ros2-gbp/grbl_msgs-release/archive/release/rolling/grbl_msgs/0.0.2-7.tar.gz
ROS_BRANCH ?= "branch=release/rolling/grbl_msgs"
SRC_URI = "git://github.com/ros2-gbp/grbl_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "c8c3556a5fc506701a85706fbfca221043fc2c9e"
S = "${WORKDIR}/git"
