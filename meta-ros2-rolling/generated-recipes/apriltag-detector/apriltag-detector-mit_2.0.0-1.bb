...
# matches with: https://github.com/ros2-gbp/apriltag_detector-release/archive/release/rolling/apriltag_detector_mit/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/apriltag_detector_mit"
SRC_URI = "git://github.com/ros2-gbp/apriltag_detector-release;${ROS_BRANCH};protocol=https"
SRCREV = "5b47a9cbec7e3904b6ff541fc76cb84a879d0508"
S = "${WORKDIR}/git"
