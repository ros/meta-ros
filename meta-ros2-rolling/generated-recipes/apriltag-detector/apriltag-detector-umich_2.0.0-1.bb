...
# matches with: https://github.com/ros2-gbp/apriltag_detector-release/archive/release/rolling/apriltag_detector_umich/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/apriltag_detector_umich"
SRC_URI = "git://github.com/ros2-gbp/apriltag_detector-release;${ROS_BRANCH};protocol=https"
SRCREV = "b9f3375255a5b2b64a44202a618273c318389c3a"
S = "${WORKDIR}/git"
