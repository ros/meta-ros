...
# matches with: https://github.com/ros2-gbp/apriltag_detector-release/archive/release/rolling/apriltag_draw/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/apriltag_draw"
SRC_URI = "git://github.com/ros2-gbp/apriltag_detector-release;${ROS_BRANCH};protocol=https"
SRCREV = "4294d5688ed3a8f5d236d28e07ebcd4ea332c655"
S = "${WORKDIR}/git"
