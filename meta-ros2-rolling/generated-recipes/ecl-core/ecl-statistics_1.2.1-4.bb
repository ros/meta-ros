...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_statistics/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_statistics"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "c0e8d8dd7d93057ac24bd8beac89d9212a1a99a2"
S = "${WORKDIR}/git"
