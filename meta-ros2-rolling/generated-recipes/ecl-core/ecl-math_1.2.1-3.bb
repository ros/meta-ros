...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_math/1.2.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_math"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "82519fcf67cf4fee4e389dc167ce0a0bf912c778"
S = "${WORKDIR}/git"
