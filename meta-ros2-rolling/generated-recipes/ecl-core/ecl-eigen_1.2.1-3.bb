...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_eigen/1.2.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_eigen"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "3965746dce8160dc360e6f41a68a9bccbce17e1e"
S = "${WORKDIR}/git"
