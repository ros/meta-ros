...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_command_line/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_command_line"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "d2b05a008d2f744adffa0468f4707c7690571de5"
S = "${WORKDIR}/git"
