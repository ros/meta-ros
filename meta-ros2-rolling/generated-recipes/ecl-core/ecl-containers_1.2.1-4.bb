...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_containers/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_containers"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "892731f8c4692aee85993224927d18c845dfe360"
S = "${WORKDIR}/git"
