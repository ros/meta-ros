...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_geometry/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_geometry"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "6f23070b3de606ffa640f469551d3aa5e59a3e30"
S = "${WORKDIR}/git"
