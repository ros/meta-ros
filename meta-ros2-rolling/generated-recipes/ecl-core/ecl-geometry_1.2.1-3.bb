...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_geometry/1.2.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_geometry"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "eb87334abf4cd68304adccb0874c175656a6c81f"
S = "${WORKDIR}/git"
