...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_streams/1.2.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_streams"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "27978f9cf3e169cb93cadf1d335b7004ebcd9740"
S = "${WORKDIR}/git"
