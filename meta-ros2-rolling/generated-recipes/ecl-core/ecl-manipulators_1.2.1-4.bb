...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_manipulators/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_manipulators"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "fc7cd14e6eb5aae61165e3c575bbc66553519a91"
S = "${WORKDIR}/git"
