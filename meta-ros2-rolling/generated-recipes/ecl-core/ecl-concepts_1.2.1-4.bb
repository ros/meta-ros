...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_concepts/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_concepts"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "072809e1b60a07ee959d2a013e5a6a49323e8d51"
S = "${WORKDIR}/git"
