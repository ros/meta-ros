...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_time/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_time"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "bfac3621ddab8cc4f30d4e429b54d93886f860e1"
S = "${WORKDIR}/git"
