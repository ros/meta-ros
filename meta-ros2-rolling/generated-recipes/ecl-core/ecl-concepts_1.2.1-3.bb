...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_concepts/1.2.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_concepts"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "df51ab7f4485f49a82c1286aa111e989c9f88b38"
S = "${WORKDIR}/git"
