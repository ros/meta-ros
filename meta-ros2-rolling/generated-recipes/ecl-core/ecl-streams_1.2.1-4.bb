...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_streams/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_streams"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "9526a2f86060c201b2866ad2f0dd380cda29cf59"
S = "${WORKDIR}/git"
