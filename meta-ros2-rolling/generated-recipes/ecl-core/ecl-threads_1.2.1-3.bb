...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_threads/1.2.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_threads"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "a98659cc770e92b3d13dc8d75d522902ddd136c9"
S = "${WORKDIR}/git"
