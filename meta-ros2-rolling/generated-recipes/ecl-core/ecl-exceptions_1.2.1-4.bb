...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_exceptions/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_exceptions"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "c2e1b001308c0850a1ebef1502fac2f31e269791"
S = "${WORKDIR}/git"
