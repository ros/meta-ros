...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_mobile_robot/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_mobile_robot"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "7b8eb21c5679d0573c700db0d9c7e32401edf84e"
S = "${WORKDIR}/git"
