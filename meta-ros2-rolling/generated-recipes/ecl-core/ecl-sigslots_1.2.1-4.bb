...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_sigslots/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ecl_sigslots"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "bf1c66ab1688b4bf9d7051d232c5142eceb2d7fa"
S = "${WORKDIR}/git"
