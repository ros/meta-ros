...
# matches with: https://github.com/ros2-gbp/joystick_drivers-release/archive/release/rolling/joy/3.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/joy"
SRC_URI = "git://github.com/ros2-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "fbb0f569c214f7200cd9a645acde4fee310656a5"
S = "${WORKDIR}/git"
