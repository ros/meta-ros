...
# matches with: https://github.com/ros2-gbp/gc_spl-release/archive/release/rolling/gc_spl_2022/4.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/gc_spl_2022"
SRC_URI = "git://github.com/ros2-gbp/gc_spl-release;${ROS_BRANCH};protocol=https"
SRCREV = "e7b2cfd17b957b2e149dbda5dce48bd5647e2a13"
S = "${WORKDIR}/git"
