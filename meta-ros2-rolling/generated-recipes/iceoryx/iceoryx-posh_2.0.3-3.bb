...
# matches with: https://github.com/ros2-gbp/iceoryx-release/archive/release/rolling/iceoryx_posh/2.0.3-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/iceoryx_posh"
SRC_URI = "git://github.com/ros2-gbp/iceoryx-release;${ROS_BRANCH};protocol=https"
SRCREV = "f760f2fc12cff1c7082c610bf0ed407d2d6c3156"
S = "${WORKDIR}/git"
