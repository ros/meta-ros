...
# matches with: https://github.com/ros2-gbp/rqt_moveit-release/archive/release/rolling/rqt_moveit/1.0.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_moveit"
SRC_URI = "git://github.com/ros2-gbp/rqt_moveit-release;${ROS_BRANCH};protocol=https"
SRCREV = "b3db4be2a441ece817f931e2dc6dfbd44f3feac5"
S = "${WORKDIR}/git"
