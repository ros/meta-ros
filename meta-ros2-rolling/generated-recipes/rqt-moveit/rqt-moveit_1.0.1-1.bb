...
# matches with: https://github.com/ros2-gbp/rqt_moveit-release/archive/release/rolling/rqt_moveit/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_moveit"
SRC_URI = "git://github.com/ros2-gbp/rqt_moveit-release;${ROS_BRANCH};protocol=https"
SRCREV = "53251e7a3356ea49bc7be0d69af4eb76ae925907"
S = "${WORKDIR}/git"
