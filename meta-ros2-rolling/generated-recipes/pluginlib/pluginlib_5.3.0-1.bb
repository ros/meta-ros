...
# matches with: https://github.com/ros2-gbp/pluginlib-release/archive/release/rolling/pluginlib/5.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/pluginlib"
SRC_URI = "git://github.com/ros2-gbp/pluginlib-release;${ROS_BRANCH};protocol=https"
SRCREV = "62a3f5fd04ab5bf06a2e847cf943a6a511357b50"
S = "${WORKDIR}/git"
