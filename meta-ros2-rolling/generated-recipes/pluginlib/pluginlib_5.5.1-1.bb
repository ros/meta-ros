...
# matches with: https://github.com/ros2-gbp/pluginlib-release/archive/release/rolling/pluginlib/5.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/pluginlib"
SRC_URI = "git://github.com/ros2-gbp/pluginlib-release;${ROS_BRANCH};protocol=https"
SRCREV = "55497a0f479607be3195b6883a6107a38f2f8dfd"
S = "${WORKDIR}/git"
