...
# matches with: https://github.com/ros2-gbp/pluginlib-release/archive/release/rolling/pluginlib/5.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/pluginlib"
SRC_URI = "git://github.com/ros2-gbp/pluginlib-release;${ROS_BRANCH};protocol=https"
SRCREV = "5879cec7bb5b428b49656592988df92ed0481b44"
S = "${WORKDIR}/git"
