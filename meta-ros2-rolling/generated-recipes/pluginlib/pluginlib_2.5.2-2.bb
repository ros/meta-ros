...
# matches with: https://github.com/ros2-gbp/pluginlib-release/archive/release/rolling/pluginlib/2.5.2-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/pluginlib"
SRC_URI = "git://github.com/ros2-gbp/pluginlib-release;${ROS_BRANCH};protocol=https"
SRCREV = "daec6a18a2de38f03339da49bc6e36205eb898f8"
S = "${WORKDIR}/git"
