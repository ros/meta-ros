...
# matches with: https://github.com/ros2-gbp/executive_smach-release/archive/release/rolling/smach/3.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/smach"
SRC_URI = "git://github.com/ros2-gbp/executive_smach-release;${ROS_BRANCH};protocol=https"
SRCREV = "a354ccefa1e76432b2f948660024b2411539161a"
S = "${WORKDIR}/git"
