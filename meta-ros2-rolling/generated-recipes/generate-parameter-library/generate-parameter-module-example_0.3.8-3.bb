...
# matches with: https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/rolling/generate_parameter_module_example/0.3.8-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/generate_parameter_module_example"
SRC_URI = "git://github.com/ros2-gbp/generate_parameter_library-release;${ROS_BRANCH};protocol=https"
SRCREV = "9cc2325f63634db9965e347430e91d30465bbc82"
S = "${WORKDIR}/git"
