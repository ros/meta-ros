...
# matches with: https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/rolling/generate_parameter_library_example_external/0.5.0-1.tar.gz
...
SRCREV = "e10ef88232a48bd739e0d5e6168b9f108288ff06"
S = "${WORKDIR}/git"
