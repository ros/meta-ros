...
# matches with: https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/rolling/generate_parameter_library/0.3.8-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/generate_parameter_library"
SRC_URI = "git://github.com/ros2-gbp/generate_parameter_library-release;${ROS_BRANCH};protocol=https"
SRCREV = "380ed9e0a0282e8bfc90367bbf20657902646799"
S = "${WORKDIR}/git"
