...
# matches with: https://github.com/ros2-gbp/odom_to_tf_ros2-release/archive/release/rolling/odom_to_tf_ros2/1.0.2-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/odom_to_tf_ros2"
SRC_URI = "git://github.com/ros2-gbp/odom_to_tf_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "c40e00e711e76f042a70324930e2e99a93407c65"
S = "${WORKDIR}/git"
