...
# matches with: https://github.com/ros2-gbp/rot_conv_lib-release/archive/release/rolling/rot_conv/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rot_conv"
SRC_URI = "git://github.com/ros2-gbp/rot_conv_lib-release;${ROS_BRANCH};protocol=https"
SRCREV = "cd44254148668ccdb86289635497993d8940dbb6"
S = "${WORKDIR}/git"
