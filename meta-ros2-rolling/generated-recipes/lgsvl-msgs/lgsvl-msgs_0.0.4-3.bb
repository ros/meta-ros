...
# matches with: https://github.com/ros2-gbp/lgsvl_msgs-release/archive/release/rolling/lgsvl_msgs/0.0.4-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lgsvl_msgs"
SRC_URI = "git://github.com/ros2-gbp/lgsvl_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "185a1e1c66eb3148dcb1ec8e0a3105a670096812"
S = "${WORKDIR}/git"
