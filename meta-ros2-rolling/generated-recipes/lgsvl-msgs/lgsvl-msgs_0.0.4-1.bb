...
# matches with: https://github.com/ros2-gbp/lgsvl_msgs-release/archive/release/rolling/lgsvl_msgs/0.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lgsvl_msgs"
SRC_URI = "git://github.com/ros2-gbp/lgsvl_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "b0e5675ac1a6dbb8faeab163401538f826eac18c"
S = "${WORKDIR}/git"
