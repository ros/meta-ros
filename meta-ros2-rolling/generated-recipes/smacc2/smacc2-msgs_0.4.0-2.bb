...
# matches with: https://github.com/ros2-gbp/SMACC2-release/archive/release/rolling/smacc2_msgs/0.4.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/smacc2_msgs"
SRC_URI = "git://github.com/ros2-gbp/SMACC2-release;${ROS_BRANCH};protocol=https"
SRCREV = "469f895fb4286d3ba5e9d96cf51c8ab30a89b1a5"
S = "${WORKDIR}/git"
