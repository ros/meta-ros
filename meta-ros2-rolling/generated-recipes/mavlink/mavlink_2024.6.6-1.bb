...
# matches with: https://github.com/ros2-gbp/mavlink-gbp-release/archive/release/rolling/mavlink/2024.6.6-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mavlink"
SRC_URI = "git://github.com/ros2-gbp/mavlink-gbp-release;${ROS_BRANCH};protocol=https"
SRCREV = "31ee30cca1dfb58f7dd100c83114e9a982fa462b"
S = "${WORKDIR}/git"
