...
# matches with: https://github.com/ros2-gbp/mavlink-gbp-release/archive/release/rolling/mavlink/2023.9.9-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mavlink"
SRC_URI = "git://github.com/ros2-gbp/mavlink-gbp-release;${ROS_BRANCH};protocol=https"
SRCREV = "8e44501f93c9254da3269741cd7757435b9b272f"
S = "${WORKDIR}/git"
