...
# matches with: https://github.com/ros2-gbp/marti_messages-release/archive/release/rolling/marti_sensor_msgs/1.6.1-1.tar.gz
...
SRCREV = "f1ef8219a28db83f909557e0db9cebf3e996a93f"
S = "${WORKDIR}/git"
