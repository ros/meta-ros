...
# matches with: https://github.com/ros2-gbp/flexbe_behavior_engine-release/archive/release/rolling/flexbe_widget/3.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/flexbe_widget"
SRC_URI = "git://github.com/ros2-gbp/flexbe_behavior_engine-release;${ROS_BRANCH};protocol=https"
SRCREV = "a976af98c5dd325ea57efae2faf6097620c33fac"
S = "${WORKDIR}/git"
