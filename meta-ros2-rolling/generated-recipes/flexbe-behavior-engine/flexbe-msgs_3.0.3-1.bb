...
# matches with: https://github.com/ros2-gbp/flexbe_behavior_engine-release/archive/release/rolling/flexbe_msgs/3.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/flexbe_msgs"
SRC_URI = "git://github.com/ros2-gbp/flexbe_behavior_engine-release;${ROS_BRANCH};protocol=https"
SRCREV = "9876f77f96950bbdcfd268cd6d421faa12a43fbe"
S = "${WORKDIR}/git"
