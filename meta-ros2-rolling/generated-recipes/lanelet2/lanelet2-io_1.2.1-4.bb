...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/rolling/lanelet2_io/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lanelet2_io"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d3f4f54893ce8eb9cea6951387f83513c3458b79"
S = "${WORKDIR}/git"
