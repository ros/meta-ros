...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/rolling/lanelet2_io/1.2.1-6.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lanelet2_io"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "38f37dab6a64d5c16ff048611c0a3b4e1bd4d132"
S = "${WORKDIR}/git"
