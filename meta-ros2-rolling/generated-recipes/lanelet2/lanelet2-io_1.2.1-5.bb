...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/rolling/lanelet2_io/1.2.1-5.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lanelet2_io"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "259e5da0957b5cdf80f16d0b319b1f40e7494dee"
S = "${WORKDIR}/git"
