...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/rolling/lanelet2/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lanelet2"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "455878a14318992dece49fca75d976c76af4f85a"
S = "${WORKDIR}/git"
