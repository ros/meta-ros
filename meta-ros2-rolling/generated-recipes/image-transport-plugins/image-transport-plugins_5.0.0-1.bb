...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/rolling/image_transport_plugins/5.0.0-1.tar.gz
...
SRCREV = "bd4c8419b2e58ee263c58f2900fdbecb0feada27"
S = "${WORKDIR}/git"
