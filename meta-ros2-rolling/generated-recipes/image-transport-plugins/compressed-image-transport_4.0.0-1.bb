...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/rolling/compressed_image_transport/4.0.0-1.tar.gz
...
SRCREV = "2329f6866809699bf801668ff4f6a06866be6d13"
S = "${WORKDIR}/git"
