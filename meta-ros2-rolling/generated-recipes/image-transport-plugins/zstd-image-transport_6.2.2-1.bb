...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/rolling/zstd_image_transport/6.2.2-1.tar.gz
...
SRCREV = "24be0aa2952087411cc3e750902a6f9549328add"
S = "${WORKDIR}/git"
