...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/rolling/image_transport_plugins/3.2.0-2.tar.gz
...
SRCREV = "927123a7618612079dc3e0edd87507f7fe5206cb"
S = "${WORKDIR}/git"
