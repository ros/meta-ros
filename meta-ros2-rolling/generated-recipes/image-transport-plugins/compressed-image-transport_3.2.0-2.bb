...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/rolling/compressed_image_transport/3.2.0-2.tar.gz
...
SRCREV = "fb730d4e3a220156be9b1e8d47bafa8164615b27"
S = "${WORKDIR}/git"
