...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libgui/2.15.14-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_libgui"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "e9a0f4c5551a8c5092f81f86e7593b18285a965a"
S = "${WORKDIR}/git"
