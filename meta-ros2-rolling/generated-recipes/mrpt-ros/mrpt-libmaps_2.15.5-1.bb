...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libmaps/2.15.5-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_libmaps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "95567843cd480a4676f5a907d15e2a1b8dfd63e7"
S = "${WORKDIR}/git"
