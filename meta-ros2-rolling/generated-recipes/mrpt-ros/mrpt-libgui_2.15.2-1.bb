...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libgui/2.15.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_libgui"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "743b53684620c63ece59559456a1c412686f1e74"
S = "${WORKDIR}/git"
