...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libmaps/2.14.11-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_libmaps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "408738e8a997a87d5aaba659971b9627882fc33b"
S = "${WORKDIR}/git"
