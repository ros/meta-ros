...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libobs/2.15.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_libobs"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "34c8b0144a861dcffded7b4b3eaa4b1397cb97e6"
S = "${WORKDIR}/git"
