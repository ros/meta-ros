...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libobs/2.14.11-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_libobs"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "55c0fba38e667e9dd9cdbebdb1876ef9d4a3db7e"
S = "${WORKDIR}/git"
