...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libmaps/2.14.10-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_libmaps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "18efe15ee99096e2d9147a08d9d41fa6452e3baf"
S = "${WORKDIR}/git"
