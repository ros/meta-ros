...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_apps/2.15.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_apps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "634e43806f875150d5281a726de1d0b03be7ab1f"
S = "${WORKDIR}/git"
