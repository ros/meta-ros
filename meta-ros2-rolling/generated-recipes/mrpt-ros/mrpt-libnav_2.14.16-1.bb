...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libnav/2.14.16-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_libnav"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "a91d71e9a022d2a8b566d7bf8d16b8be4b8745fe"
S = "${WORKDIR}/git"
