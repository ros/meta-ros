...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libapps/2.14.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_libapps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "6ebab7be7fa48289ed00fbcb19b6974bea380f26"
S = "${WORKDIR}/git"
