...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_variables/1.0.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_variables"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "0bc6e306d9f910998a1d9bd4ba55b4db1408a8f2"
S = "${WORKDIR}/git"
