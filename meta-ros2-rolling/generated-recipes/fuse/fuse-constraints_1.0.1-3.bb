...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_constraints/1.0.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_constraints"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "00c452170bd007b221506e30b4eb2dc0b3e17467"
S = "${WORKDIR}/git"
