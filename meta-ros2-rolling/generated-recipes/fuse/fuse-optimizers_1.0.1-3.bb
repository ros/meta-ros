...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_optimizers/1.0.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_optimizers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "b17fcedc1a42d6191b8988f16fef387975a30d7d"
S = "${WORKDIR}/git"
