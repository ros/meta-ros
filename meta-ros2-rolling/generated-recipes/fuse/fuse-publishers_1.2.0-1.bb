...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_publishers/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_publishers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "72c85daaf5a92cba2d0bd3b77c39de6de349100a"
S = "${WORKDIR}/git"
