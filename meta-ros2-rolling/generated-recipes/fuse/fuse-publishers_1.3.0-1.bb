...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_publishers/1.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_publishers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "24d7ea83892d0d51ecdf9b74a80ec47095e2766d"
S = "${WORKDIR}/git"
