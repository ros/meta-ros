...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_variables/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_variables"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "fdcbf8fbc5299d008c477f6209dba3327209a348"
S = "${WORKDIR}/git"
