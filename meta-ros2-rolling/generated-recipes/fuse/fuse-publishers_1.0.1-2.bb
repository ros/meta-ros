...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_publishers/1.0.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_publishers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "3cc21e0789dcf4531b288fb8ee5365ea3db45769"
S = "${WORKDIR}/git"
