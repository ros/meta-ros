...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_publishers/1.0.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_publishers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "6869fe2383bfa2a84af70324854b20280d53a53e"
S = "${WORKDIR}/git"
