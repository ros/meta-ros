...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_optimizers/1.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_optimizers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "ab54ce92f0c5c82dcc10d9d24b42fa23cc39bcd6"
S = "${WORKDIR}/git"
