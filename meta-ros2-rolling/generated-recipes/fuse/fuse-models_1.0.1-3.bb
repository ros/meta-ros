...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_models/1.0.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_models"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "f073eb57ab0099bca44acba44bfa7e2b0bf5fc40"
S = "${WORKDIR}/git"
