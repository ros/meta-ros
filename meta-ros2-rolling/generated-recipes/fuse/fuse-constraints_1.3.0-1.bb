...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_constraints/1.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_constraints"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "26bcfa3e5646f971096d916a23a7eaaac9a08abe"
S = "${WORKDIR}/git"
