...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_constraints/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_constraints"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "d8f46ad8c87f7a535538f49a50b3c409e7c60ef8"
S = "${WORKDIR}/git"
