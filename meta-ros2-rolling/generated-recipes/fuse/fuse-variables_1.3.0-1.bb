...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_variables/1.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_variables"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "b460dd67c3791d4154f0f83a97f429fdc7600918"
S = "${WORKDIR}/git"
