...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_publishers/1.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_publishers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "8cdbfe367283549e53c4532efee7b76a3328ad1b"
S = "${WORKDIR}/git"
