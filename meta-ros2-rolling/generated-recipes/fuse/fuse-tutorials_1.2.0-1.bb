...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_tutorials/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fuse_tutorials"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "b798d1797331227af144494496db6d2e4f9ae77e"
S = "${WORKDIR}/git"
