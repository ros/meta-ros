...
# matches with: https://github.com/ros2-gbp/libcamera-release/archive/release/rolling/libcamera/0.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/libcamera"
SRC_URI = "git://github.com/ros2-gbp/libcamera-release;${ROS_BRANCH};protocol=https"
SRCREV = "50556258823f8785c5fbbdeeb8ea3c0653df7941"
S = "${WORKDIR}/git"
