...
# matches with: https://github.com/ros2-gbp/libcamera-release/archive/release/rolling/libcamera/0.3.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/libcamera"
SRC_URI = "git://github.com/ros2-gbp/libcamera-release;${ROS_BRANCH};protocol=https"
SRCREV = "5fb6283871df8fd6bbd838e3d4c0c29c409989db"
S = "${WORKDIR}/git"
