...
# matches with: https://github.com/ros2-gbp/libcamera-release/archive/release/rolling/libcamera/0.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/libcamera"
SRC_URI = "git://github.com/ros2-gbp/libcamera-release;${ROS_BRANCH};protocol=https"
SRCREV = "7e6df4ed1fc8c50a3173427f905bec667f9826d3"
S = "${WORKDIR}/git"
