...
# matches with: https://github.com/ros2-gbp/libcamera-release/archive/release/rolling/libcamera/0.5.2-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/libcamera"
SRC_URI = "git://github.com/ros2-gbp/libcamera-release;${ROS_BRANCH};protocol=https"
SRCREV = "993506993f2fab485c94dbec6adb1561e420a100"
S = "${WORKDIR}/git"
