...
# matches with: https://github.com/ros2-gbp/ign_ros2_control-release/archive/release/rolling/gz_ros2_control/1.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/gz_ros2_control"
SRC_URI = "git://github.com/ros2-gbp/ign_ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "83a186ecc2cedf9155d2cc6cd1316e2a65506a82"
S = "${WORKDIR}/git"
