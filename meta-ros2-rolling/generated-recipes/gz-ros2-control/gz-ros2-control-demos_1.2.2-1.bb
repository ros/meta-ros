...
ROS_EXEC_DEPENDS = " \
    ${ROS_UNRESOLVED_DEP-ros-gz-bridge} \
    ${ROS_UNRESOLVED_DEP-ros-gz-sim} \
    ament-index-python \
    control-msgs \
...
# matches with: https://github.com/ros2-gbp/ign_ros2_control-release/archive/release/rolling/gz_ros2_control_demos/1.2.2-1.tar.gz
...
SRCREV = "9fa59a59d9fb0133f6c09d1aef6da73e08404e05"
S = "${WORKDIR}/git"
