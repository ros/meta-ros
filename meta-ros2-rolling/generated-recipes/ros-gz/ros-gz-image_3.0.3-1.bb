...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_image/3.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros_gz_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "0d69d5cc9d03d8a474cdf3e51f2ccd2f11cf3fed"
S = "${WORKDIR}/git"
