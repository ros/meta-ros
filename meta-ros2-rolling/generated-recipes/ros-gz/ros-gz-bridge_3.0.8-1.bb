...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_bridge/3.0.8-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros_gz_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "15dcf7efec03d7ee85523834dac09de2a9beb257"
S = "${WORKDIR}/git"
