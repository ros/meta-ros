...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_interfaces/0.245.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros_gz_interfaces"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "f25ee8b41065e206279d72bd75388a7f962def52"
S = "${WORKDIR}/git"
