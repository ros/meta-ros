...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_image/2.1.3-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros_gz_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "ad88d335a0cfbf07643b02ee6bcdeaf610336e46"
S = "${WORKDIR}/git"
