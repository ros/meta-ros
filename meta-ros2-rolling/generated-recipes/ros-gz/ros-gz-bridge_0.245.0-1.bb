...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_bridge/0.245.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros_gz_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "7bc43b0d7572fda252fc60a1aa835dd42033ce28"
S = "${WORKDIR}/git"
