...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_image/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros_gz_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "85a2bbf46d0b5d4acd8b54922fd56b9b864e215b"
S = "${WORKDIR}/git"
