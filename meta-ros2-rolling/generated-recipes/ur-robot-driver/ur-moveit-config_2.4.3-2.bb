...
# matches with: https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_moveit_config/2.4.3-2.tar.gz
...
SRCREV = "7191fd04acc96748821a05f4607a6952316efda1"
S = "${WORKDIR}/git"
