...
# matches with: https://github.com/ros2-gbp/rcpputils-release/archive/release/rolling/rcpputils/2.12.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rcpputils"
SRC_URI = "git://github.com/ros2-gbp/rcpputils-release;${ROS_BRANCH};protocol=https"
SRCREV = "704230a4cea3c0638596593bd18b3d4ed6221f17"
S = "${WORKDIR}/git"
