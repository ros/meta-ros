...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui_py_common/2.0.0-4.tar.gz
...
SRCREV = "29bda961658363a4e6b4613b5909784e4eef28d3"
S = "${WORKDIR}/git"
