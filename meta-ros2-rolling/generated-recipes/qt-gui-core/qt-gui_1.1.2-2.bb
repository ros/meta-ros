...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui/1.1.2-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "667803233fb8f7e5678a0a8495164a54a64d5d10"
S = "${WORKDIR}/git"
