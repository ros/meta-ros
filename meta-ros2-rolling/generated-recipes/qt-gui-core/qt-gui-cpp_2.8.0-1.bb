...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui_cpp/2.8.0-1.tar.gz
...
SRCREV = "f9d1b36407eb3fafd2db3fed82b5c858ea399b2e"
S = "${WORKDIR}/git"
