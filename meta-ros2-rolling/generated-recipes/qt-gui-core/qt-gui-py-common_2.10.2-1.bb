...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui_py_common/2.10.2-1.tar.gz
...
SRCREV = "18a4036fe8f0c410c5091e44937fcadd2b6db00f"
S = "${WORKDIR}/git"
