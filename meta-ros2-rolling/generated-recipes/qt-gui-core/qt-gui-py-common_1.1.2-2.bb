...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui_py_common/1.1.2-2.tar.gz
...
SRCREV = "353727f7e231896a1dc43f32b8153984d4be50c8"
S = "${WORKDIR}/git"
