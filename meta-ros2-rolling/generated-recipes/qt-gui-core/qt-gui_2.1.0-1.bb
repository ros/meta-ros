...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "95912658c46c0228be6950730f276b3906d3665d"
S = "${WORKDIR}/git"
