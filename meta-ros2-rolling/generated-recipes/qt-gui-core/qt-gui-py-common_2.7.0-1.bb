...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui_py_common/2.7.0-1.tar.gz
...
SRCREV = "3d3ff73c8b4baa57b9a41f28f96f45f5d9a9be7b"
S = "${WORKDIR}/git"
