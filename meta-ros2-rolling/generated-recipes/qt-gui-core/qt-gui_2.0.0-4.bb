...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui/2.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "2ca555169b9c8725cd98bd4164e65879cd7462df"
S = "${WORKDIR}/git"
