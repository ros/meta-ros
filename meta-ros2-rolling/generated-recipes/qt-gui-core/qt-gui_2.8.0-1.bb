...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui/2.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "c3d3a3a3b3ccec2d7977311152515551d279e3f0"
S = "${WORKDIR}/git"
