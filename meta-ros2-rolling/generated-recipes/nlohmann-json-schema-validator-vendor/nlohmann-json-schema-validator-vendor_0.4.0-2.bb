...
# matches with: https://github.com/ros2-gbp/nlohmann_json_schema_validator_vendor-release/archive/release/rolling/nlohmann_json_schema_validator_vendor/0.4.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/nlohmann_json_schema_validator_vendor"
SRC_URI = "git://github.com/ros2-gbp/nlohmann_json_schema_validator_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "aab609643443d382b291f39264914da64cabf0f6"
S = "${WORKDIR}/git"
