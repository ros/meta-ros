...
# matches with: https://github.com/ros2-gbp/grbl_ros-release/archive/release/rolling/grbl_ros/0.0.16-5.tar.gz
ROS_BRANCH ?= "branch=release/rolling/grbl_ros"
SRC_URI = "git://github.com/ros2-gbp/grbl_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "939d9723ff8cd2e10f8f8fe42eb59f5c1a02cb5b"
S = "${WORKDIR}/git"
