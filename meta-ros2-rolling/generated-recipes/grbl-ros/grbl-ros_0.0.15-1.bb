...
# matches with: https://github.com/flynneva/grbl_ros-release/archive/release/rolling/grbl_ros/0.0.15-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/grbl_ros"
SRC_URI = "git://github.com/flynneva/grbl_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "19241b75cdeb425a96399cb028390bc4adbcb91f"
S = "${WORKDIR}/git"
