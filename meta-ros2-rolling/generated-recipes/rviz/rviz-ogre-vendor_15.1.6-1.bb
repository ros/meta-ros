...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_ogre_vendor/15.1.6-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "78d41042bc67727f94762e411411dd16cd5060ae"
S = "${WORKDIR}/git"
