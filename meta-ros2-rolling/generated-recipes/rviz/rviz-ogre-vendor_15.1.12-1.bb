...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_ogre_vendor/15.1.12-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "19883254ac4e8cf4e36fc1b19f0fe24569732568"
S = "${WORKDIR}/git"
