...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_ogre_vendor/15.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "888805ca75421fc67eec84e7a1cfc5516f160fdc"
S = "${WORKDIR}/git"
