...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering/14.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rviz_rendering"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "7e2295685170783dff8b9dddb0aec54d8ead38c9"
S = "${WORKDIR}/git"
