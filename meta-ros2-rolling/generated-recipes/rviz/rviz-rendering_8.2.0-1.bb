...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering/8.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rviz_rendering"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "571a58f6172e67759fefcb60ced7da7864efe1a3"
S = "${WORKDIR}/git"
