...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_common/13.4.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rviz_common"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "afbd7a2bbdd586824832061aab7fe3d56a603d55"
S = "${WORKDIR}/git"
