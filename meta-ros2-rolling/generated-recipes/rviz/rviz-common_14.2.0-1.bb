...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_common/14.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rviz_common"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "7990b500fbea894a048912282cd169df061c73fa"
S = "${WORKDIR}/git"
