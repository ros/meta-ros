...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_ogre_vendor/8.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "7b17adae03c2184c135dc8fe8893ad13ba28a3f5"
S = "${WORKDIR}/git"
