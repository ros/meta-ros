...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_ogre_vendor/13.4.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "0592144537b31b86f56aa6c0e785a55f8e2f8958"
S = "${WORKDIR}/git"
