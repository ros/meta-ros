...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering/8.6.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rviz_rendering"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "da62c74243a7985c6d270730713a15f39a78aa18"
S = "${WORKDIR}/git"
