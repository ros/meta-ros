...
# matches with: https://github.com/ros2-gbp/ld08_driver-release/archive/release/rolling/ld08_driver/1.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ld08_driver"
SRC_URI = "git://github.com/ros2-gbp/ld08_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "a86d91ee4ec60c6fe076ed70397c10f8fd70c5e3"
S = "${WORKDIR}/git"
