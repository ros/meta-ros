...
# matches with: https://github.com/ros2-gbp/apriltag-release/archive/release/rolling/apriltag/3.2.0-6.tar.gz
ROS_BRANCH ?= "branch=release/rolling/apriltag"
SRC_URI = "git://github.com/ros2-gbp/apriltag-release;${ROS_BRANCH};protocol=https"
SRCREV = "c517836f68c0be3fa7317ab6ff1190cf792c3352"
S = "${WORKDIR}/git"
