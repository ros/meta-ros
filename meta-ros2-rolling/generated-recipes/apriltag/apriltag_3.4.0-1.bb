...
# matches with: https://github.com/ros2-gbp/apriltag-release/archive/release/rolling/apriltag/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/apriltag"
SRC_URI = "git://github.com/ros2-gbp/apriltag-release;${ROS_BRANCH};protocol=https"
SRCREV = "7306c8ca0e1f5277f81558833608d84968fe1760"
S = "${WORKDIR}/git"
