...
ROS_EXEC_DEPENDS = " \
    ${ROS_UNRESOLVED_DEP-python3-smbus2} \
    ament-index-python \
    geometry-msgs \
    image-proc \
    launch \
...
# matches with: https://github.com/ros2-gbp/leo_robot-release/archive/release/rolling/leo_bringup/2.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/leo_bringup"
SRC_URI = "git://github.com/ros2-gbp/leo_robot-release;${ROS_BRANCH};protocol=https"
SRCREV = "332ef614ba797088279835d97dabc98f7ea60cf7"
