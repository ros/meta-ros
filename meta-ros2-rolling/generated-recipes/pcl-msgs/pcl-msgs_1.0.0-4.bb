...
# matches with: https://github.com/ros2-gbp/pcl_msgs-release/archive/release/rolling/pcl_msgs/1.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/pcl_msgs"
SRC_URI = "git://github.com/ros2-gbp/pcl_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "34007f727c76605d750c0191098d0194f39a1bf5"
S = "${WORKDIR}/git"
