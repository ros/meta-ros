...
# matches with: https://github.com/tier4/osqp_vendor-release/archive/release/rolling/osqp_vendor/0.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/osqp_vendor"
SRC_URI = "git://github.com/tier4/osqp_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "b4178ca14f33b12337325dc998f00a56a21cb271"
S = "${WORKDIR}/git"
