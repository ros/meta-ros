...
# matches with: https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/ros2launch/0.26.5-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2launch"
SRC_URI = "git://github.com/ros2-gbp/launch_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "29396e59a59dbb392509581b7ebc4aa1988715a1"
S = "${WORKDIR}/git"
