...
# matches with: https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/launch_ros/0.29.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/launch_ros"
SRC_URI = "git://github.com/ros2-gbp/launch_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "47fcd043622f4f6a45c61292843d5576a3cd6ab5"
S = "${WORKDIR}/git"
