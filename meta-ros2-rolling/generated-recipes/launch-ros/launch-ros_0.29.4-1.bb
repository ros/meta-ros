...
# matches with: https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/launch_ros/0.29.4-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/launch_ros"
SRC_URI = "git://github.com/ros2-gbp/launch_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "59178240c042072a0eb4958a1a1e2115ef5e729d"
S = "${WORKDIR}/git"
