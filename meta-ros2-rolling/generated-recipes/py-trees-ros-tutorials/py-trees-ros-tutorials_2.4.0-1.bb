...
# matches with: https://github.com/ros2-gbp/py_trees_ros_tutorials-release/archive/release/rolling/py_trees_ros_tutorials/2.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/py_trees_ros_tutorials"
SRC_URI = "git://github.com/ros2-gbp/py_trees_ros_tutorials-release;${ROS_BRANCH};protocol=https"
SRCREV = "37fa1be6f3faf83f1a0cb9240256140949feaf66"
S = "${WORKDIR}/git"
