...
# matches with: https://github.com/ros2-gbp/moveit_resources-release/archive/release/rolling/moveit_resources_fanuc_moveit_config/3.1.1-1.tar.gz
...
SRCREV = "61fea1e6b7bef8fc1107f1a1ed172db832f64dde"
S = "${WORKDIR}/git"
