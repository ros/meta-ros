...
# matches with: https://github.com/ros2-gbp/rcdiscover-release/archive/release/rolling/rcdiscover/1.1.6-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rcdiscover"
SRC_URI = "git://github.com/ros2-gbp/rcdiscover-release;${ROS_BRANCH};protocol=https"
SRCREV = "d5a2a22db119dcd817bc50d73635151f6e579207"
S = "${WORKDIR}/git"
