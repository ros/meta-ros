...
# matches with: https://github.com/ros2-gbp/rcdiscover-release/archive/release/rolling/rcdiscover/1.1.6-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rcdiscover"
SRC_URI = "git://github.com/ros2-gbp/rcdiscover-release;${ROS_BRANCH};protocol=https"
SRCREV = "b4ba85d5556a3ff390af8bb39a3ea8da60d9a056"
S = "${WORKDIR}/git"
