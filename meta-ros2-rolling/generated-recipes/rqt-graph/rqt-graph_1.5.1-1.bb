...
# matches with: https://github.com/ros2-gbp/rqt_graph-release/archive/release/rolling/rqt_graph/1.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_graph"
SRC_URI = "git://github.com/ros2-gbp/rqt_graph-release;${ROS_BRANCH};protocol=https"
SRCREV = "b5ac2f89a40ec32a846999ce69b69c267b4d35ef"
S = "${WORKDIR}/git"
