...
# matches with: https://github.com/ros2-gbp/rqt_graph-release/archive/release/rolling/rqt_graph/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_graph"
SRC_URI = "git://github.com/ros2-gbp/rqt_graph-release;${ROS_BRANCH};protocol=https"
SRCREV = "81c449646600eded01c1bb5206ff022bef9e3fe4"
S = "${WORKDIR}/git"
