...
# matches with: https://github.com/ros2-gbp/rqt_graph-release/archive/release/rolling/rqt_graph/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_graph"
SRC_URI = "git://github.com/ros2-gbp/rqt_graph-release;${ROS_BRANCH};protocol=https"
SRCREV = "efc4e9b6e35cc453bf3db4156a2294965586be6e"
S = "${WORKDIR}/git"
