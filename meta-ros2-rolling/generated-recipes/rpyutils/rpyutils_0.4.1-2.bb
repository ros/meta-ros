...
# matches with: https://github.com/ros2-gbp/rpyutils-release/archive/release/rolling/rpyutils/0.4.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rpyutils"
SRC_URI = "git://github.com/ros2-gbp/rpyutils-release;${ROS_BRANCH};protocol=https"
SRCREV = "171724cd475284c380db87de2ecdb8937add0b0f"
S = "${WORKDIR}/git"
