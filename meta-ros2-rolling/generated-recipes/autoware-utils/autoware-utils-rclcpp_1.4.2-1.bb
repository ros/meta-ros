...
# matches with: https://github.com/ros2-gbp/autoware_utils-release/archive/release/rolling/autoware_utils_rclcpp/1.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/autoware_utils_rclcpp"
SRC_URI = "git://github.com/ros2-gbp/autoware_utils-release;${ROS_BRANCH};protocol=https"
SRCREV = "598cd0ca8264b63c7f0ea64536a2b7d58ffb8daf"
S = "${WORKDIR}/git"
