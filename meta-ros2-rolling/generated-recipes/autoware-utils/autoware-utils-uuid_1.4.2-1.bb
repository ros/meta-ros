...
# matches with: https://github.com/ros2-gbp/autoware_utils-release/archive/release/rolling/autoware_utils_uuid/1.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/autoware_utils_uuid"
SRC_URI = "git://github.com/ros2-gbp/autoware_utils-release;${ROS_BRANCH};protocol=https"
SRCREV = "43bdd7d9ff002a575db5ff9d2a3b5add85fe91f3"
S = "${WORKDIR}/git"
