...
# matches with: https://github.com/ros2-gbp/rosidl_core-release/archive/release/rolling/rosidl_core_runtime/0.2.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosidl_core_runtime"
SRC_URI = "git://github.com/ros2-gbp/rosidl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "7cbf9e872c33d37aad866ebcc3108eea40d80fde"
S = "${WORKDIR}/git"
