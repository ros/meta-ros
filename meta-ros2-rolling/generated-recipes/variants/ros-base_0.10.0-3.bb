...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/rolling/ros_base/0.10.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros_base"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "75d8db29ff91ed2c830c9ffafc717707c095c390"
S = "${WORKDIR}/git"
