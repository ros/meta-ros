...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/rolling/desktop/0.10.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/desktop"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "e0a98f91d4d99080fcd01aff44a2a2a276940f05"
S = "${WORKDIR}/git"
