...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/rolling/ros_core/0.9.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros_core"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "1d0568d5b8057736f6844fd9e252d5d28951af6e"
S = "${WORKDIR}/git"
