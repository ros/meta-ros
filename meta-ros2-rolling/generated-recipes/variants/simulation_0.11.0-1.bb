...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/rolling/simulation/0.11.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/simulation"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "0cd1c0427876f68c227a63f8e2051185965da6ac"
S = "${WORKDIR}/git"
