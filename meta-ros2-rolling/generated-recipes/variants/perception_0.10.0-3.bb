...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/rolling/perception/0.10.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/perception"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "3b5cb65fd47d330af6f7a6daff0dfe0501a0da37"
S = "${WORKDIR}/git"
