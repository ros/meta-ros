...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/rolling/perception/0.11.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/perception"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "28fb3d7d11f2167ea52c6968256958a2eb45d0d1"
S = "${WORKDIR}/git"
