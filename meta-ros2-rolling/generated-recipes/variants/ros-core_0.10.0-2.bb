...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/rolling/ros_core/0.10.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros_core"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "29eee9dacbefcb71a58d59d08a6d244c396c8d83"
S = "${WORKDIR}/git"
