...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/rolling/desktop/0.11.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/desktop"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "d2ceeb23ea147b9e4edc88392520a6e3d2e553e6"
S = "${WORKDIR}/git"
