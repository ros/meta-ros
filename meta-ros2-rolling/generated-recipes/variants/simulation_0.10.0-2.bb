...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/rolling/simulation/0.10.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/simulation"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "d3c761db760881fad28a77a982cf9454f82367c8"
S = "${WORKDIR}/git"
