...
# matches with: https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/rolling/mrpt_msgs_bridge/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_msgs_bridge"
SRC_URI = "git://github.com/ros2-gbp/mrpt_navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "3b54458a724bb4d4890ddf334610a16d13169f03"
S = "${WORKDIR}/git"
