...
# matches with: https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/rolling/mrpt_tps_astar_planner/2.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_tps_astar_planner"
SRC_URI = "git://github.com/ros2-gbp/mrpt_navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "9853a26bd9125d6db7bcb022fce27eb504711eec"
S = "${WORKDIR}/git"
