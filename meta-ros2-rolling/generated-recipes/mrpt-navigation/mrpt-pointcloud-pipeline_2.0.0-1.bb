...
# matches with: https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/rolling/mrpt_pointcloud_pipeline/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_pointcloud_pipeline"
SRC_URI = "git://github.com/ros2-gbp/mrpt_navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "e8d59f81450c39f5e9b7cd8b5b05e61b8824ff76"
S = "${WORKDIR}/git"
