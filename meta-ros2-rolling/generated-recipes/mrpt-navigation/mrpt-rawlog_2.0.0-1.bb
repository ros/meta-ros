...
# matches with: https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/rolling/mrpt_rawlog/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_rawlog"
SRC_URI = "git://github.com/ros2-gbp/mrpt_navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "8071cde580688bf3abf1dd24f5c8a0de12c22d8f"
S = "${WORKDIR}/git"
