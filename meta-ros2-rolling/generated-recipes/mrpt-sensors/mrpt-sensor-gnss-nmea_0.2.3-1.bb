...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/rolling/mrpt_sensor_gnss_nmea/0.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_sensor_gnss_nmea"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "bad2e14e8055bcc1b24cf7af43d984f5e2b75d19"
S = "${WORKDIR}/git"
