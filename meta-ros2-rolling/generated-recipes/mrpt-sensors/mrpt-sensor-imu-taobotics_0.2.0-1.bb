...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/rolling/mrpt_sensor_imu_taobotics/0.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_sensor_imu_taobotics"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "162b2e05cc21b54fa48563fd50b0fea4ba95583b"
S = "${WORKDIR}/git"
