...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/rolling/mrpt_sensors/0.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_sensors"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "af16f2723ef9781a4045ca4b284759ca7573ae45"
S = "${WORKDIR}/git"
