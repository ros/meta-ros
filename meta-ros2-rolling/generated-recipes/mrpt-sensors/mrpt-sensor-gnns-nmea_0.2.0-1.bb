...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/rolling/mrpt_sensor_gnns_nmea/0.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrpt_sensor_gnns_nmea"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "a6453d9318ca6ba4ee08c892943ba5239f89fb1b"
S = "${WORKDIR}/git"
