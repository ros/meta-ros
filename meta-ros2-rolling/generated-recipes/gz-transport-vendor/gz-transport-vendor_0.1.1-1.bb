...
DESCRIPTION = "Vendor package for: gz-transport13 13.3.0      Gazebo Transport: Provides fast and efficient asynchronous message passing, services, and data logging."
...
# matches with: https://github.com/ros2-gbp/gz_transport_vendor-release/archive/release/rolling/gz_transport_vendor/0.1.1-1.tar.gz
...
SRCREV = "da35d0deb0a969653a599d67162940dd15995fe5"
S = "${WORKDIR}/git"
