...
# matches with: https://github.com/ros2-gbp/point_cloud_transport-release/archive/release/rolling/point_cloud_transport/5.4.0-1.tar.gz
...
SRCREV = "70822400e4974463201a83ce140481b0eea2eb30"
S = "${WORKDIR}/git"
