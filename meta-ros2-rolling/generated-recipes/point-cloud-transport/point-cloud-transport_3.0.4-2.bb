...
# matches with: https://github.com/ros2-gbp/point_cloud_transport-release/archive/release/rolling/point_cloud_transport/3.0.4-2.tar.gz
...
SRCREV = "d0ffe88ee820db5d635dcdfc21f6a8d1bafb6250"
S = "${WORKDIR}/git"
