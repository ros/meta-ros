...
# matches with: https://github.com/ros2-gbp/apriltag_mit-release/archive/release/rolling/apriltag_mit/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/apriltag_mit"
SRC_URI = "git://github.com/ros2-gbp/apriltag_mit-release;${ROS_BRANCH};protocol=https"
SRCREV = "89e951d0a021d4bd34e3e4a08c284d9900f8527e"
S = "${WORKDIR}/git"
