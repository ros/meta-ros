...
# matches with: https://github.com/ros2-gbp/teleop_twist_keyboard-release/archive/release/rolling/teleop_twist_keyboard/2.3.2-4.tar.gz
...
SRCREV = "b3641a0de1498bdbeac844abc3cd86945b8ead29"
S = "${WORKDIR}/git"
