...
# matches with: https://github.com/ros2-gbp/rqt_action-release/archive/release/rolling/rqt_action/1.0.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_action"
SRC_URI = "git://github.com/ros2-gbp/rqt_action-release;${ROS_BRANCH};protocol=https"
SRCREV = "4737aada170acb7bd4af3cf94ecadc02608a0989"
S = "${WORKDIR}/git"
