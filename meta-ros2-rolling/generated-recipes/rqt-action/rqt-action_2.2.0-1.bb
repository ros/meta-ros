...
# matches with: https://github.com/ros2-gbp/rqt_action-release/archive/release/rolling/rqt_action/2.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_action"
SRC_URI = "git://github.com/ros2-gbp/rqt_action-release;${ROS_BRANCH};protocol=https"
SRCREV = "30d78ef32b0cc7326b0ff6a2d40215b2b0d3cbf3"
S = "${WORKDIR}/git"
