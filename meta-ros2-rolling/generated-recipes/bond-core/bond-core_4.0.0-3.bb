...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/bond_core/4.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/bond_core"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "8c38a96686b203e72be32aca33feb4f414d0fdbf"
S = "${WORKDIR}/git"
