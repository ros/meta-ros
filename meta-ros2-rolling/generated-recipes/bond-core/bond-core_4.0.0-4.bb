...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/bond_core/4.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/bond_core"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "7004b482507c08db0c782d3f1e343dbf63bcb097"
S = "${WORKDIR}/git"
