...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/test_bond/3.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/test_bond"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "bbd5b6d9eca9c0c91e35041bf0c2672f52cef0a4"
S = "${WORKDIR}/git"
