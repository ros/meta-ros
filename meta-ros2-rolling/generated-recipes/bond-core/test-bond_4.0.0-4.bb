...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/test_bond/4.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/test_bond"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "692cbfdb1d01299a26458cddc132298e55018fe8"
S = "${WORKDIR}/git"
