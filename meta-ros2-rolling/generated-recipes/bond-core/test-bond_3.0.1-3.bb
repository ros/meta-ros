...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/test_bond/3.0.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/test_bond"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "20df3f93d385c4b9d1f02841e8fb0c140a5465b7"
S = "${WORKDIR}/git"
