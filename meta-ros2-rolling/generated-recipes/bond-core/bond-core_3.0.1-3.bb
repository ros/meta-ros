...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/bond_core/3.0.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/bond_core"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "30b2da7830d1a3d39110bd95760fdfed17676550"
S = "${WORKDIR}/git"
