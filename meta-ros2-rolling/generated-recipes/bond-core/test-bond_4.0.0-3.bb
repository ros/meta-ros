...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/test_bond/4.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/test_bond"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "1eb509e1cfbf615191e34c9128f2c2a7b5fca355"
S = "${WORKDIR}/git"
