...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/bondcpp/3.0.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/bondcpp"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "d67b6547f10e68214e2fca6df722e8b737b1a70a"
S = "${WORKDIR}/git"
