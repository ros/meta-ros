...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/bondcpp/3.0.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/bondcpp"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "290a0656f6be5b86ecc7e505ceaddaaf98ac0d2a"
S = "${WORKDIR}/git"
