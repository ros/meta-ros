...
# matches with: https://github.com/cyberbotics/webots_ros2-release/archive/release/rolling/webots_ros2_universal_robot/1.0.6-1.tar.gz
...
SRCREV = "8ef95aafa835e1a1095147394eddf4d4be240bde"
S = "${WORKDIR}/git"
