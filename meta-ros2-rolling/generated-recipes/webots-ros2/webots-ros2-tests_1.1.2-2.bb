...
# matches with: https://github.com/cyberbotics/webots_ros2-release/archive/release/rolling/webots_ros2_tests/1.1.2-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/webots_ros2_tests"
SRC_URI = "git://github.com/cyberbotics/webots_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "597390acfd28276b8e8c453485a0203729700ada"
S = "${WORKDIR}/git"
