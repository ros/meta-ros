...
# matches with: https://github.com/ros2-gbp/mola_test_datasets-release/archive/release/rolling/mola_test_datasets/0.4.2-1.tar.gz
...
SRCREV = "9b9e8ac1b4147da0e8cb415d6faed31a49b61ba0"
S = "${WORKDIR}/git"
