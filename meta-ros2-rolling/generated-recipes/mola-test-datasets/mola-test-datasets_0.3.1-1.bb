...
# matches with: https://github.com/ros2-gbp/mola_test_datasets-release/archive/release/rolling/mola_test_datasets/0.3.1-1.tar.gz
...
SRCREV = "60cf1a6b3537979a703c9710bbacd4b495dba8cc"
S = "${WORKDIR}/git"
