...
# matches with: https://github.com/ros2-gbp/mola_test_datasets-release/archive/release/rolling/mola_test_datasets/0.3.3-1.tar.gz
...
SRCREV = "8cd00f5caead57771f85ba1a056e3cdd17b2772b"
S = "${WORKDIR}/git"
