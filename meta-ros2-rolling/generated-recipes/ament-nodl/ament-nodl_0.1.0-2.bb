...
# matches with: https://github.com/ros2-gbp/ament_nodl-release/archive/release/rolling/ament_nodl/0.1.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ament_nodl"
SRC_URI = "git://github.com/ros2-gbp/ament_nodl-release;${ROS_BRANCH};protocol=https"
SRCREV = "5f4fc939cffb99a58be43e29d6b05702df237cd5"
S = "${WORKDIR}/git"
