...
# matches with: https://github.com/ros2-gbp/rospy_message_converter-release/archive/release/rolling/rclpy_message_converter_msgs/2.0.1-2.tar.gz
...
SRCREV = "7fcc30f2b6753037a121877057529bf0a58df22b"
S = "${WORKDIR}/git"
