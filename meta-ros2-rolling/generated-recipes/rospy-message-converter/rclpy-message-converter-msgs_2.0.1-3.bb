...
# matches with: https://github.com/ros2-gbp/rospy_message_converter-release/archive/release/rolling/rclpy_message_converter_msgs/2.0.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rclpy_message_converter_msgs"
SRC_URI = "git://github.com/ros2-gbp/rospy_message_converter-release;${ROS_BRANCH};protocol=https"
SRCREV = "f78fa9a61439e3cf69c81775a78b588e8ad72346"
S = "${WORKDIR}/git"
