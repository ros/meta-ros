...
# matches with: https://github.com/ros-drivers-gbp/flir_camera_driver-release/archive/release/rolling/spinnaker_camera_driver/2.0.15-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/spinnaker_camera_driver"
SRC_URI = "git://github.com/ros-drivers-gbp/flir_camera_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "33ee45413838ac84be62d6d622019f27e4afd95f"
S = "${WORKDIR}/git"
