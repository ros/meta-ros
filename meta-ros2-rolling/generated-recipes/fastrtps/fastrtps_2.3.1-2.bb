...
# matches with: https://github.com/ros2-gbp/fastrtps-release/archive/release/rolling/fastrtps/2.3.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fastrtps"
SRC_URI = "git://github.com/ros2-gbp/fastrtps-release;${ROS_BRANCH};protocol=https"
SRCREV = "53900009c4f59910af22c31fe5aec14b5c316ecb"
S = "${WORKDIR}/git"
