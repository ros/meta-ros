...
# matches with: https://github.com/ros2-gbp/gz_utils_vendor-release/archive/release/rolling/gz_utils_vendor/0.3.0-1.tar.gz
...
SRCREV = "25db3b9801287759532d0a1fe64a6e16ae6f4026"
S = "${WORKDIR}/git"
