...
# matches with: https://github.com/ros2-gbp/point_cloud_transport_plugins-release/archive/release/rolling/zlib_point_cloud_transport/6.1.0-1.tar.gz
...
SRCREV = "d6b7a82dc6682e6104db10806723a8a8858ff92c"
S = "${WORKDIR}/git"
