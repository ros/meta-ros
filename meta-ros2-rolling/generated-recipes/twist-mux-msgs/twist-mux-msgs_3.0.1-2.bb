...
# matches with: https://github.com/ros2-gbp/twist_mux_msgs-release/archive/release/rolling/twist_mux_msgs/3.0.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/twist_mux_msgs"
SRC_URI = "git://github.com/ros2-gbp/twist_mux_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "24a68a09c840a3181fcd53dc7234f74c736733b9"
S = "${WORKDIR}/git"
