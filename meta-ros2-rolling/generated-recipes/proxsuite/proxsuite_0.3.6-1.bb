...
# matches with: https://github.com/ros2-gbp/proxsuite-release/archive/release/rolling/proxsuite/0.3.6-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/proxsuite"
SRC_URI = "git://github.com/ros2-gbp/proxsuite-release;${ROS_BRANCH};protocol=https"
SRCREV = "0bb05e03ea2442803060f0a32c9844f028d4631a"
S = "${WORKDIR}/git"
