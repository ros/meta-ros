...
# matches with: https://github.com/ros2-gbp/proxsuite-release/archive/release/rolling/proxsuite/0.6.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/proxsuite"
SRC_URI = "git://github.com/ros2-gbp/proxsuite-release;${ROS_BRANCH};protocol=https"
SRCREV = "2ee8d2f2c67034ad38aff10f644062fb925b33db"
S = "${WORKDIR}/git"
