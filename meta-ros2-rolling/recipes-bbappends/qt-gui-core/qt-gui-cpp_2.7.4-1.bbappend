...
export SIP_PROJECT_INCLUDE_DIRS="${STAGING_DIR_TARGET}/${PYTHON_SITEPACKAGES_DIR}/PyQt5/bindings"
...
DEPENDS += "python3-pyqt5-native python3-pyqt5-sip-native sip-native python3"
