...
# ERROR: Task (libcamera_0.3.0-2.bb:do_configure) failed with exit code '1'
# ../git/meson.build:269:7: ERROR: python3 is missing modules: jinja2, ply, jinja2, yaml
...
# ERROR: libcamera-0.3.0-2-r0 do_package_qa: QA Issue:
