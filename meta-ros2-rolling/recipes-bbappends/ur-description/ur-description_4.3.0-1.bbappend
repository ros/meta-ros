...
_LICENSE := "${LICENSE}"
LICENSE = "${@'${_LICENSE}'.replace('BSD-3-Clause & Universal-Robots-A-S’-Terms-and-Conditions-for-Use-of-Graphical-Documentation', 'BSD-3-Clause AND Universal-Robots-A-S')}"
