...
# matches with: https://github.com/CogRobRelease/catkin_grpc-release/archive/release/noetic/grpc/0.0.12-2.tar.gz
ROS_BRANCH ?= "branch=release/noetic/grpc"
SRC_URI = "git://github.com/CogRobRelease/catkin_grpc-release;${ROS_BRANCH};protocol=https"
SRCREV = "f69ddabe263e4e8db405d3b6424f1ec58fa15ece"
S = "${WORKDIR}/git"
