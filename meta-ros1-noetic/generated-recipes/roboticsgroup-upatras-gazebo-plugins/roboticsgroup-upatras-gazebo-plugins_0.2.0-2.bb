...
# matches with: https://github.com/roboticsgroup/roboticsgroup_upatras_gazebo_plugins-release/archive/release/noetic/roboticsgroup_upatras_gazebo_plugins/0.2.0-2.tar.gz
