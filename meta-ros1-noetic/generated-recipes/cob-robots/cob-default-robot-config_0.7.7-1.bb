...
# matches with: https://github.com/ipa320/cob_robots-release/archive/release/noetic/cob_default_robot_config/0.7.7-1.tar.gz
...
SRCREV = "28d2a44607970b4837a96f6b68b0021cd07cd22d"
S = "${WORKDIR}/git"
