...
# matches with: https://github.com/mavlink/mavros-release/archive/release/noetic/test_mavros/1.19.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/test_mavros"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "6b6e789aca0a98a5a1f98ac581baa12e13c236a9"
S = "${WORKDIR}/git"
