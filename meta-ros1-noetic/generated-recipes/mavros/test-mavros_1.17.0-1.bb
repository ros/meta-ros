...
# matches with: https://github.com/mavlink/mavros-release/archive/release/noetic/test_mavros/1.17.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/test_mavros"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "cddcf5977d2778890714105d7cb739ede29ef8fe"
S = "${WORKDIR}/git"
