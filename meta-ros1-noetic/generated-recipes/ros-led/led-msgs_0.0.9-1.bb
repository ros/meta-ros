...
# matches with: https://github.com/CopterExpress/ros_led-release/archive/release/noetic/led_msgs/0.0.9-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/led_msgs"
SRC_URI = "git://github.com/CopterExpress/ros_led-release;${ROS_BRANCH};protocol=https"
SRCREV = "c4189f65df22a358c5df2ba0cf74470edc5e1f7b"
S = "${WORKDIR}/git"
