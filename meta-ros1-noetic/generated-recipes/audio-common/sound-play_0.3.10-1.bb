...
# matches with: https://github.com/ros-gbp/audio_common-release/archive/release/noetic/sound_play/0.3.10-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/sound_play"
SRC_URI = "git://github.com/ros-gbp/audio_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "d6235c884e64f5ba7befb8e57e28647e2e83a9b5"
S = "${WORKDIR}/git"
