...
# matches with: https://github.com/ros-gbp/audio_common-release/archive/release/noetic/sound_play/0.3.11-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/sound_play"
SRC_URI = "git://github.com/ros-gbp/audio_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "617c8a01ee7384a3d0ed81820ee4253055d56df1"
S = "${WORKDIR}/git"
