...
# matches with: https://github.com/ros-gbp/audio_common-release/archive/release/noetic/sound_play/0.3.14-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/sound_play"
SRC_URI = "git://github.com/ros-gbp/audio_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "44db9a49d865d413235a08c11f80e98330a7e5ae"
S = "${WORKDIR}/git"
