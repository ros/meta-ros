...
# matches with: https://github.com/ros-gbp/joystick_drivers-release/archive/release/noetic/joy/1.15.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/joy"
SRC_URI = "git://github.com/ros-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "dcff0c0a4bd0ecaa987f2e6b6cde57e227ff7ff6"
S = "${WORKDIR}/git"
