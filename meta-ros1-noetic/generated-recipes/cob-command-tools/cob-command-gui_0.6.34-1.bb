...
# matches with: https://github.com/4am-robotics/cob_command_tools-release/archive/release/noetic/cob_command_gui/0.6.34-1.tar.gz
...
SRCREV = "4f9191935e2998a54be1f37038e25192620a38fd"
S = "${WORKDIR}/git"
