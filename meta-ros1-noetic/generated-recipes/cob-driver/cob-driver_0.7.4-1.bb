...
# matches with: https://github.com/ipa320/cob_driver-release/archive/release/noetic/cob_driver/0.7.4-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/cob_driver"
SRC_URI = "git://github.com/ipa320/cob_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "1a0f3bd0fb682edd26513139cf8da8d8e595287d"
S = "${WORKDIR}/git"
