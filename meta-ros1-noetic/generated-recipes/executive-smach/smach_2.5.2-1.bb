...
# matches with: https://github.com/ros-gbp/executive_smach-release/archive/release/noetic/smach/2.5.2-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/smach"
SRC_URI = "git://github.com/ros-gbp/executive_smach-release;${ROS_BRANCH};protocol=https"
SRCREV = "6850677c1a14ecd3680d1d6de25fa29fff30766e"
S = "${WORKDIR}/git"
