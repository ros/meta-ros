...
# matches with: https://github.com/ros-gbp/executive_smach-release/archive/release/noetic/smach/2.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/smach"
SRC_URI = "git://github.com/ros-gbp/executive_smach-release;${ROS_BRANCH};protocol=https"
SRCREV = "640df1ab0008847db9b78de4e5a171228463dd78"
S = "${WORKDIR}/git"
