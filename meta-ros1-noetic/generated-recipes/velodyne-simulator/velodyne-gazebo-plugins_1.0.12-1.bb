...
# matches with: https://github.com/DataspeedInc-release/velodyne_simulator-release/archive/release/noetic/velodyne_gazebo_plugins/1.0.12-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/velodyne_gazebo_plugins"
SRC_URI = "git://github.com/DataspeedInc-release/velodyne_simulator-release;${ROS_BRANCH};protocol=https"
SRCREV = "6a00c40d8cdd63d57b1a390be99a6e88e29e7186"
S = "${WORKDIR}/git"
