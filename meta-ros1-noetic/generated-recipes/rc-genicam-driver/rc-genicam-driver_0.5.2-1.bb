...
# matches with: https://github.com/roboception-gbp/rc_genicam_driver_ros-release/archive/release/noetic/rc_genicam_driver/0.5.2-1.tar.gz
...
SRCREV = "3554b6c8a27b4b0b24068775e7a8685350e7e0d8"
S = "${WORKDIR}/git"
