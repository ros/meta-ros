...
# matches with: https://github.com/botsync-gbp/volta-release/archive/release/noetic/volta_control/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/volta_control"
SRC_URI = "git://github.com/botsync-gbp/volta-release;${ROS_BRANCH};protocol=https"
SRCREV = "3d407910e870e74175080d727362a066ff882bc1"
S = "${WORKDIR}/git"
