...
# matches with: https://github.com/ros-gbp/diagnostics-release/archive/release/noetic/self_test/1.10.2-3.tar.gz
ROS_BRANCH ?= "branch=release/noetic/self_test"
SRC_URI = "git://github.com/ros-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "7bddfddc8445958278f9ed56febf8a6dc30d8ef8"
S = "${WORKDIR}/git"
