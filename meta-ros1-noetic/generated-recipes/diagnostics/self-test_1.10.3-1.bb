...
# matches with: https://github.com/ros-gbp/diagnostics-release/archive/release/noetic/self_test/1.10.3-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/self_test"
SRC_URI = "git://github.com/ros-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "6a7444dcbc3218a29c799c0d8b6ed845ec210d5a"
S = "${WORKDIR}/git"
