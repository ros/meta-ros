...
# matches with: https://github.com/ros-gbp/ros_control-release/archive/release/noetic/ros_control/0.19.6-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/ros_control"
SRC_URI = "git://github.com/ros-gbp/ros_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "bebd89b1219a46180bbc0c4b9abc6278e5311e22"
S = "${WORKDIR}/git"
