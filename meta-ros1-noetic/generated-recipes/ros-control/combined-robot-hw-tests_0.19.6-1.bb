...
# matches with: https://github.com/ros-gbp/ros_control-release/archive/release/noetic/combined_robot_hw_tests/0.19.6-1.tar.gz
...
SRCREV = "83345dd7f08cdaa4ee9b651008525747591294d3"
S = "${WORKDIR}/git"
