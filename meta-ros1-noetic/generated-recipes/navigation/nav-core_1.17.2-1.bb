...
# matches with: https://github.com/ros-gbp/navigation-release/archive/release/noetic/nav_core/1.17.2-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/nav_core"
SRC_URI = "git://github.com/ros-gbp/navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "8ddb96b32971a1fe2e404e35199729e5deda71ab"
S = "${WORKDIR}/git"
