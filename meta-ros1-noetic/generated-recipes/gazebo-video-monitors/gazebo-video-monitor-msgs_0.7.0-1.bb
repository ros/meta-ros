...
# matches with: https://github.com/nlamprian/gazebo_video_monitors-release/archive/release/noetic/gazebo_video_monitor_msgs/0.7.0-1.tar.gz
...
SRCREV = "40ecc490c3eeddae8e2f73b4efb87de4674fe93f"
S = "${WORKDIR}/git"
