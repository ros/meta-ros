...
# matches with: https://github.com/nlamprian/gazebo_video_monitors-release/archive/release/noetic/gazebo_video_monitors/0.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/gazebo_video_monitors"
SRC_URI = "git://github.com/nlamprian/gazebo_video_monitors-release;${ROS_BRANCH};protocol=https"
SRCREV = "90dc42e8f58d932b418727be5ec022da38af7bba"
S = "${WORKDIR}/git"
