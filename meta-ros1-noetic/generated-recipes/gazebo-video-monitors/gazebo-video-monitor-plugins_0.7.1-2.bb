...
# matches with: https://github.com/nlamprian/gazebo_video_monitors-release/archive/release/noetic/gazebo_video_monitor_plugins/0.7.1-2.tar.gz
...
SRCREV = "f74be638ca4a133f6b718ea1398a28474d948207"
S = "${WORKDIR}/git"
