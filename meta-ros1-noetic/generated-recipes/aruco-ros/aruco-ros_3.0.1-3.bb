...
# matches with: https://github.com/pal-gbp/aruco_ros-release/archive/release/noetic/aruco_ros/3.0.1-3.tar.gz
ROS_BRANCH ?= "branch=release/noetic/aruco_ros"
SRC_URI = "git://github.com/pal-gbp/aruco_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "aea0df41b1543ab2bfd26b4e3b81f5b491fd96e9"
S = "${WORKDIR}/git"
