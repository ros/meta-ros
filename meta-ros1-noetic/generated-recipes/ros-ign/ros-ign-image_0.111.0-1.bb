...
# matches with: https://github.com/ros-gbp/ros_ign-release/archive/release/noetic/ros_ign_image/0.111.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/ros_ign_image"
SRC_URI = "git://github.com/ros-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "be9e378865983448747723181bdcb2984e4edb5b"
S = "${WORKDIR}/git"
