...
# matches with: https://github.com/ros-gbp/ros_ign-release/archive/release/noetic/ros_ign_image/0.111.1-2.tar.gz
ROS_BRANCH ?= "branch=release/noetic/ros_ign_image"
SRC_URI = "git://github.com/ros-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "c7bcd020ff8f74fd7afeac304d0da877bf4e2ac1"
S = "${WORKDIR}/git"
