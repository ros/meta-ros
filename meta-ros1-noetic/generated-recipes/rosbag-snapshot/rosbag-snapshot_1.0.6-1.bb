...
# matches with: https://github.com/ros-gbp/rosbag_snapshot-release/archive/release/noetic/rosbag_snapshot/1.0.6-1.tar.gz
...
SRCREV = "b9cd5e07a25ca87d0a0bdab0db1789edbc81cd25"
S = "${WORKDIR}/git"
