...
# matches with: https://github.com/ipab-slmc/exotica-release/archive/release/noetic/exotica_collision_scene_fcl_latest/6.1.1-1.tar.gz
...
SRCREV = "437e715c267a94957031df635a2cd2b0cd9d4e94"
S = "${WORKDIR}/git"
