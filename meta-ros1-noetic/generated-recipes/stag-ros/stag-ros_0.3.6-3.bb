...
# matches with: https://github.com/usrl-uofsc/stag_ros-release/archive/release/noetic/stag_ros/0.3.6-3.tar.gz
ROS_BRANCH ?= "branch=release/noetic/stag_ros"
SRC_URI = "git://github.com/usrl-uofsc/stag_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "43c0a4728ebc6e5606db846657a083a96d5e284d"
S = "${WORKDIR}/git"
