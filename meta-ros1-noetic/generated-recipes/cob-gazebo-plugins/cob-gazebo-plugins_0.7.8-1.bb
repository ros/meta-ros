...
# matches with: https://github.com/ipa320/cob_gazebo_plugins-release/archive/release/noetic/cob_gazebo_plugins/0.7.8-1.tar.gz
...
SRCREV = "1786911f68d8a4fe2ec20d7babfd7b5b122ace52"
S = "${WORKDIR}/git"
