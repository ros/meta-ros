...
# matches with: https://github.com/ros-gbp/rgbd_launch-release/archive/release/noetic/rgbd_launch/2.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rgbd_launch"
SRC_URI = "git://github.com/ros-gbp/rgbd_launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "2c0052dc7a82a98d5ffac89e9513e1478fe36dff"
S = "${WORKDIR}/git"
