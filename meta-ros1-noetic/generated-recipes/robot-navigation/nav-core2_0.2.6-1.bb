...
# matches with: https://github.com/DLu/robot_navigation-release/archive/release/noetic/nav_core2/0.2.6-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/nav_core2"
SRC_URI = "git://github.com/DLu/robot_navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "9730b0cf310f773d8c538b1d25b9d71aed590ace"
S = "${WORKDIR}/git"
