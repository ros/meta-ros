...
# matches with: https://github.com/ros-gbp/geometry2-release/archive/release/noetic/geometry2/0.7.7-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/geometry2"
SRC_URI = "git://github.com/ros-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "1dececca317bd85323e46fa02b32d1bb6eb4cf51"
S = "${WORKDIR}/git"
