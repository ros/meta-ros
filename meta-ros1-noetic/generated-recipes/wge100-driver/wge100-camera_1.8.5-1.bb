...
#         "GPL because of list.h; other files released under BSD-3-Clause"
...
# matches with: https://github.com/ros-drivers-gbp/wge100_driver-release/archive/release/noetic/wge100_camera/1.8.5-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/wge100_camera"
SRC_URI = "git://github.com/ros-drivers-gbp/wge100_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "6458626629e6e22f2f90a9e3b9cf9ae366b928a3"
S = "${WORKDIR}/git"
