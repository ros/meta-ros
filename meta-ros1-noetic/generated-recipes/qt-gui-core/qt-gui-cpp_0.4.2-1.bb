...
# matches with: https://github.com/ros-gbp/qt_gui_core-release/archive/release/noetic/qt_gui_cpp/0.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/qt_gui_cpp"
SRC_URI = "git://github.com/ros-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "c7a43903302ca222476fede775ea2c2cc86ef552"
S = "${WORKDIR}/git"
