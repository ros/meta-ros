...
# matches with: https://github.com/stack-of-tasks/dynamic-graph-python-ros-release/archive/release/noetic/dynamic-graph-python/4.0.1-1.tar.gz
...
SRCREV = "215fdbc0054c95079a1e06d1328958f36d8381a1"
S = "${WORKDIR}/git"
