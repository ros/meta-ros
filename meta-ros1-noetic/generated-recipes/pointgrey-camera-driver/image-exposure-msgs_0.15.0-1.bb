...
# matches with: https://github.com/ros-drivers-gbp/pointgrey_camera_driver-release/archive/release/noetic/image_exposure_msgs/0.15.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/image_exposure_msgs"
SRC_URI = "git://github.com/ros-drivers-gbp/pointgrey_camera_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "a6a18d9ebcac2a985e4bf0b729a388f7f5951798"
S = "${WORKDIR}/git"
