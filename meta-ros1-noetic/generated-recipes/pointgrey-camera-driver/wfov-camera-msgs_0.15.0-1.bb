...
# matches with: https://github.com/ros-drivers-gbp/pointgrey_camera_driver-release/archive/release/noetic/wfov_camera_msgs/0.15.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/wfov_camera_msgs"
SRC_URI = "git://github.com/ros-drivers-gbp/pointgrey_camera_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "fe412ab550dbc45f010fb8db1db3a87499741e67"
S = "${WORKDIR}/git"
