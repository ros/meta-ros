...
# matches with: https://github.com/ros-drivers-gbp/pointgrey_camera_driver-release/archive/release/noetic/statistics_msgs/0.15.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/statistics_msgs"
SRC_URI = "git://github.com/ros-drivers-gbp/pointgrey_camera_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "8675584676a5084d1002e0a240db93fe1bba5db7"
S = "${WORKDIR}/git"
