...
# matches with: https://github.com/ros-industrial-release/universal_robot-release/archive/release/noetic/ur5e_moveit_config/1.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/ur5e_moveit_config"
SRC_URI = "git://github.com/ros-industrial-release/universal_robot-release;${ROS_BRANCH};protocol=https"
SRCREV = "fa6df6f5d2dcd455e78ee9d655c33e6b2806dbcd"
S = "${WORKDIR}/git"
