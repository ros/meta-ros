...
# matches with: https://github.com/ros-industrial-release/universal_robot-release/archive/release/noetic/ur16e_moveit_config/1.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/ur16e_moveit_config"
SRC_URI = "git://github.com/ros-industrial-release/universal_robot-release;${ROS_BRANCH};protocol=https"
SRCREV = "31976baa27e63acb7b96d55cf95885f519b915a9"
S = "${WORKDIR}/git"
