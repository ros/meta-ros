...
# matches with: https://github.com/ros-industrial-release/universal_robot-release/archive/release/noetic/ur20_moveit_config/1.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/ur20_moveit_config"
SRC_URI = "git://github.com/ros-industrial-release/universal_robot-release;${ROS_BRANCH};protocol=https"
SRCREV = "a49a76d0805553fe55f716c573ff7b4b2683d8d3"
S = "${WORKDIR}/git"
