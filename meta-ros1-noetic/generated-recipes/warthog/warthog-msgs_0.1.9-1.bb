...
# matches with: https://github.com/clearpath-gbp/warthog-release/archive/release/noetic/warthog_msgs/0.1.9-1.tar.gz
...
SRCREV = "0125bcbcfdd757f66f13d533db58d5a95f98f09f"
S = "${WORKDIR}/git"
