...
# matches with: https://github.com/peci1/tf2_server-release/archive/release/noetic/tf2_server/1.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/tf2_server"
SRC_URI = "git://github.com/peci1/tf2_server-release;${ROS_BRANCH};protocol=https"
SRCREV = "b30494227127739c1111ba7802fd80963e8a2ec5"
S = "${WORKDIR}/git"
