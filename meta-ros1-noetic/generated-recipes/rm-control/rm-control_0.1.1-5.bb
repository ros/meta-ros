...
# matches with: https://github.com/rm-controls/rm_control-release/archive/release/noetic/rm_control/0.1.1-5.tar.gz
...
SRCREV = "bd9f3a866d8ec5885b4db5cd8dc3d3e619bbb2be"
S = "${WORKDIR}/git"
