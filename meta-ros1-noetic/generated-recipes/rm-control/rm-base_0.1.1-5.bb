...
# matches with: https://github.com/rm-controls/rm_control-release/archive/release/noetic/rm_base/0.1.1-5.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rm_base"
SRC_URI = "git://github.com/rm-controls/rm_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "ed1073e4d6a54bf26fee0b7564ead5ef25fd3059"
S = "${WORKDIR}/git"
