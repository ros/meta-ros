...
# matches with: https://github.com/rm-controls/rm_control-release/archive/release/noetic/rm_hw/0.1.13-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rm_hw"
SRC_URI = "git://github.com/rm-controls/rm_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "52fed356b84163b4bf9935f2a32d3a25cd74a765"
S = "${WORKDIR}/git"
