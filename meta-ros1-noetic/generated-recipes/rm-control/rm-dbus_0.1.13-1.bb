...
# matches with: https://github.com/rm-controls/rm_control-release/archive/release/noetic/rm_dbus/0.1.13-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rm_dbus"
SRC_URI = "git://github.com/rm-controls/rm_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "b7067c98422e5a58d36e6756aad97a20a035c7d9"
S = "${WORKDIR}/git"
