...
# matches with: https://github.com/rm-controls/rm_control-release/archive/release/noetic/rm_msgs/0.1.1-5.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rm_msgs"
SRC_URI = "git://github.com/rm-controls/rm_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "13293156c793db8900a2edcf9d0ef67186c77805"
S = "${WORKDIR}/git"
