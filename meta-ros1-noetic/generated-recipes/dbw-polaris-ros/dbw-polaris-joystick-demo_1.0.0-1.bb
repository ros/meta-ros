...
# matches with: https://github.com/DataspeedInc-release/dbw_polaris_ros-release/archive/release/noetic/dbw_polaris_joystick_demo/1.0.0-1.tar.gz
...
SRCREV = "97212dc6da9d1d4df6a17cade282c12ee862d53f"
S = "${WORKDIR}/git"
