...
# matches with: https://github.com/tork-a/openrtm_aist_python-release/archive/release/noetic/openrtm_aist_python/1.1.0-5.tar.gz
ROS_BRANCH ?= "branch=release/noetic/openrtm_aist_python"
SRC_URI = "git://github.com/tork-a/openrtm_aist_python-release;${ROS_BRANCH};protocol=https"
SRCREV = "142d8f2be41cc0a08fd037c07452e34fe33448e4"
S = "${WORKDIR}/git"
