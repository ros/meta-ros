...
# matches with: https://github.com/stack-of-tasks/tsid-ros-release/archive/release/noetic/tsid/1.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/tsid"
SRC_URI = "git://github.com/stack-of-tasks/tsid-ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "9cf264ea76bd619fccb6c4905c04eeabd5bddefd"
S = "${WORKDIR}/git"
