...
# matches with: https://github.com/FlexBE/flexbe_behavior_engine-release/archive/release/noetic/flexbe_widget/1.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/flexbe_widget"
SRC_URI = "git://github.com/FlexBE/flexbe_behavior_engine-release;${ROS_BRANCH};protocol=https"
SRCREV = "6acd860d0370d4432ebbb25f0048cb6b7972c012"
S = "${WORKDIR}/git"
