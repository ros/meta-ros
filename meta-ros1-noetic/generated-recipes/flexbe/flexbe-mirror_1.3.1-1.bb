...
# matches with: https://github.com/FlexBE/flexbe_behavior_engine-release/archive/release/noetic/flexbe_mirror/1.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/flexbe_mirror"
SRC_URI = "git://github.com/FlexBE/flexbe_behavior_engine-release;${ROS_BRANCH};protocol=https"
SRCREV = "45989b4c581d5e5ff08d3a3bc12c0945f0c0390d"
S = "${WORKDIR}/git"
