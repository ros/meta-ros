...
# matches with: https://github.com/ros-gbp/common_msgs-release/archive/release/noetic/stereo_msgs/1.13.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/stereo_msgs"
SRC_URI = "git://github.com/ros-gbp/common_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "0eb971eeb229093d8b512626e31256c026b0e4b5"
S = "${WORKDIR}/git"
