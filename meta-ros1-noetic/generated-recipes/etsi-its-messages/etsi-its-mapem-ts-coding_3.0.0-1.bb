...
# matches with: https://github.com/ika-rwth-aachen/etsi_its_messages-release/archive/release/noetic/etsi_its_mapem_ts_coding/3.0.0-1.tar.gz
...
SRCREV = "38498df1ae5a2ad805058763990a54690854be5f"
S = "${WORKDIR}/git"
