...
# matches with: https://github.com/ika-rwth-aachen/etsi_its_messages-release/archive/release/noetic/etsi_its_msgs_utils/3.1.0-1.tar.gz
...
SRCREV = "22120a1ed7a02b241a23b3eb1776096fb3e8ce6c"
S = "${WORKDIR}/git"
