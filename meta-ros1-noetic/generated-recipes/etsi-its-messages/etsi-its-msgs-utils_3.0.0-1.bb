...
# matches with: https://github.com/ika-rwth-aachen/etsi_its_messages-release/archive/release/noetic/etsi_its_msgs_utils/3.0.0-1.tar.gz
...
SRCREV = "007229e3486331c2780ecc401ad2db7a6b94fbe1"
S = "${WORKDIR}/git"
