...
# matches with: https://github.com/ros-gbp/moveit-release/archive/release/noetic/moveit_planners/1.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/moveit_planners"
SRC_URI = "git://github.com/ros-gbp/moveit-release;${ROS_BRANCH};protocol=https"
SRCREV = "d39b96b0663670d87282305957292cad8abdecaf"
S = "${WORKDIR}/git"
