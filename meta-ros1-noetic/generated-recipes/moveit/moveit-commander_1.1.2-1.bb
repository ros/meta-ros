...
# matches with: https://github.com/ros-gbp/moveit-release/archive/release/noetic/moveit_commander/1.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/moveit_commander"
SRC_URI = "git://github.com/ros-gbp/moveit-release;${ROS_BRANCH};protocol=https"
SRCREV = "0f3d91d64ef10b89331c3af1b645828ac5fa0a43"
S = "${WORKDIR}/git"
