...
# matches with: https://github.com/ros-gbp/moveit-release/archive/release/noetic/moveit_servo/1.1.9-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/moveit_servo"
SRC_URI = "git://github.com/ros-gbp/moveit-release;${ROS_BRANCH};protocol=https"
SRCREV = "d40f28266761ca01179a4a943d9dc9432934e617"
S = "${WORKDIR}/git"
