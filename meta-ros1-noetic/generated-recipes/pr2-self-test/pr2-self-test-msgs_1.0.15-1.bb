...
# matches with: https://github.com/pr2-gbp/pr2_self_test-release/archive/release/noetic/pr2_self_test_msgs/1.0.15-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/pr2_self_test_msgs"
SRC_URI = "git://github.com/pr2-gbp/pr2_self_test-release;${ROS_BRANCH};protocol=https"
SRCREV = "e787140d7e0165ca27da0010a529e023fd9f0514"
S = "${WORKDIR}/git"
