...
# matches with: https://github.com/eric-wieser/ros_numpy-release/archive/release/noetic/ros_numpy/0.0.4-5.tar.gz
ROS_BRANCH ?= "branch=release/noetic/ros_numpy"
SRC_URI = "git://github.com/eric-wieser/ros_numpy-release;${ROS_BRANCH};protocol=https"
SRCREV = "7e32c5eec12873609408a768e3895efb3d0ee46f"
S = "${WORKDIR}/git"
