...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/topic_tools/1.15.9-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/topic_tools"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "b6f0674f16ccc0c50a2e3ca3a63801cd6a5d4d89"
S = "${WORKDIR}/git"
