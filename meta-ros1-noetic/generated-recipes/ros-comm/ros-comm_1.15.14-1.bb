...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/ros_comm/1.15.14-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/ros_comm"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "cbd0cf6b5d512eeccc8814bdff3602e9e2c3158f"
S = "${WORKDIR}/git"
