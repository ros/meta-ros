...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosparam/1.15.14-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rosparam"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "9be9425b3155c435e447996db665675601924018"
S = "${WORKDIR}/git"
