...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/roslaunch/1.15.9-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/roslaunch"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "2d87343e0ed4bd4ade20299067899e89fca0b62d"
S = "${WORKDIR}/git"
