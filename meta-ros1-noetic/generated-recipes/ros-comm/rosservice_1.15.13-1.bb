...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosservice/1.15.13-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rosservice"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "ccbd310d30a40d61108e8c836c91a2c2445fb706"
S = "${WORKDIR}/git"
