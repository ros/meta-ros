...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/roslaunch/1.15.11-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/roslaunch"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "12fc6ca2625ca0fa255ede49188315433cf4e5be"
S = "${WORKDIR}/git"
