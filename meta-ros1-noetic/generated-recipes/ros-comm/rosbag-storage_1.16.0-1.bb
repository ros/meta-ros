...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosbag_storage/1.16.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rosbag_storage"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "f6988747ac9fd9bf9c54a1904770536b4084e4e6"
S = "${WORKDIR}/git"
