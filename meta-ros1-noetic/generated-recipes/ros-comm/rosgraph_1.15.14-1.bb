...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosgraph/1.15.14-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rosgraph"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "4d1458a19157bc101fd7c8cd89d1d9d7e9d7bdd4"
S = "${WORKDIR}/git"
