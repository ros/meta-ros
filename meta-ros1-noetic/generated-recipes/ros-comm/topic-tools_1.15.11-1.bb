...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/topic_tools/1.15.11-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/topic_tools"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "0a6ca9b3da500560282c93682cd7b25c64a4aad6"
S = "${WORKDIR}/git"
