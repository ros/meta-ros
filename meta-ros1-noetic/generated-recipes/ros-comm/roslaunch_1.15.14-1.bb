...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/roslaunch/1.15.14-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/roslaunch"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "db1bbc6bffc15d7f011260ede9c4726a64ffc418"
S = "${WORKDIR}/git"
