...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosparam/1.15.13-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rosparam"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "16d88bcbfc6538447f04392f267cf237dea6223f"
S = "${WORKDIR}/git"
