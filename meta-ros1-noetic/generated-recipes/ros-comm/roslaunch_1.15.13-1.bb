...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/roslaunch/1.15.13-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/roslaunch"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "c447347b12d74bd5a4ad30a7260a514b401216a7"
S = "${WORKDIR}/git"
