...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosservice/1.17.2-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rosservice"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "258ca4d378b2a2cbb4f3603cafc50d5a7343c96e"
S = "${WORKDIR}/git"
