...
# matches with: https://github.com/roboception-gbp/rc_reason_clients_ros-release/archive/release/noetic/rc_reason_clients/0.3.1-1.tar.gz
...
SRCREV = "496565f286534e6a4a0f79b9c822056386160ac7"
S = "${WORKDIR}/git"
