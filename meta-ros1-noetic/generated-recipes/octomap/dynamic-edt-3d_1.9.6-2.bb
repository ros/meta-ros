...
# matches with: https://github.com/ros-gbp/octomap-release/archive/release/noetic/dynamic_edt_3d/1.9.6-2.tar.gz
ROS_BRANCH ?= "branch=release/noetic/dynamic_edt_3d"
SRC_URI = "git://github.com/ros-gbp/octomap-release;${ROS_BRANCH};protocol=https"
SRCREV = "346537d82f00a8da3b243e0e2ecd8af84d2fc833"
S = "${WORKDIR}/git"
