...
# matches with: https://github.com/ros-gbp/octomap-release/archive/release/noetic/dynamic_edt_3d/1.9.7-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/dynamic_edt_3d"
SRC_URI = "git://github.com/ros-gbp/octomap-release;${ROS_BRANCH};protocol=https"
SRCREV = "fd598e4400fe32478ed081e993d85098dd49dead"
S = "${WORKDIR}/git"
