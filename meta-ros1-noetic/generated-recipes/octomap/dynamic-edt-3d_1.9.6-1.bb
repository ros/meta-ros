...
# matches with: https://github.com/ros-gbp/octomap-release/archive/release/noetic/dynamic_edt_3d/1.9.6-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/dynamic_edt_3d"
SRC_URI = "git://github.com/ros-gbp/octomap-release;${ROS_BRANCH};protocol=https"
SRCREV = "2ec0cd0ef3586a2f6b02555268536bd3c7dd6cf2"
S = "${WORKDIR}/git"
