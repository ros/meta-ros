...
# matches with: https://github.com/ros-gbp/app_manager-release/archive/release/noetic/app_manager/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/app_manager"
SRC_URI = "git://github.com/ros-gbp/app_manager-release;${ROS_BRANCH};protocol=https"
SRCREV = "f6a0d2d0bd0ec04f8a29aadf51ee5b0aa1eccf4e"
S = "${WORKDIR}/git"
