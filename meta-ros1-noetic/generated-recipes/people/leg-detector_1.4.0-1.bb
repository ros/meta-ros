...
ROS_BUILD_DEPENDS = " \
    ${ROS_UNRESOLVED_DEP-liborocos-bfl} \
    dynamic-reconfigure \
    geometry-msgs \
    image-geometry \
    laser-geometry \
...
# matches with: https://github.com/OSUrobotics/people-release/archive/release/noetic/leg_detector/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/leg_detector"
SRC_URI = "git://github.com/OSUrobotics/people-release;${ROS_BRANCH};protocol=https"
SRCREV = "59d414923159506f6b5fce828507008705221982"
S = "${WORKDIR}/git"
