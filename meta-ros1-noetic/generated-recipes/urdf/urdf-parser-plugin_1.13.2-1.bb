...
# matches with: https://github.com/ros-gbp/urdf-release/archive/release/noetic/urdf_parser_plugin/1.13.2-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/urdf_parser_plugin"
SRC_URI = "git://github.com/ros-gbp/urdf-release;${ROS_BRANCH};protocol=https"
SRCREV = "ec123c82273e8cf4e69d4b6c299275ce3587487d"
S = "${WORKDIR}/git"
