...
# matches with: https://github.com/nobleo/magic_enum-release/archive/release/noetic/magic_enum/0.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/magic_enum"
SRC_URI = "git://github.com/nobleo/magic_enum-release;${ROS_BRANCH};protocol=https"
SRCREV = "a49f3592fd2b9008f7b26d0ffe85bfdd92bd07a0"
S = "${WORKDIR}/git"
