...
# matches with: https://github.com/astuff/astuff_sensor_msgs-release/archive/release/noetic/astuff_sensor_msgs/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/astuff_sensor_msgs"
SRC_URI = "git://github.com/astuff/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "db3efec1e7954dbd801f98457bc76f050750d5b5"
S = "${WORKDIR}/git"
