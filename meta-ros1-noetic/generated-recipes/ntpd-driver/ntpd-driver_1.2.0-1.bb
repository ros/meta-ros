...
# matches with: https://github.com/vooon/ntpd_driver-release/archive/release/noetic/ntpd_driver/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/ntpd_driver"
SRC_URI = "git://github.com/vooon/ntpd_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "41ef8f8f08bfcbdbe5e9cde77a3370baa6d40c9a"
S = "${WORKDIR}/git"
