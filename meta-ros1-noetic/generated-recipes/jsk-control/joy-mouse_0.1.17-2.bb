...
ROS_BUILD_DEPENDS = " \
    ${ROS_UNRESOLVED_DEP-python3-pyudev} \
    rospy \
    sensor-msgs \
"
...
# matches with: https://github.com/tork-a/jsk_control-release/archive/release/noetic/joy_mouse/0.1.17-2.tar.gz
ROS_BRANCH ?= "branch=release/noetic/joy_mouse"
SRC_URI = "git://github.com/tork-a/jsk_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "a62f0bb606f23e857b62fecc5c134d69c64ff7d4"
S = "${WORKDIR}/git"
