...
# matches with: https://github.com/eupedrosa/iris_lama-release/archive/release/noetic/iris_lama/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/iris_lama"
SRC_URI = "git://github.com/eupedrosa/iris_lama-release;${ROS_BRANCH};protocol=https"
SRCREV = "cdc27351e791e7bf10a28ef1cbc877a8a5ee9dba"
S = "${WORKDIR}/git"
