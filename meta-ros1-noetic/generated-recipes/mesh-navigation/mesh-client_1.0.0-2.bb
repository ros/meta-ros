...
# matches with: https://github.com/uos-gbp/mesh_navigation-release/archive/release/noetic/mesh_client/1.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/noetic/mesh_client"
SRC_URI = "git://github.com/uos-gbp/mesh_navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "ee88ab1839b522ea6a89c46339f6a8aff3529e24"
S = "${WORKDIR}/git"
