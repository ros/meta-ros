...
# matches with: https://github.com/fkie-release/async_web_server_cpp-release/archive/release/noetic/async_web_server_cpp/1.0.2-1.tar.gz
...
SRCREV = "cbacf449174620bed14053d3713220926470759f"
S = "${WORKDIR}/git"
