...
# matches with: https://github.com/fkie-release/multimaster_fkie-release/archive/release/noetic/fkie_node_manager_daemon/1.2.5-2.tar.gz
...
SRCREV = "fb2cd8088be9aa87642ce85d5f58727d53d7373e"
S = "${WORKDIR}/git"
