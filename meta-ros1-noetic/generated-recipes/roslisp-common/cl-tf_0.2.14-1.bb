...
# matches with: https://github.com/ros-gbp/roslisp_common-release/archive/release/noetic/cl_tf/0.2.14-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/cl_tf"
SRC_URI = "git://github.com/ros-gbp/roslisp_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "dfd1260543bed199c8ef5749dfd60acdf0bc393b"
S = "${WORKDIR}/git"
