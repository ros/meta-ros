...
# matches with: https://github.com/ros-gbp/roslisp_common-release/archive/release/noetic/cl_utils/0.2.14-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/cl_utils"
SRC_URI = "git://github.com/ros-gbp/roslisp_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "d8446c99013023e0ba0da7534581a9646f78d291"
S = "${WORKDIR}/git"
