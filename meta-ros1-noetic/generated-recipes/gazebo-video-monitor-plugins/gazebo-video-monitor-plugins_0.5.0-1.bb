...
# matches with: https://github.com/nlamprian/gazebo_video_monitor_plugins-release/archive/release/noetic/gazebo_video_monitor_plugins/0.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/gazebo_video_monitor_plugins"
SRC_URI = "git://github.com/nlamprian/gazebo_video_monitor_plugins-release;${ROS_BRANCH};protocol=https"
SRCREV = "39699ca727bb538cd83336210beaf5e571ff1abf"
S = "${WORKDIR}/git"
