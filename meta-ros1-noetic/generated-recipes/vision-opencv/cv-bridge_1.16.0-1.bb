...
# matches with: https://github.com/ros-gbp/vision_opencv-release/archive/release/noetic/cv_bridge/1.16.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/cv_bridge"
SRC_URI = "git://github.com/ros-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "b2d15724843030cb9d3801ea17af40619db89540"
S = "${WORKDIR}/git"
