...
# matches with: https://github.com/swri-robotics-gbp/mapviz-release/archive/release/noetic/mapviz/1.4.1-2.tar.gz
ROS_BRANCH ?= "branch=release/noetic/mapviz"
SRC_URI = "git://github.com/swri-robotics-gbp/mapviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "d7be985b57f6cac72c40a9eca0521340cd187c17"
S = "${WORKDIR}/git"
