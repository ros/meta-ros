...
# matches with: https://github.com/swri-robotics-gbp/mapviz-release/archive/release/noetic/mapviz/1.4.1-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/mapviz"
SRC_URI = "git://github.com/swri-robotics-gbp/mapviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "4bf44b4facf8e08b8a24d912be6712d47f0e9cf0"
S = "${WORKDIR}/git"
