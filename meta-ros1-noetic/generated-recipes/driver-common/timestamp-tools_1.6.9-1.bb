...
# matches with: https://github.com/ros-gbp/driver_common-release/archive/release/noetic/timestamp_tools/1.6.9-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/timestamp_tools"
SRC_URI = "git://github.com/ros-gbp/driver_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "dfa5cdb765720c4bbb58a72c1906c54050608ec1"
S = "${WORKDIR}/git"
