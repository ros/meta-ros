...
# ERROR: leo-teleop-1.2.1-1-r0 do_package_qa: QA Issue: /usr/opt/ros/noetic/lib/leo_teleop/scripts/key_teleop contained in package leo-teleop requires /bin/bash, but no providers found in RDEPENDS_leo-teleop? [file-rdeps]
RDEPENDS_${PN} += "bash"
