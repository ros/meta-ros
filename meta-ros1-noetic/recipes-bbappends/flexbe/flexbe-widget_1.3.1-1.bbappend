...
# ERROR: flexbe-widget-1.3.1-1-r0 do_package_qa: QA Issue: /usr/opt/ros/noetic/lib/flexbe_widget/evaluate_logs contained in package flexbe-widget requires /bin/bash, but no providers found in RDEPENDS_flexbe-widget? [file-rdeps]
RDEPENDS_${PN} += "bash"
