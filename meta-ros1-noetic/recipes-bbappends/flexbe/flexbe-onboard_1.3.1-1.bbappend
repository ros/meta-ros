...
# ERROR: flexbe-onboard-1.3.1-1-r0 do_package_qa: QA Issue: /usr/opt/ros/noetic/lib/flexbe_onboard/start_behavior contained in package flexbe-onboard requires /bin/bash, but no providers found in RDEPENDS:flexbe-onboard? [file-rdeps]
RDEPENDS:${PN} += "bash"
