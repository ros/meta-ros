...
# ERROR: flexbe-input-1.3.1-1-r0 do_package_qa: QA Issue: /usr/opt/ros/noetic/lib/flexbe_input/behavior_input contained in package flexbe-input requires /bin/bash, but no providers found in RDEPENDS:flexbe-input? [file-rdeps]
RDEPENDS:${PN} += "bash"
