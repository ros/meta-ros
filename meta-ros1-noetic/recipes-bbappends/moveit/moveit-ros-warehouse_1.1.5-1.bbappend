...
# ERROR: moveit-ros-warehouse-1.0.2-1-r0 do_package_qa: QA Issue: /opt/ros/melodic/lib/moveit_ros_warehouse/moveit_warehouse_services contained in package moveit-ros-warehouse requires libmoveit_warehouse.so.1.0.2()(64bit), but no providers found in RDEPENDS:moveit-ros-warehouse? [file-rdeps]
