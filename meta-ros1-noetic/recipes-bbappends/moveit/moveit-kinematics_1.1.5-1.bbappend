...
# ERROR: moveit-kinematics-1.0.2-1-r0 do_package_qa: QA Issue: /usr/opt/ros/melodic/lib/moveit_kinematics/auto_create_ikfast_moveit_plugin.sh contained in package moveit-kinematics requires /bin/bash, but no providers found in RDEPENDS:moveit-kinematics? [file-rdeps]
RDEPENDS:${PN} += "bash"
