...
# ERROR: moveit-planners-ompl-1.0.2-1-r0 do_package_qa: QA Issue: /opt/ros/melodic/lib/moveit_planners_ompl/moveit_ompl_planner contained in package moveit-planners-ompl requires libmoveit_ompl_interface.so.1.0.2()(64bit), but no providers found in RDEPENDS:moveit-planners-ompl? [file-rdeps]
