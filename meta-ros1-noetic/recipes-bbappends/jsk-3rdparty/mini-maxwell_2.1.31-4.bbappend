...
# ERROR: mini-maxwell-2.1.13-1-r0 do_package_qa: QA Issue: /opt/ros/melodic/share/mini_maxwell/scripts/setfilters26.py contained in package mini-maxwell requires /bin/env, but no providers found in RDEPENDS:mini-maxwell? [file-rdeps]
# ERROR: mini-maxwell-2.1.13-1-r0 do_package_qa: QA Issue: /opt/ros/melodic/share/mini_maxwell/scripts/setfilters.py contained in package mini-maxwell requires /bin/env, but no providers found in RDEPENDS:mini-maxwell? [file-rdeps]
# ...
