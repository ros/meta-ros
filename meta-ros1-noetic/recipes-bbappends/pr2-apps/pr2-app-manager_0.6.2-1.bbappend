...
# ERROR: pr2-app-manager-0.6.1-r0 do_package_qa: QA Issue: /opt/ros/noetic/lib/pr2_app_manager/install_applications.sh contained in package pr2-app-manager requires /bin/bash, but no providers found in RDEPENDS:pr2-app-manager? [file-rdeps]
RDEPENDS:${PN} += "bash"
