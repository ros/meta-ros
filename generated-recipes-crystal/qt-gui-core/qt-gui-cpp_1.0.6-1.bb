...
SRC_URI = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/crystal/qt_gui_cpp/1.0.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "0d5e5f6cec0a03265519eeb6694c8644"
SRC_URI[sha256sum] = "e96c60d3baab759e5bcbfb25f79d4a23bf901e99134d06dd01d2f25490c2abf6"
S = "${WORKDIR}/qt_gui_core-release-release-crystal-qt_gui_cpp-1.0.6-1"
