...
SRC_URI = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/crystal/qt_dotgraph/1.0.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "0471a7eb06f1f85f05f14c4c479f10d3"
SRC_URI[sha256sum] = "f67cf44c9975de2788be0dce6898d2c7924516ae4e74f1354c94adceb3ed6d23"
S = "${WORKDIR}/qt_gui_core-release-release-crystal-qt_dotgraph-1.0.6-1"
