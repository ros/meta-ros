...
SRC_URI = "https://github.com/ros-gbp/control_msgs-release/archive/release/crystal/control_msgs/2.2.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "8fbac59455a5cd2a2cdffbb3b7662d1f"
SRC_URI[sha256sum] = "cd8efc04d5acd9d2e2ed35538300b7f488197cfde2a34ab2f769dad99ee058ca"
S = "${WORKDIR}/control_msgs-release-release-crystal-control_msgs-2.2.0-1"
