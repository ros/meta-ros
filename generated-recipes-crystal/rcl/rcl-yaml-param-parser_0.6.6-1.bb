...
SRC_URI = "https://github.com/ros2-gbp/rcl-release/archive/release/crystal/rcl_yaml_param_parser/0.6.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f828c669f88c69d1cd5441ab32133794"
SRC_URI[sha256sum] = "36a57efcbf15db7c2e71af5c82d59017c74b4b80c3ed9a90be023b47fd8efd1b"
S = "${WORKDIR}/rcl-release-release-crystal-rcl_yaml_param_parser-0.6.6-1"
