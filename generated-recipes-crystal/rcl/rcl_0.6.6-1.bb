...
SRC_URI = "https://github.com/ros2-gbp/rcl-release/archive/release/crystal/rcl/0.6.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d4bef0f4fb2449cfd41b845506014f2f"
SRC_URI[sha256sum] = "e98f83aac311ace0a9b1d83d7f1a03765410e68f6281f74c080765133f4cb8cd"
S = "${WORKDIR}/rcl-release-release-crystal-rcl-0.6.6-1"
