...
SRC_URI = "git://github.com/gazebosim/gz-common.git;protocol=https;branch=gz-common7"

SRCREV = "307a1bf465acad02941f4862bb9b84879b8cbb72"
...
FILES:${PN} += " \
    ${datadir}/gz/gz-common/profiler_vis/* \
"
