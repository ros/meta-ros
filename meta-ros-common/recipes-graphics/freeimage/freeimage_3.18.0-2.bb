...
do_install () {
        ...
        install -m 644 Source/FreeImage.h ${D}${includedir}
        install -m 644 libfreeimage.a ${D}${libdir}
        install -m 755 libfreeimage-3.18.0.so ${D}${libdir}
        ln -sf libfreeimage-3.18.0.so ${D}${libdir}/libfreeimage.so.3
        ln -sf libfreeimage.so.3 ${D}${libdir}/libfreeimage.so
}
