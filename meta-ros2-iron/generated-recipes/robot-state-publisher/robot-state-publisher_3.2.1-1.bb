...
# matches with: https://github.com/ros2-gbp/robot_state_publisher-release/archive/release/iron/robot_state_publisher/3.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/robot_state_publisher"
SRC_URI = "git://github.com/ros2-gbp/robot_state_publisher-release;${ROS_BRANCH};protocol=https"
SRCREV = "16f43bc6b145106eca33945d996c9d7fa8d1f872"
S = "${WORKDIR}/git"
