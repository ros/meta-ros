...
# matches with: https://github.com/ros2-gbp/ros2_tracing-release/archive/release/iron/tracetools_read/6.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/tracetools_read"
SRC_URI = "git://github.com/ros2-gbp/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "909385196cfc79f1c316353aa387e08d0e5c67a9"
S = "${WORKDIR}/git"
