...
# matches with: https://github.com/ros2-gbp/ros2_tracing-release/archive/release/iron/tracetools/6.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/tracetools"
SRC_URI = "git://github.com/ros2-gbp/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "362371a7b4aad9479194c07e0ef3528124f4ce5e"
S = "${WORKDIR}/git"
