...
# matches with: https://github.com/ros2-gbp/rqt_moveit-release/archive/release/iron/rqt_moveit/1.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/rqt_moveit"
SRC_URI = "git://github.com/ros2-gbp/rqt_moveit-release;${ROS_BRANCH};protocol=https"
SRCREV = "b88503b759b1af4e474ed14132fe30e0dd4cc350"
S = "${WORKDIR}/git"
