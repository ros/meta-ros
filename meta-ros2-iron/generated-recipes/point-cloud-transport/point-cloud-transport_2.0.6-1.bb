...
# matches with: https://github.com/ros2-gbp/point_cloud_transport-release/archive/release/iron/point_cloud_transport/2.0.6-1.tar.gz
...
SRCREV = "abcacf7a4a6ef16ac907ddc918e5b7b60647e536"
S = "${WORKDIR}/git"
