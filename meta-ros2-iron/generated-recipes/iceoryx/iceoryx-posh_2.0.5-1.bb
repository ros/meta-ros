...
# matches with: https://github.com/ros2-gbp/iceoryx-release/archive/release/iron/iceoryx_posh/2.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/iceoryx_posh"
SRC_URI = "git://github.com/ros2-gbp/iceoryx-release;${ROS_BRANCH};protocol=https"
SRCREV = "19b490eeceacdba09d0e005422799df70ca49595"
S = "${WORKDIR}/git"
