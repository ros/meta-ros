...
# matches with: https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/iron/ntrip_client_node/0.5.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ntrip_client_node"
SRC_URI = "git://github.com/ros2-gbp/ublox_dgnss-release;${ROS_BRANCH};protocol=https"
SRCREV = "e81530062d97b7df693b4d6cf88812b216e5d496"
S = "${WORKDIR}/git"
