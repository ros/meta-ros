...
# matches with: https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/iron/ublox_dgnss/0.5.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ublox_dgnss"
SRC_URI = "git://github.com/ros2-gbp/ublox_dgnss-release;${ROS_BRANCH};protocol=https"
SRCREV = "ccf7c8c27cc24ae5eff3972fa59a0edf2c2988cc"
S = "${WORKDIR}/git"
