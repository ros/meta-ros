...
# matches with: https://github.com/ros2-gbp/warehouse_ros-release/archive/release/iron/warehouse_ros/2.0.4-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/warehouse_ros"
SRC_URI = "git://github.com/ros2-gbp/warehouse_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "d4ccdf47f8d8747674ec4befed9c873a834043ce"
S = "${WORKDIR}/git"
