...
# matches with: https://github.com/ros2-gbp/robot_calibration-release/archive/release/iron/robot_calibration_msgs/0.8.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/robot_calibration_msgs"
SRC_URI = "git://github.com/ros2-gbp/robot_calibration-release;${ROS_BRANCH};protocol=https"
SRCREV = "ac402100e099d588dcdf70e55af3e39787568b64"
S = "${WORKDIR}/git"
