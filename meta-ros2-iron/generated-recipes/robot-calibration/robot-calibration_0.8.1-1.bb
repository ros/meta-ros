...
# matches with: https://github.com/ros2-gbp/robot_calibration-release/archive/release/iron/robot_calibration/0.8.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/robot_calibration"
SRC_URI = "git://github.com/ros2-gbp/robot_calibration-release;${ROS_BRANCH};protocol=https"
SRCREV = "54aebc13f910c953a5f5fdc388ca91068f333d32"
S = "${WORKDIR}/git"
