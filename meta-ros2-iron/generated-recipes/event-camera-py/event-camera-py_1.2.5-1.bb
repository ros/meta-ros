...
# matches with: https://github.com/ros2-gbp/event_camera_py-release/archive/release/iron/event_camera_py/1.2.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/event_camera_py"
SRC_URI = "git://github.com/ros2-gbp/event_camera_py-release;${ROS_BRANCH};protocol=https"
SRCREV = "bb2ab5abd57effb648078c15ff548952ed647c27"
S = "${WORKDIR}/git"
