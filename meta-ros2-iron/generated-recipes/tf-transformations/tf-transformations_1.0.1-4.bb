...
# matches with: https://github.com/ros2-gbp/tf_transformations_release/archive/release/iron/tf_transformations/1.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/tf_transformations"
SRC_URI = "git://github.com/ros2-gbp/tf_transformations_release;${ROS_BRANCH};protocol=https"
SRCREV = "d52196e572c6a1ff18a6854fea630824f84c7b40"
S = "${WORKDIR}/git"
