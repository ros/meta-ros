...
# matches with: https://github.com/ros2-gbp/image_pipeline-release/archive/release/iron/image_pipeline/4.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/image_pipeline"
SRC_URI = "git://github.com/ros2-gbp/image_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "01c507088be4d5fbea9ff0c56f1182f94cc8ed4b"
S = "${WORKDIR}/git"
