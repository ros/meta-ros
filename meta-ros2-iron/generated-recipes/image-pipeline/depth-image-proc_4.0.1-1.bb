...
# matches with: https://github.com/ros2-gbp/image_pipeline-release/archive/release/iron/depth_image_proc/4.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/depth_image_proc"
SRC_URI = "git://github.com/ros2-gbp/image_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "1556a18dddc145428b01e668d72416304b64c3db"
S = "${WORKDIR}/git"
