...
# matches with: https://github.com/ros2-gbp/image_pipeline-release/archive/release/iron/stereo_image_proc/4.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/stereo_image_proc"
SRC_URI = "git://github.com/ros2-gbp/image_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "e8202efc6b0fc188dcb7c3439ca427ae2540e501"
S = "${WORKDIR}/git"
