...
# matches with: https://github.com/ros2-gbp/image_pipeline-release/archive/release/iron/image_publisher/4.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/image_publisher"
SRC_URI = "git://github.com/ros2-gbp/image_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "08b2e1790425830ec2222fc4af40e8f5e4d7c1d4"
S = "${WORKDIR}/git"
