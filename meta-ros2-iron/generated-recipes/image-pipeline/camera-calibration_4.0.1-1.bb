...
# matches with: https://github.com/ros2-gbp/image_pipeline-release/archive/release/iron/camera_calibration/4.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/camera_calibration"
SRC_URI = "git://github.com/ros2-gbp/image_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "d5f4eae5d477e6950ac3e825e4a090ec24dcee37"
S = "${WORKDIR}/git"
