...
# matches with: https://github.com/ros2-gbp/simple_launch-release/archive/release/iron/simple_launch/1.10.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/simple_launch"
SRC_URI = "git://github.com/ros2-gbp/simple_launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "f92c05685cfe961696f0944dc851521f2bddfa5b"
S = "${WORKDIR}/git"
