...
# matches with: https://github.com/ros2-gbp/ntrip_client-release/archive/release/iron/ntrip_client/1.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ntrip_client"
SRC_URI = "git://github.com/ros2-gbp/ntrip_client-release;${ROS_BRANCH};protocol=https"
SRCREV = "198353864267aa41c457fac2c4ec97a4ef5c2c69"
S = "${WORKDIR}/git"
