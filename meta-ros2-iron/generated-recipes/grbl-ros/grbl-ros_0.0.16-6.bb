...
# matches with: https://github.com/ros2-gbp/grbl_ros-release/archive/release/iron/grbl_ros/0.0.16-6.tar.gz
ROS_BRANCH ?= "branch=release/iron/grbl_ros"
SRC_URI = "git://github.com/ros2-gbp/grbl_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "7c6460f80349cc4b74f6b1bcfbebc79178e94077"
S = "${WORKDIR}/git"
