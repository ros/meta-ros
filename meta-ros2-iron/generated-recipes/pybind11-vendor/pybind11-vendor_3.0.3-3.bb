...
# matches with: https://github.com/ros2-gbp/pybind11_vendor-release/archive/release/iron/pybind11_vendor/3.0.3-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/pybind11_vendor"
SRC_URI = "git://github.com/ros2-gbp/pybind11_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "040893b92117e1a5361cf4d3013682641c8979b7"
S = "${WORKDIR}/git"
