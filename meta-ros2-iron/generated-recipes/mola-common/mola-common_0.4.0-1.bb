...
# matches with: https://github.com/ros2-gbp/mola_common-release/archive/release/iron/mola_common/0.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_common"
SRC_URI = "git://github.com/ros2-gbp/mola_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "bf335dba83917a7d03f4fe9f25d6f25455cd1b52"
S = "${WORKDIR}/git"
