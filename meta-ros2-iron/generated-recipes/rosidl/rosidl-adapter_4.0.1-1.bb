...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/iron/rosidl_adapter/4.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rosidl_adapter"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "c978ac3581f6b2cf1552382182c7d9986ed1e925"
S = "${WORKDIR}/git"
