...
# matches with: https://github.com/ros2-gbp/twist_mux_msgs-release/archive/release/iron/twist_mux_msgs/3.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/twist_mux_msgs"
SRC_URI = "git://github.com/ros2-gbp/twist_mux_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "3afa3546fed35690564d6999662d151614b42ac3"
S = "${WORKDIR}/git"
