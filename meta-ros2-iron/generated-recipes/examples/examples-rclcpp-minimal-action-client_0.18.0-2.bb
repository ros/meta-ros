...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/iron/examples_rclcpp_minimal_action_client/0.18.0-2.tar.gz
ROS_BRANCH ?= "branch=release/iron/examples_rclcpp_minimal_action_client"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "573e26bed53dd6bd71d660ee458b29decab254c8"
S = "${WORKDIR}/git"
