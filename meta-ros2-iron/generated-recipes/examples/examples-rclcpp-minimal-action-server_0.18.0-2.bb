...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/iron/examples_rclcpp_minimal_action_server/0.18.0-2.tar.gz
ROS_BRANCH ?= "branch=release/iron/examples_rclcpp_minimal_action_server"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "de3e862777489004bc4dc37f1450332344b8816f"
S = "${WORKDIR}/git"
