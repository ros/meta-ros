...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/iron/examples_rclpy_pointcloud_publisher/0.18.0-2.tar.gz
ROS_BRANCH ?= "branch=release/iron/examples_rclpy_pointcloud_publisher"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "427612fdba65ac680521ed7698155da4b269ab4f"
S = "${WORKDIR}/git"
