...
# matches with: https://github.com/ros2-gbp/ament_cmake_ros-release/archive/release/iron/domain_coordinator/0.11.2-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/domain_coordinator"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "e12d5e00415761ce94b21de7dea73d96276071a6"
S = "${WORKDIR}/git"
