...
# matches with: https://github.com/ros2-gbp/control_box_rst-release/archive/release/iron/control_box_rst/0.0.7-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/control_box_rst"
SRC_URI = "git://github.com/ros2-gbp/control_box_rst-release;${ROS_BRANCH};protocol=https"
SRCREV = "f774b86c6fde89d4b30757d933e6138d21524302"
S = "${WORKDIR}/git"
