...
# matches with: https://github.com/SICKAG/sick_safetyscanners_base-release/archive/release/iron/sick_safetyscanners_base/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/sick_safetyscanners_base"
SRC_URI = "git://github.com/SICKAG/sick_safetyscanners_base-release;${ROS_BRANCH};protocol=https"
SRCREV = "cb078cc4bfc9bd39fd557421e851799d4c07e4db"
S = "${WORKDIR}/git"
