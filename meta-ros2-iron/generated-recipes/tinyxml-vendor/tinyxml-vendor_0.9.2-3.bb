...
# matches with: https://github.com/ros2-gbp/tinyxml_vendor-release/archive/release/iron/tinyxml_vendor/0.9.2-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/tinyxml_vendor"
SRC_URI = "git://github.com/ros2-gbp/tinyxml_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "8fa1bfa617c71ed5fdc82de6cc3a66fe1ae5da94"
S = "${WORKDIR}/git"
