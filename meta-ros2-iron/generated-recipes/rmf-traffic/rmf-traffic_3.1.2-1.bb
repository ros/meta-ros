...
# matches with: https://github.com/ros2-gbp/rmf_traffic-release/archive/release/iron/rmf_traffic/3.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rmf_traffic"
SRC_URI = "git://github.com/ros2-gbp/rmf_traffic-release;${ROS_BRANCH};protocol=https"
SRCREV = "5cfc70ff9df6e4bc35d2963fea51f33a6d49785e"
S = "${WORKDIR}/git"
