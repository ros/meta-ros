...
# matches with: https://github.com/ros2-gbp/rmf_traffic-release/archive/release/iron/rmf_traffic/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rmf_traffic"
SRC_URI = "git://github.com/ros2-gbp/rmf_traffic-release;${ROS_BRANCH};protocol=https"
SRCREV = "73f895ba188a97ba8eb09b9986af1789543aaf7f"
S = "${WORKDIR}/git"
