...
# matches with: https://github.com/ros2-gbp/ros_battery_monitoring-release/archive/release/iron/battery_state_rviz_overlay/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/battery_state_rviz_overlay"
SRC_URI = "git://github.com/ros2-gbp/ros_battery_monitoring-release;${ROS_BRANCH};protocol=https"
SRCREV = "2cbf8328963b6192a43155a520eb74f9280ac047"
S = "${WORKDIR}/git"
