...
# matches with: https://github.com/ros2-gbp/rqt_action-release/archive/release/iron/rqt_action/2.1.2-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/rqt_action"
SRC_URI = "git://github.com/ros2-gbp/rqt_action-release;${ROS_BRANCH};protocol=https"
SRCREV = "90baff1b6ccf9baa789660ccd63305c8d1af104a"
S = "${WORKDIR}/git"
