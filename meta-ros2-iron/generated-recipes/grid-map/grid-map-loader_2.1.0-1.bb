...
# matches with: https://github.com/ros2-gbp/grid_map-release/archive/release/iron/grid_map_loader/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/grid_map_loader"
SRC_URI = "git://github.com/ros2-gbp/grid_map-release;${ROS_BRANCH};protocol=https"
SRCREV = "34f6ff07f9cdd5efcce468ce7887303f10db382f"
S = "${WORKDIR}/git"
