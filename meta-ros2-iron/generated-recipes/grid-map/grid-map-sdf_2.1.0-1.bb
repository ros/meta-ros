...
# matches with: https://github.com/ros2-gbp/grid_map-release/archive/release/iron/grid_map_sdf/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/grid_map_sdf"
SRC_URI = "git://github.com/ros2-gbp/grid_map-release;${ROS_BRANCH};protocol=https"
SRCREV = "6a66e2fc47ea0b490802ea3ae5cec1bb61f9ac5d"
S = "${WORKDIR}/git"
