...
# matches with: https://github.com/ros2-gbp/grid_map-release/archive/release/iron/grid_map_rviz_plugin/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/grid_map_rviz_plugin"
SRC_URI = "git://github.com/ros2-gbp/grid_map-release;${ROS_BRANCH};protocol=https"
SRCREV = "978ce5a4d10e41d86626d26f23e9adc45bc4539e"
S = "${WORKDIR}/git"
