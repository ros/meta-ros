...
# matches with: https://github.com/ros2-gbp/game_controller_spl-release/archive/release/iron/rcgcrd_spl_4_conversion/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rcgcrd_spl_4_conversion"
SRC_URI = "git://github.com/ros2-gbp/game_controller_spl-release;${ROS_BRANCH};protocol=https"
SRCREV = "bbca7205ace92413df795704878299f52bca1d72"
S = "${WORKDIR}/git"
