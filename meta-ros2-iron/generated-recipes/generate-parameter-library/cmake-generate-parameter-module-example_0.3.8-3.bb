...
# matches with: https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/iron/cmake_generate_parameter_module_example/0.3.8-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/cmake_generate_parameter_module_example"
SRC_URI = "git://github.com/ros2-gbp/generate_parameter_library-release;${ROS_BRANCH};protocol=https"
SRCREV = "131dffff1cb51a8f66d052c89c2404ac57c16358"
S = "${WORKDIR}/git"
