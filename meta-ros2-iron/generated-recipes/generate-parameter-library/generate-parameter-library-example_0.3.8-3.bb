...
# matches with: https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/iron/generate_parameter_library_example/0.3.8-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/generate_parameter_library_example"
SRC_URI = "git://github.com/ros2-gbp/generate_parameter_library-release;${ROS_BRANCH};protocol=https"
SRCREV = "86f25e85bf74870abdf2cd77a4d59039a48a6284"
S = "${WORKDIR}/git"
