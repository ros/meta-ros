...
# matches with: https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/iron/generate_parameter_module_example/0.3.8-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/generate_parameter_module_example"
SRC_URI = "git://github.com/ros2-gbp/generate_parameter_library-release;${ROS_BRANCH};protocol=https"
SRCREV = "f3a33edce62a73f626fbd984047822990299b8f3"
S = "${WORKDIR}/git"
