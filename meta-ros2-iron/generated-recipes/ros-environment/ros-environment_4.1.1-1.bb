...
# matches with: https://github.com/ros2-gbp/ros_environment-release/archive/release/iron/ros_environment/4.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_environment"
SRC_URI = "git://github.com/ros2-gbp/ros_environment-release;${ROS_BRANCH};protocol=https"
SRCREV = "502b8ab6793bffff5f6365f8bf494db4fcdc271f"
S = "${WORKDIR}/git"
