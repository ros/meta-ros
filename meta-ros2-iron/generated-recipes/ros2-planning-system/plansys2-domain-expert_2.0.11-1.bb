...
# matches with: https://github.com/ros2-gbp/ros2_planning_system-release/archive/release/iron/plansys2_domain_expert/2.0.11-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/plansys2_domain_expert"
SRC_URI = "git://github.com/ros2-gbp/ros2_planning_system-release;${ROS_BRANCH};protocol=https"
SRCREV = "093ffbe68795a33375573058f8697cb09e92db19"
S = "${WORKDIR}/git"
