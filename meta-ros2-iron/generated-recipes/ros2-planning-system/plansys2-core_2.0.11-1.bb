...
# matches with: https://github.com/ros2-gbp/ros2_planning_system-release/archive/release/iron/plansys2_core/2.0.11-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/plansys2_core"
SRC_URI = "git://github.com/ros2-gbp/ros2_planning_system-release;${ROS_BRANCH};protocol=https"
SRCREV = "c68faae9b12ea0ef55d4b8f8f380d58dd25be65d"
S = "${WORKDIR}/git"
