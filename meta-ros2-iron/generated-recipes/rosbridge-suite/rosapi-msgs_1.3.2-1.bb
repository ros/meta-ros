...
# matches with: https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/iron/rosapi_msgs/1.3.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rosapi_msgs"
SRC_URI = "git://github.com/ros2-gbp/rosbridge_suite-release;${ROS_BRANCH};protocol=https"
SRCREV = "baf02ca1bad14522dd07f1d09f3f5a3560f124bc"
S = "${WORKDIR}/git"
