...
# matches with: https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/iron/rosbridge_suite/1.3.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rosbridge_suite"
SRC_URI = "git://github.com/ros2-gbp/rosbridge_suite-release;${ROS_BRANCH};protocol=https"
SRCREV = "be714ae5933c0abec46f0cf5b1bb5aed84633e7d"
S = "${WORKDIR}/git"
