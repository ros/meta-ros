...
# matches with: https://github.com/ros-naoqi/libqicore-release/archive/release/iron/naoqi_libqicore/3.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/naoqi_libqicore"
SRC_URI = "git://github.com/ros-naoqi/libqicore-release;${ROS_BRANCH};protocol=https"
SRCREV = "d02ebdc1cc2c230664fd0b12e4e7df8346f83a63"
S = "${WORKDIR}/git"
