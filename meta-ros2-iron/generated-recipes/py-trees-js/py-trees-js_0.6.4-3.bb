...
# matches with: https://github.com/ros2-gbp/py_trees_js-release/archive/release/iron/py_trees_js/0.6.4-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/py_trees_js"
SRC_URI = "git://github.com/ros2-gbp/py_trees_js-release;${ROS_BRANCH};protocol=https"
SRCREV = "9e6db3c34d1da3127815451199f046b8745c0c9f"
S = "${WORKDIR}/git"
