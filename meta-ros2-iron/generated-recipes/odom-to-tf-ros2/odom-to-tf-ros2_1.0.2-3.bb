...
# matches with: https://github.com/ros2-gbp/odom_to_tf_ros2-release/archive/release/iron/odom_to_tf_ros2/1.0.2-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/odom_to_tf_ros2"
SRC_URI = "git://github.com/ros2-gbp/odom_to_tf_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "c85de6f8adc6f4bc69ec08e0f6755dcf432365ee"
S = "${WORKDIR}/git"
