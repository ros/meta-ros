...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/iron/mrpt_libnav/2.14.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mrpt_libnav"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "602f2348d1d896be6e091c5b0a5d6639fa50eeed"
S = "${WORKDIR}/git"
