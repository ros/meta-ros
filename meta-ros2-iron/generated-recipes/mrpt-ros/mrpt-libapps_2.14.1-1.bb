...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/iron/mrpt_libapps/2.14.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mrpt_libapps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "e90b433822a2c691bc8065555e952d6d66090f4a"
S = "${WORKDIR}/git"
