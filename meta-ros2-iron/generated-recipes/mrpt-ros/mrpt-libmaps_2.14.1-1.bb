...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/iron/mrpt_libmaps/2.14.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mrpt_libmaps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "56d8ec14dd2952eb9ca7d1f4b45c267ff3f5ac88"
S = "${WORKDIR}/git"
