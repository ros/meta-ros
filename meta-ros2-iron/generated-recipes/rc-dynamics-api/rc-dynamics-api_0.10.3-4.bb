...
# matches with: https://github.com/ros2-gbp/rc_dynamics_api-release/archive/release/iron/rc_dynamics_api/0.10.3-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/rc_dynamics_api"
SRC_URI = "git://github.com/ros2-gbp/rc_dynamics_api-release;${ROS_BRANCH};protocol=https"
SRCREV = "6d11a5f4d146a8bfab71e1545982ac47855378ab"
S = "${WORKDIR}/git"
