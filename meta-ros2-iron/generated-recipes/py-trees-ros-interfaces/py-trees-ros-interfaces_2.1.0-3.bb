...
# matches with: https://github.com/ros2-gbp/py_trees_ros_interfaces-release/archive/release/iron/py_trees_ros_interfaces/2.1.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/py_trees_ros_interfaces"
SRC_URI = "git://github.com/ros2-gbp/py_trees_ros_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "8faf0f95e4506cae27f9ed7aa0051352e6dcaf02"
S = "${WORKDIR}/git"
