...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/iron/mrpt_sensor_gnns_nmea/0.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mrpt_sensor_gnns_nmea"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "7c35f809d477bdf65ca1b98f2b71cc4720cf99f9"
S = "${WORKDIR}/git"
