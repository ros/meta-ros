...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/iron/mrpt_sensor_gnss_nmea/0.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mrpt_sensor_gnss_nmea"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "40015899550c3e2263b0369fc0e9a98bae25884f"
S = "${WORKDIR}/git"
