...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/iron/mrpt_sensor_bumblebee_stereo/0.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mrpt_sensor_bumblebee_stereo"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "743c2b23d6c2af10e19292074d9cda0abf551da5"
S = "${WORKDIR}/git"
