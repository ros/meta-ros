...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/iron/mrpt_generic_sensor/0.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mrpt_generic_sensor"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "c3a1dd01cdcdc524d8a927687c6b2e9d7b198673"
S = "${WORKDIR}/git"
