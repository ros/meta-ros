...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/iron/mrpt_sensorlib/0.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mrpt_sensorlib"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "8407b4d656d806ec43fcf24588e40cccff971efb"
S = "${WORKDIR}/git"
