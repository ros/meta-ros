...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/iron/mrpt_sensors/0.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mrpt_sensors"
SRC_URI = "git://github.com/ros2-gbp/mrpt_sensors-release;${ROS_BRANCH};protocol=https"
SRCREV = "a59f6b48aadeafc81af97516c67510a229b66aa4"
S = "${WORKDIR}/git"
