...
# matches with: https://github.com/ros2-gbp/laser_geometry-release/archive/release/iron/laser_geometry/2.5.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/laser_geometry"
SRC_URI = "git://github.com/ros2-gbp/laser_geometry-release;${ROS_BRANCH};protocol=https"
SRCREV = "a0cee3bf822d2f7c99d3cf34e265de025aa98c06"
S = "${WORKDIR}/git"
