...
# matches with: https://github.com/ros2-gbp/teleop_twist_keyboard-release/archive/release/iron/teleop_twist_keyboard/2.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/teleop_twist_keyboard"
SRC_URI = "git://github.com/ros2-gbp/teleop_twist_keyboard-release;${ROS_BRANCH};protocol=https"
SRCREV = "388b5b5ea2563b13cb9a1fbc2d530398270ee0d0"
S = "${WORKDIR}/git"
