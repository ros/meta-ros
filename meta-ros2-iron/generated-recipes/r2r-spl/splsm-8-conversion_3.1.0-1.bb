...
# matches with: https://github.com/ros2-gbp/r2r_spl-release/archive/release/iron/splsm_8_conversion/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/splsm_8_conversion"
SRC_URI = "git://github.com/ros2-gbp/r2r_spl-release;${ROS_BRANCH};protocol=https"
SRCREV = "cfe8a17f56baf6ca65fe043536de0843ac8a962e"
S = "${WORKDIR}/git"
