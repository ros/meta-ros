...
# matches with: https://github.com/ros2-gbp/fluent_rviz-release/archive/release/iron/fluent_rviz/0.0.3-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/fluent_rviz"
SRC_URI = "git://github.com/ros2-gbp/fluent_rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "271c843a7efb2655f6a3920c6e85b7e15819a9be"
S = "${WORKDIR}/git"
