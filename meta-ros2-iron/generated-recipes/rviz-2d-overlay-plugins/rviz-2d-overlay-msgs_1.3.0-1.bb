...
# matches with: https://github.com/ros2-gbp/rviz_2d_overlay_plugins-release/archive/release/iron/rviz_2d_overlay_msgs/1.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rviz_2d_overlay_msgs"
SRC_URI = "git://github.com/ros2-gbp/rviz_2d_overlay_plugins-release;${ROS_BRANCH};protocol=https"
SRCREV = "607d1f0734bc93a7900979e2b862861f689582e9"
S = "${WORKDIR}/git"
