...
# matches with: https://github.com/ros2-gbp/sick_safevisionary_base-release/archive/release/iron/sick_safevisionary_base/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/sick_safevisionary_base"
SRC_URI = "git://github.com/ros2-gbp/sick_safevisionary_base-release;${ROS_BRANCH};protocol=https"
SRCREV = "da21850b4c69c89b56b7287bff4a3a5a422f9014"
S = "${WORKDIR}/git"
