...
# matches with: https://github.com/ros2-gbp/pluginlib-release/archive/release/iron/pluginlib/5.2.2-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/pluginlib"
SRC_URI = "git://github.com/ros2-gbp/pluginlib-release;${ROS_BRANCH};protocol=https"
SRCREV = "d318949743d9ba09db0d044eef38f75523531d35"
S = "${WORKDIR}/git"
