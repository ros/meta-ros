...
# matches with: https://github.com/ros2-gbp/perception_open3d-release/archive/release/iron/open3d_conversions/0.1.2-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/open3d_conversions"
SRC_URI = "git://github.com/ros2-gbp/perception_open3d-release;${ROS_BRANCH};protocol=https"
SRCREV = "0353078f3c65a8652a0719cdc0b5fbb92af7ace4"
S = "${WORKDIR}/git"
