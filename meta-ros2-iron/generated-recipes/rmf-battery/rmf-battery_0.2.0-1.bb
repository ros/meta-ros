...
# matches with: https://github.com/ros2-gbp/rmf_battery-release/archive/release/iron/rmf_battery/0.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rmf_battery"
SRC_URI = "git://github.com/ros2-gbp/rmf_battery-release;${ROS_BRANCH};protocol=https"
SRCREV = "60ebeebfffb13aca1741c3ea906d2cc18c0b97d5"
S = "${WORKDIR}/git"
