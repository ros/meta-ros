...
# matches with: https://github.com/ros2-gbp/pointcloud_to_laserscan-release/archive/release/iron/pointcloud_to_laserscan/2.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/pointcloud_to_laserscan"
SRC_URI = "git://github.com/ros2-gbp/pointcloud_to_laserscan-release;${ROS_BRANCH};protocol=https"
SRCREV = "63df2e3229ec0f89246b237f1e127d9c5c79ecdc"
S = "${WORKDIR}/git"
