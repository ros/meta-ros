...
# matches with: https://github.com/ros2-gbp/ros_testing-release/archive/release/iron/ros2test/0.5.2-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros2test"
SRC_URI = "git://github.com/ros2-gbp/ros_testing-release;${ROS_BRANCH};protocol=https"
SRCREV = "ce8c8ad47a0f0dda1697b0aaffac0ae58d4bafee"
S = "${WORKDIR}/git"
