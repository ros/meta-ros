...
# matches with: https://github.com/ros2-gbp/orocos_kdl_vendor-release/archive/release/iron/python_orocos_kdl_vendor/0.3.4-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/python_orocos_kdl_vendor"
SRC_URI = "git://github.com/ros2-gbp/orocos_kdl_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "4a41c95215742748970a85c3bdc9a2e5b417ef31"
S = "${WORKDIR}/git"
