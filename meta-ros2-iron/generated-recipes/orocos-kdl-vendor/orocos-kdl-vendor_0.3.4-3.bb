...
# matches with: https://github.com/ros2-gbp/orocos_kdl_vendor-release/archive/release/iron/orocos_kdl_vendor/0.3.4-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/orocos_kdl_vendor"
SRC_URI = "git://github.com/ros2-gbp/orocos_kdl_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "548edb0faa1c0e6faa4e6095fa7b588ae344614e"
S = "${WORKDIR}/git"
