...
# matches with: https://github.com/ros2-gbp/nmea_hardware_interface-release/archive/release/iron/nmea_hardware_interface/0.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/nmea_hardware_interface"
SRC_URI = "git://github.com/ros2-gbp/nmea_hardware_interface-release;${ROS_BRANCH};protocol=https"
SRCREV = "b3cd7f299f7da1f13069b40072ec98966c971309"
S = "${WORKDIR}/git"
