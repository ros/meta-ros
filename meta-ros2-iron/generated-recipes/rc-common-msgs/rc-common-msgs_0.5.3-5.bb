...
# matches with: https://github.com/ros2-gbp/rc_common_msgs_ros2-release/archive/release/iron/rc_common_msgs/0.5.3-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/rc_common_msgs"
SRC_URI = "git://github.com/ros2-gbp/rc_common_msgs_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5da0c8b2e05336ecc9a55f6832510dd360febd54"
S = "${WORKDIR}/git"
