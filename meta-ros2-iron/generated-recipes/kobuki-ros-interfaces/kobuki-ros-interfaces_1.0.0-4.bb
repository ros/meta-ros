...
# matches with: https://github.com/ros2-gbp/kobuki_ros_interfaces-release/archive/release/iron/kobuki_ros_interfaces/1.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/kobuki_ros_interfaces"
SRC_URI = "git://github.com/ros2-gbp/kobuki_ros_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "430148d8e452bff18f5e5a507842eb130e745879"
S = "${WORKDIR}/git"
