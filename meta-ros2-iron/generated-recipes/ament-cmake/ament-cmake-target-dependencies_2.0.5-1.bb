...
# matches with: https://github.com/ros2-gbp/ament_cmake-release/archive/release/iron/ament_cmake_target_dependencies/2.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ament_cmake_target_dependencies"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake-release;${ROS_BRANCH};protocol=https"
SRCREV = "5c9481e4edae414b44f4b4ac36846db3a29ffdf9"
S = "${WORKDIR}/git"
