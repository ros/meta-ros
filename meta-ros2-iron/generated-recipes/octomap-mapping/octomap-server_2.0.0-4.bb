...
# matches with: https://github.com/ros2-gbp/octomap_mapping-release/archive/release/iron/octomap_server/2.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/octomap_server"
SRC_URI = "git://github.com/ros2-gbp/octomap_mapping-release;${ROS_BRANCH};protocol=https"
SRCREV = "b63190cecbb43bb3fbb68106b0912b4a3652773e"
S = "${WORKDIR}/git"
