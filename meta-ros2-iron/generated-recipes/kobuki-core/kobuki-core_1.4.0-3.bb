...
# matches with: https://github.com/ros2-gbp/kobuki_core-release/archive/release/iron/kobuki_core/1.4.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/kobuki_core"
SRC_URI = "git://github.com/ros2-gbp/kobuki_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "a28947de507d460b335acd049377efff8e17cea9"
S = "${WORKDIR}/git"
