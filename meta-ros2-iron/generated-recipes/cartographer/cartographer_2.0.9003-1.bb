...
# matches with: https://github.com/ros2-gbp/cartographer-release/archive/release/iron/cartographer/2.0.9003-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/cartographer"
SRC_URI = "git://github.com/ros2-gbp/cartographer-release;${ROS_BRANCH};protocol=https"
SRCREV = "b3e89269b638a1a50ee69e80db1b01a2f1b13a24"
S = "${WORKDIR}/git"
