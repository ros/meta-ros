...
# matches with: https://github.com/ros2-gbp/visp-release/archive/release/iron/visp/3.5.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/visp"
SRC_URI = "git://github.com/ros2-gbp/visp-release;${ROS_BRANCH};protocol=https"
SRCREV = "ed3e672bdc0e66a1a8db66c038a25162f59a7cd8"
S = "${WORKDIR}/git"
