...
# matches with: https://github.com/ros2-gbp/SMACC2-release/archive/release/iron/smacc2_msgs/0.4.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/smacc2_msgs"
SRC_URI = "git://github.com/ros2-gbp/SMACC2-release;${ROS_BRANCH};protocol=https"
SRCREV = "71250792cf9e7fc025834cbb64008957fa6ee53a"
S = "${WORKDIR}/git"
