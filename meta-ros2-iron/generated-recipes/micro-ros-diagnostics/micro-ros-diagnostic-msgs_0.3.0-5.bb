...
# matches with: https://github.com/ros2-gbp/micro_ros_diagnostics-release/archive/release/iron/micro_ros_diagnostic_msgs/0.3.0-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/micro_ros_diagnostic_msgs"
SRC_URI = "git://github.com/ros2-gbp/micro_ros_diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "8d9dff3d7a94b28f9957c09a1f08231cb772fed1"
S = "${WORKDIR}/git"
