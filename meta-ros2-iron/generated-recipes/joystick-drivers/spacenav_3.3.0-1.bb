...
# matches with: https://github.com/ros2-gbp/joystick_drivers-release/archive/release/iron/spacenav/3.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/spacenav"
SRC_URI = "git://github.com/ros2-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "bef70e4ac0d2fe718aff184932115a9e9e7bff20"
S = "${WORKDIR}/git"
