...
# matches with: https://github.com/ros2-gbp/joystick_drivers-release/archive/release/iron/wiimote/3.1.0-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/wiimote"
SRC_URI = "git://github.com/ros2-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "338570a142f6616c9e04e31b1e8b3db0526a898a"
S = "${WORKDIR}/git"
