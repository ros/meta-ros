...
# matches with: https://github.com/ros2-gbp/joystick_drivers-release/archive/release/iron/joy_linux/3.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/joy_linux"
SRC_URI = "git://github.com/ros2-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "78f1effd3ae573fbd9b2c2dcfdb15f4df6c75fa3"
S = "${WORKDIR}/git"
