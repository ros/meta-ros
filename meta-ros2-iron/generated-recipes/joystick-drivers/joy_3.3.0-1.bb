...
# matches with: https://github.com/ros2-gbp/joystick_drivers-release/archive/release/iron/joy/3.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/joy"
SRC_URI = "git://github.com/ros2-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "160482ab0ab0254eadebfd763d3ac47b6a035cbf"
S = "${WORKDIR}/git"
