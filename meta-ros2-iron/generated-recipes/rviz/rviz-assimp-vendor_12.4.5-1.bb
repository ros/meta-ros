...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/iron/rviz_assimp_vendor/12.4.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rviz_assimp_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "0ea61eec4cdc4aa9188a0b306de1a2c77f0778e5"
S = "${WORKDIR}/git"
