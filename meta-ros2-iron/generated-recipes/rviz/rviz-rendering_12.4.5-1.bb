...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/iron/rviz_rendering/12.4.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rviz_rendering"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "e6a0466db5a676c9bf75aa72ee5954e5e6a4dda5"
S = "${WORKDIR}/git"
