...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/iron/rviz_assimp_vendor/12.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rviz_assimp_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "5dd536dc2860f4762aa8e806e94464e05258cfcc"
S = "${WORKDIR}/git"
