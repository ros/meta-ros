...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/iron/rviz_ogre_vendor/12.4.8-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "acacb3118050d4f92442209ab3079640c3e201dd"
S = "${WORKDIR}/git"
