...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/iron/rviz_assimp_vendor/12.4.7-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rviz_assimp_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "c0c3d1fad4e36c8e6111f24a5675a0fc343e9efe"
S = "${WORKDIR}/git"
