...
# matches with: https://github.com/ros2-gbp/rqt_service_caller-release/archive/release/iron/rqt_service_caller/1.1.1-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/rqt_service_caller"
SRC_URI = "git://github.com/ros2-gbp/rqt_service_caller-release;${ROS_BRANCH};protocol=https"
SRCREV = "76e4774b275e4ac45169096106d4289cfbedefee"
S = "${WORKDIR}/git"
