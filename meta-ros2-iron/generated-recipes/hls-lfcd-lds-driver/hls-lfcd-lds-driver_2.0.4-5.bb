...
# matches with: https://github.com/ros2-gbp/hls_lfcd_lds_driver-release/archive/release/iron/hls_lfcd_lds_driver/2.0.4-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/hls_lfcd_lds_driver"
SRC_URI = "git://github.com/ros2-gbp/hls_lfcd_lds_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "e4be907c68131e746da4996c77dc745982cdee47"
S = "${WORKDIR}/git"
