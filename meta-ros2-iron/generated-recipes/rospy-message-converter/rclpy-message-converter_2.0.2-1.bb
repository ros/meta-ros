...
# matches with: https://github.com/ros2-gbp/rospy_message_converter-release/archive/release/iron/rclpy_message_converter/2.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rclpy_message_converter"
SRC_URI = "git://github.com/ros2-gbp/rospy_message_converter-release;${ROS_BRANCH};protocol=https"
SRCREV = "0b1d62e10565ac64980182360f063c3cb15d3a44"
S = "${WORKDIR}/git"
