...
# matches with: https://github.com/ros2-gbp/rospy_message_converter-release/archive/release/iron/rclpy_message_converter_msgs/2.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rclpy_message_converter_msgs"
SRC_URI = "git://github.com/ros2-gbp/rospy_message_converter-release;${ROS_BRANCH};protocol=https"
SRCREV = "ef192bd3e5ade2304a19c33382d2414886a05302"
S = "${WORKDIR}/git"
