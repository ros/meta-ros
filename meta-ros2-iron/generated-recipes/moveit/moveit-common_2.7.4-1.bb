...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/iron/moveit_common/2.7.4-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "58513540f7b3fb3b5b2b1954cb4dde911ffea8cb"
S = "${WORKDIR}/git"
