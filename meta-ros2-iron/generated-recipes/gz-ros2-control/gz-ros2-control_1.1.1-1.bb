...
# matches with: https://github.com/ros-controls/gz_ros2_control/archive/release/iron/gz_ros2_control/1.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/gz_ros2_control"
SRC_URI = "git://github.com/ros-controls/gz_ros2_control;${ROS_BRANCH};protocol=https"
SRCREV = "38fdf8757d05085fab6ee24d92075b2bdabbf378"
S = "${WORKDIR}/git"
