...
# matches with: https://github.com/ros2-gbp/rqt_robot_dashboard-release/archive/release/iron/rqt_robot_dashboard/0.6.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/rqt_robot_dashboard"
SRC_URI = "git://github.com/ros2-gbp/rqt_robot_dashboard-release;${ROS_BRANCH};protocol=https"
SRCREV = "67fcb1d1c7e97226bf914a5a47d84fb313f3d857"
S = "${WORKDIR}/git"
