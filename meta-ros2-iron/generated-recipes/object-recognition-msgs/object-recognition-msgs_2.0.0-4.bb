...
# matches with: https://github.com/ros2-gbp/object_recognition_msgs-release/archive/release/iron/object_recognition_msgs/2.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/object_recognition_msgs"
SRC_URI = "git://github.com/ros2-gbp/object_recognition_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "b9b2ee633a5080c23abc5a1cbb9d8c411e9ce70b"
S = "${WORKDIR}/git"
