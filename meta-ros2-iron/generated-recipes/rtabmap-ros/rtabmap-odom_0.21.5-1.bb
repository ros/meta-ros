...
# matches with: https://github.com/introlab/rtabmap_ros-release/archive/release/iron/rtabmap_odom/0.21.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rtabmap_odom"
SRC_URI = "git://github.com/introlab/rtabmap_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "825984e9585cdfac00296f1827149340e812f7e1"
S = "${WORKDIR}/git"
