...
# matches with: https://github.com/introlab/rtabmap_ros-release/archive/release/iron/rtabmap_sync/0.21.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rtabmap_sync"
SRC_URI = "git://github.com/introlab/rtabmap_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "2b84afe1bcd62484061913a4ec798da9e03b7b1f"
S = "${WORKDIR}/git"
