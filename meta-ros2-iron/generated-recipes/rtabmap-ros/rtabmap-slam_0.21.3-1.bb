...
# matches with: https://github.com/introlab/rtabmap_ros-release/archive/release/iron/rtabmap_slam/0.21.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rtabmap_slam"
SRC_URI = "git://github.com/introlab/rtabmap_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "395c659ae6fad3404db5bb8ca1126c50d2918934"
S = "${WORKDIR}/git"
