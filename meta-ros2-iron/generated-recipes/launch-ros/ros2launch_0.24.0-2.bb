...
# matches with: https://github.com/ros2-gbp/launch_ros-release/archive/release/iron/ros2launch/0.24.0-2.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros2launch"
SRC_URI = "git://github.com/ros2-gbp/launch_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "7bc5a0facb77d7d66f01c7613a55b1524c113a50"
S = "${WORKDIR}/git"
