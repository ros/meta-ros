...
# matches with: https://github.com/ros2-gbp/sick_safevisionary_ros2-release/archive/release/iron/sick_safevisionary_driver/1.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/sick_safevisionary_driver"
SRC_URI = "git://github.com/ros2-gbp/sick_safevisionary_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5034a3f06543af08551ac69581e90c2c94cc3f62"
S = "${WORKDIR}/git"
