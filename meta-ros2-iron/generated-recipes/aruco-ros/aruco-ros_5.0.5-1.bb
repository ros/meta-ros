...
# matches with: https://github.com/pal-gbp/aruco_ros-release/archive/release/iron/aruco_ros/5.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/aruco_ros"
SRC_URI = "git://github.com/pal-gbp/aruco_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "37075a8f0af58c972b45166077f6b3182910ad9d"
S = "${WORKDIR}/git"
