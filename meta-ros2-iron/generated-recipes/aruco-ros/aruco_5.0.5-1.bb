...
# matches with: https://github.com/pal-gbp/aruco_ros-release/archive/release/iron/aruco/5.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/aruco"
SRC_URI = "git://github.com/pal-gbp/aruco_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "f42be77ccd630b0a1498c51a7b183432fa68938b"
S = "${WORKDIR}/git"
