...
# matches with: https://github.com/ros2-gbp/kdl_parser-release/archive/release/iron/kdl_parser/2.9.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/kdl_parser"
SRC_URI = "git://github.com/ros2-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "941750d8670fc4a9725e7db30ba33bad3814d6d9"
S = "${WORKDIR}/git"
