...
# matches with: https://github.com/ros2-gbp/executive_smach-release/archive/release/iron/smach_ros/3.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/smach_ros"
SRC_URI = "git://github.com/ros2-gbp/executive_smach-release;${ROS_BRANCH};protocol=https"
SRCREV = "e4b4fb66d6daa8eb0e27e53ef74a338ccee1e524"
S = "${WORKDIR}/git"
