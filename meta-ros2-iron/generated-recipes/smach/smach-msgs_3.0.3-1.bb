...
# matches with: https://github.com/ros2-gbp/executive_smach-release/archive/release/iron/smach_msgs/3.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/smach_msgs"
SRC_URI = "git://github.com/ros2-gbp/executive_smach-release;${ROS_BRANCH};protocol=https"
SRCREV = "f621db9049616274b0183d70815daf18bc8607b4"
S = "${WORKDIR}/git"
