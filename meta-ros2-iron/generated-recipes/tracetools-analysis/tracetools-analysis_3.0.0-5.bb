...
# matches with: https://github.com/ros2-gbp/tracetools_analysis-release/archive/release/iron/tracetools_analysis/3.0.0-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/tracetools_analysis"
SRC_URI = "git://github.com/ros2-gbp/tracetools_analysis-release;${ROS_BRANCH};protocol=https"
SRCREV = "4b599bab5c91c9150e68cf7ce68d97608cd037db"
S = "${WORKDIR}/git"
