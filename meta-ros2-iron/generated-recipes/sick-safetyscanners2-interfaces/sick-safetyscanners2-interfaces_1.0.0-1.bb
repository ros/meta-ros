...
# matches with: https://github.com/SICKAG/sick_safetyscanners2_interfaces-release/archive/release/iron/sick_safetyscanners2_interfaces/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/sick_safetyscanners2_interfaces"
SRC_URI = "git://github.com/SICKAG/sick_safetyscanners2_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "cbfbe91b2df7c176577e2ed3f8d82a7ec0d17b39"
S = "${WORKDIR}/git"
