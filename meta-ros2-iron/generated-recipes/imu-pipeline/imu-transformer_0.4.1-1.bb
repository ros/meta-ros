...
# matches with: https://github.com/ros2-gbp/imu_pipeline-release/archive/release/iron/imu_transformer/0.4.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/imu_transformer"
SRC_URI = "git://github.com/ros2-gbp/imu_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "4d7b20bdcf0ea89957e1f9cb6e9e1862f5b009a4"
S = "${WORKDIR}/git"
