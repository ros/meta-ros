...
# matches with: https://github.com/ros2-gbp/rc_reason_clients-release/archive/release/iron/rc_reason_clients/0.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rc_reason_clients"
SRC_URI = "git://github.com/ros2-gbp/rc_reason_clients-release;${ROS_BRANCH};protocol=https"
SRCREV = "3d9b27ae93918997cf475d6a91e6df5f8500c126"
S = "${WORKDIR}/git"
