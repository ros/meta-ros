...
# matches with: https://github.com/ros2-gbp/rc_reason_clients-release/archive/release/iron/rc_reason_msgs/0.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rc_reason_msgs"
SRC_URI = "git://github.com/ros2-gbp/rc_reason_clients-release;${ROS_BRANCH};protocol=https"
SRCREV = "84334f8acfec1c99f15abc2af263397b9e785366"
S = "${WORKDIR}/git"
