...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/iron/bond_core/4.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/bond_core"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "5bb0f53b6d5285098a2f870389c9662f1abae4fc"
S = "${WORKDIR}/git"
