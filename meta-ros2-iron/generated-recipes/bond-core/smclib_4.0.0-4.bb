...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/iron/smclib/4.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/smclib"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "e1946ea2e7bbd8f5dff4c1b0945ee2e4e1bd93bb"
S = "${WORKDIR}/git"
