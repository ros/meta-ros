...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/iron/test_bond/4.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/test_bond"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "3598cacf3e3a934d4ec733fc361189072ea5fd30"
S = "${WORKDIR}/git"
