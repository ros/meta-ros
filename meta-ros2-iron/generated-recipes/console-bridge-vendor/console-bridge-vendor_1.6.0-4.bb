...
# matches with: https://github.com/ros2-gbp/console_bridge_vendor-release/archive/release/iron/console_bridge_vendor/1.6.0-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/console_bridge_vendor"
SRC_URI = "git://github.com/ros2-gbp/console_bridge_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "24cd844a5e257ed258c1405222228d6853207ddb"
S = "${WORKDIR}/git"
