...
# matches with: https://github.com/ros2-gbp/python_cmake_module-release/archive/release/iron/python_cmake_module/0.10.2-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/python_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/python_cmake_module-release;${ROS_BRANCH};protocol=https"
SRCREV = "cc41c76b9c00e2d3658c334557597219359c86ea"
S = "${WORKDIR}/git"
