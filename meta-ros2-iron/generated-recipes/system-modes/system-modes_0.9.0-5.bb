...
# matches with: https://github.com/ros2-gbp/system_modes-release/archive/release/iron/system_modes/0.9.0-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/system_modes"
SRC_URI = "git://github.com/ros2-gbp/system_modes-release;${ROS_BRANCH};protocol=https"
SRCREV = "4f6b948833deb903170dd717160345a287770641"
S = "${WORKDIR}/git"
