...
# matches with: https://github.com/ros2-gbp/rmf_simulation-release/archive/release/iron/rmf_robot_sim_gz_classic_plugins/2.1.1-1.tar.gz
...
SRCREV = "908d5452be16698a7cf18d94959a2abc9bcf5cd0"
S = "${WORKDIR}/git"
