...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/iron/tf2_eigen_kdl/0.31.4-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/tf2_eigen_kdl"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e50ebd9b736395ae87d01ed5c032ec6263f14ec2"
S = "${WORKDIR}/git"
