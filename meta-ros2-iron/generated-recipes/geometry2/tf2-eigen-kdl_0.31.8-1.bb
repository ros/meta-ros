...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/iron/tf2_eigen_kdl/0.31.8-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/tf2_eigen_kdl"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b384f5434536b09153e76aea874885521558d77f"
S = "${WORKDIR}/git"
