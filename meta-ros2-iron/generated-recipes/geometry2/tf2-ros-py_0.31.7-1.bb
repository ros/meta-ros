...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/iron/tf2_ros_py/0.31.7-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/tf2_ros_py"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "fde6ea177891568db5b8a44275cf91d4eb5a803c"
S = "${WORKDIR}/git"
