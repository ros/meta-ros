...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/iron/tf2_eigen/0.31.6-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/tf2_eigen"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "19c2d96b83b5fdd5319bcf6a7a21416dd03dd7e2"
S = "${WORKDIR}/git"
