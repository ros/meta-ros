...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/iron/tf2_bullet/0.31.6-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/tf2_bullet"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "13c507ac1de1f91b8766fc7e9b741bbfcaf7b20c"
S = "${WORKDIR}/git"
