...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/iron/tf2_tools/0.31.4-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "617266a3d3ed8b94080206829599f18496e00abc"
S = "${WORKDIR}/git"
