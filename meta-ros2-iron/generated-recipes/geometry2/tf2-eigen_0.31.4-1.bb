...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/iron/tf2_eigen/0.31.4-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/tf2_eigen"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "09c835b99b868df499284590383e487956fe7f4e"
S = "${WORKDIR}/git"
