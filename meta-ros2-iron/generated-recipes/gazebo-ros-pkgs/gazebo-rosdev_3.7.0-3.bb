...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/iron/gazebo_dev/3.7.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/gazebo_dev"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "35379c8bcd022b4487372cda2e3d0962438c94d1"
S = "${WORKDIR}/git"
