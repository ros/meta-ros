...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/iron/gazebo_ros_pkgs/3.7.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/gazebo_ros_pkgs"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "60f4528bceebffc07bc24feccb70bbd17cb1339f"
S = "${WORKDIR}/git"
