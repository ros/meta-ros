...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/iron/gazebo_ros/3.7.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/gazebo_ros"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "7ad5bf651809327f20fe3d7a7a9daf38f802faba"
S = "${WORKDIR}/git"
