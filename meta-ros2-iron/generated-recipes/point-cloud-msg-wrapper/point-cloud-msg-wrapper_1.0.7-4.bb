...
# matches with: https://github.com/ros2-gbp/point_cloud_msg_wrapper-release/archive/release/iron/point_cloud_msg_wrapper/1.0.7-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/point_cloud_msg_wrapper"
SRC_URI = "git://github.com/ros2-gbp/point_cloud_msg_wrapper-release;${ROS_BRANCH};protocol=https"
SRCREV = "2dd3d744ec91229325bff5ef1afe1661ac6e1332"
S = "${WORKDIR}/git"
