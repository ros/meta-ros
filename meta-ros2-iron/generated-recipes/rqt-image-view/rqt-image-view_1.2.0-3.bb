...
# matches with: https://github.com/ros2-gbp/rqt_image_view-release/archive/release/iron/rqt_image_view/1.2.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/rqt_image_view"
SRC_URI = "git://github.com/ros2-gbp/rqt_image_view-release;${ROS_BRANCH};protocol=https"
SRCREV = "096004255ba8b0c3d4c6ffa0c246dc4d22ea2c3a"
S = "${WORKDIR}/git"
