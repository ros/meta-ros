...
# matches with: https://github.com/ros2-gbp/velodyne-release/archive/release/iron/velodyne_pointcloud/2.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/velodyne_pointcloud"
SRC_URI = "git://github.com/ros2-gbp/velodyne-release;${ROS_BRANCH};protocol=https"
SRCREV = "886684f30036a5a74ecf244b60c04cb31f8df893"
S = "${WORKDIR}/git"
