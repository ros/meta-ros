...
# matches with: https://github.com/ros2-gbp/velodyne-release/archive/release/iron/velodyne_msgs/2.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/velodyne_msgs"
SRC_URI = "git://github.com/ros2-gbp/velodyne-release;${ROS_BRANCH};protocol=https"
SRCREV = "95e48818512f44180cd64d5bb7ec4c42017ca0d9"
S = "${WORKDIR}/git"
