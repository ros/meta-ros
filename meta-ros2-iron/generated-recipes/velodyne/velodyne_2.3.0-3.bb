...
# matches with: https://github.com/ros2-gbp/velodyne-release/archive/release/iron/velodyne/2.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/velodyne"
SRC_URI = "git://github.com/ros2-gbp/velodyne-release;${ROS_BRANCH};protocol=https"
SRCREV = "ac93913ed04599adccd9812eaec3ac5a990c441b"
S = "${WORKDIR}/git"
