...
# matches with: https://github.com/ros2-gbp/dolly-release/archive/release/iron/dolly_ignition/0.4.0-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/dolly_ignition"
SRC_URI = "git://github.com/ros2-gbp/dolly-release;${ROS_BRANCH};protocol=https"
SRCREV = "497df28a9ead47bca26436870ddf280ddb873d6e"
S = "${WORKDIR}/git"
