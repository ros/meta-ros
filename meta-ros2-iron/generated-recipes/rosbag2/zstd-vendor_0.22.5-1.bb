...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/iron/zstd_vendor/0.22.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/zstd_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "0485d3471b3e99ce22a3b0145ff624d6a530ac3d"
S = "${WORKDIR}/git"
