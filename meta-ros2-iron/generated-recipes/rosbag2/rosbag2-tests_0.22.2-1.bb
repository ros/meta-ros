...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/iron/rosbag2_tests/0.22.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rosbag2_tests"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d675d44efb086f3169cd7e1f43461386cb7981de"
S = "${WORKDIR}/git"
