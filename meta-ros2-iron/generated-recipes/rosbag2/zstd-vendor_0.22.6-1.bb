...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/iron/zstd_vendor/0.22.6-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/zstd_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "1b818bbe53159ce1600afedb156ae18d6ee1dbc7"
S = "${WORKDIR}/git"
