...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/iron/rosbag2_tests/0.22.6-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rosbag2_tests"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "96941de119816c2e3ffb6795fd7e1636ed073875"
S = "${WORKDIR}/git"
