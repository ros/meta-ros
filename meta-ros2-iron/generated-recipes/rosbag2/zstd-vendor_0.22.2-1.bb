...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/iron/zstd_vendor/0.22.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/zstd_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "c9a7697ee8545a37542a194fa9fd941c46efb1a9"
S = "${WORKDIR}/git"
