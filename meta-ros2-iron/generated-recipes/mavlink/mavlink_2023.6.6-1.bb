...
# matches with: https://github.com/ros2-gbp/mavlink-gbp-release/archive/release/iron/mavlink/2023.6.6-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mavlink"
SRC_URI = "git://github.com/ros2-gbp/mavlink-gbp-release;${ROS_BRANCH};protocol=https"
SRCREV = "0920243fdf18f4ec7c9396a8febf647578a28793"
S = "${WORKDIR}/git"
