...
# matches with: https://github.com/ros2-gbp/ifm3d-release/archive/release/iron/ifm3d_core/0.18.0-9.tar.gz
ROS_BRANCH ?= "branch=release/iron/ifm3d_core"
SRC_URI = "git://github.com/ros2-gbp/ifm3d-release;${ROS_BRANCH};protocol=https"
SRCREV = "f5e760189c76abca84bd6da3e3e9234f927e532f"
S = "${WORKDIR}/git"
