...
# matches with: https://github.com/ros2-gbp/find_object_2d-release/archive/release/iron/find_object_2d/0.7.0-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/find_object_2d"
SRC_URI = "git://github.com/ros2-gbp/find_object_2d-release;${ROS_BRANCH};protocol=https"
SRCREV = "ec91183d2e4b674591e8fa6eaa14f3e1ce9a5f3b"
S = "${WORKDIR}/git"
