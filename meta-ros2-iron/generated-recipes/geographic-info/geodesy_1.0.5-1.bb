...
# matches with: https://github.com/ros2-gbp/geographic_info-release/archive/release/iron/geodesy/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/geodesy"
SRC_URI = "git://github.com/ros2-gbp/geographic_info-release;${ROS_BRANCH};protocol=https"
SRCREV = "ef4117f1b56ae73c31a8678f722fea6d5a7022f5"
S = "${WORKDIR}/git"
