...
# matches with: https://github.com/ros2-gbp/geographic_info-release/archive/release/iron/geographic_info/1.0.6-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/geographic_info"
SRC_URI = "git://github.com/ros2-gbp/geographic_info-release;${ROS_BRANCH};protocol=https"
SRCREV = "35692f39c3409a3c8f7f5a0cd45a8122bfcebe00"
S = "${WORKDIR}/git"
