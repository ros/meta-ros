...
# matches with: https://github.com/ros2-gbp/geographic_info-release/archive/release/iron/geographic_msgs/1.0.6-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/geographic_msgs"
SRC_URI = "git://github.com/ros2-gbp/geographic_info-release;${ROS_BRANCH};protocol=https"
SRCREV = "cf7176b9c2573ad1d6363c1032f2092118195a59"
S = "${WORKDIR}/git"
