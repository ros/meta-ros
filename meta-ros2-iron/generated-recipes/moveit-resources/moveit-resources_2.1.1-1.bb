...
# matches with: https://github.com/ros2-gbp/moveit_resources-release/archive/release/iron/moveit_resources/2.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/moveit_resources"
SRC_URI = "git://github.com/ros2-gbp/moveit_resources-release;${ROS_BRANCH};protocol=https"
SRCREV = "8fdde12ce7dfb6c9bfad01c50d5cef1049dd50b8"
S = "${WORKDIR}/git"
