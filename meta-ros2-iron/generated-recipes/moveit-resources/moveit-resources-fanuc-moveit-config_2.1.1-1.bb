...
# matches with: https://github.com/ros2-gbp/moveit_resources-release/archive/release/iron/moveit_resources_fanuc_moveit_config/2.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/moveit_resources_fanuc_moveit_config"
SRC_URI = "git://github.com/ros2-gbp/moveit_resources-release;${ROS_BRANCH};protocol=https"
SRCREV = "8aadb36f500a050837bc780436159820b8ecde4a"
S = "${WORKDIR}/git"
