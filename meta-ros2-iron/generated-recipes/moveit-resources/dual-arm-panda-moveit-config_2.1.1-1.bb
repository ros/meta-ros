...
# matches with: https://github.com/ros2-gbp/moveit_resources-release/archive/release/iron/dual_arm_panda_moveit_config/2.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/dual_arm_panda_moveit_config"
SRC_URI = "git://github.com/ros2-gbp/moveit_resources-release;${ROS_BRANCH};protocol=https"
SRCREV = "f0281b8ac4677bb004917d5e96f7033fb5fcdf3a"
S = "${WORKDIR}/git"
