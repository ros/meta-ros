...
# matches with: https://github.com/ros2-gbp/rqt_reconfigure-release/archive/release/iron/rqt_reconfigure/1.3.4-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rqt_reconfigure"
SRC_URI = "git://github.com/ros2-gbp/rqt_reconfigure-release;${ROS_BRANCH};protocol=https"
SRCREV = "822187aa31e12f4f3db945aa6d4d646d70bc92fe"
S = "${WORKDIR}/git"
