...
# matches with: https://github.com/ros2-gbp/automotive_autonomy_msgs-release/archive/release/iron/automotive_navigation_msgs/3.0.4-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/automotive_navigation_msgs"
SRC_URI = "git://github.com/ros2-gbp/automotive_autonomy_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "787129f72b65f083bbf5fdb0b860357c42c5ac4f"
S = "${WORKDIR}/git"
