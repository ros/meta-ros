...
# matches with: https://github.com/ros2-gbp/unique_identifier_msgs-release/archive/release/iron/unique_identifier_msgs/2.3.2-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/unique_identifier_msgs"
SRC_URI = "git://github.com/ros2-gbp/unique_identifier_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "6d6008dd8ff02f0692140059583d7ac9974d13f5"
S = "${WORKDIR}/git"
