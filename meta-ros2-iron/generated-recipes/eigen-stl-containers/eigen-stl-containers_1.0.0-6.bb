...
# matches with: https://github.com/ros2-gbp/eigen_stl_containers-release/archive/release/iron/eigen_stl_containers/1.0.0-6.tar.gz
ROS_BRANCH ?= "branch=release/iron/eigen_stl_containers"
SRC_URI = "git://github.com/ros2-gbp/eigen_stl_containers-release;${ROS_BRANCH};protocol=https"
SRCREV = "343c48f9c0e4efa4c357f9b8078f19bb8e89bf5a"
S = "${WORKDIR}/git"
