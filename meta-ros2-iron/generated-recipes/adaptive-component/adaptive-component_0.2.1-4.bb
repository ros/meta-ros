...
# matches with: https://github.com/ros2-gbp/adaptive_component-release/archive/release/iron/adaptive_component/0.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/adaptive_component"
SRC_URI = "git://github.com/ros2-gbp/adaptive_component-release;${ROS_BRANCH};protocol=https"
SRCREV = "20de63833396703fff970dc1c20da1b2887dbcc2"
S = "${WORKDIR}/git"
