...
# matches with: https://github.com/ros2-gbp/metavision_driver-release/archive/release/iron/metavision_driver/1.2.8-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/metavision_driver"
SRC_URI = "git://github.com/ros2-gbp/metavision_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "b6381409f3d9155d60317c245c401cd3d8e7608d"
S = "${WORKDIR}/git"
