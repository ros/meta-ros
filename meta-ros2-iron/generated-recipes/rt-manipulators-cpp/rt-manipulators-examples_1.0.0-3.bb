...
# matches with: https://github.com/ros2-gbp/rt_manipulators_cpp-release/archive/release/iron/rt_manipulators_examples/1.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/rt_manipulators_examples"
SRC_URI = "git://github.com/ros2-gbp/rt_manipulators_cpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "949ee493c24b11b7aaf85844a46c8c923549c076"
S = "${WORKDIR}/git"
