...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/iron/etsi_its_cpm_ts_msgs/2.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/etsi_its_cpm_ts_msgs"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "9acb4863e8872eb5a51fa0dd023bbf87f0a468b6"
S = "${WORKDIR}/git"
