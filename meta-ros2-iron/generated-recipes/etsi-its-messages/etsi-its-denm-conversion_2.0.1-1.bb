...
# matches with: https://github.com/ika-rwth-aachen/etsi_its_messages-release/archive/release/iron/etsi_its_denm_conversion/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/etsi_its_denm_conversion"
SRC_URI = "git://github.com/ika-rwth-aachen/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "5199049b9831db3e66ddd6502f0fe117e872790e"
S = "${WORKDIR}/git"
