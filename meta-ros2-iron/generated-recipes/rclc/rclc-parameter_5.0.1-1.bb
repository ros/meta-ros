...
# matches with: https://github.com/ros2-gbp/rclc-release/archive/release/iron/rclc_parameter/5.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rclc_parameter"
SRC_URI = "git://github.com/ros2-gbp/rclc-release;${ROS_BRANCH};protocol=https"
SRCREV = "dab812fb2b328a8e704b0943fe3199520cb6a4d4"
S = "${WORKDIR}/git"
