...
# matches with: https://github.com/ros2-gbp/random_numbers-release/archive/release/iron/random_numbers/2.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/random_numbers"
SRC_URI = "git://github.com/ros2-gbp/random_numbers-release;${ROS_BRANCH};protocol=https"
SRCREV = "d3726137ddf37329f87caa710a020b9eada2f242"
S = "${WORKDIR}/git"
