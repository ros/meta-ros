...
# matches with: https://github.com/luxonis/depthai-core-release/archive/release/iron/depthai/2.22.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/depthai"
SRC_URI = "git://github.com/luxonis/depthai-core-release;${ROS_BRANCH};protocol=https"
SRCREV = "a97def4d5bc0805abbd0b959cfdc41166dfd59f7"
S = "${WORKDIR}/git"
