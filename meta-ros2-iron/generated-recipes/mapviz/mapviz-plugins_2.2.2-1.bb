...
# matches with: https://github.com/ros2-gbp/mapviz-release/archive/release/iron/mapviz_plugins/2.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mapviz_plugins"
SRC_URI = "git://github.com/ros2-gbp/mapviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "005c3b2059d19ae9d827722e2f040009c2e95f73"
S = "${WORKDIR}/git"
