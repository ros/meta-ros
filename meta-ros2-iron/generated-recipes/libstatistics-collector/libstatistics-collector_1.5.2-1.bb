...
# matches with: https://github.com/ros2-gbp/libstatistics_collector-release/archive/release/iron/libstatistics_collector/1.5.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/libstatistics_collector"
SRC_URI = "git://github.com/ros2-gbp/libstatistics_collector-release;${ROS_BRANCH};protocol=https"
SRCREV = "4d8c8c6c27069dccee61221824b30876cbc8eba3"
S = "${WORKDIR}/git"
