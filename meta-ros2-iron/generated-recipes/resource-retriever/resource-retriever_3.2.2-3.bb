...
# matches with: https://github.com/ros2-gbp/resource_retriever-release/archive/release/iron/resource_retriever/3.2.2-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/resource_retriever"
SRC_URI = "git://github.com/ros2-gbp/resource_retriever-release;${ROS_BRANCH};protocol=https"
SRCREV = "eb041057e50165e5e8e0eb98a02c7faee19819b2"
S = "${WORKDIR}/git"
