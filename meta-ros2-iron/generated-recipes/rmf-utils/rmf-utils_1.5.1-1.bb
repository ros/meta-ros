...
# matches with: https://github.com/ros2-gbp/rmf_utils-release/archive/release/iron/rmf_utils/1.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rmf_utils"
SRC_URI = "git://github.com/ros2-gbp/rmf_utils-release;${ROS_BRANCH};protocol=https"
SRCREV = "d62a9500eb8d8ac13b4c72549547f53ec6f88f7a"
S = "${WORKDIR}/git"
