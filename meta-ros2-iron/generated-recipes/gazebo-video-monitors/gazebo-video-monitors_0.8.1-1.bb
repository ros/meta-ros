...
# matches with: https://github.com/ros2-gbp/gazebo_video_monitors-release/archive/release/iron/gazebo_video_monitors/0.8.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/gazebo_video_monitors"
SRC_URI = "git://github.com/ros2-gbp/gazebo_video_monitors-release;${ROS_BRANCH};protocol=https"
SRCREV = "d7426758e230021cf1491f8c43c2af63b0d8417b"
S = "${WORKDIR}/git"
