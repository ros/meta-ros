...
# matches with: https://github.com/ros2-gbp/gazebo_video_monitors-release/archive/release/iron/gazebo_video_monitor_utils/0.8.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/gazebo_video_monitor_utils"
SRC_URI = "git://github.com/ros2-gbp/gazebo_video_monitors-release;${ROS_BRANCH};protocol=https"
SRCREV = "b01d99c02e5acd2d7d693af71eb2cf6c6434b750"
S = "${WORKDIR}/git"
