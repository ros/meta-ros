...
# matches with: https://github.com/ros2-gbp/gazebo_video_monitors-release/archive/release/iron/gazebo_video_monitor_plugins/0.8.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/gazebo_video_monitor_plugins"
SRC_URI = "git://github.com/ros2-gbp/gazebo_video_monitors-release;${ROS_BRANCH};protocol=https"
SRCREV = "403f34e36b301a9e8971f52c08eda2713e3829af"
S = "${WORKDIR}/git"
