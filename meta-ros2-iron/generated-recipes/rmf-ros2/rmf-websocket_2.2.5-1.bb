...
# matches with: https://github.com/ros2-gbp/rmf_ros2-release/archive/release/iron/rmf_websocket/2.2.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rmf_websocket"
SRC_URI = "git://github.com/ros2-gbp/rmf_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "c0ede0830163732561ff4d63418d87ccaaa42bf5"
S = "${WORKDIR}/git"
