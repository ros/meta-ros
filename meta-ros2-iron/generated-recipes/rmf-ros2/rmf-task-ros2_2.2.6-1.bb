...
# matches with: https://github.com/ros2-gbp/rmf_ros2-release/archive/release/iron/rmf_task_ros2/2.2.6-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rmf_task_ros2"
SRC_URI = "git://github.com/ros2-gbp/rmf_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "20874c740efef2f8b62a8c8847d5d4a3e12434a9"
S = "${WORKDIR}/git"
