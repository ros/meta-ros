...
# matches with: https://github.com/ros2-gbp/rmf_ros2-release/archive/release/iron/rmf_websocket/2.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rmf_websocket"
SRC_URI = "git://github.com/ros2-gbp/rmf_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5b99339dd9b322571edf2913c414ca8b61da9eae"
S = "${WORKDIR}/git"
