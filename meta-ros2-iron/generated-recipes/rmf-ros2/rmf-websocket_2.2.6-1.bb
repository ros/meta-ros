...
# matches with: https://github.com/ros2-gbp/rmf_ros2-release/archive/release/iron/rmf_websocket/2.2.6-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rmf_websocket"
SRC_URI = "git://github.com/ros2-gbp/rmf_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "93306c559be4967d5804a78bfbe3c9e766aba622"
S = "${WORKDIR}/git"
