...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/iron/lifecycle_msgs/1.6.0-2.tar.gz
ROS_BRANCH ?= "branch=release/iron/lifecycle_msgs"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "f60a09f8a31f6c3e99b3c7b6bbd6dc1ba65e1a27"
S = "${WORKDIR}/git"
