...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/iron/statistics_msgs/1.6.0-2.tar.gz
ROS_BRANCH ?= "branch=release/iron/statistics_msgs"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "541510897e2b26b82f3e2bca65ecb566d58fb98e"
S = "${WORKDIR}/git"
