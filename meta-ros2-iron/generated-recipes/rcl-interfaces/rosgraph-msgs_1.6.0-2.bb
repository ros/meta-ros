...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/iron/rosgraph_msgs/1.6.0-2.tar.gz
ROS_BRANCH ?= "branch=release/iron/rosgraph_msgs"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "78f7ade13b9467e31455cc020079e0bf95f19b6b"
S = "${WORKDIR}/git"
