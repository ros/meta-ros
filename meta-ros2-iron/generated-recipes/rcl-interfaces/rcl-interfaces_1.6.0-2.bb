...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/iron/rcl_interfaces/1.6.0-2.tar.gz
ROS_BRANCH ?= "branch=release/iron/rcl_interfaces"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "24fe82de724c92c1350ac1d290bec9d6911bd9f8"
S = "${WORKDIR}/git"
