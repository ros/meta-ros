...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/iron/action_msgs/1.6.0-2.tar.gz
ROS_BRANCH ?= "branch=release/iron/action_msgs"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "5fde4e7fe19e3dbd07e0a2ec8cfd884da42bde47"
S = "${WORKDIR}/git"
