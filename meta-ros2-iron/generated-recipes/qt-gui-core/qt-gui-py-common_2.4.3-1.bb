...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/iron/qt_gui_py_common/2.4.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/qt_gui_py_common"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "dcfa8c342c077952ce1f60eebc2570e0d65d5f74"
S = "${WORKDIR}/git"
