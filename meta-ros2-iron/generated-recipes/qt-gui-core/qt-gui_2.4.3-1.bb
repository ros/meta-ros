...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/iron/qt_gui/2.4.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "5ceecce5428dd162238efccd3607d01b832595a9"
S = "${WORKDIR}/git"
