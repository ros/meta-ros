...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/iron/qt_gui_cpp/2.4.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/qt_gui_cpp"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "7f458417f84751e32e7bb5d3a0a36797cf8ccafe"
S = "${WORKDIR}/git"
