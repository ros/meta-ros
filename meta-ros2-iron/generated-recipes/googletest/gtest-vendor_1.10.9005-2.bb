...
# matches with: https://github.com/ros2-gbp/googletest-release/archive/release/iron/gtest_vendor/1.10.9005-2.tar.gz
ROS_BRANCH ?= "branch=release/iron/gtest_vendor"
SRC_URI = "git://github.com/ros2-gbp/googletest-release;${ROS_BRANCH};protocol=https"
SRCREV = "fb4ccff40df38bbfdd91e96c285c8f1bef01081c"
S = "${WORKDIR}/git"
