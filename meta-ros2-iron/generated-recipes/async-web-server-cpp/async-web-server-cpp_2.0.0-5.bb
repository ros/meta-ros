...
# matches with: https://github.com/ros2-gbp/async_web_server_cpp-release/archive/release/iron/async_web_server_cpp/2.0.0-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/async_web_server_cpp"
SRC_URI = "git://github.com/ros2-gbp/async_web_server_cpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "4f1e3dadd9eee5dce85158e45c7e95c0b93557c2"
S = "${WORKDIR}/git"
