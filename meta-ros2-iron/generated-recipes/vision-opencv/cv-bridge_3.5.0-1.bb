...
# matches with: https://github.com/ros2-gbp/vision_opencv-release/archive/release/iron/cv_bridge/3.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/cv_bridge"
SRC_URI = "git://github.com/ros2-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "f65382b65093b2b3dd7a39ac2d75e21e9732292a"
S = "${WORKDIR}/git"
