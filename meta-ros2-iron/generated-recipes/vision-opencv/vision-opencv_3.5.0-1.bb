...
# matches with: https://github.com/ros2-gbp/vision_opencv-release/archive/release/iron/vision_opencv/3.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/vision_opencv"
SRC_URI = "git://github.com/ros2-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "8afbf806ebec6e4a2ac946458656aca0b55a6334"
S = "${WORKDIR}/git"
