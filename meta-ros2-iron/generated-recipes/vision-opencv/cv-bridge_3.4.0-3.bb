...
# matches with: https://github.com/ros2-gbp/vision_opencv-release/archive/release/iron/cv_bridge/3.4.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/cv_bridge"
SRC_URI = "git://github.com/ros2-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "efedf1338dcf91fcb1091230bcc0e8e1d18b9442"
S = "${WORKDIR}/git"
