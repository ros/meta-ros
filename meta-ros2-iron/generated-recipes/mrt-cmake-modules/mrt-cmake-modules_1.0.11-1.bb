...
# matches with: https://github.com/ros2-gbp/mrt_cmake_modules-release/archive/release/iron/mrt_cmake_modules/1.0.11-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mrt_cmake_modules"
SRC_URI = "git://github.com/ros2-gbp/mrt_cmake_modules-release;${ROS_BRANCH};protocol=https"
SRCREV = "e0013c6988ebf0dc8416b6b5f96a52491a2d0577"
S = "${WORKDIR}/git"
