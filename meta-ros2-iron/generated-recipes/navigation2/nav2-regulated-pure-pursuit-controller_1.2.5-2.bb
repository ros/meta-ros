...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_regulated_pure_pursuit_controller/1.2.5-2.tar.gz
...
SRCREV = "ff3ce08cfa73a4e229a730c053cf76d4eb1d1ac5"
S = "${WORKDIR}/git"
