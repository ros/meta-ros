...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_regulated_pure_pursuit_controller/1.2.7-1.tar.gz
...
SRCREV = "99a73f60b73154f40cbbe3050bd9af05567f8d3a"
S = "${WORKDIR}/git"
