...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_regulated_pure_pursuit_controller/1.2.6-1.tar.gz
...
SRCREV = "acfeeb7a53a3574a7e17415b3db5166011812e22"
S = "${WORKDIR}/git"
