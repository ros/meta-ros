...
# matches with: https://github.com/ros2-gbp/yaml_cpp_vendor-release/archive/release/iron/yaml_cpp_vendor/8.1.2-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/yaml_cpp_vendor"
SRC_URI = "git://github.com/ros2-gbp/yaml_cpp_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "1299c80cd7e90b0ff5d26cbc10b238fb459758ec"
S = "${WORKDIR}/git"
