...
# matches with: https://github.com/ros2-gbp/marti_messages-release/archive/release/iron/marti_perception_msgs/1.5.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/marti_perception_msgs"
SRC_URI = "git://github.com/ros2-gbp/marti_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "3ce8bbe4422fc6f7b7ffde2ebde0e29845e707ec"
S = "${WORKDIR}/git"
