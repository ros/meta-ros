...
# matches with: https://github.com/ros2-gbp/marti_messages-release/archive/release/iron/marti_common_msgs/1.5.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/marti_common_msgs"
SRC_URI = "git://github.com/ros2-gbp/marti_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "46f10213deed487843401479e0db6e9c114b75c0"
S = "${WORKDIR}/git"
