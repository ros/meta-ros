...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/iron/mavros_extras/2.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mavros_extras"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "548db11da1d62be4f962706fa7a6ab369d3a1ae5"
S = "${WORKDIR}/git"
