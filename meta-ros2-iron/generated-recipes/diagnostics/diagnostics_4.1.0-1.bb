...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/iron/diagnostics/4.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/diagnostics"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "106272c873b997be4a02ac1fa6ec37a025f240e0"
S = "${WORKDIR}/git"
