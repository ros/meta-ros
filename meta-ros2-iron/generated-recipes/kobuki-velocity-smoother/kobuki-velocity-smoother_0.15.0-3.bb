...
# matches with: https://github.com/ros2-gbp/kobuki_velocity_smoother-release/archive/release/iron/kobuki_velocity_smoother/0.15.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/kobuki_velocity_smoother"
SRC_URI = "git://github.com/ros2-gbp/kobuki_velocity_smoother-release;${ROS_BRANCH};protocol=https"
SRCREV = "0bbe450d26ba442a20b271962eae76a0614b32db"
S = "${WORKDIR}/git"
