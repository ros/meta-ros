...
# matches with: https://github.com/ros2-gbp/perception_pcl-release/archive/release/iron/pcl_ros/2.4.0-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/pcl_ros"
SRC_URI = "git://github.com/ros2-gbp/perception_pcl-release;${ROS_BRANCH};protocol=https"
SRCREV = "bca2d3a569e0b36ae6657dee2d3f0f8a66132e2e"
S = "${WORKDIR}/git"
