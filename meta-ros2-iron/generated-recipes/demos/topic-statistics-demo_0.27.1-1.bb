...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/iron/topic_statistics_demo/0.27.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/topic_statistics_demo"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "b96d64ecfae6ac11b6d7fe93f892cddd3a202f91"
S = "${WORKDIR}/git"
