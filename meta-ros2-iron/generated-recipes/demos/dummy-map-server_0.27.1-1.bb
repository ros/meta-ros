...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/iron/dummy_map_server/0.27.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/dummy_map_server"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "3dfd000d786984a64367f949c0cda588a53544d1"
S = "${WORKDIR}/git"
