...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/iron/action_tutorials_py/0.27.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/action_tutorials_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "b0d600701dfe36afffa1b7a2e15e0af23cfaaf7e"
S = "${WORKDIR}/git"
