...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/iron/dummy_map_server/0.27.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/dummy_map_server"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "83cb317ea2f734893ef9051c9ce7f6d03961467a"
S = "${WORKDIR}/git"
