...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/iron/lifecycle_py/0.27.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/lifecycle_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "c2616e1d1f1cc312eb2fa312bf874ec9abfb1200"
S = "${WORKDIR}/git"
