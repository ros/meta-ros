...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/iron/topic_monitor/0.27.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/topic_monitor"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "efcab25b212b0dc3e413103dc964a187edb8ce5b"
S = "${WORKDIR}/git"
