...
# matches with: https://github.com/ros2-gbp/plotjuggler_msgs-release/archive/release/iron/plotjuggler_msgs/0.2.3-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/plotjuggler_msgs"
SRC_URI = "git://github.com/ros2-gbp/plotjuggler_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "8a5e84d3ca111c660d382c27a69e5e8e15a16bf3"
S = "${WORKDIR}/git"
