...
# matches with: https://github.com/ros2-gbp/ffmpeg_encoder_decoder-release/archive/release/iron/ffmpeg_encoder_decoder/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ffmpeg_encoder_decoder"
SRC_URI = "git://github.com/ros2-gbp/ffmpeg_encoder_decoder-release;${ROS_BRANCH};protocol=https"
SRCREV = "f49ad2253e25ff090cd6f6bbe9a4f9562a7743ed"
S = "${WORKDIR}/git"
