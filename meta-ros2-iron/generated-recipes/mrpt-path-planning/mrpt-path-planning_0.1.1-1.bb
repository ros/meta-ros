...
# matches with: https://github.com/ros2-gbp/mrpt_path_planning-release/archive/release/iron/mrpt_path_planning/0.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mrpt_path_planning"
SRC_URI = "git://github.com/ros2-gbp/mrpt_path_planning-release;${ROS_BRANCH};protocol=https"
SRCREV = "e90557ea0ad3381eaa5c907df6cb078903e1eb1b"
S = "${WORKDIR}/git"
