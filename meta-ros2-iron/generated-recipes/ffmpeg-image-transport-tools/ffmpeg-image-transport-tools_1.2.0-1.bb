...
# matches with: https://github.com/ros2-gbp/ffmpeg_image_transport_tools-release/archive/release/iron/ffmpeg_image_transport_tools/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ffmpeg_image_transport_tools"
SRC_URI = "git://github.com/ros2-gbp/ffmpeg_image_transport_tools-release;${ROS_BRANCH};protocol=https"
SRCREV = "bfc15ace4587d9a715b45f8f749f88da8ecc87f1"
S = "${WORKDIR}/git"
