...
# matches with: https://github.com/ros2-gbp/realtime_support-release/archive/release/iron/rttest/0.15.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/rttest"
SRC_URI = "git://github.com/ros2-gbp/realtime_support-release;${ROS_BRANCH};protocol=https"
SRCREV = "f06d92bd7b625ad91f97db903aa47c81050661e6"
S = "${WORKDIR}/git"
