...
# matches with: https://github.com/ros2-gbp/velodyne_simulator-release/archive/release/iron/velodyne_description/2.0.3-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/velodyne_description"
SRC_URI = "git://github.com/ros2-gbp/velodyne_simulator-release;${ROS_BRANCH};protocol=https"
SRCREV = "68e4231b7effd7ece468e0a3fd267a7fc960de9d"
S = "${WORKDIR}/git"
