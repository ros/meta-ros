...
# matches with: https://github.com/ros2-gbp/velodyne_simulator-release/archive/release/iron/velodyne_gazebo_plugins/2.0.3-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/velodyne_gazebo_plugins"
SRC_URI = "git://github.com/ros2-gbp/velodyne_simulator-release;${ROS_BRANCH};protocol=https"
SRCREV = "c1d9cebfecccb1aba542c8e6fa6f4e3a8988ec77"
S = "${WORKDIR}/git"
