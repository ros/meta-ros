...
# matches with: https://github.com/ros2-gbp/cascade_lifecycle-release/archive/release/iron/rclcpp_cascade_lifecycle/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rclcpp_cascade_lifecycle"
SRC_URI = "git://github.com/ros2-gbp/cascade_lifecycle-release;${ROS_BRANCH};protocol=https"
SRCREV = "1747537dffb4889db1ce1b15ca39baddbf3f3f6a"
S = "${WORKDIR}/git"
