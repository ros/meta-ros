...
# matches with: https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/iron/microstrain_inertial_driver/4.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/microstrain_inertial_driver"
SRC_URI = "git://github.com/ros2-gbp/microstrain_inertial-release;${ROS_BRANCH};protocol=https"
SRCREV = "fed52824f3ef490c543df9b8e1ac07ad68affa1d"
S = "${WORKDIR}/git"
