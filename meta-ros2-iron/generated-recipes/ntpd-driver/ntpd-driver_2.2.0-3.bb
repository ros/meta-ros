...
# matches with: https://github.com/ros2-gbp/ntpd_driver-release/archive/release/iron/ntpd_driver/2.2.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/ntpd_driver"
SRC_URI = "git://github.com/ros2-gbp/ntpd_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "ed834048431e5643287d3a48ab03b3de694e242f"
S = "${WORKDIR}/git"
