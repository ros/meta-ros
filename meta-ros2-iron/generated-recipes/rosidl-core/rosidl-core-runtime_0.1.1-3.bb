...
# matches with: https://github.com/ros2-gbp/rosidl_core-release/archive/release/iron/rosidl_core_runtime/0.1.1-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/rosidl_core_runtime"
SRC_URI = "git://github.com/ros2-gbp/rosidl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "b6ce03e72358f55bd5191b20c03a3f923a7135f1"
S = "${WORKDIR}/git"
