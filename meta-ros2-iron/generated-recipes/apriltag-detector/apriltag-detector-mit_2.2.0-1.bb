...
# matches with: https://github.com/ros2-gbp/apriltag_detector-release/archive/release/iron/apriltag_detector_mit/2.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/apriltag_detector_mit"
SRC_URI = "git://github.com/ros2-gbp/apriltag_detector-release;${ROS_BRANCH};protocol=https"
SRCREV = "7ee1829816ac213fb6edb2caadd6e9eb5fac2da5"
S = "${WORKDIR}/git"
