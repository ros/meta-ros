...
# matches with: https://github.com/ros2-gbp/apriltag_detector-release/archive/release/iron/apriltag_detector/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/apriltag_detector"
SRC_URI = "git://github.com/ros2-gbp/apriltag_detector-release;${ROS_BRANCH};protocol=https"
SRCREV = "8f58a97851c514d4f7b7ba416bd45bb96c6e4fde"
S = "${WORKDIR}/git"
