...
# matches with: https://github.com/ros2-gbp/apriltag_detector-release/archive/release/iron/apriltag_draw/2.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/apriltag_draw"
SRC_URI = "git://github.com/ros2-gbp/apriltag_detector-release;${ROS_BRANCH};protocol=https"
SRCREV = "bf80e156f7d5be1bf6200232bc35a0b73e7c3f0f"
S = "${WORKDIR}/git"
