...
# matches with: https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/iron/libphidget22/2.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/libphidget22"
SRC_URI = "git://github.com/ros2-gbp/phidgets_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "07132f70ca13eba9d0bc75ab15b0a697853276ba"
S = "${WORKDIR}/git"
