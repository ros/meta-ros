...
# matches with: https://github.com/ros2-gbp/udp_msgs-release/archive/release/iron/udp_msgs/0.0.3-6.tar.gz
ROS_BRANCH ?= "branch=release/iron/udp_msgs"
SRC_URI = "git://github.com/ros2-gbp/udp_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "4481d89b75724427d674094d5b62947caeadc679"
S = "${WORKDIR}/git"
