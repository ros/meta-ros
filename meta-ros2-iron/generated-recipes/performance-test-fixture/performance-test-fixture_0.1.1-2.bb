...
# matches with: https://github.com/ros2-gbp/performance_test_fixture-release/archive/release/iron/performance_test_fixture/0.1.1-2.tar.gz
ROS_BRANCH ?= "branch=release/iron/performance_test_fixture"
SRC_URI = "git://github.com/ros2-gbp/performance_test_fixture-release;${ROS_BRANCH};protocol=https"
SRCREV = "adba2bd7ca271f7f0d1bf0cbd35ece1d8b56ac49"
S = "${WORKDIR}/git"
