...
# matches with: https://github.com/ros2-gbp/rmf_building_map_msgs-release/archive/release/iron/rmf_building_map_msgs/1.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rmf_building_map_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_building_map_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "2208f68bd0a6ee15440a3f7fca1bd2a300e57b78"
S = "${WORKDIR}/git"
