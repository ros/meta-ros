...
# matches with: https://github.com/ros2-gbp/event_camera_codecs-release/archive/release/iron/event_camera_codecs/1.2.4-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/event_camera_codecs"
SRC_URI = "git://github.com/ros2-gbp/event_camera_codecs-release;${ROS_BRANCH};protocol=https"
SRCREV = "a9af8e0f9a76a9b0e7f1702773101f667fc3d461"
S = "${WORKDIR}/git"
