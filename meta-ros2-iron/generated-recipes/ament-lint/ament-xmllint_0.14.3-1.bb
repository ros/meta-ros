...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/iron/ament_xmllint/0.14.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ament_xmllint"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "b9a9797ed4d5a9b4a554ed881c5120d71731c556"
S = "${WORKDIR}/git"
