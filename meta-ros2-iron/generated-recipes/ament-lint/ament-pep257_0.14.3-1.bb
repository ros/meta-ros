...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/iron/ament_pep257/0.14.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ament_pep257"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "237890f09df4dcf3ba78feaf4ae1900a2ae4d457"
S = "${WORKDIR}/git"
