...
# matches with: https://github.com/ros2-gbp/event_camera_renderer-release/archive/release/iron/event_camera_renderer/1.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/event_camera_renderer"
SRC_URI = "git://github.com/ros2-gbp/event_camera_renderer-release;${ROS_BRANCH};protocol=https"
SRCREV = "9b9aef7d7de3dd22134fff3fa56bc87df7759f34"
S = "${WORKDIR}/git"
