...
# matches with: https://github.com/ros2-gbp/example_interfaces-release/archive/release/iron/example_interfaces/0.10.2-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/example_interfaces"
SRC_URI = "git://github.com/ros2-gbp/example_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "0840dfbb4c42492c24f55125091b3d26acfefc80"
S = "${WORKDIR}/git"
