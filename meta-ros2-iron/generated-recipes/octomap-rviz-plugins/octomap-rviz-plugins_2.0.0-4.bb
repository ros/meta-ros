...
# matches with: https://github.com/ros2-gbp/octomap_rviz_plugins-release/archive/release/iron/octomap_rviz_plugins/2.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/octomap_rviz_plugins"
SRC_URI = "git://github.com/ros2-gbp/octomap_rviz_plugins-release;${ROS_BRANCH};protocol=https"
SRCREV = "18c889683e8acc95f59d2fd36e6e888032b20504"
S = "${WORKDIR}/git"
