...
# matches with: https://github.com/ros2-gbp/ros_foxglove_msgs-release/archive/release/iron/foxglove_msgs/2.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/foxglove_msgs"
SRC_URI = "git://github.com/ros2-gbp/ros_foxglove_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "6670a3404fadc12caf2712959834c471da211a80"
S = "${WORKDIR}/git"
