...
# matches with: https://github.com/ros-drivers-gbp/flir_camera_driver-release/archive/release/iron/spinnaker_camera_driver/2.2.17-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/spinnaker_camera_driver"
SRC_URI = "git://github.com/ros-drivers-gbp/flir_camera_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "986c11c67cb93ffa5fb6fbbf90690760ba653316"
S = "${WORKDIR}/git"
