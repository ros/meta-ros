...
# matches with: https://github.com/ros-drivers-gbp/flir_camera_driver-release/archive/release/iron/spinnaker_synchronized_camera_driver/2.2.17-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/spinnaker_synchronized_camera_driver"
SRC_URI = "git://github.com/ros-drivers-gbp/flir_camera_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "1c0062c8205d710fec822b7d0d306687ecac485d"
S = "${WORKDIR}/git"
