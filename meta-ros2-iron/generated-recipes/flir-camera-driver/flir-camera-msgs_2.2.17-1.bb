...
# matches with: https://github.com/ros-drivers-gbp/flir_camera_driver-release/archive/release/iron/flir_camera_msgs/2.2.17-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/flir_camera_msgs"
SRC_URI = "git://github.com/ros-drivers-gbp/flir_camera_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "96fede481bb5fb7d43f3906e6a32bad95fab0e50"
S = "${WORKDIR}/git"
