...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_relocalization/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_relocalization"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "19178f2746b1d03f0bcc1b1b161dd28a497e44a2"
S = "${WORKDIR}/git"
