...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/kitti_metrics_eval/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/kitti_metrics_eval"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "009efa483c422e244b22845f5ce1eb674068db8c"
S = "${WORKDIR}/git"
