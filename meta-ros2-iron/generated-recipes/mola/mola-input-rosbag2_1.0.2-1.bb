...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_input_rosbag2/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_input_rosbag2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "3f46f84d4daa72e03742eca35af4505eb4781d1b"
S = "${WORKDIR}/git"
