...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_navstate_fuse/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_navstate_fuse"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "68d248c52820e4cc46abb02067f7bd93ed0565df"
S = "${WORKDIR}/git"
