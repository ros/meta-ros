...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_traj_tools/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "9a87e8a8e8e1bbdc924678bcbdbd08d9a951c855"
S = "${WORKDIR}/git"
