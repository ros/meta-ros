...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_traj_tools/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "c97fec211c11eb5146710d89cd2258eb4b413370"
S = "${WORKDIR}/git"
