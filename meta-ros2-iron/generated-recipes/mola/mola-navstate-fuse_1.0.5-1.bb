...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_navstate_fuse/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_navstate_fuse"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "8ad5f8f87826883073f13b7455908d225cd90c38"
S = "${WORKDIR}/git"
