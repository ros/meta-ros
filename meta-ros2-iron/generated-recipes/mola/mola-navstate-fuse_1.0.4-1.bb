...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_navstate_fuse/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_navstate_fuse"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "da83cae51c62f5fe0a1d0107af472364c3ccf16c"
S = "${WORKDIR}/git"
