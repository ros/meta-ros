...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_traj_tools/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "1d4b2f90d10c4ad9207d0a0fcb0256de1976eba6"
S = "${WORKDIR}/git"
