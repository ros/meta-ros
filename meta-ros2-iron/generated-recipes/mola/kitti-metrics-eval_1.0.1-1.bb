...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/kitti_metrics_eval/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/kitti_metrics_eval"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "bbc6e2e55f40459227e636dac73fbfc4ebca3346"
S = "${WORKDIR}/git"
