...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_navstate_fg/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_navstate_fg"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "feeb31c1e6caafd02baea11140efe078426be169"
S = "${WORKDIR}/git"
