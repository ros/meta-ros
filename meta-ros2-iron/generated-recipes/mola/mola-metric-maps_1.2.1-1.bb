...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_metric_maps/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_metric_maps"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "6946de2108b3bc2328383f705eb8ffb431cd2947"
S = "${WORKDIR}/git"
