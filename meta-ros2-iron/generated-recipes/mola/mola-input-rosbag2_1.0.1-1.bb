...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_input_rosbag2/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_input_rosbag2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "bc129701e8d57db308a8d12e3c370de562d4844f"
S = "${WORKDIR}/git"
