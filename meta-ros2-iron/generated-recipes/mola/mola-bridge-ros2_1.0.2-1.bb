...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_bridge_ros2/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_bridge_ros2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "cdee29ebef82d989db210b61e09e9572125176e5"
S = "${WORKDIR}/git"
