...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_bridge_ros2/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_bridge_ros2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "48704726e498ee6b6fbb67caea324154e94af45d"
S = "${WORKDIR}/git"
