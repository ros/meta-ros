...
# matches with: https://github.com/ros2-gbp/aws_robomaker_small_warehouse_world-release/archive/release/iron/aws_robomaker_small_warehouse_world/1.0.5-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/aws_robomaker_small_warehouse_world"
SRC_URI = "git://github.com/ros2-gbp/aws_robomaker_small_warehouse_world-release;${ROS_BRANCH};protocol=https"
SRCREV = "23e9561ab298142edc8bb3a34e284237f93a395a"
S = "${WORKDIR}/git"
