...
# matches with: https://github.com/ros2-gbp/ament_cmake_catch2-release/archive/release/iron/ament_cmake_catch2/1.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ament_cmake_catch2"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake_catch2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e3d9a8e29b825dd2f52222b7cae3b6dc2a07c565"
S = "${WORKDIR}/git"
