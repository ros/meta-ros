...
# matches with: https://github.com/ros2-gbp/picknik_controllers-release/archive/release/iron/picknik_twist_controller/0.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/picknik_twist_controller"
SRC_URI = "git://github.com/ros2-gbp/picknik_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "b220922f3b742b908b1c4c5d38650a6b70eb1ed3"
S = "${WORKDIR}/git"
