...
# matches with: https://github.com/ros2-gbp/picknik_controllers-release/archive/release/iron/picknik_reset_fault_controller/0.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/picknik_reset_fault_controller"
SRC_URI = "git://github.com/ros2-gbp/picknik_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "e5db281063a81755a6872a8ad4bc2e8acdb6afcb"
S = "${WORKDIR}/git"
