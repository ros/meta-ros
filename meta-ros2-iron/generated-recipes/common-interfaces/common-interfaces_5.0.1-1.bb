...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/iron/common_interfaces/5.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/common_interfaces"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "f23f9cec21cffa31a0bc37d7c0cae452d27dbd70"
S = "${WORKDIR}/git"
