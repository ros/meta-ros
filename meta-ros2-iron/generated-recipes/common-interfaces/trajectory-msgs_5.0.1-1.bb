...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/iron/trajectory_msgs/5.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/trajectory_msgs"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "fb3c9515121f0dbf489127808baa4312ea51f2ca"
S = "${WORKDIR}/git"
