...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/iron/geometry_msgs/5.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/geometry_msgs"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "fb793b7a6876745257ed17cd6fc7c57f2a01ae0c"
S = "${WORKDIR}/git"
