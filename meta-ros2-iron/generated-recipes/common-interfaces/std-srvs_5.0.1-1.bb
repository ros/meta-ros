...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/iron/std_srvs/5.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/std_srvs"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "02af571c75994df7f45acb0846091096db3e36fd"
S = "${WORKDIR}/git"
