...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/iron/visualization_msgs/5.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/visualization_msgs"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "06fb7066af30950706fdca3ad6679605f83d78ed"
S = "${WORKDIR}/git"
