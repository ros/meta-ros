...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_gz_bridge/0.245.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_gz_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "bf6e0f0d55547eb7b50100fa9111231fdbde5563"
S = "${WORKDIR}/git"
