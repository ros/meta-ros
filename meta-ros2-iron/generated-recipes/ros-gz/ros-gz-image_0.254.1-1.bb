...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_gz_image/0.254.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_gz_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "2d30ccf881ed13af098c1db90dbcd1f0ca37a6bd"
S = "${WORKDIR}/git"
