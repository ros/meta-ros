...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_ign_image/0.254.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_ign_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "dd8e4e8565d973e6ed533d64e714afd28f2ef64b"
S = "${WORKDIR}/git"
