...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_ign_gazebo/0.254.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_ign_gazebo"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "19fda23a76b77b3ed7622c9819be22acc270bea6"
S = "${WORKDIR}/git"
