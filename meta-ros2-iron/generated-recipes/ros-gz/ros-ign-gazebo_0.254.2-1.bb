...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_ign_gazebo/0.254.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_ign_gazebo"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "e52ef32d8e001ee0b2e14639f44b61166c8d4e2f"
S = "${WORKDIR}/git"
