...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_gz_image/0.254.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_gz_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "8758e497c36db89470f06f551b88dea56fa9cd99"
S = "${WORKDIR}/git"
