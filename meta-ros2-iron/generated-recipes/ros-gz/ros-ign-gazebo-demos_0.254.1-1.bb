...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_ign_gazebo_demos/0.254.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_ign_gazebo_demos"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "bfef3f5632d841c321d2209afafc9ed9a0375c7e"
S = "${WORKDIR}/git"
