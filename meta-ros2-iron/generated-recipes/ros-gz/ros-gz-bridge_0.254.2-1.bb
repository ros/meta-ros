...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_gz_bridge/0.254.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_gz_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "8b67c3e520ba598aa9e879ae6492fd6b7a7c407c"
S = "${WORKDIR}/git"
