...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_gz_interfaces/0.254.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_gz_interfaces"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "ee7e5dffec326aeb592a2f6d32d2bd8eb3a18e1a"
S = "${WORKDIR}/git"
