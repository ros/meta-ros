...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_ign_gazebo/0.245.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_ign_gazebo"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "f5e1678bcdd8558c52eeca717f915986f92e5cca"
S = "${WORKDIR}/git"
