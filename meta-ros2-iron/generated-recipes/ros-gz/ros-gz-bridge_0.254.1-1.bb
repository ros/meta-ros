...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_gz_bridge/0.254.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_gz_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "666562d7462bfbdd5a582947900a5d18471ac20a"
S = "${WORKDIR}/git"
