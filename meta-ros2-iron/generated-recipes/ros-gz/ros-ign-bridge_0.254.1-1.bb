...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_ign_bridge/0.254.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_ign_bridge"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "b9b7a7e193718bbccea5b7e93464d55c9a90be60"
S = "${WORKDIR}/git"
