...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/iron/ros_ign_image/0.245.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_ign_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "449fa37a40b6fc124929de787d9f4a8cea0b056b"
S = "${WORKDIR}/git"
