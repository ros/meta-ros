...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/iron/theora_image_transport/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/theora_image_transport"
SRC_URI = "git://github.com/ros2-gbp/image_transport_plugins-release;${ROS_BRANCH};protocol=https"
SRCREV = "1da8757f7787d4eb64a81d110ebbb4c4541e46fe"
S = "${WORKDIR}/git"
