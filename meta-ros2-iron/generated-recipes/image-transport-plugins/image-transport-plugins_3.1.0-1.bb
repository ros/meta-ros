...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/iron/image_transport_plugins/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/image_transport_plugins"
SRC_URI = "git://github.com/ros2-gbp/image_transport_plugins-release;${ROS_BRANCH};protocol=https"
SRCREV = "9b5f3aa0f5a23596914d8d4f278175c3ac0476a3"
S = "${WORKDIR}/git"
