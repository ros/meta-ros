...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/iron/compressed_depth_image_transport/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/compressed_depth_image_transport"
SRC_URI = "git://github.com/ros2-gbp/image_transport_plugins-release;${ROS_BRANCH};protocol=https"
SRCREV = "19fccbe3ed7b05b3e7c47d4fa10b54feca867174"
S = "${WORKDIR}/git"
