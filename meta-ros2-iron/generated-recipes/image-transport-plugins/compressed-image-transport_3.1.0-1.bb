...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/iron/compressed_image_transport/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/compressed_image_transport"
SRC_URI = "git://github.com/ros2-gbp/image_transport_plugins-release;${ROS_BRANCH};protocol=https"
SRCREV = "256eac27f9b4d5f9409b6f85cb2f48bc095c0e8c"
S = "${WORKDIR}/git"
