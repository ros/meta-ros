...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/iron/ros2interface/0.25.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros2interface"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "f314391ef5a0a3caee59c0134e1bf348c9d9f0ee"
S = "${WORKDIR}/git"
