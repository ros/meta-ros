...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/iron/ros2interface/0.25.7-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros2interface"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "6931ea12aa38811d9dfe0db4c0102afb45fe70bb"
S = "${WORKDIR}/git"
