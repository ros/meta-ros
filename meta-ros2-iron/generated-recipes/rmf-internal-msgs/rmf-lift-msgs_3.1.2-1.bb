...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/iron/rmf_lift_msgs/3.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rmf_lift_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "978235992038fca9c9b0e5ddd9c0122bc4609c87"
S = "${WORKDIR}/git"
