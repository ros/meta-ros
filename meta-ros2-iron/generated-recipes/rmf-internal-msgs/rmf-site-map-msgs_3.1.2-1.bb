...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/iron/rmf_site_map_msgs/3.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rmf_site_map_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "aad4cd0285c4407a6294f69b555df2fe5d0b7159"
S = "${WORKDIR}/git"
