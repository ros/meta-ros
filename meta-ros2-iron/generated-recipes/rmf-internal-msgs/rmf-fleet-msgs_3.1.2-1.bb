...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/iron/rmf_fleet_msgs/3.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rmf_fleet_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "9689c26c82ba18ebc057744c5fc51b2aa583ed99"
S = "${WORKDIR}/git"
