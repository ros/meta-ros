...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/iron/rmf_scheduler_msgs/3.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rmf_scheduler_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "2b6a674f07fc0e50b5ddabee254f753db7f1b051"
S = "${WORKDIR}/git"
