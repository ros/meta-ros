...
# matches with: https://github.com/ros2-gbp/vrpn_mocap-release/archive/release/iron/vrpn_mocap/1.0.3-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/vrpn_mocap"
SRC_URI = "git://github.com/ros2-gbp/vrpn_mocap-release;${ROS_BRANCH};protocol=https"
SRCREV = "3ee02b7613da09f2a7f1803fb0eb5d26ff78fb3c"
S = "${WORKDIR}/git"
