...
# matches with: https://github.com/ros2-gbp/joint_state_publisher-release/archive/release/iron/joint_state_publisher_gui/2.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/joint_state_publisher_gui"
SRC_URI = "git://github.com/ros2-gbp/joint_state_publisher-release;${ROS_BRANCH};protocol=https"
SRCREV = "c1de8699fc5083f25170567313c5cf4efaf6a819"
S = "${WORKDIR}/git"
