...
# matches with: https://github.com/ros2-gbp/teleop_twist_joy-release/archive/release/iron/teleop_twist_joy/2.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/teleop_twist_joy"
SRC_URI = "git://github.com/ros2-gbp/teleop_twist_joy-release;${ROS_BRANCH};protocol=https"
SRCREV = "e94300d52f27ab9315933336924d0ca8322ba78f"
S = "${WORKDIR}/git"
