...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/iron/fuse_tutorials/1.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/fuse_tutorials"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "0ceec1a82da5bf565f0be20056b8bd24400c0650"
S = "${WORKDIR}/git"
