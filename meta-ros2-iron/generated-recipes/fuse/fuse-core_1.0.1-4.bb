...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/iron/fuse_core/1.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/fuse_core"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "8ff78bd32bd659940dbae4bbab8c470e7fbe4c0f"
S = "${WORKDIR}/git"
