...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/iron/fuse_constraints/1.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/fuse_constraints"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "bbaa2fc5d8ba04e65b129cabdf99c858415d42ff"
S = "${WORKDIR}/git"
