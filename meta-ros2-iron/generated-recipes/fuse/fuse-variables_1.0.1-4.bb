...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/iron/fuse_variables/1.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/fuse_variables"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "a01deb0cb5ef6f2bb73a607963f7a998611d83b3"
S = "${WORKDIR}/git"
