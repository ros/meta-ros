...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/iron/fuse_publishers/1.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/fuse_publishers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "a582456263181baac93469fe854c213e7378612f"
S = "${WORKDIR}/git"
