...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/iron/fuse_optimizers/1.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/fuse_optimizers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "50051cb9d007839b10a2b1418a1713454b8f21ee"
S = "${WORKDIR}/git"
