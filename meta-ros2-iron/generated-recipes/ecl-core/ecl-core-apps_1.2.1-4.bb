...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_core_apps/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/ecl_core_apps"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "d2d998a8a8eae2bdaf85d4836a7310cd33936cdc"
S = "${WORKDIR}/git"
