...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_command_line/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/ecl_command_line"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "5cd307b217515eb255a00664df3dc09bb3ed32a7"
S = "${WORKDIR}/git"
