...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_time/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/ecl_time"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "d7055872a565a4039fcd1790c974e4a8f6562dac"
S = "${WORKDIR}/git"
