...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_core/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/ecl_core"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "ea9b1fdcc0de35f130ace580301d60a2b7a0f65e"
S = "${WORKDIR}/git"
