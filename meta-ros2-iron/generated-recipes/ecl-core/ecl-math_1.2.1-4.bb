...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_math/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/ecl_math"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "a78330b8ea782199be94fb3110354af7b8569f81"
S = "${WORKDIR}/git"
