...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_sigslots/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/ecl_sigslots"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "35433ad33ac7580f7c86a6170171e9a5c8290b9c"
S = "${WORKDIR}/git"
