...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_containers/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/ecl_containers"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "8110ce6d5d9b8a23e8f949f0e15f449b849cecd4"
S = "${WORKDIR}/git"
