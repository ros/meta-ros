...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_exceptions/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/ecl_exceptions"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "4712427bf45e83db7fe31f12586a40bd1568108f"
S = "${WORKDIR}/git"
