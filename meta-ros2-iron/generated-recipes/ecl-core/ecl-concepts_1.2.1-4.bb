...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_concepts/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/ecl_concepts"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "060aad47e6ff23f664663186ded2e0d451adb194"
S = "${WORKDIR}/git"
