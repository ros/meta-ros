...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_statistics/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/ecl_statistics"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "199fae31ffa86bccbdbbbc8465d2d77bb30ebc73"
S = "${WORKDIR}/git"
