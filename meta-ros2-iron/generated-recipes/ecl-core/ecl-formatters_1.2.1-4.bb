...
# matches with: https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_formatters/1.2.1-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/ecl_formatters"
SRC_URI = "git://github.com/ros2-gbp/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "649cb67e49421d97ed7183ce495106d4e2e8cbd3"
S = "${WORKDIR}/git"
