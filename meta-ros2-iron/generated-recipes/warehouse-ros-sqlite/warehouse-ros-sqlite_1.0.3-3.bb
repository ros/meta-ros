...
# matches with: https://github.com/ros2-gbp/warehouse_ros_sqlite-release/archive/release/iron/warehouse_ros_sqlite/1.0.3-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/warehouse_ros_sqlite"
SRC_URI = "git://github.com/ros2-gbp/warehouse_ros_sqlite-release;${ROS_BRANCH};protocol=https"
SRCREV = "286dcc100406c5693ce15b9125b46a83d21cdf90"
S = "${WORKDIR}/git"
