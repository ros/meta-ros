...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/iron/ros_base/0.10.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_base"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "de3b3ce00084ad6eb0203cbfcdd07645aa0329a2"
S = "${WORKDIR}/git"
