...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/iron/desktop/0.10.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/desktop"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "a84f03f882b7f2b353aaf8b303bcb6390bf84048"
S = "${WORKDIR}/git"
