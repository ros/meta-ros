...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/iron/lanelet2_python/1.1.1-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/lanelet2_python"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a8749b333ad51109e8bd10dd07ec83a0acb6be29"
S = "${WORKDIR}/git"
