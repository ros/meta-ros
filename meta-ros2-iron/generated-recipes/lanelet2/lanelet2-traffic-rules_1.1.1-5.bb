...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/iron/lanelet2_traffic_rules/1.1.1-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/lanelet2_traffic_rules"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "159f83d59d83732804ab962e3c58589db2dc07b8"
S = "${WORKDIR}/git"
