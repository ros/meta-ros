...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/iron/lanelet2_io/1.1.1-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/lanelet2_io"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "7fc2e40eab69353445114094375cdce6a4b391ce"
S = "${WORKDIR}/git"
