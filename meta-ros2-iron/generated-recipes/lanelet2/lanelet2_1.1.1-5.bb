...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/iron/lanelet2/1.1.1-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/lanelet2"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "1801bdcdecb59da997319097f7e60dcce5ba7ca7"
S = "${WORKDIR}/git"
