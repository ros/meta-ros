...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/iron/lanelet2_maps/1.1.1-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/lanelet2_maps"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "93bd594ccebb4d9645bdbd729c6edee6cd530fdd"
S = "${WORKDIR}/git"
