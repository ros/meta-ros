...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/iron/lanelet2_projection/1.1.1-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/lanelet2_projection"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "67cafffb0b57ce831e7f124a32b1a8e37a719a04"
S = "${WORKDIR}/git"
