...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/iron/lanelet2_validation/1.1.1-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/lanelet2_validation"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "333acce31ba8d686d44aecbaa1a18b43010fcf83"
S = "${WORKDIR}/git"
