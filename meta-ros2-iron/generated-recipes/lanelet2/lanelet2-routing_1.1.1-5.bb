...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/iron/lanelet2_routing/1.1.1-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/lanelet2_routing"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "c6fcbf60835230a5572c0dc686f37421fa71bd42"
S = "${WORKDIR}/git"
