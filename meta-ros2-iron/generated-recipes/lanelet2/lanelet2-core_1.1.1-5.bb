...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/iron/lanelet2_core/1.1.1-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/lanelet2_core"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a0f85e219c4e9fc2fc217874371d92ec1fba0a56"
S = "${WORKDIR}/git"
