...
# matches with: https://github.com/ros2-gbp/rqt-release/archive/release/iron/rqt_py_common/1.3.4-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/rqt_py_common"
SRC_URI = "git://github.com/ros2-gbp/rqt-release;${ROS_BRANCH};protocol=https"
SRCREV = "c962939be2da761314ad3a5ac49752dad819f592"
S = "${WORKDIR}/git"
