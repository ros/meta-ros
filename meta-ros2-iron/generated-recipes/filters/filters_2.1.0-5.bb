...
# matches with: https://github.com/ros2-gbp/filters-release/archive/release/iron/filters/2.1.0-5.tar.gz
ROS_BRANCH ?= "branch=release/iron/filters"
SRC_URI = "git://github.com/ros2-gbp/filters-release;${ROS_BRANCH};protocol=https"
SRCREV = "8e29659900f45b92cb13238d11a0a639bfddaf79"
S = "${WORKDIR}/git"
