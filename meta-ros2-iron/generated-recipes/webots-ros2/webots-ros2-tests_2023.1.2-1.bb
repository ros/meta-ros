...
# matches with: https://github.com/ros2-gbp/webots_ros2-release/archive/release/iron/webots_ros2_tests/2023.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/webots_ros2_tests"
SRC_URI = "git://github.com/ros2-gbp/webots_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "112c499730861ec59bfd231101a46d38406e1fc3"
S = "${WORKDIR}/git"
