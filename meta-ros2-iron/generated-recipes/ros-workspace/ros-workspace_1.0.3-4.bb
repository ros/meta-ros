...
# matches with: https://github.com/ros2-gbp/ros_workspace-release/archive/release/iron/ros_workspace/1.0.3-4.tar.gz
ROS_BRANCH ?= "branch=release/iron/ros_workspace"
SRC_URI = "git://github.com/ros2-gbp/ros_workspace-release;${ROS_BRANCH};protocol=https"
SRCREV = "064bfd7175373790ec372bcaa762141121c71e53"
S = "${WORKDIR}/git"
