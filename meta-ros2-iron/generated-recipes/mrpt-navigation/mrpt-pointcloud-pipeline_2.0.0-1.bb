...
# matches with: https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/iron/mrpt_pointcloud_pipeline/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mrpt_pointcloud_pipeline"
SRC_URI = "git://github.com/ros2-gbp/mrpt_navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "2637d98afe715c2769974ddbb2c7dd06760a5aff"
S = "${WORKDIR}/git"
