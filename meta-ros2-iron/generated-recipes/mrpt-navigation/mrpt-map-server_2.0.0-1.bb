...
# matches with: https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/iron/mrpt_map_server/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mrpt_map_server"
SRC_URI = "git://github.com/ros2-gbp/mrpt_navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "191e0a5f8e5b319ddcecfe8944b68db6e4a097c5"
S = "${WORKDIR}/git"
