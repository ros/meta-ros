...
# matches with: https://github.com/ros2-gbp/transport_drivers-release/archive/release/iron/asio_cmake_module/1.2.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/asio_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/transport_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "de0f4d9c2410f941807e3e5ef636b91a28449655"
S = "${WORKDIR}/git"
