...
# matches with: https://github.com/ros2-gbp/transport_drivers-release/archive/release/iron/serial_driver/1.2.0-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/serial_driver"
SRC_URI = "git://github.com/ros2-gbp/transport_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "5b2aceec502435939dfb9392cb8d2a0a4619fffc"
S = "${WORKDIR}/git"
