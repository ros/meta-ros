...
# matches with: https://github.com/ros2-gbp/ffmpeg_image_transport-release/archive/release/iron/ffmpeg_image_transport/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ffmpeg_image_transport"
SRC_URI = "git://github.com/ros2-gbp/ffmpeg_image_transport-release;${ROS_BRANCH};protocol=https"
SRCREV = "db4ebbcb86280b99d28531e8ff27005754892e73"
S = "${WORKDIR}/git"
