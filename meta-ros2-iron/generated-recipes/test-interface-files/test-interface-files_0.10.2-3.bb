...
# matches with: https://github.com/ros2-gbp/test_interface_files-release/archive/release/iron/test_interface_files/0.10.2-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/test_interface_files"
SRC_URI = "git://github.com/ros2-gbp/test_interface_files-release;${ROS_BRANCH};protocol=https"
SRCREV = "1f2792150508b7ca7466a5d52259745576433125"
S = "${WORKDIR}/git"
