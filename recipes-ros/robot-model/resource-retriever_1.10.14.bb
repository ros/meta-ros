...
The resourse retriever was initially designed to load mesh files into memory, \
but it can be used for any type of data. The resource retriever is based on \
the the libcurl library."
SECTION = "devel"
LICENSE = "BSD"
