...
# ERROR: jderobot-color-tuner-0.0.3-6-r0 do_package_qa: QA Issue: /opt/ros/melodic/bin/colorTuner contained in package jderobot-color-tuner requires /bin/bash, but no providers found in RDEPENDS:jderobot-color-tuner? [file-rdeps]
ROS_EXEC_DEPENDS += " \
    bash \
"
