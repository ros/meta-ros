...
# ERROR: jackal-description-0.6.4-1-r0 do_package_qa: QA Issue: /usr/opt/ros/melodic/lib/jackal_description/env_run contained in package jackal-description requires /bin/bash, but no providers found in RDEPENDS_jackal-description? [file-rdeps]
RDEPENDS_${PN} += "bash"
