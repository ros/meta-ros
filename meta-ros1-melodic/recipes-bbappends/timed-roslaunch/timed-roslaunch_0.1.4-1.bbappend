...
# ERROR: timed-roslaunch-0.1.4-1-r0 do_package_qa: QA Issue: /opt/ros/melodic/lib/timed_roslaunch/timed_roslaunch.sh contained in package timed-roslaunch requires /bin/bash, but no providers found in RDEPENDS:timed-roslaunch? [file-rdeps]
RDEPENDS:${PN} += "bash"
