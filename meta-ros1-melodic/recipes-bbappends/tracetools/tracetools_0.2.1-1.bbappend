...
# ERROR: tracetools-0.2.1-1-r0 do_package_qa: QA Issue: /opt/ros/melodic/lib/tracetools/setup-lttng-roscpp.sh contained in package tracetools requires /bin/bash, but no providers found in RDEPENDS_tracetools? [file-rdeps]
RDEPENDS_${PN} += "bash"
