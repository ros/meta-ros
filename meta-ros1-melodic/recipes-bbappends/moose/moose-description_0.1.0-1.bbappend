...
# ERROR: moose-description-0.1.0-1-r0 do_package_qa: QA Issue: /opt/ros/melodic/lib/moose_description/env_run contained in package moose-description requires /bin/bash, but no providers found in RDEPENDS:moose-description? [file-rdeps]
RDEPENDS:${PN} += "bash"
