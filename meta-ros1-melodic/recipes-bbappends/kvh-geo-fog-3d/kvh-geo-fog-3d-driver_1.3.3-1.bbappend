...
# ERROR: kvh-geo-fog-3d-driver-1.3.3-1-r0 do_package_qa: QA Issue: /opt/ros/melodic/share/kvh_geo_fog_3d_driver/run_tests.sh contained in package kvh-geo-fog-3d-driver requires /bin/bash, but no providers found in RDEPENDS:kvh-geo-fog-3d-driver? [file-rdeps]
RDEPENDS:${PN} += "bash"
