...
# ERROR: warthog-description-0.1.1-2-r0 do_package_qa: QA Issue: /usr/opt/ros/melodic/lib/warthog_description/env_run contained in package warthog-description requires /bin/bash, but no providers found in RDEPENDS:warthog-description? [file-rdeps]
RDEPENDS:${PN} += "bash"
