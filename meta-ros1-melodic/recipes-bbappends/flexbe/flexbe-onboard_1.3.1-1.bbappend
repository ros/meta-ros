...
# ERROR: flexbe-onboard-1.3.0-1-r0 do_package_qa: QA Issue: /opt/ros/melodic/lib/flexbe_onboard/start_behavior contained in package flexbe-onboard requires /bin/bash, but no providers found in RDEPENDS_flexbe-onboard? [file-rdeps]
RDEPENDS_${PN} += "bash"
