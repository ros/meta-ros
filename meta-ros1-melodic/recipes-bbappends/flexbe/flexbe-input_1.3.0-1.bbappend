...
# ERROR: flexbe-input-1.3.0-1-r0 do_package_qa: QA Issue: /opt/ros/melodic/lib/flexbe_input/behavior_input contained in package flexbe-input requires /bin/bash, but no providers found in RDEPENDS_flexbe-input? [file-rdeps]
RDEPENDS_${PN} += "bash"
