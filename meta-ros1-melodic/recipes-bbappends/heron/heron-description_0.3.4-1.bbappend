...
# ERROR: heron-description-0.3.3-1-r0 do_package_qa: QA Issue: /opt/ros/melodic/lib/heron_description/env_run contained in package heron-description requires /bin/bash, but no providers found in RDEPENDS_heron-description? [file-rdeps]
RDEPENDS_${PN} += "bash"
