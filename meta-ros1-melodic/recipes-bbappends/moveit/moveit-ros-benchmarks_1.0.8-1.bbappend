...
# ERROR: moveit-ros-benchmarks-1.0.2-1-r0 do_package_qa: QA Issue: /opt/ros/melodic/lib/moveit_ros_benchmarks/moveit_run_benchmark contained in package moveit-ros-benchmarks requires libmoveit_ros_benchmarks.so.1.0.2()(64bit), but no providers found in RDEPENDS:moveit-ros-benchmarks? [file-rdeps]
