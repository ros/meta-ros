...
# ERROR: moveit-ros-move-group-1.0.2-1-r0 do_package_qa: QA Issue: /opt/ros/melodic/lib/moveit_ros_move_group/move_group contained in package moveit-ros-move-group requires libmoveit_move_group_capabilities_base.so.1.0.2()(64bit), but no providers found in RDEPENDS:moveit-ros-move-group? [file-rdeps]
