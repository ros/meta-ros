...
ROS_TEST_DEPENDS = " \
    ...
    ${ROS_UNRESOLVED_DEP-python-docopt} \
    code-coverage \
...
# matches with: https://github.com/PilzDE/pilz_industrial_motion-release/archive/release/melodic/pilz_robot_programming/0.4.14-1.tar.gz
...
SRCREV = "01bb47ac1a3dfd1b67f53757255b2634c2e94aa3"
S = "${WORKDIR}/git"
