...
# matches with: https://github.com/mavlink/mavros-release/archive/release/melodic/mavros_extras/1.6.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/mavros_extras"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "397a3e55bacf8f1e0525da1be02a04ee6c114c19"
S = "${WORKDIR}/git"
