...
# matches with: https://github.com/mavlink/mavros-release/archive/release/melodic/libmavconn/0.32.2-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/libmavconn"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "95158e893a05f8f09610072fe38f87e8085c408c"
S = "${WORKDIR}/git"
