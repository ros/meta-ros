...
# matches with: https://github.com/mavlink/mavros-release/archive/release/melodic/mavros_msgs/0.33.3-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/mavros_msgs"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "6e8beacbad4e2cf2224a8d8dcc321b1317c09f2d"
S = "${WORKDIR}/git"
