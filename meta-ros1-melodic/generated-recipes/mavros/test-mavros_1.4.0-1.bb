...
# matches with: https://github.com/mavlink/mavros-release/archive/release/melodic/test_mavros/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/test_mavros"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "0e69670bdb8e7d3b8f3cd80c79827d84ad55d981"
S = "${WORKDIR}/git"
