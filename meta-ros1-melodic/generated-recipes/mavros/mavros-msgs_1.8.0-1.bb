...
# matches with: https://github.com/mavlink/mavros-release/archive/release/melodic/mavros_msgs/1.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/mavros_msgs"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "4c1e411c2783201787cb6ee211a46c7620cd5e3a"
S = "${WORKDIR}/git"
