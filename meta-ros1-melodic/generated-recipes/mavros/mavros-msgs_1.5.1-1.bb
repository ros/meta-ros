...
# matches with: https://github.com/mavlink/mavros-release/archive/release/melodic/mavros_msgs/1.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/mavros_msgs"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "9140462d911bd46ade6dca237ff5b8db1884e86a"
S = "${WORKDIR}/git"
