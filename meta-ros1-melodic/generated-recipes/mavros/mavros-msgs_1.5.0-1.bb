...
# matches with: https://github.com/mavlink/mavros-release/archive/release/melodic/mavros_msgs/1.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/mavros_msgs"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "b51217a7fb0a2849dc3f23fa5b31216684c042f8"
S = "${WORKDIR}/git"
