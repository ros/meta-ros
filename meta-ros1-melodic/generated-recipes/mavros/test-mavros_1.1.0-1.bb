...
# matches with: https://github.com/mavlink/mavros-release/archive/release/melodic/test_mavros/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/test_mavros"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "49d049862dea5440f268f53467f9417f6b7036b7"
S = "${WORKDIR}/git"
