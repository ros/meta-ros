...
# matches with: https://github.com/mavlink/mavros-release/archive/release/melodic/mavros_extras/1.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/mavros_extras"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "02624ce62025bc8c86b79791d61238f0817a33d6"
S = "${WORKDIR}/git"
