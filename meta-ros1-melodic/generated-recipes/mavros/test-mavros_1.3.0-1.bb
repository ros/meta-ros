...
# matches with: https://github.com/mavlink/mavros-release/archive/release/melodic/test_mavros/1.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/test_mavros"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "116064e03ed064ab2ad354dd86ceb3973574078d"
S = "${WORKDIR}/git"
