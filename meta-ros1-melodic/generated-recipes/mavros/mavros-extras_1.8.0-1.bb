...
# matches with: https://github.com/mavlink/mavros-release/archive/release/melodic/mavros_extras/1.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/mavros_extras"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "f2d40c5566a9c52be198a32eb37d5901a2af5f25"
S = "${WORKDIR}/git"
