...
# matches with: https://github.com/SICKAG/sick_scan-release/archive/release/melodic/sick_scan/1.10.1-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/sick_scan"
SRC_URI = "git://github.com/SICKAG/sick_scan-release;${ROS_BRANCH};protocol=https"
SRCREV = "2b84874a5f111fbda4de8d068f5e01e90810272f"
S = "${WORKDIR}/git"
