...
ROS_EXEC_DEPENDS = " \
    ${ROS_UNRESOLVED_DEP-rviz-mesh-plugin} \
    hdf5-map-io \
    label-manager \
    mesh-msgs \
...
# matches with: https://github.com/uos-gbp/mesh-tools/archive/release/melodic/mesh_tools/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/mesh_tools"
SRC_URI = "git://github.com/uos-gbp/mesh-tools;${ROS_BRANCH};protocol=https"
SRCREV = "482db566e7b4272590bd2158baa288e970cdd5df"
S = "${WORKDIR}/git"
