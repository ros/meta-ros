...
# matches with: https://github.com/uos-gbp/mesh-tools/archive/release/melodic/rviz_mesh_plugin/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rviz_mesh_plugin"
SRC_URI = "git://github.com/uos-gbp/mesh-tools;${ROS_BRANCH};protocol=https"
SRCREV = "822e0e8919aaab2cd78db8c53ad27ed5bcbeea2e"
S = "${WORKDIR}/git"
