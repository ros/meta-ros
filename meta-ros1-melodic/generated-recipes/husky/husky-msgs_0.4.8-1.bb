...
# matches with: https://github.com/clearpath-gbp/husky-release/archive/release/melodic/husky_msgs/0.4.8-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/husky_msgs"
SRC_URI = "git://github.com/clearpath-gbp/husky-release;${ROS_BRANCH};protocol=https"
SRCREV = "62e9e3fe5e132731f77c7e35fdbbf48aca78f7ab"
S = "${WORKDIR}/git"
