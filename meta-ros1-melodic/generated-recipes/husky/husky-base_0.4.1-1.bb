...
# matches with: https://github.com/clearpath-gbp/husky-release/archive/release/melodic/husky_base/0.4.1-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/husky_base"
SRC_URI = "git://github.com/clearpath-gbp/husky-release;${ROS_BRANCH};protocol=https"
SRCREV = "9db39e1e6739a82a70ddfcdf96729a1df4da7318"
S = "${WORKDIR}/git"
