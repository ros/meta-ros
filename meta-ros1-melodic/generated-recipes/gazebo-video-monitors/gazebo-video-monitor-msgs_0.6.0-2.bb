...
# matches with: https://github.com/nlamprian/gazebo_video_monitors-release/archive/release/melodic/gazebo_video_monitor_msgs/0.6.0-2.tar.gz
ROS_BRANCH ?= "branch=release/melodic/gazebo_video_monitor_msgs"
SRC_URI = "git://github.com/nlamprian/gazebo_video_monitors-release;${ROS_BRANCH};protocol=https"
SRCREV = "941ffb688f30cb844e976976236bad7d20ebd73e"
S = "${WORKDIR}/git"
