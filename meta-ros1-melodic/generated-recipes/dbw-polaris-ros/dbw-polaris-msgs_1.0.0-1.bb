...
# matches with: https://github.com/DataspeedInc-release/dbw_polaris_ros-release/archive/release/melodic/dbw_polaris_msgs/1.0.0-1.tar.gz
...
SRCREV = "803c61db94921f5ef45fe127ddca879a9ffefdef"
S = "${WORKDIR}/git"
