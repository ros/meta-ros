...
# matches with: https://github.com/ros-gbp/vrx-release/archive/release/melodic/usv_gazebo_plugins/1.2.5-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/usv_gazebo_plugins"
SRC_URI = "git://github.com/ros-gbp/vrx-release;${ROS_BRANCH};protocol=https"
SRCREV = "ae9880ea8f4f8afa833f10d0a6d4c1a44bbbae0f"
S = "${WORKDIR}/git"
