...
# matches with: https://github.com/ros-gbp/vrx-release/archive/release/melodic/usv_gazebo_plugins/1.2.6-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/usv_gazebo_plugins"
SRC_URI = "git://github.com/ros-gbp/vrx-release;${ROS_BRANCH};protocol=https"
SRCREV = "2b95dfbf9bbe5ea1cc314498e9e289531b0aade9"
S = "${WORKDIR}/git"
