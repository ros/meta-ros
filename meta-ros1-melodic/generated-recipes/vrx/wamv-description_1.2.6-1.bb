...
# matches with: https://github.com/ros-gbp/vrx-release/archive/release/melodic/wamv_description/1.2.6-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/wamv_description"
SRC_URI = "git://github.com/ros-gbp/vrx-release;${ROS_BRANCH};protocol=https"
SRCREV = "e3b4fc00090f64df91fa0d6be2fcbd62481baee0"
S = "${WORKDIR}/git"
