...
# matches with: https://github.com/ros-gbp/rqt_robot_monitor-release/archive/release/melodic/rqt_robot_monitor/0.5.13-1.tar.gz
...
SRCREV = "02868ad0555b20173223009bed8e6d2bea48aa86"
S = "${WORKDIR}/git"
