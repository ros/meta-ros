...
# matches with: https://github.com/ros-gbp/moveit-release/archive/release/melodic/moveit_servo/1.0.8-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/moveit_servo"
SRC_URI = "git://github.com/ros-gbp/moveit-release;${ROS_BRANCH};protocol=https"
SRCREV = "b4c7d7b8f8b24eebb04fdfb72d4238b68283fa5e"
S = "${WORKDIR}/git"
