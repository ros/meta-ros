...
# matches with: https://github.com/tork-a/jsk_common-release/archive/release/melodic/jsk_tools/2.2.11-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/jsk_tools"
SRC_URI = "git://github.com/tork-a/jsk_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "cdf899087d80cd727b593c94c17e34bd429db978"
S = "${WORKDIR}/git"
