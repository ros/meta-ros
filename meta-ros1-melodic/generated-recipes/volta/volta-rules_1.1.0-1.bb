...
# matches with: https://github.com/botsync-gbp/volta-release/archive/release/melodic/volta_rules/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/volta_rules"
SRC_URI = "git://github.com/botsync-gbp/volta-release;${ROS_BRANCH};protocol=https"
SRCREV = "1fd752f3fbf7819aeab8d33cfcb4130cc27272a8"
S = "${WORKDIR}/git"
