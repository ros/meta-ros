...
# matches with: https://github.com/uos-gbp/uos-tools/archive/release/melodic/uos_diffdrive_teleop/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/uos_diffdrive_teleop"
SRC_URI = "git://github.com/uos-gbp/uos-tools;${ROS_BRANCH};protocol=https"
SRCREV = "840fca22ee158a7694d33a5d0b701d8b65677e4c"
S = "${WORKDIR}/git"
