...
# matches with: https://github.com/PilzDE/psen_scan-release/archive/release/melodic/psen_scan/1.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/psen_scan"
SRC_URI = "git://github.com/PilzDE/psen_scan-release;${ROS_BRANCH};protocol=https"
SRCREV = "b731db9aa2ae3cbe52267e85c57ec897a243235a"
S = "${WORKDIR}/git"
