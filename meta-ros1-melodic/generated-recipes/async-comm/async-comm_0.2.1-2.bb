...
# matches with: https://github.com/dpkoch/async_comm-release/archive/release/melodic/async_comm/0.2.1-2.tar.gz
ROS_BRANCH ?= "branch=release/melodic/async_comm"
SRC_URI = "git://github.com/dpkoch/async_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "2fe2dd987bc224d53fe04b1aa30daab90c094d8b"
S = "${WORKDIR}/git"
