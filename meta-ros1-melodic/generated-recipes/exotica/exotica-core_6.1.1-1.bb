...
# matches with: https://github.com/ipab-slmc/exotica-release/archive/release/melodic/exotica_core/6.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/exotica_core"
SRC_URI = "git://github.com/ipab-slmc/exotica-release;${ROS_BRANCH};protocol=https"
SRCREV = "fb3eca670e7f75fa16859837eef53bd57e170b90"
S = "${WORKDIR}/git"
