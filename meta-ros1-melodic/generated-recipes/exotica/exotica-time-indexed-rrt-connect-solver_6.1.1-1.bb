...
# matches with: https://github.com/ipab-slmc/exotica-release/archive/release/melodic/exotica_time_indexed_rrt_connect_solver/6.1.1-1.tar.gz
...
SRCREV = "e1c8a8d7d3fc4308e5b0b0b60c3a2ed84528f69b"
S = "${WORKDIR}/git"
