...
# matches with: https://github.com/ipab-slmc/exotica-release/archive/release/melodic/exotica_core/6.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/exotica_core"
SRC_URI = "git://github.com/ipab-slmc/exotica-release;${ROS_BRANCH};protocol=https"
SRCREV = "2701dc1ea35ab536962794ed5b2479dab8fb6fbc"
S = "${WORKDIR}/git"
