...
# matches with: https://github.com/PilzDE/psen_scan_v2-release/archive/release/melodic/psen_scan_v2/0.3.1-1.tar.gz
...
SRCREV = "753676e2db6f510109210e109a301fa0b8b61d4b"
S = "${WORKDIR}/git"
