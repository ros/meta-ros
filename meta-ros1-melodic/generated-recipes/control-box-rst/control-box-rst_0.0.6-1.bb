...
# matches with: https://github.com/rst-tu-dortmund/control_box_rst-release/archive/release/melodic/control_box_rst/0.0.6-1.tar.gz
...
SRCREV = "d40ba7daa0ccf881ea48982a5a92de8a1fa4da93"
S = "${WORKDIR}/git"
