...
# matches with: https://github.com/ros-gbp/scan_tools-release/archive/release/melodic/laser_ortho_projector/0.3.3-2.tar.gz
ROS_BRANCH ?= "branch=release/melodic/laser_ortho_projector"
SRC_URI = "git://github.com/ros-gbp/scan_tools-release;${ROS_BRANCH};protocol=https"
SRCREV = "f0fe38f9f3282b8f6ec5ae00882a77b6d6b1b825"
S = "${WORKDIR}/git"
