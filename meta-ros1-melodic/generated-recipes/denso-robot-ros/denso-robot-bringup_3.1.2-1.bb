...
# matches with: https://github.com/DENSORobot/denso_robot_ros-release/archive/release/melodic/denso_robot_bringup/3.1.2-1.tar.gz
...
SRCREV = "dabac9e7be91cdab28ed3a3ca43ac3880358162f"
S = "${WORKDIR}/git"
