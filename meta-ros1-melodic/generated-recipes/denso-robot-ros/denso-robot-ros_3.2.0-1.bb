...
# matches with: https://github.com/DENSORobot/denso_robot_ros-release/archive/release/melodic/denso_robot_ros/3.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/denso_robot_ros"
SRC_URI = "git://github.com/DENSORobot/denso_robot_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "192634fb6e0bd3c967996cadd8a0ff1e67eac561"
S = "${WORKDIR}/git"
