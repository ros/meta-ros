...
# matches with: https://github.com/DENSORobot/denso_robot_ros-release/archive/release/melodic/denso_robot_descriptions/3.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/denso_robot_descriptions"
SRC_URI = "git://github.com/DENSORobot/denso_robot_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "3481aa64d854c56db1f7f3f4ed310b2cf15bd997"
S = "${WORKDIR}/git"
