...
# matches with: https://github.com/clearpath-gbp/dingo-release/archive/release/melodic/dingo_msgs/0.1.6-2.tar.gz
ROS_BRANCH ?= "branch=release/melodic/dingo_msgs"
SRC_URI = "git://github.com/clearpath-gbp/dingo-release;${ROS_BRANCH};protocol=https"
SRCREV = "30fe601607ff6ee1c3b4cdc91f46c19b414ca526"
S = "${WORKDIR}/git"
