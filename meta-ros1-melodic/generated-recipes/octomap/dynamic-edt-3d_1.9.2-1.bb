...
# matches with: https://github.com/ros-gbp/octomap-release/archive/release/melodic/dynamic_edt_3d/1.9.2-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/dynamic_edt_3d"
SRC_URI = "git://github.com/ros-gbp/octomap-release;${ROS_BRANCH};protocol=https"
SRCREV = "2e3eac8cb23f9b436bff2a30ecadeb442d9cfb22"
S = "${WORKDIR}/git"
