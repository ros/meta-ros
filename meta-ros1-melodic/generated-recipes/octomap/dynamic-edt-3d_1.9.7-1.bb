...
# matches with: https://github.com/ros-gbp/octomap-release/archive/release/melodic/dynamic_edt_3d/1.9.7-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/dynamic_edt_3d"
SRC_URI = "git://github.com/ros-gbp/octomap-release;${ROS_BRANCH};protocol=https"
SRCREV = "d722ee243def7449662ac08d0e2028c055d0b1f0"
S = "${WORKDIR}/git"
