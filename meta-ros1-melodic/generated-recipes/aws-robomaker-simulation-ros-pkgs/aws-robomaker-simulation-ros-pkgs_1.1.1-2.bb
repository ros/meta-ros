...
# matches with: https://github.com/aws-gbp/aws_robomaker_simulation_ros_pkgs-release/archive/release/melodic/aws_robomaker_simulation_ros_pkgs/1.1.1-2.tar.gz
ROS_BRANCH ?= "branch=release/melodic/aws_robomaker_simulation_ros_pkgs"
SRC_URI = "git://github.com/aws-gbp/aws_robomaker_simulation_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "a7dc74cf15377b47989ff346a9dd008226756585"
S = "${WORKDIR}/git"
