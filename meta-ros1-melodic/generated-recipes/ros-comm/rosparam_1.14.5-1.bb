...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/rosparam/1.14.5-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rosparam"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "0394f98c13dd064849bec17212a8de0c85f87bd2"
S = "${WORKDIR}/git"
