...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/topic_tools/1.14.11-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/topic_tools"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "d11b97a0dd35a25d8567f389543509a680ddecc1"
S = "${WORKDIR}/git"
