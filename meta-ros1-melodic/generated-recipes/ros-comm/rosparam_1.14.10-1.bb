...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/rosparam/1.14.10-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rosparam"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "e5586be5e2850e6ecbdf7b40f35dccf779a86130"
S = "${WORKDIR}/git"
