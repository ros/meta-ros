...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/rosservice/1.14.5-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rosservice"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "28d71b8b82ea5b9ac4a9ba14d5402c9841c798b6"
S = "${WORKDIR}/git"
