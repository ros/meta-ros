...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/rostest/1.14.10-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rostest"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "8b6cf520b08f955bbc28a88d79f9d9a48ae0cc59"
S = "${WORKDIR}/git"
