...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/rosgraph/1.14.7-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rosgraph"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "821382128333168f65bb53179d0553e410aa3a90"
S = "${WORKDIR}/git"
