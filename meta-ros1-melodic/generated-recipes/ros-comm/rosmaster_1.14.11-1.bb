...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/rosmaster/1.14.11-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rosmaster"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "dc3ecd65ef8c34cdbca18197f842e2a84b7b4ffb"
S = "${WORKDIR}/git"
