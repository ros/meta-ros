...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/ros_comm/1.14.7-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/ros_comm"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "2e1554591927add91635d3b07abd128eac30c2cd"
S = "${WORKDIR}/git"
