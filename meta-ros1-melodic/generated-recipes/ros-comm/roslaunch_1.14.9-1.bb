...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/roslaunch/1.14.9-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/roslaunch"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "470eccd03f2900450294e22f014cb879083d075f"
S = "${WORKDIR}/git"
