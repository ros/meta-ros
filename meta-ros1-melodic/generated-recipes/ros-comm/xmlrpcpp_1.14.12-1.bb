...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/xmlrpcpp/1.14.12-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/xmlrpcpp"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "976521319b8db92fd75c5298070fe9af90b4b406"
S = "${WORKDIR}/git"
