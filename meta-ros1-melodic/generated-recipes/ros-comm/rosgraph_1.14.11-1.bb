...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/rosgraph/1.14.11-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rosgraph"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "7e5fd076b9533fe5f3add52d9b56abbb5607b49f"
S = "${WORKDIR}/git"
