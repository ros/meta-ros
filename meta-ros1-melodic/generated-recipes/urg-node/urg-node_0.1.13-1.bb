...
# matches with: https://github.com/ros-gbp/urg_node-release/archive/release/melodic/urg_node/0.1.13-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/urg_node"
SRC_URI = "git://github.com/ros-gbp/urg_node-release;${ROS_BRANCH};protocol=https"
SRCREV = "f2d26cd4b41e42456fae8668a78d7c6f05a3b3ba"
S = "${WORKDIR}/git"
