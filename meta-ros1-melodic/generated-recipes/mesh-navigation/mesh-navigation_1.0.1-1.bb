...
# matches with: https://github.com/uos-gbp/mesh_navigation-release/archive/release/melodic/mesh_navigation/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/mesh_navigation"
SRC_URI = "git://github.com/uos-gbp/mesh_navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "03f03e97a05ad4be9855eacd526b99019fb16bfa"
S = "${WORKDIR}/git"
