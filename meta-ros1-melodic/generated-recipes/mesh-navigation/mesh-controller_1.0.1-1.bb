...
# matches with: https://github.com/uos-gbp/mesh_navigation-release/archive/release/melodic/mesh_controller/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/mesh_controller"
SRC_URI = "git://github.com/uos-gbp/mesh_navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "d5af3c96e0f80f0eca7ced1f77e958d5f3229fc8"
S = "${WORKDIR}/git"
