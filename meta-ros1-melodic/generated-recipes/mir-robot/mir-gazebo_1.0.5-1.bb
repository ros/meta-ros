...
# matches with: https://github.com/uos-gbp/mir_robot-release/archive/release/melodic/mir_gazebo/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/mir_gazebo"
SRC_URI = "git://github.com/uos-gbp/mir_robot-release;${ROS_BRANCH};protocol=https"
SRCREV = "19db664b1b5e2b09ec4946f10e0f2e773248545e"
S = "${WORKDIR}/git"
