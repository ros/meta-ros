...
# matches with: https://github.com/ros-gbp/qt_gui_core-release/archive/release/melodic/qt_gui_cpp/0.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/qt_gui_cpp"
SRC_URI = "git://github.com/ros-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "57ee15a7dcf0d26f3e842a68b27efd2827b75893"
S = "${WORKDIR}/git"
