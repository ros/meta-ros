...
# matches with: https://github.com/ros-gbp/qt_gui_core-release/archive/release/melodic/qt_gui/0.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/qt_gui"
SRC_URI = "git://github.com/ros-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "01f6d54b9e89db7bdcd9e331d0c625b3dd7b7cea"
S = "${WORKDIR}/git"
