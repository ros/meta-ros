...
# matches with: https://github.com/DataspeedInc-release/dbw_fca_ros-release/archive/release/melodic/dbw_fca_description/1.2.1-1.tar.gz
...
SRCREV = "0e5db3e036ace0adcd8621399de2571dbe1afa7a"
S = "${WORKDIR}/git"
