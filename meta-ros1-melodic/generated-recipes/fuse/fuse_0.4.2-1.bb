...
# matches with: https://github.com/locusrobotics/fuse-release/archive/release/melodic/fuse/0.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/fuse"
SRC_URI = "git://github.com/locusrobotics/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "a936abda3e228aeab30a5db4c9dbbdf81ef7780b"
S = "${WORKDIR}/git"
