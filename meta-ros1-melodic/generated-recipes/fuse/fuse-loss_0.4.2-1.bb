...
# matches with: https://github.com/locusrobotics/fuse-release/archive/release/melodic/fuse_loss/0.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/fuse_loss"
SRC_URI = "git://github.com/locusrobotics/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "bde54cac62144bc73c3f7a8a1cb22f548f601ea0"
S = "${WORKDIR}/git"
