...
# matches with: https://github.com/DLu/robot_navigation-release/archive/release/melodic/nav_grid/0.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/nav_grid"
SRC_URI = "git://github.com/DLu/robot_navigation-release;${ROS_BRANCH};protocol=https"
SRCREV = "6562bc026534fbd42a64ac79ed45785352f94326"
S = "${WORKDIR}/git"
