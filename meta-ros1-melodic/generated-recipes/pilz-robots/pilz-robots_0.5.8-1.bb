...
# matches with: https://github.com/PilzDE/pilz_robots-release/archive/release/melodic/pilz_robots/0.5.8-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/pilz_robots"
SRC_URI = "git://github.com/PilzDE/pilz_robots-release;${ROS_BRANCH};protocol=https"
SRCREV = "a7716607cd4855097366b11b3a7e4111fb8851df"
S = "${WORKDIR}/git"
