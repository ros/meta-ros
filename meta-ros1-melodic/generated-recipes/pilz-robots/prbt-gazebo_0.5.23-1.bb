...
# matches with: https://github.com/PilzDE/pilz_robots-release/archive/release/melodic/prbt_gazebo/0.5.23-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/prbt_gazebo"
SRC_URI = "git://github.com/PilzDE/pilz_robots-release;${ROS_BRANCH};protocol=https"
SRCREV = "b892832cdb1448246fac6b4efb6b718867c9e80c"
S = "${WORKDIR}/git"
