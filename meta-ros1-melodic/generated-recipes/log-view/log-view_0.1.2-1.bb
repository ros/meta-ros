...
# matches with: https://github.com/hatchbed/log_view-release/archive/release/melodic/log_view/0.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/log_view"
SRC_URI = "git://github.com/hatchbed/log_view-release;${ROS_BRANCH};protocol=https"
SRCREV = "f6f6d6b266f8ee08f8256386710d9a31748ab98d"
S = "${WORKDIR}/git"
