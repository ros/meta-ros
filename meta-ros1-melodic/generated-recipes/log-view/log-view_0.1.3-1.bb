...
# matches with: https://github.com/hatchbed/log_view-release/archive/release/melodic/log_view/0.1.3-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/log_view"
SRC_URI = "git://github.com/hatchbed/log_view-release;${ROS_BRANCH};protocol=https"
SRCREV = "6142448e4e51e9b32746ca4e40c188b7dd354401"
S = "${WORKDIR}/git"
