...
# matches with: https://github.com/iralabdisco/ira_laser_tools-release/archive/release/melodic/ira_laser_tools/1.0.6-1.tar.gz
...
SRCREV = "a648737c9e1045745f3ddd8ce3739bd737813a3f"
S = "${WORKDIR}/git"
