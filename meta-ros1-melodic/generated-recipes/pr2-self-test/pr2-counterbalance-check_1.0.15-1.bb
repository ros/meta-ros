...
# matches with: https://github.com/pr2-gbp/pr2_self_test-release/archive/release/melodic/pr2_counterbalance_check/1.0.15-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/pr2_counterbalance_check"
SRC_URI = "git://github.com/pr2-gbp/pr2_self_test-release;${ROS_BRANCH};protocol=https"
SRCREV = "26b98689910cd800ea4cedc344989c630ef97a23"
S = "${WORKDIR}/git"
