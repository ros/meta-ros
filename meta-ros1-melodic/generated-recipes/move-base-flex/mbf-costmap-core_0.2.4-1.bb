...
# matches with: https://github.com/uos-gbp/move_base_flex-release/archive/release/melodic/mbf_costmap_core/0.2.4-1.tar.gz
...
SRCREV = "dd2bfefb961fe3cafa4465b5e0ae770bbd192e53"
S = "${WORKDIR}/git"
