...
# matches with: https://github.com/uos-gbp/move_base_flex-release/archive/release/melodic/mbf_abstract_nav/0.2.4-1.tar.gz
...
SRCREV = "e2ae588693bfbfe5e3e4563f62b0b5cb381965ca"
S = "${WORKDIR}/git"
