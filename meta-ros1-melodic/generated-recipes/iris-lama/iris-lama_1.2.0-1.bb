...
# matches with: https://github.com/eupedrosa/iris_lama-release/archive/release/melodic/iris_lama/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/iris_lama"
SRC_URI = "git://github.com/eupedrosa/iris_lama-release;${ROS_BRANCH};protocol=https"
SRCREV = "b850163094afee60bfaa6ecaa8d60706fde72a9d"
S = "${WORKDIR}/git"
