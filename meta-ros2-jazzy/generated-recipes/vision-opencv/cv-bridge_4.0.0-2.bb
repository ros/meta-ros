...
# matches with: https://github.com/ros2-gbp/vision_opencv-release/archive/release/jazzy/cv_bridge/4.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/cv_bridge"
SRC_URI = "git://github.com/ros2-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "6a2de436b09d786168fcbe43c9b1e41d575f4e10"
S = "${WORKDIR}/git"
