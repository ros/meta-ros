...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_navstate_fuse/1.0.2-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_navstate_fuse"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "1f9a9839828fd43b36aea76a6fca511317ca9ac1"
S = "${WORKDIR}/git"
