...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_navstate_fg/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_navstate_fg"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "706010b8f68c58da55e60bf7f4bc895b3acbf1be"
S = "${WORKDIR}/git"
