...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_bridge_ros2/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_bridge_ros2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "a797e6363575e7443dbc73a70934f373d0122f81"
S = "${WORKDIR}/git"
