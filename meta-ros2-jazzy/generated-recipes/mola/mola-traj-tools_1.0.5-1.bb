...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_traj_tools/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "5723660bcaaf11a99a38cd0bb06683211df0fcb1"
S = "${WORKDIR}/git"
