...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_navstate_fuse/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_navstate_fuse"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "9c56d7c2cc2e303ea2bd0eb975cde92bd5b99bf3"
S = "${WORKDIR}/git"
