...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_input_rawlog/1.0.2-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_input_rawlog"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "1b20f97dea249cb76f201adee113c1e0cb331c4c"
S = "${WORKDIR}/git"
