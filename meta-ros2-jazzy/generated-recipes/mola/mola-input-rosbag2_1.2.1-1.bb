...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_input_rosbag2/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_input_rosbag2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "b6382da09c76153611b8e2b1ec9e4585b15accac"
S = "${WORKDIR}/git"
