...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_traj_tools/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "561e00907795f5d9fecfb2f3b8a178196a80dfe4"
S = "${WORKDIR}/git"
