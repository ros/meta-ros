...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_traj_tools/1.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "6d5aed2c35ef83e4442f2eb48001a0ca0fbd1b16"
S = "${WORKDIR}/git"
