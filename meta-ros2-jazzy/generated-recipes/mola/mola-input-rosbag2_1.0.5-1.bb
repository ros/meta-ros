...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_input_rosbag2/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_input_rosbag2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "2db9278b5e89bab683db1912c4b356d257ea7b34"
S = "${WORKDIR}/git"
