...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_input_rosbag2/1.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_input_rosbag2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "40aee2d2e77ff4d9fda371d77ebd50aa57bdad92"
S = "${WORKDIR}/git"
