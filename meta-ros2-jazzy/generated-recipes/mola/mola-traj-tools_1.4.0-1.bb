...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_traj_tools/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_traj_tools"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "0ecbf3964423a736e6dcae3ed91621386fe42ef8"
S = "${WORKDIR}/git"
