...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_metric_maps/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_metric_maps"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "de9be921238033b1d4fe79f771568b1e5e9b21b8"
S = "${WORKDIR}/git"
