...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_bridge_ros2/1.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_bridge_ros2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "4c0ef3aedacca9a0ce5cfea8d65a799fbbf92507"
S = "${WORKDIR}/git"
