...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_input_rosbag2/2.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_input_rosbag2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "7b2e0b85949e86db8caa354187276ee51d230d8f"
S = "${WORKDIR}/git"
