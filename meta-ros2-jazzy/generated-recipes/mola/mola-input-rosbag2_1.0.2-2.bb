...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_input_rosbag2/1.0.2-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_input_rosbag2"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "0693be02cf76c7a7c9b7c2d856daec45a7d7334f"
S = "${WORKDIR}/git"
