...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_navstate_fg/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_navstate_fg"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "e243780f079cd9488fe7a90ff6ae27b9ed9a61ad"
S = "${WORKDIR}/git"
