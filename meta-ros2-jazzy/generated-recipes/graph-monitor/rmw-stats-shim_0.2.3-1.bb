...
# matches with: https://github.com/ros2-gbp/graph_monitor-release/archive/release/jazzy/rmw_stats_shim/0.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rmw_stats_shim"
SRC_URI = "git://github.com/ros2-gbp/graph_monitor-release;${ROS_BRANCH};protocol=https"
SRCREV = "eda011a2f8da7e928600f05ab47362eb7bfd35e1"
S = "${WORKDIR}/git"
