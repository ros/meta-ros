...
# matches with: https://github.com/ros2-gbp/rmf_building_map_msgs-release/archive/release/jazzy/rmf_building_map_msgs/1.4.0-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rmf_building_map_msgs"
