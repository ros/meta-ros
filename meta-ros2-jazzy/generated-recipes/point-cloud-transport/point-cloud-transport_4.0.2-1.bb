...
# matches with: https://github.com/ros2-gbp/point_cloud_transport-release/archive/release/jazzy/point_cloud_transport/4.0.2-1.tar.gz
...
SRCREV = "452aa97f48936798370822d1ac54ba8fd430050a"
S = "${WORKDIR}/git"
