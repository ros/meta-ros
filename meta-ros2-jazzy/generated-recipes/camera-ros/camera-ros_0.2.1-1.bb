...
# matches with: https://github.com/ros2-gbp/camera_ros-release/archive/release/jazzy/camera_ros/0.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/camera_ros"
SRC_URI = "git://github.com/ros2-gbp/camera_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "2d0d3a0d7929cd926f478acabe8d1d358fe7c048"
S = "${WORKDIR}/git"
