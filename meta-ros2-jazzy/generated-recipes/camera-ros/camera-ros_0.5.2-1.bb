...
# matches with: https://github.com/ros2-gbp/camera_ros-release/archive/release/jazzy/camera_ros/0.5.2-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/camera_ros"
SRC_URI = "git://github.com/ros2-gbp/camera_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "3c6aab8f8e64166d3597be6fabbe90b37c4005f5"
S = "${WORKDIR}/git"
