...
# matches with: https://github.com/ros2-gbp/camera_ros-release/archive/release/jazzy/camera_ros/0.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/camera_ros"
SRC_URI = "git://github.com/ros2-gbp/camera_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "cd5563d3966bd5a9733f6af7d654cf892f6b27cc"
S = "${WORKDIR}/git"
