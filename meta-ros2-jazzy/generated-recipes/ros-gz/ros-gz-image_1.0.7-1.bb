...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz_image/1.0.7-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ros_gz_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "ea6c5487c2ecc641877a2a95d7e834a81c8506a9"
S = "${WORKDIR}/git"
