...
# matches with: https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz_image/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ros_gz_image"
SRC_URI = "git://github.com/ros2-gbp/ros_ign-release;${ROS_BRANCH};protocol=https"
SRCREV = "9bfbc65098329e8517660bd7dcf02a4ac48a3a71"
S = "${WORKDIR}/git"
