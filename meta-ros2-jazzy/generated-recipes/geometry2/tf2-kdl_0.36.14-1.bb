...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_kdl/0.36.14-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_kdl"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "1c0d5a5142e4be6869fe0f3f74edf34fbf6ea48c"
S = "${WORKDIR}/git"
