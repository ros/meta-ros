...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_bullet/0.36.21-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_bullet"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e9508921e0cc685bfb97b62a0d59ffa0106112dd"
S = "${WORKDIR}/git"
