...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_tools/0.36.4-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "985d79ecc02978c993c3db46f636a34a43475721"
S = "${WORKDIR}/git"
