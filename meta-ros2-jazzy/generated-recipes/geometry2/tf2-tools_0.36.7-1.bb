...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_tools/0.36.7-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8079a211c3c03a33ff16aa68120ab0cd0581dbd1"
S = "${WORKDIR}/git"
