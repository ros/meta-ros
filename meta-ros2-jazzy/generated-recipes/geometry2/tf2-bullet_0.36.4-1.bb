...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_bullet/0.36.4-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_bullet"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "fa984b138aa51bfae7e066616cc08fd9291d9a50"
S = "${WORKDIR}/git"
