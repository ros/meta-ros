...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_eigen_kdl/0.36.7-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_eigen_kdl"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d9bd25b0c92d5a0305fb77589af1fbe8667e1baf"
S = "${WORKDIR}/git"
