...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_ros_py/0.36.11-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_ros_py"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8943140fb721af20d61924f53a62a11b1ee39627"
S = "${WORKDIR}/git"
