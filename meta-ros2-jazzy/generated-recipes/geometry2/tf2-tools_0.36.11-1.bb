...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_tools/0.36.11-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "59275652953b0c053547cefa3614560f15c713da"
S = "${WORKDIR}/git"
