...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_tools/0.36.19-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e7741f9dae12424bfab67b7e0dbc78311d06fbe8"
S = "${WORKDIR}/git"
