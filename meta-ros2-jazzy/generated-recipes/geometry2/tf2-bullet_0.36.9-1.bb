...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_bullet/0.36.9-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_bullet"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "225315eefb1aa82f54d7bdf3b09069c5039329ea"
S = "${WORKDIR}/git"
