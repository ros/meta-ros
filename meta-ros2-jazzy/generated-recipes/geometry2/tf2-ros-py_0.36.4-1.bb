...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_ros_py/0.36.4-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_ros_py"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "4d145d4799c00815612cd8636f4ca17f8222aeeb"
S = "${WORKDIR}/git"
