...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_kdl/0.36.16-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_kdl"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "1f3ae9668f1cbf7264f0e1377c1e40f6942d7a59"
S = "${WORKDIR}/git"
