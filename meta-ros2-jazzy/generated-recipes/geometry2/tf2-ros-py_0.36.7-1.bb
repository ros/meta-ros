...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_ros_py/0.36.7-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_ros_py"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e01c725bc1d70a55cf1d892449e3bedf95e9df02"
S = "${WORKDIR}/git"
