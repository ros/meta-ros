...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_eigen_kdl/0.36.2-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_eigen_kdl"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "374c4343ca1ad77a66e6d5cd5920efa64d9331c3"
S = "${WORKDIR}/git"
