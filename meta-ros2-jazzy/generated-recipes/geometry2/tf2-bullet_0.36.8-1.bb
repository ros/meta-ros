...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_bullet/0.36.8-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_bullet"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "9dc1ec892b9a0e167ac57f4d52c50fb0b4573c5e"
S = "${WORKDIR}/git"
