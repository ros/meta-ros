...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_eigen_kdl/0.36.8-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_eigen_kdl"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "4c04872e0db9ce9746763bc7a78c0e21b16f6015"
S = "${WORKDIR}/git"
