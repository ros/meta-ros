...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_eigen_kdl/0.36.20-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tf2_eigen_kdl"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "ce715a91ef54c308c02d27b53dc7e1bf2af388eb"
S = "${WORKDIR}/git"
