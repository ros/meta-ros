...
# matches with: https://github.com/robosoft-ai/SMACC2-release/archive/release/jazzy/cl_moveit2z/3.1.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/cl_moveit2z"
SRC_URI = "git://github.com/robosoft-ai/SMACC2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e0de307151ecf652a542a07107fe697a3eed18f1"
S = "${WORKDIR}/git"
