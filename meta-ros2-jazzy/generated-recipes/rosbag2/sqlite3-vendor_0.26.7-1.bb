...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/sqlite3_vendor/0.26.7-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/sqlite3_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "ba46d3af273ef7e5253b2279d7553f3b62e1f98f"
S = "${WORKDIR}/git"
