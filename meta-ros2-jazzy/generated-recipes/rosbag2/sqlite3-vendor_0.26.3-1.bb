...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/sqlite3_vendor/0.26.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/sqlite3_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "7fdb81c21db558bd8ddb128e567e18d0e2d30df3"
S = "${WORKDIR}/git"
