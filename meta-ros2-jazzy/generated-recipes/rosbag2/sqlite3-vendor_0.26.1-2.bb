...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/sqlite3_vendor/0.26.1-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/sqlite3_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "34a782aea4daf42ea5cf1ed2fed7b89ab767cbd0"
S = "${WORKDIR}/git"
