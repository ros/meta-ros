...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/liblz4_vendor/0.26.6-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/liblz4_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e43c103e8408d88be3e46e9bd49ab5f82914f0bd"
S = "${WORKDIR}/git"
