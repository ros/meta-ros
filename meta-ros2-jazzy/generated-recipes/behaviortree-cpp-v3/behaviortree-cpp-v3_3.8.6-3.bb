...
# matches with: https://github.com/ros2-gbp/behaviortree_cpp-release/archive/release/jazzy/behaviortree_cpp_v3/3.8.6-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/behaviortree_cpp_v3"
SRC_URI = "git://github.com/ros2-gbp/behaviortree_cpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "0b5edf037bf08f1401392b7914a0d6add7789360"
S = "${WORKDIR}/git"
