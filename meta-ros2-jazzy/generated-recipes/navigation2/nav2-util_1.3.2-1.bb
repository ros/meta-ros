...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_util/1.3.2-1.tar.gz
...
SRCREV = "6492242b8d0928be620a9e5e5642dcda59da41db"
S = "${WORKDIR}/git"
