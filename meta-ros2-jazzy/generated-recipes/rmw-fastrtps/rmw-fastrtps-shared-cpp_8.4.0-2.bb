...
# matches with: https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/jazzy/rmw_fastrtps_shared_cpp/8.4.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rmw_fastrtps_shared_cpp"
SRC_URI = "git://github.com/ros2-gbp/rmw_fastrtps-release;${ROS_BRANCH};protocol=https"
SRCREV = "6a2e662631be2f96b984564c6eb2a19846b33793"
S = "${WORKDIR}/git"
