...
# matches with: https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/jazzy/rmw_fastrtps_dynamic_cpp/8.4.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rmw_fastrtps_dynamic_cpp"
SRC_URI = "git://github.com/ros2-gbp/rmw_fastrtps-release;${ROS_BRANCH};protocol=https"
SRCREV = "e5e67e8769dc3c309fbb3a58acab50cad6a884f0"
S = "${WORKDIR}/git"
