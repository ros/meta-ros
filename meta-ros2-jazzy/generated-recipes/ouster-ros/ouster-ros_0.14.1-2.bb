...
# matches with: https://github.com/ros2-gbp/ouster-ros-release/archive/release/jazzy/ouster_ros/0.14.1-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ouster_ros"
SRC_URI = "git://github.com/ros2-gbp/ouster-ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "54f370c34eb75ab37aceaeeddeb1479ac7ff99b1"
S = "${WORKDIR}/git"
