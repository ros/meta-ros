...
# matches with: https://github.com/ros2-gbp/twist_mux-release/archive/release/jazzy/twist_mux/4.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/twist_mux"
SRC_URI = "git://github.com/ros2-gbp/twist_mux-release;${ROS_BRANCH};protocol=https"
SRCREV = "025308b135ade9fed08cd4b41ec8148cfbf95f08"
S = "${WORKDIR}/git"
