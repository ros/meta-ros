...
# matches with: https://github.com/ros2-gbp/automotive_autonomy_msgs-release/archive/release/jazzy/automotive_platform_msgs/3.0.4-6.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/automotive_platform_msgs"
SRC_URI = "git://github.com/ros2-gbp/automotive_autonomy_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "52a0f24bbcbe3b2a5f503ada8e224014cab98b6c"
S = "${WORKDIR}/git"
