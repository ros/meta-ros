...
# matches with: https://github.com/ros2-gbp/automotive_autonomy_msgs-release/archive/release/jazzy/automotive_autonomy_msgs/3.0.4-6.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/automotive_autonomy_msgs"
SRC_URI = "git://github.com/ros2-gbp/automotive_autonomy_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "34fc7813acfef2ff1efba213b734f4fb35656208"
S = "${WORKDIR}/git"
