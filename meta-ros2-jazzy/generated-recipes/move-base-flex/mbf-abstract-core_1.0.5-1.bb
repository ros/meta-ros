...
# matches with: https://github.com/ros2-gbp/move_base_flex-release/archive/release/jazzy/mbf_abstract_core/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mbf_abstract_core"
SRC_URI = "git://github.com/ros2-gbp/move_base_flex-release;${ROS_BRANCH};protocol=https"
SRCREV = "8a799a14c648aacf754496387bdf86d149a4ec08"
S = "${WORKDIR}/git"
