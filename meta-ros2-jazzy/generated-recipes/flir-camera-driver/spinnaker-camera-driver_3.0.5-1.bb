...
# matches with: https://github.com/ros2-gbp/flir_camera_driver-release/archive/release/jazzy/spinnaker_camera_driver/3.0.5-1.tar.gz
...
SRCREV = "b3b78b1bf2deabf214ef1d5406595a7ba2974f6f"
S = "${WORKDIR}/git"
