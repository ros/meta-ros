...
# matches with: https://github.com/ros2-gbp/multisensor_calibration-release/archive/release/jazzy/small_gicp_vendor/2.0.4-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/small_gicp_vendor"
SRC_URI = "git://github.com/ros2-gbp/multisensor_calibration-release;${ROS_BRANCH};protocol=https"
SRCREV = "676fabded0b10f8626a4a2798a68d69091a129d7"
S = "${WORKDIR}/git"
