...
# matches with: https://github.com/ros2-gbp/velodyne-release/archive/release/jazzy/velodyne_msgs/2.3.0-4.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/velodyne_msgs"
SRC_URI = "git://github.com/ros2-gbp/velodyne-release;${ROS_BRANCH};protocol=https"
SRCREV = "42dfd152f78b4edca4ed94c689332373b25a75b8"
S = "${WORKDIR}/git"
