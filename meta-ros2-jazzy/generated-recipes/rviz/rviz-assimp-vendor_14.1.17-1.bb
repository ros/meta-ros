...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_assimp_vendor/14.1.17-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rviz_assimp_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "9c7002f5cb6363a01a21a3dfce8e2c0951deba61"
S = "${WORKDIR}/git"
