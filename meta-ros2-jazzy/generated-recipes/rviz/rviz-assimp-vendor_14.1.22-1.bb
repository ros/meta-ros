...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_assimp_vendor/14.1.22-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rviz_assimp_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "e89671c7d8976b4378384f31b22febd6339189b1"
S = "${WORKDIR}/git"
