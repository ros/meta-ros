...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_assimp_vendor/14.1.14-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rviz_assimp_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "0dfec9ad02cb9ec3e0fa03fb8d1aec4397d77394"
S = "${WORKDIR}/git"
