...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_rendering/14.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rviz_rendering"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "2ba653abd883a02da5a161cea63f34f6b5448978"
S = "${WORKDIR}/git"
