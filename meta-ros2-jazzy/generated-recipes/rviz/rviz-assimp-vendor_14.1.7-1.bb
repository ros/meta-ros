...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_assimp_vendor/14.1.7-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rviz_assimp_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "cd696db9b8d09be1c759d4d3ed6b02da7d3b0666"
S = "${WORKDIR}/git"
