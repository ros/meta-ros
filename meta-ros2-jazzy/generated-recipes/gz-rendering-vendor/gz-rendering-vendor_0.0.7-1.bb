...
DESCRIPTION = "Vendor package for: gz-rendering8 8.2.3      Gazebo Rendering: Rendering library for robot applications"
...
# matches with: https://github.com/ros2-gbp/gz_rendering_vendor-release/archive/release/jazzy/gz_rendering_vendor/0.0.7-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/gz_rendering_vendor"
SRC_URI = "git://github.com/ros2-gbp/gz_rendering_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "882c65c0f16dcf25242676260f5db30ae3184e4f"
S = "${WORKDIR}/git"
