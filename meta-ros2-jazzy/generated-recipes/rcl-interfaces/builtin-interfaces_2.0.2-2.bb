...
# matches with: https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/jazzy/builtin_interfaces/2.0.2-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/builtin_interfaces"
SRC_URI = "git://github.com/ros2-gbp/rcl_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "77d0c5db6fc502b0d44926e2a852b8149eebe704"
S = "${WORKDIR}/git"
