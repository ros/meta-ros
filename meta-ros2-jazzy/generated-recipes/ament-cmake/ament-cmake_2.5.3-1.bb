...
# matches with: https://github.com/ros2-gbp/ament_cmake-release/archive/release/jazzy/ament_cmake/2.5.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ament_cmake"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake-release;${ROS_BRANCH};protocol=https"
SRCREV = "5ab00de67d6699715606076b0bdd2ba2b6384a95"
S = "${WORKDIR}/git"
