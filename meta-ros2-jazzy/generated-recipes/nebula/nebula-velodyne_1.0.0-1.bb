...
# matches with: https://github.com/ros2-gbp/nebula-release/archive/release/jazzy/nebula_velodyne/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/nebula_velodyne"
SRC_URI = "git://github.com/ros2-gbp/nebula-release;${ROS_BRANCH};protocol=https"
SRCREV = "cbd2d8b1de2bb2664fe83728f4ddd768d682d7cd"
S = "${WORKDIR}/git"
