...
# matches with: https://github.com/ros2-gbp/nebula-release/archive/release/jazzy/nebula_hesai/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/nebula_hesai"
SRC_URI = "git://github.com/ros2-gbp/nebula-release;${ROS_BRANCH};protocol=https"
SRCREV = "7acd7c3bd534a8b8d2be6ab64c9d65257ba691bd"
S = "${WORKDIR}/git"
