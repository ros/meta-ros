...
# matches with: https://github.com/ros2-gbp/hebi_cpp_api-release/archive/release/jazzy/hebi_cpp_api/3.15.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/hebi_cpp_api"
SRC_URI = "git://github.com/ros2-gbp/hebi_cpp_api-release;${ROS_BRANCH};protocol=https"
SRCREV = "f8037165090495ae703e603bbf0e4f9ff8adb372"
S = "${WORKDIR}/git"
