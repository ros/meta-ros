...
# matches with: https://github.com/ros2-gbp/mola_sm_loop_closure-release/archive/release/jazzy/mola_sm_loop_closure/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_sm_loop_closure"
SRC_URI = "git://github.com/ros2-gbp/mola_sm_loop_closure-release;${ROS_BRANCH};protocol=https"
SRCREV = "9bd0a696ceb4749ddf0b7532a84142e46f63c2c9"
S = "${WORKDIR}/git"
