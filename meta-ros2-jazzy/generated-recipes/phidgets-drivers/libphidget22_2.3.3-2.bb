...
# matches with: https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/jazzy/libphidget22/2.3.3-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/libphidget22"
SRC_URI = "git://github.com/ros2-gbp/phidgets_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "f325a1971b200ca0531ddcbdc51241c1e6a2d3e5"
S = "${WORKDIR}/git"
