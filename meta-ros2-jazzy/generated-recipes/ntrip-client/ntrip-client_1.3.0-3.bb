...
# matches with: https://github.com/ros2-gbp/ntrip_client-release/archive/release/jazzy/ntrip_client/1.3.0-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ntrip_client"
SRC_URI = "git://github.com/ros2-gbp/ntrip_client-release;${ROS_BRANCH};protocol=https"
SRCREV = "8b043737e69f30b6c448fc926d7d5192521f2eb1"
S = "${WORKDIR}/git"
