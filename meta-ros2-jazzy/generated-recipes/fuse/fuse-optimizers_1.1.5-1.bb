...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/jazzy/fuse_optimizers/1.1.5-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/fuse_optimizers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "113030e011eef58e5c33030f8a89ddc1adbe4a8f"
S = "${WORKDIR}/git"
