...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/jazzy/fuse_optimizers/1.1.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/fuse_optimizers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "06aa545a69146b7c58be261644acf0e7caee5cb6"
S = "${WORKDIR}/git"
