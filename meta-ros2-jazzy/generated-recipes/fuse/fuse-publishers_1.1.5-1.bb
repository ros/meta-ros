...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/jazzy/fuse_publishers/1.1.5-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/fuse_publishers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "ace4bae137e0fc3a974359ce0e0e5392dde883a3"
S = "${WORKDIR}/git"
