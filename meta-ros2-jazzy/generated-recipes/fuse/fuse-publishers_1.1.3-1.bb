...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/jazzy/fuse_publishers/1.1.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/fuse_publishers"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "26657f844087652681ec2fb3820b74659185032a"
S = "${WORKDIR}/git"
