...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/jazzy/fuse_constraints/1.1.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/fuse_constraints"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "b47ec665931a87bbde7d33d5f59a9893f7c68000"
S = "${WORKDIR}/git"
