...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/jazzy/fuse_tutorials/1.1.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/fuse_tutorials"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "361c62136f031db318febfb1fc1b63d1b43b3e4f"
S = "${WORKDIR}/git"
