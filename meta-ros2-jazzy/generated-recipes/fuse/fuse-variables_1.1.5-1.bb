...
# matches with: https://github.com/ros2-gbp/fuse-release/archive/release/jazzy/fuse_variables/1.1.5-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/fuse_variables"
SRC_URI = "git://github.com/ros2-gbp/fuse-release;${ROS_BRANCH};protocol=https"
SRCREV = "a15d7bedf61caab63281b390b6bb56d954579228"
S = "${WORKDIR}/git"
