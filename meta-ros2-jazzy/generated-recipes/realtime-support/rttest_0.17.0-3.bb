...
# matches with: https://github.com/ros2-gbp/realtime_support-release/archive/release/jazzy/rttest/0.17.0-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rttest"
SRC_URI = "git://github.com/ros2-gbp/realtime_support-release;${ROS_BRANCH};protocol=https"
SRCREV = "19a193b3d09bcc656177b5df025466181096871d"
S = "${WORKDIR}/git"
