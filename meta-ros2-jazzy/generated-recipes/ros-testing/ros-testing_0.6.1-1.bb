...
# matches with: https://github.com/ros2-gbp/ros_testing-release/archive/release/jazzy/ros_testing/0.6.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ros_testing"
SRC_URI = "git://github.com/ros2-gbp/ros_testing-release;${ROS_BRANCH};protocol=https"
SRCREV = "74640b01874f0472dfff28b1d6715f7d74736e2c"
S = "${WORKDIR}/git"
