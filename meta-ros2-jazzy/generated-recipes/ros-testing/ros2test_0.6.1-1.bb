...
# matches with: https://github.com/ros2-gbp/ros_testing-release/archive/release/jazzy/ros2test/0.6.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ros2test"
SRC_URI = "git://github.com/ros2-gbp/ros_testing-release;${ROS_BRANCH};protocol=https"
SRCREV = "8646077a4ddc7a3863ac143006610256efb3d0c9"
S = "${WORKDIR}/git"
