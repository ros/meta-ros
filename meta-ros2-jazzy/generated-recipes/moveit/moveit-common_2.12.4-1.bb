...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_common/2.12.4-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "260bcd094495039b89e6deee83daa1e69653252a"
S = "${WORKDIR}/git"
