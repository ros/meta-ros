...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_common/2.12.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b5ab8929a34fdf4f9427f9b6e6fda2ec81617173"
S = "${WORKDIR}/git"
