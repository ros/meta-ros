...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/pilz_industrial_motion_planner_testutils/2.12.3-1.tar.gz
...
SRCREV = "0fe427fada7aa9d8039ae39ea8a2b8fcd0bac0a4"
S = "${WORKDIR}/git"
