...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_planners/2.12.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_planners"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "0f09bdcf77ac31ea6bfd5e34d258bd3f892c61e7"
S = "${WORKDIR}/git"
