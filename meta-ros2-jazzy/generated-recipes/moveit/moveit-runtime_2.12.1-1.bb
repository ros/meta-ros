...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_runtime/2.12.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_runtime"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a3dc942b90bcf7fbc407be4c70eeda9d6637a612"
S = "${WORKDIR}/git"
