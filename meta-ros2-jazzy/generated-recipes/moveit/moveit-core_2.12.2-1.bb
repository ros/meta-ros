...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_core/2.12.2-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_core"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "9da26eb4113b5fa1e515c22718296ec3ba245def"
S = "${WORKDIR}/git"
