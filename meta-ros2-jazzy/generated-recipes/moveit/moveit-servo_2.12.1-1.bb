...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_servo/2.12.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_servo"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e9e3823c6ef62588637d829a5c2b236924b56f1e"
S = "${WORKDIR}/git"
