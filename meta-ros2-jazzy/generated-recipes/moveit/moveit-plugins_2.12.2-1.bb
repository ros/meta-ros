...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_plugins/2.12.2-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_plugins"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b8faab4e544060a45927ded3ff2e6c6b0149e8a2"
S = "${WORKDIR}/git"
