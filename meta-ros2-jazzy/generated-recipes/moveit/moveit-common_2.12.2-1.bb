...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_common/2.12.2-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "09f6d0f9596d0d4c5cb4b8cab50f57fa42df57d2"
S = "${WORKDIR}/git"
