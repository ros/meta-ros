...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_plugins/2.12.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_plugins"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "3a4f2829779f333cf75ac440294149f00e8e481a"
S = "${WORKDIR}/git"
