...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_plugins/2.10.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_plugins"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5141fa4cd1dcf35e61f772376dba2c30930168db"
S = "${WORKDIR}/git"
