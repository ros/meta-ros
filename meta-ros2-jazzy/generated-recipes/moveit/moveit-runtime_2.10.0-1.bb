...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_runtime/2.10.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_runtime"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "2ddde4274e5e80ea818897525648caaf6cdd54ac"
S = "${WORKDIR}/git"
