...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_planners/2.12.4-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_planners"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "052aa40c9e1323ba902ffc527778fd785ec8edba"
S = "${WORKDIR}/git"
