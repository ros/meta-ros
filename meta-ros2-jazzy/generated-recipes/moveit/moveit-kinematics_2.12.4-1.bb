...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_kinematics/2.12.4-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_kinematics"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d5b08c80ae7d27d4482b6294687f572547d8ca12"
S = "${WORKDIR}/git"
