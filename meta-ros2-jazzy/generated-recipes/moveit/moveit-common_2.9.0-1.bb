...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_common/2.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "82592f9612d3bec0f4cf184dc7a61044ef82121a"
S = "${WORKDIR}/git"
