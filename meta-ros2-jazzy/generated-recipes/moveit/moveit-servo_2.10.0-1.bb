...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_servo/2.10.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_servo"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "cb66905f35b3d028d549fedb54280842822adbe6"
S = "${WORKDIR}/git"
