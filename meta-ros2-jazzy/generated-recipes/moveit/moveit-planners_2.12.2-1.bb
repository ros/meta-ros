...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_planners/2.12.2-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_planners"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "c30fb256d7b84f94f0cd144d56e1d71d26c15bfa"
S = "${WORKDIR}/git"
