...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_hybrid_planning/2.12.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_hybrid_planning"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "e878b2e0d1abbd890c5831a93bfd3370010427b0"
S = "${WORKDIR}/git"
