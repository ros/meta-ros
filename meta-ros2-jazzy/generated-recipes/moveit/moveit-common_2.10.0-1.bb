...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_common/2.10.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "f940ec341fab3a1a9e1134ef6765630ee5b2d4b1"
S = "${WORKDIR}/git"
