...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_runtime/2.12.2-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_runtime"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b150c6fedfca04cc87fbd1917422f3d63dfc8ada"
S = "${WORKDIR}/git"
