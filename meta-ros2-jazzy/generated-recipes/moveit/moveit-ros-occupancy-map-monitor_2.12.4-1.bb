...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_ros_occupancy_map_monitor/2.12.4-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/moveit_ros_occupancy_map_monitor"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "f9ada243771f620f37203142fbeb35e7fe41261c"
S = "${WORKDIR}/git"
