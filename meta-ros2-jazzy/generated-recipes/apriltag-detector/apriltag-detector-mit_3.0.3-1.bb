...
# matches with: https://github.com/ros2-gbp/apriltag_detector-release/archive/release/jazzy/apriltag_detector_mit/3.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/apriltag_detector_mit"
SRC_URI = "git://github.com/ros2-gbp/apriltag_detector-release;${ROS_BRANCH};protocol=https"
SRCREV = "3be6122eb8e08253d2e991e5000ae143b4170682"
S = "${WORKDIR}/git"
