...
# matches with: https://github.com/ros2-gbp/simple_launch-release/archive/release/jazzy/simple_launch/1.11.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/simple_launch"
SRC_URI = "git://github.com/ros2-gbp/simple_launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "c5ae96881fd362d73111227cd001b76b8b229b7a"
S = "${WORKDIR}/git"
