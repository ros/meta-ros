...
# matches with: https://github.com/ros2-gbp/ros_babel_fish-release/archive/release/jazzy/ros_babel_fish_test_msgs/2.25.11-1.tar.gz
...
SRCREV = "b3afc0374b96be6424574ee27fbaa9cba25dce12"
S = "${WORKDIR}/git"
