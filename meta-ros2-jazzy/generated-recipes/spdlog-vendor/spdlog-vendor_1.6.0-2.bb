...
# matches with: https://github.com/ros2-gbp/spdlog_vendor-release/archive/release/jazzy/spdlog_vendor/1.6.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/spdlog_vendor"
SRC_URI = "git://github.com/ros2-gbp/spdlog_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "586112123b2fc0a0a208cbed8d4a090460e0a61f"
S = "${WORKDIR}/git"
