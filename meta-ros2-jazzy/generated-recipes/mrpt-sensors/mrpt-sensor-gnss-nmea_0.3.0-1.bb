...
# matches with: https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/jazzy/mrpt_sensor_gnss_nmea/0.3.0-1.tar.gz
...
SRCREV = "9e49a7acd147cd4e9bdbd645b26feeb454ef51a6"
S = "${WORKDIR}/git"
