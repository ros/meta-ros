...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/jazzy/lifecycle_py/0.33.7-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/lifecycle_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "7e6eaac41236f567e1ee525d153742deee08dd15"
S = "${WORKDIR}/git"
