...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/jazzy/topic_monitor/0.33.2-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/topic_monitor"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "fe5c275b31cd99626e95af09844092817d7d020d"
S = "${WORKDIR}/git"
