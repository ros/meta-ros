...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/jazzy/logging_demo/0.33.7-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/logging_demo"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "7775a986428ca7838df83b96f6de9336ee926b5f"
S = "${WORKDIR}/git"
