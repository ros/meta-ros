...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/jazzy/lifecycle_py/0.33.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/lifecycle_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "13b62b8cf475325adcaffeeb3344f6af7ad791ef"
S = "${WORKDIR}/git"
