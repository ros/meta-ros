...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/jazzy/topic_monitor/0.33.11-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/topic_monitor"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "f95ace6a9bd772e2d5ac7a4ebda7d7488a28bac8"
S = "${WORKDIR}/git"
