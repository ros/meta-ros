...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/jazzy/logging_demo/0.33.9-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/logging_demo"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "e2ab616123e8dd51107223b4260d38619fd42de5"
S = "${WORKDIR}/git"
