...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/jazzy/topic_monitor/0.33.9-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/topic_monitor"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "6aee2f5aca34531cd6444cef80884111ee23165f"
S = "${WORKDIR}/git"
