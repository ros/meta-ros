...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/jazzy/lifecycle_py/0.33.2-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/lifecycle_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "f771394b5af4c3387f2a15bc88fe07671442440d"
S = "${WORKDIR}/git"
