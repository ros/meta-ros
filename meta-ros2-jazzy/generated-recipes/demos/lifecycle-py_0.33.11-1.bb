...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/jazzy/lifecycle_py/0.33.11-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/lifecycle_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "346c3e9127fb284c5a0d60514e7e6b78cfdb70f6"
S = "${WORKDIR}/git"
