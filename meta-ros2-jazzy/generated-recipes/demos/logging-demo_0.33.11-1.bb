...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/jazzy/logging_demo/0.33.11-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/logging_demo"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "42be3c9832845ba87f72419df856520ed8f0beec"
S = "${WORKDIR}/git"
