...
# matches with: https://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release/archive/release/jazzy/fastrtps_cmake_module/3.6.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/fastrtps_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release;${ROS_BRANCH};protocol=https"
SRCREV = "d3265cdbcaad3096098474edb966fd17eb5a977f"
S = "${WORKDIR}/git"
