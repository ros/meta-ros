...
# matches with: https://github.com/ros2-gbp/performance_test_fixture-release/archive/release/jazzy/performance_test_fixture/0.2.0-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/performance_test_fixture"
SRC_URI = "git://github.com/ros2-gbp/performance_test_fixture-release;${ROS_BRANCH};protocol=https"
SRCREV = "b459a303e469ad6a63549350dcf2102772cd0db9"
S = "${WORKDIR}/git"
