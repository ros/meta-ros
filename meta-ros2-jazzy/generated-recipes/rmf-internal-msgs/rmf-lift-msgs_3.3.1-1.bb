...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/jazzy/rmf_lift_msgs/3.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rmf_lift_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "7bde0e3a44aa28f48a200305762f4dbb81636c08"
S = "${WORKDIR}/git"
