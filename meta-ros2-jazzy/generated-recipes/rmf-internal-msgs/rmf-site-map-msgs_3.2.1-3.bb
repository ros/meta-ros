...
# matches with: https://github.com/ros2-gbp/rmf_internal_msgs-release/archive/release/jazzy/rmf_site_map_msgs/3.2.1-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rmf_site_map_msgs"
SRC_URI = "git://github.com/ros2-gbp/rmf_internal_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "fd577d3d91fcea6aad458631802880281096e44b"
S = "${WORKDIR}/git"
