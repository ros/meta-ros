...
# matches with: https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/jazzy/ublox_ubx_msgs/0.5.3-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ublox_ubx_msgs"
SRC_URI = "git://github.com/ros2-gbp/ublox_dgnss-release;${ROS_BRANCH};protocol=https"
SRCREV = "ab4207257e0bd9e858866e33b108aa90ba412e5a"
S = "${WORKDIR}/git"
