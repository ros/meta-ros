...
# matches with: https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/jazzy/ntrip_client_node/0.5.3-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ntrip_client_node"
SRC_URI = "git://github.com/ros2-gbp/ublox_dgnss-release;${ROS_BRANCH};protocol=https"
SRCREV = "153c7bdbaf4ecee8decb754480f2443f2fd6b90a"
S = "${WORKDIR}/git"
