...
# matches with: https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/jazzy/ublox_ubx_interfaces/0.5.3-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ublox_ubx_interfaces"
SRC_URI = "git://github.com/ros2-gbp/ublox_dgnss-release;${ROS_BRANCH};protocol=https"
SRCREV = "8888b0296db01863fed2e91a5337cf367fbb1b4e"
S = "${WORKDIR}/git"
