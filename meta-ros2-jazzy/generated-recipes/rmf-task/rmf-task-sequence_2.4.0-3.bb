...
# matches with: https://github.com/ros2-gbp/rmf_task-release/archive/release/jazzy/rmf_task_sequence/2.4.0-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rmf_task_sequence"
SRC_URI = "git://github.com/ros2-gbp/rmf_task-release;${ROS_BRANCH};protocol=https"
SRCREV = "6826c03ed303e103658691081a2ffccc968c52d8"
S = "${WORKDIR}/git"
