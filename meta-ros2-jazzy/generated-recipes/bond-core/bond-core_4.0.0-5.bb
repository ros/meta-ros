...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/jazzy/bond_core/4.0.0-5.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/bond_core"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "af2df210c9b1bee966e06af45f65348efd43abb0"
S = "${WORKDIR}/git"
