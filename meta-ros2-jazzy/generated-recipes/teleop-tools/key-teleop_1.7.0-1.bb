...
# matches with: https://github.com/ros2-gbp/teleop_tools-release/archive/release/jazzy/key_teleop/1.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/key_teleop"
SRC_URI = "git://github.com/ros2-gbp/teleop_tools-release;${ROS_BRANCH};protocol=https"
SRCREV = "f1fbb30230c60fcf9d79207e8cc3ba8e5f03be5e"
S = "${WORKDIR}/git"
