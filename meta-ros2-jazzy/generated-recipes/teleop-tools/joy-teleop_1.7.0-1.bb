...
# matches with: https://github.com/ros2-gbp/teleop_tools-release/archive/release/jazzy/joy_teleop/1.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/joy_teleop"
SRC_URI = "git://github.com/ros2-gbp/teleop_tools-release;${ROS_BRANCH};protocol=https"
SRCREV = "a85f889a8a8db4cdbe797a8e1feed0a1a583c4e2"
S = "${WORKDIR}/git"
