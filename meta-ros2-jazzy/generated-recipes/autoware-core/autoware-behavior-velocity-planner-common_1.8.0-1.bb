...
# matches with: https://github.com/ros2-gbp/autoware_core-release/archive/release/jazzy/autoware_behavior_velocity_planner_common/1.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/autoware_behavior_velocity_planner_common"
SRC_URI = "git://github.com/ros2-gbp/autoware_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "6f61f496b4c75bb694de934379acab477039500c"
S = "${WORKDIR}/git"
