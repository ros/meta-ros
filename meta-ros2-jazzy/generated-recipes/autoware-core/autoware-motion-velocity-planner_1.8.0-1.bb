...
# matches with: https://github.com/ros2-gbp/autoware_core-release/archive/release/jazzy/autoware_motion_velocity_planner/1.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/autoware_motion_velocity_planner"
SRC_URI = "git://github.com/ros2-gbp/autoware_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "a6f5c83234ec55ccbf0bfa5916c218def58db05c"
S = "${WORKDIR}/git"
