...
# matches with: https://github.com/ros2-gbp/autoware_core-release/archive/release/jazzy/autoware_motion_velocity_planner_common/1.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/autoware_motion_velocity_planner_common"
SRC_URI = "git://github.com/ros2-gbp/autoware_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "532264d1cadba24475341c65a5241e4518e55fbe"
S = "${WORKDIR}/git"
