...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_primitives_conversion/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/etsi_its_primitives_conversion"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "ccb24da58f7ed64cb7dd378db7baf499a399fdbc"
S = "${WORKDIR}/git"
