...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_spatem_ts_msgs/3.1.0-1.tar.gz
...
SRCREV = "9386381fd54f37205b60253a8a8f4149f31be550"
S = "${WORKDIR}/git"
