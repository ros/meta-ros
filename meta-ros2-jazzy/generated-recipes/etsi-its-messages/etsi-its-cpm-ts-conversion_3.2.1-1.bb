...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_cpm_ts_conversion/3.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/etsi_its_cpm_ts_conversion"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "0d9e1d60fec555ad47f1499a57a604badde110ae"
S = "${WORKDIR}/git"
