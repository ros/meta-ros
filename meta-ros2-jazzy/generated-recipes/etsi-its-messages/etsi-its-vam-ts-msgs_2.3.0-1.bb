...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_vam_ts_msgs/2.3.0-1.tar.gz
...
SRCREV = "a8b4def15b50512b906d1e1a5e9d1ee599bba7cb"
S = "${WORKDIR}/git"
