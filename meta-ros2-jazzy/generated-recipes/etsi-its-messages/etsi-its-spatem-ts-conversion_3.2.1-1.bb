...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_spatem_ts_conversion/3.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/etsi_its_spatem_ts_conversion"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "38794384147b8f5cb368eae484ab4e5615efe4d7"
S = "${WORKDIR}/git"
