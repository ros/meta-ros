...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_mcm_uulm_conversion/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/etsi_its_mcm_uulm_conversion"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "1fce05c06d10c59d53a7d94588eadf9e2b11c5e3"
S = "${WORKDIR}/git"
