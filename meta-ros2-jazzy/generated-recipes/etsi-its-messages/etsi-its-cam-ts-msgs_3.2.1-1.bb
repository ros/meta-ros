...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_cam_ts_msgs/3.2.1-1.tar.gz
...
SRCREV = "d1bd73be1e67838590840eb90a353c840446ecef"
S = "${WORKDIR}/git"
