...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_denm_ts_conversion/3.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/etsi_its_denm_ts_conversion"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "ccf1a1fc29a3cd6cb5ca8f5576bca3adcae61f01"
S = "${WORKDIR}/git"
