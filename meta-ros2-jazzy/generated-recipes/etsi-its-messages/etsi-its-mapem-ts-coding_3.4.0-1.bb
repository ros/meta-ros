...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_mapem_ts_coding/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/etsi_its_mapem_ts_coding"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "1015653f8f2e712dc7a14a702792689ca75325c8"
S = "${WORKDIR}/git"
