...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_vam_ts_coding/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/etsi_its_vam_ts_coding"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "f8be5b8201b017ad32aac85ffe9e0a371816c7c7"
S = "${WORKDIR}/git"
