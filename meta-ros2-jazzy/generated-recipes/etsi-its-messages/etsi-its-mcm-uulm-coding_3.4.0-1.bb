...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_mcm_uulm_coding/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/etsi_its_mcm_uulm_coding"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "f5afba8a66865874ed820ea032094b86dfafca41"
S = "${WORKDIR}/git"
