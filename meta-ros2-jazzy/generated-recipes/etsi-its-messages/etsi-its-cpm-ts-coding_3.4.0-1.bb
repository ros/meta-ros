...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_cpm_ts_coding/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/etsi_its_cpm_ts_coding"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "4b0696ce89df600ffccf0cf552511eea14c047c2"
S = "${WORKDIR}/git"
