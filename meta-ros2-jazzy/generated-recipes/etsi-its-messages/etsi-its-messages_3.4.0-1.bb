...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_messages/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/etsi_its_messages"
SRC_URI = "git://github.com/ros2-gbp/etsi_its_messages-release;${ROS_BRANCH};protocol=https"
SRCREV = "c0f8e641031943213866c67ebb6f3b4e8a03a002"
S = "${WORKDIR}/git"
