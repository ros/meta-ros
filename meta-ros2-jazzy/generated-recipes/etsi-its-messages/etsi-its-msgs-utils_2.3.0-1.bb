...
# matches with: https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/jazzy/etsi_its_msgs_utils/2.3.0-1.tar.gz
...
SRCREV = "ac30eb22c6938f64ca11d3e1f0962d1158db1af9"
S = "${WORKDIR}/git"
