...
# matches with: https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/jazzy/mola_gtsam_factors/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_gtsam_factors"
SRC_URI = "git://github.com/ros2-gbp/mola_state_estimation-release;${ROS_BRANCH};protocol=https"
SRCREV = "ab2d0c46729248dd46f8869b810ad7ae9e47ce1c"
S = "${WORKDIR}/git"
