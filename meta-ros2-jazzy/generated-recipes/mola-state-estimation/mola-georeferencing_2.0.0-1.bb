...
# matches with: https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/jazzy/mola_georeferencing/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_georeferencing"
SRC_URI = "git://github.com/ros2-gbp/mola_state_estimation-release;${ROS_BRANCH};protocol=https"
SRCREV = "91d0353a339539f0be6d20327eecfd2cc72b61be"
S = "${WORKDIR}/git"
