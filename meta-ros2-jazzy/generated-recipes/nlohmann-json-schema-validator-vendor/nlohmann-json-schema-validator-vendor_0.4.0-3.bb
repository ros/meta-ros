...
# matches with: https://github.com/ros2-gbp/nlohmann_json_schema_validator_vendor-release/archive/release/jazzy/nlohmann_json_schema_validator_vendor/0.4.0-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/nlohmann_json_schema_validator_vendor"
SRC_URI = "git://github.com/ros2-gbp/nlohmann_json_schema_validator_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "887812c02316af16a75d8400ac5eab44c8eba4a4"
S = "${WORKDIR}/git"
