...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/jazzy/compressed_depth_image_transport/4.0.5-1.tar.gz
...
SRCREV = "4ca0b16902a4fe58fae2edc271b0a6e8eeb2468c"
S = "${WORKDIR}/git"
