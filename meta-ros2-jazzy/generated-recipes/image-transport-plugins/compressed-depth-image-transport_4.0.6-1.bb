...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/jazzy/compressed_depth_image_transport/4.0.6-1.tar.gz
...
SRCREV = "d6785e77003038f32af00b728766f50be614b6d6"
S = "${WORKDIR}/git"
