...
# matches with: https://github.com/ros2-gbp/mqtt_client-release/archive/release/jazzy/mqtt_client/2.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mqtt_client"
SRC_URI = "git://github.com/ros2-gbp/mqtt_client-release;${ROS_BRANCH};protocol=https"
SRCREV = "67b87fefcc04c2e4987b515a2f82ed4c70c7c26b"
S = "${WORKDIR}/git"
