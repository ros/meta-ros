...
# matches with: https://github.com/ros2-gbp/ign_ros2_control-release/archive/release/jazzy/gz_ros2_control_demos/1.2.16-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/gz_ros2_control_demos"
SRC_URI = "git://github.com/ros2-gbp/ign_ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "135965c442c265991648a191946de3ebf1729985"
S = "${WORKDIR}/git"
