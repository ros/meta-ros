...
# matches with: https://github.com/ros2-gbp/ign_ros2_control-release/archive/release/jazzy/gz_ros2_control/1.2.16-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/gz_ros2_control"
SRC_URI = "git://github.com/ros2-gbp/ign_ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "d815cd2b85ffd4a9dfef07f8790bfe359440b568"
S = "${WORKDIR}/git"
