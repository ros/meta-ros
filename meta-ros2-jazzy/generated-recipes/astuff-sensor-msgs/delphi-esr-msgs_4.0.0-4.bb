...
# matches with: https://github.com/ros2-gbp/astuff_sensor_msgs-release/archive/release/jazzy/delphi_esr_msgs/4.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/delphi_esr_msgs"
SRC_URI = "git://github.com/ros2-gbp/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "1472f4d0624f3eb26fbc4f16588cb8361f059807"
S = "${WORKDIR}/git"
