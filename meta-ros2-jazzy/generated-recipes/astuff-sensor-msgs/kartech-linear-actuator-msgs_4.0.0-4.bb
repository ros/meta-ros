...
# matches with: https://github.com/ros2-gbp/astuff_sensor_msgs-release/archive/release/jazzy/kartech_linear_actuator_msgs/4.0.0-4.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/kartech_linear_actuator_msgs"
SRC_URI = "git://github.com/ros2-gbp/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "ff9619e827b54c47fa7510043858db7b8a01d211"
S = "${WORKDIR}/git"
