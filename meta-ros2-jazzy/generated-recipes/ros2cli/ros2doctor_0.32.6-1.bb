...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2doctor/0.32.6-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ros2doctor"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "891db6a8d0db21f1fe183c5069978fef5bdc724e"
S = "${WORKDIR}/git"
