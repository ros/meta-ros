...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2interface/0.32.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ros2interface"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "2fc4821d3d5b0e0d1effbb7dd5533b5bde2b33e1"
S = "${WORKDIR}/git"
