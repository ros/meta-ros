...
# matches with: https://github.com/ros2-gbp/iceoryx-release/archive/release/jazzy/iceoryx_binding_c/2.0.5-6.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/iceoryx_binding_c"
SRC_URI = "git://github.com/ros2-gbp/iceoryx-release;${ROS_BRANCH};protocol=https"
SRCREV = "cd93f6a8b8a0aba7828db592fca2a61065227605"
S = "${WORKDIR}/git"
