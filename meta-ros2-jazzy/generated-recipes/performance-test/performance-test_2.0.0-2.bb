...
# matches with: https://github.com/ros2-gbp/performance_test-release/archive/release/jazzy/performance_test/2.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/performance_test"
SRC_URI = "git://github.com/ros2-gbp/performance_test-release;${ROS_BRANCH};protocol=https"
SRCREV = "be48f37e34cf496f4c557b712c3fe4c7491783d5"
S = "${WORKDIR}/git"
