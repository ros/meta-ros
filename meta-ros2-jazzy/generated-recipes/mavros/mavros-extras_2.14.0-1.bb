...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/jazzy/mavros_extras/2.14.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mavros_extras"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "0629ad2e304c8014ec32147a8f3c4b85a753c6a6"
S = "${WORKDIR}/git"
