...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/jazzy/mavros_extras/2.6.0-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mavros_extras"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "d733753bfca9e0bad0acf5f1f03049d1927bbfa4"
S = "${WORKDIR}/git"
