...
# matches with: https://github.com/ros2-gbp/mavros-release/archive/release/jazzy/mavros_extras/2.10.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mavros_extras"
SRC_URI = "git://github.com/ros2-gbp/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "0a2faa2712397846746ff1d4833d8795064d7f9d"
S = "${WORKDIR}/git"
