...
# matches with: https://github.com/ros2-gbp/ros2_planning_system-release/archive/release/jazzy/plansys2_support_py/2.0.18-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/plansys2_support_py"
SRC_URI = "git://github.com/ros2-gbp/ros2_planning_system-release;${ROS_BRANCH};protocol=https"
SRCREV = "831d3fa64fd45f6641c7536b178466250fd5b3e8"
S = "${WORKDIR}/git"
