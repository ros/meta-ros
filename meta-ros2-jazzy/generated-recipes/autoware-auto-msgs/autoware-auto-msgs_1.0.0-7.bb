...
# matches with: https://github.com/ros2-gbp/autoware_auto_msgs-release/archive/release/jazzy/autoware_auto_msgs/1.0.0-7.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/autoware_auto_msgs"
SRC_URI = "git://github.com/ros2-gbp/autoware_auto_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "f0718df1847edd2e93373607df31b52a675a0f31"
S = "${WORKDIR}/git"
