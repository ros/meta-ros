...
# matches with: https://github.com/ros2-gbp/ros_foxglove_msgs-release/archive/release/jazzy/foxglove_msgs/3.0.0-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/foxglove_msgs"
SRC_URI = "git://github.com/ros2-gbp/ros_foxglove_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "1643daf92cf16b9a75cc2e3e184c7077de87db2a"
S = "${WORKDIR}/git"
