...
# matches with: https://github.com/ros2-gbp/magic_enum-release/archive/release/jazzy/magic_enum/0.9.7-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/magic_enum"
SRC_URI = "git://github.com/ros2-gbp/magic_enum-release;${ROS_BRANCH};protocol=https"
SRCREV = "12f640417984431ed644872937f17968a39bbf9d"
S = "${WORKDIR}/git"
