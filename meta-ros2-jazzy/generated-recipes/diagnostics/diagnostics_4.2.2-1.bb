...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/jazzy/diagnostics/4.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/diagnostics"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "19fddf3d2749e4917fbda6a3e89eabcdb45c00ee"
S = "${WORKDIR}/git"
