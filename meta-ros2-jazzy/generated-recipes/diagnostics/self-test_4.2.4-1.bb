...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/jazzy/self_test/4.2.4-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/self_test"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "e5b28e1edbe341c17f579111ab40c3b859c89192"
S = "${WORKDIR}/git"
