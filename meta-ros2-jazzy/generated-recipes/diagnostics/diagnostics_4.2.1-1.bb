...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/jazzy/diagnostics/4.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/diagnostics"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "904ae24d5e00bd38b48157ff4446b384090e42b5"
S = "${WORKDIR}/git"
