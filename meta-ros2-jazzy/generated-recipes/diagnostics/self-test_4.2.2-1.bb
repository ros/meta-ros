...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/jazzy/self_test/4.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/self_test"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "dacaee6e2647eee39b86da51bbe5c6b7d5e6932c"
S = "${WORKDIR}/git"
