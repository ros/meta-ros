...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/jazzy/diagnostics/4.2.7-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/diagnostics"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "5368b12348c3568ebe4e752ca2a5c8b76eaf1575"
S = "${WORKDIR}/git"
