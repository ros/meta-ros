...
DESCRIPTION = "Vendor package for: gz-math7 7.6.0      Gazebo Math : Math classes and functions for robot applications"
...
# matches with: https://github.com/ros2-gbp/gz_math_vendor-release/archive/release/jazzy/gz_math_vendor/0.0.9-1.tar.gz
