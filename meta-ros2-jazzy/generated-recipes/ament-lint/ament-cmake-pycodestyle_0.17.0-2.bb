...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_pycodestyle/0.17.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ament_cmake_pycodestyle"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "2c7a6db355c1837e810713e8afeaa99befb8d09b"
S = "${WORKDIR}/git"
