...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_pyflakes/0.17.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ament_pyflakes"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "899d4f47da88b57d43239eaf41fd73ab61fe9a70"
S = "${WORKDIR}/git"
