...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_lint_cmake/0.17.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ament_cmake_lint_cmake"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "bd29aee89d54c6ce71cab83ce4fdaa8f96b75df3"
S = "${WORKDIR}/git"
