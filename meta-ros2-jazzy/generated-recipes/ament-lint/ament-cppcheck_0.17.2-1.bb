...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cppcheck/0.17.2-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ament_cppcheck"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "f6173f5bddead292b9bd8dcb39e2ca9993f94bb2"
S = "${WORKDIR}/git"
