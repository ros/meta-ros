...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_clang_tidy/0.17.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ament_cmake_clang_tidy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "46425242fed1e21ff90da988560f160a75d6e1d7"
S = "${WORKDIR}/git"
