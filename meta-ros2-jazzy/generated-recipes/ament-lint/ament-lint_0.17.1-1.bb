...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_lint/0.17.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ament_lint"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "743e72f2a5a406d647dceeeaec8e201cceebe378"
S = "${WORKDIR}/git"
