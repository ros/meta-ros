...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_pclint/0.17.4-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ament_pclint"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "5c8b65a8a432d8b8570bd27c2086a9acec7d039b"
S = "${WORKDIR}/git"
