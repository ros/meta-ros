...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_clang_format/0.17.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ament_cmake_clang_format"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "15e6aa9e0b95f65cb8e7a98aee4da87d3867b0aa"
S = "${WORKDIR}/git"
