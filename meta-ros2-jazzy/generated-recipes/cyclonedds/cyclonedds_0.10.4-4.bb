...
# matches with: https://github.com/ros2-gbp/cyclonedds-release/archive/release/jazzy/cyclonedds/0.10.4-4.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/cyclonedds"
SRC_URI = "git://github.com/ros2-gbp/cyclonedds-release;${ROS_BRANCH};protocol=https"
SRCREV = "3864ffca149a7e6c55dea0346356174ca2e44dc5"
S = "${WORKDIR}/git"
