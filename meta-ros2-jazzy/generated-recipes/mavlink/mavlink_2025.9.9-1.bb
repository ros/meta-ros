...
# matches with: https://github.com/ros2-gbp/mavlink-gbp-release/archive/release/jazzy/mavlink/2025.9.9-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mavlink"
SRC_URI = "git://github.com/ros2-gbp/mavlink-gbp-release;${ROS_BRANCH};protocol=https"
SRCREV = "c7030f2e5d1c1cf1e5dc5d470bd9756db06216a5"
S = "${WORKDIR}/git"
