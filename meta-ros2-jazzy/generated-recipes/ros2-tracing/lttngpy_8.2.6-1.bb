...
# matches with: https://github.com/ros2-gbp/ros2_tracing-release/archive/release/jazzy/lttngpy/8.2.6-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/lttngpy"
SRC_URI = "git://github.com/ros2-gbp/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "90fef426cb19d4c930c1e9a036368cb8f301a0a4"
S = "${WORKDIR}/git"
