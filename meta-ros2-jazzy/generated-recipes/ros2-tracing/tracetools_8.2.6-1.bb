...
# matches with: https://github.com/ros2-gbp/ros2_tracing-release/archive/release/jazzy/tracetools/8.2.6-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/tracetools"
SRC_URI = "git://github.com/ros2-gbp/ros2_tracing-release;${ROS_BRANCH};protocol=https"
SRCREV = "7a5d85e51b1cb0525a955dbf685edfb807fb1e52"
S = "${WORKDIR}/git"
