...
# matches with: https://github.com/ros2-gbp/zenoh_bridge_dds-release/archive/release/jazzy/zenoh_bridge_dds/0.5.0-5.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/zenoh_bridge_dds"
SRC_URI = "git://github.com/ros2-gbp/zenoh_bridge_dds-release;${ROS_BRANCH};protocol=https"
SRCREV = "9bfadd4d1132571b6ac912a2f1746d1113cf5258"
S = "${WORKDIR}/git"
