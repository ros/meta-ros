...
# matches with: https://github.com/ros2-gbp/grid_map-release/archive/release/jazzy/grid_map_core/2.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/grid_map_core"
SRC_URI = "git://github.com/ros2-gbp/grid_map-release;${ROS_BRANCH};protocol=https"
SRCREV = "62a7d5dbc8dac1525797c562015107125df608b5"
S = "${WORKDIR}/git"
