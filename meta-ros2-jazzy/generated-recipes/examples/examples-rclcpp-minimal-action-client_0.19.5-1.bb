...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/jazzy/examples_rclcpp_minimal_action_client/0.19.5-1.tar.gz
...
SRCREV = "b00129689036304b803314da7de3c0caddcabbc7"
S = "${WORKDIR}/git"
