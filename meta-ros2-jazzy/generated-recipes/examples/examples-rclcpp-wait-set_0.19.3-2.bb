...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/jazzy/examples_rclcpp_wait_set/0.19.3-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/examples_rclcpp_wait_set"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "f67527c51785f38616961738e797f6a0711ffd30"
S = "${WORKDIR}/git"
