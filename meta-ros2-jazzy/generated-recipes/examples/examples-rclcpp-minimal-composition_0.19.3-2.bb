...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/jazzy/examples_rclcpp_minimal_composition/0.19.3-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/examples_rclcpp_minimal_composition"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "468e7b14a1bd2ddb01b230f4fc155ecfd5c2ce11"
S = "${WORKDIR}/git"
