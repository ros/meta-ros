...
# matches with: https://github.com/ros2-gbp/plotjuggler-ros-plugins-release/archive/release/jazzy/plotjuggler_ros/2.1.0-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/plotjuggler_ros"
SRC_URI = "git://github.com/ros2-gbp/plotjuggler-ros-plugins-release;${ROS_BRANCH};protocol=https"
SRCREV = "9aaa1461584dbc9ac092302eff6915df6ba667b3"
S = "${WORKDIR}/git"
