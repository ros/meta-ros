...
# matches with: https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/rqt_joint_trajectory_controller/4.14.0-1.tar.gz
...
SRCREV = "ca9fceacfce72b0089f9569332f41be7bce047d5"
S = "${WORKDIR}/git"
