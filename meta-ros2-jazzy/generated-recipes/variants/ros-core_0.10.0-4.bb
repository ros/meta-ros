...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/jazzy/ros_core/0.10.0-4.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ros_core"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "4b9c4acab5108550fba9979d0e7aa5adc41d77a0"
S = "${WORKDIR}/git"
