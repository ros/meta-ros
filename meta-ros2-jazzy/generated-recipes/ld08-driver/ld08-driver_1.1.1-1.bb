...
# matches with: https://github.com/ros2-gbp/ld08_driver-release/archive/release/jazzy/ld08_driver/1.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/ld08_driver"
SRC_URI = "git://github.com/ros2-gbp/ld08_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "c279b388ef657cd7866d0500f90f1c49d98cbfd9"
S = "${WORKDIR}/git"
