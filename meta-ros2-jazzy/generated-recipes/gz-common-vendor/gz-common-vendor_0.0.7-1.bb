...
# matches with: https://github.com/ros2-gbp/gz_common_vendor-release/archive/release/jazzy/gz_common_vendor/0.0.7-1.tar.gz
...
SRCREV = "c7834c5ff9baeab7b24001a8f8d4b26080184ceb"
S = "${WORKDIR}/git"
