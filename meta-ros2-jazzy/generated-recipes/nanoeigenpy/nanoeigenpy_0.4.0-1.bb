...
# matches with: https://github.com/ros2-gbp/nanoeigenpy-release/archive/release/jazzy/nanoeigenpy/0.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/nanoeigenpy"
SRC_URI = "git://github.com/ros2-gbp/nanoeigenpy-release;${ROS_BRANCH};protocol=https"
SRCREV = "c49d6ec9fc54b08b2e0267d01091b7fa46ffe6a5"
S = "${WORKDIR}/git"
