...
# matches with: https://github.com/ros2-gbp/topic_tools-release/archive/release/jazzy/topic_tools/1.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/topic_tools"
SRC_URI = "git://github.com/ros2-gbp/topic_tools-release;${ROS_BRANCH};protocol=https"
SRCREV = "a0ba30f9dc8c3584d61a7e68a53f5467bdd96a2f"
S = "${WORKDIR}/git"
