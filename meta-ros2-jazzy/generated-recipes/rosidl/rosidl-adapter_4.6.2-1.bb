...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/jazzy/rosidl_adapter/4.6.2-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rosidl_adapter"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "129dd5a758be4fe1e380f2ac8df79573c4764795"
S = "${WORKDIR}/git"
