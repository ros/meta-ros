...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/jazzy/rosidl_adapter/4.6.7-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rosidl_adapter"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "98a23d343c2dc4ede42c80b17238cbdf4e52def4"
S = "${WORKDIR}/git"
