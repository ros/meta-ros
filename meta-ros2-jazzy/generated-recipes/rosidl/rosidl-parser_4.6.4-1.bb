...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/jazzy/rosidl_parser/4.6.4-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "cfa2918fe3fba7824521c75587efdbf9699f3d42"
S = "${WORKDIR}/git"
