...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/jazzy/rosidl_parser/4.6.6-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "3ee60a95a003b76d31a92cf0df994c3942a0e076"
S = "${WORKDIR}/git"
