...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/jazzy/rosidl_typesupport_introspection_cpp/4.6.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rosidl_typesupport_introspection_cpp"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "68a5d3b39fd5fc13ebbab48d3593bd81d86007f6"
S = "${WORKDIR}/git"
