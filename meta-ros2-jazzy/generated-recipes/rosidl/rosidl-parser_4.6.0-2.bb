...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/jazzy/rosidl_parser/4.6.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "35311c4a5b3bdfb2d8a50bd10bb2b578075fbaa0"
S = "${WORKDIR}/git"
