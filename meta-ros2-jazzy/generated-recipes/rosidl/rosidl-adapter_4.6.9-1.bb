...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/jazzy/rosidl_adapter/4.6.9-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/rosidl_adapter"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "e9a5f621aa44ebce363c548529b060bf46fde7ce"
S = "${WORKDIR}/git"
