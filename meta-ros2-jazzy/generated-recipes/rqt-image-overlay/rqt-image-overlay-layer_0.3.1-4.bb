...
# matches with: https://github.com/ros2-gbp/rqt_image_overlay-release/archive/release/jazzy/rqt_image_overlay_layer/0.3.1-4.tar.gz
...
SRCREV = "02784b28cc1e852177b9e4d0b25b49f144422fe6"
S = "${WORKDIR}/git"
