...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/jazzy/nav_msgs/5.3.4-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/nav_msgs"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "0b11bb2781dd9fd4de74593757cffd32de3cff38"
S = "${WORKDIR}/git"
