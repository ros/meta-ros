...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/jazzy/common_interfaces/5.3.4-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/common_interfaces"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "7818423935cdef8242faa7cc75d23a2fccefaf86"
S = "${WORKDIR}/git"
