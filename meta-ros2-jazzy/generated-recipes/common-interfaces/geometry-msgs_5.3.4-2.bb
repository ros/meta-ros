...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/jazzy/geometry_msgs/5.3.4-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/geometry_msgs"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "cd3f421d0e08b80fc66943cea5cf7f34655755fd"
S = "${WORKDIR}/git"
