...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/jazzy/diagnostic_msgs/5.3.4-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/diagnostic_msgs"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "6fe54b465a7d6a03620fa8f311aaef5eb3db7114"
S = "${WORKDIR}/git"
