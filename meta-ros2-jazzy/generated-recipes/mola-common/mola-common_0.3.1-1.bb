...
# matches with: https://github.com/ros2-gbp/mola_common-release/archive/release/jazzy/mola_common/0.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mola_common"
SRC_URI = "git://github.com/ros2-gbp/mola_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "e6799934cd94df30596c4f65be77e8ec9ef905d0"
S = "${WORKDIR}/git"
