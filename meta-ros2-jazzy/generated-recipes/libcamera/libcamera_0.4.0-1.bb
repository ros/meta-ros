...
# matches with: https://github.com/ros2-gbp/libcamera-release/archive/release/jazzy/libcamera/0.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/libcamera"
SRC_URI = "git://github.com/ros2-gbp/libcamera-release;${ROS_BRANCH};protocol=https"
SRCREV = "42faf17a65432f065451393302647f5818115ad9"
S = "${WORKDIR}/git"
