...
# matches with: https://github.com/ros2-gbp/libcamera-release/archive/release/jazzy/libcamera/0.3.2-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/libcamera"
SRC_URI = "git://github.com/ros2-gbp/libcamera-release;${ROS_BRANCH};protocol=https"
SRCREV = "74f3a2a8ecc6e213eb02c09b6d19849a1d04ffe2"
S = "${WORKDIR}/git"
