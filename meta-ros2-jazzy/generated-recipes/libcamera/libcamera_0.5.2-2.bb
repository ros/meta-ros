...
# matches with: https://github.com/ros2-gbp/libcamera-release/archive/release/jazzy/libcamera/0.5.2-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/libcamera"
SRC_URI = "git://github.com/ros2-gbp/libcamera-release;${ROS_BRANCH};protocol=https"
SRCREV = "0ed41d5a466441244431be7b2bc7efd51f8ffc33"
S = "${WORKDIR}/git"
