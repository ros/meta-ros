...
# matches with: https://github.com/ros2-gbp/libcamera-release/archive/release/jazzy/libcamera/0.7.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/libcamera"
SRC_URI = "git://github.com/ros2-gbp/libcamera-release;${ROS_BRANCH};protocol=https"
SRCREV = "df25535794ea224ca20a366fa288a3dcc55a6a45"
S = "${WORKDIR}/git"
