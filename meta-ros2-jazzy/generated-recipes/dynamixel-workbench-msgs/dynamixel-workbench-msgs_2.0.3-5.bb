...
# matches with: https://github.com/ros2-gbp/dynamixel_workbench_msgs-release/archive/release/jazzy/dynamixel_workbench_msgs/2.0.3-5.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/dynamixel_workbench_msgs"
SRC_URI = "git://github.com/ros2-gbp/dynamixel_workbench_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "dc300702741bf35a25967aba0a7465a453890fca"
S = "${WORKDIR}/git"
