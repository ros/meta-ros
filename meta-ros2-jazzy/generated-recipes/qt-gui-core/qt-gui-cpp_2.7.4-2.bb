...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/jazzy/qt_gui_cpp/2.7.4-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/qt_gui_cpp"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "08b713a20f93a00a1453852534c6cf503140913b"
S = "${WORKDIR}/git"
