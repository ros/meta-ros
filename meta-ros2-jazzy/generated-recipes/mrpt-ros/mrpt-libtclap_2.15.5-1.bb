...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libtclap/2.15.5-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libtclap"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "7ba8ae9cf81ab679b1463086e50ebbd561399fd1"
S = "${WORKDIR}/git"
