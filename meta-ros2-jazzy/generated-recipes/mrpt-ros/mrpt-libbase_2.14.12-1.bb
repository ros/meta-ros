...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libbase/2.14.12-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libbase"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "9ea6671202a0ed2d217be61b69d4e941a1a50bc6"
S = "${WORKDIR}/git"
