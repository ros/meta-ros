...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libslam/2.14.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libslam"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "e8b247306c8486dc526efa652199ffe7f79adf3a"
S = "${WORKDIR}/git"
