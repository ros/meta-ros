...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_apps/2.15.18-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_apps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "d0cf8a7e5ee1cd7d1bcbcd7cf4d40fc00be5900c"
S = "${WORKDIR}/git"
