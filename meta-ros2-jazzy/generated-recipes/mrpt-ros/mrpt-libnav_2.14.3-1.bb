...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libnav/2.14.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libnav"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "4080827111e7565b5ddfab69dffc54b2f3a6bf7e"
S = "${WORKDIR}/git"
