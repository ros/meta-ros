...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libtclap/2.15.18-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libtclap"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "476b5efde1f7268366e76284d38fcbc1d458dcde"
S = "${WORKDIR}/git"
