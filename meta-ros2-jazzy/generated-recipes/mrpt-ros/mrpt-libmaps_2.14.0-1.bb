...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libmaps/2.14.0-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libmaps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "0d7f4f5d274985c0964329898df30a3ef8ce5760"
S = "${WORKDIR}/git"
