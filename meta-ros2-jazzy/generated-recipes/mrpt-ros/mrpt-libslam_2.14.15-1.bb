...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libslam/2.14.15-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libslam"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "fb5cf97be3d5f0ab05d0eb3d5c14ff4a73a02f1c"
S = "${WORKDIR}/git"
