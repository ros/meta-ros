...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libnav/2.15.5-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libnav"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "d8b0b48ee89f391fe54c2fff67a9a86039af410e"
S = "${WORKDIR}/git"
