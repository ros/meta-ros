...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libtclap/2.15.1-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libtclap"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "cacbf6a9728664ebfc0034ee891a2ec3b0f75508"
S = "${WORKDIR}/git"
