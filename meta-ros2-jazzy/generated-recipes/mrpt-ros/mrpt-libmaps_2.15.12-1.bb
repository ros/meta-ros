...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libmaps/2.15.12-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libmaps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "6e63d6ced67c6dbde0ec08b2efbdbc4b7ea4547d"
S = "${WORKDIR}/git"
