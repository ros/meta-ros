...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libposes/2.14.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libposes"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "a9d6f14032914a6f815c5517ef94d26acdf2d0b7"
S = "${WORKDIR}/git"
