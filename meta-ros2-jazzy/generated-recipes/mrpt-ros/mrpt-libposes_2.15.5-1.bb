...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libposes/2.15.5-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libposes"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "5f98be17a7a2abb45b5561ba04dc63925088928f"
S = "${WORKDIR}/git"
