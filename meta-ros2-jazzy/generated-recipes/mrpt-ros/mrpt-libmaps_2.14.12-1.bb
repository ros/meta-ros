...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libmaps/2.14.12-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libmaps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "9159f4e0103b8967b9f201617cd5dc8b364acc34"
S = "${WORKDIR}/git"
