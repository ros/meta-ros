...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libmaps/2.15.5-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libmaps"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "316058e50547b060884c1fdfa966a9c2b8a5a7fa"
S = "${WORKDIR}/git"
