...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libopengl/2.15.18-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libopengl"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "ffd98f3e6a63766a181bde1022ee8b7b3563edac"
S = "${WORKDIR}/git"
