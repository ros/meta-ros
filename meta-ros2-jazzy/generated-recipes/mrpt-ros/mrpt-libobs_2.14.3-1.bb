...
# matches with: https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libobs/2.14.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/mrpt_libobs"
SRC_URI = "git://github.com/ros2-gbp/mrpt_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "11bd1734a713b94f2050da2266fd70a48b0ebe81"
S = "${WORKDIR}/git"
