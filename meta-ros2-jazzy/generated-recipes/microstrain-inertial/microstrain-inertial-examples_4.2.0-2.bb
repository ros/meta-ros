...
# matches with: https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/jazzy/microstrain_inertial_examples/4.2.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/microstrain_inertial_examples"
SRC_URI = "git://github.com/ros2-gbp/microstrain_inertial-release;${ROS_BRANCH};protocol=https"
SRCREV = "fd77671d4e87b3ad8deaac6ee79ff1e21fa4a32f"
S = "${WORKDIR}/git"
