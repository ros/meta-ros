...
# matches with: https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/jazzy/microstrain_inertial_driver/4.2.0-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/microstrain_inertial_driver"
SRC_URI = "git://github.com/ros2-gbp/microstrain_inertial-release;${ROS_BRANCH};protocol=https"
SRCREV = "ab4a1acc126ecde103b749f78cb00ebf766885f4"
S = "${WORKDIR}/git"
