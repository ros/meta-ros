...
# matches with: https://github.com/ros2-gbp/perception_pcl-release/archive/release/jazzy/pcl_ros/2.6.1-3.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/pcl_ros"
SRC_URI = "git://github.com/ros2-gbp/perception_pcl-release;${ROS_BRANCH};protocol=https"
SRCREV = "76df7d9e204baa33e050be5e52db2292afad08b9"
S = "${WORKDIR}/git"
