...
# matches with: https://github.com/ros2-gbp/urdf-release/archive/release/jazzy/urdf_parser_plugin/2.10.1-2.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/urdf_parser_plugin"
SRC_URI = "git://github.com/ros2-gbp/urdf-release;${ROS_BRANCH};protocol=https"
SRCREV = "f01d3400ba2fc704f39310d5da4272a2c8ec4fdd"
S = "${WORKDIR}/git"
