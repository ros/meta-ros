...
# matches with: https://github.com/ros2-gbp/crazyswarm2-release/archive/release/jazzy/crazyflie/1.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/crazyflie"
SRC_URI = "git://github.com/ros2-gbp/crazyswarm2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b6be69e410d4711613625bd29c7d4db99be4aeb7"
S = "${WORKDIR}/git"
