...
# matches with: https://github.com/ros2-gbp/ros_environment-release/archive/release/crystal/ros_environment/2.2.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/ros_environment"
SRC_URI = "git://github.com/ros2-gbp/ros_environment-release;${ROS_BRANCH};protocol=https"
SRCREV = "70fdb7d0dfad5a665353fe13973eb10ecc987675"
S = "${WORKDIR}/git"
