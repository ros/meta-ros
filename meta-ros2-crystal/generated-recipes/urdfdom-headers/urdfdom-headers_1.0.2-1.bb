...
# matches with: https://github.com/ros2-gbp/urdfdom_headers-release/archive/release/crystal/urdfdom_headers/1.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/crystal/urdfdom_headers"
SRC_URI = "git://github.com/ros2-gbp/urdfdom_headers-release;${ROS_BRANCH};protocol=https"
SRCREV = "ea260aaa8132d4840aa8bee6c5921cd6ffc0508f"
S = "${WORKDIR}/git"
