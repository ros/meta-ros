...
# matches with: https://github.com/ros2-gbp/rosidl_python-release/archive/release/crystal/python_cmake_module/0.6.3-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/python_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/rosidl_python-release;${ROS_BRANCH};protocol=https"
SRCREV = "b66677b14773f3fda939b0bcd01121d97ac9702c"
S = "${WORKDIR}/git"
