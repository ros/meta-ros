...
# matches with: https://github.com/ros2-gbp/rcl_logging-release/archive/release/crystal/rcl_logging_noop/0.2.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/rcl_logging_noop"
SRC_URI = "git://github.com/ros2-gbp/rcl_logging-release;${ROS_BRANCH};protocol=https"
SRCREV = "ca1ee3091388ce3645c0a05d201322b259fd2f4d"
S = "${WORKDIR}/git"
