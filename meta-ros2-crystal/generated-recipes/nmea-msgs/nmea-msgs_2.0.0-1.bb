...
# matches with: https://github.com/ros2-gbp/nmea_msgs-release/archive/release/crystal/nmea_msgs/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/crystal/nmea_msgs"
SRC_URI = "git://github.com/ros2-gbp/nmea_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "16bba7ebaf6ad4bcae91db9259eb0d41441be666"
S = "${WORKDIR}/git"
