...
# matches with: https://github.com/ros2-gbp/rclcpp-release/archive/release/crystal/rclcpp_action/0.6.5-1.tar.gz
ROS_BRANCH ?= "branch=release/crystal/rclcpp_action"
SRC_URI = "git://github.com/ros2-gbp/rclcpp-release;${ROS_BRANCH};protocol=https"
SRCREV = "25df59f470a41161990a3587923a2477632832e2"
S = "${WORKDIR}/git"
