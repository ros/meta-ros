...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/crystal/qt_gui_core/1.0.6-1.tar.gz
ROS_BRANCH ?= "branch=release/crystal/qt_gui_core"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "2559de3b7df08ff4c72addd288b62ab4fe721be7"
S = "${WORKDIR}/git"
