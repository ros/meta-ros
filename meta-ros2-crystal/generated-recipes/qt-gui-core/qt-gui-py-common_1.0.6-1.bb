...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/crystal/qt_gui_py_common/1.0.6-1.tar.gz
ROS_BRANCH ?= "branch=release/crystal/qt_gui_py_common"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "eb48d7c57b9e341c23e292cf583636025b73491a"
S = "${WORKDIR}/git"
