...
# matches with: https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/crystal/rmw_fastrtps_shared_cpp/0.6.2-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/rmw_fastrtps_shared_cpp"
SRC_URI = "git://github.com/ros2-gbp/rmw_fastrtps-release;${ROS_BRANCH};protocol=https"
SRCREV = "5d99640b75a8cd2ca9706a6c91f551de2ebe5ef4"
S = "${WORKDIR}/git"
