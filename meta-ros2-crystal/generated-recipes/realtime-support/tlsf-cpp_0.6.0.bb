...
# matches with: https://github.com/ros2-gbp/realtime_support-release/archive/release/crystal/tlsf_cpp/0.6.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/tlsf_cpp"
SRC_URI = "git://github.com/ros2-gbp/realtime_support-release;${ROS_BRANCH};protocol=https"
SRCREV = "44afd0faf8734c0487e8d73b2ec80d42a4836f3f"
S = "${WORKDIR}/git"
