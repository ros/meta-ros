...
# matches with: https://github.com/ros2-gbp/realtime_support-release/archive/release/crystal/rttest/0.6.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/rttest"
SRC_URI = "git://github.com/ros2-gbp/realtime_support-release;${ROS_BRANCH};protocol=https"
SRCREV = "e365e22d5ad1ecbc4ff1b67d76406b75536054df"
S = "${WORKDIR}/git"
