...
# matches with: https://github.com/ros2-gbp/image_common-release/archive/release/crystal/camera_info_manager/2.0.1-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/camera_info_manager"
SRC_URI = "git://github.com/ros2-gbp/image_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "3258254aa3aceecdb1bc292ae8c746e59df5bd1c"
S = "${WORKDIR}/git"
