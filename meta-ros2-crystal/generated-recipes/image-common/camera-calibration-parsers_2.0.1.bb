...
# matches with: https://github.com/ros2-gbp/image_common-release/archive/release/crystal/camera_calibration_parsers/2.0.1-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/camera_calibration_parsers"
SRC_URI = "git://github.com/ros2-gbp/image_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "8e27bda26e5ecb0ec4e75ac3dae121ada0733de6"
S = "${WORKDIR}/git"
