...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/crystal/lifecycle/0.6.2-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/lifecycle"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "d061676095267b01245715f6378d9a0332a0b0a4"
S = "${WORKDIR}/git"
