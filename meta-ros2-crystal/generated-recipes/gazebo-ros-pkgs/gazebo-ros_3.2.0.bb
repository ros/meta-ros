...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/crystal/gazebo_ros/3.2.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/gazebo_ros"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "ea9797f97574d16eefa78961078c46d2e312253c"
S = "${WORKDIR}/git"
