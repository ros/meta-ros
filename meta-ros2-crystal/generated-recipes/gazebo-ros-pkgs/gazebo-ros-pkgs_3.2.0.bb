...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/crystal/gazebo_ros_pkgs/3.2.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/gazebo_ros_pkgs"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "40f01b4a03cea94e2ac94864d1556d6a4facce82"
S = "${WORKDIR}/git"
