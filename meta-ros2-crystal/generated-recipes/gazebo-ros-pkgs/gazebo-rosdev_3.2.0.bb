...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/crystal/gazebo_dev/3.2.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/gazebo_dev"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "4d355e9074f175cf75130f84f205c13654d17043"
S = "${WORKDIR}/git"
