...
# matches with: https://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release/archive/release/crystal/fastrtps_cmake_module/0.6.1-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/fastrtps_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release;${ROS_BRANCH};protocol=https"
SRCREV = "7547d329ba28f82f01ae038e011bf6847eb47793"
S = "${WORKDIR}/git"
