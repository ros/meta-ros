...
# matches with: https://github.com/ros2-gbp/orocos_kinematics_dynamics-release/archive/release/crystal/orocos_kdl/3.1.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/orocos_kdl"
SRC_URI = "git://github.com/ros2-gbp/orocos_kinematics_dynamics-release;${ROS_BRANCH};protocol=https"
SRCREV = "7cf1a7ad228b8e48cab7bf79616ec7563c99b340"
S = "${WORKDIR}/git"
