...
# matches with: https://github.com/ros2-gbp/resource_retriever-release/archive/release/crystal/resource_retriever/2.1.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/resource_retriever"
SRC_URI = "git://github.com/ros2-gbp/resource_retriever-release;${ROS_BRANCH};protocol=https"
SRCREV = "e64295df64539c8a74b21924917217a0d44ad3fc"
S = "${WORKDIR}/git"
