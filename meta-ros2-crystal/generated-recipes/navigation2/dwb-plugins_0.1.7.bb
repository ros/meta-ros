...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/crystal/dwb_plugins/0.1.7-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/dwb_plugins"
SRC_URI = "git://github.com/SteveMacenski/navigation2-release;${ROS_BRANCH};protocol=https"
SRCREV = "fe82a89d6a59e16360f80537800d2f0a57deeb2c"
S = "${WORKDIR}/git"
