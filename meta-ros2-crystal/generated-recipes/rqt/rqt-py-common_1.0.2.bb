...
# matches with: https://github.com/ros2-gbp/rqt-release/archive/release/crystal/rqt_py_common/1.0.2-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/rqt_py_common"
SRC_URI = "git://github.com/ros2-gbp/rqt-release;${ROS_BRANCH};protocol=https"
SRCREV = "3d1340b0b1edb8e8946d8e6f1690ba3ad02cb4b5"
S = "${WORKDIR}/git"
