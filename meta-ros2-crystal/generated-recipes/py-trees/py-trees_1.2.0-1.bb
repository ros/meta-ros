...
# matches with: https://github.com/stonier/py_trees-release/archive/release/crystal/py_trees/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/crystal/py_trees"
SRC_URI = "git://github.com/stonier/py_trees-release;${ROS_BRANCH};protocol=https"
SRCREV = "f0e0bb93fe90868af7c5ccef877d65cbfc594fef"
S = "${WORKDIR}/git"
