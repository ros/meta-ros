...
# matches with: https://github.com/ros2-gbp/ament_cmake-release/archive/release/crystal/ament_cmake_core/0.6.1-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/ament_cmake_core"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake-release;${ROS_BRANCH};protocol=https"
SRCREV = "e4fb5f0725cffa00b6e233e9dc52648ba241fbec"
S = "${WORKDIR}/git"
