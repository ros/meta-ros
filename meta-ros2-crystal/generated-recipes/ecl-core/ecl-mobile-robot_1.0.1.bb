...
# matches with: https://github.com/yujinrobot-release/ecl_core-release/archive/release/crystal/ecl_mobile_robot/1.0.1-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/ecl_mobile_robot"
SRC_URI = "git://github.com/yujinrobot-release/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "a8f0aeb29e59c515321e7e80cf8ecbf0c86b257f"
S = "${WORKDIR}/git"
