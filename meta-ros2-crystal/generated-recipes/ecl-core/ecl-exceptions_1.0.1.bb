...
# matches with: https://github.com/yujinrobot-release/ecl_core-release/archive/release/crystal/ecl_exceptions/1.0.1-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/ecl_exceptions"
SRC_URI = "git://github.com/yujinrobot-release/ecl_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "16e7b8a4c6b2d70ce0620174cd02ff75ebdb1db9"
S = "${WORKDIR}/git"
