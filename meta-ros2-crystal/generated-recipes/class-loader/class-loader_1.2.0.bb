...
# matches with: https://github.com/ros2-gbp/class_loader-release/archive/release/crystal/class_loader/1.2.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/class_loader"
SRC_URI = "git://github.com/ros2-gbp/class_loader-release;${ROS_BRANCH};protocol=https"
SRCREV = "9b90482c81be3f20eae61bb91b68dcc923ed4ccd"
S = "${WORKDIR}/git"
