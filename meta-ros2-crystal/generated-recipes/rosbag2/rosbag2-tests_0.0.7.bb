...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/crystal/rosbag2_tests/0.0.7-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/rosbag2_tests"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "859478456cb1107f36b1dd1786405ccd1abfc7bb"
S = "${WORKDIR}/git"
