...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/crystal/ament_clang_format/0.6.4-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/ament_clang_format"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "7ccddac04d874668d9ad091d2d2ef0ce86310fce"
S = "${WORKDIR}/git"
