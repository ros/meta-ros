...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/crystal/ament_cmake_cppcheck/0.6.4-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/ament_cmake_cppcheck"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "54a4812d97aa1bef9eeed0039707e5a8dbd1b8dd"
S = "${WORKDIR}/git"
