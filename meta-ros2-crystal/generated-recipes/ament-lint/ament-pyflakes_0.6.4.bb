...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/crystal/ament_pyflakes/0.6.4-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/ament_pyflakes"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "7365a114ffc562f587ad3daccf9ac3d46f587ae1"
S = "${WORKDIR}/git"
