...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/crystal/ament_lint_cmake/0.6.4-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/ament_lint_cmake"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "a629ba1aa9a4648bc77d1ccaa239dfba71243c16"
S = "${WORKDIR}/git"
