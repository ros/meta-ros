...
# matches with: https://github.com/cyberbotics/webots_ros2-release/archive/release/crystal/webots_ros2_core/0.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/crystal/webots_ros2_core"
SRC_URI = "git://github.com/cyberbotics/webots_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "df66ff1fe10be01458ccf067867a6f8bee168238"
S = "${WORKDIR}/git"
