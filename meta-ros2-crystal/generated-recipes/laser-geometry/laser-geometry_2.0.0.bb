...
# matches with: https://github.com/ros2-gbp/laser_geometry-release/archive/release/crystal/laser_geometry/2.0.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/laser_geometry"
SRC_URI = "git://github.com/ros2-gbp/laser_geometry-release;${ROS_BRANCH};protocol=https"
SRCREV = "cf56ba22c5054ad226e0f71b64fbe0cdc6f79d5c"
S = "${WORKDIR}/git"
