...
# matches with: https://github.com/ros2-gbp/image_pipeline-release/archive/release/crystal/image_publisher/2.0.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/image_publisher"
SRC_URI = "git://github.com/ros2-gbp/image_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "8fb1f55d17edbc921bdc1bec6b49ef7cdd134270"
S = "${WORKDIR}/git"
