...
# matches with: https://github.com/ros2-gbp/fastcdr-release/archive/release/crystal/fastcdr/1.0.8-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/fastcdr"
SRC_URI = "git://github.com/ros2-gbp/fastcdr-release;${ROS_BRANCH};protocol=https"
SRCREV = "8babf24abc8f2e4195c6ee598b24608f2e978c2e"
S = "${WORKDIR}/git"
