...
# matches with: https://github.com/ros2-gbp/urdf-release/archive/release/crystal/urdf/2.2.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/urdf"
SRC_URI = "git://github.com/ros2-gbp/urdf-release;${ROS_BRANCH};protocol=https"
SRCREV = "1e648e4b00fde5a8261f80be42aac02024fcac32"
S = "${WORKDIR}/git"
