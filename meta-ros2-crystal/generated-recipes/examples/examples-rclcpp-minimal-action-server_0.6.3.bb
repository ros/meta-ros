...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/crystal/examples_rclcpp_minimal_action_server/0.6.3-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/examples_rclcpp_minimal_action_server"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "0ba2cba7a8ae7378a3499355e3df859607d1deeb"
S = "${WORKDIR}/git"
