...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/crystal/examples_rclpy_minimal_action_client/0.6.3-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/examples_rclpy_minimal_action_client"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "aee1c008840e547862d73b4b622e07be20270976"
S = "${WORKDIR}/git"
