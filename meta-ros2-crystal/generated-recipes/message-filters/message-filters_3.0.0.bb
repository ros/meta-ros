...
# matches with: https://github.com/ros2-gbp/ros2_message_filters-release/archive/release/crystal/message_filters/3.0.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/message_filters"
SRC_URI = "git://github.com/ros2-gbp/ros2_message_filters-release;${ROS_BRANCH};protocol=https"
SRCREV = "c20f38442728729664d77541af9882adb3dc19a1"
S = "${WORKDIR}/git"
