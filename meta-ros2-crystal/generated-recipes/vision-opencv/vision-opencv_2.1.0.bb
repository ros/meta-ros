...
# matches with: https://github.com/ros2-gbp/vision_opencv-release/archive/release/crystal/vision_opencv/2.1.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/vision_opencv"
SRC_URI = "git://github.com/ros2-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "7062f65b5864a2346428e38050377d6c646dcff9"
S = "${WORKDIR}/git"
