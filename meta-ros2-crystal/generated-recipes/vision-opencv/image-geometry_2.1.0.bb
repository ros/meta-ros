...
# matches with: https://github.com/ros2-gbp/vision_opencv-release/archive/release/crystal/image_geometry/2.1.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/image_geometry"
SRC_URI = "git://github.com/ros2-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "628de7b70b72b7cb9c7d131a6966109369a5b986"
S = "${WORKDIR}/git"
