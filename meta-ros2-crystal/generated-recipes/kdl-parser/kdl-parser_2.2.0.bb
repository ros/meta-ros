...
# matches with: https://github.com/ros2-gbp/kdl_parser-release/archive/release/crystal/kdl_parser/2.2.0-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/kdl_parser"
SRC_URI = "git://github.com/ros2-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "2f8c6e86ed2aab83c91469ade68ad9c5cfb0486a"
S = "${WORKDIR}/git"
