...
# matches with: https://github.com/boschresearch/fmi_adapter_ros2-release/archive/release/crystal/fmi_adapter_examples/0.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/crystal/fmi_adapter_examples"
SRC_URI = "git://github.com/boschresearch/fmi_adapter_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b4b26a6b8646474aceede8b107940555854a11d9"
S = "${WORKDIR}/git"
