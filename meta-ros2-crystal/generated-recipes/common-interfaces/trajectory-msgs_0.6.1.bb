...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/crystal/trajectory_msgs/0.6.1-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/trajectory_msgs"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "214a12bfe5a7625fbeac3e0c3e0a2ea4e60c7fa3"
S = "${WORKDIR}/git"
