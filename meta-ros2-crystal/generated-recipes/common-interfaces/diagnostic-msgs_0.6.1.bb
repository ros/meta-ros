...
# matches with: https://github.com/ros2-gbp/common_interfaces-release/archive/release/crystal/diagnostic_msgs/0.6.1-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/diagnostic_msgs"
SRC_URI = "git://github.com/ros2-gbp/common_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "75368c8361063bcfbe24c2dab0b0de3f8c0a8c88"
S = "${WORKDIR}/git"
