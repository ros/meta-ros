...
# matches with: https://github.com/ros2-gbp/rosidl_typesupport_connext-release/archive/release/crystal/connext_cmake_module/0.6.4-0.tar.gz
ROS_BRANCH ?= "branch=release/crystal/connext_cmake_module"
SRC_URI = "git://github.com/ros2-gbp/rosidl_typesupport_connext-release;${ROS_BRANCH};protocol=https"
SRCREV = "e26845f53e943a2c6ab61c01c1481ddaf0b913db"
S = "${WORKDIR}/git"
